...
모델 훈련코드는 [여기](https://colab.research.google.com/github/sanghunkang/tensorflow-lite/mobile_team_project/model_training/train_speech_model_ios_ko.ipynb)를 참고해주세요. 
