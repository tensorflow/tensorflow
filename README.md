...
TensorFlow was developed by the Google Brain team for research in machine learning and neural networks. Its architecture, however, is versatile and applicable to a range of other domains as well.
