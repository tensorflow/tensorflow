...
researchers push the state-of-the-art in ML and developers quickly build and
deploy ML-powered applications.

The researchers and engineers who developed TensorFlow worked on the 
Google Brain team within Google's Machine Intelligence Research organization 
to conduct machine learning and deep neural networks research. The system is
