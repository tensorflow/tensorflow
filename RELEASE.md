...
* Other:
  ...
  * Conv2D, Conv2DBackpropInput, Conv2DBackpropFilter now supports arbitrary
    dilations with GPU and cudnnv6 suppor
  * Estimator supports Dataset: `input_fn` can return a Dataset instead of
    Tensors.
  * RevBlock: memory-efficient implementation of reversible residual layers
  * Minor refactor: move stats files from stochastic to common, remove
    stochastic
  * BFCAllocator changed to reduce internal fragmentation
  ...
  * Renaming SqueezeDims attribute to Axis in C++ API for Squeeze op.
  * Changed embedding op to use parallel version of DynamicStitch.
  * Sparse multidimensional feature columns support
