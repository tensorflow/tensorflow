...
*   Fixes an OOB segfault in `DynamicStitch` caused by missing validation ([CVE-2022-41883](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-41883))
...
*   Fixes a overflow in `tf.keras.losses.poisson` ([CVE-2022-41887](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2022-41887))
...
This release introduces some vulnerability fixes.
