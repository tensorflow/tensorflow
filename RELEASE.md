...
* Android can now be built to run with CUDA acceleration on compatible Tegra devices (see [makefile/README.md](contrib/makefile/README.md) for more information)
