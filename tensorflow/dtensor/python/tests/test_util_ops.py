...
def expand_test_config(op_list, test_configs):
    ...
    for op_info in op_list:
        ...
        for added_test_config in test_configs:
            ...
            test_config["testcase_name"] = (
                op_info["testcase_name"] + "_" + str(test_index)
            )
            test_index += 1
...
UNARY_OPS = [
    {"testcase_name": "Identity", "op": array_ops.identity},
    {"testcase_name": "ZerosLike", "op": array_ops.zeros_like_v2},
    {"testcase_name": "Abs", "op": math_ops.abs},
    {"testcase_name": "Negative", "op": gen_math_ops.neg},
    {"testcase_name": "Cast", "op": lambda x: math_ops.cast(x, dtypes.int32)},
    {"testcase_name": "ErfOp", "op": gen_math_ops.erf},
    {"testcase_name": "Softmax", "op": nn_ops.softmax_v2},
    {"testcase_name": "LogSoftmax", "op": nn_ops.log_softmax_v2},
    {"testcase_name": "StopGradient", "op": array_ops.stop_gradient},
    {"testcase_name": "Exp", "op": math_ops.exp},
    {"testcase_name": "Sqrt", "op": math_ops.sqrt},
    {"testcase_name": "Rsqrt", "op": math_ops.rsqrt},
    {"testcase_name": "Reciprocal", "op": gen_math_ops.reciprocal},
    {"testcase_name": "Relu", "op": gen_nn_ops.relu},
    {"testcase_name": "Square", "op": gen_math_ops.square},
    {"testcase_name": "Tanh", "op": gen_math_ops.tanh},
    {"testcase_name": "Cos", "op": gen_math_ops.cos},
    {"testcase_name": "Sigmoid", "op": math_ops.sigmoid},
    {"testcase_name": "Acos", "op": math_ops.acos},
    {"testcase_name": "Acosh", "op": gen_math_ops.acosh},
    {"testcase_name": "Angle", "op": math_ops.angle},
    {"testcase_name": "Asin", "op": gen_math_ops.asin},
    {"testcase_name": "Asinh", "op": gen_math_ops.asinh},
    {"testcase_name": "Atan", "op": gen_math_ops.atan},
    {"testcase_name": "Bessel0e", "op": special_math_ops.bessel_i0e},
    {"testcase_name": "Bessel1e", "op": special_math_ops.bessel_i1e},
    {
        "testcase_name": "Bitcast",
        "op": lambda x: gen_array_ops.bitcast(x, type=dtypes.int32),
    },
    {"testcase_name": "Ceil", "op": math_ops.ceil},
    {
    ...
    {"testcase_name": "Conj", "op": math_ops.conj},
    {"testcase_name": "Cosh", "op": gen_math_ops.cosh},
    {"testcase_name": "Digamma", "op": gen_math_ops.digamma},
    {
        "testcase_name": "ComplexAbs",
        "op": lambda x: gen_math_ops.complex_abs(
            x=math_ops.cast(x, dtypes.complex64), Tout=float, name="raw"
        ),
    },
    {"testcase_name": "Sign", "op": math_ops.sign},
    {"testcase_name": "Elu", "op": gen_nn_ops.elu},
    {"testcase_name": "Erfc", "op": gen_math_ops.erfc},
    {"testcase_name": "Expm1", "op": gen_math_ops.expm1},
    {"testcase_name": "Floor", "op": math_ops.floor},
    {"testcase_name": "Imag", "op": math_ops.imag},
    {"testcase_name": "Inv", "op": (lambda x: gen_math_ops.inv(x=x, name="Inv"))},
    {"testcase_name": "IsInf", "op": gen_math_ops.is_inf},
    {"testcase_name": "IsNan", "op": gen_math_ops.is_nan},
    {
...
BINARY_ANY_TYPE_OPS_WITH_BROADCASTING_SUPPORT = [
    {"testcase_name": "Add", "op": math_ops.add},
    {"testcase_name": "Subtract", "op": math_ops.subtract},
    {"testcase_name": "Multiply", "op": math_ops.multiply},
    {"testcase_name": "Maximum", "op": gen_math_ops.maximum},
    {"testcase_name": "Minimum", "op": gen_math_ops.minimum},
    {"testcase_name": "Squared_Difference", "op": gen_math_ops.squared_difference},
    {"testcase_name": "GreaterEqual", "op": gen_math_ops.greater_equal},
    {"testcase_name": "Equal", "op": math_ops.equal},
    {"testcase_name": "NotEqual", "op": math_ops.not_equal},
    {"testcase_name": "LessEqual", "op": gen_math_ops.less_equal},
    {"testcase_name": "Less", "op": gen_math_ops.less},
    {"testcase_name": "Pow", "op": math_ops.pow},
]

BINARY_FLOAT_OPS_WITH_BROADCASTING_SUPPORT = [
    {"testcase_name": "Real_Divide", "op": math_ops.divide},
    {"testcase_name": "DivNoNan", "op": math_ops.div_no_nan},
] + BINARY_ANY_TYPE_OPS_WITH_BROADCASTING_SUPPORT

BINARY_INT_OPS_WITH_BROADCASTING_SUPPORT = [
    {"testcase_name": "LeftShift", "op": gen_bitwise_ops.left_shift},
    {"testcase_name": "RightShift", "op": gen_bitwise_ops.right_shift},
    {"testcase_name": "BitwiseOr", "op": gen_bitwise_ops.bitwise_or},
    {"testcase_name": "BitwiseAnd", "op": gen_bitwise_ops.bitwise_and},
    {"testcase_name": "BitwiseXor", "op": gen_bitwise_ops.bitwise_xor},
    {"testcase_name": "TruncateDiv", "op": gen_math_ops.truncate_div},
    {"testcase_name": "TruncateMod", "op": gen_math_ops.truncate_mod},
] + BINARY_ANY_TYPE_OPS_WITH_BROADCASTING_SUPPORT

BINARY_BOOL_OPS = [{"testcase_name": "LogicalOr", "op": gen_math_ops.logical_or}]
...
BINARY_FLOAT_OPS = [
    ...
    {"testcase_name": "Atan2", "op": gen_math_ops.atan2},
    {"testcase_name": "Betainc", "op": lambda a, b: gen_math_ops.betainc(a, b, 1.0)},
    {"testcase_name": "Complex", "op": math_ops.complex},
    {
        "testcase_name": "EluGrad",
        "op": (
            lambda x, y: gen_nn_ops.elu_grad(gradients=x, outputs=y, name="op_elugrad")
        ),
    },
    {"testcase_name": "Igamma", "op": gen_math_ops.igamma},
    {
        "testcase_name": "IgammaGradA",
        "op": (lambda a, x: gen_math_ops.igamma_grad_a(a=a, x=x, name="IgammaGradA")),
    },
    {
        "testcase_name": "LeakyReluGrad",
        "op": (lambda x, y: gen_nn_ops.leaky_relu_grad(gradients=x, features=y)),
    },
    {
...
REDUCTION_OPS = [
    {"testcase_name": "Sum", "op": math_ops.reduce_sum},
    {"testcase_name": "Mean", "op": math_ops.reduce_mean},
    {"testcase_name": "Prod", "op": math_ops.reduce_prod},
    {"testcase_name": "Max", "op": math_ops.reduce_max},
    {"testcase_name": "Min", "op": math_ops.reduce_min},
]
...
EXPANSION_OPS = [
    dict(
        ...
        inputs=lambda: (constant_op.constant([[1.0]]), [4, 4]),
        op=gen_array_ops.tile,
    ),
    dict(
        testcase_name="TileFrom2x2Array",
        inputs=lambda: (constant_op.constant([[1.0, 2.0], [3.0, 4.0]]), [2, 4]),
        op=gen_array_ops.tile,
    ),
    dict(
        testcase_name="Fill",
        inputs=lambda: ([2, 4], constant_op.constant(1.0)),
        op=array_ops.fill,
    ),
]
...
PADDINGS = [
    {"testcase_name": "SamePadding", "padding": "SAME"},
    {"testcase_name": "ValidPadding", "padding": "VALID"},
]
