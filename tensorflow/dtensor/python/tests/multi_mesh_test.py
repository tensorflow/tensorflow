...
class MultiMeshTest(test_util.DTensorBaseTest):
    ...
    def testMultiMeshAdd(self):
        ...
        self.assertDTensorEqual(
            ...
            Layout.replicated(self.first_mesh, rank=0),
            first_mesh_result,
        )
        self.assertDTensorEqual(
            np.ones([3], dtype=np.int32),
    ...
    def testMultiMeshWithHostMesh(self, host_to_tpu):
        ...
        host_layout = Layout(
            sharded_layout_on_tpu.sharding_specs, sharded_layout_on_tpu.mesh.host_mesh()
        )
    ...
    def testMultiMeshBackward(self):
        ...
        self.assertDTensorEqual(
            -0.5 * 0.5 * 0.5 * (1 / numpy_a) ** 1.5, host_layout, a_grad_grad
        )
