...
class ConvOpTest(test_util.DTensorBaseTest):
    ...
    def testConvFollowedByEinsumWithGradient(
        self,
        conv_op,
        input_size,
        kernel_size,
        ...
        result, inputs_grad, kernel_grad, weight_grad = conv_fn(x_in, kernel_in, weight)
...
SPATIALLY_PARTITIONED_CONV_TEST_CASES = [
    [
        ("Case1", (BATCH_SIZE, 8, 16, CHANNEL_IN), (3, 5, CHANNEL_IN, CHANNEL_OUT)),
        ("Case2", (BATCH_SIZE, 8, 128, CHANNEL_IN), (3, 9, CHANNEL_IN, CHANNEL_OUT)),
    ],
    [
        ("ValidPadding", "VALID"),
        ("SamePadding", "SAME"),
    ...
    [
        ...
        ("Batch_2d_2x2x2", [BATCH_DIM, HEIGHT_DIM, WIDTH_DIM, UNSHARDED], (2, 2, 2)),
    ],
]
...
class SpatiallyPartitionedConvOpTest(test_util.DTensorBaseTest):
    ...
    def testConv(self, input_shape, kernel_shape, padding, sharding_specs, topology):
    ...
    def testConvWithGradient(
        self, input_shape, kernel_shape, padding, sharding_specs, topology
    ):
        ...
        d_output, d_inputs_grad, d_kernel_grad = conv_fn(d_x_in, d_kernel_in, padding)
