...
class DTensorSPMDTest(test_util.DTensorBaseTest):
    def setUp(self):
        ...
        self.skipForDeviceType(["GPU", "TPU"], "SparseTensors only supported on CPU.")
    ...
    def testIdentityOpWithSparseTensorInputSimple(self, dtype):
        ...
        self.assertDTensorEqual(
            inputs, layout, f(numpy_util.pack_numpy(inputs, layout, make_sparse=True))
        )
    ...
    def testIdentityOpWithSparseTensorInputComplex(
        self, dtype, is_sparse_a, is_sparse_b
    ):
    ...
    def testMultipleIdentityOpFromOneSparseTensor(self):
        ...
        got_a, got_b = f(numpy_util.pack_numpy(inputs_a, layout_a, make_sparse=True))
