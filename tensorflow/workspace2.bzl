...
def _tf_repositories():
    ...
    tf_http_archive(
        name = "XNNPACK",
        sha256 = "06ed18adcc0522bda232240468b954ec4611d6c66feb30fad57e50df842652d3",
        strip_prefix = "XNNPACK-eab168758e40695b8e3469e89d97a9b693b9db86",
        urls = tf_mirror_urls("https://github.com/google/XNNPACK/archive/eab168758e40695b8e3469e89d97a9b693b9db86.zip"),
    )
    # LINT.ThenChange(//tensorflow/lite/tools/cmake/modules/xnnpack.cmake)

    # KleidiAI library, used by XNNPACK for ARM microkernels.
    tf_http_archive(
        name = "KleidiAI",
