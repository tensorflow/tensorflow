...
def _tf_repositories():
    ...
    tf_http_archive(
        name = "org_xprof",
        sha256 = "d7509905dd315cc678689b4523f38b8a2793c07f3553d004fd271206289bd679",
        strip_prefix = "xprof-d0a9bec6bea0170cb358f69e9d818a9e228db114",
        patch_file = ["//third_party/xprof:xprof.patch"],
        urls = tf_mirror_urls("https://github.com/openxla/xprof/archive/d0a9bec6bea0170cb358f69e9d818a9e228db114.zip"),
        repo_mapping = {
            "@xla": "@local_xla",
            "@tsl": "@local_tsl",
        },
