...
def _tf_repositories():
    ...
    tf_http_archive(
        ...
        sha256 = "6477d83c9edbb34a0ebce6d751a1b32962bc6415d75d04972b676c6894ceaef9",
        strip_prefix = "nccl-2.18.3-1",
        urls = tf_mirror_urls("https://github.com/nvidia/nccl/archive/v2.18.3-1.tar.gz"),
    )
