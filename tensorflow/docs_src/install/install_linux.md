...
Take the following steps to install TensorFlow with Virtualenv:
  ...
  5. (Optional) If Step 4 failed (typically because you invoked a pip version
     ...
     https://storage.googleapis.com/tensorflow/linux/cpu/tensorflow-1.1.0rc1-cp34-cp34m-linux_x86_64.whl</b></pre>
...
take the following steps:
  ...
  2. (Optional.) If Step 1 failed, install the latest version of TensorFlow
     ...
     https://storage.googleapis.com/tensorflow/linux/cpu/tensorflow-1.1.0rc1-cp34-cp34m-linux_x86_64.whl</b>
     </pre>
