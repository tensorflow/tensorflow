...
Take the following steps to install TensorFlow for Java on Linux or Mac OS:
  ...
  1. Download
     [libtensorflow.jar](https://storage.googleapis.com/tensorflow/libtensorflow/libtensorflow-1.4.1.jar),
...
Take the following steps to install TensorFlow for Java on Windows:
  ...
  2. Download the following Java Native Interface (JNI) file appropriate for
     [TensorFlow for Java on Windows](https://storage.googleapis.com/tensorflow/libtensorflow/libtensorflow_jni-cpu-windows-x86_64-1.4.1.zip).
...
<pre><b>javac -cp libtensorflow-1.4.1.jar HelloTF.java</b></pre>
...
<pre><b>java -cp libtensorflow-1.4.1.jar:. -Djava.library.path=./jni HelloTF</b></pre>
