...
def tf_repositories(path_prefix = "", tf_repo_name = ""):
    ...
    tf_http_archive(
        ...
        strip_prefix = "google-cloud-cpp-1.13.0",
        patch_file = clean_dep("//third_party:com_github_googleapis_google_cloud_cpp.patch"),
        urls = [
            "https://storage.googleapis.com/mirror.tensorflow.org/github.com/googleapis/google-cloud-cpp/archive/v1.13.0.tar.gz",
            "https://github.com/googleapis/google-cloud-cpp/archive/v1.13.0.tar.gz",
        ],
    )
