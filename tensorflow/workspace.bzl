...
def tf_repositories(path_prefix = "", tf_repo_name = ""):
    ...
    tf_http_archive(
        ...
        sha256 = "77b67691cf9f76e6af77c9c5385db9822e8685aab2741f6913d73dce6fca4faf",
        strip_prefix = "llvm-project-5b9e4daef06dcfefc786737a32c8bbb5bd0fc5c4/llvm",
        urls = [
            "https://storage.googleapis.com/mirror.tensorflow.org/github.com/llvm/llvm-project/archive/5b9e4daef06dcfefc786737a32c8bbb5bd0fc5c4.tar.gz",
            "https://github.com/llvm/llvm-project/archive/5b9e4daef06dcfefc786737a32c8bbb5bd0fc5c4.tar.gz",
        ],
    )
