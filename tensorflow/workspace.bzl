...
def tf_repositories(path_prefix = "", tf_repo_name = ""):
    ...
    tf_http_archive(
        ...
        sha256 = "c4ffe9a3e47d10c85b4b5d5fb3200083983df26b50b079ba755eb459d3d97056",
        strip_prefix = "llvm-project-d82b6ba21b32ddf00af886b9160feef88211773e/llvm",
        urls = [
            "https://storage.googleapis.com/mirror.tensorflow.org/github.com/llvm/llvm-project/archive/d82b6ba21b32ddf00af886b9160feef88211773e.tar.gz",
            "https://github.com/llvm/llvm-project/archive/d82b6ba21b32ddf00af886b9160feef88211773e.tar.gz",
        ],
    )
