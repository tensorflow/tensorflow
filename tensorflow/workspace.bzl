...
def tf_workspace(path_prefix = "", tf_repo_name = ""):
    ...
    tf_http_archive(
        ...
        extra = {
            clean_dep("//third_party:parquet/parquet_types.h"): "src/parquet/parquet_types.h",
            clean_dep("//third_party:parquet/parquet_types.cpp"): "src/parquet/parquet_types.cpp",
        },
    )
