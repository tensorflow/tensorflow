...
def tf_repositories(path_prefix = "", tf_repo_name = ""):
    ...
    tf_http_archive(
        ...
        sha256 = "c555c6c264586baf8b7b83214f4ae8a52fde0294dcd391ec8eaf71897b249486",
        strip_prefix = "llvm-40ae5ec11a91f28bd1ae95d49e9e887fe3284fe3",
        urls = [
            "https://mirror.bazel.build/github.com/llvm-mirror/llvm/archive/40ae5ec11a91f28bd1ae95d49e9e887fe3284fe3.tar.gz",
            "https://github.com/llvm-mirror/llvm/archive/40ae5ec11a91f28bd1ae95d49e9e887fe3284fe3.tar.gz",
        ],
    )
