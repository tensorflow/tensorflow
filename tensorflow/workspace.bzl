...
def tf_repositories(path_prefix = "", tf_repo_name = ""):
    ...
    tf_http_archive(
        ...
        sha256 = "cef37080c2a9262372addcc0adf9e7f6aa11d007c1d49be22c4b0adf0f6eb520",
        strip_prefix = "llvm-c16d7eeac521332d590cf717d6eb5c7d2f233fab",
        urls = [
            "https://mirror.bazel.build/github.com/llvm-mirror/llvm/archive/c16d7eeac521332d590cf717d6eb5c7d2f233fab.tar.gz",
            "https://github.com/llvm-mirror/llvm/archive/c16d7eeac521332d590cf717d6eb5c7d2f233fab.tar.gz",
        ],
    )
