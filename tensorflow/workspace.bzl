...
def tf_repositories(path_prefix = "", tf_repo_name = ""):
    ...
    tf_http_archive(
        ...
        sha256 = "5fac6b0290848c159be3fc8682270f4e89011fa67be4fd11fc7130505dd13d48",
        strip_prefix = "llvm-d35e5f8dded4c884ca25ca88f184e1505cad106c",
        urls = [
            "https://mirror.bazel.build/github.com/llvm-mirror/llvm/archive/d35e5f8dded4c884ca25ca88f184e1505cad106c.tar.gz",
            "https://github.com/llvm-mirror/llvm/archive/d35e5f8dded4c884ca25ca88f184e1505cad106c.tar.gz",
        ],
    )
