...
#define CURAND_ROUTINE_EACH(__macro)            \
  ...
  __macro(curandSetGeneratorOffset)             \
  __macro(curandGenerateNormal)                 \
  __macro(curandGenerateNormalDouble)

// clang-format on

CURAND_ROUTINE_EACH(STREAM_EXECUTOR_CURAND_WRAP)
#undef CURAND_ROUTINE_EACH
