...
bool CUDABlas::DoBlasAsum(Stream *stream, uint64 elem_count,
  ...
  return DoBlasInternal(wrap::cublasSasum, stream,
                        ...
                        cuda::CUDAMemory(x), incx, cuda::CUDAMemoryMutable(result));
}
...
bool CUDABlas::DoBlasAsum(Stream *stream, uint64 elem_count,
  ...
  return DoBlasInternal(
      ...
      elem_count, cuda::CUDAComplex(cuda::CUDAMemory(x)), incx, cuda::CUDAMemoryMutable(result));
}
...
bool CUDABlas::DoBlasAxpy(Stream *stream, uint64 elem_count, float alpha,
  ...
  return DoBlasInternal(wrap::cublasSaxpy, stream,
                        ...
                        cuda::CUDAMemory(x), incx, cuda::CUDAMemoryMutable(y), incy);
}
...
bool CUDABlas::DoBlasAxpy(Stream *stream, uint64 elem_count,
  ...
  return DoBlasInternal(wrap::cublasCaxpy, stream,
                        ...
                        cuda::CUDAComplex(&alpha), cuda::CUDAComplex(cuda::CUDAMemory(x)), incx,
                        cuda::CUDAComplex(cuda::CUDAMemoryMutable(y)), incy);
}
...
bool CUDABlas::DoBlasCopy(Stream *stream, uint64 elem_count,
  ...
  return DoBlasInternal(wrap::cublasCcopy, stream,
                        true /* = pointer_mode_host */, elem_count,
                        cuda::CUDAComplex(cuda::CUDAMemory(x)), incx,
                        cuda::CUDAComplex(cuda::CUDAMemoryMutable(y)), incy);
}
...
bool CUDABlas::DoBlasDot(Stream *stream, uint64 elem_count,
  ...
  return DoBlasInternal(
      ...
      cuda::CUDAMemory(x), incx, cuda::CUDAMemory(y), incy, cuda::CUDAMemoryMutable(result));
}
...
bool CUDABlas::DoBlasDotc(Stream *stream, uint64 elem_count,
  ...
  return DoBlasInternal(
      ...
      cuda::CUDAComplex(cuda::CUDAMemory(x)), incx, cuda::CUDAComplex(cuda::CUDAMemory(y)), incy,
      cuda::CUDAComplex(cuda::CUDAMemoryMutable(result)));
}
...
bool CUDABlas::DoBlasRot(Stream *stream, uint64 elem_count,
  ...
  return DoBlasInternal(
      ...
      cuda::CUDAMemoryMutable(x), incx, cuda::CUDAMemoryMutable(y), incy, &c, &s);
}
...
bool CUDABlas::DoBlasRot(Stream *stream, uint64 elem_count,
  ...
  return DoBlasInternal(wrap::cublasCsrot, stream,
                        true /* = pointer_mode_host */, elem_count,
                        cuda::CUDAComplex(cuda::CUDAMemoryMutable(x)), incx,
                        cuda::CUDAComplex(cuda::CUDAMemoryMutable(y)), incy, &c, &s);
}
...
bool CUDABlas::DoBlasRotg(Stream *stream, DeviceMemory<float> *a,
  ...
  return DoBlasInternal(wrap::cublasSrotg, stream,
                        false /* = pointer_mode_host */, cuda::CUDAMemoryMutable(a),
                        cuda::CUDAMemoryMutable(b), cuda::CUDAMemoryMutable(c),
                        cuda::CUDAMemoryMutable(s));
}
...
bool CUDABlas::DoBlasRotg(Stream *stream, DeviceMemory<double> *a,
  ...
  return DoBlasInternal(wrap::cublasDrotg, stream,
                        ...
                        cuda::CUDAComplex(cuda::CUDAMemoryMutable(a)), cuda::CUDAMemoryMutable(b),
                        cuda::CUDAMemoryMutable(c), cuda::CUDAMemoryMutable(s));
}
...
bool CUDABlas::DoBlasRotg(Stream *stream, DeviceMemory<std::complex<float>> *a,
  ...
  return DoBlasInternal(
      ...
      cuda::CUDAComplex(cuda::CUDAMemoryMutable(a)), cuda::CUDAComplex(cuda::CUDAMemoryMutable(b)),
      cuda::CUDAComplex(cuda::CUDAMemoryMutable(c)), cuda::CUDAComplex(cuda::CUDAMemoryMutable(s)));
}
...
bool CUDABlas::DoBlasRotm(Stream *stream, uint64 elem_count,
  ...
  return DoBlasInternal(wrap::cublasSrotm, stream,
                        false /* = pointer_mode_host */, elem_count,
                        cuda::CUDAMemoryMutable(x), incx, cuda::CUDAMemoryMutable(y), incy,
                        cuda::CUDAMemory(param));
}
...
bool CUDABlas::DoBlasRotmg(Stream *stream, DeviceMemory<float> *d1,
  ...
  return DoBlasInternal(wrap::cublasSrotmg, stream,
                        false /* = pointer_mode_host */, cuda::CUDAMemoryMutable(d1),
                        cuda::CUDAMemoryMutable(d2), cuda::CUDAMemoryMutable(x1),
                        cuda::CUDAMemory(y1), cuda::CUDAMemoryMutable(param));
}
...
bool CUDABlas::DoBlasScal(Stream *stream, uint64 elem_count, float alpha,
  ...
  return DoBlasInternal(
      ...
      cuda::CUDAComplex(&alpha), cuda::CUDAComplex(cuda::CUDAMemoryMutable(x)), incx);
}
...
bool CUDABlas::DoBlasGbmv(Stream *stream, blas::Transpose trans, uint64 m,
  ...
  return DoBlasInternal(
      ...
      CUDABlasTranspose(trans), m, n, kl, ku, &alpha, cuda::CUDAMemory(a), lda,
      cuda::CUDAMemory(x), incx, &beta, cuda::CUDAMemoryMutable(y), incy);
}
...
bool CUDABlas::DoBlasGbmv(Stream *stream, blas::Transpose trans, uint64 m,
  ...
  return DoBlasInternal(
      ...
      CUDABlasTranspose(trans), m, n, kl, ku, cuda::CUDAComplex(&alpha),
      cuda::CUDAComplex(cuda::CUDAMemory(a)), lda, cuda::CUDAComplex(cuda::CUDAMemory(x)), incx,
      cuda::CUDAComplex(&beta), cuda::CUDAComplex(cuda::CUDAMemoryMutable(y)), incy);
}
...
bool CUDABlas::DoBlasGemv(Stream *stream, blas::Transpose trans, uint64 m,
  ...
  return DoBlasInternal(
      ...
      CUDABlasTranspose(trans), m, n, &alpha, cuda::CUDAMemory(a), lda, cuda::CUDAMemory(x),
      incx, &beta, cuda::CUDAMemoryMutable(y), incy);
}
...
bool CUDABlas::DoBlasGemv(Stream *stream, blas::Transpose trans, uint64 m,
  ...
  return DoBlasInternal(
      ...
      CUDABlasTranspose(trans), m, n, cuda::CUDAComplex(&alpha),
      cuda::CUDAComplex(cuda::CUDAMemory(a)), lda, cuda::CUDAComplex(cuda::CUDAMemory(x)), incx,
      cuda::CUDAComplex(&beta), cuda::CUDAComplex(cuda::CUDAMemoryMutable(y)), incy);
}
...
bool CUDABlas::DoBlasGer(Stream *stream, uint64 m, uint64 n, float alpha,
  ...
  return DoBlasInternal(
      ...
      cuda::CUDAMemory(x), incx, cuda::CUDAMemory(y), incy, cuda::CUDAMemoryMutable(a), lda);
}
...
bool CUDABlas::DoBlasGerc(Stream *stream, uint64 m, uint64 n,
  ...
  return DoBlasInternal(
      ...
      cuda::CUDAComplex(&alpha), cuda::CUDAComplex(cuda::CUDAMemory(x)), incx,
      cuda::CUDAComplex(cuda::CUDAMemory(y)), incy, cuda::CUDAComplex(cuda::CUDAMemoryMutable(a)), lda);
}
...
bool CUDABlas::DoBlasHbmv(Stream *stream, blas::UpperLower uplo, uint64 n,
  ...
  return DoBlasInternal(
      ...
      CUDABlasUpperLower(uplo), n, k, cuda::CUDAComplex(&alpha),
      cuda::CUDAComplex(cuda::CUDAMemory(a)), lda, cuda::CUDAComplex(cuda::CUDAMemory(x)), incx,
      cuda::CUDAComplex(&beta), cuda::CUDAComplex(cuda::CUDAMemoryMutable(y)), incy);
}
...
bool CUDABlas::DoBlasHemv(Stream *stream, blas::UpperLower uplo, uint64 n,
  ...
  return DoBlasInternal(
      ...
      CUDABlasUpperLower(uplo), n, cuda::CUDAComplex(&alpha),
      cuda::CUDAComplex(cuda::CUDAMemory(a)), lda, cuda::CUDAComplex(cuda::CUDAMemory(x)), incx,
      cuda::CUDAComplex(&beta), cuda::CUDAComplex(cuda::CUDAMemoryMutable(y)), incy);
}
...
bool CUDABlas::DoBlasHer(Stream *stream, blas::UpperLower uplo, uint64 n,
  ...
  return DoBlasInternal(
      ...
      CUDABlasUpperLower(uplo), n, &alpha, cuda::CUDAComplex(cuda::CUDAMemory(x)), incx,
      cuda::CUDAComplex(cuda::CUDAMemoryMutable(a)), lda);
}
...
bool CUDABlas::DoBlasHpmv(Stream *stream, blas::UpperLower uplo, uint64 n,
  ...
  return DoBlasInternal(
      ...
      CUDABlasUpperLower(uplo), n, cuda::CUDAComplex(&alpha),
      cuda::CUDAComplex(cuda::CUDAMemory(ap)), cuda::CUDAComplex(cuda::CUDAMemory(x)), incx,
      cuda::CUDAComplex(&beta), cuda::CUDAComplex(cuda::CUDAMemoryMutable(y)), incy);
}
...
bool CUDABlas::DoBlasHpr(Stream *stream, blas::UpperLower uplo, uint64 n,
  ...
  return DoBlasInternal(
      ...
      CUDABlasUpperLower(uplo), n, cuda::CUDAComplex(&alpha),
      cuda::CUDAComplex(cuda::CUDAMemory(x)), incx, cuda::CUDAComplex(cuda::CUDAMemoryMutable(ap)));
}
...
bool CUDABlas::DoBlasHpr2(Stream *stream, blas::UpperLower uplo, uint64 n,
  ...
  return DoBlasInternal(
      ...
      CUDABlasUpperLower(uplo), n, cuda::CUDAComplex(&alpha),
      cuda::CUDAComplex(cuda::CUDAMemory(x)), incx, cuda::CUDAComplex(cuda::CUDAMemory(y)), incy,
      cuda::CUDAComplex(cuda::CUDAMemoryMutable(ap)));
}
...
bool CUDABlas::DoBlasSbmv(Stream *stream, blas::UpperLower uplo, uint64 n,
  ...
  return DoBlasInternal(
      ...
      CUDABlasUpperLower(uplo), n, k, &alpha, cuda::CUDAMemory(a), lda, cuda::CUDAMemory(x),
      incx, &beta, cuda::CUDAMemoryMutable(y), incy);
}
...
bool CUDABlas::DoBlasSpmv(Stream *stream, blas::UpperLower uplo, uint64 n,
  ...
  return DoBlasInternal(wrap::cublasSspmv, stream,
                        ...
                        CUDABlasUpperLower(uplo), n, &alpha, cuda::CUDAMemory(ap),
                        cuda::CUDAMemory(x), incx, &beta, cuda::CUDAMemoryMutable(y), incy);
}
...
bool CUDABlas::DoBlasSpr(Stream *stream, blas::UpperLower uplo, uint64 n,
  ...
  return DoBlasInternal(wrap::cublasSspr, stream,
                        true /* = pointer_mode_host */,
                        CUDABlasUpperLower(uplo), n, &alpha, cuda::CUDAMemory(x),
                        incx, cuda::CUDAMemoryMutable(ap));
}
...
bool CUDABlas::DoBlasSpr2(Stream *stream, blas::UpperLower uplo, uint64 n,
  ...
  return DoBlasInternal(wrap::cublasSspr2, stream,
                        true /* = pointer_mode_host */,
                        CUDABlasUpperLower(uplo), n, &alpha, cuda::CUDAMemory(x),
                        incx, cuda::CUDAMemory(y), incy, cuda::CUDAMemoryMutable(ap));
}
...
bool CUDABlas::DoBlasSymv(Stream *stream, blas::UpperLower uplo, uint64 n,
  ...
  return DoBlasInternal(wrap::cublasSsymv, stream,
                        true /* = pointer_mode_host */,
                        CUDABlasUpperLower(uplo), n, &alpha, cuda::CUDAMemory(a), lda,
                        cuda::CUDAMemory(x), incx, &beta, cuda::CUDAMemoryMutable(y), incy);
}
...
bool CUDABlas::DoBlasSyr(Stream *stream, blas::UpperLower uplo, uint64 n,
  ...
  return DoBlasInternal(wrap::cublasSsyr, stream,
                        true /* = pointer_mode_host */,
                        CUDABlasUpperLower(uplo), n, &alpha, cuda::CUDAMemory(x),
                        incx, cuda::CUDAMemoryMutable(a), lda);
}
...
bool CUDABlas::DoBlasSyr2(Stream *stream, blas::UpperLower uplo, uint64 n,
  ...
  return DoBlasInternal(wrap::cublasSsyr2, stream,
                        true /* = pointer_mode_host */,
                        CUDABlasUpperLower(uplo), n, &alpha, cuda::CUDAMemory(x),
                        incx, cuda::CUDAMemory(y), incy, cuda::CUDAMemoryMutable(a), lda);
}
...
bool CUDABlas::DoBlasTbmv(Stream *stream, blas::UpperLower uplo,
  ...
  return DoBlasInternal(wrap::cublasStbmv, stream,
                        ...
                        CUDABlasDiagonal(diag), n, k, cuda::CUDAMemory(a), lda,
                        cuda::CUDAMemoryMutable(x), incx);
}
...
bool CUDABlas::DoBlasTbmv(Stream *stream, blas::UpperLower uplo,
  ...
  return DoBlasInternal(
      ...
      CUDABlasUpperLower(uplo), CUDABlasTranspose(trans),
      CUDABlasDiagonal(diag), n, k, cuda::CUDAComplex(cuda::CUDAMemory(a)), lda,
      cuda::CUDAComplex(cuda::CUDAMemoryMutable(x)), incx);
}
...
bool CUDABlas::DoBlasTpmv(Stream *stream, blas::UpperLower uplo,
  ...
  return DoBlasInternal(
      ...
      CUDABlasUpperLower(uplo), CUDABlasTranspose(trans),
      CUDABlasDiagonal(diag), n, cuda::CUDAMemory(ap), cuda::CUDAMemoryMutable(x), incx);
}
...
bool CUDABlas::DoBlasTpmv(Stream *stream, blas::UpperLower uplo,
  ...
  return DoBlasInternal(wrap::cublasCtpmv, stream,
                        true /* = pointer_mode_host */,
                        CUDABlasUpperLower(uplo), CUDABlasTranspose(trans),
                        CUDABlasDiagonal(diag), n, cuda::CUDAComplex(cuda::CUDAMemory(ap)),
                        cuda::CUDAComplex(cuda::CUDAMemoryMutable(x)), incx);
}
...
bool CUDABlas::DoBlasTrmv(Stream *stream, blas::UpperLower uplo,
  ...
  return DoBlasInternal(wrap::cublasStrmv, stream,
                        true /* = pointer_mode_host */,
                        CUDABlasUpperLower(uplo), CUDABlasTranspose(trans),
                        CUDABlasDiagonal(diag), n, cuda::CUDAMemory(a), lda,
                        cuda::CUDAMemoryMutable(x), incx);
}
...
bool CUDABlas::DoBlasTrmv(Stream *stream, blas::UpperLower uplo,
  ...
  return DoBlasInternal(wrap::cublasCtrmv, stream,
                        true /* = pointer_mode_host */,
                        CUDABlasUpperLower(uplo), CUDABlasTranspose(trans),
                        CUDABlasDiagonal(diag), n, cuda::CUDAComplex(cuda::CUDAMemory(a)),
                        lda, cuda::CUDAComplex(cuda::CUDAMemoryMutable(x)), incx);
}
...
bool CUDABlas::DoBlasGemm(
  ...
  return DoBlasInternalImpl(
      ...
      CUDABlasTranspose(transb), m, n, k, &alpha, cuda::CUDAMemory(a),
      SE_CUDA_DATA_HALF, lda, cuda::CUDAMemory(b), SE_CUDA_DATA_HALF, ldb, &beta,
      cuda::CUDAMemoryMutable(c), SE_CUDA_DATA_HALF, ldc);
...
bool CUDABlas::DoBlasGemm(Stream *stream, blas::Transpose transa,
  ...
  return DoBlasInternal(
      ...
      cuda::CUDAMemory(a), lda, cuda::CUDAMemory(b), ldb, &beta, cuda::CUDAMemoryMutable(c), ldc);
}
...
bool CUDABlas::DoBlasGemm(Stream *stream, blas::Transpose transa,
  ...
  return DoBlasInternal(
      ...
      cuda::CUDAComplex(&alpha), cuda::CUDAComplex(cuda::CUDAMemory(a)), lda,
      cuda::CUDAComplex(cuda::CUDAMemory(b)), ldb, cuda::CUDAComplex(&beta),
      cuda::CUDAComplex(cuda::CUDAMemoryMutable(c)), ldc);
}
...
bool CUDABlas::DoBlasGemmWithAlgorithmImpl(
  ...
  bool result = DoBlasInternalFailureOK(
      ...
      CUDABlasTranspose(transa), CUDABlasTranspose(transb), m, n, k,
      alpha.is_pointer() ? cuda::CUDAMemory(alpha.pointer()) : &alpha.value(),
      cuda::CUDAMemory(a), cuda_in_type, lda, cuda::CUDAMemory(b), cuda_in_type, ldb,
      beta.is_pointer() ? cuda::CUDAMemory(beta.pointer()) : &beta.value(),
      cuda::CUDAMemoryMutable(c), CUDADataType<OutT>::type, ldc,
...
port::Status CUDABlas::DoBlasGemmBatchedInternal(
  ...
  typedef typename HalfAsFloat<typename cuda::CUDAComplexT<T>::type>::type CUDA_T;
  ...
  if (stream->parent()->GetDeviceDescription().cuda_compute_capability(
    ...
    const void **a_void_ptrs = reinterpret_cast<const void **>(
        const_cast<const CUDA_T **>(cuda::CUDAMemory(a)));
    const void **b_void_ptrs = reinterpret_cast<const void **>(
        const_cast<const CUDA_T **>(cuda::CUDAMemory(b)));
    void **c_void_ptrs =
        reinterpret_cast<void **>(const_cast<CUDA_T **>(cuda::CUDAMemory(c)));
    bool ok;
  ...
  if (data_type != CUDA_R_16F) {
    bool ok = DoBlasInternal(
        ...
        CUDABlasTranspose(transa), CUDABlasTranspose(transb), m, n, k,
        cuda::CUDAComplex(&alpha), const_cast<const CUDA_T **>(cuda::CUDAMemory(a)), lda,
        const_cast<const CUDA_T **>(cuda::CUDAMemory(b)), ldb, cuda::CUDAComplex(&beta),
        const_cast<CUDA_T **>(cuda::CUDAMemory(c)), ldc, batch_count);
    if (ok) {
      return port::Status::OK();
    }
    return port::Status(port::error::INTERNAL,
...
bool CUDABlas::DoBlasGemmStridedBatched(
  ...
  if (stream->parent()->GetDeviceDescription().cuda_compute_capability(
    ...
    if (cc_major >= 5) {
      ...
      bool ok = DoBlasInternalImpl(
          ...
          m, n, k, &alpha, cuda::CUDAMemory(a), CUDA_R_16F, lda, stride_a,
          cuda::CUDAMemory(b), CUDA_R_16F, ldb, stride_b, &beta, cuda::CUDAMemoryMutable(c),
  ...
  for (int batch = 0; batch < batch_count; ++batch) {
    const auto *a_matrix =
        reinterpret_cast<const __half *>(cuda::CUDAMemory(a) + batch * stride_a);
    const auto *b_matrix =
        reinterpret_cast<const __half *>(cuda::CUDAMemory(b) + batch * stride_b);
    auto *c_matrix =
        reinterpret_cast<__half *>(cuda::CUDAMemoryMutable(c) + batch * stride_c);
    bool ok = DoBlasInternalImpl(
        wrap::cublasSgemmEx, stream, true /* = pointer_mode_host */,
        true /* = err_on_failure= */, use_tensor_ops, CUDABlasTranspose(transa),
...
bool CUDABlas::DoBlasGemmStridedBatched(
  ...
  return DoBlasInternal(
      ...
      CUDABlasTranspose(transa), CUDABlasTranspose(transb), m, n, k, &alpha,
      cuda::CUDAMemory(a), lda, stride_a, cuda::CUDAMemory(b), ldb, stride_b, &beta,
      cuda::CUDAMemoryMutable(c), ldc, stride_c, batch_count);
}
...
bool CUDABlas::DoBlasGemmStridedBatched(
  ...
  return DoBlasInternal(
      ...
      CUDABlasTranspose(transa), CUDABlasTranspose(transb), m, n, k,
      cuda::CUDAComplex(&alpha), cuda::CUDAComplex(cuda::CUDAMemory(a)), lda, stride_a,
      cuda::CUDAComplex(cuda::CUDAMemory(b)), ldb, stride_b, cuda::CUDAComplex(&beta),
      cuda::CUDAComplex(cuda::CUDAMemoryMutable(c)), ldc, stride_c, batch_count);
}
...
bool CUDABlas::DoBlasHemm(Stream *stream, blas::Side side,
  ...
  return DoBlasInternal(
      ...
      CUDABlasSide(side), CUDABlasUpperLower(uplo), m, n, cuda::CUDAComplex(&alpha),
      cuda::CUDAComplex(cuda::CUDAMemory(a)), lda, cuda::CUDAComplex(cuda::CUDAMemory(b)), ldb,
      cuda::CUDAComplex(&beta), cuda::CUDAComplex(cuda::CUDAMemoryMutable(c)), ldc);
}
...
bool CUDABlas::DoBlasHerk(Stream *stream, blas::UpperLower uplo,
  ...
  return DoBlasInternal(wrap::cublasCherk, stream,
                        ...
                        k, cuda::CUDAComplex(&alpha), cuda::CUDAComplex(cuda::CUDAMemory(a)), lda,
                        &beta, cuda::CUDAComplex(cuda::CUDAMemoryMutable(c)), ldc);
}
...
bool CUDABlas::DoBlasHer2k(Stream *stream, blas::UpperLower uplo,
  ...
  return DoBlasInternal(wrap::cublasCher2k, stream,
                        ...
                        CUDABlasUpperLower(uplo), CUDABlasTranspose(trans), n,
                        k, cuda::CUDAComplex(&alpha), cuda::CUDAComplex(cuda::CUDAMemory(a)), lda,
                        cuda::CUDAComplex(cuda::CUDAMemory(b)), ldb, &beta,
                        cuda::CUDAComplex(cuda::CUDAMemoryMutable(c)), ldc);
}
...
bool CUDABlas::DoBlasSymm(Stream *stream, blas::Side side,
  ...
  return DoBlasInternal(
      ...
      CUDABlasSide(side), CUDABlasUpperLower(uplo), m, n, &alpha, cuda::CUDAMemory(a),
      lda, cuda::CUDAMemory(b), ldb, &beta, cuda::CUDAMemoryMutable(c), ldc);
}
...
bool CUDABlas::DoBlasSyrk(Stream *stream, blas::UpperLower uplo,
  ...
  return DoBlasInternal(
      ...
      cuda::CUDAMemory(a), lda, &beta, cuda::CUDAMemoryMutable(c), ldc);
}
...
bool CUDABlas::DoBlasSyrk(Stream *stream, blas::UpperLower uplo,
  ...
  return DoBlasInternal(
      ...
      cuda::CUDAComplex(&alpha), cuda::CUDAComplex(cuda::CUDAMemory(a)), lda, cuda::CUDAComplex(&beta),
      cuda::CUDAComplex(cuda::CUDAMemoryMutable(c)), ldc);
}
...
bool CUDABlas::DoBlasTrmm(Stream *stream, blas::Side side,
  ...
  return DoBlasInternal(
      ...
      CUDABlasDiagonal(diag), m, n, &alpha, cuda::CUDAMemory(a), lda,
      cuda::CUDAMemoryMutable(b), ldb, cuda::CUDAMemoryMutable(b), ldb);
}
...
bool CUDABlas::DoBlasTrmm(Stream *stream, blas::Side side,
  ...
  return DoBlasInternal(
      ...
      CUDABlasSide(side), CUDABlasUpperLower(uplo), CUDABlasTranspose(transa),
      CUDABlasDiagonal(diag), m, n, cuda::CUDAComplex(&alpha),
      cuda::CUDAComplex(cuda::CUDAMemory(a)), lda, cuda::CUDAComplex(cuda::CUDAMemoryMutable(b)), ldb,
      cuda::CUDAComplex(cuda::CUDAMemoryMutable(b)), ldb);
}
...
bool CUDABlas::DoBlasTrsm(Stream *stream, blas::Side side,
  ...
  return DoBlasInternal(wrap::cublasStrsm, stream,
                        ...
                        CUDABlasDiagonal(diag), m, n, &alpha, cuda::CUDAMemory(a),
                        lda, cuda::CUDAMemoryMutable(b), ldb);
}
