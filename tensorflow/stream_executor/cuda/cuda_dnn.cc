...
port::Status CudnnSupport::DoConvolve(
  ...
  CudnnTensorDescriptor output_nd(output_descriptor, ToCudnnDataType(output_type));
...
template <typename ElementType, typename BiasType, typename ScaleType, typename OutputType>
