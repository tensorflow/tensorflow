...
def TestOneInput(data):
  ...
  # tf.raw_ops.Acos takes bfloat16, half, float32, float64, complex64,
  # complex128, but get_random_numeric_tensor only generates tf.float16,
  # tf.float32, tf.float64, tf.int32, tf.int64. We test the intersection.
  dtype = fh.get_tf_dtype([tf.float32, tf.float64])
