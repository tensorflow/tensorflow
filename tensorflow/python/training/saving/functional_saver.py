...
class _SingleDeviceSaver(object):
    ...
    def restore(self, file_prefix, options=None):
        ...
        restore_ops = {}
        for saveable, restored_tensors in zip(
            self._saveable_objects, structured_restored_tensors
        ):
...
class MultiDeviceSaver(object):
    ...
    def __init__(
        self, saveable_objects, registered_savers=None, call_with_mapped_captures=None
    ):
        """Specify a list of `SaveableObject`s to save and restore.
