...
class Optimizer(
    ...
    def __init__(self, use_locking, name, use_own_namescope_for_non_slot_vars=False):
    ...
    def apply_gradients(
        ...
        with ops.name_scope(name, self._name, skip_on_eager=False) as name:
            ...
            for grad, var, processor in converted_grads_and_vars:
                ...
                with (
                    ops.name_scope("update_" + scope_name, skip_on_eager=False),
    ...
    def _trackable_children(self, save_type=trackable.SaveType.CHECKPOINT, **kwargs):
        ...
        for (name, _), variable_object in sorted(
            ...
            if (
                context.executing_eagerly()
                or variable_object._graph_key == current_graph_key
            ):  # pylint: disable=protected-access
