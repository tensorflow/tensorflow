...
class CapturableResource(six.with_metaclass(_ResourceMetaclass, base.Trackable)):
...
class RestoredResource(TrackableResource):
    ...
    def _add_trackable_child(self, name, value):
        ...
        if isinstance(value, base.Trackable) and not isinstance(
            value, def_function.Function
        ):
