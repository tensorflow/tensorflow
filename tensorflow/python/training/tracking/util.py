...
class _CheckpointRestoreCoordinator(object):
    ...
    def restore_saveables(
        self, tensor_saveables, python_saveables, registered_savers=None
    ):
        ...
        if tensor_saveables or registered_savers:
            ...
            new_restore_ops = functional_saver.MultiDeviceSaver(
                validated_saveables, registered_savers
...
def add_variable(
    ...
    return (
        trackable._add_variable_with_custom_getter(  # pylint: disable=protected-access
            name=name,
            shape=shape,
            dtype=dtype,
...
class TrackableSaver(object):
    ...
    def _save_cached_when_graph_building(
        ...
        (
            ...
            feed_additions,
            registered_savers,
        ) = self._gather_saveables(object_graph_tensor=object_graph_tensor)
        if (
...
def frozen_saver(root_trackable):
    ...
    return functional_saver.MultiDeviceSaver(named_saveable_objects, registered_savers)
