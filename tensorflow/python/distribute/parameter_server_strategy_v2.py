...
from tensorflow.python.distribute.cluster_resolver import (
    cluster_resolver as base_cluster_resolver,
)
...
class ParameterServerStrategyV2(distribute_lib.Strategy):
    ...
    * When using `Model.fit`, `tf.distribute.experimental.ParameterServerStrategy`
    ...
    def __init__(
        ...
        variable_partitioner: sharded_variable.Partitioner = None,
    ):
    ...
    def _configure_coordination_service(
        self, cluster_spec: base_cluster_resolver.ClusterSpec
    ):
        if context.context().coordination_service is None:
            ...
            context.context().configure_coordination_service(
                ...
                service_leader=multi_worker_util.coordination_leader(cluster_spec),
    ...
    def _verify_args_and_config(
        self, cluster_resolver: base_cluster_resolver.ClusterResolver
    ):
