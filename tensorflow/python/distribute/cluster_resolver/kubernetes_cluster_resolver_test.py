...
from tensorflow.python.distribute.cluster_resolver.kubernetes_cluster_resolver import (
    ExecutableLocation,
)
from tensorflow.python.distribute.cluster_resolver.kubernetes_cluster_resolver import (
...
def _mock_kubernetes_client(ret):
    ...
    mock_client.list_pod_for_all_namespaces.side_effect = lambda *args, **kwargs: ret[
...
class KubernetesClusterResolverTest(test.TestCase):
    ...
    def testNonRunningPod(self):
        ret = _create_pod_list(
            ("tensorflow-abc123", "Failed", "10.1.2.3"),
        )
