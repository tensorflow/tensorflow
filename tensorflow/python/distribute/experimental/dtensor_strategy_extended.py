...
class DTensorStrategyExtended(distribute_lib.StrategyExtendedV2):
    ...
    def _experimental_distribute_dataset(self, dataset, options):
        ...
        if batch_size.numpy() < 0:
            ...
            raise ValueError(
                "DTensor strategy requires a static batch size for now."
    ...
    def _experimental_distribute_values_from_function(self, value_fn):
        ...
        map_fn = functools.partial(
            dtensor_util.convert_per_replica_to_dtensor, mesh=self._mesh
        )
    ...
    def call_for_each_replica(self, fn, args=(), kwargs=None):
        ...
        map_fn = functools.partial(
            dtensor_util.convert_inputs_to_dtensor, mesh=self._mesh
        )
