...
def checkpoint_test_helper(
    dvar_test, distribution, synchronization, aggregation, enable_async_ckpt
):
...
class DistributedVariableTest(test.TestCase, parameterized.TestCase):
    ...
    def testCheckpointing(self, distribution, synchronization, aggregation, mode):
        ...
        checkpoint_test_helper(
            self, distribution, synchronization, aggregation, enable_async_ckpt=False
        )
    ...
    def testAsyncCheckpointing(self, distribution, synchronization, aggregation, mode):
        ...
        checkpoint_test_helper(
            self, distribution, synchronization, aggregation, enable_async_ckpt=True
        )
