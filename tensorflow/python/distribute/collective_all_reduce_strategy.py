...
class CollectiveAllReduceStrategy(distribute_lib.Strategy):
    ...
    * In eager mode, the strategy needs to be created before calling any other
    ...
    def __init__(self, cluster_resolver=None, communication_options=None):
        ...
        distribute_lib.distribution_strategy_replica_gauge.get_cell("num_workers").set(
            self.extended._num_workers
        )
    ...
    def _from_local_devices(cls, devices, communication_options=None):
        ...
        obj.extended._initialize_local(
            TFConfigClusterResolver(), devices=devices
        )  # pylint: disable=protected-access
        return obj
...
class _CollectiveAllReduceStrategyExperimental(
    CollectiveAllReduceStrategy, metaclass=_CollectiveAllReduceStrategyExperimentalMeta
):
    ...
    def _from_local_devices(
        cls, devices, communication=collective_util.CommunicationImplementation.AUTO
    ):
        """A convenience method to create an object with a list of devices."""
...
@tf_export(
    v1=["distribute.experimental.MultiWorkerMirroredStrategy"]
...
class CollectiveAllReduceExtended(mirrored_strategy.MirroredExtended):
    ...
    def __init__(self, container_strategy, cluster_resolver, communication_options):
        ...
        self._collective_key_base = (
            container_strategy._collective_key_base
        )  # pylint: disable=protected-access
    ...
    def _get_variable_creator_initial_value(
        ...
        if replica_id == 0:  # First replica on each worker.
            ...
            return super(
                ...
                replica_id=replica_id, device=device, primary_var=primary_var, **kwargs
            )
    ...
    def _make_input_fn_iterator(
        ...
        return input_lib_v1.InputFunctionIterator(
            input_fn, self._input_workers, [input_context], self._container_strategy()
        )
