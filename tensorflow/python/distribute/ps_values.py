...
class DistributedTable(lookup_ops.StaticHashTable):
    ...
    def resource_handle_call_time_value(self):
        ...
        def closure():
            ...
            if dispatch_context:
                remote_value = (
                    self._distributed_table._values[  # pylint: disable=protected-access
...
class RestoredDistributedTable(DistributedTable):
    ...
    def _create_resource(self):
        ...
        return (
            self._coordinator_instance._create_resource()
        )  # pylint: disable=protected-access

    def _initialize(self):
        """A function that initializes the resource."""
        return (
            self._coordinator_instance._initialize()
        )  # pylint: disable=protected-access

    def _destroy_resource(self):
        """A function that destroys the resource."""
        return (
            self._coordinator_instance._destroy_resource()
        )  # pylint: disable=protected-access
