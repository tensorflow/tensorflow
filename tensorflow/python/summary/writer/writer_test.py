...
class FileWriterTestBase:
    ...
    def testAddingSummaryGraphAndRunMetadata(self):
        ...
        sw.add_summary(
            summary_pb2.Summary(
                value=[summary_pb2.Summary.Value(tag="mee", simple_value=10.0)]
            ),
            10,
        )
        sw.add_summary(
            summary_pb2.Summary(
                value=[summary_pb2.Summary.Value(tag="boo", simple_value=20.0)]
            ),
            20,
        )
    ...
    def testAddingSummariesFromSessionRunCalls(self):
        ...
        with self.cached_session():
            ...
            summ = summary_pb2.Summary(
                value=[summary_pb2.Summary.Value(tag="i", simple_value=1.0)]
            )
...
class FileWriterTestCase(FileWriterTestBase, test.TestCase):
    ...
    def testWriterException_raisedFromFlush(self):
        ...
        with test.mock.patch.object(
            writer_thread, "_ev_writer", autospec=True
        ) as mock_writer:
