...
PYBIND11_MODULE(_pywrap_toco_api, m) {
  m.def(
      "TocoConvert",
      [](const py::object& model_flags_proto_txt_raw,
         const py::object& toco_flags_proto_txt_raw,
         const py::object& input_contents_txt_raw, bool extended_return) {
      ...
      py::arg("toco_flags_proto_txt_raw"),
      py::arg("input_contents_txt_raw"),
      py::arg("extended_return") = false,
      R"pbdoc(
