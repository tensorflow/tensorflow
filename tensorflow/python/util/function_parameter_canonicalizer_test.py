...
class FunctionParameterCanonicalizerTest(test.TestCase):
    def setUp(self):
        ...
        self._matmul_func = _function_parameter_canonicalizer_binding_for_test.FunctionParameterCanonicalizer(
            [
                "a",
                "b",
                "transpose_a",
    ...
    def testPosAndKwd(self):
        self.assertEqual(
            self._matmul_func.canonicalize(2, 3, transpose_a=True, name="my_matmul"),
    ...
    def testTooManyArgs(self):
        with self.assertRaisesRegex(
            TypeError, "Too many arguments were given. Expected 9 but got 10."
        ):
    ...
    def testKwargNotInterned(self):
        func = _function_parameter_canonicalizer_binding_for_test.FunctionParameterCanonicalizer(
            ["long_parameter_name"], ()
        )
