...
class TfInspectTest(test.TestCase):
    ...
    def testGetArgSpecOnPartialWithDecoratorThatChangesArgspec(self):
        ...
        signature = inspect.Signature(
            [
                inspect.Parameter("a", inspect.Parameter.KEYWORD_ONLY, default=2),
                inspect.Parameter("b", inspect.Parameter.KEYWORD_ONLY, default=1),
                inspect.Parameter("c", inspect.Parameter.KEYWORD_ONLY, default="hello"),
            ]
        )
