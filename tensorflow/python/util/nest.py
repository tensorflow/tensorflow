...
STRUCTURES_HAVE_MISMATCHING_LENGTHS = nest_util.STRUCTURES_HAVE_MISMATCHING_LENGTHS
...
INPUT_TREE_SMALLER_THAN_SHALLOW_TREE = nest_util.INPUT_TREE_SMALLER_THAN_SHALLOW_TREE
...
def flatten(structure, expand_composites=False):
    ...
    """
    return nest_util.flatten(nest_util.Modality.CORE, structure, expand_composites)
...
def map_structure(func, *structure, **kwargs):
    ...
    * Type check is set to False:
    ...
    """
    return nest_util.map_structure(nest_util.Modality.CORE, func, *structure, **kwargs)
