...
class ValidateExportTest(test.TestCase):
    ...
    def testExportClassInEstimator(self):
        ...
        self.assertEqual(("TestClassA1",), TestClassA._tf_api_names)
        self.assertEqual(["TestClassA1"], tf_export.get_v1_names(TestClassA))
        self.assertEqual(["estimator.TestClassB1"], tf_export.get_v1_names(TestClassB))
    ...
    def testExportSingleConstant(self):
        ...
        self.assertEqual(
            [(("NAME_A", "NAME_B"), "test_constant")], module1._tf_api_constants
        )
        self.assertEqual(
            [(("NAME_A", "NAME_B"), "test_constant")],
    ...
    def testExportMultipleConstants(self):
        ...
        self.assertEqual(
            [(("NAME_C", "NAME_D"), "abc"), (("NAME_E", "NAME_F"), 0.5)],
