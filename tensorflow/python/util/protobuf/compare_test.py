...
class ProtoEqTest(googletest.TestCase):
    ...
    def testMessage(self):
        ...
        self.assertEqual(
            'string_: "a" small < strings: "a" >', 'string_: "a" small < strings: "a" >'
        )
        self.assertNotEquals(
            'string_: "a" small < strings: "a" >', 'int64_: 1 small < strings: "a" >'
        )
    ...
    def testNestedMessage(self):
        ...
        self.assertEqual(
            "medium < smalls <> smalls <> >", "medium < smalls <> smalls <> >"
        )
    ...
    def testTagOrder(self):
        ...
        self.assertNotEquals(
            'string_: "a" int64_: 2            ', "             int64_: 1            "
        )
        self.assertNotEquals(
            'string_: "b" int64_: 1            ', 'string_: "a" int64_: 2            '
        )
        self.assertEqual(
            'string_: "a" int64_: 1            ', 'string_: "a" int64_: 1            '
        )
        self.assertNotEquals(
            'string_: "a" int64_: 1 float_: 0.0', 'string_: "a" int64_: 1            '
        )
        self.assertEqual(
            'string_: "a" int64_: 1 float_: 0.0', 'string_: "a" int64_: 1 float_: 0.0'
        )
        self.assertNotEquals(
            'string_: "a" int64_: 1 float_: 0.1', 'string_: "a" int64_: 1 float_: 0.0'
        )
        self.assertNotEquals(
            'string_: "a" int64_: 2 float_: 0.0', 'string_: "a" int64_: 1 float_: 0.1'
        )
        self.assertNotEquals(
            'string_: "a"                      ', "             int64_: 1 float_: 0.1"
        )
        self.assertNotEquals(
            'string_: "a"           float_: 0.0', "             int64_: 1            "
        )
        self.assertNotEquals(
            'string_: "b"           float_: 0.0', 'string_: "a" int64_: 1            '
        )
        ...
        self.assertNotEquals(
            'string_: "a" small < strings: "b" >', 'string_: "a" small < strings: "a" >'
        )
        self.assertEqual(
            'string_: "a" small < strings: "a" >', 'string_: "a" small < strings: "a" >'
        )
        ...
        self.assertNotEquals(
            'string_: "a" medium < smalls <> >', 'string_: "a" small < strings: "a" >'
        )
...
class AssertTest(googletest.TestCase):
    ...
    def assertNone(self, a, b, message, **kwargs):
        ...
        self.assertRaisesRegex(
            AssertionError, message, self.assertProtoEqual, a, b, **kwargs
        )
    ...
    def testRepeatedPrimitives(self):
        ...
        self.assertSameNotEqual(
            "int64s: 0 int64s: 1 int64s: 2", "int64s: 2 int64s: 1 int64s: 0"
        )
    ...
    def testRepeatedMessage(self):
        ...
        self.assertSameNotEqual(
            "medium: { smalls: {} }", "medium: { smalls: {} smalls: {} }"
        )
        self.assertSameNotEqual(
            "medium: { smalls: {} smalls: {} } medium: {}",
