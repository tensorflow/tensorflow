...
class OptimizerV2(trackable.Trackable):
    ...
    def get_gradients(self, loss, params):
        ...
        with (
            backend.get_graph().as_default(),
            backend.name_scope(self._name + "/gradients"),
        ):
    ...
    def _create_hypers(self):
        ...
        with self._distribution_strategy_scope():
            ...
            for name, value in sorted(self._hyper.items()):
                if isinstance(
                    value, (tensor.Tensor, tf_variables.Variable)
                ) or callable(value):
    ...
    def _create_or_restore_slot_variable(
        ...
        if (
            ...
            # variables.
            and (
                not ops.get_default_graph()._variable_creator_stack  # pylint: disable=protected-access
