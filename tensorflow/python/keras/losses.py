...
def cosine_similarity(y_true, y_pred, axis=-1):
  ...
  Note that it is a real number. When it is a negative number between -1 and 0, 0
  indicates orthogonality and values closer to -1 indicate greater similarity.
