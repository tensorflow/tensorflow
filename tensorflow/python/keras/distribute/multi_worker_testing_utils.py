...
def mnist_synthetic_dataset(batch_size, steps_per_epoch):
    ...
    # train dataset
    x_train = array_ops.ones(
        [batch_size * steps_per_epoch, 28, 28, 1], dtype=dtypes.float32
    )
    y_train = array_ops.ones([batch_size * steps_per_epoch, 1], dtype=dtypes.int32)
    ...
    y_test = random_ops.random_uniform(
        [10000, 1], minval=0, maxval=9, dtype=dtypes.int32
    )
