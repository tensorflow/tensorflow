...
keras_export(v1=["keras.initializers.Orthogonal", "keras.initializers.orthogonal"])(
    _v1_orthogonal_initializer
)
keras_export(v1=["keras.initializers.Identity", "keras.initializers.identity"])(
    _v1_identity
)
keras_export(v1=["keras.initializers.glorot_uniform"])(_v1_glorot_uniform_initializer)
keras_export(v1=["keras.initializers.glorot_normal"])(_v1_glorot_normal_initializer)
