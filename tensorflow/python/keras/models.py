...
def _clone_functional_model(model, input_tensors=None, layer_fn=_clone_layer):
    ...
    input_tensors, output_tensors, created_layers = functional.reconstruct_from_config(
...
@keras_export(
    "keras.__internal__.models.in_place_subclassed_model_state_restoration", v1=[]
)
