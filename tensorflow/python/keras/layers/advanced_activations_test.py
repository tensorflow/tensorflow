...
class AdvancedActivationsTest(keras_parameterized.TestCase):
    ...
    def test_prelu(self):
        testing_utils.layer_test(
            keras.layers.PReLU, kwargs={}, input_shape=(2, 3, 4), supports_masking=True
        )
    ...
    def test_relu_with_invalid_max_value(self):
        with self.assertRaisesRegex(
            ValueError,
            "max_value of a ReLU layer cannot be a negative " "value. Got: -10",
        ):
            testing_utils.layer_test(
                keras.layers.ReLU,
                kwargs={"max_value": -10},
    ...
    def test_relu_with_invalid_negative_slope(self):
        with self.assertRaisesRegex(
            ValueError,
            "negative_slope of a ReLU layer cannot be a negative " "value. Got: None",
        ):
            testing_utils.layer_test(
                keras.layers.ReLU,
        ...
        with self.assertRaisesRegex(
            ValueError,
            "negative_slope of a ReLU layer cannot be a negative " "value. Got: -10",
        ):
            testing_utils.layer_test(
                keras.layers.ReLU,
    ...
    def test_relu_with_invalid_threshold(self):
        with self.assertRaisesRegex(
            ValueError,
            "threshold of a ReLU layer cannot be a negative " "value. Got: None",
        ):
            testing_utils.layer_test(
                keras.layers.ReLU,
        ...
        with self.assertRaisesRegex(
            ValueError,
            "threshold of a ReLU layer cannot be a negative " "value. Got: -10",
        ):
            testing_utils.layer_test(
                keras.layers.ReLU,
                kwargs={"threshold": -10},
    ...
    def test_leaky_elu_with_invalid_alpha(self):
        ...
        with self.assertRaisesRegex(
            ValueError,
            "Alpha of an ELU layer cannot be None, " "requires a float. Got None",
        ):
            testing_utils.layer_test(
                keras.layers.ELU,
                kwargs={"alpha": None},
    ...
    def test_threshold_relu_with_invalid_theta(self):
        ...
        with self.assertRaisesRegex(
            ValueError,
            "The theta value of a Thresholded ReLU " "layer should be >=0, got -10",
        ):
            testing_utils.layer_test(
                keras.layers.ThresholdedReLU,
                kwargs={"theta": -10},
