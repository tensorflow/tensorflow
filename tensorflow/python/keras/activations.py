...
def tanhexp(x):
  ...
  It is a smooth, non-monotonic function with high convergence speed
  and with good accuracy that consistently matches or outperforms ReLU
  on lightweight (or) mobile neural networks.
