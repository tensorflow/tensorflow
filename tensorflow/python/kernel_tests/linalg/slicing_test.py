...
class SlicingTest(test.TestCase):
    ...
    def test_single_param_slice_broadcast_batch(self):
        ...
        self.assertAllEqual(
            list(
                array_ops.zeros([1, 4, 3])[
                    ..., array_ops.newaxis, 2:, array_ops.newaxis
                ].shape
            )
            + [1],
    ...
    def test_single_param_slice_broadcast_batch_leading_newaxis(self):
        ...
        expected = array_ops.zeros([1, 4, 3])[
            array_ops.newaxis, ..., array_ops.newaxis, 2:, array_ops.newaxis
        ].shape + [1]
    ...
    def test_slice_nested_operator(self):
        ...
        self.assertAllEqual(
            linop[0, ..., array_ops.newaxis].batch_shape_tensor(), [3, 5, 2, 1]
        )
        self.assertAllEqual(
            linop[..., array_ops.newaxis].batch_shape_tensor(), [4, 3, 5, 2, 1]
        )
