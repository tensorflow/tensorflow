...
LayerShapeNHWC = collections.namedtuple(
    "LayerShapeNHWC", "batch, height, width, channels"
)
...
class ConvolutionTest(test.TestCase):
    ...
    def testConvBackwardFilterGradient(self, rate=1):
        ...
        self._assert_reproducible(
            lambda: nn_ops.conv2d_backprop_filter(
                in_op,
                filter_shape,
                out_op,
                strides=strides,
    ...
    def testConvBackwardInputGradient(self, rate=1):
        ...
        self._assert_reproducible(
            lambda: nn_ops.conv2d_backprop_input(
                in_shape,
                filter_op,
                out_op,
                strides=strides,
    ...
    def testConvTransposeForward(self, rate=1):
        ...
        self._assert_reproducible(
            lambda: nn_ops.conv2d_transpose_v2(
                in_op,
                filter_op,
                out_shape,
                strides=1,
