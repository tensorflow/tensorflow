...
class SparseSliceOpTest(test.TestCase):
    ...
    def _SparseTensor_5x7(self):
        ...
        val = np.array(
            [0, 2, 4, 5, 11, 13, 14, 16, 20, 23, 25, 30, 32, 33, 35, 41, 44, 46]
        ).astype(np.int64)
    ...
    def testSliceMatrixUnevenRows(self):
        with self.session():
            ...
            self.assertAllEqual(
                sp_tensor0.values, [0, 2, 4, 5, 11, 13, 14, 16, 20, 23, 25]
            )
    ...
    def testGradientsExplicit(self):
        ...
        # pyformat: disable
        self.assertAllEqual(
            input_grad_vals, [0, 0, 0, 0, 0, 0, 0, 20, 0, 0, 30, 0, 0, 0]
        )
        # pyformat: enable
        ...
        # pyformat: disable
        self.assertAllEqual(
            input_grad_vals, [0, 0, 0, 0, 11, 0, 0, 0, 0, 0, 0, 0, 0, 0]
        )
        # pyformat: enable
        ...
        # pyformat: disable
        self.assertAllEqual(
            input_grad_vals, [0, 0, 0, 0, 0, 13, 0, 0, 23, 0, 0, 0, 33, 0]
        )
        # pyformat: enable
