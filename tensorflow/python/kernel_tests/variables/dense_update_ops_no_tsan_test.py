...
class AssignOpTest(test.TestCase):
    ...
    def testParallelUpdateWithoutLocking(self):
        ...
        with self.cached_session() as sess:
            ...
            adds = [
                state_ops.assign_add(p, ones_t, use_locking=False) for _ in range(20)
            ]
    ...
    def testParallelAssignWithoutLocking(self):
        ...
        with self.cached_session() as sess:
            ...
            threads = [
                self.checkedThread(target=run_assign, args=(assign_op,))
    ...
    def testParallelUpdateWithLocking(self):
        ...
        with self.cached_session() as sess:
            ...
            adds = [
                state_ops.assign_add(p, ones_t, use_locking=True) for _ in range(20)
            ]
