...
class SegmentReductionDeterminismExceptionsTest(test.TestCase):
            ...
            for segment_ids_type in [dtypes.int32, dtypes.int64]:
                for data_type in [dtypes.float16, dtypes.float32, dtypes.float64]:
                    with self.cached_session(force_gpu=True):
                        ...
                        if (
                            not DeterministicSegmentReductionsSupported()
    ...
    _UNSORTED_ERROR_MESSAGE = (
        "Deterministic GPU implementation of unsorted "
                ...
                for segment_ids_type in [dtypes.int32, dtypes.int64]:
                    for data_type in [
                        ...
                        if (
                            ...
                            and data_type == dtypes.int32
                        ):  # sqrt_n doesn't support int32
                            continue
