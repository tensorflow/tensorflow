...
class ParameterizedTruncatedNormalTest(test.TestCase):
    ...
    def testRightTail(self):
        ...
        self.validateMoments([int(1e5)], 0.0, 1.0, 4.0, np.infty, use_stateless=True)

    @test_util.run_deprecated_v1
    def testLeftTail(self):
        self.validateMoments([int(1e5)], 0.0, 1.0, -np.infty, -4.0)
        self.validateMoments([int(1e5)], 0.0, 1.0, -np.infty, -4.0, use_stateless=True)
    ...
    def testRightTailShifted(self):
        ...
        self.validateMoments([int(1e5)], -5.0, 1.0, 2.0, np.infty, use_stateless=True)
    ...
    def testTruncateOnLeft_entireTailOnRight(self):
        ...
        self.validateKolmogorovSmirnov(
            [int(1e5)], 10.0, 1.0, 4.0, np.infty, use_stateless=True
        )
    ...
    def testTruncateOnRight_entireTailOnLeft(self):
        ...
        self.validateKolmogorovSmirnov(
            [int(1e5)], -8.0, 1.0, -np.infty, -4.0, use_stateless=True
        )
