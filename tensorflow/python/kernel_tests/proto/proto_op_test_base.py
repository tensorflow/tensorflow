...
class ProtoOpTestBase(test.TestCase):
    ...
    def minmax_test_case():
        ...
        value.double_value.append(-1.7976931348623158e308)
        value.double_value.append(2.2250738585072014e-308)
        value.double_value.append(1.7976931348623158e308)
        value.float_value.append(-3.402823466e38)
        ...
        field.dtype = types_pb2.DT_DOUBLE
        field.value.double_value.append(-1.7976931348623158e308)
        ...
        field.dtype = types_pb2.DT_FLOAT
        field.value.float_value.append(-3.402823466e38)
