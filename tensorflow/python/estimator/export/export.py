...
_SINGLE_TENSOR_DEFAULT_NAMES = {
  'features': _SINGLE_FEATURE_DEFAULT_NAME,
  'receiver_tensors': _SINGLE_RECEIVER_DEFAULT_NAME,
  'receiver_tensors_alternatives': _SINGLE_RECEIVER_DEFAULT_NAME
}
...
def _wrap_and_check_input_tensors(tensors, field_name):
  ...
  """
  if tensors is None:
    raise ValueError('{} must be defined.'.format(field_name))
...
class ServingInputReceiver(
  ...
  def __new__(cls,
    ...
    features = _wrap_and_check_input_tensors(features, 'features')
      ...
      for alternative_name, receiver_tensors_alt in (
        ...
        receiver_tensors_alternatives[alternative_name] = (
            _wrap_and_check_input_tensors(
                receiver_tensors_alt, 'receiver_tensors_alternatives'))
