...
def _test_any_sparse_combinations():
    cases = [
        ...
        ("TestCase_4", lambda: (tensor.Tensor, sparse_tensor.SparseTensor), True),
        (
            "TestCase_5",
...
def _test_as_dense_shapes_combinations():
    cases = [
        ...
        (
            ...
            lambda: (tensor.Tensor, (), tensor.Tensor),
            lambda: (tensor_shape.TensorShape([]), (), tensor_shape.TensorShape([])),
        ),
        (
            "TestCase_10",
...
def _test_get_classes_combinations():
    cases = [
        ...
        ("TestCase_4", lambda: (constant_op.constant([1])), lambda: (tensor.Tensor)),
        (
            "TestCase_5",
            lambda: (
                sparse_tensor.SparseTensor(indices=[[0]], values=[1], dense_shape=[1]),
        ...
        (
            ...
            lambda: (sparse_tensor.SparseTensor, (), tensor.Tensor),
        ),
        (
            "TestCase_10",
            lambda: (
