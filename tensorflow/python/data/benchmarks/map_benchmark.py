...
class MapBenchmark(benchmark_base.DatasetBenchmarkBase):
    ...
    def benchmark_chain_of_maps(self):
        def benchmark_helper(
            chain_length, fn, use_inter_op_parallelism, label, benchmark_id
        ):
    ...
    def benchmark_map_fan_out(self):
        ...
        def benchmark_helper(
            fan_out, fn, use_inter_op_parallelism, label, benchmark_id
        ):
    ...
    def _benchmark_nested_parallel_map(self, cycle_length, num_parallel_calls):
        ...
        map_dataset_str = (
            ...
            else "parallel_map_num_parallel_calls_%s" % num_parallel_calls_str
        )
