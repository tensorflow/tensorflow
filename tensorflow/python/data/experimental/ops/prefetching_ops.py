...
class _CopyToDeviceDataset(dataset_ops.UnaryUnchangedStructureDataset):
    ...
    def __init__(self, input_dataset, target_device, source_device="/cpu:0"):
        ...
        """
        self._input_dataset = (
            input_dataset._apply_debug_options()
        ...
        init_func_concrete = (
            _init_func._get_concrete_function_internal()
        )  # pylint: disable=protected-access
        ...
        self._init_func = (
            _remote_init_func._get_concrete_function_internal()
        )  # pylint: disable=protected-access
        ...
        next_func_concrete = (
            _next_func._get_concrete_function_internal()
        )  # pylint: disable=protected-access
        ...
        self._next_func = (
            _remote_next_func._get_concrete_function_internal()
        )  # pylint: disable=protected-access
        ...
        def _finalize_func(string_handle):
            ...
            iterator_resource = gen_dataset_ops.iterator_from_string_handle_v2(
                string_handle, **self._input_dataset._flat_structure
            )  # pylint: disable=protected-access
            with ops.control_dependencies(
                [
        ...
        finalize_func_concrete = (
            _finalize_func._get_concrete_function_internal()
        )  # pylint: disable=protected-access
