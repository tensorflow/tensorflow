...
class OptimizationOptions(options_lib.OptionsBase):
    ...
    filter_parallelization = options_lib.create_option(
        ...
        ty=bool,
        docstring="Whether to parallelize stateless filter transformations. If None, "
        "defaults to False.",
    )
    ...
    inject_prefetch = options_lib.create_option(
        ...
        ty=bool,
        docstring="Whether to inject prefetch transformation as the last transformation "
