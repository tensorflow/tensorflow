...
class DatasetV2(tracking_base.Trackable, composite_tensor.CompositeTensor):
  ...
  **Component**: The leaf in the nested structure of an element.
  ...
  @staticmethod
  @deprecation.deprecated_args(None, "Use output_spec instead",
                               "output_types", "output_shapes")
  # TODO(lithuak): Make output_spec a required argument once output_types
  # and output_shapes are removed.
  def from_generator(generator,
    ...
    given `output_spec` argument or with the given `output_types` and (optional)
    `output_shapes` arguments whichiver was specified.

    The recommended way to call `from_generator` is to use the `output_spec`
