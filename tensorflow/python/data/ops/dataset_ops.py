  ...
  def load(
    ...
    Args:
      ...
      reader_func: Optional. A function to control how to read data from shards.
        ...
        computation.
      wait: For distributed snapshots, waits for the snapshot to be written if
        it is not found or not finished. Only supports distributed snapshots
        generated with `distributed_save`. Default to `False` for backward
        compatiblity. Users of `distributed_save` are recommended to set it to
        `True`.
