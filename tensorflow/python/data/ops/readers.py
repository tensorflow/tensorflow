...
def _create_or_validate_filenames_dataset(filenames, name=None):
    ...
    if isinstance(filenames, dataset_ops.DatasetV2):
        ...
        filenames = dataset_ops.TensorSliceDataset(filenames, is_files=True, name=name)
    return filenames


def _create_dataset_reader(
    dataset_creator, filenames, num_parallel_reads=None, name=None
):
...
class _TextLineDataset(dataset_ops.DatasetSource):
    ...
    def __init__(self, filenames, compression_type=None, buffer_size=None, name=None):
        ...
        variant_tensor = gen_dataset_ops.text_line_dataset(
            self._filenames, self._compression_type, self._buffer_size, **kwargs
        )
...
class TextLineDatasetV1(dataset_ops.DatasetV1Adapter):
    ...
    def __init__(
        ...
        wrapped = TextLineDatasetV2(
            filenames, compression_type, buffer_size, num_parallel_reads, name
        )
