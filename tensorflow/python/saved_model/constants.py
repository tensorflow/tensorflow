...
ASSETS_DIRECTORY = pywrap_saved_model.ASSETS_DIRECTORY
tf_export(
...
EXTRA_ASSETS_DIRECTORY = pywrap_saved_model.EXTRA_ASSETS_DIRECTORY

# CollectionDef key containing SavedModel assets.
ASSETS_KEY = pywrap_saved_model.ASSETS_KEY
tf_export(
...
LEGACY_INIT_OP_KEY = pywrap_saved_model.LEGACY_INIT_OP_KEY
tf_export(
    v1=[
...
MAIN_OP_KEY = pywrap_saved_model.MAIN_OP_KEY
tf_export(
...
TRAIN_OP_KEY = pywrap_saved_model.TRAIN_OP_KEY

# Schema version for SavedModel.
SAVED_MODEL_SCHEMA_VERSION = pywrap_saved_model.SAVED_MODEL_SCHEMA_VERSION
tf_export(
...
SAVED_MODEL_FILENAME_PB = pywrap_saved_model.SAVED_MODEL_FILENAME_PB
tf_export(
...
SAVED_MODEL_FILENAME_PBTXT = pywrap_saved_model.SAVED_MODEL_FILENAME_PBTXT
tf_export(
...
DEBUG_DIRECTORY = pywrap_saved_model.DEBUG_DIRECTORY
tf_export(
...
# SavedModel.
DEBUG_INFO_FILENAME_PB = pywrap_saved_model.DEBUG_INFO_FILENAME_PB
tf_export(
...
VARIABLES_DIRECTORY = pywrap_saved_model.VARIABLES_DIRECTORY
tf_export(
...
VARIABLES_FILENAME = pywrap_saved_model.VARIABLES_FILENAME
tf_export(
...
INIT_OP_SIGNATURE_KEY = pywrap_saved_model.INIT_OP_SIGNATURE_KEY
TRAIN_OP_SIGNATURE_KEY = pywrap_saved_model.TRAIN_OP_SIGNATURE_KEY
