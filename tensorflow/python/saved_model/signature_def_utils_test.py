...
class SignatureDefUtilsTest(test.TestCase):
    ...
    def testRegressionSignatureDef(self):
        ...
        self.assertEqual(
            signature_constants.REGRESS_METHOD_NAME, signature_def.method_name
        )
        ...
        # Check outputs in signature def.
        self.assertEqual(1, len(signature_def.outputs))
        y_tensor_info_actual = signature_def.outputs[
    ...
    def testClassificationSignatureDef(self):
        ...
        self.assertEqual(
            signature_constants.CLASSIFY_METHOD_NAME, signature_def.method_name
        )
        ...
        classes_tensor_info_actual = signature_def.outputs[
        ...
        scores_tensor_info_actual = signature_def.outputs[
    ...
    def testPredictionSignatureDef(self):
        ...
        self.assertEqual(
            signature_constants.PREDICT_METHOD_NAME, signature_def.method_name
        )
    ...
    def testInvalidClassificationSignaturesAreRejected(self):
        ...
        self._assertInvalidSignature(
            {"inputs": _STRING}, {}, signature_constants.CLASSIFY_METHOD_NAME
        )
    ...
    def testInvalidRegressionSignaturesAreRejected(self):
        ...
        # REGRESS: wrong keys
        self._assertInvalidSignature(
            {}, {"outputs": _FLOAT}, signature_constants.REGRESS_METHOD_NAME
        )
        ...
        self._assertInvalidSignature(
            {"inputs": _STRING}, {}, signature_constants.REGRESS_METHOD_NAME
        )
    ...
    def testInvalidPredictSignaturesAreRejected(self):
        # PREDICT: wrong keys
        self._assertInvalidSignature(
            {}, {"baz": _STRING, "qux": _FLOAT}, signature_constants.PREDICT_METHOD_NAME
        )

        self._assertInvalidSignature(
            {"foo": _STRING, "bar": _FLOAT}, {}, signature_constants.PREDICT_METHOD_NAME
        )
