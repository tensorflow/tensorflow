...
class _PredicateRegistry(object):
    ...
    def name_lookup(self, registered_name):
        ...
        try:
            ...
            raise LookupError(
                f"The {self.name} registry does not have name "
...
def register_serializable(
    package="Custom", name=None, predicate=None
...
def register_checkpoint_saver(
    package="Custom", name=None, predicate=None, save_fn=None, restore_fn=None
):
