...
class MetricsTests(test.TestCase):
    ...
    def test_python_save(self):
        ...
        self.assertEqual(metrics.GetWriteApi(save._SAVE_V2_LABEL), save_api_count + 1)
    ...
    def test_load_v1_in_v2(self):
        ...
        self.assertEqual(
            metrics.GetReadApi(load_v1_in_v2._LOAD_V1_V2_LABEL), load_v1_v2_count + 1
        )
