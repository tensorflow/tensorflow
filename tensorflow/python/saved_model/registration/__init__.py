...
from tensorflow.python.saved_model.registration.registration import (
    get_registered_class_name,
)
from tensorflow.python.saved_model.registration.registration import (
    get_registered_saver_name,
)
...
def register_tf_checkpoint_saver(
    name=None,
    predicate=None,
    save_fn=None,
    restore_fn=None,
