...
def TF_CreatePlaceholders(
    arg0: PyGraph, arg1: object, arg2: str
) -> list[TF_Output]: ...
...
def TF_GraphCopyFunction(
    arg0: PyGraph, arg1: TF_Function, arg2: TF_Function
) -> None: ...
def TF_GraphImportGraphDefWithResults(
    arg0: PyGraph, arg1: TF_Buffer, arg2: TF_ImportGraphDefOptions
) -> TF_ImportGraphDefResults: ...
def TF_GraphImportGraphDefWithResultsNoSerialization(
    arg0: PyGraph, arg1, arg2: TF_ImportGraphDefOptions
) -> TF_ImportGraphDefResults: ...
def TF_GraphNextOperation(arg0: PyGraph, arg1: int) -> tuple: ...
def TF_GraphRemoveFunction(arg0: PyGraph, arg1: str) -> None: ...
def TF_GraphSetOutputHandleShapesAndTypes_wrapper(
    arg0: PyGraph,
    arg1: TF_Output,
    arg2: list[list[int] | None],
    arg3: list[int],
    arg4: object,
) -> None: ...
def TF_GraphToFunction_wrapper(
    ...
    arg1: str,
    arg2: bool,
    arg3: list[TF_Operation] | None,
    arg4: list[TF_Output],
    arg5: list[TF_Output],
    arg6: list[bytes],
    arg7: list[TF_Operation],
    arg8: list[bytes],
    arg9: None,
    arg10: str,
) -> TF_Function: ...
...
def TF_ImportGraphDefOptionsAddInputMapping(
    arg0: TF_ImportGraphDefOptions, arg1: str, arg2: int, arg3: TF_Output
) -> None: ...
def TF_ImportGraphDefOptionsAddReturnOperation(
    arg0: TF_ImportGraphDefOptions, arg1: str
) -> None: ...
def TF_ImportGraphDefOptionsAddReturnOutput(
    arg0: TF_ImportGraphDefOptions, arg1: str, arg2: int
) -> None: ...
...
def TF_ImportGraphDefOptionsSetPropagateDeviceSpec(
    arg0: TF_ImportGraphDefOptions, arg1: int
) -> None: ...
def TF_ImportGraphDefOptionsSetUniquifyNames(
    arg0: TF_ImportGraphDefOptions, arg1: int
) -> None: ...
def TF_ImportGraphDefOptionsSetValidateColocationConstraints(
    arg0: TF_ImportGraphDefOptions, arg1: int
) -> None: ...
def TF_ImportGraphDefResultsMissingUnusedInputMappings_wrapper(
    arg0: TF_ImportGraphDefResults,
) -> list[str]: ...
...
def TF_OperationGetAttrValueProto(
    arg0: TF_Operation, arg1: str, arg2: TF_Buffer
) -> None: ...
...
def TF_SessionPRunSetup_wrapper(
    arg0: TF_Session,
    arg1: list[TF_Output],
    arg2: list[TF_Output],
    arg3: list[TF_Operation],
) -> str: ...
def TF_SessionPRun_wrapper(
    arg0: TF_Session, arg1: str, arg2: object, arg3: list[TF_Output]
) -> object: ...
def TF_SessionReleaseCallable(arg0: TF_Session, arg1: int) -> None: ...
def TF_SessionRunCallable(
    arg0: TF_Session, arg1: int, arg2: object, arg3: TF_Buffer
) -> list: ...
def TF_SessionRun_wrapper(
    arg0: TF_Session,
    arg1: TF_Buffer,
    arg2: object,
    arg3: list[TF_Output],
    arg4: list[TF_Operation],
    arg5: TF_Buffer,
) -> object: ...
def TF_SetAttrValueProto(
    arg0: TF_OperationDescription, arg1: str, arg2: bytes
) -> None: ...
