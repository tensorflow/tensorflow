        ...
        * var_shape
        ...
        def from_spec(cls, spec: str) -> Self:
            ...
            try:
                ...
                raise ValueError(
                    "Spec string must contain space-separated full_shape info."
                ) from e
            ...
            for dim in full_shape_str.split():
                try:
                    ...
                    raise ValueError(
                        ...
                        f"Found '{dim}', which is not an integer."
                    ) from e
            ...
            for dim_spec in slice_str.split(":"):
                ...
                try:
                    ...
                    raise ValueError(
                        ...
                        f"Found '{offset}', which is not an integer."
                    ) from e
                try:
                    ...
                    raise ValueError(
                        ...
                        f"Found '{shape}', which is not an integer."
                    ) from e

            return cls(
                full_shape=full_shape, var_offset=var_offset, var_shape=var_shape
            )
