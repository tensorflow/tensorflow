...
class StructuredTensorTest(test_util.TensorFlowTestCase, parameterized.TestCase):
            ...
            structured_tensor.StructuredTensor.from_pyval(
                ...
                structured_tensor.StructuredTensor.Spec(
                    _ragged_shape=DynamicRaggedShape.Spec(
                        row_partitions=[], static_inner_shape=[2, 2], dtype=dtypes.int64
                    ),
                    _fields={
                        "x": tensor.TensorSpec([2, 2], dtypes.int32),
        ...
        [
            ...
            },
            {
                ...
                "type_spec": structured_tensor.StructuredTensor.Spec._from_fields_and_rank(
                    fields={"a": tensor.TensorSpec([0], dtypes.int32)}, rank=1
                ),
                "expected": lambda: StructuredTensor.from_fields(
                    shape=[0], fields={"a": []}
                ),
            },
            {
                ...
                "type_spec": StructuredTensor.Spec._from_shape(
                    DynamicRaggedShape.Spec(
                        row_partitions=[], static_inner_shape=[0, 5], dtype=dtypes.int64
                    )
                ),
                "expected": lambda: StructuredTensor.from_fields(
                    shape=[0, 5], fields={}
            ...
            },
            {
                ...
                "type_spec": StructuredTensor.Spec._from_shape(
                    DynamicRaggedShape.Spec(
                        row_partitions=[], static_inner_shape=[1, 0], dtype=dtypes.int64
                    )
                ),
            ...
            },
            {
                ...
                "type_spec": structured_tensor.StructuredTensorSpec(
                    [2, 3], {"a": tensor.TensorSpec(None, dtypes.int32)}
                ),
                "expected": lambda: StructuredTensor.from_fields(
    ...
    @parameterized.named_parameters(
        [
            ...
            dict(
                ...
                pyval={"a": 1},
                type_spec=StructuredTensor.Spec._from_fields_and_rank(
                    fields={"b": tensor.TensorSpec([1], dtypes.int32)}, rank=1
                ),
            ...
            dict(
                ...
                pyval=[{"a": 1}],
                type_spec=StructuredTensor.Spec._from_fields_and_rank(
                    fields={"a": tensor.TensorSpec([], dtypes.int32)}, rank=0
                ),
            ...
            dict(
                ...
                type_spec=StructuredTensor.Spec._from_fields_and_rank(
                    fields={
                        "a": StructuredTensor.Spec._from_fields_and_rank(
                            fields={"b": tensor.TensorSpec([], dtypes.int32)}, rank=0
                        )
                    },
                    rank=0,
                ),
            ...
            dict(
                ...
                pyval=[[1]],
                type_spec=StructuredTensor.Spec._from_fields_and_rank(
                    fields={"a": tensor.TensorSpec([1, 1], dtypes.int32)}, rank=2
                ),
                msg=r"Value at \(\) does not match typespec",
            ),
            dict(
    ...
    def testWithUpdatesChecks(self):
        ...
        with self.assertRaisesRegex(
            ValueError,
            r"cannot update.*\('b', 'd', 'x'\).*does not already "
            r"exist",
        ):
        ...
        with self.assertRaisesRegex(
            ValueError, r"`StructuredTensor.with_updates` failed for field \('c',\)"
        ):
