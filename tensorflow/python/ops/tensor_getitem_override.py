...
def _slice_helper(tensor, slice_spec, var=None):
    ...
    for s in slice_spec:
        if isinstance(s, _BaseSlice):
            ...
            if isinstance(s, tensor_lib.Tensor) and (
                s.dtype == dtypes.int16 or s.dtype == dtypes.int64
            ):
    ...
    with ops.name_scope(
        ...
        if begin:
            ...
            if (
                ...
                packed_begin.dtype == dtypes.int16
                and packed_end.dtype == dtypes.int16
                and packed_strides.dtype == dtypes.int16
            ):
