...
class _TrackableResourceSummaryWriter(
    _ResourceSummaryWriter, resource.TrackableResource, metaclass=_MultiMetaclass
):
...
def summary_writer_function(name, tensor, function, family=None):
    ...
    def record():
        with (
            ops.name_scope(name_scope),
            summary_op_util.summary_scope(name, family, values=[tensor]) as (
                tag,
                scope,
            ),
        ):
