...
def _compute_theoretical_jacobian(
    x, x_shape, x_data, dy, dy_shape, dx, extra_feed_dict
):
...
def _compute_gradient(
    x, x_shape, dx, y, y_shape, dy, x_init_value=None, delta=1e-3, extra_feed_dict=None
):
...
def _compute_gradient_list(
    ...
    ret = [
        ...
        for xi, x_shapei, dxi, dyi, x_init_valuei in zip(
            x, x_shape, dx, dy, x_init_value
        )
    ]
    return ret
