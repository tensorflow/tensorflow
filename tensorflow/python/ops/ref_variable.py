...
class RefVariable(variable_v1.VariableV1, core.Tensor):
    ...
    def __init__(
        ...
        if variable_def:
            ...
            if initial_value:
                raise ValueError(
                    "variable_def and initial_value are mutually exclusive."
                )
    ...
    def _init_from_args(
        ...
        with ops.init_scope():
            ...
            with ops.name_scope(
                name, "Variable", [] if init_from_fn else [initial_value]
            ) as name:
                if init_from_fn:
                        ...
                        with ops.name_scope("Initializer"), ops.device(None):
                            ...
                            if shape is None:
                                shape = (
                                    ...
                                    if validate_shape
                                    else tensor_shape.unknown_shape()
                                )
    ...
    def _init_from_proto(self, variable_def, import_scope=None):
        ...
        if (
            hasattr(variable_def, "initial_value_name")
    ...
    def _restore_from_tensors(self, restored_tensors):
        ...
        return state_ops.assign(
            self, restored_tensor, validate_shape=self.get_shape().is_fully_defined()
        )
...
tensor_conversion_registry.register_tensor_conversion_function(
    RefVariable, RefVariable._TensorConversionFunction
)  # pylint: disable=protected-access
