...
override_binary_operator.override_binary_operator_helper(_add_dispatch_factory, "add")
...
override_binary_operator.override_binary_operator_helper(_floordiv_factory, "floordiv")
override_binary_operator.override_binary_operator_helper(_matmul_factory, "matmul")
override_binary_operator.override_binary_operator_helper(_mod_factory, "mod")
override_binary_operator.override_binary_operator_helper(_mul_dispatch_factory, "mul")
...
override_binary_operator.override_binary_operator_helper(_subtract_factory, "sub")
override_binary_operator.override_binary_operator_helper(_truediv_factory, "truediv")
...
tensor_lib.Tensor._override_operator(
    "__lt__", _promote_dtypes_decorator(gen_math_ops.less)
)
tensor_lib.Tensor._override_operator(
    "__le__", _promote_dtypes_decorator(gen_math_ops.less_equal)
)
tensor_lib.Tensor._override_operator(
    "__gt__", _promote_dtypes_decorator(gen_math_ops.greater)
)
tensor_lib.Tensor._override_operator(
    "__ge__", _promote_dtypes_decorator(gen_math_ops.greater_equal)
)
