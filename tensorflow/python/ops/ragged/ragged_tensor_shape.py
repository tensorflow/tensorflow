...
class RaggedTensorDynamicShape:
    ...
    def broadcast_to_rank(self, rank):
        ...
        if dims_to_add < 0:
            ...
            return RaggedTensorDynamicShape(
                partitioned_dims, self.inner_dim_sizes, self.dim_size_dtype
            )
        else:
        ...
        with ops.control_dependencies([broadcast_check]):
            ...
            # Inner dimensions:
                ...
                if lengths_is_scalar:
                    ...
                    if axis == 0:
                        raise ValueError(
                            "Unable to broadcast: outermost dimension must be uniform."
                        )
    ...
    def _broadcast_uniform_partitioned_dimension(self, axis, lengths):
        ...
        return RaggedTensorDynamicShape(
            partitioned_sizes, inner_sizes, self.dim_size_dtype
        )
