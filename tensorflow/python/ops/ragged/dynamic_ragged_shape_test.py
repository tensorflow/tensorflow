...
class DynamicRaggedShapeSpecTest(parameterized.TestCase):
  ...
  def test_from_tensor_shape(self):
    ...
    self.assertEqual(spec._row_partitions[0].dtype, dtypes.int32)
    self.assertEqual(spec._row_partitions[1].dtype, dtypes.int32)
    self.assertEqual(spec._row_partitions[2].dtype, dtypes.int32)
