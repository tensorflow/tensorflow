...
def _to_row_partitions_from_lengths(
    ...
    """
    (result, _) = dynamic_ragged_shape._to_row_partitions_and_nvals_from_lengths(
        lengths
    )
    return result
...
class DynamicRaggedShapeTest(test_util.TensorFlowTestCase, parameterized.TestCase):
    ...
    def assertShapeEq(
        self, x: DynamicRaggedShape, y: DynamicRaggedShape, msg=None
    ) -> None:
    ...
    def assertBroadcasterEq(
        self, x: dynamic_ragged_shape._Broadcaster, y: dynamic_ragged_shape._Broadcaster
    ) -> None:
    ...
    def testGetBroadcaster(self):
        ...
        expected = dynamic_ragged_shape._Broadcaster(
            origin_shape,
            dest_shape,
            [
    ...
    def testBroadcaster(
        ...
        expected = dynamic_ragged_shape._Broadcaster(
            source, target, expected_gather_indices
        )
        self.assertBroadcasterEq(actual, expected)
    ...
    def testNumElements(self):
        shape = DynamicRaggedShape.from_lengths([2, 3, 4, 5])._with_num_row_partitions(
            2
        )
    ...
    def testConstructorWithStaticInnerShape(self):
        ...
        rts = DynamicRaggedShape(
            row_partitions, inner_shape, validate=True, static_inner_shape=[3]
        )
        static_inner_shape = tensor_util.constant_value(rts.inner_shape)
        static_valid_rowids0 = tensor_util.constant_value(
            rts.row_partitions[0].value_rowids()
    ...
    def testBroadcastDynamicShapeExtended(
        ...
        [actual, bc_a, bc_b] = dynamic_ragged_shape.broadcast_dynamic_shape_extended(
            shape_a, shape_b
        )
    ...
    def testFromRowPartitions(self, rps, lengths_e, num_row_partitions_e):
        ...
        expected = DynamicRaggedShape.from_lengths(lengths_e)._with_num_row_partitions(
    ...
    def testBroadcastDynamicShapeFirstLayer(self):
        ...
        [a_layer, b_layer] = dynamic_ragged_shape._broadcast_dynamic_shape_first_layer(
            a_0, b_0
        )
    ...
    @parameterized.parameters(
        [
            ...
            dict(
                doc=(
                    "x.shape=[2, (D1), 1]; y.shape=[1, 1, 4]; bcast.shape=[2, (D1), 4]"
                ),
                x=ragged_factory_ops.constant_value(
    ...
    @parameterized.parameters(
        [
            dict(
                lengths_a=[3, (1, 4, 2)], lengths_b=[], new_impl=True, max_num_ops=5
            ),  # Actual ops: 1
            dict(
            ...
            dict(
                lengths_a=[3, (1, 4, 2)], lengths_b=[], new_impl=False, max_num_ops=5
            ),  # Actual ops: 1
            dict(
                lengths_a=[3, (1, 4, 2), 3, 2],
                lengths_b=[3, 2],
    ...
    @parameterized.parameters(
        [
            ...
            dict(
                lengths_a=[3, (1, 4, 2)], lengths_b=[], shape_e=[3, None], new_impl=True
            ),
            dict(
    ...
    @parameterized.parameters(
        [
            dict(lengths_a=[3, (1, 4, 2)], lengths_b=[], shape_e=[3, (1, 4, 2)]),
            dict(lengths_a=[5], lengths_b=[1], shape_e=[5]),
            dict(
                lengths_a=[5, (1, 4, 2, 1, 3), 3],
                lengths_b=[5, 1, 3],
                shape_e=[5, None, 3],
    ...
    def testBroadcastDynamicShapeStatic(
        self,
        lengths_a,
        lengths_b,
        shape_e,
    ...
    @parameterized.parameters(
        [
            dict(lengths_a=[3, (1, 4, 2)], dim=0, expected=3),
            dict(lengths_a=[5], dim=0, expected=5),
            dict(lengths_a=[5, (1, 4, 2, 1, 3), 3], dim=0, expected=5),
            dict(lengths_a=[5, (1, 4, 2, 1, 3), 3], dim=2, expected=3),
            dict(lengths_a=[3, 2, (1, 4, 2, 1, 3, 1), 3], dim=1, expected=2),
    ...
    @parameterized.parameters(
        [
            dict(
                ...
                new_num_row_partitions=2,
            ),  # Fails
            dict(
                lengths_a=[3, 2, (1, 4, 2, 1, 3, 1), 3],
                shape_e=[3, 2, (1, 4, 2, 1, 3, 1), 3],
                new_num_row_partitions=3,
            ),  # Fails
        ]
    )
    def testNumRowPartitionShapeStatic(
        self, lengths_a, shape_e, new_num_row_partitions, num_row_partitions_a=None
    ):
        if context.executing_eagerly():
            return
        shape_a = DynamicRaggedShape.from_lengths(
    ...
    @parameterized.parameters(
        [
            dict(lengths_a=[5, (1, 4, 2, 1, 3), 3], inner_shape=[33], new_inner_rank=1),
            dict(
                lengths_a=[3, 2, (1, 4, 2, 1, 3, 1), 3],
                inner_shape=[36],
                new_inner_rank=1,
    ...
    def testAltInnerShapeStatic(
        self, lengths_a, inner_shape, new_inner_rank, num_row_partitions_a=None
    ):
        if context.executing_eagerly():
            return
        shape_a = DynamicRaggedShape.from_lengths(
    ...
    @parameterized.parameters(
        [
            dict(lengths=[3, (1, 4, 2)], shape_e=[3, None]),
            dict(lengths=[3, (1, 4, 2)], shape_e=[3, None]),
            dict(lengths=[5, (1, 4, 2, 1, 3), 3], shape_e=[5, None, 3]),
            dict(lengths=[5, (1, 4, 2, 1, 3), 3], shape_e=[5, None, 3]),
            dict(lengths=[3, 2, (1, 4, 2, 1, 3, 1), 3], shape_e=[3, 2, None, 3]),
            dict(lengths=[3, 2, (1, 4, 2, 1, 3, 1), 3], shape_e=[3, 2, None, 3]),
        ]
    )
    ...
    @parameterized.parameters(
        [
            dict(lengths=[5, (1, 4, 2, 1, 3), 3], shape_e=[5, (1, 4, 2, 1, 3), 3]),
            dict(
    ...
    def testWithNumRowPartitionsDType(self):
        # Note that this test loses the later static values.
        shape = DynamicRaggedShape(
            [], constant_op.constant([5, 2, 3], dtype=dtypes.int32)
        )
    ...
    def test_merge_with_spec(self):
        ...
        spec = DynamicRaggedShape.Spec(
            row_partitions=[RowPartitionSpec(nrows=2, nvals=8, dtype=dtypes.int64)],
    ...
    def test_merge_with_spec_raises(self):
        original = DynamicRaggedShape.from_lengths([2, (3, 5), 6], dtype=dtypes.int64)
        spec = DynamicRaggedShape.Spec(
            row_partitions=[RowPartitionSpec(nrows=2, nvals=8, dtype=dtypes.int32)],
            static_inner_shape=tensor_shape.TensorShape([8, 6]),
            dtype=dtypes.int32,
        )
        with self.assertRaisesRegex(
            ValueError, "RowPartition and RowPartitionSpec are not compatible"
        ):
    ...
    def test_merge_with_spec_uniform(self):
        ...
        original = DynamicRaggedShape.from_lengths(
            [2, 4, 6], num_row_partitions=1, dtype=dtypes.int64
        )
        self.assertShapeEq(result, original)
    ...
    @parameterized.parameters(
        [
            dict(lengths=[2, 2], num_row_partitions=1, expected=[2, 2]),
    ...
    def testReprRankKnown(self):
        ...
        actual = str(a)
        self.assertEqual(
            "<DynamicRaggedShape lengths=[2, (1, 2), 3] num_row_partitions=1>", actual
        )

    def assertDimsEqual(self, x: tensor_shape.TensorShape, y: tensor_shape.TensorShape):
        if x.rank is None:
            self.assertIsNone(
                y.rank, "x has an unknown rank, but y does not: x={}, y={}".format(x, y)
            )
            return
        self.assertIsNotNone(
            y.rank, "y has an unknown rank, but x does not: x={}, y={}".format(x, y)
        )
    ...
    def testBroadcasterRepr(self):
        ...
        bc = dynamic_ragged_shape._Broadcaster(
            source_shape, target_shape, layer_broadcasters
        )
        actual = str(bc)
...
class DynamicRaggedShapeErrorTest(parameterized.TestCase):
    ...
    def testBroadcastDynamicShapeUnmatchedTypes6432(self):
        shape_int64 = DynamicRaggedShape.from_lengths(
            [3, (0, 2, 3)], dtype=dtypes.int64
        )
        shape_int32 = DynamicRaggedShape.from_lengths(
            [3, (0, 2, 3)], dtype=dtypes.int32
        )
...
class DynamicRaggedShapeSpecTest(parameterized.TestCase):
    def assertRowPartitionSpecEqual(
        self, a: RowPartitionSpec, b: RowPartitionSpec, msg=""
    ) -> None:
    ...
    def assertTensorShapeEqual(
        self, a: tensor_shape.TensorShape, b: tensor_shape.TensorShape
    ) -> None:
    ...
    def assertDynamicRaggedShapeSpecEqual(
        self, a: DynamicRaggedShape.Spec, b: DynamicRaggedShape.Spec
    ) -> None:
        ...
        [
            ...
            dict(
                ...
                expected=dynamic_ragged_shape.DynamicRaggedShape.Spec(
                    row_partitions=[
                        RowPartitionSpec(
                            nrows=5, nvals=15, uniform_row_length=3, dtype=dtypes.int32
                        ),
                        RowPartitionSpec(
                            nrows=15,
                            nvals=None,
            ...
            dict(
                ...
                expected=dynamic_ragged_shape.DynamicRaggedShape.Spec(
                    row_partitions=[],
                    static_inner_shape=tensor_shape.TensorShape([5, 3, None, 4, 2, 5]),
                    dtype=dtypes.int32,
                ),
            ),
        ]
    ...
    def test_from_tensor_shape(self, shape, num_row_partitions, dtype, expected):
        spec = DynamicRaggedShape.Spec._from_tensor_shape(
            shape, num_row_partitions, dtype
        )
    ...
    def test_from_tensor_shape_raises(
        self, shape, num_row_partitions, dtype, error_type, error_regex
    ):
        with self.assertRaisesRegex(error_type, error_regex):
    ...
    def test_num_slices_in_dimension_raises(
        self, spec, dimension, error_type, error_regex
    ):
        with self.assertRaisesRegex(error_type, error_regex):
    ...
    def test_with_num_row_partitions_raises(
        self, spec, num_row_partitions, error_type, error_regex
    ):
        with self.assertRaisesRegex(error_type, error_regex):
    ...
    def test_truncate_unknown(self):
        spec = DynamicRaggedShape.Spec(
            row_partitions=[
                ...
                RowPartitionSpec(
                    nrows=7, nvals=None, uniform_row_length=None, dtype=dtypes.int32
                ),
            ],
            static_inner_shape=tensor_shape.TensorShape(None),
            dtype=dtypes.int32,
    ...
    @parameterized.parameters(
        [
            ...
            dict(
                row_partitions=[
                    RowPartitionSpec(
                        nrows=6, nvals=None, uniform_row_length=None, dtype=dtypes.int64
                    )
                ],
                static_inner_shape=tensor_shape.TensorShape([None]),
                inner_shape=tensor.TensorSpec([1], dtypes.int64),
            ...
            dict(
                row_partitions=[
                    ...
                    RowPartitionSpec(
                        nrows=60, nvals=120, uniform_row_length=None, dtype=dtypes.int64
                    ),
                ],
    ...
    def test_constructor_idempotent(
        self, row_partitions, static_inner_shape, inner_shape
    ):
    ...
    @parameterized.parameters(
        [
            ...
            dict(
                ...
                expected_row_partitions=[
                    RowPartitionSpec(
                        nrows=6, nvals=60, uniform_row_length=None, dtype=dtypes.int64
                    ),
                    RowPartitionSpec(
                        nrows=60, nvals=120, uniform_row_length=None, dtype=dtypes.int64
                    ),
    ...
    def test_constructor_improvements(
        self,
        original,
        expected_row_partitions,
        ...
        self.assertTensorShapeEqual(
            original._static_inner_shape, expected_static_inner_shape
        )
    ...
    def test_constructor_raises(
        self, row_partitions, static_inner_shape, dtype, error_type, msg
    ):
        # Note that self_merge is only idempotent if no data is partially present.
        ...
        [
            dict(
                ...
                expected=dynamic_ragged_shape.DynamicRaggedShape.Spec(
                    row_partitions=[
                        RowPartitionSpec(
                            nrows=3, nvals=18, uniform_row_length=6, dtype=dtypes.int64
                        ),
                        RowPartitionSpec(
                            nrows=18,
                            nvals=9,
    ...
    def test_unbatch(
        self, spec: DynamicRaggedShape.Spec, expected: DynamicRaggedShape.Spec
    ):
        encoder = dynamic_ragged_shape._DynamicRaggedShapeBatchEncoder()
