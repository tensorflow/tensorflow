...
class RaggedStackOpTest(test_util.TensorFlowTestCase, parameterized.TestCase):
    @parameterized.parameters(
        dict(
            ...
            rt_inputs=([["a00", "a01"], [], ["a20", "a21"]],),  # shape=(3, None)
            axis=0,
            expected=[[[b"a00", b"a01"], [], [b"a20", b"a21"]]],
        ),
        dict(
            descr="One rank-2 input (ragged_rank=1), axis=1",
            rt_inputs=([["a00", "a01"], [], ["a20", "a21", "a22"]],),  # shape=(3, None)
            axis=1,
        ...
        dict(
            ...
            axis=0,
            expected=[[[b"a00", b"a01"], [], [b"a20", b"a21"]], [[b"b00"], [b"b10"]]],
        ),
        dict(
        ...
        dict(
            ...
            expected=[
                ...
                [[[b"b000"]], [[b"b100", b"b101"], [b"b110"]]],
                [[], [[b"c100", b"c101", b"c102", b"c103"]], [[], [b"c210", b"c211"]]],
            ],
        ),
        dict(
    ...
    def testRaggedStack(
        ...
        rt_inputs = [
            ragged_factory_ops.constant(
                rt_input, ragged_rank=rrank
            )  # pylint: disable=g-long-ternary
            if rrank != 0
            else constant_op.constant(rt_input)
    ...
    def testError(self, rt_inputs, axis, error, message):
        self.assertRaisesRegex(error, message, ragged_concat_ops.stack, rt_inputs, axis)
