...
class RaggedBatchGatherOpTest(test_util.TensorFlowTestCase, parameterized.TestCase):
    @parameterized.parameters(
        [
            ...
            dict(
                ...
                indices=ragged_factory_ops.constant_value([[1, 2, 0], [], [], [0, 0]]),
            ...
            dict(
                descr=(
                    "params: [B1, (P1), (P2), P3], indices: [B1, I], "
                    "result: [B1, I, (P2), P3]"
                ),
                params=ragged_factory_ops.constant_value(
                    [[[["a"]], [["b"], ["c"]]], [[["d"], ["e"]], [["f"]]], [[["g"]]]],
            ...
            dict(
                descr=(
                    "params: [B1, B2, P1], indices: [B1, B2, I], result: [B1, B2, I]"
                ),
                params=[[["a", "b", "c"]], [["d", "e", "f"]], [["g", "h", "i"]]],
                indices=[[[2, 0]], [[0, 1]], [[1, 0]]],
                expected=[[[b"c", b"a"]], [[b"d", b"e"]], [[b"h", b"g"]]],
            ...
            dict(
                descr=(
                    "params: [B1, (B2), P1], indices: [B1, (B2), I], "
                    "result: [B1, (B2), I]"
                ),
                params=ragged_factory_ops.constant_value(
                    [[["a", "b", "c"], ["d", "e", "f"]], [["g", "h", "i"]]],
    ...
    @parameterized.parameters(
        [
            ...
            dict(
                ...
                indices=[[1, 100], [0, -1]],
                expected=[
                    [["Trumpty", "Dumpty", "sat", "on", "a", "wall"], ["$NONE^"]],
                    [
                        ["It's", "always", "darkest", "before", "the", "dawn"],
                        ["$NONE^"],
                    ],
    ...
    def testRaggedBatchGatherUnknownRankError(self):
        ...
        with self.assertRaisesRegex(
            ValueError,
            r"batch_dims=-1 may only be negative "
    ...
    @parameterized.parameters(
        [
            ...
            dict(
                ...
                indices=ragged_factory_ops.constant_value([[[0, 0], [0, 0, 0]], [[0]]]),
                message="batch shape from indices does not match params shape",
            ),
            dict(  # rank mismatch
                params=ragged_factory_ops.constant_value([[[0, 0], [0, 0, 0]], [[0]]]),
                indices=ragged_factory_ops.constant_value(
                    [[[0, 0]], [[0, 0, 0]], [[0]]]
                ),
            ...
            dict(
                ...
                error=(ValueError, errors.InvalidArgumentError),
                message=(
                    r"batch shape from indices .* does not match "
    ...
    def testRaggedBatchGatherStaticError(
        self, params, indices, message=None, error=ValueError
    ):
