  ...
  class Spec:
    ...
    def from_tensor_shape(cls,
      ...
      if shape.rank is None:
        raise ValueError(
            "This method only works if the rank of the shape is known")
    ...
    def with_num_row_partitions(
      ...
      if self.num_row_partitions == new_num_row_partitions:
        ...
        return DynamicRaggedShape.Spec(
            self._row_partitions + tail_shape._row_partitions,
            tail_shape._static_inner_shape, tail_shape._inner_shape)
      else:
