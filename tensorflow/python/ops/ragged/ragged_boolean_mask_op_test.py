...
class RaggedBooleanMaskOpTest(test_util.TensorFlowTestCase, parameterized.TestCase):
    ...
    @parameterized.parameters(
        [
            ...
            dict(
                descr=(
                    "data.shape=[3, (D2), (D3), (D4)]; mask.shape=[3, (D2), (D3), (D4)]"
                ),
                data=ragged_factory_ops.constant_value(
                    [[[[1, 2], [3, 4]], [[5, 6]]], [[[2, 4], [6, 8]]]]
                ),
            ...
            dict(
                ...
                data=[[[1, 2], [3, 4], [5, 6]], [[7, 8], [9, 0], [2, 4]]],
                mask=ragged_factory_ops.constant_value(
                    [[[T, F], [F, F], [T, T]], [[T, F], [F, T], [F, F]]], ragged_rank=1
                ),
                expected=ragged_factory_ops.constant_value(
                    [[[1], [], [5, 6]], [[7], [0], []]]
                ),
            ...
            dict(
                ...
                data=ragged_factory_ops.constant_value(
                    [[[1, 2, 3], [4, 5, 6]], [[7, 8, 9], [2, 4, 6]]], ragged_rank=1
                ),
                mask=[[T, F], [T, T]],
                expected=ragged_factory_ops.constant_value(
    ...
    def testErrors(self):
        ...
        self.assertRaises(TypeError, ragged_array_ops.boolean_mask, [[1, 2]], [[0, 1]])
        self.assertRaisesRegex(
            ValueError,
            "Tensor conversion requested dtype bool for RaggedTensor with dtype int32",
            ragged_array_ops.boolean_mask,
