...
class RaggedTensorSpecSupportedValuesTest(
    ...
    @parameterized.parameters(
        [
            ...
            (
                ...
                [
                    WrappedTensor.Spec(tensor.TensorSpec([None, 3], dtypes.float32)),
            ...
            (
                ...
                [
                    WrappedTensor.Spec(tensor.TensorSpec([None, 3], dtypes.float64)),
                    tensor.TensorSpec([None], dtypes.int64),
                    tensor.TensorSpec([None], dtypes.int64),
                ],
            ),
    ...
    def testIsCompatibleWith(self):
        ...
        spec3 = RaggedTensorSpec(
            ...
            dtypes.int32,
            1,
            flat_values_spec=WrappedTensor.Spec(tensor.TensorSpec(None, dtypes.int32)),
        )
