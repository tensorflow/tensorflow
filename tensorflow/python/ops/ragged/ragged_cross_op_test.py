...
class RaggedCrossOpTest(test_util.TensorFlowTestCase, parameterized.TestCase):
        ...
        [
            ...
            dict(
                ...
                expected=ragged_const(
                    [[b"a_X_d", b"a_X_e", b"b_X_d", b"b_X_e"], [], [b"c_X_g"]]
                ),
            ),
            dict(
            ...
            dict(
                ...
                expected=ragged_const(
                    [[b"a_X_1", b"a_X_2", b"b_X_1", b"b_X_2"], [], [b"c_X_4"]]
                ),
            ),
            dict(
            ...
            dict(
                ...
                inputs=[dense_const([[1, 2], [3, 4]]), dense_const([[5, 6], [7, 8]])],
                expected=ragged_const(
                    [
            ...
            dict(
                ...
                expected=ragged_const(
                    [
                        [b"1_X_d", b"1_X_e", b"2_X_d", b"2_X_e"],
                        [b"3_X_f", b"4_X_f"],
                        [b"5_X_g", b"6_X_g"],
                    ]
                ),
    ...
    def testRaggedCross(
        ...
        if matches_sparse_cross:
            ...
            self.assertAllEqual(
                ragged_cross, ragged_tensor.RaggedTensor.from_sparse(sparse_cross)
            )
    ...
    @parameterized.named_parameters(
        [
            ...
            dict(testcase_name="NegativeSplits", ragged_splits=[-216, -114, -58, -54]),
    ...
    def testRaggedCrossInvalidRaggedSplits(self, ragged_splits):
        ...
        with self.assertRaisesRegex(
            ...
            ragged_row_splits_0_tensor = ragged_const(ragged_splits, dtype=dtypes.int64)
