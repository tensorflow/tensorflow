...
class TestSparseCount(test_util.TensorFlowTestCase, parameterized.TestCase):
  ...
  @parameterized.product(
      (
          ...
          dict(
              ...
              expected=[2, 1, 0, 3],  # same as equivalent dense tensor
          ),
          dict(
              tid="_s1_all_zeros",
              x_factory=_sparse_factory([0, 0, 0, 0, 0, 0]),
              expected=[6],  # same as equivalent dense tensor
          ),
          dict(
              tid="_s2",
              ...
              expected=[6, 1, 2, 3],  # same as equivalent dense tensor
          ),
          dict(
              tid="_s3",
              x_factory=_sparse_factory(
  ...
  def test_default(self, x_factory, minlength, maxlength, expected, tid=None):
    ...
    self.assertAllEqual(
        ...
        self.evaluate(
            sparse_ops.bincount(
                x, minlength=minlength, maxlength=maxlength
            )
        ),
    )
    self.assertAllEqual(
  ...
  @parameterized.product(
      (
          dict(
              ...
              # same as equivalent dense tensor
  ...
  def test_axis_neg_one(self, tid, x_factory, minlength, maxlength, expected):
    x = x_factory()
  ...
  @parameterized.product(
      (
          ...
          dict(
              ...
              expected=[1, 1, 1, 1],  # same as dense
              axis=None,
          ),
          dict(
              tid="_s3",
