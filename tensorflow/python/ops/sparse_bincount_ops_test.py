...
class TestSparseCount(test_util.TensorFlowTestCase, parameterized.TestCase):
    ...
    @parameterized.named_parameters(
        ...
        },
        {
            ...
            "x": np.array(
                [
                    [1941591354222760687, 0, 1241591354229760689],
    ...
    @parameterized.product(
        (
            ...
            dict(
                tid="_s2",
                x_factory=_sparse_factory([[0, 0, 0], [0, 1, 0], [2, 0, 2], [3, 3, 3]]),
                expected=[0, 1, 2, 3],
            ),
            dict(
                tid="_s3",
    ...
    def test_default(
        ...
        self.assertAllEqual(
            expected,
            self.evaluate(
                sparse_ops.bincount(x, minlength=minlength, maxlength=maxlength, axis=0)
            ),
        )
