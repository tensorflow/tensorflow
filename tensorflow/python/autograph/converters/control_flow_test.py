...
class WhileStatementTest(ControlFlowTestBase):
  ...
  def test_nested_composite_state(self):
  ...
  def test_local_composite_complex_nestable(self):
  ...
  def test_local_composite_complex_illegal(self):
