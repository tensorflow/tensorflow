...
class InitScopeTest(test_util.TensorFlowTestCase):
  ...
  def testNewExecutingEagerlyOutsideFunctions(self):
    @def_function.function
    def f():
      return ops.simplified_executing_eagerly_outside_functions()

    with context.graph_mode():
      self.assertFalse(ops.simplified_executing_eagerly_outside_functions())
    ...
    with context.eager_mode():
      self.assertTrue(ops.simplified_executing_eagerly_outside_functions())
      self.assertTrue(f())
