...
class TensorType(trace.TraceType):
    ...
    def is_subtype_of(self, other):
        ...
        if any(
            o is not None and s != o for s, o in zip(self.shape_dims, other.shape_dims)
        ):
            return False
    ...
    def __eq__(self, other) -> bool:
        ...
        return (
            self.shape_rank == other.shape_rank and self.shape_dims == other.shape_dims
        )
...
class Graph(object):
    ...
    def _variable_creator_scope(self, creator, priority=100):
        ...
        self._thread_local._variable_creator_stack = (
            new  # pylint: disable=protected-access
        )
        try:
            yield
        finally:
    ...
    def _variable_creator_stack(self, variable_creator_stack):
        self._thread_local._variable_creator_stack = (
            variable_creator_stack  # pylint: disable=protected-access
        )
    ...
    if context.executing_eagerly():
        ...
        try:
            ...
            if outer_graph is not None:
                outer_graph._device_function_stack = (
                    outer_device_stack  # pylint: disable=protected-access
                )
