...
class BoundedTensorSpecTest(test_util.TensorFlowTestCase):
    ...
    def testMinimumMaximumAttributes(self):
        spec = tensor_spec.BoundedTensorSpec((1, 2, 3), dtypes.float32, 0, (5, 5, 5))
    ...
    def testReuseSpec(self):
        spec_1 = tensor_spec.BoundedTensorSpec(
    ...
    def testEquality(self):
        spec_1_1 = tensor_spec.BoundedTensorSpec(
        ...
        spec_2_1 = tensor_spec.BoundedTensorSpec(
            (1, 2, 3), dtypes.float32, 1, (5, 5, 5)
        )
        spec_2_2 = tensor_spec.BoundedTensorSpec(
            (1, 2, 3), dtypes.float32, (1, 1, 1), (5, 5, 5)
        )
        spec_2_3 = tensor_spec.BoundedTensorSpec(
            (1, 2, 3), dtypes.float32, (1, 1, 1), 5
        )
        spec_3_1 = tensor_spec.BoundedTensorSpec(
            (1, 2, 3), dtypes.float32, (2, 1, 1), (5, 5, 5)
        )
