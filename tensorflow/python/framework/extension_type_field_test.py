...
class ExtensionTypeFieldTest(test_util.TensorFlowTestCase, parameterized.TestCase):
    ...
    @parameterized.parameters(
        [
            ...
            ("x", int, "hello world", "default value for x: expected 'int', got 'str'"),
            (
                "seq",
                typing.Tuple[typing.Union[int, float], ...],
                [33, 12.8, "zero"],
            ...
            (
                "z",
                typing.Mapping[tensor.Tensor, int],
                {},
...
class ValidateFieldPyTypeTest(test_util.TensorFlowTestCase, parameterized.TestCase):
    ...
    @parameterized.parameters(
        [
            ...
            dict(
                tp=typing.Mapping[tensor.Tensor, int],
...
class FieldValueConverterTest(test_util.TensorFlowTestCase, parameterized.TestCase):
    ...
    @parameterized.parameters(
        [
            ...
            ({"a": (12, 3.0)}, typing.Mapping[str, _TUPLE[int, float]]),
            (
    ...
    def testConvertValueForSpec(self, value, value_type, expected=None):
        ...
        converted = extension_type_field._convert_value(
            value, value_type, ("x",), extension_type_field._ConversionContext.SPEC
        )
        if isinstance(converted, (tensor.Tensor, ragged_tensor.RaggedTensor)):
            self.assertAllEqual(converted, expected)
        else:
    ...
    @parameterized.parameters(
        [
            ...
            ([1, 2, 3.0], _TUPLE[int, ...], r"x\[2\]: expected 'int', got 'float'"),
            (
                "foo",
                tensor_shape.TensorShape,
