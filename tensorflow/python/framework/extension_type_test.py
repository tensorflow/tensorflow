...
class ExtensionTypeTest(test_util.TensorFlowTestCase, parameterized.TestCase):
    ...
    def testConstructorSignature(self):
        ...
        expected_parameters = [
            ...
            tf_inspect.Parameter("x", POSITIONAL_OR_KEYWORD, annotation=tensor.Tensor),
            tf_inspect.Parameter("y", POSITIONAL_OR_KEYWORD, annotation=tensor.Tensor),
    ...
    def testConstructorSignatureWithAnnotatedTensorField(self):
        ...
        expected_parameters = [
            tf_inspect.Parameter("self", POSITIONAL_OR_KEYWORD),
            tf_inspect.Parameter("a", POSITIONAL_OR_KEYWORD, annotation=tensor.Tensor),
            tf_inspect.Parameter(
                "b", POSITIONAL_OR_KEYWORD, annotation=str, default="Hello world"
            ),
            tf_inspect.Parameter(
    ...
    def testForwardReferences(self):
        ...
        expected_parameters = [
            ...
            tf_inspect.Parameter("y", POSITIONAL_OR_KEYWORD, annotation="ForwardRefB"),
        ]
    ...
    def testSubclassing(self):
        ...
        self.assertEqual(
            list(tf_inspect.signature(StringInstrument.__init__).parameters.values()),
            [
                tf_inspect.Parameter("self", POSITIONAL_OR_KEYWORD),
                tf_inspect.Parameter(
        ...
        self.assertEqual(
            ...
            [
                ...
                tf_inspect.Parameter("weight", KEYWORD_ONLY, annotation=tensor.Tensor),
                tf_inspect.Parameter(
                ...
                tf_inspect.Parameter("maker", KEYWORD_ONLY, annotation=tensor.Tensor),
            ],
        )
