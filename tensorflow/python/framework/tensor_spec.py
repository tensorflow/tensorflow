...
class DenseSpec(type_spec.TypeSpec):
    ...
    def most_specific_compatible_type(self, other):
        if (type(self) is not type(other)) or (self._dtype != other.dtype):
            raise ValueError(
                f"Types are not compatible: {self!r} with type of "
...
class TensorSpec(DenseSpec, type_spec.BatchableTypeSpec):
    ...
    def _to_components(self, value):
        try:
            ...
            raise ValueError(
                f"Value {value} is not convertible to a tensor with "
...
class BoundedTensorSpec(TensorSpec):
    ...
    def __init__(self, shape, dtype, minimum, maximum, name=None):
        ...
        try:
            ...
            raise ValueError(
                f"`minimum` {minimum} is not compatible with shape "
        ...
        try:
            ...
            raise ValueError(
                f"`maximum` {maximum} is not compatible with shape "
                f"{self.shape}. Original error: {exception!r}."
            )
