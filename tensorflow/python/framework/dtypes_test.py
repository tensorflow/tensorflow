...
class TypesTest(test_util.TensorFlowTestCase, parameterized.TestCase):
    ...
    def testNumpyConversion(self):
        ...
        self.assertIs(dtypes.float8_e4m3fn, dtypes.as_dtype(dtypes._np_float8_e4m3fn))
        self.assertIs(dtypes.float4_e2m1fn, dtypes.as_dtype(dtypes._np_float4_e2m1fn))
        self.assertIs(
    ...
    def testStringConversion(self):
        ...
        self.assertIs(dtypes.float8_e4m3b11fnuz, dtypes.as_dtype("float8_e4m3b11fnuz"))
        ...
        self.assertIs(dtypes.float8_e4m3fn_ref, dtypes.as_dtype("float8_e4m3fn_ref"))
        self.assertIs(dtypes.float4_e2m1fn_ref, dtypes.as_dtype("float4_e2m1fn_ref"))
    ...
    def testDTypeSupertypes(self):
        self.assertEqual(
            dtypes.string, dtypes.string.most_specific_common_supertype([])
        )
        self.assertEqual(
            dtypes.string, dtypes.string.most_specific_common_supertype([dtypes.string])
        )
        self.assertIsNone(dtypes.string.most_specific_common_supertype([dtypes.uint32]))
