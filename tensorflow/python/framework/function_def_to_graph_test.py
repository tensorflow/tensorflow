...
class FunctionDefToGraphTest(test.TestCase):
    def _build_function_def(self):
        ...
        fdef = graph_to_function_def.graph_to_function_def(
            g, g.get_operations(), [x, y], [sum_squares, sum_cubes]  # Inputs
        )  # Outputs.
    ...
    def testShapes(self):
        ...
        g = function_def_to_graph.function_def_to_graph(
            fdef,
            input_shapes=[tensor_shape.TensorShape([5]), tensor_shape.TensorShape([5])],
        )
...
class FunctionDefToGraphDefTest(test.TestCase):
    def _build_function_def(self):
        ...
        fdef = graph_to_function_def.graph_to_function_def(
            g, g.get_operations(), [x, y, z], [x, d_2, e_2, list_output0]  # Inputs
        )  # Outputs.
    ...
    def testTensorNames(self):
        ...
        self.assertSequenceEqual(
            g.node[5].input, ["foo_1:0", "foo_1:1", "list_output:1"]
        )
