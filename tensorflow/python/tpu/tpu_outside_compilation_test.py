    ...
    def testColocateGradientWithOutsideCompiledOp(self):
        ...
        def train_step():
            ...
            def tpu_fn(x):
                ...
                assert (
                    sqrt_grad.get_attr(tpu_replication._OUTSIDE_COMPILATION_ATTR)
                    == b"0.gradients/uid"
                )
                return grad
...
class OutsideCompilationOnUnsupportedOpTest(test.TestCase, parameterized.TestCase):
        ...
        def train_step(a, b):
            def fn(a, b):
                ...
                result = array_ops.identity(
                    cond.cond(pred, fn1, fn2), name="uncompilable_control_flow"
                )
                return result
    ...
    def testOutsideCompilationWithTPUPartitionedCallOp(self):
        ...
        concrete = partitioned_tpu_fn.get_concrete_function(
            x=tensor.TensorSpec(shape=(1), dtype=dtypes.float32, name="input_tensor")
        )
