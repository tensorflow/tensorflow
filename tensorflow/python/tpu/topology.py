...
class Topology(object):
    ...
    def __init__(self, serialized=None, mesh_shape=None, device_coordinates=None):
        ...
        if serialized:
            ...
            self._device_coordinates = numpy_compat.np_asarray(
                device_coordinates, dtype=np.int32
            )
            ...
            if len(
                ...
                raise ValueError(
                    ...
                    "got device_coordinates.shape={} len(device_coordinates.shape)={} device_coordinates.shape[2]={} mesh_shape={}, len(mesh_shape)={}".format(
                        self._device_coordinates.shape,
