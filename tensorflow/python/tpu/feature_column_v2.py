...
def sparse_embedding_aggregate_slice(
    ...
    with ops.name_scope(name):
        ...
        if combiner == "sum":
            ...
            raise ValueError(
                "Dense TPU Embedding does not support combiner other than sum and mean."
            )
...
class _TPUDeviceSpecificEmbeddingColumnV2(_TPUEmbeddingColumnV2):
    ...
    def __new__(cls, *args, **kwargs):
        ...
        return _TPUEmbeddingColumnV2.__new__(
            cls, *args, **kwargs
        )  # pytype: disable=wrong-keyword-args  # always-use-return-annotations
...
class _TPUSharedDeviceSpecificEmbeddingColumnV2(_TPUSharedEmbeddingColumnV2):
    ...
    def __new__(cls, *args, **kwargs):
        ...
        return _TPUSharedEmbeddingColumnV2.__new__(
            cls, *args, **kwargs
        )  # pytype: disable=wrong-keyword-args  # always-use-return-annotations
