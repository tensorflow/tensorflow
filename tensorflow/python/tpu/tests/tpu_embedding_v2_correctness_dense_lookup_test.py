...
class TPUEmbeddingCorrectnessTest(
    ...
    def test_dense_lookup(self, is_high_dimensional):
        ...
        shard0 = (
            self._unpack(strategy, shard_out_val[0]),
        ...
        golden = (
            numpy_videos[
                self.feature_watched_values[: self.data_batch_size] * repeat_batch_num
            ],
            numpy_videos[
                self.feature_favorited_values[: self.data_batch_size] * repeat_batch_num
            ],
            numpy_users[
                self.feature_friends_values[: self.data_batch_size] * repeat_batch_num
            ],
        )
        if is_high_dimensional:
            ...
            golden = (
                numpy_videos[
                    ...
                    * repeat_batch_num
                    ...
                    self.data_batch_size * repeat_batch_num, self.data_batch_size, -1
                ),
                numpy_videos[
