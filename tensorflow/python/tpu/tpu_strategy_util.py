...
_tpu_worker_address = monitoring.StringGauge(
    ...
    "The worker address that the coordinator/client connects to.",
    "address",
)
...
def initialize_tpu_system_impl(cluster_resolver, tpu_cluster_resolver_cls):
    ...
    if (
        tpu_cluster_resolver_cls is None
        or not issubclass(
    ...
    if context.executing_eagerly():
        ...
        try:
            ...
            raise errors.NotFoundError(
                None,
                None,
                "TPUs not found in the cluster. Failed in initialization: " + str(e),
            )
        finally:
