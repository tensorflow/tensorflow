...
class TPUEmbeddingV0(tpu_embedding_base.TPUEmbeddingBase):
    ...
    def __init__(
        ...
        if not isinstance(
            ...
            raise RuntimeError(
                "TPUEmbeddingV0 should be created under TPUStrategy but found {}.".format(
                    self._strategy
                )
            )
        self._built = False
    ...
    def _pad_or_truncate_with_sequence_length(
        ...
        if original_sequence_length > sequence_length:
            ...
            embeddings = array_ops.pad(
                ...
                paddings=[
                    [0, 0],
                    [0, sequence_length - original_sequence_length],
                    [0, 0],
                ],
            )
        return embeddings
