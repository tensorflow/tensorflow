...
class DeviceAssignment(object):
    ...
    def coordinates(
        self, replica: int, logical_core: int
    ...
    def host_device(
        self, replica: int = 0, logical_core: int = 0, job: Optional[Text] = None
    ) -> Text:
    ...
    def build(
        ...
        return device_assignment(
            topology, computation_shape, computation_stride, num_replicas
        )
