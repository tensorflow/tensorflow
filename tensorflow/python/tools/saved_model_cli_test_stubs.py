"""Test-only stubs to import saved_model_cli without full TensorFlow deps."""
...
def ensure_package(name, path=None):
...
def install_saved_model_cli_stubs():
  ...
  ensure_package('tensorflow.python')
  ensure_package('tensorflow.python.tools', 'tensorflow/python/tools')
  ensure_package('tensorflow.python.util')
  ...
  ensure_package('tensorflow.python.lib')
  ensure_package('tensorflow.python.lib.io')
  ...
  ensure_package('tensorflow.python.saved_model')
  ...
  debug_pkg = ensure_package('tensorflow.python.debug')
  wrappers_pkg = ensure_package('tensorflow.python.debug.wrappers')
  ...
  saved_model_utils_mod = types.ModuleType('tensorflow.python.tools.saved_model_utils')
  saved_model_utils_mod.get_meta_graph_def = lambda *args, **kwargs: types.SimpleNamespace()
  saved_model_utils_mod.read_saved_model = lambda *args, **kwargs: types.SimpleNamespace(meta_graphs=[])
  sys.modules['tensorflow.python.tools.saved_model_utils'] = saved_model_utils_mod
  ...
  ensure_package('tensorflow.core')
  ensure_package('tensorflow.core.example')
  ...
  ensure_package('tensorflow.core.framework')
  ...
  ensure_package('tensorflow.core.protobuf')
  ...
  try:
    ...
    ensure_package('google')
    ensure_package('google.protobuf')
  ...
  platform_pkg = ensure_package('tensorflow.python.platform')
  ...
  client_pkg = ensure_package('tensorflow.python.client')
  ...
  eager_pkg = ensure_package('tensorflow.python.eager')
  ...
  framework_pkg = ensure_package('tensorflow.python.framework')
  ...
  tpu_pkg = ensure_package('tensorflow.python.tpu')
