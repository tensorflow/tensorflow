...
# copybara: uncomment load("@rules_python//python/private:reexports.bzl", _ActualBuiltinPyInfo = "BuiltinPyInfo")

# Within Google, the PyInfo symbol is removed
# copybara:uncomment _ActualBuiltinPyInfo = None

def _get_builtin_py_info():
    # May be None in Bazel 8+
    if _ActualBuiltinPyInfo == None:
        return None
