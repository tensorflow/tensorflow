...
def _get_module_docstring(docs_by_module: Mapping[str, str], module: str) -> str:
            ...
            if module == output_package and root_template_path:
                with open(root_template_path, "r") as template:
                    ...
                    content = content.replace(
                        "# API IMPORTS PLACEHOLDER", module_imports
                    )
...
__all__.extend([_s for _s in _names_with_underscore])
          """
                    ...
                    content = content.replace(
                        "# __all__ PLACEHOLDER", root_module_footer
                    )
...
def gen_nested_compat_files(
    ...
    if compat_module in generated_imports_by_module:
        nested_generated_imports_by_module[compat_module] = generated_imports_by_module[
            compat_module
        ]
