...
_TENSORFLOW_DOC_SOURCES = {
    ...
    "distribute": DocSource(docstring_module_name="distribute"),
    ...
    "gfile": DocSource(docstring="Import router for file_io."),
    ...
    "metrics": DocSource(docstring="Evaluation-related metrics."),
    "nest": DocSource(docstring_module_name="util.nest"),
    "nn": DocSource(docstring_module_name="ops.nn_ops"),
    "nn.rnn_cell": DocSource(docstring="Module for constructing RNN Cells."),
    "python_io": DocSource(docstring_module_name="lib.io.python_io"),
    "ragged": DocSource(docstring_module_name="ops.ragged"),
    "resource_loader": DocSource(docstring="Resource management library."),
    ...
    "sysconfig": DocSource(docstring="System configuration library."),
    "test": DocSource(docstring="Testing."),
    "train": DocSource(
        docstring=(
...
_KERAS_DOC_SOURCES = {
    "keras.optimizers.experimental": DocSource(
        docstring_module_name="optimizers.optimizer_experimental"
    )
}
