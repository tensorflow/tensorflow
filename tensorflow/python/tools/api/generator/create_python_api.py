...
def main():
    ...
    parser.add_argument(
        ...
        default=False,
        type=bool,
        help="Whether to import submodules using relative imports or absolute imports",
    )
    parser.add_argument(
        "--proxy_module_root",
        default=None,
    ...
    if args.loading == "default":
        ...
        raise ValueError(
            f"Invalid value for --loading flag: {args.loading}. Must "
            "be one of lazy, static, default."
        )
    if args.proxy_module_root is None:
        create_primary_api_files(
            outputs,
            packages,
            packages_to_ignore,
