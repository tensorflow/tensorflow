...
@tf_export("types.experimental.func.TraceType", v1=[])
class TraceType(metaclass=abc.ABCMeta):
  ...
  ```python
  class FruitTraceType(tf.types.experimental.func.TraceType):
...
@tf_export("types.experimental.func.TracingContext", v1=[])
...
tf_export(
    "types.experimental.func.SupportsTracingProtocol",
