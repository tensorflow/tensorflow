...
# =============================================================================
"""Saves a TensorFlow model with a VariableV2 node used in 2 engines.

   The saved model is loaded and executed by tests to check that TF-TRT can
   successfully convert and execute the model.
"""
...
def GenerateModelWithVariableV2OneVarTwoEngines(tf_saved_model_dir):
  """Generates a model to test 1 VariableV2 node used in 2 engines."""

  def SimpleModel():
    """Defines model with a TF graph."""
    ...
    def GraphFn():
      ...
      var1 = variable_scope.get_variable(
          ...
          initializer=init_ops.constant_initializer(np.reshape(
...
if __name__ == "__main__":
  GenerateModelWithVariableV2OneVarTwoEngines(
