...
def _check_trt_version_compatibility():
  ...
  def raise_trt_version_deprecated(version_type, trt_version):
    ...
    logging.error(
        ...
        "been removed. Please upgrade to TensorRT 7 or more recent.".format(
            ...
            trt_version=trt_utils._version_tuple_to_string(trt_version)))
  ...
  if (loaded_version[0] != linked_version[0] or
    ...
    logging.error(
        ...
        trt_utils._version_tuple_to_string(loaded_version),
        trt_utils._version_tuple_to_string(linked_version))
    ...
    logging.info(
        ...
        "compatible.", trt_utils._version_tuple_to_string(loaded_version),
        trt_utils._version_tuple_to_string(linked_version))
