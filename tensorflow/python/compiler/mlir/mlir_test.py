...
class MLIRGraphDefImportTest(test.TestCase):
    ...
    def testInvalidPbtxt(self):
        with self.assertRaisesRegex(
            errors.InvalidArgumentError, "Could not parse input proto"
        ):
    ...
    def testGraphDefToTf(self):
        ...
        # inputs and outputs.
        self.assertRegex(
            mlir_tf, r"func @main\(%arg0: tensor<10x10xf32>, %arg1: tensor<10x10xf32>"
        )
        ...
        self.assertRegex(mlir_tf, r"func @main\(%arg0: tensor<f32>, %arg1: tensor<f32>")
        ...
        with self.assertRaisesRegex(
            errors.InvalidArgumentError, "Dimensions must be equal"
        ):
            import_graphdef(
                tf_graph_def,
                "tf-standard-pipeline",
