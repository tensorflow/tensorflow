...
class TracingCompilationTest(test.TestCase, parameterized.TestCase):
    ...
    def testFunctionWithInvalidAttribute(self):
        ...
        with self.assertRaisesRegex(
            ValueError,
            "Tracing compilation does not support `experimental_1` as an attribute.",
        ):
    ...
    def testSwapImplementationWithGrapplerPlugin(self, cpu_decorator, gpu_decorator):
        ...
        with (
            context.graph_mode(),
            self.cached_session(config=config_proto, graph=ops.Graph(), use_gpu=True),
        ):
    ...
    def testDictReturned(self):
        ...
        fn_op2 = fn.get_concrete_function(
            z=(
                ...
                tensor_lib.TensorSpec(shape=(), dtype=dtypes.float32, name="z_second"),
            ),
        ...
        fn_op3 = fn.get_concrete_function(
            ...
            z=(
                tensor_lib.TensorSpec(shape=(None,), dtype=dtypes.float32, name="z1"),
