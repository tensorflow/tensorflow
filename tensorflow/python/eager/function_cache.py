...
class FunctionCacheKey(trace.TraceType):
    ...
    def __eq__(self, other) -> bool:
        ...
        return (
            self.call_context == other.call_context and self.arg_spec == other.arg_spec
        )

    def __repr__(self) -> str:
        return (
            f"{type(self).__name__}(arg_spec={repr(self.arg_spec)},"
