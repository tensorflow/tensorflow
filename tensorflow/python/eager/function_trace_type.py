...
class OrderedCollectionType(trace.TraceType):
    ...
    def __repr__(self):
        return "{}(components={})".format(type(self).__name__, repr(self.components))
...
class AttrsType(OrderedCollectionType):
    ...
    def __init__(self, classtype: Type[object], attributes: Tuple[trace.TraceType]):
