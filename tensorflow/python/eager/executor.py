...
def new_executor(enable_async, enable_streaming_enqueue=True, in_flight_nodes_limit=0):
    handle = pywrap_tfe.TFE_NewExecutor(
        enable_async, enable_streaming_enqueue, in_flight_nodes_limit
    )
