...
class CheckpointViewTest(test.TestCase):
    def test_children(self):
        ...
        current_name, node_id = next(
            iter(checkpoint_view.CheckpointView(root_save_path).children(0).items())
        )
    ...
    def test_match(self):
        ...
        self.assertDictEqual(
            matching_nodes, {0: root2, 1: leaf11, 2: leaf12, 4: leaf13, 6: leaf15}
        )
    ...
    def test_diff(self):
        ...
        self.assertDictEqual(
            diff[0], {0: root2, 1: leaf11, 2: leaf12, 4: leaf13, 6: leaf15}
        )
