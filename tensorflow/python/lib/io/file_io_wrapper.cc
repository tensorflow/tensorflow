...
PYBIND11_MODULE(_pywrap_file_io, m, pybind11::mod_gil_not_used()) {
  m.def(
      "FileExists",
  ...
  py::class_<WritableFile>(m, "WritableFile")
      ...
      .def("append",
           [](py::object self_obj, absl::string_view data) {
             ...
             const auto status =
                 RunFileObjectMethod(self_obj, /*release_gil=*/false,
      ...
      .def("tell",
           [](py::object self_obj) {
             ...
             int64_t pos = -1;
             const auto status =
                 RunFileObjectMethod(self_obj, /*release_gil=*/true,
      ...
      .def("close", [](py::object self_obj) {
        ...
        const auto status = RunFileObjectMethod(
            self_obj, /*release_gil=*/true, [&]() { return self->Close(); });
        tensorflow::MaybeRaiseRegisteredFromStatus(status);
      });
  ...
  py::class_<BufferedInputStream>(m, "BufferedInputStream")
      ...
      .def("tell", [](py::object self_obj) {
        ...
        return RunFileObjectMethod(self_obj, /*release_gil=*/true,
                                   [&]() { return self->Tell(); });
      });
}
}  // namespace
