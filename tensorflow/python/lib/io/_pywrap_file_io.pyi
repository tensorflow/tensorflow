...
class BufferedInputStream:
    def __init__(
        self, filename: str, buffer_size: int, token: TransactionToken = ...
    ) -> None: ...
...
class WritableFile:
    def __init__(
        self, filename: str, mode: str, token: TransactionToken = ...
    ) -> None: ...
...
def CopyFile(
    src: str, target: str, overwrite: bool, token: TransactionToken = ...
) -> None: ...
...
def WriteStringToFile(
    filename: str, data: str, token: TransactionToken = ...
) -> None: ...
