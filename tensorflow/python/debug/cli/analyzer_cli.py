...
class DebugAnalyzer(object):
    ...
    def _build_argument_parsers(self, config):
        ...
        ap.add_argument(
            ...
            type=int,
            default=10,
            help="Maximum number of elements (ops or Tensors) to show per source line.",
        )
        ap.add_argument(
            "-b",
            "--line_begin",
    ...
    def print_tensor(self, args, screen_info=None):
        ...
        if (
            self._debug_dump.loaded_partition_graphs()
...
def create_analyzer_ui(
    debug_dump, tensor_filters=None, ui_type="readline", on_ui_exit=None, config=None
):
