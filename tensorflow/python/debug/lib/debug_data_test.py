...
class DebugDumpDirTest(test_util.TensorFlowTestCase):
    ...
    def _makeDataDirWithMultipleDevicesAndDuplicateNodeNames(self):
        ...
        open(
            os.path.join(cpu_0_dir, "node_foo_1_2_DebugIdentity_1472563253536386"), "wb"
        )
        open(
            os.path.join(gpu_0_dir, "node_foo_1_2_DebugIdentity_1472563253536385"), "wb"
        )
        open(
            os.path.join(gpu_1_dir, "node_foo_1_2_DebugIdentity_1472563253536387"), "wb"
        )
    ...
    def testDebugDumpDir_validDuplicateNodeNamesWithMultipleDevices(self):
        ...
        dump_dir = debug_data.DebugDumpDir(
            self._dump_root, partition_graphs=[graph_cpu_0, graph_gpu_0, graph_gpu_1]
        )
