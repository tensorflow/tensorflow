...
Status AssetManagerFileSystem::FileExists(const string& fname/*, TransactionToken* token */) {
...
Status AssetManagerFileSystem::GetFileSize(const string& fname, uint64* s/*, TransactionToken* token */) {
...
Status AssetManagerFileSystem::Stat(const string& fname, FileStatistics* stat/*, TransactionToken* token */) {
  uint64 size;
...
bool AssetManagerFileSystem::DirectoryExists(const std::string& fname/*, TransactionToken* token */) {
...
Status AssetManagerFileSystem::DeleteFile(const string& f/*, TransactionToken* token */) {
  return errors::Unimplemented("Asset storage is read only.");
}
Status AssetManagerFileSystem::CreateDir(const string& d/*, TransactionToken* token */) {
  return errors::Unimplemented("Asset storage is read only.");
}
Status AssetManagerFileSystem::DeleteDir(const string& d/*, TransactionToken* token */) {
  return errors::Unimplemented("Asset storage is read only.");
}
Status AssetManagerFileSystem::RenameFile(const string& s, const string& t/*, TransactionToken* token */) {
  return errors::Unimplemented("Asset storage is read only.");
}
