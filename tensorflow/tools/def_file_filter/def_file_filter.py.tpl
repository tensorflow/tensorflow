...
INCLUDEPRE_RE = re.compile(r"absl::lts_[0-9]+::base_internal::ThrowStdOutOfRange|" # for _pywrap_tfe
                           ...
                           r"absl::lts_[0-9]+::status_internal::MapToLocalCode|"  # for absl::Status
                           r"absl::lts_[0-9]+::Status::Status|" # for absl::Status
                           r"absl::lts_[0-9]+::Status::PrepareToModify|" # for absl::Status
...
def main():
  ...
  with open(args.output, "w") as def_fp:
    ...
    def_fp.write("\t ?SlowIsEnabled@VLogSite@log_internal@lts_20240116@absl@@AEAA_NHH@Z\n")
    def_fp.write("\t ??0LogMessage@log_internal@lts_20240116@absl@@QEAA@PEBDHUInfoTag@0123@@Z\n")
    ...
    def_fp.write("\t ?Unref@StatusRep@status_internal@lts_20240116@absl@@QEBAXXZ\n")
