...
INCLUDEPRE_RE = re.compile(r"absl::lts_[0-9]+::base_internal::ThrowStdOutOfRange|" # for _pywrap_tfe
                           ...
                           r"absl::lts_[0-9]+::log_internal|" # for _pywrap_tfe
                           ...
                           r"absl::lts_[0-9]+::status_internal::StatusRep::Unref|"  # for absl::Status
...
def main():
  ...
  with open(args.output, "w") as def_fp:
    ...
    def_fp.write("\t ?kSooControl@container_internal@lts_20240722@absl@@3QBW4ctrl_t@123@B\n") # for _pywrap_tfe
