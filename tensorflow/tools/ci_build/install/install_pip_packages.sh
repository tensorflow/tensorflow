...
if $(cat /etc/*-release | grep -q 14.04); then
  pip2 install --no-binary=:all: --upgrade numpy==1.14.4
  pip3 install --no-binary=:all: --upgrade numpy==1.14.4
else
  pip2 install --upgrade numpy==1.14.4
  pip3 install --upgrade numpy==1.14.4
fi
