...
flags.DEFINE_boolean(
    "test_log_output_use_tmpdir", False, "Whether to store the log output into tmpdir."
)
flags.DEFINE_string(
    "benchmark_type", "", """Benchmark type (BenchmarkType enum string)."""
)
flags.DEFINE_string(
...
flags.DEFINE_string(
    "test_log_output_dir", "", """Directory for benchmark results output."""
)
flags.DEFINE_string(
...
def main(unused_args):
    ...
    if FLAGS.test_log_output_filename:
        ...
        file_name = name.strip("/").translate(
            str.maketrans("/:", "__")
