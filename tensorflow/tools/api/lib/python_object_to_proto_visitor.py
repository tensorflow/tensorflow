...
if sys.version_info.major == 3:
    ...
    _NORMALIZE_ISINSTANCE = {
        ...
        "<class 'tensorflow.lite.python.op_hint.OpHintArgumentTracker'>",
        "<class "
        ...
        "<class 'tensorflow.python.ops.variables.Variable.SaveSliceInfo'>": "<class "
...
_NORMALIZE_TYPE["tensorflow.python.framework.tensor.Tensor"] = (
