...
def build_docs(output_dir, code_url_prefix, search_hints):
    ...
    expected_path_contents = {
        ...
        "tf/keras/preprocessing/image/random_brightness.md": "keras_preprocessing/image/affine_transformations.py",
    }
    ...
    if num_files < 2000:
        raise ValueError(
            "The TensorFlow api should be more than 2000 files"
