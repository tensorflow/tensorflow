...
EXTRA_PACKAGES = {
    'and-cuda': [
        ...
        'nvidia-cublas-cu12 >= 12.5.3.2, == 12.*',
        'nvidia-cuda-cupti-cu12 >= 12.5.82, == 12.*',
        'nvidia-cuda-nvcc-cu12 >= 12.5.82, == 12.*',
        'nvidia-cuda-nvrtc-cu12 >= 12.5.82, == 12.*',
        'nvidia-cuda-runtime-cu12 >= 12.5.82, == 12.*',
        'nvidia-cudnn-cu12 >= 9.3.0.75, == 9.*',
        'nvidia-cufft-cu12 >= 11.2.3.61, == 11.*',
        'nvidia-curand-cu12 >= 10.3.6.82, == 10.*',
        'nvidia-cusolver-cu12 >= 11.6.3.83, == 11.*',
        'nvidia-cusparse-cu12 >= 12.5.1.3, == 12.*',
        'nvidia-nccl-cu12 >= 2.25.1, == 2.*',
        'nvidia-nvjitlink-cu12 >= 12.5.82, == 12.*',
    ],
    'gcs-filesystem': [
