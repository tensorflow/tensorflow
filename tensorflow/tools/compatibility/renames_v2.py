...
renames = {
    ...
    'tf.data.FixedLengthRecordDataset': 'tf.compat.v1.data.FixedLengthRecordDataset',
    'tf.data.TFRecordDataset': 'tf.compat.v1.data.TFRecordDataset',
    'tf.data.TextLineDataset': 'tf.compat.v1.data.TextLineDataset',
    'tf.data.experimental.Counter': 'tf.compat.v1.data.experimental.Counter',
    'tf.data.experimental.CsvDataset': 'tf.compat.v1.data.experimental.CsvDataset',
    'tf.data.experimental.RandomDataset': 'tf.compat.v1.data.experimental.RandomDataset',
    'tf.data.experimental.SqlDataset': 'tf.compat.v1.data.experimental.SqlDataset',
    'tf.data.experimental.choose_from_datasets': 'tf.compat.v1.data.experimental.choose_from_datasets',
    'tf.data.experimental.make_batched_features_dataset': 'tf.compat.v1.data.experimental.make_batched_features_dataset',
    'tf.data.experimental.make_csv_dataset': 'tf.compat.v1.data.experimental.make_csv_dataset',
    'tf.data.experimental.sample_from_datasets': 'tf.compat.v1.data.experimental.sample_from_datasets',
