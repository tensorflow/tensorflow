...
However, these Dockerfiles are still used to build [TensorFlow's official Docker
images](https://hub.docker.com/r/tensorflow/tensorflow) while the internal
infrastructure for the newer Dockerfiles is being developed.
