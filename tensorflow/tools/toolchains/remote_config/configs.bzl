...
def initialize_rbe_configs():
    ...
    ml_build_rbe_config("docker://us-docker.pkg.dev/ml-oss-artifacts-published/ml-public-container/ml-build@sha256:b7b82e95f15719a3a088c23ab25260b0712a4ceb9ef400832b95cb3cce644b30")
