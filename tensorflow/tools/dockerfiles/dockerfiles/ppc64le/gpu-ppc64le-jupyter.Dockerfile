...
RUN wget https://raw.githubusercontent.com/tensorflow/docs/r2.0/site/en/tutorials/keras/classification.ipynb
RUN wget https://raw.githubusercontent.com/tensorflow/docs/r2.0/site/en/tutorials/keras/text_classification.ipynb
