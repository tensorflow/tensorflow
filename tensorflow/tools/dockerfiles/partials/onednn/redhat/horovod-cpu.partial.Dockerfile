...
ADD https://raw.githubusercontent.com/Intel-tensorflow/tensorflow/v2.8.0/LEGAL-NOTICE ./licenses/
ADD https://raw.githubusercontent.com/Intel-tensorflow/tensorflow/v2.8.0/LICENSE ./licenses/
ADD https://raw.githubusercontent.com/Intel-tensorflow/tensorflow/v2.8.0/third_party_programs_license/oneDNN-THIRD-PARTY-PROGRAMS ./licenses/third_party_programs_license/
ADD https://raw.githubusercontent.com/Intel-tensorflow/tensorflow/v2.8.0/third_party_programs_license/third-party-programs.txt ./licenses/third_party_programs_license/
