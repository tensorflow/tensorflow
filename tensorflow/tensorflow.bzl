...
def tf_gpu_library(deps = None, cuda_deps = None, copts = tf_copts(), **kwargs):
    """Generate a cc_library with a conditional set of CUDA dependencies.
      ...
      - In addition, when the library is also built with TensorRT or NCCL
          enabled, it additionally passes -DGOOGLE_TENSORRT=1 or -DGOOGLE_NCCL=1
          to the list of copts.
