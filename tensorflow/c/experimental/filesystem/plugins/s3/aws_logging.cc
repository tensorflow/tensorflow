...
static const std::map<int, Aws::Utils::Logging::LogLevel> log_levels_tf_to_aws =
    {{tensorflow::INFO, Aws::Utils::Logging::LogLevel::Info},
     {tensorflow::WARNING, Aws::Utils::Logging::LogLevel::Warn},
     {tensorflow::ERROR, Aws::Utils::Logging::LogLevel::Error},
     {tensorflow::FATAL, Aws::Utils::Logging::LogLevel::Fatal}};
...
void AWSLogSystem::Log(Aws::Utils::Logging::LogLevel log_level, const char* tag,
  ...
  const std::string s = tensorflow::strings::Printf(format, args);
...
static tensorflow::mutex s3_logging_mutex(tensorflow::LINKER_INITIALIZED);
void AWSLogSystem::InitializeAWSLogging() {
  std::lock_guard<tensorflow::mutex> s3_logging_lock(s3_logging_mutex);
  if (!initialized) {
