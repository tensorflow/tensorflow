...
// Sets a custom Executor for the current thread. All nodes created by this thread
// will be added to this Executor. It will override the current executor.
...
// devices, so executing tf.functions which contain operations placed on the custom
// devices will fail.
//
...
// error info if error happens. If so, the status will be set with the error info.
