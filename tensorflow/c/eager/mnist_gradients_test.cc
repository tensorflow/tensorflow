...
//  public:
//   explicit ReluMulGradientFunction(AbstractContext* ctx, std::vector<AbstractTensorHandle*> f_inputs) : 
//             ctx_(ctx), forward_inputs(f_inputs) {}
...
// // Computes `SoftmaxLoss(scores, labels)` and records it on the tape.
