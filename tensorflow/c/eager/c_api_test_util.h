...
//Return a tensor handle containing 2D matrix containing given float data and dimensions
TFE_TensorHandle* TestMatrixTensorHandleWithInput(TFE_Context* ctx, float data[], int64_t dims [], int num_dims);

//Return a tensor handle containing 2D matrix containing given int32 data and dimensions
