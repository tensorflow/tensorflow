...
x_max7 {
  x_x.7.0 = f32[] parameter(0)
  x_y.7.1 = f32[] parameter(1)
  ROOT x_maximum.7.2 = f32[] maximum(f32[] x_x.7.0, f32[] x_y.7.1)
}

x_add8 {
  x_x.8.0 = f32[] parameter(0)
  x_y.8.1 = f32[] parameter(1)
  ROOT x_add.8.2 = f32[] add(f32[] x_x.8.0, f32[] x_y.8.1)
}

x__pop_op_relu {
  x_constant.9.10.clone = f32[] constant(0), metadata={op_type="Relu" op_name="Relu"}
  x_broadcast.9.11.clone = f32[1,12]{1,0} broadcast(f32[] x_constant.9.10.clone), dimensions={}, metadata={op_type="Relu" op_name="Relu"}
  x_arg_0 = f32[1,12]{1,0} parameter(0)
  ROOT x_maximum.9.12.clone = f32[1,12]{1,0} maximum(f32[1,12]{1,0} x_broadcast.9.11.clone, f32[1,12]{1,0} x_arg_0), metadata={op_type="Relu" op_name="Relu"}
}

x__pop_op_relugrad {
  x_arg_0.1 = f32[1,12]{1,0} parameter(0)
  x_constant.9.10.clone.1 = f32[] constant(0), metadata={op_type="Relu" op_name="Relu"}
  x_broadcast.9.11.clone.1 = f32[1,12]{1,0} broadcast(f32[] x_constant.9.10.clone.1), dimensions={}, metadata={op_type="Relu" op_name="Relu"}
  x_greater-than.9.44.clone = pred[1,12]{1,0} compare(f32[1,12]{1,0} x_arg_0.1, f32[1,12]{1,0} x_broadcast.9.11.clone.1), direction=GT, metadata={op_type="ReluGrad" op_name="gradients/Relu_grad/ReluGrad"}
  x_arg_1 = f32[1,12]{1,0} parameter(1)
  ROOT x_select.9.45.clone = f32[1,12]{1,0} select(pred[1,12]{1,0} x_greater-than.9.44.clone, f32[1,12]{1,0} x_arg_1, f32[1,12]{1,0} x_broadcast.9.11.clone.1), metadata={op_type="ReluGrad" op_name="gradients/Relu_grad/ReluGrad"}
}

x__pop_op_wide_const {
  x_constant.9.6.clone = f32[] constant(0.01), metadata={op_type="Const" op_name="GradientDescent/learning_rate"}
  ROOT x_broadcast.9.39.clone = f32[12,12]{1,0} broadcast(f32[] x_constant.9.6.clone), dimensions={}, metadata={op_type="ResourceApplyGradientDescent" op_name="GradientDescent/update_w2/ResourceApplyGradientDescent"}
}

x__pop_op_wide_const.1 {
  x_constant.9.6.clone.1 = f32[] constant(0.01), metadata={op_type="Const" op_name="GradientDescent/learning_rate"}
  ROOT x_broadcast.9.48.clone = f32[4,12]{1,0} broadcast(f32[] x_constant.9.6.clone.1), dimensions={}, metadata={op_type="ResourceApplyGradientDescent" op_name="GradientDescent/update_w1/ResourceApplyGradientDescent"}
}

ENTRY x_cluster_1 {
  x_arg2.9.2 = f32[12,12]{1,0} parameter(2), metadata={op_name="XLA_Args"}
  x_call.2 = f32[12,12]{1,0} call(), to_apply=x__pop_op_wide_const, metadata={op_type="Const" op_name="GradientDescent/learning_rate"}
  x_arg0.9.0 = f32[1,4]{1,0} parameter(0), metadata={op_name="XLA_Args"}
  x_arg3.9.3 = f32[4,12]{1,0} parameter(3), metadata={op_name="XLA_Args"}
  x_dot.9.9 = f32[1,12]{1,0} dot(f32[1,4]{1,0} x_arg0.9.0, f32[4,12]{1,0} x_arg3.9.3), lhs_contracting_dims={1}, rhs_contracting_dims={0}, metadata={op_type="MatMul" op_name="MatMul"}
  x_call = f32[1,12]{1,0} call(f32[1,12]{1,0} x_dot.9.9), to_apply=x__pop_op_relu, metadata={op_type="Relu" op_name="Relu"}
  x_transpose.9.35 = f32[12,1]{0,1} transpose(f32[1,12]{1,0} x_call), dimensions={1,0}, metadata={op_type="MatMul" op_name="gradients/MatMul_1_grad/MatMul_1"}
  x_dot.9.13 = f32[1,12]{1,0} dot(f32[1,12]{1,0} x_call, f32[12,12]{1,0} x_arg2.9.2), lhs_contracting_dims={1}, rhs_contracting_dims={0}, metadata={op_type="MatMul" op_name="MatMul_1"}
  x_constant.9.14 = f32[] constant(-inf), metadata={op_type="SoftmaxCrossEntropyWithLogits" op_name="softmax_cross_entropy_with_logits_sg"}
  x_reduce.9.15 = f32[1]{0} reduce(f32[1,12]{1,0} x_dot.9.13, f32[] x_constant.9.14), dimensions={1}, to_apply=x_max7, metadata={op_type="SoftmaxCrossEntropyWithLogits" op_name="softmax_cross_entropy_with_logits_sg"}
  x_broadcast.9.16 = f32[1,12]{1,0} broadcast(f32[1]{0} x_reduce.9.15), dimensions={0}, metadata={op_type="SoftmaxCrossEntropyWithLogits" op_name="softmax_cross_entropy_with_logits_sg"}
  x_subtract.9.17 = f32[1,12]{1,0} subtract(f32[1,12]{1,0} x_dot.9.13, f32[1,12]{1,0} x_broadcast.9.16), metadata={op_type="SoftmaxCrossEntropyWithLogits" op_name="softmax_cross_entropy_with_logits_sg"}
  x_exponential.9.18 = f32[1,12]{1,0} exponential(f32[1,12]{1,0} x_subtract.9.17), metadata={op_type="SoftmaxCrossEntropyWithLogits" op_name="softmax_cross_entropy_with_logits_sg"}
  x_constant.9.10 = f32[] constant(0), metadata={op_type="Relu" op_name="Relu"}
  x_reduce.9.21 = f32[1]{0} reduce(f32[1,12]{1,0} x_exponential.9.18, f32[] x_constant.9.10), dimensions={1}, to_apply=x_add8, metadata={op_type="SoftmaxCrossEntropyWithLogits" op_name="softmax_cross_entropy_with_logits_sg"}
  x_broadcast.9.32 = f32[1,12]{1,0} broadcast(f32[1]{0} x_reduce.9.21), dimensions={0}, metadata={op_type="SoftmaxCrossEntropyWithLogits" op_name="softmax_cross_entropy_with_logits_sg"}
  x_divide.9.33 = f32[1,12]{1,0} divide(f32[1,12]{1,0} x_exponential.9.18, f32[1,12]{1,0} x_broadcast.9.32), metadata={op_type="SoftmaxCrossEntropyWithLogits" op_name="softmax_cross_entropy_with_logits_sg"}
  x_arg1.9.1 = f32[1,12]{1,0} parameter(1), metadata={op_name="XLA_Args"}
  x_subtract.9.34 = f32[1,12]{1,0} subtract(f32[1,12]{1,0} x_divide.9.33, f32[1,12]{1,0} x_arg1.9.1), metadata={op_type="SoftmaxCrossEntropyWithLogits" op_name="softmax_cross_entropy_with_logits_sg"}
  x_dot.9.36 = f32[12,12]{1,0} dot(f32[12,1]{0,1} x_transpose.9.35, f32[1,12]{1,0} x_subtract.9.34), lhs_contracting_dims={1}, rhs_contracting_dims={0}, metadata={op_type="MatMul" op_name="gradients/MatMul_1_grad/MatMul_1"}
  x_multiply.9.40 = f32[12,12]{1,0} multiply(f32[12,12]{1,0} x_call.2, f32[12,12]{1,0} x_dot.9.36), metadata={op_type="ResourceApplyGradientDescent" op_name="GradientDescent/update_w2/ResourceApplyGradientDescent"}
  x_subtract.9.41 = f32[12,12]{1,0} subtract(f32[12,12]{1,0} x_arg2.9.2, f32[12,12]{1,0} x_multiply.9.40), metadata={op_type="ResourceApplyGradientDescent" op_name="GradientDescent/update_w2/ResourceApplyGradientDescent"}
  x_call.3 = f32[4,12]{1,0} call(), to_apply=x__pop_op_wide_const.1, metadata={op_type="Const" op_name="GradientDescent/learning_rate"}
  x_transpose.9.46 = f32[4,1]{0,1} transpose(f32[1,4]{1,0} x_arg0.9.0), dimensions={1,0}, metadata={op_type="MatMul" op_name="gradients/MatMul_grad/MatMul_1"}
  x_transpose.9.37 = f32[12,12]{0,1} transpose(f32[12,12]{1,0} x_arg2.9.2), dimensions={1,0}, metadata={op_type="MatMul" op_name="gradients/MatMul_1_grad/MatMul"}
  x_dot.9.38 = f32[1,12]{1,0} dot(f32[1,12]{1,0} x_subtract.9.34, f32[12,12]{0,1} x_transpose.9.37), lhs_contracting_dims={1}, rhs_contracting_dims={0}, metadata={op_type="MatMul" op_name="gradients/MatMul_1_grad/MatMul"}
  x_call.1 = f32[1,12]{1,0} call(f32[1,12]{1,0} x_call, f32[1,12]{1,0} x_dot.9.38), to_apply=x__pop_op_relugrad, metadata={op_type="ReluGrad" op_name="gradients/Relu_grad/ReluGrad"}
  x_dot.9.47 = f32[4,12]{1,0} dot(f32[4,1]{0,1} x_transpose.9.46, f32[1,12]{1,0} x_call.1), lhs_contracting_dims={1}, rhs_contracting_dims={0}, metadata={op_type="MatMul" op_name="gradients/MatMul_grad/MatMul_1"}
  x_multiply.9.49 = f32[4,12]{1,0} multiply(f32[4,12]{1,0} x_call.3, f32[4,12]{1,0} x_dot.9.47), metadata={op_type="ResourceApplyGradientDescent" op_name="GradientDescent/update_w1/ResourceApplyGradientDescent"}
  x_subtract.9.50 = f32[4,12]{1,0} subtract(f32[4,12]{1,0} x_arg3.9.3, f32[4,12]{1,0} x_multiply.9.49), metadata={op_type="ResourceApplyGradientDescent" op_name="GradientDescent/update_w1/ResourceApplyGradientDescent"}
  ROOT x_tuple.9.55 = (f32[12,12]{1,0}, f32[4,12]{1,0}) tuple(f32[12,12]{1,0} x_subtract.9.41, f32[4,12]{1,0} x_subtract.9.50), metadata={op_name="XLA_Retvals"}
}
