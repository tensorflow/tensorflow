...
%pop_backprop_conv {
  ...
  ROOT %call.2.clone = f16[1,16,16,64]{3,2,1,0} fusion(f16[1,16,16,4]{3,2,1,0} %arg_0.3, f16[5,5,64,4]{3,2,1,0} %arg_1.3), kind=kCustom, calls=%_pop_op_conv_with_reverse, metadata={op_type="Conv2DBackpropInput" op_name="gradients/all/Conv2D_1_grad/Conv2DBackpropInput"}
}
...
%cluster_1  {
  ...
  %call.3 = f16[4]{0} fusion(), kind=kCustom, calls=%_pop_op_wide_const, metadata={op_type="Const" op_name="GradientDescent/update_all/1bias/Cast"}
  ...
  %call.9 = f16[1,16,16,64]{3,2,1,0} fusion(f16[1,16,16,4]{3,2,1,0} %arg0.19.0, f16[7,7,4,64]{3,2,1,0} %arg5.19.5), kind=kCustom, calls=%pop_convolution.1, metadata={op_type="Conv2D" op_name="all/Conv2D"}
  %arg4.19.4 = f16[64]{0} parameter(4), metadata={op_name="XLA_Args"}
  %call.1 = f16[1,16,16,64]{3,2,1,0} fusion(f16[1,16,16,64]{3,2,1,0} %call.9, f16[64]{0} %arg4.19.4), kind=kCustom, calls=%_pop_op_biasadd.1, metadata={op_type="Add" op_name="all/add"}
  %arg3.19.3 = f16[5,5,64,4]{3,2,1,0} parameter(3), metadata={op_name="XLA_Args"}
  %call.8 = f16[1,16,16,4]{3,2,1,0} fusion(f16[1,16,16,64]{3,2,1,0} %call.1, f16[5,5,64,4]{3,2,1,0} %arg3.19.3), kind=kCustom, calls=%pop_convolution, metadata={op_type="Conv2D" op_name="all/Conv2D_1"}
  %call = f16[1,16,16,4]{3,2,1,0} fusion(f16[1,16,16,4]{3,2,1,0} %call.8, f16[4]{0} %arg2.19.2), kind=kCustom, calls=%_pop_op_biasadd, metadata={op_type="Add" op_name="all/add_1"}
  ...
  %call.4 = f16[5,5,64,4]{3,2,1,0} fusion(), kind=kCustom, calls=%_pop_op_wide_const.1, metadata={op_type="Const" op_name="GradientDescent/update_all/1bias/Cast"}
  ...
  %call.10 = f16[5,5,64,4]{3,2,1,0} fusion(f16[1,16,16,64]{3,2,1,0} %call.1, f16[1,16,16,4]{3,2,1,0} %reshape.10), kind=kCustom, calls=%pop_convolution.2, metadata={op_type="Conv2DBackpropFilter" op_name="gradients/all/Conv2D_1_grad/Conv2DBackpropFilter"}
  ...
  %call.5 = f16[64]{0} fusion(), kind=kCustom, calls=%_pop_op_wide_const.2, metadata={op_type="Const" op_name="GradientDescent/update_all/1bias/Cast"}
  %call.7 = f16[1,16,16,64]{3,2,1,0} fusion(f16[1,16,16,4]{3,2,1,0} %reshape.10, f16[5,5,64,4]{3,2,1,0} %arg3.19.3), kind=kCustom, calls=%pop_backprop_conv, metadata={op_type="Conv2DBackpropInput" op_name="gradients/all/Conv2D_1_grad/Conv2DBackpropInput"}
  ...
  %call.6 = f16[7,7,4,64]{3,2,1,0} fusion(), kind=kCustom, calls=%_pop_op_wide_const.3, metadata={op_type="Const" op_name="GradientDescent/update_all/1bias/Cast"}
  ...
  %call.11 = f16[7,7,4,64]{3,2,1,0} fusion(f16[1,16,16,4]{3,2,1,0} %arg0.19.0, f16[1,16,16,64]{3,2,1,0} %convert.2), kind=kCustom, calls=%pop_convolution.3, metadata={op_type="Conv2DBackpropFilter" op_name="gradients/all/Conv2D_grad/Conv2DBackpropFilter"}
...
TEST_F(ConvolutionClassifierTest, SingleConvTraining) {
  ...
  ENTRY %cluster_1 {
    ...
    %call = f32[3,3,4,12]{3,2,1,0} fusion(), kind=kCustom, calls=%_pop_op_wide_const, metadata={op_type="Const" op_name="GradientDescent/learning_rate"}
    %arg0.7.0 = f32[1,24,24,4]{3,2,1,0} parameter(0), metadata={op_name="XLA_Args"}
    %call.4 = f32[1,24,24,12]{3,2,1,0} fusion(f32[1,24,24,4]{3,2,1,0} %arg0.7.0, f32[3,3,4,12]{3,2,1,0} %arg2.7.2), kind=kCustom, calls=%pop_convolution.1, metadata={op_type="Conv2D" op_name="Conv2D"}
    ...
    %call.1 = f32[1,12]{1,0} fusion(), kind=kCustom, calls=%_pop_op_wide_const.1, metadata={op_type="Mean" op_name="Mean"}
    ...
    %call.2 = f32[1,24,24,12]{3,2,1,0} fusion(), kind=kCustom, calls=%_pop_op_wide_const.2, metadata={op_type="Const" op_name="ConstantFolding/gradients/Mean_grad/truediv_recip"}
    ...
    %call.3 = f32[3,3,4,12]{3,2,1,0} fusion(f32[1,24,24,4]{3,2,1,0} %arg0.7.0, f32[1,24,24,12]{3,2,1,0} %multiply.7.50), kind=kCustom, calls=%pop_convolution, metadata={op_type="Conv2DBackpropFilter" op_name="gradients/Conv2D_grad/Conv2DBackpropFilter"}
...
ENTRY %cluster_1 {
  ...
  %call.2 = f32[12,12]{1,0} fusion(), kind=kCustom, calls=%_pop_op_wide_const, metadata={op_type="Const" op_name="GradientDescent/learning_rate"}
  ...
  %call = f32[1,12]{1,0} fusion(f32[1,12]{1,0} %dot.9.9), kind=kCustom, calls=%_pop_op_relu, metadata={op_type="Relu" op_name="Relu"}
  ...
  %call.3 = f32[4,12]{1,0} fusion(), kind=kCustom, calls=%_pop_op_wide_const.1, metadata={op_type="Const" op_name="GradientDescent/learning_rate"}
  ...
  %call.1 = f32[1,12]{1,0} fusion(f32[1,12]{1,0} %call, f32[1,12]{1,0} %dot.9.38), kind=kCustom, calls=%_pop_op_relugrad, metadata={op_type="ReluGrad" op_name="gradients/Relu_grad/ReluGrad"}
...
ENTRY %cluster_9 {
  ...
  %call = f32[32,32]{1,0} fusion(f32[32,32]{1,0} %add.17.8), kind=kCustom, calls=%_pop_op_relu, metadata={op_type="Relu" op_name="dense/Relu"}
  ...
  %call.1 = f32[32,1]{1,0} fusion(f32[32,1]{1,0} %add.17.14), kind=kCustom, calls=%_pop_op_sigmoid, metadata={op_type="Sigmoid" op_name="dense_1/Sigmoid"}
