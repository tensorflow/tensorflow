...
body {
  ...
  b_e0 = f16[4] get-tuple-element(b_p0), index=0, sharding={maximal device=1}
  b_e1 = f16[4] get-tuple-element(b_p0), index=1, sharding={maximal device=1}
  b_e2 = f16[4] get-tuple-element(b_p0), index=2, sharding={maximal device=1}
