...
class IpuXlaVariableTest(test_util.TensorFlowTestCase):
  ...
  def testRandomNormalInitalizer(self):
    ...
    with tu.ipu_session() as sess:
      ...
      ok = [
        '__seed*','vs/z1/Initializer/random_normal/RandomStandardNormal/fusion/Normal']
  ...
  def testTruncatedNormalScalarInitalizer(self):
    ...
    with tu.ipu_session() as sess:
      ...
      ok = [
        '__seed*','z1/Initializer/truncated_normal/TruncatedNormal/custom-call.*/TruncatedNormal',
  ...
  def testUniformRandomInitalizer(self):
    ...
    with tu.ipu_session() as sess:
      ...
      cs_list = tu.get_compute_sets_from_report(s)
      ok = [
        '__seed*','vs/z1/Initializer/random_uniform/RandomUniform/fusion/Uniform']
      self.assertTrue(tu.check_all_compute_sets_and_list(cs_list, ok))
