...
ENTRY %top (arg0.1: f32[1,1,2,2]) -> f32[] {
  ...
  %fusion = (s32[], f32[], f32[1,1,2,2]) fusion((s32[], f32[], f32[1,1,2,2]) %tuple.6.clone), kind=kCustom, calls=%_body, backend_config="{\"fusionConfig\":{\"isRepeatLoop\":true,\"repeatCount\":\"100\"}}"
