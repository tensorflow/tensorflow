...
#ifndef TENSORFLOW_COMPILER_PLUGIN_POPLAR_DRIVER_VISITOR_ARITHMETIC_EXPR_H_
#define TENSORFLOW_COMPILER_PLUGIN_POPLAR_DRIVER_VISITOR_ARITHMETIC_EXPR_H_
...
#define ARITHMETIC_EXPR_VISITOR_UNIMPLEMENTED(Name) \
  ...
  ARITHMETIC_EXPR_VISITOR_UNIMPLEMENTED(HandleCrossReplicaSum);
  ...
  ARITHMETIC_EXPR_VISITOR_UNIMPLEMENTED(HandleHostCompute);
