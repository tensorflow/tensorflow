...
#ifndef TENSORFLOW_COMPILER_PLUGIN_POPLAR_DRIVER_PASSES_CASTS_ELIMINATION_H_
#define TENSORFLOW_COMPILER_PLUGIN_POPLAR_DRIVER_PASSES_CASTS_ELIMINATION_H_
