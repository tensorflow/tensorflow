...
class VariableOpsTest(xla_test.XLATestCase):
    ...
    @test_util.disable_mlir_bridge(
        "TODO: MLIR bridge does not yetsupport ResourceScatterSub"
    )
    ...
    @test_util.disable_mlir_bridge(
        "TODO: MLIR bridge does not yetsupport ResourceScatterMul"
    )
    ...
    @test_util.disable_mlir_bridge(
        "TODO: MLIR bridge does not yetsupport ResourceScatterDiv"
    )
    ...
    @test_util.disable_mlir_bridge(
        "TODO: MLIR bridge does not yetsupport ResourceScatterMin"
    )
    ...
    @test_util.disable_mlir_bridge(
        "TODO: MLIR bridge does not yetsupport ResourceScatterMax"
    )
    ...
    @test_util.disable_mlir_bridge(
        "TODO: MLIR bridge does not yetsupport ResourceScatterNdAdd"
    )
    ...
    @test_util.disable_mlir_bridge(
        "TODO: MLIR bridge does not yetsupport ResourceScatterNdUpdateAdd"
    )
...
class SliceAssignTest(xla_test.XLATestCase):
    @test_util.disable_mlir_bridge(
        "TODO: MLIR bridge does not yetsupport ResourceStridedSliceAssign"
    )
    ...
    @test_util.disable_mlir_bridge(
        "TODO: MLIR bridge does not yetsupport uninitialized resource variable"
    )
