...
""")
    ...
    @parameterized.named_parameters(
        dict(testcase_name="_" + dim_var_type, dim_var_type=dim_var_type)
...
""")
    ...
    @parameterized.named_parameters(
        dict(testcase_name="_" + platform_idx_type, platform_idx_type=platform_idx_type)
...
""")
        ...
        module_attrs = ""  # attribute is missing
        with self.assertRaisesRegex(
            errors.InvalidArgumentError, "Module has dynamic shapes"
        ):
            self._assertOpOutputMatchesExpected(f, (x,), (res,))
