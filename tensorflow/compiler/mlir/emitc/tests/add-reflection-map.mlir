...
// CHECK: %0 = "emitc.constant"() <{value = #emitc.opaque<"{{\"another_feature\", reinterpret_cast<char*>(&another_feature)}, {\"some_feature\", reinterpret_cast<char*>(&some_feature)}, {\"output_0\", reinterpret_cast<char*>(&output_0)}}">}> : () -> !emitc.opaque<"const std::map<std::string, char*>">
