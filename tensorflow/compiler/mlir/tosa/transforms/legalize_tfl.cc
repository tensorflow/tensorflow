...
static LogicalResult matchAndRewriteAddSub(Operation* op,
  ...
  ShapedType input_lhs_type = lhs.getType().template dyn_cast<ShapedType>();
  ShapedType input_rhs_type = rhs.getType().template dyn_cast<ShapedType>();
  ShapedType output_type =
  ...
  input_lhs_type = lhs.getType().cast<ShapedType>();
  input_rhs_type = rhs.getType().cast<ShapedType>();
