...
// CHECK: %[[VAL_10:.*]] = "tosa.const"() <{values = dense<133> : tensor<1xui8>}> : () -> tensor<1xui8>
...
// CHECK:           %[[VAL_1:.*]] = "tosa.const"() <{values = dense<0> : tensor<1xui16>}> : () -> tensor<1xui16>
...
// CHECK:           %[[RESCALE_0:.*]] = tosa.rescale %[[ARG0]], %[[VAL_2]], %[[VAL_3]], %[[VAL_1]], %[[VAL_0]] {input_unsigned = true, output_unsigned = false, per_channel = false, rounding_mode = SINGLE_ROUND, scale32 = true} : (tensor<?x112x112x32x!quant.uniform<u16:f32, 0.023529412224888802>>, tensor<1xi32>, tensor<1xi8>, tensor<1xui16>, tensor<1xi16>) -> tensor<?x112x112x32x!quant.uniform<i16:f32, 0.023529412224888802>>
// CHECK:           %[[RESCALE_1:.*]] = tosa.rescale %[[RESCALE_0]], %[[VAL_2]], %[[VAL_3]], %[[VAL_0]], %[[VAL_0]] {input_unsigned = false, output_unsigned = false, per_channel = false, rounding_mode = SINGLE_ROUND, scale32 = true} : (tensor<?x112x112x32x!quant.uniform<i16:f32, 0.023529412224888802>>, tensor<1xi32>, tensor<1xi8>, tensor<1xi16>, tensor<1xi16>) -> tensor<?x112x112x32x!quant.uniform<i16:f32, 0.023529412224888802>>
// CHECK:           %[[CLAMP_0:.*]] = tosa.clamp %[[RESCALE_1]] {max_val = 32767 : i16, min_val = 0 : i16} : (tensor<?x112x112x32x!quant.uniform<i16:f32, 0.023529412224888802>>) -> tensor<?x112x112x32x!quant.uniform<i16:f32, 0.023529412224888802>>
// CHECK:           %[[RESCALE_2:.*]] = tosa.rescale %[[CLAMP_0]], %[[VAL_2]], %[[VAL_3]], %[[VAL_0]], %[[VAL_1]] {input_unsigned = false, output_unsigned = true, per_channel = false, rounding_mode = SINGLE_ROUND, scale32 = true} : (tensor<?x112x112x32x!quant.uniform<i16:f32, 0.023529412224888802>>, tensor<1xi32>, tensor<1xi8>, tensor<1xi16>, tensor<1xui16>) -> tensor<?x112x112x32x!quant.uniform<u16:f32, 0.023529412224888802>>
...
// CHECK-DAG: %[[VAL_3_UINT:.*]] = "tosa.const"() <{values = dense<0> : tensor<1xui8>}> : () -> tensor<1xui8>
...
// CHECK: %[[VAL_6:.*]] = tosa.rescale %[[VAL_0]], %[[VAL_4]], %[[VAL_5]], %[[VAL_3_UINT]], %[[VAL_2]] {input_unsigned = true, output_unsigned = false, per_channel = false, rounding_mode = SINGLE_ROUND, scale32 = true} : (tensor<13x21x3xui8>, tensor<1xi32>, tensor<1xi8>, tensor<1xui8>, tensor<1xi8>) -> tensor<13x21x3x!quant.uniform<i8:f32, 1.000000e+00:-128>>
...
// CHECK: %[[VAL_11:.*]] = tosa.rescale %[[VAL_10]], %[[VAL_4]], %[[VAL_5]], %[[VAL_2]], %[[VAL_3_UINT]] {input_unsigned = false, output_unsigned = true, per_channel = false, rounding_mode = SINGLE_ROUND, scale32 = true} : (tensor<13x3x!quant.uniform<i8:f32, 1.000000e+00:-128>>, tensor<1xi32>, tensor<1xi8>, tensor<1xi8>, tensor<1xui8>) -> tensor<13x3xui8>
...
// CHECK:           %[[VAL_4:.*]] = "tosa.const"() <{values = dense<0> : tensor<1xi16>}> : () -> tensor<1xi16>
// CHECK:           %[[VAL_5:.*]] = "tosa.const"() <{values = dense<0> : tensor<1xui16>}> : () -> tensor<1xui16>
...
// CHECK:           %[[RESCALE_0:.*]] = tosa.rescale %[[ARG0]], %[[VAL_6]], %[[VAL_7]], %[[VAL_5]], %[[VAL_4]] {input_unsigned = true, output_unsigned = false, per_channel = false, rounding_mode = SINGLE_ROUND, scale32 = true} : (tensor<1x32x32x8x!quant.uniform<u16:f32, 1.000000e+00>>, tensor<1xi32>, tensor<1xi8>, tensor<1xui16>, tensor<1xi16>) -> tensor<1x32x32x8x!quant.uniform<i16:f32, 1.000000e+00>>
// CHECK:           %[[VAL_8:.*]] = tosa.conv2d %[[RESCALE_0]], %[[ARG1]], %[[VAL_3]], %[[VAL_4]], %[[VAL_2]] {acc_type = i48, dilation = array<i64: 1, 1>, pad = array<i64: 1, 1, 3, 4>, stride = array<i64: 1, 1>} : (tensor<1x32x32x8x!quant.uniform<i16:f32, 1.000000e+00>>, tensor<3x3x8x16x!quant.uniform<i8:f32, 1.000000e+00>>, tensor<1xi48>, tensor<1xi16>, tensor<1xi8>) -> tensor<1x32x32x3xi48>
// CHECK:           %[[RESCALE_1:.*]] = tosa.rescale %[[VAL_8]], %[[VAL_1]], %[[VAL_0]], %[[VAL_3]], %[[VAL_4]] {input_unsigned = false, output_unsigned = false, per_channel = false, rounding_mode = SINGLE_ROUND, scale32 = false} : (tensor<1x32x32x3xi48>, tensor<1xi16>, tensor<1xi8>, tensor<1xi48>, tensor<1xi16>) -> tensor<1x32x32x3x!quant.uniform<i16:f32, 1.000000e+00>>
// CHECK:           %[[RESCALE_2:.*]] = tosa.rescale %[[RESCALE_1]], %[[VAL_6]], %[[VAL_7]], %[[VAL_4]], %[[VAL_5]] {input_unsigned = false, output_unsigned = true, per_channel = false, rounding_mode = SINGLE_ROUND, scale32 = true} : (tensor<1x32x32x3x!quant.uniform<i16:f32, 1.000000e+00>>, tensor<1xi32>, tensor<1xi8>, tensor<1xi16>, tensor<1xui16>) -> tensor<1x32x32x3x!quant.uniform<u16:f32, 1.000000e+00>>
// CHECK:           return %[[RESCALE_2]]
...
// CHECK: %[[VAL_2:.*]] = "tosa.const"() <{values = dense<1073741824> : tensor<1xi32>}> : () -> tensor<1xi32>
// CHECK: %[[VAL_3:.*]] = "tosa.const"() <{values = dense<30> : tensor<1xi8>}> : () -> tensor<1xi8>
// CHECK: %[[VAL_4:.*]] = "tosa.const"() <{values = dense<0> : tensor<1xui8>}> : () -> tensor<1xui8>
// CHECK: %[[VAL_5:.*]] = "tosa.const"() <{values = dense<-128> : tensor<1xi8>}> : () -> tensor<1xi8>
// CHECK: %[[VAL_6:.*]] = tosa.rescale %[[VAL_0]], %[[VAL_2]], %[[VAL_3]], %[[VAL_4]], %[[VAL_5]] {input_unsigned = true, output_unsigned = false, per_channel = false, rounding_mode = SINGLE_ROUND, scale32 = true} : (tensor<13x21x3xui8>, tensor<1xi32>, tensor<1xi8>, tensor<1xui8>, tensor<1xi8>) -> tensor<13x21x3x!quant.uniform<i8:f32, 1.000000e+00:-128>>
