...
def Convert(
    ...
    converter_flags_proto_txt_raw: object,
    input_contents_txt_raw: object,
    extended_return: bool = ...,
    debug_info_txt_raw: object = ...,
...
def ExperimentalMlirQuantizeModel(
    ...
    enable_whole_model_verify: bool = ...,
    op_blocklist: object = ...,
    node_blocklist: object = ...,
    enable_variable_quantization: bool = ...,
    disable_per_channel_for_dense_layers: bool = ...,
    debug_options_proto_txt_raw: object = ...,
) -> object: ...
