...
inline std::unique_ptr<mlir::Pass> CreateReduceWhileOperandsPass() {
  return Create<ReduceWhileOperandsPass>();
}
...
inline std::unique_ptr<mlir::Pass> CreateReduceTypePrecisionPass() {
  return Create<ReduceTypePrecisionPass>();
}
...
inline void registerTensorFlowLitePasses() {
  ...
  Register<ReduceWhileOperandsPass>();
  Register<ReduceTypePrecisionPass>();
}
