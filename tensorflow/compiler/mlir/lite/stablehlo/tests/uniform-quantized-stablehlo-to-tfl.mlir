...
// CHECK: %[[CST:.*]] = arith.constant dense<[2, 1, 0]> : tensor<3xi64>
// CHECK: %[[TRANSPOSE:.*]] = "tfl.transpose"(%[[ARG0]], %[[CST]]) : (tensor<2x3x4x!quant.uniform<i8:f32, 2.000000e+00:-1>>, tensor<3xi64>) -> tensor<4x3x2x!quant.uniform<i8:f32, 2.000000e+00:-1>>
