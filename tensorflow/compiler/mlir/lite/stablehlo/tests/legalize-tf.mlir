...
// CHECK-NEXT: %[[TEMP_1:.*]] = stablehlo.constant dense<4.33680869E-19> : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_2:.*]] = stablehlo.constant dense<0.693147182> : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_3:.*]] = stablehlo.constant dense<2.30584283E+20> : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_4:.*]] = stablehlo.constant dense<2.30584274E+12> : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_5:.*]] = stablehlo.constant dense<2.30584285E+30> : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_6:.*]] = stablehlo.constant dense<1.41421354> : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_7:.*]] = stablehlo.constant dense<2.30584287E+18> : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_8:.*]] = stablehlo.constant dense<1.500000e+00> : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_9:.*]] = stablehlo.constant dense<0x7F800000> : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_10:.*]] = stablehlo.constant dense<0.000000e+00> : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_11:.*]] = stablehlo.constant dense<2.000000e+00> : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_12:.*]] = stablehlo.constant dense<5.000000e-01> : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_13:.*]] = stablehlo.constant dense<1.000000e+00> : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_14:.*]] = stablehlo.real %arg0 : (tensor<2xcomplex<f32>>) -> tensor<2xf32>
// CHECK-NEXT: %[[TEMP_15:.*]] = stablehlo.abs %[[TEMP_14]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_16:.*]] = stablehlo.imag %arg0 : (tensor<2xcomplex<f32>>) -> tensor<2xf32>
// CHECK-NEXT: %[[TEMP_17:.*]] = stablehlo.abs %[[TEMP_16]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_18:.*]] = stablehlo.maximum %[[TEMP_15]], %[[TEMP_17]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_19:.*]] = stablehlo.compare  GE, %[[TEMP_18]], %[[TEMP_7]] : (tensor<2xf32>, tensor<2xf32>) -> tensor<2xi1>
// CHECK-NEXT: %[[TEMP_20:.*]] = stablehlo.compare  LE, %[[TEMP_15]], %[[TEMP_13]] : (tensor<2xf32>, tensor<2xf32>) -> tensor<2xi1>
// CHECK-NEXT: %[[TEMP_21:.*]] = stablehlo.add %[[TEMP_15]], %[[TEMP_13]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_22:.*]] = stablehlo.abs %[[TEMP_21]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_23:.*]] = stablehlo.maximum %[[TEMP_22]], %[[TEMP_17]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_24:.*]] = stablehlo.minimum %[[TEMP_22]], %[[TEMP_17]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_25:.*]] = stablehlo.compare  EQ, %[[TEMP_23]], %[[TEMP_24]] : (tensor<2xf32>, tensor<2xf32>) -> tensor<2xi1>
// CHECK-NEXT: %[[TEMP_26:.*]] = stablehlo.multiply %[[TEMP_23]], %[[TEMP_6]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_27:.*]] = stablehlo.divide %[[TEMP_24]], %[[TEMP_23]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_28:.*]] = stablehlo.multiply %[[TEMP_27]], %[[TEMP_27]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_29:.*]] = stablehlo.add %[[TEMP_28]], %[[TEMP_13]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_30:.*]] = stablehlo.sqrt %[[TEMP_29]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_31:.*]] = stablehlo.compare  EQ, %[[TEMP_30]], %[[TEMP_13]] : (tensor<2xf32>, tensor<2xf32>) -> tensor<2xi1>
// CHECK-NEXT: %[[TEMP_32:.*]] = stablehlo.compare  GT, %[[TEMP_28]], %[[TEMP_10]] : (tensor<2xf32>, tensor<2xf32>) -> tensor<2xi1>
// CHECK-NEXT: %[[TEMP_33:.*]] = stablehlo.and %[[TEMP_31]], %[[TEMP_32]] : tensor<2xi1>
// CHECK-NEXT: %[[TEMP_34:.*]] = stablehlo.multiply %[[TEMP_23]], %[[TEMP_28]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_35:.*]] = stablehlo.divide %[[TEMP_34]], %[[TEMP_11]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_36:.*]] = stablehlo.add %[[TEMP_23]], %[[TEMP_35]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_37:.*]] = stablehlo.multiply %[[TEMP_23]], %[[TEMP_30]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_38:.*]] = stablehlo.select %[[TEMP_33]], %[[TEMP_36]], %[[TEMP_37]] : tensor<2xi1>, tensor<2xf32>
// CHECK-NEXT: %[[TEMP_39:.*]] = stablehlo.select %[[TEMP_25]], %[[TEMP_26]], %[[TEMP_38]] : tensor<2xi1>, tensor<2xf32>
// CHECK-NEXT: %[[TEMP_40:.*]] = stablehlo.subtract %[[TEMP_15]], %[[TEMP_13]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_41:.*]] = stablehlo.abs %[[TEMP_40]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_42:.*]] = stablehlo.maximum %[[TEMP_41]], %[[TEMP_17]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_43:.*]] = stablehlo.minimum %[[TEMP_41]], %[[TEMP_17]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_44:.*]] = stablehlo.compare  EQ, %[[TEMP_42]], %[[TEMP_43]] : (tensor<2xf32>, tensor<2xf32>) -> tensor<2xi1>
// CHECK-NEXT: %[[TEMP_45:.*]] = stablehlo.multiply %[[TEMP_42]], %[[TEMP_6]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_46:.*]] = stablehlo.divide %[[TEMP_43]], %[[TEMP_42]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_47:.*]] = stablehlo.multiply %[[TEMP_46]], %[[TEMP_46]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_48:.*]] = stablehlo.add %[[TEMP_47]], %[[TEMP_13]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_49:.*]] = stablehlo.sqrt %[[TEMP_48]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_50:.*]] = stablehlo.compare  EQ, %[[TEMP_49]], %[[TEMP_13]] : (tensor<2xf32>, tensor<2xf32>) -> tensor<2xi1>
// CHECK-NEXT: %[[TEMP_51:.*]] = stablehlo.compare  GT, %[[TEMP_47]], %[[TEMP_10]] : (tensor<2xf32>, tensor<2xf32>) -> tensor<2xi1>
// CHECK-NEXT: %[[TEMP_52:.*]] = stablehlo.and %[[TEMP_50]], %[[TEMP_51]] : tensor<2xi1>
// CHECK-NEXT: %[[TEMP_53:.*]] = stablehlo.multiply %[[TEMP_42]], %[[TEMP_47]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_54:.*]] = stablehlo.divide %[[TEMP_53]], %[[TEMP_11]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_55:.*]] = stablehlo.add %[[TEMP_42]], %[[TEMP_54]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_56:.*]] = stablehlo.multiply %[[TEMP_42]], %[[TEMP_49]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_57:.*]] = stablehlo.select %[[TEMP_52]], %[[TEMP_55]], %[[TEMP_56]] : tensor<2xi1>, tensor<2xf32>
// CHECK-NEXT: %[[TEMP_58:.*]] = stablehlo.select %[[TEMP_44]], %[[TEMP_45]], %[[TEMP_57]] : tensor<2xi1>, tensor<2xf32>
// CHECK-NEXT: %[[TEMP_59:.*]] = stablehlo.add %[[TEMP_39]], %[[TEMP_58]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_60:.*]] = stablehlo.multiply %[[TEMP_59]], %[[TEMP_12]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_61:.*]] = stablehlo.add %[[TEMP_60]], %[[TEMP_15]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_62:.*]] = stablehlo.multiply %[[TEMP_61]], %[[TEMP_12]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_63:.*]] = stablehlo.multiply %[[TEMP_17]], %[[TEMP_17]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_64:.*]] = stablehlo.add %[[TEMP_39]], %[[TEMP_21]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_65:.*]] = stablehlo.divide %[[TEMP_63]], %[[TEMP_64]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_66:.*]] = stablehlo.subtract %[[TEMP_58]], %[[TEMP_40]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_67:.*]] = stablehlo.add %[[TEMP_65]], %[[TEMP_66]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_68:.*]] = stablehlo.multiply %[[TEMP_62]], %[[TEMP_67]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_69:.*]] = stablehlo.sqrt %[[TEMP_68]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_70:.*]] = stablehlo.divide %[[TEMP_62]], %[[TEMP_64]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_71:.*]] = stablehlo.add %[[TEMP_58]], %[[TEMP_40]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_72:.*]] = stablehlo.divide %[[TEMP_62]], %[[TEMP_71]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_73:.*]] = stablehlo.add %[[TEMP_70]], %[[TEMP_72]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_74:.*]] = stablehlo.sqrt %[[TEMP_73]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_75:.*]] = stablehlo.multiply %[[TEMP_17]], %[[TEMP_74]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_76:.*]] = stablehlo.select %[[TEMP_20]], %[[TEMP_69]], %[[TEMP_75]] : tensor<2xi1>, tensor<2xf32>
// CHECK-NEXT: %[[TEMP_77:.*]] = stablehlo.select %[[TEMP_19]], %[[TEMP_17]], %[[TEMP_76]] : tensor<2xi1>, tensor<2xf32>
// CHECK-NEXT: %[[TEMP_78:.*]] = stablehlo.compare  LT, %[[TEMP_15]], %[[TEMP_5]] : (tensor<2xf32>, tensor<2xf32>) -> tensor<2xi1>
// CHECK-NEXT: %[[TEMP_79:.*]] = stablehlo.select %[[TEMP_78]], %[[TEMP_4]], %[[TEMP_3]] : tensor<2xi1>, tensor<2xf32>
// CHECK-NEXT: %[[TEMP_80:.*]] = stablehlo.compare  GE, %[[TEMP_17]], %[[TEMP_79]] : (tensor<2xf32>, tensor<2xf32>) -> tensor<2xi1>
// CHECK-NEXT: %[[TEMP_81:.*]] = stablehlo.select %[[TEMP_80]], %[[TEMP_17]], %[[TEMP_15]] : tensor<2xi1>, tensor<2xf32>
// CHECK-NEXT: %[[TEMP_82:.*]] = stablehlo.select %[[TEMP_80]], %[[TEMP_79]], %[[TEMP_7]] : tensor<2xi1>, tensor<2xf32>
// CHECK-NEXT: %[[TEMP_83:.*]] = stablehlo.compare  GE, %[[TEMP_81]], %[[TEMP_82]] : (tensor<2xf32>, tensor<2xf32>) -> tensor<2xi1>
// CHECK-NEXT: %[[TEMP_84:.*]] = stablehlo.log %[[TEMP_81]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_85:.*]] = stablehlo.add %[[TEMP_84]], %[[TEMP_2]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_86:.*]] = stablehlo.compare  EQ, %[[TEMP_17]], %[[TEMP_9]] : (tensor<2xf32>, tensor<2xf32>) -> tensor<2xi1>
// CHECK-NEXT: %[[TEMP_87:.*]] = stablehlo.not %[[TEMP_86]] : tensor<2xi1>
// CHECK-NEXT: %[[TEMP_88:.*]] = stablehlo.and %[[TEMP_80]], %[[TEMP_87]] : tensor<2xi1>
// CHECK-NEXT: %[[TEMP_89:.*]] = stablehlo.divide %[[TEMP_15]], %[[TEMP_17]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_90:.*]] = stablehlo.select %[[TEMP_88]], %[[TEMP_89]], %[[TEMP_10]] : tensor<2xi1>, tensor<2xf32>
// CHECK-NEXT: %[[TEMP_91:.*]] = stablehlo.multiply %[[TEMP_90]], %[[TEMP_90]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_92:.*]] = stablehlo.log_plus_one %[[TEMP_91]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_93:.*]] = stablehlo.multiply %[[TEMP_92]], %[[TEMP_12]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_94:.*]] = stablehlo.add %[[TEMP_85]], %[[TEMP_93]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_95:.*]] = stablehlo.compare  LT, %[[TEMP_17]], %[[TEMP_1]] : (tensor<2xf32>, tensor<2xf32>) -> tensor<2xi1>
// CHECK-NEXT: %[[TEMP_96:.*]] = stablehlo.compare  LT, %[[TEMP_15]], %[[TEMP_13]] : (tensor<2xf32>, tensor<2xf32>) -> tensor<2xi1>
// CHECK-NEXT: %[[TEMP_97:.*]] = stablehlo.and %[[TEMP_95]], %[[TEMP_96]] : tensor<2xi1>
// CHECK-NEXT: %[[TEMP_98:.*]] = stablehlo.multiply %[[TEMP_21]], %[[TEMP_40]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_99:.*]] = stablehlo.add %[[TEMP_60]], %[[TEMP_13]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_100:.*]] = stablehlo.divide %[[TEMP_98]], %[[TEMP_99]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_101:.*]] = stablehlo.negate %[[TEMP_100]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_102:.*]] = stablehlo.compare  GE, %[[TEMP_15]], %[[TEMP_13]] : (tensor<2xf32>, tensor<2xf32>) -> tensor<2xi1>
// CHECK-NEXT: %[[TEMP_103:.*]] = stablehlo.multiply %[[TEMP_63]], %[[TEMP_12]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_104:.*]] = stablehlo.divide %[[TEMP_103]], %[[TEMP_64]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_105:.*]] = stablehlo.multiply %[[TEMP_71]], %[[TEMP_12]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_106:.*]] = stablehlo.add %[[TEMP_104]], %[[TEMP_105]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_107:.*]] = stablehlo.compare  LE, %[[TEMP_60]], %[[TEMP_8]] : (tensor<2xf32>, tensor<2xf32>) -> tensor<2xi1>
// CHECK-NEXT: %[[TEMP_108:.*]] = stablehlo.divide %[[TEMP_103]], %[[TEMP_66]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_109:.*]] = stablehlo.add %[[TEMP_104]], %[[TEMP_108]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_110:.*]] = stablehlo.subtract %[[TEMP_60]], %[[TEMP_13]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_111:.*]] = stablehlo.select %[[TEMP_107]], %[[TEMP_109]], %[[TEMP_110]] : tensor<2xi1>, tensor<2xf32>
// CHECK-NEXT: %[[TEMP_112:.*]] = stablehlo.select %[[TEMP_102]], %[[TEMP_106]], %[[TEMP_111]] : tensor<2xi1>, tensor<2xf32>
// CHECK-NEXT: %[[TEMP_113:.*]] = stablehlo.select %[[TEMP_97]], %[[TEMP_101]], %[[TEMP_112]] : tensor<2xi1>, tensor<2xf32>
// CHECK-NEXT: %[[TEMP_114:.*]] = stablehlo.multiply %[[TEMP_113]], %[[TEMP_99]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_115:.*]] = stablehlo.sqrt %[[TEMP_114]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_116:.*]] = stablehlo.divide %[[TEMP_17]], %[[TEMP_115]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_117:.*]] = stablehlo.add %[[TEMP_113]], %[[TEMP_115]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_118:.*]] = stablehlo.log_plus_one %[[TEMP_117]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_119:.*]] = stablehlo.select %[[TEMP_97]], %[[TEMP_116]], %[[TEMP_118]] : tensor<2xi1>, tensor<2xf32>
// CHECK-NEXT: %[[TEMP_120:.*]] = stablehlo.select %[[TEMP_83]], %[[TEMP_94]], %[[TEMP_119]] : tensor<2xi1>, tensor<2xf32>
// CHECK-NEXT: %[[TEMP_121:.*]] = stablehlo.real %arg0 : (tensor<2xcomplex<f32>>) -> tensor<2xf32>
// CHECK-NEXT: %[[TEMP_122:.*]] = stablehlo.atan2 %[[TEMP_77]], %[[TEMP_121]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_123:.*]] = stablehlo.imag %arg0 : (tensor<2xcomplex<f32>>) -> tensor<2xf32>
// CHECK-NEXT: %[[TEMP_124:.*]] = stablehlo.compare  LT, %[[TEMP_123]], %[[TEMP_10]] : (tensor<2xf32>, tensor<2xf32>) -> tensor<2xi1>
// CHECK-NEXT: %[[TEMP_125:.*]] = stablehlo.negate %[[TEMP_120]] : tensor<2xf32>
// CHECK-NEXT: %[[TEMP_126:.*]] = stablehlo.select %[[TEMP_124]], %[[TEMP_120]], %[[TEMP_125]] : tensor<2xi1>, tensor<2xf32>
// CHECK-NEXT: %[[TEMP_127:.*]] = stablehlo.complex %[[TEMP_122]], %[[TEMP_126]] : tensor<2xcomplex<f32>>
// CHECK-NEXT: return %[[TEMP_127]] : tensor<2xcomplex<f32>>
