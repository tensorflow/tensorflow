 ...
 public:
  ...
  LogicalResult matchAndRewrite(
      ...
      ConversionPatternRewriter& rewriter) const final {
    {
      ...
      ShapedType operand_type = cast<ShapedType>(operands[0].getType());
      ShapedType indices_type = cast<ShapedType>(indices.getType());
      ShapedType updates_type = cast<ShapedType>(updates[0].getType());
