...
class ConvertNdConvOp : public OpConversionPattern<mhlo::ConvolutionOp> {
 public:
  ...
  LogicalResult matchAndRewrite(
    ...
    const int input_channels = cast<ShapedType>(conv_op.getLhs().getType())
                                   .getDimSize(input_feature_dimension);
    const int kernel_input_channels =
        cast<ShapedType>(conv_op.getRhs().getType())
  ...
  static bool IsSupportedConvOp(mhlo::ConvolutionOp conv_op) {
    if (!cast<ShapedType>(conv_op.getRhs().getType()).hasStaticShape()) {
      return false;
    }
    if (!cast<ShapedType>(conv_op.getLhs().getType()).hasStaticShape() &&
        !cast<ShapedType>(conv_op.getType()).hasStaticShape()) {
      auto dnums = conv_op.getDimensionNumbers();
      auto lhs_type = cast<ShapedType>(conv_op.getLhs().getType());
      auto out_type = cast<ShapedType>(conv_op.getType());
    ...
    if (cast<ShapedType>(conv_op.getWindowStrides().value().getType())
            .getRank() != 1)
      return false;
 ...
 private:
  bool IsSamePadding(mhlo::ConvolutionOp conv_op, ArrayRef<int64_t> strides,
    ...
    for (auto i : llvm::seq<int>(0, num_spatial_dims)) {
      ...
      tensorflow::Status status = tensorflow::GetWindowedOutputSizeVerbose(
          cast<ShapedType>(conv_op.getLhs().getType())
  ...
  Value SliceNegativePadding(Value value, ArrayRef<int64_t> explicit_padding,
    ...
    auto input_type = cast<RankedTensorType>(value.getType());
  ...
  void CreateConvOp(mhlo::ConvolutionOp conv_op, ArrayRef<int64_t> strides,
    ...
    if (padding == "EXPLICIT" && num_spatial_dims == 3) {
      auto lhs_type = dyn_cast<RankedTensorType>(conv_op.getLhs().getType());
    ...
    auto conv_output_type = cast<RankedTensorType>(conv_op.getType());
    ...
    if (is_depthwise_conv && num_spatial_dims == 2) {
      ...
      auto filter_type = cast<ShapedType>(rhs.getType());
...
class Convert1DConvOp : public OpConversionPattern<mhlo::ConvolutionOp> {
 public:
  ...
  LogicalResult matchAndRewrite(
    ...
    const int64_t input_channels = cast<ShapedType>(conv_op.getLhs().getType())
                                       .getDimSize(input_feature_dimension);
    const int kernel_input_feature_dimension =
        dnums.getKernelInputFeatureDimension();
    const int kernel_input_channels =
    ...
    auto image_type = cast<ShapedType>(conv_op.getLhs().getType());
    ...
    auto kernel_type = cast<ShapedType>(conv_op.getRhs().getType());
    ...
    auto output_type = cast<ShapedType>(conv_op->getResult(0).getType());
    ...
    auto conv2d_output_type = cast<ShapedType>(conv2d_output.getType());
...
LogicalResult IsSupportedNonTrivialConvOp(mhlo::ConvolutionOp conv_op,
                                          ConversionPatternRewriter& rewriter) {
  if (!cast<ShapedType>(conv_op.getLhs().getType()).hasStaticShape() ||
      !cast<ShapedType>(conv_op.getRhs().getType()).hasStaticShape() ||
      !cast<ShapedType>(conv_op.getType()).hasStaticShape())
  ...
  LogicalResult matchAndRewrite(
    ...
    auto create_slice = [&](mlir::Value tensor, int depth_idx, int channel_idx,
      ...
      std::vector<int64_t> tensor_shape =
          cast<ShapedType>(tensor.getType()).getShape().vec();
 ...
 public:
  ...
  LogicalResult matchAndRewrite(
    ...
    if (dnums.getOutputBatchDimension() != 0 ||
      ...
      auto output_shape =
          cast<RankedTensorType>(conv_op.getResult().getType()).getShape();
      ...
      auto output_type = RankedTensorType::get(
          ...
          cast<ShapedType>(conv_op.getRhs().getType()).getElementType());
 ...
 private:
  ...
  bool IsValidPaddingForTransposedConv(mhlo::ConvolutionOp conv_op,
    ...
    for (size_t i = 1; i <= num_spatial_dims; ++i) {
      ...
      int64_t input_size = cast<ShapedType>(conv_op.getLhs().getType())
                               .getDimSize(input_spatial_dims[i - 1]);
      int64_t kernel_size = cast<ShapedType>(conv_op.getRhs().getType())
                                .getDimSize(kernel_spatial_dims[i - 1]);
      int64_t output_size = cast<ShapedType>(conv_op.getType())
...
class ConvertDynamicSliceOp : public OpConversionPattern<mhlo::DynamicSliceOp> {
 public:
  ...
  LogicalResult matchAndRewrite(
      ...
      ConversionPatternRewriter& rewriter) const final {
    ShapedType input_type = cast<ShapedType>(op.getOperand().getType());
    if (!input_type.hasStaticShape()) return failure();
    Type start_indices_element_type =
        cast<ShapedType>(op.getStartIndices().front().getType())
            .getElementType();
    ...
    for (uint64_t i = 0, e = op.getStartIndices().size(); i < e; ++i) {
      ...
      auto cast_type = cast<ShapedType>(start.getType())
...
class ConvertDynamicUpdateSliceOp
 ...
 public:
  ...
  LogicalResult matchAndRewrite(
      ...
      ConversionPatternRewriter& rewriter) const final {
    ShapedType operand_type = cast<ShapedType>(op.getOperand().getType());
    ShapedType update_type =
        dyn_cast_or_null<ShapedType>(op.getUpdate().getType());
    ShapedType start_indices_type =
        dyn_cast_or_null<ShapedType>(op.getStartIndices().front().getType());
...
class ConvertSortToTfTopk : public OpConversionPattern<mhlo::SortOp> {
 public:
  ...
  LogicalResult matchAndRewrite(
    ...
    auto keys_ty = dyn_cast_or_null<ShapedType>(keys.getType());
    auto indices_ty = dyn_cast_or_null<ShapedType>(indices.getType());
...
Value ConvertDot(PatternRewriter& rewriter, Value lhs, Value rhs,
  ...
  auto rhs_type = cast<ShapedType>(rhs.getType());
...
Value ConvertDotOp(PatternRewriter& rewriter, Operation* old_op) {
  ...
  auto lhs_rank = cast<ShapedType>(dot_op.getLhs().getType()).getRank();
  ...
  return ConvertDot(
      ...
      cast<ShapedType>(dot_op.getResult().getType()), dot_op.getLoc());
}
...
Value ConvertDotGeneralOp(PatternRewriter& rewriter, Operation* old_op) {
  ...
  return ConvertDot(rewriter, dot_general_op.getLhs(), dot_general_op.getRhs(),
                    ...
                    cast<ShapedType>(dot_general_op.getResult().getType()),
...
class ConvertReduceOpToTfOp : public OpConversionPattern<mhlo::ReduceOp> {
 ...
 private:
  ...
  LogicalResult MatchReduceOpOperand(mhlo::ReduceOp reduce_op) const {
    ...
    if (!isa<RankedTensorType>(reduce_op.getInputs()[0].getType()))
      return failure();
    if (!isa<RankedTensorType>(reduce_op.getType(0))) return failure();
    return success();
  }
};
...
class ConvertReduceOpToTfProd
 ...
 public:
  ...
  LogicalResult MatchInitValue(Value init_value) const override {
    auto type = cast<ShapedType>(init_value.getType()).getElementType();
    if (isa<FloatType>(type)) {
      float const_value;
      if (failed(GetConstantSplatValue<float>(init_value, const_value)) ||
          const_value != 1.0)
        return failure();
    } else if (isa<IntegerType>(type) && type.isSignlessInteger()) {
      int32_t const_value;
 ...
 public:
  ...
  LogicalResult matchAndRewrite(
    ...
    RankedTensorType type =
        dyn_cast_or_null<RankedTensorType>(iota_op.getType());
...
bool IsSpatialPoolingWithoutDilation(
  ...
  auto operand_type = dyn_cast<RankedTensorType>(rw.getInputs()[0].getType());
  RankedTensorType output_type =
      dyn_cast<RankedTensorType>(rw.getResult(0).getType());
...
class ConvertLoweredCumOp : public OpConversionPattern<mhlo::ReduceWindowOp> {
 public:
  ...
  LogicalResult matchAndRewrite(
    ...
    auto const_op_dense_value = cast<DenseElementsAttr>(const_op.getValue());
    if (!const_op_dense_value || !IsInitValue(const_op_dense_value)) {
      return failure();
    }

    auto operand_type = cast<ShapedType>(rw.getInputs()[0].getType());
 ...
 public:
  ...
  LogicalResult matchAndRewrite(
    ...
    const RankedTensorType rw_type =
        dyn_cast<RankedTensorType>(rw.getResult(0).getType());
    if (!rw_type || !isa<FloatType>(rw_type.getElementType()) ||
...
bool IsDenseSplatIntAttr(ElementsAttr float_or_int) {
  return isa<SplatElementsAttr>(float_or_int) &&
         isa<DenseIntElementsAttr>(float_or_int);
}

bool IsDenseSplatFloatAttr(ElementsAttr float_or_int) {
  return isa<SplatElementsAttr>(float_or_int) &&
         isa<DenseFPElementsAttr>(float_or_int);
}
...
bool ValueIsReciprocal(ElementsAttr float_or_int, ElementsAttr rhs) {
  if (IsDenseSplatFloatAttr(float_or_int) &&
    ...
    return (cast<SplatElementsAttr>(float_or_int).getSplatValue<APFloat>() *
            cast<SplatElementsAttr>(rhs).getSplatValue<APFloat>())
        .isExactlyValue(1.0);
  } else if (IsDenseSplatIntAttr(float_or_int) &&
             IsDenseSplatIntAttr(float_or_int)) {
    return (cast<SplatElementsAttr>(float_or_int).getSplatValue<APInt>() *
            cast<SplatElementsAttr>(rhs).getSplatValue<APInt>()) == 1;
  }
  return false;
}
...
bool ValueEquals(ElementsAttr float_or_int, double rhs) {
  if (IsDenseSplatFloatAttr(float_or_int)) {
    return cast<SplatElementsAttr>(float_or_int)
...
bool ValueGreaterThanZero(ElementsAttr float_or_int) {
  if (IsDenseSplatIntAttr(float_or_int)) {
    auto value = cast<SplatElementsAttr>(float_or_int).getSplatValue<APInt>();
    return !value.isNegative() && !value.isZero();
  } else if (IsDenseSplatFloatAttr(float_or_int)) {
    auto value = cast<SplatElementsAttr>(float_or_int).getSplatValue<APFloat>();
...
bool TensorIsSign(PatternRewriter& rewriter, ElementsAttr float_or_int,
  ...
  if (isa<DenseIntElementsAttr>(float_or_int)) {
...
class ConvertGatherOp : public OpConversionPattern<mhlo::GatherOp> {
 public:
  ...
  LogicalResult matchAndRewrite(
    ...
    ShapedType operand_type = cast<ShapedType>(operand.getType());
    ShapedType start_indices_type = cast<ShapedType>(start_indices.getType());
    ShapedType result_type = cast<ShapedType>(gather_op.getResult().getType());
 ...
 public:
  ...
  LogicalResult matchAndRewrite(
    ...
    for (auto type : while_op->getOperandTypes()) {
      if (isa<TupleType>(type)) return failure();
    }
...
class ConvertRealDynamicSliceOp
 ...
 public:
  ...
  LogicalResult matchAndRewrite(
      ...
      ConversionPatternRewriter& rewriter) const final {
    auto start_indices_type = cast<RankedTensorType>(
        real_dynamic_slice_op.getStartIndices().getType());
    auto end_indices_type = cast<RankedTensorType>(
...
class ConvertDynamicIotaOp : public OpConversionPattern<mhlo::DynamicIotaOp> {
 public:
  ...
  LogicalResult matchAndRewrite(
      ...
      ConversionPatternRewriter& rewriter) const final {
    RankedTensorType type =
        dyn_cast_or_null<RankedTensorType>(dynamic_iota_op.getType());
    ...
    if (isa<FloatType>(element_type)) {
      auto cast_type =
          cast<ShapedType>(output_shape.getType()).clone(element_type);
...
bool IsTFStyleBroadcast(DenseIntElementsAttr broadcast_dimensions,
  ...
  int64_t output_rank = cast<ShapedType>(output.getType()).getRank();
  return input_rank == 0 ||
...
arith::ConstantOp ExpandedShape(PatternRewriter& rewriter, Value input,
  ...
  SmallVector<Attribute, 4> expanded_shape(
      cast<ShapedType>(output.getType()).getRank(),
      /*Value=*/rewriter.getI64IntegerAttr(1));

  // Set dimension sizes specified by broadcast_dimensions.
  ArrayRef<int64_t> input_shape = cast<ShapedType>(input.getType()).getShape();
...
Value ExpandedDynamicShape(PatternRewriter& rewriter, Value input,
                           DenseIntElementsAttr broadcast_dimensions,
                           Value output) {
  assert(cast<ShapedType>(output.getType()) &&
