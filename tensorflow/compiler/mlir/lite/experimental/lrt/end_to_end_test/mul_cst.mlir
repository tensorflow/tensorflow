...
// CHECK:   %1 = "tfl.custom"(%arg0, %0) <{custom_code = {{.*}}, custom_option = #tfl<const_bytes : "{{.*}}">}> : (tensor<4xf32>, tensor<4xf32>) -> tensor<4xf32>
...
// METADATA: "tfl.custom"(%arg0, %0) <{custom_code = "ExampleSocManufacturer"
