...
func @hashtable_string_to_int64(%arg0: tensor<i64>) -> tensor<*xi64> {
  %cst = constant dense<"f"> : tensor<!tf_type.string>
  ...
  // CHECK:       [[CST:%.*]] = constant dense<"f"> : tensor<!tf_type.string>
...
func @hashtable_int64_to_string(%arg0: tensor<i64>) -> tensor<*x!tf_type.string> {
  %cst = constant dense<"f"> : tensor<!tf_type.string>
...
func @no_legalization_on_hashtable_string_to_string(%arg0: tensor<!tf_type.string>) {
...
func @hashtable_import(%arg0: tensor<5x!tf_type.string>) {
  %cst = constant dense<["emerson", "lake", "palmer"]> : tensor<3x!tf_type.string>
  ...
  // CHECK:       [[CST:%.*]] = constant dense<["emerson", "lake", "palmer"]> : tensor<3x!tf_type.string>
...
func @hashtable_size(%arg0: tensor<5x!tf_type.string>) -> tensor<i64> {
  %0 = "tf.HashTableV2"() {container = "", device = "", key_dtype = !tf_type.string, shared_name = "hash_table_1dd4fef4-646d-491f-a3a8-bf5334f45813", use_node_name_sharing = false, value_dtype = i64} : () -> tensor<!tf_type.resource>
...
func @hashtable_import_then_find(%arg0: tensor<5x!tf_type.string>) -> tensor<*xi64> {
  %cst = constant dense<["emerson", "lake", "palmer"]> : tensor<3x!tf_type.string>
...
func @hashtable_import_then_size(%arg0: tensor<5x!tf_type.string>) -> tensor<i64> {
  %cst = constant dense<["emerson", "lake", "palmer"]> : tensor<3x!tf_type.string>
  %cst_0 = constant dense<[0, 1, 2]> : tensor<3xi64>
  %0 = "tf.HashTableV2"() {container = "", device = "", key_dtype = !tf_type.string, shared_name = "hash_table_1dd4fef4-646d-491f-a3a8-bf5334f45813", use_node_name_sharing = false, value_dtype = i64} : () -> tensor<!tf_type.resource>
  "tf.LookupTableImportV2"(%0, %cst, %cst_0) {device = ""} : (tensor<!tf_type.resource>, tensor<3x!tf_type.string>, tensor<3xi64>) -> ()
