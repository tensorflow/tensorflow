...
// CHECK:           %[[VAL_1:.*]] = "tfl.custom"(%[[VAL_0]]) {custom_code = "RandomStandardNormal", custom_option = opaque<"tfl", "0x"> : tensor<0xi8>} : (tensor<2xi32>) -> tensor<3x4xf32>
...
// CHECK:           %[[VAL_1:.*]] = "tfl.custom"(%[[VAL_0]]) {custom_code = "RandomUniform", custom_option = opaque<"tfl", "0x"> : tensor<0xi8>} : (tensor<2xi32>) -> tensor<1x2xf32>
