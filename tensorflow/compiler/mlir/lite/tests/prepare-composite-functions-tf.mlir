...
// CHECK-DAG:       [[VAL_10:%.*]] = constant unit
// CHECK-DAG:       [[VAL_11:%.*]] = constant dense<0> : tensor<2xi64>
// CHECK-DAG:       [[VAL_12:%.*]] = constant dense<[1, 0]> : tensor<2xi64>
// CHECK:           [[VAL_13:%.*]] = "tf.Slice"([[VAL_7]], [[VAL_11]], [[VAL_12]]) : (tensor<4x3xf32>, tensor<2xi64>, tensor<2xi64>) -> tensor<1x0xf32>
// CHECK-DAG:       [[VAL_14:%.*]] = constant dense<[1, 0]> : tensor<2xi64>
// CHECK-DAG:       [[VAL_15:%.*]] = constant dense<[1, 0]> : tensor<2xi64>
// CHECK:           [[VAL_16:%.*]] = "tf.Slice"([[VAL_7]], [[VAL_14]], [[VAL_15]]) : (tensor<4x3xf32>, tensor<2xi64>, tensor<2xi64>) -> tensor<1x0xf32>
// CHECK-DAG:       [[VAL_17:%.*]] = constant dense<[2, 0]> : tensor<2xi64>
// CHECK-DAG:       [[VAL_18:%.*]] = constant dense<[1, 0]> : tensor<2xi64>
// CHECK:           [[VAL_19:%.*]] = "tf.Slice"([[VAL_7]], [[VAL_17]], [[VAL_18]]) : (tensor<4x3xf32>, tensor<2xi64>, tensor<2xi64>) -> tensor<1x0xf32>
// CHECK-DAG:       [[VAL_20:%.*]] = constant dense<[3, 0]> : tensor<2xi64>
// CHECK-DAG:       [[VAL_21:%.*]] = constant dense<[1, 0]> : tensor<2xi64>
// CHECK:           [[VAL_22:%.*]] = "tf.Slice"([[VAL_7]], [[VAL_20]], [[VAL_21]]) : (tensor<4x3xf32>, tensor<2xi64>, tensor<2xi64>) -> tensor<1x0xf32>
// CHECK-DAG:       [[VAL_23:%.*]] = constant dense<0> : tensor<2xi64>
// CHECK-DAG:       [[VAL_24:%.*]] = constant dense<[1, 3]> : tensor<2xi64>
// CHECK:           [[VAL_25:%.*]] = "tf.Slice"([[VAL_7]], [[VAL_23]], [[VAL_24]]) : (tensor<4x3xf32>, tensor<2xi64>, tensor<2xi64>) -> tensor<1x3xf32>
// CHECK-DAG:       [[VAL_26:%.*]] = constant dense<[1, 0]> : tensor<2xi64>
// CHECK-DAG:       [[VAL_27:%.*]] = constant dense<[1, 3]> : tensor<2xi64>
// CHECK:           [[VAL_28:%.*]] = "tf.Slice"([[VAL_7]], [[VAL_26]], [[VAL_27]]) : (tensor<4x3xf32>, tensor<2xi64>, tensor<2xi64>) -> tensor<1x3xf32>
// CHECK-DAG:       [[VAL_29:%.*]] = constant dense<[2, 0]> : tensor<2xi64>
// CHECK-DAG:       [[VAL_30:%.*]] = constant dense<[1, 3]> : tensor<2xi64>
// CHECK:           [[VAL_31:%.*]] = "tf.Slice"([[VAL_7]], [[VAL_29]], [[VAL_30]]) : (tensor<4x3xf32>, tensor<2xi64>, tensor<2xi64>) -> tensor<1x3xf32>
// CHECK-DAG:       [[VAL_32:%.*]] = constant dense<[3, 0]> : tensor<2xi64>
// CHECK-DAG:       [[VAL_33:%.*]] = constant dense<[1, 3]> : tensor<2xi64>
// CHECK:           [[VAL_34:%.*]] = "tf.Slice"([[VAL_7]], [[VAL_32]], [[VAL_33]]) : (tensor<4x3xf32>, tensor<2xi64>, tensor<2xi64>) -> tensor<1x3xf32>
// CHECK-DAG:       [[VAL_35:%.*]] = constant dense<0> : tensor<1xi64>
// CHECK-DAG:       [[VAL_36:%.*]] = constant dense<1> : tensor<1xi64>
// CHECK:           [[VAL_37:%.*]] = "tf.Slice"([[VAL_3]], [[VAL_35]], [[VAL_36]]) : (tensor<2xf32>, tensor<1xi64>, tensor<1xi64>) -> tensor<1xf32>
// CHECK-DAG:       [[VAL_38:%.*]] = constant dense<1> : tensor<1xi64>
// CHECK-DAG:       [[VAL_39:%.*]] = constant dense<1> : tensor<1xi64>
// CHECK:           [[VAL_40:%.*]] = "tf.Slice"([[VAL_3]], [[VAL_38]], [[VAL_39]]) : (tensor<2xf32>, tensor<1xi64>, tensor<1xi64>) -> tensor<1xf32>
// CHECK-DAG:       [[VAL_41:%.*]] = constant dense<0.000000e+00> : tensor<1xf32>
// CHECK-DAG:       [[VAL_42:%.*]] = constant dense<0.000000e+00> : tensor<1xf32>
// CHECK-DAG:       [[VAL_43:%.*]] = constant dense<0> : tensor<2xi64>
// CHECK-DAG:       [[VAL_44:%.*]] = constant dense<[3, 1]> : tensor<2xi64>
// CHECK:           [[VAL_45:%.*]] = "tf.Slice"([[VAL_9]], [[VAL_43]], [[VAL_44]]) : (tensor<3x1xf32>, tensor<2xi64>, tensor<2xi64>) -> tensor<3x1xf32>
// CHECK-DAG:       [[VAL_46:%.*]] = constant dense<0.000000e+00> : tensor<3xf32>
// CHECK-DAG:       [[VAL_47:%.*]] = constant dense<0.000000e+00> : tensor<1x3xf32>
// CHECK-DAG:       [[VAL_48:%.*]] = constant dense<0.000000e+00> : tensor<1x1xf32>
...
// CHECK-DAG:       [[VAL_56:%.*]] = constant unit
// CHECK-DAG:       [[VAL_57:%.*]] = constant dense<0> : tensor<2xi64>
// CHECK-DAG:       [[VAL_58:%.*]] = constant dense<[1, 0]> : tensor<2xi64>
// CHECK:           [[VAL_59:%.*]] = "tf.Slice"([[VAL_53]], [[VAL_57]], [[VAL_58]]) : (tensor<4x3xf32>, tensor<2xi64>, tensor<2xi64>) -> tensor<1x0xf32>
// CHECK-DAG:       [[VAL_60:%.*]] = constant dense<[1, 0]> : tensor<2xi64>
// CHECK-DAG:       [[VAL_61:%.*]] = constant dense<[1, 0]> : tensor<2xi64>
// CHECK:           [[VAL_62:%.*]] = "tf.Slice"([[VAL_53]], [[VAL_60]], [[VAL_61]]) : (tensor<4x3xf32>, tensor<2xi64>, tensor<2xi64>) -> tensor<1x0xf32>
// CHECK-DAG:       [[VAL_63:%.*]] = constant dense<[2, 0]> : tensor<2xi64>
// CHECK-DAG:       [[VAL_64:%.*]] = constant dense<[1, 0]> : tensor<2xi64>
// CHECK:           [[VAL_65:%.*]] = "tf.Slice"([[VAL_53]], [[VAL_63]], [[VAL_64]]) : (tensor<4x3xf32>, tensor<2xi64>, tensor<2xi64>) -> tensor<1x0xf32>
// CHECK-DAG:       [[VAL_66:%.*]] = constant dense<[3, 0]> : tensor<2xi64>
// CHECK-DAG:       [[VAL_67:%.*]] = constant dense<[1, 0]> : tensor<2xi64>
// CHECK:           [[VAL_68:%.*]] = "tf.Slice"([[VAL_53]], [[VAL_66]], [[VAL_67]]) : (tensor<4x3xf32>, tensor<2xi64>, tensor<2xi64>) -> tensor<1x0xf32>
// CHECK-DAG:       [[VAL_69:%.*]] = constant dense<0> : tensor<2xi64>
// CHECK-DAG:       [[VAL_70:%.*]] = constant dense<[1, 3]> : tensor<2xi64>
// CHECK:           [[VAL_71:%.*]] = "tf.Slice"([[VAL_53]], [[VAL_69]], [[VAL_70]]) : (tensor<4x3xf32>, tensor<2xi64>, tensor<2xi64>) -> tensor<1x3xf32>
// CHECK-DAG:       [[VAL_72:%.*]] = constant dense<[1, 0]> : tensor<2xi64>
// CHECK-DAG:       [[VAL_73:%.*]] = constant dense<[1, 3]> : tensor<2xi64>
// CHECK:           [[VAL_74:%.*]] = "tf.Slice"([[VAL_53]], [[VAL_72]], [[VAL_73]]) : (tensor<4x3xf32>, tensor<2xi64>, tensor<2xi64>) -> tensor<1x3xf32>
// CHECK-DAG:       [[VAL_75:%.*]] = constant dense<[2, 0]> : tensor<2xi64>
// CHECK-DAG:       [[VAL_76:%.*]] = constant dense<[1, 3]> : tensor<2xi64>
// CHECK:           [[VAL_77:%.*]] = "tf.Slice"([[VAL_53]], [[VAL_75]], [[VAL_76]]) : (tensor<4x3xf32>, tensor<2xi64>, tensor<2xi64>) -> tensor<1x3xf32>
// CHECK-DAG:       [[VAL_78:%.*]] = constant dense<[3, 0]> : tensor<2xi64>
// CHECK-DAG:       [[VAL_79:%.*]] = constant dense<[1, 3]> : tensor<2xi64>
// CHECK:           [[VAL_80:%.*]] = "tf.Slice"([[VAL_53]], [[VAL_78]], [[VAL_79]]) : (tensor<4x3xf32>, tensor<2xi64>, tensor<2xi64>) -> tensor<1x3xf32>
// CHECK-DAG:       [[VAL_81:%.*]] = constant dense<0> : tensor<1xi64>
// CHECK-DAG:       [[VAL_82:%.*]] = constant dense<1> : tensor<1xi64>
// CHECK:           [[VAL_83:%.*]] = "tf.Slice"([[VAL_3]], [[VAL_81]], [[VAL_82]]) : (tensor<2xf32>, tensor<1xi64>, tensor<1xi64>) -> tensor<1xf32>
// CHECK-DAG:       [[VAL_84:%.*]] = constant dense<1> : tensor<1xi64>
// CHECK-DAG:       [[VAL_85:%.*]] = constant dense<1> : tensor<1xi64>
// CHECK:           [[VAL_86:%.*]] = "tf.Slice"([[VAL_3]], [[VAL_84]], [[VAL_85]]) : (tensor<2xf32>, tensor<1xi64>, tensor<1xi64>) -> tensor<1xf32>
// CHECK-DAG:       [[VAL_87:%.*]] = constant dense<0.000000e+00> : tensor<1xf32>
// CHECK-DAG:       [[VAL_88:%.*]] = constant dense<0.000000e+00> : tensor<1xf32>
// CHECK-DAG:       [[VAL_89:%.*]] = constant dense<0> : tensor<2xi64>
// CHECK-DAG:       [[VAL_90:%.*]] = constant dense<[3, 1]> : tensor<2xi64>
// CHECK:           [[VAL_91:%.*]] = "tf.Slice"([[VAL_55]], [[VAL_89]], [[VAL_90]]) : (tensor<3x1xf32>, tensor<2xi64>, tensor<2xi64>) -> tensor<3x1xf32>
// CHECK-DAG:       [[VAL_92:%.*]] = constant dense<0.000000e+00> : tensor<3xf32>
// CHECK-DAG:       [[VAL_93:%.*]] = constant dense<0.000000e+00> : tensor<1x3xf32>
// CHECK-DAG:       [[VAL_94:%.*]] = constant dense<0.000000e+00> : tensor<1x1xf32>
// CHECK-DAG:       [[VAL_95:%.*]] = constant dense<0> : tensor<1xi64>
// CHECK-DAG:       [[VAL_96:%.*]] = constant dense<1> : tensor<1xi64>
// CHECK:           [[VAL_97:%.*]] = "tf.Slice"([[VAL_5]], [[VAL_95]], [[VAL_96]]) : (tensor<2xf32>, tensor<1xi64>, tensor<1xi64>) -> tensor<1xf32>
// CHECK-DAG:       [[VAL_98:%.*]] = constant dense<1> : tensor<1xi64>
// CHECK-DAG:       [[VAL_99:%.*]] = constant dense<1> : tensor<1xi64>
// CHECK:           [[VAL_100:%.*]] = "tf.Slice"([[VAL_5]], [[VAL_98]], [[VAL_99]]) : (tensor<2xf32>, tensor<1xi64>, tensor<1xi64>) -> tensor<1xf32>
// CHECK-DAG:       [[VAL_101:%.*]] = constant dense<0.000000e+00> : tensor<1xf32>
// CHECK-DAG:       [[VAL_102:%.*]] = constant dense<0.000000e+00> : tensor<1xf32>
...
// CHECK-DAG:       [[VAL_21:%.*]] = constant dense<[-1, 0, 0]> : tensor<3xi32>
// CHECK-DAG:       [[VAL_22:%.*]] = constant dense<0> : tensor<3xi32>
// CHECK-DAG:       [[VAL_23:%.*]] = constant dense<1> : tensor<3xi32>
...
// CHECK-DAG:       [[VAL_21:%.*]] = constant dense<[0, -1, 0]> : tensor<3xi32>
// CHECK-DAG:       [[VAL_22:%.*]] = constant dense<0> : tensor<3xi32>
// CHECK-DAG:       [[VAL_23:%.*]] = constant dense<1> : tensor<3xi32>
...
// CHECK-DAG:       [[VAL_23:%.*]] = constant dense<[-1, 0, 0]> : tensor<3xi32>
// CHECK-DAG:       [[VAL_24:%.*]] = constant dense<0> : tensor<3xi32>
// CHECK-DAG:       [[VAL_25:%.*]] = constant dense<1> : tensor<3xi32>
...
// CHECK-DAG:       [[VAL_23:%.*]] = constant dense<[0, -1, 0]> : tensor<3xi32>
// CHECK-DAG:       [[VAL_24:%.*]] = constant dense<0> : tensor<3xi32>
// CHECK-DAG:       [[VAL_25:%.*]] = constant dense<1> : tensor<3xi32>
