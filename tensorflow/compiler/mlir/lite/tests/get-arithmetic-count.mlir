...
func.func @testMaxPool3D(%arg0: tensor<1x10x10x10x3xf32>) -> tensor<1x10x10x10x3xf32> {
...
func.func @testAveragePool3D(%arg0: tensor<1x10x10x10x3xf32>) -> tensor<1x10x10x10x3xf32> {
  // CHECK: _arithmetic_count = 81000 : i64
