...
func.func @sparse_f32() -> tensor<3x2xf32> {
  ...
  // CHECK: {compressed_data = dense<[1.000000e+00, 2.000000e+00, 5.000000e-01, 2.500000e-01, -1.000000e+00, -2.000000e+00, -5.000000e-01, -2.500000e-01]> : tensor<8xf32>, s_param = {block_map = [3 : i32, 1 : i32], dim_metadata = [{dense_size = 16 : i32, format = #tfl<"dimension_type_attr DENSE">, indices = [], segments = []}, {dense_size = 1 : i32, format = #tfl<"dimension_type_attr DENSE">, indices = [], segments = []}, {dense_size = 1 : i32, format = #tfl<"dimension_type_attr DENSE">, indices = [], segments = []}, {dense_size = 0 : i32, format = #tfl<"dimension_type_attr SPARSE_CSR">, indices = [1 : i32, 4 : i32, 9 : i32], segments = [0 : i32, 5 : i32, 11 : i32]}], traversal_order = [0 : i32, 1 : i32, 2 : i32, 3 : i32]}, value = dense<0.000000e+00> : tensor<3x2xf32>}
  %0 = "tfl.pseudo_sparse_const"() {compressed_data = dense<[1.0, 2.0, 0.5, 0.25, -1.0, -2.0, -0.5, -0.25]> : tensor<8xf32>, s_param = {block_map = [3 : i32, 1 : i32], dim_metadata = [{dense_size = 16 : i32, format = #tfl<"dimension_type_attr DENSE">, indices = [], segments = []}, {dense_size = 1 : i32, format = #tfl<"dimension_type_attr DENSE">, indices = [], segments = []}, {dense_size = 1 : i32, format = #tfl<"dimension_type_attr DENSE">, indices = [], segments = []}, {dense_size = 0 : i32, format = #tfl<"dimension_type_attr SPARSE_CSR">, indices = [1 : i32, 4 : i32, 9 : i32], segments = [0 : i32, 5 : i32, 11 : i32]}], traversal_order = [0 : i32, 1 : i32, 2 : i32, 3 : i32]}, value = dense<0.000000e+00> : tensor<3x2xf32>} : () -> tensor<3x2xf32>
  func.return %0: tensor<3x2xf32>
}

func.func @sparse_f16() -> tensor<3x2xf16> {
  // CHECK-LABEL: @sparse_f16
  // CHECK: {compressed_data = dense<[1.000000e+00, 2.000000e+00, 5.000000e-01, 2.500000e-01, -1.000000e+00, -2.000000e+00, -5.000000e-01, -2.500000e-01]> : tensor<8xf16>, s_param = {block_map = [3 : i32, 1 : i32], dim_metadata = [{dense_size = 16 : i32, format = #tfl<"dimension_type_attr DENSE">, indices = [], segments = []}, {dense_size = 1 : i32, format = #tfl<"dimension_type_attr DENSE">, indices = [], segments = []}, {dense_size = 1 : i32, format = #tfl<"dimension_type_attr DENSE">, indices = [], segments = []}, {dense_size = 0 : i32, format = #tfl<"dimension_type_attr SPARSE_CSR">, indices = [1 : i32, 4 : i32, 9 : i32], segments = [0 : i32, 5 : i32, 11 : i32]}], traversal_order = [0 : i32, 1 : i32, 2 : i32, 3 : i32]}, value = dense<0.000000e+00> : tensor<3x2xf16>}
  %0 = "tfl.pseudo_sparse_const"() {compressed_data = dense<[1.0, 2.0, 0.5, 0.25, -1.0, -2.0, -0.5, -0.25]> : tensor<8xf16>, s_param = {block_map = [3 : i32, 1 : i32], dim_metadata = [{dense_size = 16 : i32, format = #tfl<"dimension_type_attr DENSE">, indices = [], segments = []}, {dense_size = 1 : i32, format = #tfl<"dimension_type_attr DENSE">, indices = [], segments = []}, {dense_size = 1 : i32, format = #tfl<"dimension_type_attr DENSE">, indices = [], segments = []}, {dense_size = 0 : i32, format = #tfl<"dimension_type_attr SPARSE_CSR">, indices = [1 : i32, 4 : i32, 9 : i32], segments = [0 : i32, 5 : i32, 11 : i32]}], traversal_order = [0 : i32, 1 : i32, 2 : i32, 3 : i32]}, value = dense<0.000000e+00> : tensor<3x2xf16>} : () -> tensor<3x2xf16>
  func.return %0: tensor<3x2xf16>
}

func.func @sparse_qu8() -> tensor<3x2x!quant.uniform<u8<1:255>:f32, 1.0>> {
  // CHECK-LABEL: @sparse_qu8
  // CHECK: {compressed_data = dense<[1, 2, 3, 4, -1, -2, -3, -4]> : tensor<8xi8>, qtype = tensor<3x2x!quant.uniform<u8<1:255>:f32, 1.000000e+00>>, s_param = {block_map = [3 : i32, 1 : i32], dim_metadata = [{dense_size = 16 : i32, format = #tfl<"dimension_type_attr DENSE">, indices = [], segments = []}, {dense_size = 1 : i32, format = #tfl<"dimension_type_attr DENSE">, indices = [], segments = []}, {dense_size = 1 : i32, format = #tfl<"dimension_type_attr DENSE">, indices = [], segments = []}, {dense_size = 0 : i32, format = #tfl<"dimension_type_attr SPARSE_CSR">, indices = [1 : i32, 4 : i32, 9 : i32], segments = [0 : i32, 5 : i32, 11 : i32]}], traversal_order = [0 : i32, 1 : i32, 2 : i32, 3 : i32]}, value = dense<0> : tensor<3x2xi8>}
  %0 = "tfl.pseudo_sparse_qconst"() {compressed_data = dense<[1, 2, 3, 4, -1, -2, -3, -4]> : tensor<8xi8>, qtype = tensor<3x2x!quant.uniform<u8<1:255>:f32, 1.0>>, s_param = {block_map = [3 : i32, 1 : i32], dim_metadata = [{dense_size = 16 : i32, format = #tfl<"dimension_type_attr DENSE">, indices = [], segments = []}, {dense_size = 1 : i32, format = #tfl<"dimension_type_attr DENSE">, indices = [], segments = []}, {dense_size = 1 : i32, format = #tfl<"dimension_type_attr DENSE">, indices = [], segments = []}, {dense_size = 0 : i32, format = #tfl<"dimension_type_attr SPARSE_CSR">, indices = [1 : i32, 4 : i32, 9 : i32], segments = [0 : i32, 5 : i32, 11 : i32]}], traversal_order = [0 : i32, 1 : i32, 2 : i32, 3 : i32]}, value = dense<42> : tensor<3x2xi8>} : () -> tensor<3x2x!quant.uniform<u8<1:255>:f32, 1.0>>
