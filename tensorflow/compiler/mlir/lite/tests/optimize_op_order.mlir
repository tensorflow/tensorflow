...
func @dequantize_pushdown_gather_with_reduction(%arg0: tensor<2xi32>) -> tensor<2x2xf32> {
...
func @no_pushdown_gather_with_no_reduction(%arg0: tensor<2xi32>) -> tensor<2x2xf32> {
