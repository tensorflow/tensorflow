...
^bb0(%arg0: tensor<256x32x32x3xf32>, %arg1: tensor<16x3x3x3xf32>, %arg2: tensor<1x1x1x16xf32>):
  // expected-error @+1 {{'tfl.conv_2d' op operand #2 must be 1D tensor of any non-token type values or none type, but got 'tensor<1x1x1x16xf32>'}}
...
func.func @depthwise_conv_2D_invalid_bias(%arg0: tensor<1x224x224x3xf32>) -> tensor<1x112x112x32xf32> {
  ...
  // expected-error @+1 {{'tfl.depthwise_conv_2d' op operand #2 must be 1D tensor of any non-token type values or none type, but got 'tensor<32x1xf32>'}}
