...
^bb0(%arg0: tensor<256x32x32x3xf32>, %arg1: tensor<16x3x3x3xf32>, %arg2: tensor<1x1x1x16xf32>):
  // The expected error string is shortened to match both the older and newer
  // MLIR TableGen dialect message formats.
  // expected-error @+1 {{'tfl.conv_2d' op operand #2 must be 1D tensor}}
...
func.func @depthwise_conv_2D_invalid_bias(%arg0: tensor<1x224x224x3xf32>) -> tensor<1x112x112x32xf32> {
  ...
  // The expected error string is shortened to match both the older and newer
  // MLIR TableGen dialect message formats.
  // expected-error @+1 {{'tfl.depthwise_conv_2d' op operand #2 must be 1D tensor}}
