...
// CHECK-DAG:       %[[CST_1:.*]] = constant dense<0.000000e+00> : tensor<f32>
// CHECK-DAG:       %[[CST_2:.*]] = constant dense<0> : tensor<i32>
// CHECK-DAG:       %[[VAL_0:.*]] = "tfl.while"(%[[CST_2]]) ( {
// CHECK-DAG:       ^bb0(%[[A2_COND:.*]]: tensor<i32>):  // no predecessors
// CHECK-DAG:         %[[CST_3:.*]] = constant dense<3> : tensor<i32>
...
// CHECK-DAG:         %[[CST_4:.*]] = constant dense<1> : tensor<i32>
...
func @increase_3rd_operand_3_times() -> tensor<i32> {
  %cst_0 = "std.constant" () {value = dense<1.0> : tensor<f32>} : () -> tensor<f32>
  %cst_1 = "std.constant" () {value = dense<0.0> : tensor<f32>} : () -> tensor<f32>
  ...
  %0:3 = "tfl.while"(%cst_0, %cst_1, %cst_2) (
    ...
    ^bb0(%arg0: tensor<f32>, %arg1: tensor<f32>, %arg2: tensor<i32>):
      %cst_3 = "std.constant" () {value = dense<3> : tensor<i32>} : () -> tensor<i32>
