// RUN: tf-opt "-xla-legalize-tf=use-tf2xla-fallback=false use-tf2xla-hlo-importer=false" -verify-diagnostics %s | FileCheck --check-prefix NO_FALLBACK %s
...
// RUN: tf-opt "-xla-legalize-tf=use-tf2xla-fallback=true use-tf2xla-hlo-importer=false" %s | FileCheck --check-prefix UNSPECIFIED_FALLBACK_DEVICE %s
// RUN: tf-opt "-xla-legalize-tf=use-tf2xla-fallback=true device-type=INVALID_DEVICE_TYPE use-tf2xla-hlo-importer=false" %s | FileCheck --check-prefix UNSUPPORTED_FALLBACK_DEVICE %s
