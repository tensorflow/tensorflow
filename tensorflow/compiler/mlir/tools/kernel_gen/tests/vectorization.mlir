...
// The following allocation and operations should be removed.
...
// CHECK-NEXT:        %[[VAL_10:.*]] = memref.alloca() {alignment = 16 : i64} : memref<32xi8>
// CHECK-NEXT:        %[[VAL_11:.*]] = memref.cast %[[VAL_10]] : memref<32xi8> to memref<?xi8>
// CHECK-NEXT:        %[[VAL_12:.*]] = memref.view %[[VAL_11]]{{\[}}%[[C0]]][] : memref<?xi8> to memref<4xf64>
...
// CHECK-NEXT:        %[[VAL_23:.*]] = memref.alloca() {alignment = 16 : i64} : memref<32xi8>
// CHECK-NEXT:        %[[VAL_24:.*]] = memref.cast %[[VAL_23]] : memref<32xi8> to memref<?xi8>
// CHECK-NEXT:        %[[VAL_25:.*]] = memref.view %[[VAL_24]]{{\[}}%[[C0]]][] : memref<?xi8> to memref<4xf64>
