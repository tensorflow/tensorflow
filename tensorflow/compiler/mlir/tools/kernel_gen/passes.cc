...
class GpuKernelToBlobPass
 ...
 public:
  ...
  xla::StatusOr<std::vector<uint8>> GetGpuBinaryBlob(
    ...
    int gpu_version = compute_capability_.first;
    std::string libdevice_dir = tensorflow::RocdlRoot();

    return xla::gpu::amdgpu::CompileToHsaco(llvmModule.get(), gpu_version,
    ...
    TF_ASSIGN_OR_RETURN(
        std::string ptx,
        xla::gpu::nvptx::CompileToPtx(llvmModule.get(), compute_capability_,
