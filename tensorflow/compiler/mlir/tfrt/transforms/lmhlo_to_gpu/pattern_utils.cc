...
const tfrt::gpu::wrapper::Platform kGpuTargetPlatform = tfrt::gpu::wrapper::Platform::ROCm;
const tfrt::gpu::wrapper::BlasGemmAlgo kBlasGemmDefaultAlgo = rocblas_gemm_algo_standard;
const tfrt::gpu::wrapper::BlasOperation kBlasOperationTranspose = rocblas_operation_transpose;
const tfrt::gpu::wrapper::BlasOperation kBlasOperationConjTranspose = rocblas_operation_conjugate_transpose;
const tfrt::gpu::wrapper::BlasOperation kBlasOperationNone = rocblas_operation_none;
...
const tfrt::gpu::wrapper::BlasDiagType kBlasDiagNonUnit = rocblas_diagonal_non_unit;
#else
const tfrt::gpu::wrapper::Platform kGpuTargetPlatform = tfrt::gpu::wrapper::Platform::CUDA;
const tfrt::gpu::wrapper::BlasGemmAlgo kBlasGemmDefaultAlgo = CUBLAS_GEMM_DEFAULT;
const tfrt::gpu::wrapper::BlasOperation kBlasOperationTranspose = CUBLAS_OP_T;
const tfrt::gpu::wrapper::BlasOperation kBlasOperationConjTranspose = CUBLAS_OP_C;
const tfrt::gpu::wrapper::BlasOperation kBlasOperationNone = CUBLAS_OP_N;
const tfrt::gpu::wrapper::BlasFillMode kBlasFillModeLower = CUBLAS_FILL_MODE_LOWER;
const tfrt::gpu::wrapper::BlasFillMode kBlasFillModeUpper = CUBLAS_FILL_MODE_UPPER;
