...
// Converts from mlir::Type to the corresponding tfrt::gpu::wrapper::BlasDataType.
tfrt::gpu::wrapper::BlasDataType MlirTypeToBlasDataType(mlir::Type type);

// Converts from mlir::Type to the corresponding tfrt::gpu::wrapper::BlasComputeType.
tfrt::gpu::wrapper::BlasComputeType MlirTypeToBlasComputeType(mlir::Type type);

// Converts from mlir::Type to the corresponding tfrt::gpu::wrapper::DnnDataType.
