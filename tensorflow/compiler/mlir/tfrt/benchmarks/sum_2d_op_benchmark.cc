...
#define BM_DYNAMIC_ALL(ROWS, COLS)                                       \
  BM_SUITE_SUM_F32(Sum2DDynamicAll_##ROWS##_##COLS, 2, INTS(ROWS, COLS), \
...
#define BM_STATIC_ROW(ROWS, COLS)                                      \
  BM_SUITE_SUM_F32(Sum2DStaticRow##ROWS##_##COLS, 2, INTS(ROWS, COLS), \
...
#define BM_STATIC_COL(ROWS, COLS)                                       \
  BM_SUITE_SUM_F32(Sum2DStaticCol_##ROWS##_##COLS, 2, INTS(ROWS, COLS), \
...
#define BM_STATIC_ALL(ROWS, COLS)                                       \
  BM_SUITE_SUM_F32(Sum2DStaticAll_##ROWS##_##COLS, 2, INTS(ROWS, COLS), \
