...
#define BM_DYNAMIC_ALL(ROWS, COLS)                                        \
  BM_SUITE_SUM_F32(SumRowDynamicAll_##ROWS##_##COLS, 2, INTS(ROWS, COLS), \
...
#define BM_STATIC_ROW(ROWS, COLS)                                       \
  BM_SUITE_SUM_F32(SumRowStaticRow##ROWS##_##COLS, 2, INTS(ROWS, COLS), \
...
#define BM_STATIC_COL(ROWS, COLS)                                        \
  BM_SUITE_SUM_F32(SumRowStaticCol_##ROWS##_##COLS, 2, INTS(ROWS, COLS), \
...
#define BM_STATIC_ALL(ROWS, COLS)                                        \
  BM_SUITE_SUM_F32(SumRowStaticAll_##ROWS##_##COLS, 2, INTS(ROWS, COLS), \
