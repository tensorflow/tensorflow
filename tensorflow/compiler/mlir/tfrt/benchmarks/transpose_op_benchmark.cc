...
BM(Jitrt(Transpose_large_1x0, Transpose2D(), "compute",
         Inputs({20480, 20480})));
BM(JitrtV(Transpose_large_1x0, Transpose2D(), "compute",
          Inputs({20480, 20480})));
BM(Tfrt(Transpose_large_1x0, Transpose2D(), "compute", Inputs({20480, 20480})));
BM(Eigen(Transpose_large_1x0, Shuffle<2>({1, 0}), Inputs({20480, 20480})));
