func.func @test(%V__0 : tensor<?x?x?xf32> { python_test_attrs.static_type = tensor<90x46x74xf32> }, %V__1 : tensor<?x?x?xf32> { python_test_attrs.static_type = tensor<90x1x74xf32> }) -> tensor<?x?x?xf32> {
