builtin.func @test(%V__0 : tensor<?x?xf32> { python_test_attrs.static_type = tensor<1x22xf32> }, %V__1 : tensor<?xi1> { python_test_attrs.static_type = tensor<1xi1> }) -> tensor<?x?xf32> {
