builtin.func @test(%V__0 : tensor<f32> { python_test_attrs.static_type = tensor<f32> }, %V__1 : tensor<?x?x?xf32> { python_test_attrs.static_type = tensor<1x80x1xf32> }) -> tensor<?x?xf32> {
