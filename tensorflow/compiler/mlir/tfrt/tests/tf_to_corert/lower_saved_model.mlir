...
func @basic(
    ...
    %arg1: tensor<!tf.resource<tensor<i32>>> {tf_saved_model.bound_input = @z})
  ...
  %0 = "tf.ReadVariableOp"(%arg0) {device = "/device:CPU:0", dtype = i32} : (tensor<!tf.resource<tensor<i32>>>) -> tensor<i32>
  %1 = "tf.ReadVariableOp"(%arg1) {device = "/device:CPU:0", dtype = i32} : (tensor<!tf.resource<tensor<i32>>>) -> tensor<i32>
...
func private @then_branch(
    %arg0: tensor<!tf.resource<tensor<i32>>>,
    %arg1: tensor<!tf.resource<tensor<i32>>>) -> tensor<i32> {
  // CHECK-NOT: tf.ReadVariableOp
  %0 = "tf.ReadVariableOp"(%arg0) {device = "/device:CPU:0", dtype = i32} : (tensor<!tf.resource<tensor<i32>>>) -> tensor<i32>
  // CHECK: return [[arg0]]
  return %0 : tensor<i32>
...
func private @else_branch(
    ...
    %arg1: tensor<!tf.resource<tensor<i32>>>) -> tensor<i32> {
  // CHECK-NOT: tf.ReadVariableOp
  %0 = "tf.ReadVariableOp"(%arg1) {device = "/device:CPU:0", dtype = i32} : (tensor<!tf.resource<tensor<i32>>>) -> tensor<i32>
  // CHECK: return [[arg1]]
  return %0 : tensor<i32>
}
...
func @if(
    ...
    %arg1: tensor<!tf.resource<tensor<i32>>> {tf_saved_model.bound_input = @y},
    %arg2: tensor<!tf.resource<tensor<i32>>> {tf_saved_model.bound_input = @z})
  ...
  %0 = "tf.If"(%arg0, %arg1, %arg2) {then_branch = @then_branch, else_branch = @else_branch, is_stateless = false} : (tensor<i1>, tensor<!tf.resource<tensor<i32>>>, tensor<!tf.resource<tensor<i32>>>) -> tensor<i32>
...
func @case(
  ...
  %0 = "tf.Case"(%arg0, %arg1, %arg2) {branches = [@then_branch, @else_branch], is_stateless = false} : (tensor<i32>, tensor<!tf.resource<tensor<i32>>>, tensor<!tf.resource<tensor<i32>>>) -> tensor<i32>
...
func private @while_cond(
    %arg0: tensor<i32>,
    %arg1: tensor<!tf.resource<tensor<i32>>>) -> tensor<i1> {
...
func private @while_body(
    %arg0: tensor<i32>,
    %arg1: tensor<!tf.resource<tensor<i32>>>) -> (tensor<i32>, tensor<!tf.resource<tensor<i32>>>) {
  // CHECK-NOT: tf.ReadVariableOp
  %0 = "tf.ReadVariableOp"(%arg1) {device = "/device:CPU:0", dtype = i32} : (tensor<!tf.resource<tensor<i32>>>) -> tensor<i32>
  %sum = "tf.AddV2"(%arg0, %0) {device = "/device:CPU:0"} : (tensor<i32>, tensor<i32>) -> tensor<i32>

  return %sum, %arg1 : tensor<i32>, tensor<!tf.resource<tensor<i32>>>
}

// CHECK-LABEL: func @test_while
// CHECK-SAME: [[arg0:%.*]]: tensor<i32> {tf.resource_name = "z"}
func @while(
    %arg0: tensor<!tf.resource<tensor<i32>>> {tf_saved_model.bound_input = @z})
      -> (tensor<i32> {tf_saved_model.index_path = ["r0"]}, tensor<i32> {tf_saved_model.index_path = ["r1"]})
  ...
  %1, %2 = "tf.While"(%0, %arg0)
    ...
    (tensor<i32>, tensor<!tf.resource<tensor<i32>>>) -> (tensor<i32>, tensor<!tf.resource<tensor<i32>>>)

  // CHECK-NOT: tf.ReadVariableOp
  %3 = "tf.ReadVariableOp"(%2) {device = "/device:CPU:0", dtype = i32} : (tensor<!tf.resource<tensor<i32>>>) -> tensor<i32>
...
func private @batched_function(
    %arg0: tensor<i32>,
    %arg1: tensor<*x!tf.resource>) -> tensor<i32> {
  // CHECK-NOT: tf.ReadVariableOp
  %0 = "tf.ReadVariableOp"(%arg1) {device = "/device:CPU:0"} : (tensor<*x!tf.resource>) -> tensor<i32>
