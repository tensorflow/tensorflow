...
func private @batch_3(%arg0: tensor<?x1xi32>) -> tensor<*xi32> {
...
func private @compute_3(%arg0: tensor<?x1xi32> {tf._user_specified_name = "0"}, %arg1: tensor<?x1xi32>) -> (tensor<?x1xi32>, tensor<?x1xi32>) {
  return %arg0, %arg1 : tensor<?x1xi32>, tensor<?x1xi32>
}
