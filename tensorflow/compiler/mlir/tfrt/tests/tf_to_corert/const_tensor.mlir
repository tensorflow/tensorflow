...
func @tensor_proto() -> tensor<!tf.quint8> {
  ...
  %0 = "tf.Const"() {value = opaque<"tf", "0x746674656E736F722464747970653A2044545F5155494E54382074656E736F725F7368617065207B207D2074656E736F725F636F6E74656E743A20224022"> : tensor<!tf.quint8>} : () -> tensor<!tf.quint8>
  return %0 : tensor<!tf.quint8>
}
