...
func private @batch_1(%arg0: tensor<?x?xi32>) -> tensor<*xi32> {
...
func private @compute_1(%arg0: tensor<?x?xi32> {tf._user_specified_name = "0"}, %arg1: tensor<?x?xi32>) -> (tensor<?x?xi32>, tensor<?x?xi32>) {
  return %arg0, %arg1 : tensor<?x?xi32>, tensor<?x?xi32>
}
