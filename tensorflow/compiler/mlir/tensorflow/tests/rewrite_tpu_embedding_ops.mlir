...
func.func @send_tpu_embedding_gradients(%arg0: tensor<512x256xf32>) -> () {
  ...
  "tf.SendTPUEmbeddingGradients"(%arg0) {config = "\0A%\0A\0Dwatches_table\10\F5\03\18\80\02 \01*\0C\1A\00j\05\0D\00\00\80?\88\01\01\10\02\18\80\04 \01(\02", operandSegmentSizes = array<i32: 1, 0>} : (tensor<512x256xf32>) -> ()
  func.return
}
