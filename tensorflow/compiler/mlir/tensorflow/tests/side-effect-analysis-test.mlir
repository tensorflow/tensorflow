...
// ordering tokens are present (TF_CollectiveOrderingEffect).
...
// Tests that we create dependencies between `CollectiveGatherV2` ops if no
// ordering tokens are present (TF_CollectiveOrderingEffect).
func.func @collective_gather_ordering_effect(
  // expected-remark@above {{ID: 7}}
  %input: tensor<f32>,
  %group_key: tensor<i32>,
  %group_size: tensor<i32>,
  ...
  tf_executor.graph {
    ...
    %island = tf_executor.island {
        // expected-remark@above {{ID: 3}}
        // expected-remark@above {{Successors: {4}}}
        %0 = "tf.CollectiveGatherV2"(%input, %group_size, %group_key, %instance_key) : (tensor<f32>, tensor<i32>, tensor<i32>, tensor<i32>) -> tensor<f32>
        // expected-remark@above {{ID: 0}}
        // expected-remark@above {{Successors: {1}}}
        %1 = "tf.CollectiveGatherV2"(%input, %group_size, %group_key, %instance_key) : (tensor<f32>, tensor<i32>, tensor<i32>, tensor<i32>) -> tensor<f32>
        // expected-remark@above {{ID: 1}}
        // expected-remark@above {{Predecessors: {0}}}
        // expected-remark@above {{Successors: {2}}}
        tf_executor.yield
...
// Tests that we don't create dependencies between `CollectiveGatherV2` ops if
// ordering tokens are present and independent.
func.func @collective_gather_independent_ordering_tokens(
  // expected-remark@above {{ID: 7}}
  %arg0: tensor<*x!tf_type.resource<tensor<f32>>> {tf._resource_arg_unique_id = 0 : i64},
  %arg1: tensor<*x!tf_type.resource<tensor<f32>>> {tf._resource_arg_unique_id = 1 : i64},
  %input: tensor<f32>,
  ...
  tf_executor.graph {
    ...
    %island = tf_executor.island {
        // expected-remark@above {{ID: 3}}
        // expected-remark@above {{Successors: {4}}}
        %0 = "tf.CollectiveGatherV2"(%input, %group_size, %group_key, %instance_key, %arg0) : (tensor<f32>, tensor<i32>, tensor<i32>, tensor<i32>, tensor<*x!tf_type.resource<tensor<f32>>>) -> tensor<f32>
        // expected-remark@above {{ID: 0}}
        // expected-remark@above {{Successors: {2}}}
        %1 = "tf.CollectiveGatherV2"(%input, %group_size, %group_key, %instance_key, %arg1) : (tensor<f32>, tensor<i32>, tensor<i32>, tensor<i32>, tensor<*x!tf_type.resource<tensor<f32>>>) -> tensor<f32>
        // expected-remark@above {{ID: 1}}
        // expected-remark@above {{Successors: {2}}}
        tf_executor.yield
        // expected-remark@above {{ID: 2}}
...
// Tests that we do create dependencies between `CollectiveGatherV2` ops if
// ordering tokens are present and dependent.
func.func @collective_gather_dependent_ordering_tokens(
  // expected-remark@above {{ID: 7}}
  %arg0: tensor<*x!tf_type.resource<tensor<f32>>> {tf._resource_arg_unique_id = 0 : i64},
  %arg1: tensor<*x!tf_type.resource<tensor<f32>>> {tf._resource_arg_unique_id = 0 : i64},
  %input: tensor<f32>,
