...
func @LoopTest() {
  ...
  %11:3 = "_tf.NextIteration.value"() {device = "", name = "while/NextIteration", T = "tfdtype$DT_INT32", id = 0} : () -> (tensor<*xi32>, tensor<*xi32>, !_tf.control)
  ...
  "_tf.NextIteration.user"(%10#0) {device = "", name = "while/NextIteration", T = "tfdtype$DT_INT32", id = 0} : (tensor<*xi32>) -> ()
  return
}
