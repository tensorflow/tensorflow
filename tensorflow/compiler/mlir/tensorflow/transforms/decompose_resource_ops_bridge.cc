...
#include "tensorflow/compiler/mlir/tensorflow/transforms/generated_decompose_resource_ops_bridge.inc"
}  // namespace

void PopulateDecomposeResourceOpsBridgePatterns(MLIRContext *context,
