...
class EnterOp
 ...
 public:
  ...
  ValuePtr getData() { return getOperand(0); }
  void setData(ValuePtr value) { setOperand(0, value); }
...
class SwitchOp : public Op<SwitchOp, OpTrait::AtLeastNOperands<2>::Impl,
 ...
 public:
  ...
  ValuePtr getPredicate() { return getOperand(1); }
  void setPredicate(ValuePtr value) { setOperand(1, value); }
