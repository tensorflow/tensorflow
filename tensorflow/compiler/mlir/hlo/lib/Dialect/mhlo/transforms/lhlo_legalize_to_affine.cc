...
static LogicalResult fillBuffer(Location loc, Value buffer, Value fillValue,
  ...
  Value initVal = fillMemRefType
                      ? builder.create<AffineLoadOp>(loc, fillValue, /*indices=*/llvm::None)
                      : fillValue;
