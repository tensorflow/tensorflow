...
func.func @dynamic_broadcast_in_dim(%arg : tensor<?x?xf32>,
  ...
  // CHECK-DAG: %[[RESULT_TILE:.*]] = gml_st.tile %[[RESULT_SPACE]] [0, 1, 2] [3, 4, 5] [1, 1, 1] : !gml_st.tile<123x456x789> to !gml_st.tile<?x?x?>
  ...
  // CHECK-DAG: %[[OPERAND_TILE:.*]] = gml_st.operand_tile_for_dynamic_broadcast_in_dim %[[RESULT_TILE]], %[[OPERAND_SPACE]], %[[RESULT_SPACE]], [0, 2] : !gml_st.tile<?x?x?>, !gml_st.tile<?x?>, !gml_st.tile<123x456x789> -> !gml_st.tile<?x?>
  ...
  %tile = gml_st.tile %space [0, 1, 2] [3, 4, 5] [1, 1, 1]
      : !gml_st.tile<123x456x789> to !gml_st.tile<?x?x?>
