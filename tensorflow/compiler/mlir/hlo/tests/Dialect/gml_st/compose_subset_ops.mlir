...
func.func @tile_of_tile(%arg : tensor<?x?xf32>, %i : index, %j : index,
  ...
  // CHECK-DAG: %[[RES:.*]] = gml_st.materialize %[[ARG]] at %[[TILE]] : tensor<?x?xf32> at !gml_st.tile<4x?>
  // CHECK:     return %[[RES]]
  ...
  %result = gml_st.materialize %arg at %tile_of_tile
      : tensor<?x?xf32> at !gml_st.tile<4x?>
...
func.func @tile_of_tile_of_tile_all_constant(%arg : tensor<4096x2048xf32>)
  ...
  // CHECK-DAG: %[[RES:.*]] = gml_st.materialize %[[ARG]] at %[[TILE]] : tensor<4096x2048xf32> at !gml_st.tile<128x64>
  // CHECK:     return %[[RES]]
  ...
  %res = gml_st.materialize %arg at %ttt
      : tensor<4096x2048xf32> at !gml_st.tile<128x64>
...
func.func @tile_chain_w_zeroes_and_ones(%arg : tensor<8192x4096x2048xf32>, 
  ...
  // CHECK-DAG: %[[RES:.*]] = gml_st.materialize %[[ARG]] at %[[TILE]] : tensor<8192x4096x2048xf32> at !gml_st.tile<?x?x?>
  // CHECK:     return %[[RES]]
  ...
  %result = gml_st.materialize %arg at %tile_of_tile
      : tensor<8192x4096x2048xf32> at !gml_st.tile<?x?x?>
...
func.func @tile_of_tile_arith_shortcuts_add(%arg : tensor<32x32x32xf32>,
  ...
  // CHECK-DAG: %[[RES:.*]] = gml_st.materialize %[[ARG]] at %[[TILE]]
  // CHECK:     return %[[RES]]
  ...
  %result = gml_st.materialize %arg at %tile_of_tile
      : tensor<32x32x32xf32> at !gml_st.tile<8x8x8>
...
func.func @tile_of_tile_arith_shortcuts_mul(%arg : tensor<32x32x32x32x32xf32>,
  ...
  %result = gml_st.materialize %arg at %tile_of_tile
      : tensor<32x32x32x32x32xf32> at !gml_st.tile<8x8x8x8x8>
