...
// CHECK-DAG:  %[[VAL_9:.*]] = arith.constant dense<-1> : tensor<i32>
// CHECK-DAG:  %[[VAL_10:.*]] = arith.constant dense<1> : tensor<i32>
// CHECK-DAG:  %[[VAL_11:.*]] = arith.constant dense<0> : tensor<i32>
// CHECK-DAG:  %[[VAL_12:.*]] = arith.constant dense<1000> : tensor<i32>
// CHECK:  %[[VAL_14:.*]] = arith.index_cast %[[VAL_11]] : tensor<i32> to tensor<index>
// CHECK:  %[[VAL_15:.*]] = tensor.extract %[[VAL_14]][] : tensor<index>
// CHECK:  %[[VAL_16:.*]] = arith.index_cast %[[VAL_12]] : tensor<i32> to tensor<index>
// CHECK:  %[[VAL_17:.*]] = tensor.extract %[[VAL_16]][] : tensor<index>
// CHECK:  %[[VAL_18:.*]] = arith.index_cast %[[VAL_10]] : tensor<i32> to tensor<index>
