...
// CHECK-SAME: tensor<2x!quant.uniform<i32:f32:0, {0.044138411144371337,0.044169864606680966}>>
// CHECK: %[[dq0:.*]] = "quant.dcast"(%[[q0]])

// CHECK: %[[cst_1:.*]] = arith.constant
// CHECK: %[[q1:.*]] = "quant.qcast"(%[[cst_1]]) {volatile}
// CHECK-SAME: tensor<2x3x3x2x!quant.uniform<i8<-127:127>:f32:0, {0.075123051020104109,0.075176584439014829}>>
// CHECK: %[[dq1:.*]] = "quant.dcast"(%[[q1]])
