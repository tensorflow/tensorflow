...
std::unique_ptr<OperationPass<func::FuncOp>> CreateTFConvertTfXlaOpToTfOpPass();
...
std::unique_ptr<OperationPass<func::FuncOp>>
CreateTFInsertCustomAggregationOpsPass(
...
std::unique_ptr<OperationPass<mlir::func::FuncOp>> CreateTFOptimizePass();
