...
class QuantizedModelTest(test.TestCase, parameterized.TestCase):
    ...
    def _extract_first_xla_call_module_op(self, output_saved_model_path: str) -> str:
    ...
    def _get_function_aliases(
        ...
        return loader.get_meta_graph_def_from_tags(tags).meta_info_def.function_aliases
