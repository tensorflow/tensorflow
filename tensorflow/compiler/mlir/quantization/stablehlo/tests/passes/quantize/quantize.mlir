...
// CHECK: %[[CALL_0:.+]] =  call @quantized_dot_general_fn(%[[QCAST_1]], %[[QCAST_0]]) : (tensor<1x4x!quant.uniform<i8:f32, 6.000000e-03:-128>>, tensor<4x3x!quant.uniform<i8<-127:127>:f32, 5.000000e-03>>) -> tensor<1x3x!quant.uniform<i8:f32, 1.000000e-03:-3>>
