...
==============================================================================*/
#ifndef TENSORFLOW_COMPILER_MLIR_QUANTIZATION_STABLEHLO_CC_TF_STATIC_RANGE_PTQ_H_
#define TENSORFLOW_COMPILER_MLIR_QUANTIZATION_STABLEHLO_CC_TF_STATIC_RANGE_PTQ_H_
...
class StaticRangePtqComponent : public quant::stablehlo::Component {
 public:
  ...
  StaticRangePtqComponent(
      ...
      absl::flat_hash_map<std::string, tensorflow::SignatureDef>
          signature_def_map,
      absl::flat_hash_map<quant::stablehlo::FunctionName,
                          quant::stablehlo::FunctionAlias>
          function_aliases);
...
#endif  // TENSORFLOW_COMPILER_MLIR_QUANTIZATION_STABLEHLO_CC_TF_STATIC_RANGE_PTQ_H_
