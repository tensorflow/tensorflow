...
#ifndef TENSORFLOW_COMPILER_MLIR_QUANTIZATION_IR_QUANT_TYPES_H_
#define TENSORFLOW_COMPILER_MLIR_QUANTIZATION_IR_QUANT_TYPES_H_
...
#endif  // TENSORFLOW_COMPILER_MLIR_QUANTIZATION_IR_QUANT_TYPES_H_
