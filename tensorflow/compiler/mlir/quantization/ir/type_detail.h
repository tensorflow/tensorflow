...
// QuantOps Type detail

#ifndef TENSORFLOW_COMPILER_MLIR_QUANTIZATION_IR_TYPE_DETAIL_H_
#define TENSORFLOW_COMPILER_MLIR_QUANTIZATION_IR_TYPE_DETAIL_H_
...
#endif  // TENSORFLOW_COMPILER_MLIR_QUANTIZATION_IR_TYPE_DETAIL_H_
