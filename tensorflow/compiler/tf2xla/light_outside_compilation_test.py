...
class LightOutsideCompilationTest(test_util.TensorFlowTestCase):
    ...
    def test_static_tf_op(self):
        ...
        with context.device("/gpu:0"):
            ...
            self.assertFilecheck(
                compiled_f.experimental_get_compiler_ir(z)("hlo"),
                r"""
    ...
    def test_dynamic_input(self):
        ...
        with context.device("/gpu:0"):
            ...
            with self.assertRaisesRegex(
                ValueError, "Input dynamic dimensions are not supported"
            ):
    ...
    def test_multi_output_tf_op(self):
        ...
        def compiled_f(x):
            return (
                test_ops_for_light_outside_compilation.test_static_multiple_output_tf(x)
            )
