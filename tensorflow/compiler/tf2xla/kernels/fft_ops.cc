...
REGISTER_XLA_OP(Name("RFFT"), RFFTOp<1>);
REGISTER_XLA_OP(Name("RFFT2D"), RFFTOp<2>);
REGISTER_XLA_OP(Name("RFFT3D"), RFFTOp<3>);
...
REGISTER_XLA_OP(Name("IRFFT"), IRFFTOp<1>);
REGISTER_XLA_OP(Name("IRFFT2D"), IRFFTOp<2>);
REGISTER_XLA_OP(Name("IRFFT3D"), IRFFTOp<3>);
