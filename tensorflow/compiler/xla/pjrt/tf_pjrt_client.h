...
#ifndef TENSORFLOW_COMPILER_XLA_PJRT_TF_PJRT_CLIENT_H_
#define TENSORFLOW_COMPILER_XLA_PJRT_TF_PJRT_CLIENT_H_
...
#endif  // TENSORFLOW_COMPILER_XLA_PJRT_TF_PJRT_CLIENT_H_
