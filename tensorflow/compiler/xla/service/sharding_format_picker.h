...
#ifndef TENSORFLOW_COMPILER_XLA_SERVICE_SHARDING_FORMAT_PICKER_H_
#define TENSORFLOW_COMPILER_XLA_SERVICE_SHARDING_FORMAT_PICKER_H_
...
#endif  // TENSORFLOW_COMPILER_XLA_SERVICE_SHARDING_FORMAT_PICKER_H_
