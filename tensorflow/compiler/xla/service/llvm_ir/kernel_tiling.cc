...
IrArray::Index KernelMappingScheme::EmitBlockIndex(
        llvm::Type* index_ty, TargetMachineFeatures& target_machine_features) {
...
KernelMappingScheme::EmitThreadYXCoordinate(llvm::Type* index_ty, TargetMachineFeatures& target_machine_features) {
