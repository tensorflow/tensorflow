...
StatusOr<HloInstruction*> PartitionGather(
  ...
  CHECK_EQ(output_sharding, HloSharding::Replicate());
...
StatusOr<HloInstruction*> PartitionScatter(
  ...
  CHECK_EQ(output_sharding,
           HloSharding::Single(scatter->shape(), HloSharding::Replicate()));
  ...
  new_scatter->set_sharding(output_sharding);
  return new_scatter;
}
