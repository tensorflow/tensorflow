...
TEST_F(CublasLtGemmRewriteTest, ScaledF8) {
  const char* hlo_text = R"(
    HloModule test
...
; CHECK-NEXT:    [[C0:%[^ ]+]] = f16[16,16]{1,0} constant({...})
...
; CHECK-NEXT:    ROOT [[OUT:%[^ ]+]] = (f8e4m3fn[16,16]{1,0}, f32[]) custom-call([[P0]], [[P1_TRANSPOSE]], [[C0]], [[P2]], [[P3]], /*index=5*/[[C1]], [[P4_INV]]),
