...
CHECK: @fusion(i8* noalias align 16 dereferenceable(400) %alloc0, i8* noalias align 64 dereferenceable(600) %alloc1, i8* noalias align 64 dereferenceable(864) %temp_buf)
)");
}
