...
class GpuExecutable : public Executable {
 ...
 private:
  ...
  // The compute capability of the GPU. In the runtime, GpuExecutable check with
  // either amd's isa version, or nvdia's major minor version, depending on the
  // gpu hardware
  absl::variant<std::pair<int, int>, int> compute_capability_;
