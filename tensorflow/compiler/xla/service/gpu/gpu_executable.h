...
>>>>>>> c22f0b0... Addressing review comments
 ...
 private:
  ...
  // The GPU version. In the runtime, GpuExecutable check with
  // either amd's isa version, or nvdia's major minor version for compute
  // capability, depending on the hardware
