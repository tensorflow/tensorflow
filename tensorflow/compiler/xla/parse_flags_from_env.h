...
// flags from an environtment variable, or (if the first non-whitespace in the
// variable value is not '-'), a file named by that environment variable.
//
...
// its return value.
bool ParseFlagsFromEnv(absl::string_view envvar,
