...
// CHECK-LABEL:  func @erf_inv
// CHECK:  [[ARG_0:%.*]]: tensor<16x16xf32>) {
// CHECK-DAG:     [[TMP_0:%.*]] = mhlo.negate [[ARG_0]] : tensor<16x16xf32>
// CHECK-DAG:     [[TMP_1:%.*]] = mhlo.multiply [[ARG_0]], [[TMP_0]] : tensor<16x16xf32>
...
// CHECK-DAG:     [[TMP_5:%.*]] = mhlo.compare  LT, [[TMP_3]], [[TMP_4]],  NOTYPE : (tensor<16x16xf32>, tensor<16x16xf32>) -> tensor<16x16xi1>
// CHECK-DAG:     [[TMP_6:%.*]] = mhlo.constant dense<2.500000e+00> : tensor<16x16xf32>
// CHECK-DAG:     [[TMP_7:%.*]] = mhlo.subtract [[TMP_3]], [[TMP_6]] : tensor<16x16xf32>
...
// CHECK-DAG:     [[TMP_11:%.*]] = mhlo.select [[TMP_5]], [[TMP_7]], [[TMP_10]] : tensor<16x16xi1>, tensor<16x16xf32>
...
// CHECK-DAG:     [[TMP_14:%.*]] = mhlo.select [[TMP_5]], [[TMP_12]], [[TMP_13]] : tensor<16x16xi1>, tensor<16x16xf32>
...
// CHECK-DAG:     [[TMP_17:%.*]] = mhlo.select [[TMP_5]], [[TMP_15]], [[TMP_16]] : tensor<16x16xi1>, tensor<16x16xf32>
// CHECK-DAG:     [[TMP_18:%.*]] = mhlo.multiply [[TMP_14]], [[TMP_11]] : tensor<16x16xf32>
// CHECK-DAG:     [[TMP_19:%.*]] = mhlo.add [[TMP_17]], [[TMP_18]] : tensor<16x16xf32>
// CHECK-DAG:     [[TMP_20:%.*]] = mhlo.constant dense<-3.5233877E-6> : tensor<16x16xf32>
// CHECK-DAG:     [[TMP_21:%.*]] = mhlo.constant dense<0.00134934322> : tensor<16x16xf32>
// CHECK-DAG:     [[TMP_22:%.*]] = mhlo.select [[TMP_5]], [[TMP_20]], [[TMP_21]] : tensor<16x16xi1>, tensor<16x16xf32>
// CHECK-DAG:     [[TMP_23:%.*]] = mhlo.multiply [[TMP_19]], [[TMP_11]] : tensor<16x16xf32>
// CHECK-DAG:     [[TMP_24:%.*]] = mhlo.add [[TMP_22]], [[TMP_23]] : tensor<16x16xf32>
...
// CHECK-DAG:     [[TMP_28:%.*]] = mhlo.multiply [[TMP_24]], [[TMP_11]] : tensor<16x16xf32>
...
// CHECK-DAG:     [[TMP_33:%.*]] = mhlo.multiply [[TMP_29]], [[TMP_11]] : tensor<16x16xf32>
...
// CHECK-DAG:     [[TMP_38:%.*]] = mhlo.multiply [[TMP_34]], [[TMP_11]] : tensor<16x16xf32>
// CHECK-DAG:     [[TMP_39:%.*]] = mhlo.add [[TMP_37]], [[TMP_38]] : tensor<16x16xf32>
...
// CHECK-DAG:     [[TMP_43:%.*]] = mhlo.multiply [[TMP_39]], [[TMP_11]] : tensor<16x16xf32>
...
// CHECK-DAG:     [[TMP_48:%.*]] = mhlo.multiply [[TMP_44]], [[TMP_11]] : tensor<16x16xf32>
...
// CHECK-DAG:     [[TMP_52:%.*]] = mhlo.select [[TMP_5]], [[TMP_50]], [[TMP_51]] : tensor<16x16xi1>, tensor<16x16xf32>
// CHECK-DAG:     [[TMP_53:%.*]] = mhlo.multiply [[TMP_49]], [[TMP_11]] : tensor<16x16xf32>
// CHECK-DAG:     [[TMP_54:%.*]] = mhlo.add [[TMP_52]], [[TMP_53]] : tensor<16x16xf32>
// CHECK-DAG:     [[TMP_55:%.*]] = mhlo.multiply [[TMP_54]], [[ARG_0]] : tensor<16x16xf32>
// CHECK-DAG:     [[TMP_56:%.*]] = mhlo.abs [[ARG_0]] : tensor<16x16xf32>
// CHECK-DAG:     [[TMP_57:%.*]] = mhlo.constant dense<1.000000e+00> : tensor<16x16xf32>
// CHECK-DAG:     [[TMP_58:%.*]] = mhlo.compare  EQ, [[TMP_56]], [[TMP_57]],  NOTYPE : (tensor<16x16xf32>, tensor<16x16xf32>) -> tensor<16x16xi1>
// CHECK-DAG:     [[TMP_59:%.*]] = mhlo.constant dense<3.40282347E+38> : tensor<16x16xf32>
// CHECK-DAG:     [[TMP_60:%.*]] = mhlo.multiply [[ARG_0]], [[TMP_59]] : tensor<16x16xf32>
...
// CHECK: @erf_inv_wide([[ARG_0:%.*]]: tensor<16x16xf64>) {
...
// CHECK-DAG:   [[VAL_165:%.*]] = mhlo.constant dense<1.7976931348623157E+308> : tensor<16x16xf64>
