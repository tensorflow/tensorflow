...
// CHECK-SEQUENTIAL:         %[[MIN:.*]] = affine.min #map0(%[[ARG2]])[%[[LHS_DIM_0]]]
// CHECK-SEQUENTIAL:         %[[MIN_0:.*]] = affine.min #map1(%[[ARG3]])[%[[LHS_DIM_1]]]
...
// CHECK-SEQUENTIAL:         %[[MIN_1:.*]] = affine.min #map0(%[[ARG2_0]])[%[[LHS_DIM_0]]]
// CHECK-SEQUENTIAL:         %[[MIN_2:.*]] = affine.min #map1(%[[ARG3_0]])[%[[LHS_DIM_1]]]
...
// CHECK-SEQUENTIAL:         %[[MIN:.*]] = affine.min #map0(%[[ARG2]])[%[[INIT_DIM_0]]]
// CHECK-SEQUENTIAL:         %[[MIN_0:.*]] = affine.min #map1(%[[ARG3]])[%[[INIT_DIM_1]]]
...
// CHECK-SEQUENTIAL:         %[[MIN:.*]] = affine.min #map0(%[[ARG4]])[%[[DIM]]]
// CHECK-SEQUENTIAL:         %[[MIN_0:.*]] = affine.min #map1(%[[ARG5]])[%[[DIM_0]]]
...
// CHECK-SEQUENTIAL-DAG:   %[[ZERO:.*]] = arith.constant 0
// CHECK-SEQUENTIAL-DAG:   %[[ONE:.*]] = arith.constant 1
...
// CHECK-SEQUENTIAL-DAG:   %[[C1:.*]] = arith.constant 1
// CHECK-SEQUENTIAL-DAG:   %[[C2:.*]] = arith.constant 2
...
// CHECK-SEQUENTIAL-SAME:      [%[[C1]], %[[C1]], %[[OUT_DIM2]]] [1, 1, 1]
