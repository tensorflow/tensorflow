...
// PEELED:         %[[REM_LHS_PAR:.*]] = gml_st.parallel (%[[I:.*]], %[[J:.*]]) = (%[[IUB]], %[[C0]])
// PEELED:           %[[REM_LHS_SLICE:.*]] = gml_st.materialize %[[MAIN_PAR]]
...
// PEELED:         gml_st.parallel (%[[I:.*]], %[[J:.*]]) = (%[[C0]], %[[JUB]])
// PEELED:           %[[REM_RHS_SLICE:.*]] = gml_st.materialize %[[REM_LHS_PAR]]
...
// MARKED-DAG:     %[[C0:.*]] = arith.constant 0 : index
