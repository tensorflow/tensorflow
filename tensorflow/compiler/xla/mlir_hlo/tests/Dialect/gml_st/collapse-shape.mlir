...
// CHECK-1:        %[[COLLAPSED:.*]] = tensor.collapse_shape %[[ARG0]] {{\[\[}}0, 1, 2{{\]\]}}
...
// CHECK-1:        %[[EXPANDED:.*]] = tensor.expand_shape %[[GENERIC]] {{\[\[}}0, 1, 2], [3{{\]\]}}
...
// CHECK-2:        %[[COLLAPSED:.*]] = tensor.collapse_shape %[[ARG0]] {{\[\[}}0, 1], [2{{\]\]}}
...
// CHECK-2:        %[[EXPANDED:.*]] = tensor.expand_shape %[[GENERIC]] {{\[\[}}0, 1], [2], [3{{\]\]}}
...
// CHECK-1:        %[[COLLAPSED:.*]] = tensor.collapse_shape %[[ARG0]] {{\[\[}}0, 1, 2], [3{{\]\]}}
// CHECK-1:        %[[EMPTY:.*]] = tensor.empty()
...
// CHECK-1:        %[[EXPANDED:.*]] = tensor.expand_shape %[[GENERIC]] {{\[\[}}0, 1, 2{{\]\]}}
// CHECK-1:        return %[[EXPANDED]]
...
// CHECK-2:        %[[COLLAPSED:.*]] = tensor.collapse_shape %[[ARG0]] {{\[\[}}0, 1], [2], [3{{\]\]}}
// CHECK-2:        %[[EMPTY:.*]] = tensor.empty()
...
// CHECK-2:        %[[EXPANDED:.*]] = tensor.expand_shape %[[GENERIC]] {{\[\[}}0, 1], [2{{\]\]}}
// CHECK-2:        return %[[EXPANDED]]
...
// CHECK:          %[[COLLAPSED_0:.*]] = tensor.collapse_shape %[[ARG1]] {{\[\[}}0, 1, 2, 3{{\]\]}}
...
// CHECK:          %[[EXPANDED:.*]] = tensor.expand_shape %[[GENERIC]] {{\[\[}}0, 1, 2, 3{{\]\]}}
// CHECK:          return %[[EXPANDED]]

// CHECK-1:      #map = affine_map<(d0, d1) -> (d0, d1)>
// CHECK-1:      func.func @cwise(%[[ARG0:.*]]: tensor<2x4x2048x4096xf32>, %[[ARG1:.*]]: tensor<2x4x2048x4096xf32>)
// CHECK-1:        %[[COLLAPSED:.*]] = tensor.collapse_shape %[[ARG0]] {{\[\[}}0, 1, 2], [3{{\]\]}}
// CHECK-1:        %[[COLLAPSED_0:.*]] = tensor.collapse_shape %[[ARG1]] {{\[\[}}0, 1, 2], [3{{\]\]}}
// CHECK-1:        %[[EMPTY:.*]] = tensor.empty()
// CHECK-1:        %[[GENERIC:.*]] = linalg.generic
...
// CHECK-2:        %[[COLLAPSED:.*]] = tensor.collapse_shape %[[ARG0]] {{\[\[}}0, 1], [2], [3{{\]\]}}
// CHECK-2:        %[[COLLAPSED_0:.*]] = tensor.collapse_shape %[[ARG1]] {{\[\[}}0, 1], [2], [3{{\]\]}}
// CHECK-2:        %[[EMPTY:.*]] = tensor.empty()
// CHECK-2:        %[[GENERIC:.*]] = linalg.generic
...
// CHECK-1:        %[[COLLAPSED_0:.*]] = tensor.collapse_shape %[[ARG0]] {{\[\[}}0, 1, 2], [3{{\]\]}}
...
// CHECK-1:          linalg.yield %[[SUBF]] : f32
// CHECK-1:        %[[EXPANDED:.*]] = tensor.expand_shape %[[GENERIC_1]] {{\[\[}}0, 1, 2], [3{{\]\]}}
// CHECK-1:        return %[[EXPANDED]]
...
// CHECK-2:        %[[COLLAPSED_0:.*]] = tensor.collapse_shape %[[ARG0]] {{\[\[}}0, 1], [2], [3{{\]\]}}
...
// CHECK-2:          linalg.yield %[[SUBF]] : f32
// CHECK-2:        %[[EXPANDED:.*]] = tensor.expand_shape %[[GENERIC_1]] {{\[\[}}0, 1], [2], [3{{\]\]}}
// CHECK-2:        return %[[EXPANDED]]
