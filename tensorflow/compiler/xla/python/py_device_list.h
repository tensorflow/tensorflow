...
#ifndef TENSORFLOW_COMPILER_XLA_PYTHON_PY_DEVICE_LIST_H_
#define TENSORFLOW_COMPILER_XLA_PYTHON_PY_DEVICE_LIST_H_
...
#endif  // TENSORFLOW_COMPILER_XLA_PYTHON_PY_DEVICE_LIST_H_
