...
class Client:
    ...
    def get_default_device_assignment(
        self, num_replicas: int, num_partitions: int
    ) -> List[List[Device]]: ...
    @overload
    ...
    def compile(
        self, computation: XlaComputation, compile_options: CompileOptions = ...
    ) -> Executable: ...
    def serialize_executable(self, executable: Executable) -> bytes: ...
    def deserialize_executable(
        self, serialized: bytes, options: CompileOptions
    ) -> Executable: ...
    # TODO(skyewm): remove when jax stop providing hlo_module
    def deserialize_executable(
        self, serialized: bytes, hlo_module: HloModule, options: CompileOptions
    ) -> Executable: ...
...
class Executable:
    ...
    def execute_sharded_on_local_devices(
        self, arguments: Sequence[List[DeviceArray]]
...
def buffer_to_dlpack_managed_tensor(
    buffer: Buffer, take_ownership: bool = ...
) -> Any: ...
