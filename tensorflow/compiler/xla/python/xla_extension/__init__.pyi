...
class ShardedBuffer:
  ...
  def get_device_buffer(self, device_id: int) -> DeviceArray: ...
...
class ArrayImpl:
  ...
  def platform(self) -> str: ...
  def unsafe_buffer_pointer(self) -> Any: ...
  def _on_device_size_in_bytes(self) -> int: ...
  def copy_to_device(self, dst_device: Device) -> ArrayImpl: ...
  def _single_device_array_to_np_array(self) -> np.ndarray: ...
  def _copy_single_device_array_to_host_async(self) -> _Status: ...
  def is_deleted(self) -> bool: ...
...
class LoadedExecutable:
  ...
  def execute_sharded_on_local_devices(
      self,
      arguments: Sequence[Union[ShardedBuffer, List[DeviceArray]]]) -> List[Union[ShardedBuffer, List[DeviceArray]]]: ...
