...
def AllGather(
    ...
    use_global_device_placement: Optional[bool] = ...,
) -> XlaOp: ...
def AllReduce(
    operand: XlaOp,
...
def ApproxTopK(
    ...
    reduction_input_size_override: Optional[int],
) -> XlaOp: ...
def ApproxTopKReductionOutputSize(
    ...
    recall_target: float,
    aggregate_to_topk: Optional[bool] = ...,
    input_size_override: Optional[int] = ...,
) -> Tuple[int, int]: ...
def ReduceScatter(
    operand: XlaOp,
    computation: XlaComputation,
    ...
    use_global_device_ids: Optional[bool] = ...,
) -> XlaOp: ...
def AllToAll(
    operand: XlaOp,
    split_dimension: int,
...
def BitcastConvertType(operand: XlaOp, new_element_type: PrimitiveType) -> XlaOp: ...
...
def CollectivePermute(
    operand: XlaOp, source_target_pairs: Sequence[Tuple[int, int]]
) -> XlaOp: ...
def ConcatInDim(
...
def ConvertElementType(operand: XlaOp, new_element_type: PrimitiveType) -> XlaOp: ...
def CreateToken(builder: XlaBuilder) -> XlaOp: ...
def CrossReplicaSum(
    operand: XlaOp, replica_groups: Sequence[_ReplicaGroup] = ...
) -> XlaOp: ...
def CustomCall(
    builder: XlaBuilder,
...
def Fft(operand: XlaOp, fft_type: FftType, fft_length: Sequence[int]) -> XlaOp: ...
def Gather(
    a: XlaOp,
    start_indices: XlaOp,
...
def InfeedWithToken(
    token: XlaOp, shape: Shape, config: Optional[str] = ...
) -> XlaOp: ...
@overload
...
def OutfeedWithToken(
    ...
    token: XlaOp,
    shape_with_layout: Shape,
    outfeed_config: Optional[str] = ...,
) -> XlaOp: ...
def Pad(
    operand: XlaOp, padding_value: XlaOp, padding_config: _PaddingConfig
) -> XlaOp: ...
def Parameter(
    builder: XlaBuilder,
...
@overload
def Reshape(
    operand: XlaOp, dimensions: Sequence[int], new_sizes: Sequence[int]
) -> XlaOp: ...
@overload
...
def While(condition: XlaComputation, body: XlaComputation, init: XlaOp) -> XlaOp: ...
...
def ShiftLeft(
    lhs: XlaOp, rhs: XlaOp, broadcast_dimensions: Sequence[int] = ...
) -> XlaOp: ...
