...
def execute_with_python_values(
    executable: Executable, arguments: Sequence[Any], backend: Client
) -> Sequence[numpy.ndarray]: ...
def execute_with_python_values_replicated(
    executable: Executable, arguments: Sequence[Sequence[Any]], backend: Client
...
def make_gpu_client(
    distributed_client: Optional[DistributedRuntimeClient] = ..., node_id: int = ...
) -> Client: ...
...
def make_replica_groups(
    replica_groups: Optional[Sequence[Sequence[int]]],
) -> List[ReplicaGroup]: ...
