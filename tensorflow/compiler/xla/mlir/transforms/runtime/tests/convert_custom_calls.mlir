// RUN: xla-runtime-opt %s --xla-rt-convert-custom-calls | FileCheck %s --dump-input=always
...
// CHECK: ) -> memref<?xf32> attributes {rt.exported} {
func.func @function_call_to_custom_call(
  %arg0: !rt.execution_context,
  %arg1: memref<?xf32>
) -> memref<?xf32> attributes {rt.exported} {
