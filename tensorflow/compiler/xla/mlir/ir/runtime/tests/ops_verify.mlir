...
func.func private @verify_entrypoint_non_func(%arg0: memref<?xf32>) {
  ...
  call @direct_custom_call(%arg0) {rt.entrypoint}: (memref<?xf32>) -> ()
  return
}
...
// -----
// expected-error @+1 {{'func.func' op requires "rt.direct_custom_call" to only accept string value}}
func.func private @direct_custom_call(%arg0: memref<?xf32>) -> memref<?xf32>
  attributes { rt.direct_custom_call = 1, attr0 = 1 : i32, attr1 = 1.0 : f32 }
...
func.func private @verify_custom_call_non_func(%arg0: memref<?xf32>)
  ...
  call @direct_custom_call(%arg0) {rt.custom_call = "target"}: (memref<?xf32>) -> ()
  return
}
