...
using TypesF8 = ::testing::Types<tsl::float8_e4m3>;
...
XLA_TYPED_TEST(DotOperationTestWithCublasLt_F8, ScaledF8) {
  ...
  XlaOp tuple = Tuple(&builder, {d_f8, d_amax});
  ...
  Literal expected_d = LiteralUtil::CreateR2FromArray2D<T>(
      {{64.0f, 0.0f, 128.0f, 0.0f, 192.0f, 0.0f, 256.0f, 0.0f, 320.0f, 0.0f,
        384.0f, 0.0f, 448.0f, 0.0f, 448.0f, 0.0f},
       {0.0f, 448.0f, 0.0f, 448.0f, 0.0f, 384.0f, 0.0f, 320.0f, 0.0f, 256.0f,
        0.0f, 192.0f, 0.0f, 128.0f, 0.0f, 64.0f},
       {64.0f, 0.0f, 128.0f, 0.0f, 192.0f, 0.0f, 256.0f, 0.0f, 320.0f, 0.0f,
        384.0f, 0.0f, 448.0f, 0.0f, 448.0f, 0.0f},
       {0.0f, 448.0f, 0.0f, 448.0f, 0.0f, 384.0f, 0.0f, 320.0f, 0.0f, 256.0f,
        0.0f, 192.0f, 0.0f, 128.0f, 0.0f, 64.0f},
       ...
       {0.0f, 448.0f, 0.0f, 448.0f, 0.0f, 384.0f, 0.0f, 320.0f, 0.0f, 256.0f,
        0.0f, 192.0f, 0.0f, 128.0f, 0.0f, 64.0f}});
  Literal expected_amax = LiteralUtil::CreateR0<float>({655.36f});
