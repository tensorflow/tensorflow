...
// For the unit tests to load any registered driver plugins
void LoadRegisteredPlugins();

// For a static initializer to call, registering a loading
// function to be called once the unit test main has started
void RegisterXlaDriverPlugin(const std::function<void()>);
