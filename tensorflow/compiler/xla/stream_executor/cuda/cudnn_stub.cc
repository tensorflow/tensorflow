...
#elif CUDNN_MAJOR < 7
#include "tensorflow/compiler/xla/stream_executor/cuda/cudnn_6_0.inc"
#elif CUDNN_MAJOR == 7 && CUDNN_MINOR < 1
#include "tensorflow/compiler/xla/stream_executor/cuda/cudnn_7_0.inc"
// 2 instead of 3: see https://github.com/tensorflow/tensorflow/issues/32350
#elif CUDNN_MAJOR == 7 && CUDNN_MINOR < 2
#include "tensorflow/compiler/xla/stream_executor/cuda/cudnn_7_1.inc"
#elif CUDNN_MAJOR == 7 && CUDNN_MINOR < 4
#include "tensorflow/compiler/xla/stream_executor/cuda/cudnn_7_3.inc"
#elif CUDNN_MAJOR == 7 && CUDNN_MINOR < 6
#include "tensorflow/compiler/xla/stream_executor/cuda/cudnn_7_4.inc"
#elif CUDNN_MAJOR == 7
#include "tensorflow/compiler/xla/stream_executor/cuda/cudnn_7_6.inc"
#else
#include "tensorflow/compiler/xla/stream_executor/cuda/cudnn_8_0.inc"
#endif
