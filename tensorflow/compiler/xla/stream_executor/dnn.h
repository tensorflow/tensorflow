...
class TensorDescriptor {
 public:
  TensorDescriptor() {}
  port::StatusOr<std::vector<int64_t>> GetPhysicalDimensionsMajorToMinor()
      const;
...
class MatmulTensorDescriptor {
 public:
  ...
  port::StatusOr<std::vector<int64_t>> GetNonContractingDims() const;
  ...
  std::vector<int64_t> GetCudnnCompatibleStrides(
      bool is_lhs
      /*if not lhs, then rhs*/) const;
  port::StatusOr<std::vector<int64_t>> MakeCudnnCompatible(
...
class DnnSupport {
 public:
  ...
  virtual port::StatusOr<std::unique_ptr<const dnn::FusedMHASimpleRunner>>
  ...
  virtual port::StatusOr<std::unique_ptr<const dnn::FusedMHAMaskRunner>>
  ...
  virtual port::StatusOr<std::unique_ptr<const dnn::FusedMHABiasMaskRunner>>
