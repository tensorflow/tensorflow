...
class XlaCompilationCache : public ResourceBase {
 public:
  ...
  //
  // The result of compilation is written to `*out_compilation_result`, which must
  // be non-null. If `out_executable` is non-null, also builds an
  // xla::LocalExecutable and sets `out_executable` to point to it. The resulting
