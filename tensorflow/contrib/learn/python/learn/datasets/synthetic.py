...
def circles(n_samples=100, noise=None, factor=0.8, n_classes=2, *args, **kwargs):
  ...
  Args:
    ...
    factor: size factor of the inner circles with respect to the outer ones (optional, float, default=0.8)
    n_classes: Number of classes to generate (optional, int, default=2)
