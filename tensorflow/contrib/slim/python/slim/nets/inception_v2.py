...
def inception_v2_base(inputs,
  ...
  Args:
    ...
    scope: Optional variable_op_scope.
  ...
  with tf.variable_op_scope([inputs], scope, 'InceptionV2'):
    with slim.arg_scope(
...
def inception_v2(inputs,
  ...
  with tf.variable_op_scope([inputs, num_classes], scope,
                            'InceptionV2', reuse=reuse) as scope:
