...
_single_image_random_dot_stereograms_op = _single_image_random_dot_stereograms.single_image_random_dot_stereograms

def single_image_random_dot_stereograms(**kwargs):
  ...
  Raises:
    Nothing
  """
  return _single_image_random_dot_stereograms_op(**kwargs)

ops.NotDifferentiable("single_image_random_dot_stereograms")
