...
from one graph to another. There are separate functions to copy ops and
variables, since their usage in TensorFlow is intrinsically different.
There is also a function to retrive an op from 
