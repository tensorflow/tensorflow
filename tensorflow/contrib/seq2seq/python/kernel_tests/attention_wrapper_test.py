...
class AttentionWrapperTest(test.TestCase):
  ...
  def testNotUseAttentionLayer(self):
    ...
    expected_final_output = BasicDecoderOutput(
        rnn_output=array(
            [[[
                -0.24277855, -0.07872247, 0.15671003, 0.24866608, 0.30515286,
                -0.24618624, 0.0507621, 0.18785201, -0.16496147, -0.138405
            ], [
                -0.24277849, -0.07872227, 0.15671015, 0.24866594, 0.30515245,
                -0.24618617, 0.05076224, 0.18785192, -0.16496134, -0.13840486
            ], [
                -0.24277903, -0.07872239, 0.15671065, 0.24866652, 0.30515283,
                -0.24618667, 0.05076243, 0.18785232, -0.16496192, -0.13840519
            ]], [[
                0.39683789, 0.12260036, -0.06023827, -0.09247135, 0.11370862,
                -0.1547074, 0.00654875, -0.26491123, 0.08399884, 0.1876322
            ], [
                0.39683688, 0.12260011, -0.06023812, -0.09247123, 0.11370841,
                -0.15470725, 0.00654882, -0.26491043, 0.08399857, 0.18763176
            ], [
                0.39683694, 0.12260016, -0.06023812, -0.09247129, 0.11370847,
                -0.1547074, 0.00654885, -0.2649104, 0.08399855, 0.18763182
            ]], [[
                -0.432805, 0.07398784, -0.01561836, 0.19199517, -0.02651545,
                -0.21643993, -0.02017856, 0.00162333, 0.21297953, 0.25590748
            ], [
                -0.43280441, 0.07398778, -0.01561838, 0.19199494, -0.02651539,
                -0.2164396, -0.02017859, 0.00162333, 0.2129792, 0.25590718
            ], [
                -0.43280473, 0.07398786, -0.01561838, 0.19199508, -0.02651543,
                -0.21643978, -0.02017862, 0.00162333, 0.21297936, 0.25590736
            ]], [[
                0.07059769, 0.16451193, 0.01174642, 0.04646424, 0.14275651,
                0.07944378, -0.10852743, 0.15305836, 0.02151343, -0.05589932
            ], [
                0.07059769, 0.16451195, 0.01174642, 0.04646424, 0.14275652,
                0.07944378, -0.10852744, 0.15305838, 0.02151344, -0.05589932
            ], [
                0.07059769, 0.16451193, 0.01174642, 0.04646424, 0.14275651,
                0.07944378, -0.10852743, 0.15305836, 0.02151343, -0.05589932
            ]], [[0., 0., 0., 0., 0., 0., 0., 0., 0.,
    ...
    expected_final_state = AttentionWrapperState(
        cell_state=LSTMStateTuple(
            c=array(
                [[
                    -0.01816516, -0.01675301, -0.00513183, 0.01560374,
                    -0.01254231, -0.00434179, -0.01262734, -0.01721472,
                    0.02279618
                ], [
                    0.01265936, -0.00846189, -0.00376618, 0.0313628,
                    -0.03488337, -0.02464793, -0.00498007, -0.00459409,
                    -0.02097382
                ], [
                    -0.00780995, 0.00314269, -0.01383716, -0.01147376,
                    0.00483319, -0.01340735, 0.00865264, -0.00632812,
                    -0.01053766
                ], [
                    -0.04184838, -0.01223641, 0.00094449, 0.03911438,
                    0.00432476, 0.0222066, -0.0300624, -0.05418365, -0.0261539
                ], [
            ...
            h=array(
                [[
                    -0.00912324, -0.00827531, -0.00261125, 0.00765155,
                    -0.00636977, -0.00217171, -0.00643897, -0.00876094,
                    0.01136858
                ], [
                    0.00629574, -0.00427225, -0.00182555, 0.01597121,
                    -0.01734862, -0.01224119, -0.00245434, -0.0023048,
                    -0.01077694
                ], [
                    -0.00391358, 0.00161294, -0.00683057, -0.00569066,
                    0.0024297, -0.00658555, 0.00429511, -0.00309842, -0.00520863
                ], [
                    -0.02087489, -0.00603306, 0.00047561, 0.01920064,
                    0.00213868, 0.01115329, -0.01526589, -0.02687524,
                    -0.01297526
                ], [
