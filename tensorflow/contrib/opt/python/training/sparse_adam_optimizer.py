...
large improvement in model training throughput for some applications. The semantics of Sparse Adam is close to the original Adam algorithm, and the convergence is also close to Adam.
"""
...
class SparseAdamOptimizer(adam.AdamOptimizer):
  ...
  The same as Lazy Adam, this class provides lazier handling of gradient updates for sparse variables.
  ...
  improvements in model training throughput for some applications. Compared with Lazy Adam, the sementics
  of Spare Adam is close to original Adam optimizer, and the convergence is also close to original Adam.
  """
  ...
  def _finish(self, update_ops, name_scope):
    ...
    # TODO: this function will be updated the same as _resource_apply_sparse
