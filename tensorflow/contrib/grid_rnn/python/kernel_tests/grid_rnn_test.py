...
class GridRNNCellTest(tf.test.TestCase):
  ...
  def testGrid2BasicLSTMCell(self):
    with self.test_session(use_gpu=False) as sess:
      with tf.variable_scope(
        ...
        self.assertEqual(s[0][0].get_shape(), (1, 2))
        self.assertEqual(s[0][1].get_shape(), (1, 2))
        self.assertEqual(s[1][0].get_shape(), (1, 2))
        self.assertEqual(s[1][1].get_shape(), (1, 2))
        ...
        self.assertAllClose(res_s[0][0].shape, (1, 2))
        self.assertAllClose(res_s[0][1].shape, (1, 2))
        self.assertAllClose(res_s[1][0].shape, (1, 2))
        self.assertAllClose(res_s[1][1].shape, (1, 2))
        ...
        self.assertEqual(len(s2[0]), 2)
        self.assertEqual(len(s2[1]), 2)
        self.assertEqual(s2[0][0].get_shape(), (1, 2))
        self.assertEqual(s2[0][1].get_shape(), (1, 2))
        self.assertEqual(s2[1][0].get_shape(), (1, 2))
        self.assertEqual(s2[1][1].get_shape(), (1, 2))
        ...
        self.assertAllClose(res_s2[0][0].shape, (1, 2))
        self.assertAllClose(res_s2[0][1].shape, (1, 2))
        self.assertAllClose(res_s2[1][0].shape, (1, 2))
        self.assertAllClose(res_s2[1][1].shape, (1, 2))
  ...
  # test with input of None (https://github.com/tensorflow/tensorflow/issues/4296)

  # test for state_size and output_size
