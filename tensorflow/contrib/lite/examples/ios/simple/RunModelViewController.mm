...
@interface RunModelViewController () <UINavigationControllerDelegate,
...
- (NSString*)runInferenceOnImage:(UIImage*)image {
  ...
  NSString* graph_path = [self filePathForResourceName:@"mobilenet_v1_1.0_224"
                                         withExtension:@"tflite"];

  std::unique_ptr<tflite::FlatBufferModel> model(
      tflite::FlatBufferModel::BuildFromFile([graph_path fileSystemRepresentation]));
