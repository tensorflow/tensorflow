...
public final class OperatorProcessor extends AbstractProcessor {
  ...
  private static final TypeName T_OPERAND =
    ParameterizedTypeName.get(ClassName.get("org.tensorflow", "Operand"), WildcardTypeName.subtypeOf(Object.class));
  // Iterable<Operand<?>>
  private static final TypeName T_ITERABLE_OPERAND = ParameterizedTypeName.get(ClassName.get(Iterable.class), T_OPERAND);
