...
public interface OperationBuilder {
   ...
   * <ul>
   * <li>In eager mode, the result of the operation will be computed immediately.</li>
   * <li>In graph mode, the operation will be added as a node to the graph to be executed later, when running
   * a {@link Session}.</li>
   * </ul>
   *
