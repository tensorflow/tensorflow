...
public class TensorTest {
  ...
  public void scalars() {
    ...
    {
      Tensor t = Tensor.create(8589934592L);
  ...
  public void failCreateOnMismatchedDimensions() {
    ...
    try {
      Tensor t = Tensor.create(invalid);
  ...
  public void failCopyToOnScalar() {
    final Tensor scalar = Tensor.create(3);
    try {
      scalar.copyTo(3);
  ...
  public void failOnArbitraryObject() {
    try {
      Tensor t = Tensor.create(new Object());
  ...
  public void failOnZeroDimension() {
    try {
      Tensor t = Tensor.create(new int[3][0][1]);
