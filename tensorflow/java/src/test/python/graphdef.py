...
# ==============================================================================
"""Generate a GraphDef for the Java Graph unittest.

Temporary tool to excercise the Java API unittests till that API becomes
expressive enough to construct graphs. Delete this tool when that happens.
"""
