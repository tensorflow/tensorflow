...
#ifndef TENSORFLOW_CORE_TPU_TF_RENDEZVOUS_C_API_CONVERSIONS_H_
#define TENSORFLOW_CORE_TPU_TF_RENDEZVOUS_C_API_CONVERSIONS_H_
...
tsl::AllocatorAttributes FromC(const TF_AllocatorAttributes& attributes);
...
#endif  // TENSORFLOW_CORE_TPU_TF_RENDEZVOUS_C_API_CONVERSIONS_H_
