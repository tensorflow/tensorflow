...
class XlaSparseDenseMatmulCustomCombinerOnTcWithCsrInputOp
 ...
 public:
  ...
  xla::XlaComputation BuildTcCustomCombinerComputation(
    ...
    CHECK_OK(compiler->CompileFunction(options, combiner_computation_,
                                       arguments,
  ...
  void Compile(XlaOpKernelContext* ctx) override {
    ...
    xla::XlaComputation custom_combiner_tc_computation =
