...
#include "xprof/plugin/tensorboard_plugin_profile/protobuf/hardware_types.pb.h"  // from @org_xprof
#include "xprof/plugin/tensorboard_plugin_profile/protobuf/op_stats.pb.h"  // from @org_xprof
