...
#include "xprof/plugin/tensorboard_plugin_profile/protobuf/input_pipeline.pb.h"  // from @org_xprof
#include "xprof/plugin/tensorboard_plugin_profile/protobuf/op_stats.pb.h"  // from @org_xprof
#include "xprof/plugin/tensorboard_plugin_profile/protobuf/tpu_input_pipeline.pb.h"  // from @org_xprof
