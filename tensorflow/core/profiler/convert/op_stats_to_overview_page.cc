...
#include "xprof/plugin/tensorboard_plugin_profile/protobuf/overview_page.pb.h"  // from @org_xprof
#include "xprof/plugin/tensorboard_plugin_profile/protobuf/power_metrics.pb.h"  // from @org_xprof
#include "xprof/plugin/tensorboard_plugin_profile/protobuf/tf_function.pb.h"  // from @org_xprof
