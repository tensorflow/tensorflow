...
static inline Status CsrmmImpl(
  ...
  TF_RETURN_IF_GPUSPARSE_ERROR(op(hipsparse_handle, transA, transB, m, n, k,
                                  nnz, AsHipComplex(alpha_host), descrA, 
                                  AsHipComplex(csrSortedValA), csrSortedRowPtrA, 
                                  csrSortedColIndA, AsHipComplex(B), ldb, 
...
static inline Status CsrmvImpl(SparseFnT op, OpKernelContext* context,
  ...
  TF_RETURN_IF_GPUSPARSE_ERROR(
      op(hipsparse_handle, transA, m, n, nnz, AsHipComplex(alpha_host), 
         descrA, AsHipComplex(csrSortedValA), csrSortedRowPtrA, 
         csrSortedColIndA, AsHipComplex(x), AsHipComplex(beta_host),
         AsHipComplex(y)));
  return Status::OK();
}
...
static inline Status CsrgemmImpl(
  ...
  TF_RETURN_IF_GPUSPARSE_ERROR(
      op(hipsparse_handle, transA, transB, m, n, k, descrA, nnzA,
         AsHipComplex(csrSortedValA), csrSortedRowPtrA, csrSortedColIndA, 
         descrB, nnzB, AsHipComplex(csrSortedValB), csrSortedRowPtrB, 
         csrSortedColIndB, descrC, AsHipComplex(csrSortedValC),
...
static inline Status Csr2cscImpl(SparseFnT op, OpKernelContext* context,
  ...
  TF_RETURN_IF_GPUSPARSE_ERROR(
      op(hipsparse_handle, m, n, nnz, AsHipComplex(csrVal),
         csrRowPtr, csrColInd, AsHipComplex(cscVal),
