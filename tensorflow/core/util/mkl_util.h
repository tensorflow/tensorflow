...
class MklDnnData {
 ...
 public:
  ...
  // hence default operator= will result in memory leak if user_memory was already initialized.
  // See https://github.com/tensorflow/tensorflow/pull/45593 as an example of such leak.
