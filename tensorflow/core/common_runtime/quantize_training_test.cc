...
TEST_F(QuantizeTrainingTest, FixedRangeAndEMARange_QuantizeAndDequantize) {
  ...
  */
  ...
  // of 0 and 6.
  string min_const_name = absl::StrCat(relu6->name(), "/InputMin");
  string max_const_name = absl::StrCat(relu6->name(), "/InputMax");
  ...
  string min_var_name = absl::StrCat(relu->name(), "/Min/Variable");
  string max_var_name = absl::StrCat(relu->name(), "/Max/Variable");
