...
TEST(GPUBFCAllocatorTest, NoDups) {
  GPUBFCAllocator a(PhysicalGpuId(0), 1 << 30, "GPU_0_bfc");
...
TEST(GPUBFCAllocatorTest, TestCustomMemoryLimit) {
  ...
  GPUBFCAllocator a(PhysicalGpuId(0), 1 << 20, "GPU_0_bfc");
...
TEST(GPUBFCAllocatorTest, AllocationsAndDeallocationsWithGrowth) {
  ...
  GPUBFCAllocator a(PhysicalGpuId(0), 1LL << 31, options, "GPU_0_bfc");
...
TEST(GPUBFCAllocatorTest, DISABLED_AllocatorReceivesZeroMemory) {
  GPUBFCAllocator a(PhysicalGpuId(0), 1UL << 60, "GPU_0_bfc");
  GPUBFCAllocator b(PhysicalGpuId(0), 1UL << 60, "GPU_0_bfc");
...
static void BM_Allocation(int iters) {
  GPUBFCAllocator a(PhysicalGpuId(0), 1uLL << 33, "GPU_0_bfc");
...
class GPUBFCAllocatorPrivateMethodsTest : public ::testing::Test {
 protected:
  ...
  void TestLog2FloorNonZeroSlow() {
    GPUBFCAllocator a(PhysicalGpuId(0), 1 /* total_memory */, "GPU_0_bfc");
