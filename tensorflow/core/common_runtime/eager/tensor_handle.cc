...
absl::Status TensorHandle::ExtractPackedHandle(const int index,
  ...
  if (Type() != PACKED) {
    return absl::InternalError(
        absl::StrCat("Invalid ExtractPackedHandleOnDevice call on a",
                     TypeString(), " handle: ", absl::Hex(this)));
  }
...
absl::Status TensorHandle::Tensor(const tensorflow::Tensor** t) const {
  ...
  if (Type() != LOCAL) {
    return absl::InternalError(absl::StrCat("Invalid Tensor call on a ",
                                            TypeString(),
                                            " handle: ", absl::Hex(this)));
  }
...
absl::Status TensorHandle::TensorFromDevice(
  ...
  if (elem == local_mirrors_.end()) {
    return absl::InternalError(
        absl::StrCat("Invalid device: ", absl::Hex(d),
                     " in Tensor call to handle: ", absl::Hex(this)));
  }
...
absl::Status TensorHandle::TensorValue(const Device* d,
  ...
  if (d == device_) {
    if (Type() != LOCAL) {
      return absl::InternalError(absl::StrCat("Invalid TensorValue call on a ",
                                              TypeString(),
                                              " handle: ", absl::Hex(this)));
    }
  ...
  if (elem == local_mirrors_.end()) {
    return absl::InternalError(
        absl::StrCat("Invalid device: ", absl::Hex(d),
                     " in TensorValue call: ", absl::Hex(this)));
  }
...
absl::Status TensorHandle::Unprotect(const Device* d) {
  ...
  if (elem == local_mirrors_.end()) {
    return absl::InternalError(
        absl::StrCat("Invalid device: ", absl::Hex(d),
                     " in Unprotect call to handle: ", absl::Hex(this)));
  }
