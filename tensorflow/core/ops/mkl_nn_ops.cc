...
REGISTER_OP("_MklNativeFusedBatchNorm")
    ...
    .Doc(R"doc(
MKL version of FusedBatchNorm operator that does not depend
on layout propagation. Uses oneDNN APIs to perform fused
batch normalization.
...
REGISTER_OP("_MklNativeFusedBatchNormGrad")
    ...
    .Doc(R"doc(
MKL version of FusedBatchNormGrad operator that does not depend
on layout propagation. Uses oneDNN APIs to compute
...
REGISTER_OP("_MklNativeFusedBatchNormEx")
    ...
    .SetShapeFn(shape_inference::FusedBatchNormShape)
    .Doc(R"doc(
MKL version of FusedBatchNormEx operator that does not depend on layout propagation.
