...
GTEST_API_ int main(int argc, char** argv) {
  ...
  // XXX: Must be called only when we're not running benchmarks because
  ...
  // defined by the benchmark library via its own command-line flag facility,
  // which is not known to absl flags.
