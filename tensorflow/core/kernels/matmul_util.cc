...
StatusOr<const PlanAndAlgorithms*> GetPlanAndAlgorithms(
  ...
  if (inserted) {
    ...
    TF_ASSIGN_OR_RETURN(auto xlatype, se::gpu::AsXlaPrimitiveType(params.dtype));
    ...
    constexpr auto kRowMajor =
        se::gpu::MatrixLayout::Order::kRowMajor;
    ...
    se::gpu::GemmConfig cfg = {
      .lhs_layout = se::gpu::MatrixLayout{xlatype, rows_a, cols_a, 
          kRowMajor, batch_sz, std::nullopt, batch_stride_a, params.trans_a
      },
      .rhs_layout = se::gpu::MatrixLayout{xlatype, rows_b, cols_b, 
          kRowMajor, batch_sz, std::nullopt, batch_stride_b, params.trans_b
      },
      .c_layout = se::gpu::MatrixLayout{xlatype, rows_c, cols_c, 
          kRowMajor, batch_sz
      },
      .output_layout = se::gpu::MatrixLayout{xlatype, rows_c, cols_c, 
          kRowMajor, batch_sz
      },
    ...
    TF_ASSIGN_OR_RETURN(auto plan, 
        se::gpu::BlasLt::GetMatmulPlan(stream, cfg, params.epilogue));
