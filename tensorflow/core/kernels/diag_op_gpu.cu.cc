...
template struct DiagFunctor<GPUDevice, int32_t>;
template struct DiagFunctor<GPUDevice, int64_t>;
...
template struct DiagPartFunctor<GPUDevice, int32_t>;
template struct DiagPartFunctor<GPUDevice, int64_t>;
