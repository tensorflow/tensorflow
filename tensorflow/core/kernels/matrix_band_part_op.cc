...
TF_INCLUDE_IF_WITH_EXTRA_TYPES(false,TF_CALL_bool(REGISTER_MATRIX_BAND_PART_GPU));
TF_CALL_complex64(REGISTER_MATRIX_BAND_PART_GPU);
TF_CALL_complex128(REGISTER_MATRIX_BAND_PART_GPU);
TF_INCLUDE_IF_WITH_EXTRA_TYPES(true,TF_CALL_INTEGRAL_TYPES(REGISTER_MATRIX_BAND_PART_GPU));
