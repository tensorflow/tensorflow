...
class MatrixSolveOpGpu : public AsyncOpKernel {
 public:
  ...
  void ComputeAsync(OpKernelContext* context, DoneCallback done) final {
    ...
    // because cuBLAS/rocSolver assumes column-major storage while TensorFlow TF uses
    // row-major.
...
#else //TENSORFLOW_USE_ROCM
    auto op_t = adjoint_ ? rocblas_operation_conjugate_transpose : rocblas_operation_transpose;
#endif
