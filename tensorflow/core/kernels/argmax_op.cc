...
TF_INCLUDE_IF_WITH_EXTRA_TYPES( TF_CALL_INTEGRAL_TYPES(DECLARE_GPU_SPECS));
TF_INCLUDE_IF_WITH_EXTRA_TYPES( TF_CALL_INTEGRAL_TYPES(DECLARE_GPU_CLASS));
...
TF_INCLUDE_IF_WITH_EXTRA_TYPES(TF_CALL_INTEGRAL_TYPES(REGISTER_ARGMAX_GPU));
