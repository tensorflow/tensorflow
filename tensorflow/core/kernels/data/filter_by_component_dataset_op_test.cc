...
#include "tensorflow/core/kernels/data/filter_by_component_dataset_op.h"
 ...
 protected:
  ...
  Status CreateFilterByLastComponentDatasetKernel(
    ...
    NodeDef node_def = test::function::NDef(
        kNodeName,
        name_utils::OpName(FilterByLastComponentDatasetOp::kDatasetType),
        {FilterByLastComponentDatasetOp::kInputDataset},
        {{FilterByLastComponentDatasetOp::kOutputTypes, output_types},
         {FilterByLastComponentDatasetOp::kOutputShapes, output_shapes}});
...
TEST_F(FilterByLastComponentDatasetOpTest, DatasetTypeString) {
  ...
  EXPECT_EQ(filter_by_last_component_dataset->type_string(),
            name_utils::OpName(FilterByLastComponentDatasetOp::kDatasetType));
}
...
TEST_F(FilterByLastComponentDatasetOpTest, IteratorOutputPrefix) {
  ...
  EXPECT_EQ(iterator->prefix(),
            name_utils::IteratorPrefix(
                FilterByLastComponentDatasetOp::kDatasetType, "Iterator"));
}
