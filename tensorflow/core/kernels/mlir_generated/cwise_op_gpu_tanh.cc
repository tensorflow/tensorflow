...
REGISTER_AND_GENERATE_UNARY_KERNEL(Tanh, F16, Eigen::half)
REGISTER_AND_GENERATE_UNARY_KERNEL(Tanh, F32, float)
REGISTER_AND_GENERATE_UNARY_KERNEL(Tanh, F64, double)
}  // namespace tensorflow
