...
REGISTER_AND_GENERATE_UNARY_KERNEL(Abs, F16, Eigen::half);
REGISTER_AND_GENERATE_UNARY_KERNEL(Abs, F32, float);
REGISTER_AND_GENERATE_UNARY_KERNEL(Abs, F64, double);
REGISTER_AND_GENERATE_UNARY_KERNEL(Abs, I32, int32);
REGISTER_AND_GENERATE_UNARY_KERNEL(Abs, I64, int64);
}  // namespace tensorflow
