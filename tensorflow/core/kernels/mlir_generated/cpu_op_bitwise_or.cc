...
// GENERATE_AND_REGISTER_BINARY_CPU_KERNEL(BitwiseOr, DT_UINT8);
// GENERATE_AND_REGISTER_BINARY_CPU_KERNEL(BitwiseOr, DT_UINT16);
// GENERATE_AND_REGISTER_BINARY_CPU_KERNEL(BitwiseOr, DT_UINT32);
// GENERATE_AND_REGISTER_BINARY_CPU_KERNEL(BitwiseOr, DT_UINT64);
