...
#define CURRY_FLOATING_TYPES(FN, arg0) \
  FN(arg0, DT_BOOL);                   \
  FN(arg0, DT_HALF);                   \
  FN(arg0, DT_FLOAT);                  \
  FN(arg0, DT_DOUBLE);                 \
...
CURRY_FLOATING_TYPES(GENERATE_AND_REGISTER_CAST_GPU, DT_HALF)
CURRY_FLOATING_TYPES(GENERATE_AND_REGISTER_CAST_GPU, DT_FLOAT)
CURRY_FLOATING_TYPES(GENERATE_AND_REGISTER_CAST_GPU, DT_DOUBLE)
