...
GENERATE_AND_REGISTER_BINARY_GPU_KERNEL2(Less, DT_UINT8, DT_BOOL);
GENERATE_AND_REGISTER_BINARY_GPU_KERNEL2(Less, DT_UINT16, DT_BOOL);
GENERATE_AND_REGISTER_BINARY_GPU_KERNEL2(Less, DT_UINT32, DT_BOOL);
GENERATE_AND_REGISTER_BINARY_GPU_KERNEL2(Less, DT_UINT64, DT_BOOL);
