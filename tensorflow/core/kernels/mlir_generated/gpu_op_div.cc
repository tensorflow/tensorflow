...
REGISTER_ALIASED_GPU_KERNEL(TruncateDiv DT_HALF);
REGISTER_ALIASED_GPU_KERNEL(TruncateDiv, DT_FLOAT);
REGISTER_ALIASED_GPU_KERNEL(TruncateDiv, DT_DOUBLE);
REGISTER_ALIASED_GPU_KERNEL(TruncateDiv, DT_INT16);
REGISTER_ALIASED_GPU_KERNEL(TruncateDiv, DT_INT64);
REGISTER_ALIASED_GPU_KERNEL(TruncateDiv, DT_UINT8);
REGISTER_ALIASED_GPU_KERNEL(TruncateDiv, DT_UINT16);
REGISTER_ALIASED_GPU_KERNEL(TruncateDiv, DT_COMPLEX64);
REGISTER_ALIASED_GPU_KERNEL(TruncateDiv, DT_COMPLEX128);
