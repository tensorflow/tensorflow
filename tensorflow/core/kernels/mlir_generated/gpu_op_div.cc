...
REGISTER_ALIASED_GPU_KERNEL(TruncateDiv, Div, DT_INT8, DT_INT8);
REGISTER_ALIASED_GPU_KERNEL(TruncateDiv, Div, DT_INT64, DT_INT64);
REGISTER_ALIASED_GPU_KERNEL(TruncateDiv, Div, DT_FLOAT32, DT_FLOAT32);
REGISTER_ALIASED_GPU_KERNEL(TruncateDiv, Div, DT_FLOAT64, DT_FLOAT64);
REGISTER_ALIASED_GPU_KERNEL(TruncateDiv, Div, DT_DOUBLE, DT_DOUBLE);
REGISTER_ALIASED_GPU_KERNEL(TruncateDiv, Div, DT_COMPLEX64, DT_COMPLEX64);        
REGISTER_ALIASED_GPU_KERNEL(TruncateDiv, Div, DT_COMPLEX64, DT_COMPLEX128);        
