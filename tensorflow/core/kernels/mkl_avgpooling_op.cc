...
class MklAvgPoolingOp : public MklPoolingForwardOpBase<T, version> {
 public:
  explicit MklAvgPoolingOp(OpKernelConstruction* context)
      : MklPoolingForwardOpBase<T, version>(context) {
...
template <class Device, MklQuantization version, class T>
class MklAvgPoolingGradOp : public MklPoolingBackwardOpBase<T, version> {
 public:
  explicit MklAvgPoolingGradOp(OpKernelConstruction* context)
      : MklPoolingBackwardOpBase<T, version>(context) {}
...
REGISTER_KERNEL_BUILDER(
    ...
    MklAvgPoolingOp<CPUDevice, MklQuantization::FP32, float>);
...
REGISTER_KERNEL_BUILDER(
    Name("_MklAvgPool3DGrad")
        ...
        .TypeConstraint<float>("T")
        .Label(mkl_op_registry::kMklOpLabel),
    MklAvgPoolingGradOp<CPUDevice, MklQuantization::FP32, float>);
...
REGISTER_KERNEL_BUILDER(
    ...
    MklAvgPoolingOp<CPUDevice, MklQuantization::INT8, quint8>);
...
REGISTER_KERNEL_BUILDER(
    Name("_MklQuantizedAvgPool")
        ...
        .Label(mkl_op_registry::kMklQuantizedOpLabel),
    MklAvgPoolingOp<CPUDevice, MklQuantization::INT8, qint8>);
