...
REGISTER6(BinaryOp, CPU, "TruncateDiv", functor::div, float, Eigen::half, double,
          bfloat16, complex64, complex128);
REGISTER8(BinaryOp, CPU, "TruncateDiv", functor::safe_div, uint8, uint16, uint32,
          uint64, int8, int16, int32, int64_t);          
...
REGISTER4(BinaryOp, GPU, "TruncateDiv", functor::div, float, Eigen::half, double, uint8,
          uint16, int16, int64, complex64, complex128);
