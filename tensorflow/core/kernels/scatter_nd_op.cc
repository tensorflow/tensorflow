...
/*#define REGISTER_SCATTER_ND_TENSOR_MIN_MAX_CPU(type) \
  REGISTER_SCATTER_ND_TENSOR_MIN_CPU(type);          \
  REGISTER_SCATTER_ND_TENSOR_MAX_CPU(type);
*/
// Register TensorScatterUpdate/Add/Sub for all number types.
TF_CALL_NUMBER_TYPES(REGISTER_SCATTER_ND_TENSOR_CPU);
// Register TensorScatterMin/Max for real numbre types
//TF_CALL_REAL_NUMBER_TYPES(REGISTER_SCATTER_ND_TENSOR_MINMAX_CPU);
...
//#undef REGISTER_SCATTER_ND_TENSOR_MIN_MAX_CPU
