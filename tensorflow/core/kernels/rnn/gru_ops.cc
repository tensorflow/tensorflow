  ...
  void Compute(OpKernelContext* ctx) override {
    ...
    OP_REQUIRES(ctx, TensorShapeUtils::IsMatrix(x_tensor->shape()),
                absl::InvalidArgumentError(absl::StrCat(
                    "Rank of x must be 2, got ", x_tensor->dims())));
    ...
    OP_REQUIRES(ctx, TensorShapeUtils::IsMatrix(h_prev_tensor->shape()),
                absl::InvalidArgumentError(absl::StrCat(
                    "Rank of h_prev must be 2, got ", h_prev_tensor->dims())));
    ...
    OP_REQUIRES(ctx, TensorShapeUtils::IsMatrix(w_ru_tensor->shape()),
                absl::InvalidArgumentError(absl::StrCat(
                    "Rank of w_ru_ must be 2, got ", w_ru_tensor->dims())));
    OP_REQUIRES(
        ctx, w_ru_tensor->dim_size(0) == input_size + cell_size,
        absl::InvalidArgumentError(absl::StrCat(
    ...
    OP_REQUIRES(ctx, TensorShapeUtils::IsMatrix(w_c_tensor->shape()),
                absl::InvalidArgumentError(absl::StrCat(
                    "Rank of w_c must be 2, got ", w_c_tensor->dims())));
    ...
    OP_REQUIRES(ctx, TensorShapeUtils::IsVector(b_ru_tensor->shape()),
                absl::InvalidArgumentError(absl::StrCat(
                    "Rank of b_ru must be 1, got ", b_ru_tensor->dims())));
    ...
    OP_REQUIRES(ctx, TensorShapeUtils::IsVector(b_c_tensor->shape()),
                absl::InvalidArgumentError(absl::StrCat(
                    "Rank of b_c must be 1, got ", b_c_tensor->dims())));
...
class GRUBlockCellGradOp : public OpKernel {
 public:
  ...
  void Compute(OpKernelContext* ctx) override {
    ...
    OP_REQUIRES(ctx, TensorShapeUtils::IsMatrix(r_tensor->shape()),
                absl::InvalidArgumentError(absl::StrCat(
                    "Rank of r must be 2, got ", r_tensor->dims())));
    ...
    OP_REQUIRES(ctx, TensorShapeUtils::IsMatrix(u_tensor->shape()),
                absl::InvalidArgumentError(absl::StrCat(
                    "Rank of u must be 2, got ", u_tensor->dims())));
    ...
    OP_REQUIRES(ctx, TensorShapeUtils::IsMatrix(c_tensor->shape()),
                absl::InvalidArgumentError(absl::StrCat(
                    "Rank of w_c must be 2, got ", c_tensor->dims())));
    ...
    OP_REQUIRES(ctx, TensorShapeUtils::IsMatrix(d_h_tensor->shape()),
                absl::InvalidArgumentError(absl::StrCat(
                    "Rank of d_h must be 2, got ", d_h_tensor->dims())));
