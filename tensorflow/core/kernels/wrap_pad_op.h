...
// Functor definition for WrapPadOp, must be compilable by nvcc.
...
// Functor used by WrapPadOp to do the computations.
...
struct WrapPad<Device, T, Tpadding, 0> {
...
#endif  // TENSORFLOW_CORE_KERNELS_WRAP_PAD_OP_H_
