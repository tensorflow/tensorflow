...
Status FixedUnigramSampler::SetDistributionSampler(Env* env, const string& vocab_file){
...
Status FixedUnigramSampler::SetDistributionSampler(const std::vector<float>& unigrams){
