...
TF_IF_WITH_EXTRA_TYPES(TF_CALL_GPU_NUMBER_TYPES(REGISTER_ADDN_GPU), TF_CALL_int32(REGISTER_ADDN_GPU));
TF_IF_WITH_EXTRA_TYPES(TF_CALL_int64(REGISTER_ADDN_GPU), TF_CALL_int16(REGISTER_ADDN_GPU));
...
TF_INCLUDE_IF_WITH_EXTRA_TYPES(
    false, REGISTER_KERNEL_BUILDER(Name("AddN")
                                       .Device(DEVICE_GPU)
