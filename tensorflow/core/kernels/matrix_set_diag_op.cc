...
TF_INCLUDE_IF_WITH_EXTRA_TYPES(true,TF_CALL_INTEGRAL_TYPES(REGISTER_MATRIX_SET_DIAG_GPU));
...
TF_INCLUDE_IF_WITH_EXTRA_TYPES(true,TF_CALL_INTEGRAL_TYPES(REGISTER_BATCH_MATRIX_SET_DIAG_GPU));
