...
TF_CALL_uint16(DEFINE_REVERSE_ALL_DIMS);
TF_CALL_int16(DEFINE_REVERSE_ALL_DIMS);
TF_CALL_uint32(DEFINE_REVERSE_ALL_DIMS);
TF_CALL_int32(DEFINE_REVERSE_ALL_DIMS);
TF_CALL_uint64(DEFINE_REVERSE_ALL_DIMS);
TF_CALL_int64(DEFINE_REVERSE_ALL_DIMS);
