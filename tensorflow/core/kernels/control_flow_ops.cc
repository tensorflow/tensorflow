...
TF_INCLUDE_IF_WITH_EXTRA_TYPES(true,TF_CALL_int32(REGISTER_GPU_SWITCH));
TF_INCLUDE_IF_WITH_EXTRA_TYPES(true,TF_CALL_bool(REGISTER_GPU_SWITCH));
TF_INCLUDE_IF_WITH_EXTRA_TYPES(true,TF_CALL_string(REGISTER_GPU_SWITCH));
TF_INCLUDE_IF_WITH_EXTRA_TYPES(true,TF_CALL_resource(REGISTER_GPU_SWITCH));
TF_CALL_QUANTIZED_TYPES(REGISTER_GPU_SWITCH);
TF_CALL_NUMBER_TYPES_NO_INT32(REGISTER_GPU_REF_SWITCH);
TF_INCLUDE_IF_WITH_EXTRA_TYPES(true,TF_CALL_int32(REGISTER_GPU_REF_SWITCH));
TF_INCLUDE_IF_WITH_EXTRA_TYPES(true,TF_CALL_bool(REGISTER_GPU_REF_SWITCH));
TF_INCLUDE_IF_WITH_EXTRA_TYPES(true,TF_CALL_string(REGISTER_GPU_REF_SWITCH));
...
TF_INCLUDE_IF_WITH_EXTRA_TYPES(false,REGISTER_GPU_HOST_REF_KERNEL(int32));
TF_INCLUDE_IF_WITH_EXTRA_TYPES(false,REGISTER_GPU_HOST_KERNEL(bool));
TF_INCLUDE_IF_WITH_EXTRA_TYPES(false,REGISTER_GPU_HOST_REF_KERNEL(bool));
TF_INCLUDE_IF_WITH_EXTRA_TYPES(false,REGISTER_GPU_HOST_KERNEL(string));
TF_INCLUDE_IF_WITH_EXTRA_TYPES(false,REGISTER_GPU_HOST_REF_KERNEL(string));
...
TF_INCLUDE_IF_WITH_EXTRA_TYPES(true,TF_CALL_int32(REGISTER_GPU_REF_KERNEL));
TF_INCLUDE_IF_WITH_EXTRA_TYPES(true,TF_CALL_string(REGISTER_GPU_KERNEL));
TF_INCLUDE_IF_WITH_EXTRA_TYPES(true,TF_CALL_string(REGISTER_GPU_REF_KERNEL));
TF_INCLUDE_IF_WITH_EXTRA_TYPES(true,TF_CALL_resource(REGISTER_GPU_KERNEL));
TF_INCLUDE_IF_WITH_EXTRA_TYPES(true,TF_CALL_resource(REGISTER_GPU_REF_KERNEL));
