...
template <typename Device, typename T, typename Tpadding, bool biasEnabled,
          bool padEnabled>
class MklConvOp : public OpKernel {
 public:
  ~MklConvOp() {}
...
#define REGISTER_MKL_CPU(T)                                              \
  REGISTER_KERNEL_BUILDER(Name("_MklConv2D")                             \
                              ...
                              .TypeConstraint<T>("T")                    \
                              .Label(mkl_op_registry::kMklOpLabel),      \
                          MklConvOp<CPUDevice, T, int32, false, false>); \
  REGISTER_KERNEL_BUILDER(Name("_MklConv2DWithBias")                     \
                              .Device(DEVICE_CPU)                        \
                              .TypeConstraint<T>("T")                    \
                              .Label(mkl_op_registry::kMklOpLabel),      \
                          MklConvOp<CPUDevice, T, int32, true, false>);  \
  REGISTER_KERNEL_BUILDER(Name("__MklDummyConv2DWithBias")               \
                              .Device(DEVICE_CPU)                        \
                              .TypeConstraint<T>("T")                    \
                              .Label(mkl_op_registry::kMklOpLabel),      \
  ...
  REGISTER_KERNEL_BUILDER(Name("_MklPadWithConv2D")                      \
                              ...
                              .Label(mkl_op_registry::kMklOpLabel),      \
                          MklConvOp<CPUDevice, T, int32, false, true>);  \
  REGISTER_KERNEL_BUILDER(Name("_MklPadWithConv2D")                      \
                              .Device(DEVICE_CPU)                        \
                              .TypeConstraint<T>("T")                    \
                              .TypeConstraint<int64>("Tpaddings")        \
                              .Label(mkl_op_registry::kMklOpLabel),      \
                          MklConvOp<CPUDevice, T, int64, false, true>);  \
