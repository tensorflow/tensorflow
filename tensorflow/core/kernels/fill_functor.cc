...
DEFINE_SETZERO_CPU(uint32_t);
DEFINE_SETZERO_CPU(uint64_t);
DEFINE_SETZERO_CPU(uint8_t);
DEFINE_SETZERO_CPU(int8_t);
DEFINE_SETZERO_CPU(uint16_t);
DEFINE_SETZERO_CPU(int16_t);
DEFINE_SETZERO_CPU(int32_t);
...
DEFINE_SETZERO_CPU(float8_e8m0fnu);
...
DEFINE_SETONE_CPU(uint32_t);
DEFINE_SETONE_CPU(uint64_t);
DEFINE_SETONE_CPU(uint8_t);
DEFINE_SETONE_CPU(int8_t);
DEFINE_SETONE_CPU(uint16_t);
DEFINE_SETONE_CPU(int16_t);
DEFINE_SETONE_CPU(int32_t);
...
DEFINE_SETONE_CPU(float8_e8m0fnu);
...
DEFINE_FILL_CPU(float8_e8m0fnu);
