...
class MklMaxPoolingOp : public MklPoolingForwardOpBase<T, version> {
 public:
...
class MklMaxPoolingGradOp : public MklPoolingBackwardOpBase<T, version> {
 public:
  explicit MklMaxPoolingGradOp(OpKernelConstruction* context)
...
REGISTER_KERNEL_BUILDER(
    ...
    MklMaxPoolingOp<CPUDevice, MklQuantization::FP32, float>);
...
REGISTER_KERNEL_BUILDER(
    Name("_MklMaxPool3DGrad")
        ...
        .TypeConstraint<float>("T")
        .Label(mkl_op_registry::kMklOpLabel),
    MklMaxPoolingGradOp<CPUDevice, MklQuantization::FP32, float>);
...
REGISTER_KERNEL_BUILDER(
    Name("_MklQuantizedMaxPool")
        .Device(DEVICE_CPU)
        .TypeConstraint<quint8>("T")
        .Label(mkl_op_registry::kMklQuantizedOpLabel),
    MklMaxPoolingOp<CPUDevice, MklQuantization::INT8, quint8>);
...
REGISTER_KERNEL_BUILDER(
    Name("_MklQuantizedMaxPool")
        ...
        .Label(mkl_op_registry::kMklQuantizedOpLabel),
    MklMaxPoolingOp<CPUDevice, MklQuantization::INT8, qint8>);
