...
TF_INCLUDE_IF_WITH_EXTRA_TYPES(
    false, REGISTER_KERNEL_BUILDER(Name("_ParallelConcatUpdate")
                                       .Device(DEVICE_GPU)
                                       .HostMemory("value")
                                       .HostMemory("update")
                                       .HostMemory("output")
...
TF_INCLUDE_IF_WITH_EXTRA_TYPES(
    false, REGISTER_KERNEL_BUILDER(Name("InplaceUpdate")
                                       .Device(DEVICE_GPU)
                                       .HostMemory("x")
                                       .HostMemory("i")
                                       .HostMemory("v")
                                   ...
                                   InplaceOp<CPUDevice, functor::I_UPDATE>));
TF_INCLUDE_IF_WITH_EXTRA_TYPES(
    false, REGISTER_KERNEL_BUILDER(Name("InplaceAdd")
                                       .Device(DEVICE_GPU)
                                       .HostMemory("x")
                                       .HostMemory("i")
                                       .HostMemory("v")
                                   ...
                                   InplaceOp<CPUDevice, functor::I_ADD>));
TF_INCLUDE_IF_WITH_EXTRA_TYPES(
    false, REGISTER_KERNEL_BUILDER(Name("InplaceSub")
                                       .Device(DEVICE_GPU)
                                       .HostMemory("x")
                                       .HostMemory("i")
                                       .HostMemory("v")
...
TF_INCLUDE_IF_WITH_EXTRA_TYPES(
    false, REGISTER_KERNEL_BUILDER(Name("DeepCopy")
                                       .Device(DEVICE_GPU)
                                       .HostMemory("x")
                                       .HostMemory("y")
                                       .TypeConstraint<int32>("T"),
