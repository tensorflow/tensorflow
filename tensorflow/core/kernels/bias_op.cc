...
TF_INCLUDE_IF_WITH_EXTRA_TYPES(TF_CALL_uint32(REGISTER_GPU_KERNEL));
TF_INCLUDE_IF_WITH_EXTRA_TYPES(TF_CALL_uint64(REGISTER_GPU_KERNEL));
TF_INCLUDE_IF_WITH_EXTRA_TYPES(TF_CALL_int32(REGISTER_GPU_KERNEL));
