...
TEST_ALL_CASTS_FROM(uint8_t)
TEST_ALL_CASTS_FROM(uint16_t)
TEST_ALL_CASTS_FROM(uint32_t)
TEST_ALL_CASTS_FROM(uint64_t)
TEST_ALL_CASTS_FROM(int16_t)
TEST_ALL_CASTS_FROM(int32_t)
