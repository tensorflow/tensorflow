...
TF_CALL_bfloat16(DECLARE_FOR_ALL_REDUCERS);
...
TF_CALL_half(DECLARE_FOR_LOGSUMEXP_REDUCER);
TF_CALL_float(DECLARE_FOR_LOGSUMEXP_REDUCER);
TF_CALL_double(DECLARE_FOR_LOGSUMEXP_REDUCER);
