 ...
 public:
  ...
  void Compute(OpKernelContext* context) override {
    ...
    OP_REQUIRES(context, input_min_tensor.NumElements() == 1,
                absl::InvalidArgumentError("input_min must have 1 element"));
    ...
    OP_REQUIRES(context, input_max_tensor.NumElements() == 1,
                absl::InvalidArgumentError("input_max must have 1 element"));
    ...
    OP_REQUIRES(context, mean_min_tensor.NumElements() == 1,
                absl::InvalidArgumentError("mean_min must have 1 element"));
    ...
    OP_REQUIRES(context, mean_max_tensor.NumElements() == 1,
                absl::InvalidArgumentError("mean_max must have 1 element"));
    ...
    OP_REQUIRES(context, var_min_tensor.NumElements() == 1,
                absl::InvalidArgumentError("var_min must have 1 element"));
    ...
    OP_REQUIRES(context, var_max_tensor.NumElements() == 1,
                absl::InvalidArgumentError("var_max must have 1 element"));
    ...
    OP_REQUIRES(context, beta_min_tensor.NumElements() == 1,
                absl::InvalidArgumentError("beta_min must have 1 element"));
    ...
    OP_REQUIRES(context, beta_max_tensor.NumElements() == 1,
                absl::InvalidArgumentError("beta_max must have 1 element"));
    ...
    OP_REQUIRES(context, gamma_min_tensor.NumElements() == 1,
                absl::InvalidArgumentError("gamma_min must have 1 element"));
    ...
    OP_REQUIRES(context, gamma_max_tensor.NumElements() == 1,
                absl::InvalidArgumentError("gamma_max must have 1 element"));
    ...
    OP_REQUIRES(
        context, mean.NumElements() > 1,
        absl::InvalidArgumentError(absl::StrCat(
            "Must have at least a mean value", gamma.shape().DebugString())));
    OP_REQUIRES(context, mean.NumElements() > 1,
                absl::InvalidArgumentError("Must have at least a mean value"));
    const auto last_dim = input.shape().dims() - 1;
    OP_REQUIRES(
        context, mean.shape().dim_size(0) == input.shape().dim_size(last_dim),
        absl::InvalidArgumentError(absl::StrCat(
            "Must provide as many means as the "
            "last dimension of the input tensor: ",
            mean.shape().DebugString(), " vs. ", input.shape().DebugString())));
    OP_REQUIRES(
