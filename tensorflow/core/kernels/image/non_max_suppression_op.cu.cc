...
StatusOr<int> CountIf(OpKernelContext* context, const float* dev_array,
  ...
  TF_RETURN_IF_CUDA_ERROR(gpuprim::DeviceSelect::If(nullptr, workspace_size,
...
Status NmsGpu(const float* d_sorted_boxes_float_ptr, const int num_boxes,
  ...
  TF_RETURN_IF_CUDA_ERROR(gpuprim::DeviceSelect::Flagged(static_cast<void*>(nullptr),  // temp_storage
                                                flagged_buffer_size,
