...
TF_INCLUDE_IF_WITH_EXTRA_TYPES(true,TF_CALL_int32(REGISTER_GPU_LEN));
...
TF_INCLUDE_IF_WITH_EXTRA_TYPES(false,REGISTER_GPU_int32(int32));
TF_INCLUDE_IF_WITH_EXTRA_TYPES(false,REGISTER_GPU_int32(int64));
