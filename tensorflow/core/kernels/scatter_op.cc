...
TF_INCLUDE_IF_WITH_EXTRA_TYPES(true,TF_CALL_half(REGISTER_SCATTER_ARITHMETIC_GPU));
TF_INCLUDE_IF_WITH_EXTRA_TYPES(true,TF_CALL_int32(REGISTER_SCATTER_ARITHMETIC_GPU));
TF_INCLUDE_IF_WITH_EXTRA_TYPES(true,TF_CALL_half(REGISTER_SCATTER_UPDATE_GPU));
TF_INCLUDE_IF_WITH_EXTRA_TYPES(true,TF_CALL_int32(REGISTER_SCATTER_UPDATE_GPU));
TF_INCLUDE_IF_WITH_EXTRA_TYPES(true,TF_CALL_int32(REGISTER_SCATTER_MINMAX_GPU));
