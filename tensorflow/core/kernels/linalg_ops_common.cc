...
template <class InputScalar, class OutputScalar>
void LinearAlgebraOp<InputScalar,OutputScalar>::Compute(OpKernelContext* context) {
  TensorInputs inputs;
...
template <class InputScalar, class OutputScalar>
void LinearAlgebraOp<InputScalar,OutputScalar>::AnalyzeInputs(OpKernelContext* context,
                                            TensorInputs* inputs,
                                            TensorShapes* input_matrix_shapes,
                                            TensorShape* batch_shape) {
  int input_rank = -1;
