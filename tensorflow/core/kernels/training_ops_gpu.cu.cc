...
template struct functor::SparseApplyProximalAdagrad<GPUDevice, Eigen::half,
                                                    int64_t>;
template struct functor::SparseApplyProximalAdagrad<GPUDevice, float, int32_t>;
template struct functor::SparseApplyProximalAdagrad<GPUDevice, float, int64_t>;
template struct functor::SparseApplyProximalAdagrad<GPUDevice, double, int32_t>;
template struct functor::SparseApplyProximalAdagrad<GPUDevice, double, int64_t>;
...
template struct functor::SparseApplyKerasMomentum<GPUDevice, Eigen::half,
                                                  int64_t>;
template struct functor::SparseApplyKerasMomentum<GPUDevice, float, int32_t>;
template struct functor::SparseApplyKerasMomentum<GPUDevice, float, int64_t>;
template struct functor::SparseApplyKerasMomentum<GPUDevice, double, int32_t>;
template struct functor::SparseApplyKerasMomentum<GPUDevice, double, int64_t>;
template struct functor::SparseApplyKerasMomentum<GPUDevice, complex64,
                                                  int32_t>;
template struct functor::SparseApplyKerasMomentum<GPUDevice, complex64,
                                                  int64_t>;
template struct functor::SparseApplyKerasMomentum<GPUDevice, complex128,
                                                  int32_t>;
template struct functor::SparseApplyKerasMomentum<GPUDevice, complex128,
                                                  int64_t>;

template struct functor::SparseApplyAdadelta<GPUDevice, Eigen::half, int32_t>;
template struct functor::SparseApplyAdadelta<GPUDevice, Eigen::half, int64_t>;
template struct functor::SparseApplyAdadelta<GPUDevice, float, int32_t>;
template struct functor::SparseApplyAdadelta<GPUDevice, float, int64_t>;
template struct functor::SparseApplyAdadelta<GPUDevice, double, int32_t>;
template struct functor::SparseApplyAdadelta<GPUDevice, double, int64_t>;
template struct functor::SparseApplyAdadelta<GPUDevice, complex64, int32_t>;
template struct functor::SparseApplyAdadelta<GPUDevice, complex64, int64_t>;
template struct functor::SparseApplyAdadelta<GPUDevice, complex128, int32_t>;
template struct functor::SparseApplyAdadelta<GPUDevice, complex128, int64_t>;
