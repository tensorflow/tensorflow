...
template struct functor::DepthToSpaceOpFunctor<GPUDevice, Eigen::half, FORMAT_NCHW>;
template struct functor::DepthToSpaceOpFunctor<GPUDevice, Eigen::half, FORMAT_NHWC>;
