...
#ifndef TENSORFLOW_CORE_KERNELS_TEXT_UTF8_BINARIZE_KERNEL_TEMPLATE_H_
#define TENSORFLOW_CORE_KERNELS_TEXT_UTF8_BINARIZE_KERNEL_TEMPLATE_H_
...
absl::Status Utf8BinarizeOp<Rt>::ShapeInference(ShapeInferenceContext* c) {
  ...
  int64_t word_length;
  SH_RETURN_IF_ERROR(c->GetAttr(std::string(kMaxCharsAttr), &word_length));
...
#endif  // TENSORFLOW_CORE_KERNELS_TEXT_UTF8_BINARIZE_KERNEL_TEMPLATE_H_
