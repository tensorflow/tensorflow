...
#ifndef TENSORFLOW_CORE_KERNELS_TEXT_TEXT_KERNELS_TEST_UTIL_H_
#define TENSORFLOW_CORE_KERNELS_TEXT_TEXT_KERNELS_TEST_UTIL_H_
...
#endif  // TENSORFLOW_CORE_KERNELS_TEXT_TEXT_KERNELS_TEST_UTIL_H_
