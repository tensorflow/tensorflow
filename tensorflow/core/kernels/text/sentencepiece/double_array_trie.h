...
#ifndef TENSORFLOW_CORE_KERNELS_TEXT_SENTENCEPIECE_DOUBLE_ARRAY_TRIE_H_
#define TENSORFLOW_CORE_KERNELS_TEXT_SENTENCEPIECE_DOUBLE_ARRAY_TRIE_H_
...
#endif  // TENSORFLOW_CORE_KERNELS_TEXT_SENTENCEPIECE_DOUBLE_ARRAY_TRIE_H_
