...
#ifndef TENSORFLOW_CORE_KERNELS_TEXT_SENTENCEPIECE_MODEL_CONVERTER_H_
#define TENSORFLOW_CORE_KERNELS_TEXT_SENTENCEPIECE_MODEL_CONVERTER_H_
#include <string>
...
#endif  // TENSORFLOW_CORE_KERNELS_TEXT_SENTENCEPIECE_MODEL_CONVERTER_H_
