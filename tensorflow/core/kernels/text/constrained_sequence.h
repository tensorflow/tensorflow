...
#ifndef TENSORFLOW_CORE_KERNELS_TEXT_CONSTRAINED_SEQUENCE_H_
#define TENSORFLOW_CORE_KERNELS_TEXT_CONSTRAINED_SEQUENCE_H_
...
#endif  // TENSORFLOW_CORE_KERNELS_TEXT_CONSTRAINED_SEQUENCE_H_
