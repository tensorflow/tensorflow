...
#ifndef TENSORFLOW_CORE_KERNELS_TEXT_WHITESPACE_TOKENIZER_CONFIG_BUILDER_H_
#define TENSORFLOW_CORE_KERNELS_TEXT_WHITESPACE_TOKENIZER_CONFIG_BUILDER_H_
...
#endif  // TENSORFLOW_CORE_KERNELS_TEXT_WHITESPACE_TOKENIZER_CONFIG_BUILDER_H_
