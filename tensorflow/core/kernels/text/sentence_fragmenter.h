...
#ifndef TENSORFLOW_CORE_KERNELS_TEXT_SENTENCE_FRAGMENTER_H_
#define TENSORFLOW_CORE_KERNELS_TEXT_SENTENCE_FRAGMENTER_H_
...
class SentenceFragmenter {
 ...
 private:
  ...
  // TODO(hterry): DISALLOW_COPY_AND_ASSIGN(SentenceFragmenter);
};

}  // namespace text
}  // namespace tensorflow

#endif  // TENSORFLOW_CORE_KERNELS_TEXT_SENTENCE_FRAGMENTER_H_
