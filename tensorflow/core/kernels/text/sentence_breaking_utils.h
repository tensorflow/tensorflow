...
#ifndef TENSORFLOW_CORE_KERNELS_TEXT_SENTENCE_BREAKING_UTILS_H_
#define TENSORFLOW_CORE_KERNELS_TEXT_SENTENCE_BREAKING_UTILS_H_
...
#endif  // TENSORFLOW_CORE_KERNELS_TEXT_SENTENCE_BREAKING_UTILS_H_
