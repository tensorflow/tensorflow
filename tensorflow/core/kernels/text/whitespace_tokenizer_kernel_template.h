...
#ifndef TENSORFLOW_CORE_KERNELS_TEXT_WHITESPACE_TOKENIZER_KERNEL_TEMPLATE_H_
#define TENSORFLOW_CORE_KERNELS_TEXT_WHITESPACE_TOKENIZER_KERNEL_TEMPLATE_H_
...
absl::Status WhitespaceTokenizeWithOffsetsV2Op<Rt>::Invoke(
  ...
  SH_RETURN_IF_ERROR(
      this->template FillOutputTensor<std::string, tensorflow::tstring>(
...
#endif  // TENSORFLOW_CORE_KERNELS_TEXT_WHITESPACE_TOKENIZER_KERNEL_TEMPLATE_H_
