...
#ifndef TENSORFLOW_CORE_KERNELS_TEXT_BOISE_OFFSET_CONVERTER_H_
#define TENSORFLOW_CORE_KERNELS_TEXT_BOISE_OFFSET_CONVERTER_H_
...
#endif  // TENSORFLOW_CORE_KERNELS_TEXT_BOISE_OFFSET_CONVERTER_H_
