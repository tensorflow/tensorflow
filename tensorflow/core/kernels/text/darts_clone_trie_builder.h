...
#ifndef TENSORFLOW_CORE_KERNELS_TEXT_DARTS_CLONE_TRIE_BUILDER_H_
#define TENSORFLOW_CORE_KERNELS_TEXT_DARTS_CLONE_TRIE_BUILDER_H_
...
#endif  // TENSORFLOW_CORE_KERNELS_TEXT_DARTS_CLONE_TRIE_BUILDER_H_
