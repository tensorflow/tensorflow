...
#ifndef TENSORFLOW_CORE_KERNELS_TEXT_BOISE_OFFSET_CONVERTER_KERNEL_TEMPLATE_H_
#define TENSORFLOW_CORE_KERNELS_TEXT_BOISE_OFFSET_CONVERTER_KERNEL_TEMPLATE_H_
...
absl::Status BoiseTagsToOffsetsOp<Rt>::FillOutputTensor(
  ...
  // TODO(rneale): investigate using memcpy like previous WST
...
#endif  // TENSORFLOW_CORE_KERNELS_TEXT_BOISE_OFFSET_CONVERTER_KERNEL_TEMPLATE_H_
