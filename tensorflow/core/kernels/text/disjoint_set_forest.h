...
#ifndef TENSORFLOW_CORE_KERNELS_TEXT_DISJOINT_SET_FOREST_H_
#define TENSORFLOW_CORE_KERNELS_TEXT_DISJOINT_SET_FOREST_H_
...
#endif  // TENSORFLOW_CORE_KERNELS_TEXT_DISJOINT_SET_FOREST_H_
