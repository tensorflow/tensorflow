...
class RegexSplitOp : public tensorflow::OpKernel {
 public:
  ...
  void Compute(tensorflow::OpKernelContext* ctx) override {
    ...
    OP_REQUIRES(ctx, delim_re->ok(),
                absl::InvalidArgumentError(
                    absl::StrCat("Invalid pattern: ", delim_regex_pattern,
    ...
    OP_REQUIRES(ctx, keep_delim_re->ok(),
                absl::InvalidArgumentError(
                    absl::StrCat("Invalid pattern: ", keep_delim_regex_pattern,
