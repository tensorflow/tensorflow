...
#ifndef TENSORFLOW_CORE_KERNELS_TEXT_DARTS_CLONE_TRIE_WRAPPER_H_
#define TENSORFLOW_CORE_KERNELS_TEXT_DARTS_CLONE_TRIE_WRAPPER_H_
...
#endif  // TENSORFLOW_CORE_KERNELS_TEXT_DARTS_CLONE_TRIE_WRAPPER_H_
