...
limitations under the License.
==============================================================================*/
#ifndef TENSORFLOW_CORE_KERNELS_TEXT_NGRAMS_KERNEL_TEMPLATE_H_
#define TENSORFLOW_CORE_KERNELS_TEXT_NGRAMS_KERNEL_TEMPLATE_H_
...
class NgramsStringJoin
    : public tflite::shim::OpKernelShim<NgramsStringJoin, Rt> {
 protected:
  using Shape = tflite::shim::Shape;

 public:
  using typename tflite::shim::OpKernelShim<NgramsStringJoin, Rt>::InitContext;
  using
      typename tflite::shim::OpKernelShim<NgramsStringJoin, Rt>::InvokeContext;
  ...
  static std::vector<std::string> Attrs() {
    return {"width: int", "axis: int", "string_separator: string",
...
#endif  // TENSORFLOW_CORE_KERNELS_TEXT_NGRAMS_KERNEL_TEMPLATE_H_
