...
#ifndef TENSORFLOW_CORE_KERNELS_TEXT_BYTE_SPLITTER_H_
#define TENSORFLOW_CORE_KERNELS_TEXT_BYTE_SPLITTER_H_
...
class ByteSplitter {
 public:
  ...
  void Split(const absl::string_view input, std::vector<unsigned char>* bytes,
  ...
  absl::StatusOr<std::vector<absl::string_view>> SplitByOffsets(
      absl::string_view input, absl::Span<const int> start_offsets,
...
#endif  // TENSORFLOW_CORE_KERNELS_TEXT_BYTE_SPLITTER_H_
