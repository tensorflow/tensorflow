...
#ifndef TENSORFLOW_CORE_KERNELS_TEXT_SPANNING_TREE_ITERATOR_H_
#define TENSORFLOW_CORE_KERNELS_TEXT_SPANNING_TREE_ITERATOR_H_
...
#endif  // TENSORFLOW_CORE_KERNELS_TEXT_SPANNING_TREE_ITERATOR_H_
