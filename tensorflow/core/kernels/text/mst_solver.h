...
#ifndef TENSORFLOW_CORE_KERNELS_TEXT_MST_SOLVER_H_
#define TENSORFLOW_CORE_KERNELS_TEXT_MST_SOLVER_H_
...
absl::Status MstSolver<Index, Score>::ExpansionPhase(absl::Span<Index> argmax) {
  if (argmax.size() < num_original_nodes_) {
    return absl::InvalidArgumentError(
        absl::StrCat("Argmax array too small: ", num_original_nodes_,
...
#endif  // TENSORFLOW_CORE_KERNELS_TEXT_MST_SOLVER_H_
