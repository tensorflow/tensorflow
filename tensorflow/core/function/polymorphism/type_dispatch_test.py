...
class MockShape(trace.TraceType):
    ...
    def most_specific_common_supertype(self, others):
        ...
        dims = [
            dim if all(dim == other.shape[i] for other in others) else None
    ...
    return function_type.FunctionType(
        [
            function_type.Parameter(
                "x", function_type.Parameter.POSITIONAL_ONLY, False, MockShape(*shape)
            )
        ]
    )
...
class TypeDispatchTableTest(test.TestCase):
    ...
    def testGeneralizedExisting(self):
        ...
        table.add_target(make_shape_function_type(None, 1, 2))
        self.assertEqual(
            table.try_generalizing_function_type(make_shape_function_type(None, 1, 3)),
            make_shape_function_type(None, None, None),
        )
    ...
    def testGeneralizedNovel(self):
        ...
        table.add_target(make_shape_function_type(None, 1, 2))
        self.assertEqual(
            table.try_generalizing_function_type(make_shape_function_type(None, 2, 3)),
            make_shape_function_type(None, None, None),
        )
    ...
    def testGeneralizedUnknown(self):
        ...
        self.assertEqual(
            table.try_generalizing_function_type(make_shape_function_type(None, 4, 3)),
