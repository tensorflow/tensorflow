            ...
            function_type.FunctionType(
                (
                    function_type.Parameter(
                        "x", function_type.Parameter.POSITIONAL_OR_KEYWORD, False, None
                    ),
                    function_type.Parameter(
                        "y", function_type.Parameter.POSITIONAL_OR_KEYWORD, False, None
                    ),
                    function_type.Parameter(
                        "z", function_type.Parameter.POSITIONAL_OR_KEYWORD, False, None
                    ),
                )
            ),
        )
        ...
        self.assertEqual(
            ...
            function_type.FunctionType(
                (
                    ...
                    function_type.Parameter(
                        "y", function_type.Parameter.POSITIONAL_OR_KEYWORD, True, None
                    ),
                    function_type.Parameter(
                        "z", function_type.Parameter.POSITIONAL_OR_KEYWORD, True, None
                    ),
                )
            ),
        )
        self.assertEqual(
            function_type.FunctionType.get_default_values(foo), {"x": 1, "y": 2, "z": 3}
        )
    ...
    def test_pickle(self):
        original = function_type.FunctionType(
            [
                ...
                function_type.Parameter(
                    "z", function_type.Parameter.KEYWORD_ONLY, False, None
                ),
            ]
        )
...
class CanonicalizationTest(test.TestCase, parameterized.TestCase):
    ...
    def test_optional_some(self, args, kwargs):
        ...
        mono_type, _ = function_type.canonicalize_to_monomorphic(
            args, kwargs, default_values, {}, polymorphic_type
        )
    ...
    def test_varkwargs(self):
        ...
        expected_type = function_type.FunctionType(
            [
                function_type.Parameter(
                    "x",
                    function_type.Parameter.KEYWORD_ONLY,
                    False,
                    trace_type.from_value(1, type_context),
                ),
                function_type.Parameter(
...
class TypeHierarchyTest(test.TestCase):
    ...
    def test_partial_raises_error(self):
        ...
        bar_type = function_type.FunctionType(
            [
                function_type.Parameter(
                    "x", function_type.Parameter.POSITIONAL_ONLY, False, None
                )
            ]
        )
        self.assertNotEqual(foo_type, bar_type)
    ...
    def test_related_types(self):
        ...
        foo_type = function_type.FunctionType(
            [
                function_type.Parameter(
                    "x", function_type.Parameter.POSITIONAL_ONLY, False, supertype
                ),
            ]
        )
        bar_type = function_type.FunctionType(
            [
                function_type.Parameter(
                    "x", function_type.Parameter.POSITIONAL_ONLY, False, subtype
                )
            ]
        )
...
class CapturesTest(test.TestCase):
    def setUp(self):
        ...
        self.type_a1_b1 = gen_type_fn(
            {"a": trace_type.from_value(1), "b": trace_type.from_value(1)}
        )
...
class SanitizationTest(test.TestCase):
    def testRename(self):
        ...
        self.assertEqual("Foo", function_type.sanitize_arg_name("Foo"))
        self.assertEqual(
            "arg_96ab_cd___53", function_type.sanitize_arg_name("96ab.cd//?53")
        )
...
class SerializationTest(test.TestCase, parameterized.TestCase):
    ...
    def testParameter(self, name, kind, optional, type_contraint):
        ...
        expected_type_constraint = (
            serialization.serialize(type_contraint) if type_contraint else None
        )
    ...
    def testFunctionType(self):
        original = function_type.FunctionType(
            [
                function_type.Parameter(
                    "a", function_type.Parameter.POSITIONAL_ONLY, False, None
                ),
            ],
        ...
        expected = function_type_pb2.FunctionType(
            ...
            captures=[
                function_type_pb2.Capture(
                    name="b",
                    type_constraint=serialization.serialize(trace_type.from_value(1)),
                )
            ],
        )
        self.assertEqual(original.to_proto(), expected)
...
class FromStructuredSignatureTest(test.TestCase, parameterized.TestCase):
    @parameterized.parameters(
        ...
        {
            "signature": (([1, 2, 3],), {}),
            "expected_types": (trace_type.from_value([1, 2, 3]),),
        },
        {
            "signature": ((), {}),
            "expected_types": (),
