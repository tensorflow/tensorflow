...
class Literal(trace.TraceType, serialization.Serializable):
    ...
    def experimental_from_proto(
        cls, proto: default_types_pb2.SerializedLiteral
    ) -> "Literal":
    ...
    def experimental_as_proto(self) -> default_types_pb2.SerializedLiteral:
        ...
        raise ValueError(
            "Can not serialize Literal of type " + type(self.value).__name__
        )
...
class Tuple(trace.TraceType, serialization.Serializable):
    ...
    def is_subtype_of(self, other: trace.TraceType) -> bool:
        if not isinstance(other, Tuple) or len(self.components) != len(
            other.components
        ):
            return False

        return all(
            self_component.is_subtype_of(other_component)
            for self_component, other_component in zip(
    ...
    def most_specific_common_supertype(
        ...
        """See base class."""
        if not all(
            isinstance(other, Tuple) and len(self.components) == len(other.components)
            for other in others
        ):
            return None
    ...
    @classmethod
    def experimental_from_proto(
        cls, proto: default_types_pb2.SerializedTuple
    ) -> "Tuple":
    ...
    def cast(self, value: Any, casting_context) -> Any:
        ...
        assert len(value) == len(self.components), (
...
class List(trace.TraceType, serialization.Serializable):
    ...
    def cast(self, value: Any, casting_context) -> Any:
        ...
        assert len(value) == len(self.components_tuple.components), (
...
class NamedTuple(trace.TraceType, serialization.Serializable):
    ...
    def from_type_and_attributes(
        cls, named_tuple_type: Any, attributes: PythonTuple[trace.TraceType]
    ) -> "NamedTuple":
        return NamedTuple(
            named_tuple_type.__name__,
            named_tuple_type._fields,
            attributes,
            named_tuple_type,
        )
    ...
    def is_subtype_of(self, other: trace.TraceType) -> bool:
        ...
        return (
            ...
            and self.attributes.is_subtype_of(other.attributes)
        )
    ...
    def most_specific_common_supertype(
        ...
        return NamedTuple(
            ...
            supertyped_attributes.components,
    ...
    @classmethod
    def experimental_from_proto(
        cls, proto: default_types_pb2.SerializedNamedTuple
    ) -> "NamedTuple":
        return NamedTuple(
            proto.type_name,
            tuple(proto.attribute_names),
    ...
    def placeholder_value(self, placeholder_context) -> Any:
        if self._placeholder_type is None:
            ...
            raise ValueError(
                "Can not generate placeholder value for NamedTuple with"
    ...
    def cast(self, value: Any, casting_context) -> Any:
        ...
        assert set(value_dict.keys()) == set(self.attribute_names), (
...
class Attrs(trace.TraceType):
    ...
    @classmethod
    def from_type_and_attributes(
        cls, attrs_type: Any, attributes: PythonTuple[trace.TraceType]
    ) -> "Attrs":
        return Attrs(
            attrs_type.__name__,
    ...
    def most_specific_common_supertype(
        ...
        return Attrs(
            self.named_attributes.type_name,
    ...
    @classmethod
    def experimental_from_proto(
        cls, proto: default_types_pb2.SerializedAttrs
    ) -> "Attrs":
        return Attrs(
            proto.named_attributes.type_name,
            tuple(proto.named_attributes.attribute_names),
            Tuple.experimental_from_proto(proto.named_attributes.attributes).components,
        )
    ...
    def placeholder_value(self, placeholder_context) -> Any:
        if self._placeholder_type is None:
            ...
            # can generate a placeholder type using the description if ever needed.
            raise ValueError(
                "Can not generate placeholder value for Attrs with"
                " unspecified placeholder_type. Note: placeholder_type "
                "is lost during serialization."
            )
        attribute_placeholders = [
...
class Dict(trace.TraceType, serialization.Serializable):
    ...
    def is_subtype_of(self, other: trace.TraceType) -> bool:
        ...
        # that decision.
        return all(
            self.mapping[key].is_subtype_of(other.mapping[key]) for key in self.mapping
        )
    ...
    def placeholder_value(self, placeholder_context) -> Any:
        if self._placeholder_type is None:
            raise ValueError(
                "Can not generate placeholder value for Dict with"
                " unspecified placeholder_type. Note: placeholder_type "
                "is lost during serialization."
            )
        attribute_placeholders = [
    ...
    def from_tensors(self, tensors):
        ...
        sorted_traversal = {
            key: self.mapping[key].from_tensors(tensors) for key in sorted(self.mapping)
        }
    ...
    def cast(self, value: Any, casting_context) -> Any:
        ...
        assert set(value.keys()) == set(self.mapping.keys()), (
