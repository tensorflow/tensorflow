...
class SerializeTest(test.TestCase):
    ...
    def testCompositeClassSerialization(self):
        ...
        self.assertEqual(
            proto.elements[0], serialization.serialize(MyCustomClass(1, "name_1"))
        )
        self.assertEqual(
            proto.elements[1], serialization.serialize(MyCustomClass(2, "name_2"))
        )
        self.assertEqual(
            proto.elements[2], serialization.serialize(MyCustomClass(3, "name_3"))
        )
