...
//     %2 = "tf.XlaCallModule"(%0, %1) {Sout = [#tf_type.shape<?>], dim_args_spec = [], _entry_function = @_stablehlo_main_sub, _stablehlo_module_attrs = { mhlo.num_partitions = 1 }, _stablehlo_version = "1.0.0", module = "", platforms = ["TPU", "CUDA"], version = 9 : i64, use_shardy_partitioner = false} : (tensor<4x2xi32>, tensor<4x2xi32>) -> tensor<4x2xi32>
