// RUN: tfg-transforms-opt -pass-pipeline='tfg-lift-graph-to-func{feeds=Placeholder1:0,Placeholder2:0 fetches=SomeAdd3:0 control_rets=SomeAdd4},tfg-lower-func-to-graph' %s | FileCheck %s
// RUN: tfg-transforms-opt -pass-pipeline='tfg-lift-graph-to-func{fetches=SomeAdd3:0 control_rets=SomeAdd4},tfg-lower-func-to-graph' %s | FileCheck %s
// RUN: tfg-transforms-opt -pass-pipeline='tfg-lift-graph-to-func{feeds=Placeholder1:0,Placeholder2:0 control_rets=SomeAdd4},tfg-lower-func-to-graph' %s | FileCheck %s
// RUN: tfg-transforms-opt -pass-pipeline='tfg-lift-graph-to-func{feeds=Placeholder1:0,Placeholder2:0},tfg-lower-func-to-graph' %s | FileCheck %s
