...
module {
  tfg.graph #tf_type.version<producer = 1143, min_consumer = 0> {
    ...
    // CHECK: , %[[CTRL_4:.*]] = Const [%[[CTRL_2]]] name("i1/eval_0/const_folded")
    ...
    // CHECK: %[[CONST_1:.*]], %[[CTRL_3:.*]] = Const {{.*}} name("i3/eval_0/const_folded")
    ...
    // CHECK: %[[CONST_2:.*]], %[[CTRL_5:.*]] = Const {{.*}} name("i4/eval_0/const_folded")
