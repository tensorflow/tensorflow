...
TEST(ReorderDataDiscardingOpsTest, ExampleOps) {
  ...
  EXPECT_TRUE(graph_utils::ContainsGraphNodeWithName("reorder_data_discarding_ops/take", output));
  EXPECT_TRUE(graph_utils::ContainsGraphNodeWithName("reorder_data_discarding_ops/skip", output));
  EXPECT_FALSE(graph_utils::ContainsGraphNodeWithName("reorder_data_discarding_ops/shard", output));
  ...
  EXPECT_TRUE(graph_utils::GetInputNode(*graph.GetNode("reorder_data_discarding_ops/take"),
                                        graph)->name() == "range");
