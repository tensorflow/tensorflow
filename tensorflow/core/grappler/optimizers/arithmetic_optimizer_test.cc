...
TEST_F(ArithmeticOptimizerTest, HoistCWiseUnaryFromConcatWithReshape) {
  ...
  Output axis = ops::Const(s.WithOpName("axis"), 0, {});
  Output ctrl1 = ops::Placeholder(s.WithOpName("ctrl1"), DT_BOOL,
                                  ops::Placeholder::Shape({}));
  Output ctrl2 = ops::Placeholder(s.WithOpName("ctrl2"), DT_BOOL,
                                  ops::Placeholder::Shape({}));
  Output ctrl3 = ops::Placeholder(s.WithOpName("ctrl3"), DT_BOOL,
                                  ops::Placeholder::Shape({}));
  Output ctrl4 = ops::Placeholder(s.WithOpName("ctrl4"), DT_BOOL,
                                  ops::Placeholder::Shape({}));
  Output ctrl5 = ops::Placeholder(s.WithOpName("ctrl5"), DT_BOOL,
                                  ops::Placeholder::Shape({}));
  ...
  Output reshape_b = ops::Reshape(
      s.WithOpName("reshape_b").WithControlDependencies(ctrl4), b, new_shape);
  ...
  Output reshape_c =
      ops::Reshape(s.WithOpName("reshape_c").WithControlDependencies(ctrl4),
                   exp_c, new_shape);
  ...
  Output reshape_temp =
      ops::Reshape(s.WithOpName("reshape_temp").WithControlDependencies(ctrl4),
                   exp_c2, temp_shape);
  ...
  Output reshape_c2 =
      ops::Reshape(s.WithOpName("reshape_c2").WithControlDependencies(ctrl5),
                   cos_exp_c2, new_shape);
...
TEST_F(ArithmeticOptimizerTest, HoistCWiseUnaryIntoSplitWithReshape) {
  ...
  Output reshape_b =
      ops::Reshape(s.WithOpName("reshape_b").WithControlDependencies(ctrl4),
                   split1[0], new_shape);
  ...
  Output reshape_b2 =
      ops::Reshape(s.WithOpName("reshape_b2").WithControlDependencies(ctrl5),
                   cos_exp_b2, new_shape);
