...
class RecognizeResult(object):
  ...
  def __init__(self, founded_command="_silence_",
               score=0.0, is_new_command=False):
    """
    ...
    Args:
      ...
      is_new_command: A boolean indicating if the founded command is a new one against the last one.
    """
