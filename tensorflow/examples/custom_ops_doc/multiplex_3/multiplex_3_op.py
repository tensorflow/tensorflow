...
from tensorflow.examples.custom_ops_doc.multiplex_2.multiplex_2_op import (
...
def multiplex_sparse(
    cond: tf.SparseTensor, a: tf.SparseTensor, b: tf.SparseTensor, name=None
):
