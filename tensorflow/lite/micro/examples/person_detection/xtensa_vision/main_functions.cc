...
// 136 for buffers used by framework and rest for scratchbuffer used by kernels
constexpr int kTensorArenaSize = 136 * 1024 + (2416 * 1024);
...
void loop() {
  ...
  int32_t cycleStart, cycleStop, totalCycles;
#pragma no_reorder
