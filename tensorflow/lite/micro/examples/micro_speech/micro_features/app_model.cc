...
tflite::MicroMutableOpResolver app_get_model_ops_resolver() {
	...
	micro_ops_resolver.AddBuiltin(tflite::BuiltinOperator_DEPTHWISE_CONV_2D, tflite::ops::micro::Register_DEPTHWISE_CONV_2D());
	micro_ops_resolver.AddBuiltin(tflite::BuiltinOperator_FULLY_CONNECTED, tflite::ops::micro::Register_FULLY_CONNECTED());
	micro_ops_resolver.AddBuiltin(tflite::BuiltinOperator_SOFTMAX, tflite::ops::micro::Register_SOFTMAX());
	return micro_ops_resolver;
}
...
const int g_app_micro_model_data_len = 18208;
