...
constexpr int kTensorArenaSize = 10*10*10 * 1024;
...
extern unsigned char single_grucell_model_tflite[];
...
void setup_tf() {
	...
	model = tflite::GetModel(single_grucell_model_tflite);
	...
	printf("input0->dims->size = %d\n", input0->dims->size);
	printf("input1->dims->size = %d\n", input1->dims->size);
