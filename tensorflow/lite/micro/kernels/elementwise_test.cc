...
TF_LITE_MICRO_TEST(Abs) {
  ...
  tflite::testing::TestElementwiseFloat(
      ...
      {2, 2, 2},                    // Output shape
      {0.01f, 0.01f, 10, 10},         // Output values
      output_data);
}
...
TF_LITE_MICRO_TEST(Log) {
  ...
  tflite::testing::TestElementwiseFloat(
      ...
      {2, 2, 2},                      // Input shape
      {1, 2.7182818f, 0.5, 2},         // Input values
      {2, 2, 2},                      // Output shape
      {0, 1, -0.6931472f, 0.6931472f},  // Output values
      output_data);
}
...
TF_LITE_MICRO_TEST(Rsqrt) {
  ...
  tflite::testing::TestElementwiseFloat(
      ...
      {2, 2, 2},                      // Output shape
      {1, 0.7071f, 0.5f, 0.33333f},      // Output values
      output_data);
}
...
TF_LITE_MICRO_TEST(Square) {
  ...
  tflite::testing::TestElementwiseFloat(
      ...
      {2, 2, 2},                       // Input shape
      {1, 2, 0.5f, -3.0f},               // Input values
      {2, 2, 2},                       // Output shape
      {1, 4.0f, 0.25f, 9.0f},             // Output values
      output_data);
}
...
TF_LITE_MICRO_TEST(TANH) {
	...
	tflite::testing::TestElementwiseFloat(
		...
		{ 2, 2, 2 },                       // Input shape
		{ 0, 50, 0.5f, -50 },               // Input values
		{ 2, 2, 2 },                       // Output shape
		{ 0, 1, 0.462117f, -1 },             // Output values
		output_data);
}
