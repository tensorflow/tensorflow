...
TF_LITE_MICRO_TEST(GatherOp_Shuffle2D) {
...
TF_LITE_MICRO_TEST(GatherOp_1DInput0DIndex) {
  // For input_dims[], positions_dims[], or output_dims[], element 0 is the
  // number of dimensions in that array, not the actual dimension data.
...
TF_LITE_MICRO_TEST(GatherOp_2DInput0DIndex) {
  // For input_dims[], positions_dims[], or output_dims[], element 0 is the
  // number of dimensions in that array, not the actual dimension data.
  const int input_dims[] = {2, 2, 2};
  const int positions_dims[] = {0};
...
TF_LITE_MICRO_TEST(GatherOp_1DInput1DIndex) {
  // For input_dims[], positions_dims[], or output_dims[], element 0 is the
  // number of dimensions in that array, not the actual dimension data.
  const int input_dims[] = {1, 3};
...
TF_LITE_MICRO_TEST(GatherOp_2DIndexWith2DResult) {
  // For input_dims[], positions_dims[], or output_dims[], element 0 is the
  // number of dimensions in that array, not the actual dimension data.
  const int input_dims[] = {1, 3};
...
TF_LITE_MICRO_TEST(GatherOp_Duplicate3D) {
  // For input_dims[], positions_dims[], or output_dims[], element 0 is the
  // number of dimensions in that array, not the actual dimension data.
...
TF_LITE_MICRO_TEST(GatherOp_Axis0) {
  // For input_dims[], positions_dims[], or output_dims[], element 0 is the
  // number of dimensions in that array, not the actual dimension data.
...
TF_LITE_MICRO_TEST(GatherOp_Axis1_Shuffle3D) {
  // For input_dims[], positions_dims[], or output_dims[], element 0 is the
  // number of dimensions in that array, not the actual dimension data.
  const int axis = 1;
...
TF_LITE_MICRO_TEST(GatherOp_LastAxis_0DIndex) {
  // For input_dims[], positions_dims[], or output_dims[], element 0 is the
  // number of dimensions in that array, not the actual dimension data.
  const int axis = -1;
  const int input_dims[] = {3, 1, 2, 3};
