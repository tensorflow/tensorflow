...
float_32 CEVA_TFLM_Abs_Float32(float_32 a);
float_32 CEVA_TFLM_Cos_Float32(float_32 a);
float_32 CEVA_TFLM_Log_Float32(float_32 a);
float_32 CEVA_TFLM_Sqrt_Float32(float_32 a);
float_32 CEVA_TFLM_Rsqrt_Float32(float_32 a);
float_32 CEVA_TFLM_Sin_Float32(float_32 a);
float_32 CEVA_TFLM_Tanh_Float32(float_32 a);
float_32 CEVA_TFLM_Sigmoid_Float32(float_32 a);

float_32 CEVA_TFLM_Square_Float32(float_32 a);
bool CEVA_TFLM_LogicalNot(bool a);
...
void CEVA_TFLM_SplitLoops_Float32(const void* tensors, const int* dataIndex,
                                  const float* input_ptr, int outer_size,
                                  int output_count, int copy_size);
void CEVA_TFLM_SplitLoops_int8(const void* tensors, const int* dataIndex,
