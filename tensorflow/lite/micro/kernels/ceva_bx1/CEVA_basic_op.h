...
#ifndef WIN32
static inline __attribute__((always_inline)) short2 min_short2(short2 inA, short2 inB);
static inline __attribute__((always_inline)) short2 max_short2(short2 inA, short2 inB);
static inline __attribute__((always_inline)) int lim_sat8(int inA);
static inline __attribute__((always_inline)) short2 sub_short2(short2 inA, short2 inB);
static inline __attribute__((always_inline)) int2 sub_int2(int2 inA, int2 inB);
static inline __attribute__((always_inline)) int2 shiftl_int2(int2 inA, int inB);
static inline __attribute__((always_inline)) int2 shiftr_int2_rnd(int2 inA, int inB);
static inline __attribute__((always_inline)) int2 mpy_int2_rnd_sat(int2 inA, int2 inB);
static inline __attribute__((always_inline)) int2 mac3_4_short2(short2 inA, short2 inB, short2 inC, short2 inD, int2 in_acc);
static inline __attribute__((always_inline)) int mac3_2_short2(short2 inA, short2 inB, int inC);
static inline __attribute__((always_inline)) int mac(short inA, short inB, int inC);
static inline __attribute__((always_inline)) I32 L_mpy_ll_sat_rnd(I32 inp1, I32 inp2);
...
static inline __attribute__((always_inline)) int2 mac3_4_short2(short2 inA, short2 inB, short2 inC, short2 inD, int2 inE)
{
	return _mac3(inA, inB, inC, inD, inE);
}
static inline __attribute__((always_inline)) int mac3_2_short2(short2 inA, short2 inB, int inE)
{
	return _mac3(inA, inB, inE);
}
static inline __attribute__((always_inline)) int mac(short inA, short inB, int inE)
{
...
static inline __attribute__((always_inline)) Word32 L_shl(Word32 L_v1, Word16 v2);
static inline __attribute__((always_inline)) Word32 L_shr(Word32 L_v1, Word16 v2);
...
static inline int2 mac3_4_short2(short2 inA, short2 inB, short2 inC, short2 inD, int2 inE);
...
static inline int2 shiftr_int2_rnd(int2 inA, int inB)
{
	...
	ret_val.lo = ((inA.lo >> inB) +
		((remainder.lo > threshold.lo) & one));
	ret_val.hi = ((inA.hi >> inB) +
		((remainder.hi > threshold.hi) & one));
	return ret_val;	
}
#ifndef INT32_MIN
...
{
	int2 out_acc;
	long long acc_lo = (long long)inE.lo + (long long)inA.lo*inB.lo + (long long)inC.lo*inD.lo;
	long long acc_hi = (long long)inE.hi + (long long)inA.hi*inB.hi + (long long)inC.hi*inD.hi;
