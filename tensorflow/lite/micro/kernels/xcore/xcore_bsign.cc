#include "tensorflow/lite/c/common.h"
 ...
 {
     BSign8OpData *op = nullptr;

     context->AllocatePersistentBuffer(context, sizeof(BSign8OpData), reinterpret_cast<void **>(&op));
     op->jobs = nullptr; 
     ...
     /* Allocate the jobs */
     context->AllocatePersistentBuffer(context,sizeof(nn_bsign_8_job_t) * op->n_threads, reinterpret_cast<void**>(&op->jobs));
