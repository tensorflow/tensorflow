...
#if !defined(XTENSA) && !defined(CEVA_BX1) && \
    !defined(CEVA_SP500) 
// TODO(b/170503075): xtensa kernels are less general
// than reference kernels and we ifdef out test cases that are currently known to fail.
...
//See tflite quantization spec: https://www.tensorflow.org/lite/performance/quantization_spec
