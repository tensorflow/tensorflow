...
#define TF_LITE_BATCH_TO_SPACE_ND(scalar)             \
  ...
  switch (op_context.input->type) {  // Already know in/out types are same.
    case kTfLiteFloat32:
      TF_LITE_BATCH_TO_SPACE_ND(float);
      break;
    case kTfLiteUInt8:
      TF_LITE_BATCH_TO_SPACE_ND(uint8_t);
      break;
    case kTfLiteInt8:
      TF_LITE_BATCH_TO_SPACE_ND(int8_t);
      break;
    case kTfLiteInt32:
      TF_LITE_BATCH_TO_SPACE_ND(int32_t);
      break;
    case kTfLiteInt64:
      TF_LITE_BATCH_TO_SPACE_ND(int64_t);
      break;
    default:
      context->ReportError(
...
TfLiteRegistration* Register_BATCH_TO_SPACE_ND() {
  static TfLiteRegistration r = {nullptr, nullptr, batch_to_space_nd::Prepare,
                                 batch_to_space_nd::Eval};
  return &r;
}
