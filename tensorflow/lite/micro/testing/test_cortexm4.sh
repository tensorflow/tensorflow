...
# ==============================================================================
#
# Tests a 'cortexm4' generic LF by parsing the log output of Renode emulation.
#
...
declare -r TEST_TMPDIR=/tmp/test_cortexm4_binary/
declare -r MICRO_LOG_PATH=${TEST_TMPDIR}
declare -r MICRO_LOG_FILENAME=${MICRO_LOG_PATH}/logs.txt
mkdir -p ${MICRO_LOG_PATH}

docker build -t renode_cortexm4 \
  -f ${ROOT_DIR}/tensorflow/lite/micro/testing/Dockerfile.cortexm4 \
