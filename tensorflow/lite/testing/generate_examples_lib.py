...
from tensorflow.lite.testing.op_tests.dynamic_update_slice import (
    make_dynamic_update_slice_tests,
)
...
from tensorflow.lite.testing.op_tests.fully_connected_4bit_hybrid import (
    make_fully_connected_4bit_hybrid_tests,
)
...
from tensorflow.lite.testing.op_tests.matrix_band_part import (
    make_matrix_band_part_tests,
)
...
from tensorflow.lite.testing.op_tests.random_standard_normal import (
    make_random_standard_normal_tests,
)
...
from tensorflow.lite.testing.op_tests.unsorted_segment import (
    make_unsorted_segment_max_tests,
    make_unsorted_segment_min_tests,
    make_unsorted_segment_prod_tests,
    make_unsorted_segment_sum_tests,
)
    ...
    with zipfile.PyZipFile(zip_path, "w") as archive:
        ...
        for test_name in test_sets:
            ...
            multi_gen_state.test_name = re.sub(
                r"(_(|with-flex|forward-compat|mlir-quant))?$", "", test_name, count=1
            )
