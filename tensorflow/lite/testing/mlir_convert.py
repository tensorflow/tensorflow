...
def mlir_convert(
    ...
    **kwargs
    ...
    extra_convert_options = kwargs.get(
        "extra_convert_options", zip_test_utils.ExtraConvertOptions()
    )
    tflite_model = None
    log = ""
    ...
    if options.make_tf_ptq_tests:
        ...
        converter._experimental_tf_quantization_mode = (
            tf_quantization_mode  # pylint: disable=protected-access
        )
