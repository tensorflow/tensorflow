    ...
    def logical(options, expected_tf_failures=0):
        ...
        def build_inputs(parameters, sess, inputs, outputs):
            input_value1 = create_tensor_data(
                tf.bool, parameters["input_shape_pair"][0]
            )
            input_value2 = create_tensor_data(
                tf.bool, parameters["input_shape_pair"][1]
            )
...
def make_logical_xor_tests(options):
    ...
    return _make_logical_tests(tf.math.logical_xor)(options, expected_tf_failures=1)
