...
def make_unsorted_segment_tests(options, unsorted_segment_op):
    ...
    def build_graph_one_node(parameters):
        ...
        num_segments_tensor = tf.constant(
            parameters["num_segments"], dtype=tf.int32, shape=[], name="num_segments"
        )
        output = unsorted_segment_op(
    ...
    def build_graph_multi_node(parameters):
        ...
        segment_ids_tensor = tf.compat.v1.placeholder(
            dtype=tf.int32, name="segment_ids", shape=parameters["segment_id_shape"]
        )
        num_segments_tensor = tf.constant(
            parameters["num_segments"], dtype=tf.int32, shape=[], name="num_segments"
        )
        intermediate_tensor = unsorted_segment_op(
            data_tensor, segment_ids_tensor, num_segments_tensor
        )
        ...
        output = unsorted_segment_op(
            intermediate_tensor, segment_ids_tensor_2, num_segments_tensor_2
        )
