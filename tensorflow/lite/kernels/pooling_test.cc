...
TEST(FloatPoolingOpTest, MaxPoolWithInvalidFilterSize) {
  EXPECT_DEATH(
      FloatPoolingOpModel m(BuiltinOperator_MAX_POOL_2D,
                            /*input=*/{TensorType_FLOAT32, {1, 2, 4, 1}},
                            /*filter_width=*/0, /*filter_height=*/2,
                            /*output=*/{TensorType_FLOAT32, {}},
                            /*padding=*/Padding_VALID,
...
TEST(FloatPoolingOpTest, AveragePoolWithInvalidFilterSize) {
  EXPECT_DEATH(
      FloatPoolingOpModel m(BuiltinOperator_AVERAGE_POOL_2D,
                            /*input=*/{TensorType_FLOAT32, {1, 2, 4, 1}},
                            /*filter_width=*/-5, /*filter_height=*/2,
                            /*output=*/{TensorType_FLOAT32, {}},
                            /*padding=*/Padding_VALID,
                            /*stride_w=*/1, /*stride_h=*/1),
      "Cannot allocate tensors");
