...
TfLiteStatus ResizeOutputAndTemporaryTensors(
  ...
  // Note: older versions of LiteRT also allowed the number of output channels
  // to be a multiple of the number of filter channels, but that this case was
  // never implemented correctly and is no longer permitted.
