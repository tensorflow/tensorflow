...
inline TfLitePaddingValues ComputePaddingDepthHeightWidth(
    int stride_depth, int stride_height, int stride_width,
    int dilation_rate_depth, int dilation_rate_height, int dilation_rate_width,
    int in_depth, int in_height, int in_width,
    int filter_depth, int filter_height, int filter_width,
    TfLitePadding padding, int* out_depth, int* out_height, int* out_width) {
  *out_width = ComputeOutSize(padding, in_width, filter_width, stride_width,
                              dilation_rate_width);
  *out_height = ComputeOutSize(padding, in_height, filter_height, stride_height,
                               dilation_rate_height);
