...
TEST(LSTMIntegerOpModel, NoCifgYesLayerNormYesProjectionNoPeephole) {
  // Hyper parameters.
  const int n_batch = 2;
  const int n_input = 5;
  const int n_cell = 4;
...
TEST(LSTMIntegerOpModel, YesCifgYesLayerNormYesProjectionNoPeephole) {
  // Hyper parameters.
  const int n_batch = 2;
  const int n_input = 5;
  const int n_cell = 4;
...
TEST(LSTMIntegerOpModel, YesCifgYesLayerNormNoProjectionNoPeephole) {
  // Hyper parameters.
  const int n_batch = 2;
  const int n_input = 5;
  const int n_cell = 4;
  ...
  const std::vector<float> recurrent_to_cell_weights = {
      -0.3, 0.2,  0.1,  -0.3, 0.8, -0.08, -0.2, 0.3,
      0.8,  -0.6, -0.1, 0.2,  0.3, -0.1,  0.2,  0.5};

  const std::vector<float> recurrent_to_forget_weights = {
      -0.5, -0.3, -0.5, -0.2, 0.6, 0.4, 0.9,  0.3,
      -0.1, 0.2,  0.5,  0.2,  0.2, 0.3, -0.1, 0.4};

  const std::vector<float> recurrent_to_output_weights = {
      0.3,  -0.1, 0.1,  -0.2, -0.5, -0.7, -0.2, -0.6,
      -0.1, -0.4, -0.7, -0.2, 0.1,  0.5,  0.2,  -0.3};
  ...
  const std::vector<std::vector<int8_t>> expected_output = {
      ...
      {-17, 23, 5, 48, -17, 20, -1, 52},
      {-23, 29, 17, 39, -19, 22, -3, 59},
  };
...
TEST(LSTMIntegerOpModel, YesCifgYesLayerNormNoProjectionYesPeephole) {
  // Hyper parameters.
  const int n_batch = 2;
  const int n_input = 5;
  const int n_cell = 4;
  ...
  // Expected outputs.
  const std::vector<std::vector<int8_t>> expected_output = {
      {-15, 21, 14, 20, -15, 16, 5, 27},
      {-17, 24, 6, 45, -16, 20, -1, 50},
      {-24, 29, 16, 38, -18, 22, -3, 56},
  };
