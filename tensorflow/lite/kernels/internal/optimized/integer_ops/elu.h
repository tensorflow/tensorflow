...
==============================================================================*/
#ifndef TENSORFLOW_LITE_KERNELS_INTERNAL_OPTIMIZED_INTEGER_OPS_ELU_H_
#define TENSORFLOW_LITE_KERNELS_INTERNAL_OPTIMIZED_INTEGER_OPS_ELU_H_
...
inline void QElu(const EluParams& params, const RuntimeShape& input_shape,
  ...
  for (; c < size; ++c) {
    ...
    if (input_val_centered <= -input_range_radius) {
      ...
      int32 output_val_s32 = RoundingDivideByPOT(final_val_f4.raw(), 27);
      if (output_val_s32 < 0) {
        // Rescale the value
