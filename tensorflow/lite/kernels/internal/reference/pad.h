...
inline void PadImpl(const PadParams& op_params, const RuntimeShape& input_shape,
...
template <typename T, typename P>
inline void Pad(const PadParams& op_params, const RuntimeShape& input_shape,
                const T* input_data, const P* pad_value_ptr,
                const RuntimeShape& output_shape, T* output_data) {
...
// similar cases.
template <typename T, typename P>
inline void PadImageStyle(const PadParams& op_params,
