...
// Test that integer overflow in string fill dimensions returns kTfLiteError.
TEST(FillOpTest, FillStringOverflowDimensions) {
  FillOpModel<int32_t, std::string> m(
      TensorType_INT32, {2}, {40000, 60000}, "AB", TestType::kDynamic);
