 ...
 public:
  LayerNormUnidirectionalLSTMOpModel(
      ...
      : UnidirectionalLSTMOpModel(
            n_batch, n_input, n_cell, n_output, sequence_length, time_major,
            use_cifg, use_peephole, use_projection_weights, use_projection_bias,
            cell_clip, proj_clip, input_shapes, TensorType_FLOAT32,
            /*is_layer_norm=*/true) {}
};
...
class IndyLSTMOpTest : public ::testing::TestWithParam<std::tuple<bool, bool>> {
};

INSTANTIATE_TEST_SUITE_P(PeepHoleAndCifg, IndyLSTMOpTest,
