...
TEST(TileTest, Float32Vector) {
  Check<float>({3}, {1.0, 2.0, 3.0}, {2}, {6}, {1.0, 2.0, 3.0, 1.0, 2.0, 3.0},
               TensorType_FLOAT32, TensorType_INT32);
}

TEST(TileTest, Float32Matrix) {
  Check<float>(
      {2, 3}, {11.f, 12.f, 13.f, 21.f, 22.f, 23.f}, {2, 1}, {4, 3},
...
TEST(TileTest, Float32HighDimension) {
  Check<float>(
      {1, 2, 3}, {11.f, 12.f, 13.f, 21.f, 22.f, 23.f}, {2, 3, 1}, {2, 6, 3},
      {11.f, 12.f, 13.f, 21.f, 22.f, 23.f, 11.f, 12.f, 13.f, 21.f, 22.f, 23.f,
       11.f, 12.f, 13.f, 21.f, 22.f, 23.f, 11.f, 12.f, 13.f, 21.f, 22.f, 23.f,
       11.f, 12.f, 13.f, 21.f, 22.f, 23.f, 11.f, 12.f, 13.f, 21.f, 22.f, 23.f},
      TensorType_FLOAT32, TensorType_INT32);
...
TEST(TileTest, Uint8Matrix) {
  Check<uint8_t>({2, 3}, {11, 12, 13, 21, 22, 23}, {2, 1}, {4, 3},
                 {11, 12, 13, 21, 22, 23, 11, 12, 13, 21, 22, 23},
                 TensorType_UINT8, TensorType_INT32);
}

TEST(TileTest, Int32Matrix) {
  Check<int32_t>({2, 3}, {11, 12, 13, 21, 22, 23}, {2, 1}, {4, 3},
                 {11, 12, 13, 21, 22, 23, 11, 12, 13, 21, 22, 23},
                 TensorType_INT32, TensorType_INT32);
}

TEST(TileTest, BooleanMatrix) {
  Check<bool>({2, 3}, {true, false, false, true, true, false}, {2, 1}, {4, 3},
              {true, false, false, true, true, false, true, false, false, true,
               true, false},
              TensorType_BOOL, TensorType_INT32);
}

TEST(TileTest, Int64Matrix) {
  Check<int64_t>({2, 3}, {11, 12, 13, 21, 22, 23}, {2, 1}, {4, 3},
                 {11, 12, 13, 21, 22, 23, 11, 12, 13, 21, 22, 23},
