...
TYPED_TEST(StridedSliceOpTest, Offset) {
  for (bool constant_tensors : {true, false}) {
    ...
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>({TypeParam(1), TypeParam(2), TypeParam(3)}));
    if (constant_tensors) {
...
TYPED_TEST(StridedSliceOpTest, OffsetArray) {
  for (bool constant_tensors : {true, false}) {
    ...
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>({TypeParam(1), TypeParam(2), TypeParam(5), TypeParam(6)}));
    if (constant_tensors) {
      EXPECT_THAT(m.GetOutputTensor(0)->allocation_type, kTfLitePersistentRo);
    } else {
      EXPECT_THAT(m.GetOutputTensor(0)->allocation_type, kTfLiteArenaRw);
...
TYPED_TEST(StridedSliceOpTest, OffsetConstantStride) {
  ...
  ASSERT_EQ(m.Invoke(), kTfLiteOk);
  EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({2, 2}));
  EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>({TypeParam(1), TypeParam(3), TypeParam(13), TypeParam(15)}));
  EXPECT_THAT(m.GetOutputTensor(0)->allocation_type, kTfLiteArenaRw);
}
...
TYPED_TEST(StridedSliceOpTest, OffsetConstantNegativeStride) {
  ...
  EXPECT_THAT(m.GetOutput(),
              ElementsAreTypedArray<TypeParam>({TypeParam(28), TypeParam(26), TypeParam(16), TypeParam(14)}));
  EXPECT_THAT(m.GetOutputTensor(0)->allocation_type, kTfLiteArenaRw);
}
...
TYPED_TEST(StridedSliceOpTest, In1D) {
  for (bool constant_tensors : {true, false}) {
    ...
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>({TypeParam(2), TypeParam(3)}));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In1D_Int32End) {
  for (bool constant_tensors : {true, false}) {
    ...
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>(casted_values));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In1D_NegativeEnd) {
  for (bool constant_tensors : {true, false}) {
    ...
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>({TypeParam(2)}));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In1D_OutOfRangeEnd) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({3}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>({TypeParam(2), TypeParam(3), TypeParam(4)}));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In1D_NegativeBeginNegativeStride) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({1}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>({TypeParam(3)}));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In1D_OutOfRangeBeginNegativeStride) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({1}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>({TypeParam(4)}));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In1D_NegativeEndNegativeStride) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({2}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>({TypeParam(3), TypeParam(2)}));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In1D_OutOfRangeEndNegativeStride) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({2}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>({TypeParam(2), TypeParam(1)}));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In1D_NegStride) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({3}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>({TypeParam(3), TypeParam(2), TypeParam(1)}));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In1D_EvenLenStride2) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({1}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>({TypeParam(1)}));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In1D_OddLenStride2) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({2}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>({TypeParam(1), TypeParam(3)}));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In2D_Identity) {
  for (bool constant_tensors : {true, false}) {
    ...
    EXPECT_THAT(m.GetOutput(),
                ElementsAreTypedArray<TypeParam>({TypeParam(1), TypeParam(2), TypeParam(3), TypeParam(4), TypeParam(5), TypeParam(6)}));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In2D) {
  for (bool constant_tensors : {true, false}) {
    ...
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>({TypeParam(4), TypeParam(5)}));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In2D_NegStride) {
  for (bool constant_tensors : {true, false}) {
    ...
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>({TypeParam(6), TypeParam(5), TypeParam(4)}));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In2D_BeginMask) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({2, 2}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>({TypeParam(1), TypeParam(2), TypeParam(4), TypeParam(5)}));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In2D_EndMask) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({1, 3}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>({TypeParam(4), TypeParam(5), TypeParam(6)}));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In2D_NegStrideEndMask) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({1, 2}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>({TypeParam(5), TypeParam(4)}));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In3D_Strided2) {
  for (bool constant_tensors : {true, false}) {
    ...
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>({TypeParam(1), TypeParam(5)}));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In2D_ShrinkAxis2_BeginEndAxis1_NegativeSlice) {
  for (bool constant_tensors : {true, false}) {
    ...
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>({TypeParam(0), TypeParam(1), TypeParam(2), TypeParam(3)}));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In2D_ShrinkAxisMask2) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({2}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>({TypeParam(1), TypeParam(4)}));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In3D_IdentityShrinkAxis2) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({2, 2}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>({TypeParam(1), TypeParam(2), TypeParam(7), TypeParam(8)}));
  }
}
TYPED_TEST(StridedSliceOpTest, In3D_IdentityShrinkAxis3) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({2}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>({TypeParam(1), TypeParam(2)}));
  }
}
TYPED_TEST(StridedSliceOpTest, In3D_IdentityShrinkAxis4) {
  for (bool constant_tensors : {true, false}) {
    ...
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({2, 3}));
    EXPECT_THAT(m.GetOutput(),
                ElementsAreTypedArray<TypeParam>({TypeParam(1), TypeParam(3), TypeParam(5), TypeParam(7), TypeParam(9), TypeParam(11)}));
  }
}
TYPED_TEST(StridedSliceOpTest, In3D_IdentityShrinkAxis5) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({3}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>({TypeParam(1), TypeParam(3), TypeParam(5)}));
  }
}
TYPED_TEST(StridedSliceOpTest, In3D_IdentityShrinkAxis6) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({2}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>({TypeParam(1), TypeParam(7)}));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In5D_Identity) {
  for (bool constant_tensors : {true, false}) {
    ...
    EXPECT_THAT(m.GetOutput(),
                ElementsAreTypedArray<TypeParam>({TypeParam(1), TypeParam(2), TypeParam(3), TypeParam(4), TypeParam(9), TypeParam(10), TypeParam(11), TypeParam(12)}));
  }
}
TYPED_TEST(StridedSliceOpTest, In5D_IdentityShrinkAxis1) {
  for (bool constant_tensors : {true, false}) {
    ...
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>({TypeParam(1), TypeParam(2), TypeParam(3), TypeParam(4)}));
  }
}
...
TYPED_TEST(StridedSliceOpTest, NegEndMask) {
  for (bool constant_tensors : {true, false}) {
    ...
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({2, 3}));
    EXPECT_THAT(m.GetOutput(),
                ElementsAreTypedArray<TypeParam>({TypeParam(3), TypeParam(2), TypeParam(1), TypeParam(6), TypeParam(5), TypeParam(4)}));
  }
}
