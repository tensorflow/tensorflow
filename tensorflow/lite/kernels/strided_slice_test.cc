...
TYPED_TEST(StridedSliceOpTest, Offset) {
  for (bool constant_tensors : {true, false}) {
    ...
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({1, 2, 3})));
    if (constant_tensors) {
...
TYPED_TEST(StridedSliceOpTest, OffsetArray) {
  for (bool constant_tensors : {true, false}) {
    ...
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({1, 2, 5, 6})));
    if (constant_tensors) {
      EXPECT_THAT(m.GetOutputTensor(0)->allocation_type, kTfLitePersistentRo);
    } else {
      EXPECT_THAT(m.GetOutputTensor(0)->allocation_type, kTfLiteArenaRw);
...
TYPED_TEST(StridedSliceOpTest, OffsetConstantStride) {
  ...
  ASSERT_EQ(m.Invoke(), kTfLiteOk);
  EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({2, 2}));
  EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({1, 3, 13, 15})));
  EXPECT_THAT(m.GetOutputTensor(0)->allocation_type, kTfLiteArenaRw);
}
...
TYPED_TEST(StridedSliceOpTest, OffsetConstantNegativeStride) {
  ...
  EXPECT_THAT(m.GetOutput(),
              ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({28, 26, 16, 14})));
  EXPECT_THAT(m.GetOutputTensor(0)->allocation_type, kTfLiteArenaRw);
}
...
TYPED_TEST(StridedSliceOpTest, In1D) {
  for (bool constant_tensors : {true, false}) {
    ...
    const std::vector<TypeParam> input_data = CastVector<TypeParam>({1, 2, 3, 4});
    StridedSliceOpModel<TypeParam> m({4}, {1}, {1}, {1}, input_data, {1}, {3},
                                     {1}, 0, 0, 0, 0, 0, constant_tensors);
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({2}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({2, 3})));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In1D_NegativeEnd) {
  for (bool constant_tensors : {true, false}) {
    ...
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({2})));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In1D_OutOfRangeEnd) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({3}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({2, 3, 4})));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In1D_NegativeBeginNegativeStride) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({1}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({3})));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In1D_OutOfRangeBeginNegativeStride) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({1}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({4})));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In1D_NegativeEndNegativeStride) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({2}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({3, 2})));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In1D_OutOfRangeEndNegativeStride) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({2}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({2, 1})));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In1D_NegStride) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({3}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({3, 2, 1})));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In1D_EvenLenStride2) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({1}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({1})));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In1D_OddLenStride2) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({2}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({1, 3})));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In2D) {
  for (bool constant_tensors : {true, false}) {
    ...
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({4, 5})));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In2D_NegStride) {
  for (bool constant_tensors : {true, false}) {
    ...
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({6, 5, 4})));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In2D_BeginMask) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({2, 2}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({1, 2, 4, 5})));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In2D_EndMask) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({1, 3}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({4, 5, 6})));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In2D_NegStrideEndMask) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({1, 2}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({5, 4})));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In3D_Strided2) {
  for (bool constant_tensors : {true, false}) {
    ...
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({1, 5})));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In1D_ShrinkAxisMask1_NegativeSlice) {
  for (bool constant_tensors : {true, false}) {
    ...
    const std::vector<TypeParam> input_data = CastVector<TypeParam>({0, 1, 2, 3});
...
TYPED_TEST(StridedSliceOpTest, In2D_ShrinkAxis2_BeginEndAxis1_NegativeSlice) {
  for (bool constant_tensors : {true, false}) {
    ...
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({0, 1, 2, 3})));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In2D_ShrinkAxisMask2) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({2}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({1, 4})));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In3D_IdentityShrinkAxis1) {
  for (bool constant_tensors : {true, false}) {
    ...
    EXPECT_THAT(m.GetOutput(),
                ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({1, 2, 3, 4, 5, 6})));
  }
}
TYPED_TEST(StridedSliceOpTest, In3D_IdentityShrinkAxis2) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({2, 2}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({1, 2, 7, 8})));
  }
}
TYPED_TEST(StridedSliceOpTest, In3D_IdentityShrinkAxis3) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({2}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({1, 2})));
  }
}
TYPED_TEST(StridedSliceOpTest, In3D_IdentityShrinkAxis4) {
  for (bool constant_tensors : {true, false}) {
    ...
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({2, 3}));
    EXPECT_THAT(m.GetOutput(),
                ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({1, 3, 5, 7, 9, 11})));
  }
}
TYPED_TEST(StridedSliceOpTest, In3D_IdentityShrinkAxis5) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({3}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({1, 3, 5})));
  }
}
TYPED_TEST(StridedSliceOpTest, In3D_IdentityShrinkAxis6) {
  for (bool constant_tensors : {true, false}) {
    ...
    ASSERT_EQ(m.Invoke(), kTfLiteOk);
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({2}));
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({1, 7})));
  }
}
...
TYPED_TEST(StridedSliceOpTest, In5D_Identity) {
  for (bool constant_tensors : {true, false}) {
    ...
    EXPECT_THAT(m.GetOutput(),
                ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({1, 2, 3, 4, 9, 10, 11, 12})));
  }
}
TYPED_TEST(StridedSliceOpTest, In5D_IdentityShrinkAxis1) {
  for (bool constant_tensors : {true, false}) {
    ...
    EXPECT_THAT(m.GetOutput(), ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({1, 2, 3, 4})));
  }
}
...
TYPED_TEST(StridedSliceOpTest, NegEndMask) {
  for (bool constant_tensors : {true, false}) {
    ...
    EXPECT_THAT(m.GetOutputShape(), ElementsAreArray({2, 3}));
    EXPECT_THAT(m.GetOutput(),
                ElementsAreTypedArray<TypeParam>(CastVector<TypeParam>({3, 2, 1, 6, 5, 4})));
  }
}
