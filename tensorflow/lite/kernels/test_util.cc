...
std::string GetDumpedModelName() {
  // The mutex is used to ensure thread safety for mutil-thread tests. Notice
  ...
  model_serial++;
  // Determine the name of exported model.
  ...
  std::string output_file_name =
      StringReplace(raw_output_file_name, "/", "_", true);
