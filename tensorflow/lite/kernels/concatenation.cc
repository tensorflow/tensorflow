...
#define TF_LITE_CONCATENATION_QUANTIZED(data_type)                           \
  {                                                                          \
    VectorOfQuantizedTensors<data_type> all_inputs(*context, *node->inputs); \
    tflite::ConcatenationParams op_params;                                   \
    op_params.axis = axis;                                                   \
  ...
  switch (output->type) {  // Already know in/outtypes are same.
    ...
    case kTfLiteInt32:
      ...
      break;
    case kTfLiteUInt8:
      TF_LITE_CONCATENATION_QUANTIZED(uint8_t);
      break;
    case kTfLiteInt8:
    ...
    case kTfLiteInt64:
      ...
      break;
    case kTfLiteInt16:
      TF_LITE_CONCATENATION_QUANTIZED(int16_t)
      break;
    default:
