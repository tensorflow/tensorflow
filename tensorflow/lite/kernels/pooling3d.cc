...
// TODO(b/184309471) Support MaxPool3D op.
enum PoolType {
  kAverage,
};
...
// TODO(b/190142662) Add optimized kernels.
TfLiteRegistration* Register_AVG_POOL_3D() {
  static TfLiteRegistration r = {
      pooling_3d::Init, pooling_3d::Free,
      pooling_3d::GenericPrepare<pooling_3d::kAverage>,
