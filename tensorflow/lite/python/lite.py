...
class TFLiteConverterV2(TFLiteConverterBase):
  ...
  def convert(self):
    ...
    Raises:
      ValueError:
        - No concrete functions is specified. when no concrete function
        is specified.
        - Multiple concrete functions are specified. when more than one
        concrete functions are specified.
