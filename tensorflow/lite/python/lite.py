...
from tensorflow.lite.python.convert import (
    convert_graphdef_with_arrays as _convert_graphdef_with_arrays,
)
...
class QuantizationMode(object):
    ...
    def is_integer_quantize(self):
        return (
            ...
            or self.is_training_time_low_bit_allow_float()
        )

    def is_training_time_int8_allow_float(self):
        return (
            not self.is_training_time_low_bit_allow_float()
            and self.any_optimization_enabled()
    ...
    def converter_flags(self, inference_ty=None, inference_input_ty=None):
        ...
        if self.is_integer_quantize():
            ...
            return {
                ...
                "enable_mlir_dynamic_range_quantizer": self._enable_new_dynamic_range_quantizer,
            }
            ...
            return {
                ...
                "accumulation_type": self._target_spec._experimental_supported_accumulation_type,  # pylint: disable=protected-access
        ...
        converter_kwargs.update(
            {
                ...
                "optimization_low_bit_qat": quant_mode.is_training_time_low_bit_allow_float(),
...
class TFLiteFrozenGraphConverterV2(TFLiteConverterBaseV2):
    ...
    def _convert_concrete_functions_to_saved_model(self, output_dir):
        ...
        if not self._trackable_obj or isinstance(
            self._trackable_obj, (_function.ConcreteFunction, _def_function.Function)
        ):
            return None, None, None
...
class TFLiteJaxConverterV2(TFLiteConverterBaseV2):
    ...
    def convert(self):
        ...
        if len(self._inputs) != len(self._serving_funcs):
            msg = "Input tensor mapping len {} does not match serving func len {}.".format(
                len(self._inputs), len(self._serving_funcs)
            )
