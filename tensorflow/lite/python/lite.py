...
from tensorflow.lite.python.convert import (
    build_conversion_flags as _build_conversion_flags,
)
...
from tensorflow.lite.python.util import (
    populate_conversion_metadata as _populate_conversion_metadata,
)
from tensorflow.lite.python.util import (
...
class TFLiteConverterBase:
    ...
    def _save_conversion_params_metric(
        ...
        self._metadata.options.forceSelectTfOps = set([OpsSet.SELECT_TF_OPS]) == set(
            self.target_spec.supported_ops
        )
    ...
    def _optimize_tflite_model(self, model, quant_mode, debug_options, quant_io=True):
