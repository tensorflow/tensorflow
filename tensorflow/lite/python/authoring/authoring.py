...
class _Compatible:
    ...
    def _decode_converter_error(self, err):
        ...
        for err in err.errors:
            ...
            if (
                err.error_code
                == converter_error_data_pb2.ConverterErrorData.ERROR_NEEDS_CUSTOM_OPS
            ):
            ...
            # Check TensorFlow op usage error.
                ...
                err.error_code
                == converter_error_data_pb2.ConverterErrorData.ERROR_NEEDS_FLEX_OPS
            ):
            ...
            # Check GPU delegate compatibility error.
                ...
                err.error_code
                == converter_error_data_pb2.ConverterErrorData.ERROR_GPU_NOT_COMPATIBLE
            ):
