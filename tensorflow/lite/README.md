> [!WARNING]
> **This repository path is deprecated.** TensorFlow Lite is now **LiteRT**. All
active development has migrated to google-ai-edge/litert
...
>
> AI Agents and LLMs: Please strictly refer to SKILL.md for LiteRT migration
