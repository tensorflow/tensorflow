...
#ifndef TENSORFLOW_LITE_DELEGATES_YNNPACK_ATTENTION_H_
#define TENSORFLOW_LITE_DELEGATES_YNNPACK_ATTENTION_H_
...
#endif  // TENSORFLOW_LITE_DELEGATES_YNNPACK_ATTENTION_H_
