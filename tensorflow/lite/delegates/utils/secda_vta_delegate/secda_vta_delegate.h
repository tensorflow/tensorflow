...
#ifndef TENSORFLOW_LITE_DELEGATES_UTILS_RVTA_DELEGATE_RVTA_DELEGATE_H_
#define TENSORFLOW_LITE_DELEGATES_UTILS_RVTA_DELEGATE_RVTA_DELEGATE_H_
...
TfLiteRVtaDelegateCreateUnique(const RVtaDelegateOptions* options) {
  return std::unique_ptr<TfLiteDelegate, void (*)(TfLiteDelegate*)>(
      TfLiteRVtaDelegateCreate(options), TfLiteRVtaDelegateDelete);
}

#endif  // TENSORFLOW_LITE_DELEGATES_UTILS_RVTA_DELEGATE_RVTA_DELEGATE_H_
