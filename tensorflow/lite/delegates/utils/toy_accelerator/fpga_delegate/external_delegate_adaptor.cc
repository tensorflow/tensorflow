...
#include "tensorflow/lite/delegates/utils/toy_accelerator/fpga_delegate/toy_delegate.h"
...
TfLiteDelegate* CreateToyDelegateFromOptions(char** options_keys,
  ...
  TFLITE_LOG(INFO) << "Toy delegate: allowed_builtin_code set to "
                   << options.allowed_builtin_code << ".";
  TFLITE_LOG(INFO) << "Toy delegate: error_during_init set to "
                   << options.error_during_init << ".";
  TFLITE_LOG(INFO) << "Toy delegate: error_during_prepare set to "
                   << options.error_during_prepare << ".";
  TFLITE_LOG(INFO) << "Toy delegate: error_during_invoke set to "
                   << options.error_during_invoke << ".";
