...
#include "tensorflow/lite/delegates/utils/toy_accelerator/fpga_delegate/util.h"
#include "tensorflow/lite/kernels/internal/quantization_util.h"
#include "tensorflow/lite/kernels/kernel_util.h"

#include "driver/add_driver.h"
 ...
 public:
  ...
  TfLiteStatus Eval(TfLiteContext* context, TfLiteNode* node) override {
    ...
    for (int i = 0; i < node_count; i++) {
      ...
      prf_end(0, toy_t.driver_time);
      dparams.layer++;
      dparams.delegated_nodes--;
    }

    if (dparams.delegated_nodes == 0) toy_t.print();
    return kTfLiteOk;
  }
...
class ToyDelegate : public SimpleDelegateInterface {
 public:
  ...
  bool IsNodeSupportedByDelegate(const TfLiteRegistration* registration,
    ...
    // Both input matrices need to of the same dimenions
    ...
    // Return true to add the node for delegation
    dparams.delegated_nodes++;
    return true;
  }
