...
void blocked_gemm_test_tflite(acc_container& drv, sysC_sigs* scs, int N,
  ...
  scs->sig_ra_sig.write(drv.ra);
  scs->sig_flipped.write(drv.flipped);
  scs->sig_start.write(++drv.vta_count);
