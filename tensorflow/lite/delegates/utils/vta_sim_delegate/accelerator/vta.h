...
SC_MODULE(ACCNAME) {
  ...
  AXI4M_bus_port<unsigned long long>
      insns;  // only 64 bits should be 128, 1 << VTA_LOG_INS_WIDTH
  ...
  // bus_T* wgt_mem1 = new bus_T[VTA_WGT_BUFF_DEPTH];
  // bus_T* wgt_mem2 = new bus_T[VTA_WGT_BUFF_DEPTH];
  // bus_T* wgt_mem3 = new bus_T[VTA_WGT_BUFF_DEPTH];
  // bus_T* wgt_mem4 = new bus_T[VTA_WGT_BUFF_DEPTH];
  // bus_T* wgt_mem5 = new bus_T[VTA_WGT_BUFF_DEPTH];
  // bus_T* wgt_mem6 = new bus_T[VTA_WGT_BUFF_DEPTH];
  // bus_T* wgt_mem7 = new bus_T[VTA_WGT_BUFF_DEPTH];
  // bus_T* wgt_mem8 = new bus_T[VTA_WGT_BUFF_DEPTH];

  // bus_T* wgt_mem9 = new bus_T[VTA_WGT_BUFF_DEPTH];
  // bus_T* wgt_mem10 = new bus_T[VTA_WGT_BUFF_DEPTH];
  // bus_T* wgt_mem11 = new bus_T[VTA_WGT_BUFF_DEPTH];
  // bus_T* wgt_mem12 = new bus_T[VTA_WGT_BUFF_DEPTH];
  // bus_T* wgt_mem13 = new bus_T[VTA_WGT_BUFF_DEPTH];
  // bus_T* wgt_mem14 = new bus_T[VTA_WGT_BUFF_DEPTH];
  // bus_T* wgt_mem15 = new bus_T[VTA_WGT_BUFF_DEPTH];
  // bus_T* wgt_mem16 = new bus_T[VTA_WGT_BUFF_DEPTH];

  // bus_T* wgt_mem17 = new bus_T[VTA_WGT_BUFF_DEPTH];
  // bus_T* wgt_mem18 = new bus_T[VTA_WGT_BUFF_DEPTH];
  // bus_T* wgt_mem19 = new bus_T[VTA_WGT_BUFF_DEPTH];
  // bus_T* wgt_mem20 = new bus_T[VTA_WGT_BUFF_DEPTH];
  // bus_T* wgt_mem21 = new bus_T[VTA_WGT_BUFF_DEPTH];
  // bus_T* wgt_mem22 = new bus_T[VTA_WGT_BUFF_DEPTH];
  // bus_T* wgt_mem23 = new bus_T[VTA_WGT_BUFF_DEPTH];
  // bus_T* wgt_mem24 = new bus_T[VTA_WGT_BUFF_DEPTH];

  // bus_T* wgt_mem25 = new bus_T[VTA_WGT_BUFF_DEPTH];
  // bus_T* wgt_mem26 = new bus_T[VTA_WGT_BUFF_DEPTH];
  // bus_T* wgt_mem27 = new bus_T[VTA_WGT_BUFF_DEPTH];
  // bus_T* wgt_mem28 = new bus_T[VTA_WGT_BUFF_DEPTH];
  // bus_T* wgt_mem29 = new bus_T[VTA_WGT_BUFF_DEPTH];
  // bus_T* wgt_mem30 = new bus_T[VTA_WGT_BUFF_DEPTH];
  // bus_T* wgt_mem31 = new bus_T[VTA_WGT_BUFF_DEPTH];
  // bus_T* wgt_mem32 = new bus_T[VTA_WGT_BUFF_DEPTH];
  ...
  std::vector<Metric*> profiling_vars = {per_batch_cycles, fetch_cycles,
                                         load_cycles,      compute_cycles,
                                         store_cycles,     instructions_count};
  ...
  void gemm(insn_T insn_raw, uop_T*, bus_T*, bus_T*, bus_T*, bus_T*);

  void ppu(insn_T, bool, bus_T*, crf_type*, crx_type*, bus_T*);

  void alu(insn_T insn_raw, uop_T*, bus_T*, bus_T*, bus_T*, bus_T*);
  ...
  void load_pad_2d(AXI4M_bus_port<unsigned long long>&, sc_in<unsigned int>&,
                   DATA_T*, memop_sram_T, memop_dram_T, memop_size_T,
                   memop_size_T, memop_stride_T, memop_pad_T, memop_pad_T,
                   memop_sram_T, memop_sram_T);

  template <typename DATA_T, int MAT_AXI_RATIO, int ELEM_BYTES>
  void load_2d(AXI4M_bus_port<unsigned long long>&, sc_in<unsigned int>&,
               DATA_T*, memop_sram_T, memop_dram_T, memop_size_T, memop_size_T,
               memop_stride_T);

  template <typename DATA_T, int MAT_AXI_RATIO, int ELEM_BYTES>
  void load_1ds(AXI4M_bus_port<unsigned long long>&, sc_in<unsigned int>&,
                DATA_T*, memop_sram_T, memop_dram_T, memop_size_T, memop_size_T,
                memop_stride_T);

  template <typename WIDE_T, typename NARROW_T, typename IDX_T, int WIDE_W,
            int NARROW_W, int Y_DIM, int X_DIM>
  void read_tensor(IDX_T, WIDE_T*, NARROW_T[Y_DIM][X_DIM]);

  template <typename WIDE_T, typename NARROW_T, typename IDX_T, int WIDE_W,
            int NARROW_W, int Y_DIM, int X_DIM>
  void write_tensor(IDX_T, NARROW_T[Y_DIM][X_DIM], WIDE_T*);
