...
// void blocked_gemm_test_tflitev3(systemC_sigs* scs, int batch, int in_channels,
//                                int out_channels, int block,
//                                bool uop_compression, int virtual_threads,
//                                uint32_t* inputs, uint32_t* weights,
//                                uint32_t* biases, uint32_t* outputs,
//                                uint32_t* crf, uint32_t* crx, bool save,
//                                int ra) {
//   // Some assertions
...
//       "=============\n");
//   printf(
//       "INFO - Blocked GEMM test: batch=%d, in_channels=%d, out_channels=%d, "
//       "uop_comp=%d\n",
...
//   int uop_size = uop_compression
//                      ? batch / VTA_BATCH
//                      : batch / VTA_BATCH * in_channels / VTA_BLOCK_IN *
...
//                                             0, uop_size, 0, 0, 0, 0);
//   // Load bias (Compute())
//   insn_buf[insn_idx++] = get1DLoadStoreInsn(VTA_OPCODE_LOAD,  // opcode
//                                             VTA_MEM_ID_ACC,   // type
//                                             0,                // sram offset
//                                             0,                // dram offset
//                                             out_size,         // size
...
//                                             1,                // push prev dep
//                                             0);               // push next dep
//   // Load weight block (pop next) (Load())
//   insn_buf[insn_idx++] = get1DLoadStoreInsn(VTA_OPCODE_LOAD,  // opcode
//                                             VTA_MEM_ID_WGT,   // type
//                                             0,                // sram offset
//                                             0,                // dram offset
...
//                                             0,                // push prev dep
//                                             0);               // push next dep
//   // Load input block (push next) (Load())
//   insn_buf[insn_idx++] = get1DLoadStoreInsn(VTA_OPCODE_LOAD,  // opcode
//                                             VTA_MEM_ID_INP,   // type
//                                             0,                // sram offset
//                                             0,                // dram offset
...
//                   0,                             // push prev dep
//                   1);                            // push_next_dep
//   // Store output block (pop prev, push prev if not last) (Store())
//   insn_buf[insn_idx++] = get1DLoadStoreInsn(VTA_OPCODE_STORE,  // opcode
//                                             VTA_MEM_ID_OUT,    // type
//                                             0,                 // sram offset
//                                             0,                 // dram offset
//                                             out_size,          // size
...
//   // Prepare the uop buffer
//   VTAUop* uop_buf =
//       getGEMMUops(batch / VTA_BATCH, in_channels / VTA_BLOCK_IN,
//                   out_channels / VTA_BLOCK_OUT, uop_compression, 0);
