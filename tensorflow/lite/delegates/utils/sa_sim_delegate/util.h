#ifndef TENSORFLOW_LITE_DELEGATES_UTILS_SA_SIM_DELEGATE_SA_SIM_DELEGATE_UTIL_H_
#define TENSORFLOW_LITE_DELEGATES_UTILS_SA_SIM_DELEGATE_SA_SIM_DELEGATE_UTIL_H_
...
// This file mostly contains generic tflite code to prepare CONV2D tensors / IM2COL
