...
FpgaIpDriver::FpgaIpDriver() : dev_mem_fd(-1), mapped_fpga_ip(nullptr), size(4096) {
    // Initialize member variables
    ip_base_address = 0x80000000;
    ip_input_1_offset = 0x18;
    ip_input_2_offset = 0x20;
    ip_output_offset = 0x10;
    ip_add_flag_offset = 0x28;
...
int32_t FpgaIpDriver::fpga_compute(int32_t input_1, int32_t input_2, bool add_flag) {
