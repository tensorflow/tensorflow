...
TfLiteStatus DelegatePrepare(TfLiteContext* context, TfLiteDelegate* delegate) {
  const TfLiteRegistration kRegistration = {
      ...
      [](TfLiteContext* context, const char* buffer, size_t) -> void* {
        ...
        context->ReportError(context, "TfLiteGpuDelegate Prepare: %s", status.error_message().c_str());
        return nullptr;
      },
      // .free
      ...
      [](TfLiteContext* context, TfLiteNode* node) -> TfLiteStatus {
        ...
        context->ReportError(context, "TfLiteMetalDelegate Invoke: %s", status.error_message().c_str());
        return kTfLiteError;
      },
