...
struct ProgramBuilder {
  ...
  explicit ProgramBuilder(flatbuffers::FlatBufferBuilder &_fbb) : fbb_(_fbb) {
...
inline flatbuffers::Offset<Program> CreateProgramDirect(
  ...
  return tflite::gpu::cl::data::CreateProgram(_fbb, fingerprint, binary__);
}
...
struct CompiledCache FLATBUFFERS_FINAL_CLASS : private flatbuffers::Table {
  ...
  const flatbuffers::Vector<flatbuffers::Offset<Program>> *programs() const {
    return GetPointer<
        const flatbuffers::Vector<flatbuffers::Offset<Program>> *>(VT_PROGRAMS);
  }
  bool Verify(flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           verifier.VerifyVectorOfTables(programs()) && verifier.EndTable();
  }
};
...
struct CompiledCacheBuilder {
  ...
  void add_programs(
      flatbuffers::Offset<flatbuffers::Vector<flatbuffers::Offset<Program>>>
          programs) {
...
inline flatbuffers::Offset<CompiledCache> CreateCompiledCacheDirect(
  ...
  auto programs__ =
      programs ? _fbb.CreateVector<flatbuffers::Offset<Program>>(*programs) : 0;
  return tflite::gpu::cl::data::CreateCompiledCache(_fbb, driver_version__,
                                                    programs__);
}

inline const tflite::gpu::cl::data::CompiledCache *GetCompiledCache(
    const void *buf) {
  return flatbuffers::GetRoot<tflite::gpu::cl::data::CompiledCache>(buf);
}

inline const tflite::gpu::cl::data::CompiledCache *GetSizePrefixedCompiledCache(
    const void *buf) {
  return flatbuffers::GetSizePrefixedRoot<tflite::gpu::cl::data::CompiledCache>(
      buf);
}

inline const char *CompiledCacheIdentifier() { return "AFCM"; }

inline bool CompiledCacheBufferHasIdentifier(const void *buf) {
  return flatbuffers::BufferHasIdentifier(buf, CompiledCacheIdentifier());
}

inline bool VerifyCompiledCacheBuffer(flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<tflite::gpu::cl::data::CompiledCache>(
      CompiledCacheIdentifier());
}

inline bool VerifySizePrefixedCompiledCacheBuffer(
    flatbuffers::Verifier &verifier) {
  return verifier
      .VerifySizePrefixedBuffer<tflite::gpu::cl::data::CompiledCache>(
          CompiledCacheIdentifier());
}

inline const char *CompiledCacheExtension() { return "jetbin"; }
