...
enum BuiltinOperator : int32_t {
  ...
  BuiltinOperator_AVERAGE_POOL_3D = 159,
  BuiltinOperator_MAX_POOL_3D = 160,
...
enum BuiltinOptions : uint8_t {
  ...
  BuiltinOptions_Pool3DOptions = 124,
...
struct Pool3DOptionsBuilder {
  ...
  Pool3DOptionsBuilder &operator=(const Pool3DOptionsBuilder &);
