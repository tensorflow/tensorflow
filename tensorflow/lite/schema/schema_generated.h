...
enum BuiltinOperator {
  ...
  BuiltinOperator_RECIPROCAL = 118,
  BuiltinOperator_MIN = BuiltinOperator_ADD,
  BuiltinOperator_MAX = BuiltinOperator_RECIPROCAL
};

inline const BuiltinOperator (&EnumValuesBuiltinOperator())[118] {
