...
enum BuiltinOperator : int32_t {
  ...
  BuiltinOperator_AVERAGE_POOL_3D = 162,
  BuiltinOperator_MAX_POOL_3D = 163,
  BuiltinOperator_MIN = BuiltinOperator_ADD,
  BuiltinOperator_MAX = BuiltinOperator_MAX_POOL_3D
};

inline const BuiltinOperator (&EnumValuesBuiltinOperator())[164] {
...
inline const char * const *EnumNamesBuiltinOperator() {
  static const char * const names[165] = {
    "ADD",
    "AVERAGE_POOL_2D",
    "CONCATENATION",
    "CONV_2D",
...
enum BuiltinOptions : uint8_t {
  ...
  BuiltinOptions_Pool3DOptions = 127,
...
template<> struct BuiltinOptionsUnionTraits<tflite::Pool3DOptionsT> {
  static const BuiltinOptions enum_value = BuiltinOptions_Pool3DOptions;
};
...
struct Pool3DOptions FLATBUFFERS_FINAL_CLASS : private ::flatbuffers::Table {
  ...
  typedef Pool3DOptionsBuilder Builder;
  enum FlatBuffersVTableOffset FLATBUFFERS_VTABLE_UNDERLYING_TYPE {
    VT_PADDING = 4,
    VT_STRIDE_D = 6,
    VT_STRIDE_W = 8,
  ...
  bool Verify(::flatbuffers::Verifier &verifier) const {
    return VerifyTableStart(verifier) &&
           ...
           VerifyField<int32_t>(verifier, VT_STRIDE_W, 4) &&
           VerifyField<int32_t>(verifier, VT_STRIDE_H, 4) &&
           VerifyField<int32_t>(verifier, VT_FILTER_DEPTH, 4) &&
           VerifyField<int32_t>(verifier, VT_FILTER_WIDTH, 4) &&
           VerifyField<int32_t>(verifier, VT_FILTER_HEIGHT, 4) &&
           VerifyField<int8_t>(verifier, VT_FUSED_ACTIVATION_FUNCTION, 1) &&
           verifier.EndTable();
