page_type: reference
description: Writes metadata into the Bert NL classifier.
...
<meta itemprop="name" content="tflite_support.metadata_writers.bert_nl_classifier.MetadataWriter" />
...
<td>
  <a target="_blank" href="https://github.com/tensorflow/tflite-support/blob/v0.4.4/tensorflow_lite_support/metadata/python/metadata_writers/bert_nl_classifier.py#L35-L150">
...
<code>tflite_support.metadata_writers.bert_nl_classifier.MetadataWriter(
...
<a target="_blank" class="external" href="https://github.com/tensorflow/tflite-support/blob/v0.4.4/tensorflow_lite_support/metadata/python/metadata_writers/bert_nl_classifier.py#L86-L150">View source</a>
...
`ids_name`, `mask_name`, and `segment_name` correspond to the <a href="https://www.tensorflow.org/api_docs/python/tf/Tensor#name"><code>Tensor.name</code></a>
...
<a target="_blank" class="external" href="https://github.com/tensorflow/tflite-support/blob/v0.4.4/tensorflow_lite_support/metadata/python/metadata_writers/bert_nl_classifier.py#L38-L84">View source</a>
...
<td>
input tensor information. If not specified, default input
