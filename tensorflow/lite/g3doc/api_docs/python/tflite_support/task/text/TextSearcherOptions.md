page_type: reference
description: Options for the text search task.
...
<meta itemprop="name" content="tflite_support.task.text.TextSearcherOptions" />
...
<td>
  <a target="_blank" href="https://github.com/tensorflow/tflite-support/blob/v0.4.4/tensorflow_lite_support/python/task/text/text_searcher.py#L31-L47">
...
<code>tflite_support.task.text.TextSearcherOptions(
...
<td>
Base options for the text searcher task.
</td>
</tr><tr>
<td>
...
<td>
Embedding options for the text searcher task.
</td>
</tr><tr>
<td>
...
<td>
Search options for the text searcher task.
</td>
</tr>
</table>
