page_type: reference
description: Represents a categorical slot whose values are within a finite set.
...
<meta itemprop="name" content="tflite_support.task.processor.CategoricalSlot" />
...
<code>tflite_support.task.processor.CategoricalSlot(
    slot: str,
    prediction: <a href="../../../tflite_support/task/processor/Category"><code>tflite_support.task.processor.Category</code></a>
)
</code></pre>
