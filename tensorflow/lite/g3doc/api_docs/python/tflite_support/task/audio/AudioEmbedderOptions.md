page_type: reference
description: Options for the audio embedder task.
...
<meta itemprop="name" content="tflite_support.task.audio.AudioEmbedderOptions" />
...
<td>
  <a target="_blank" href="https://github.com/tensorflow/tflite-support/blob/v0.4.4/tensorflow_lite_support/python/task/audio/audio_embedder.py#L33-L44">
...
<code>tflite_support.task.audio.AudioEmbedderOptions(
...
<td>
Embedding options for the audio embedder task.
</td>
</tr>
</table>
