...
struct NnApiSupportLibrary {
  ...
  int64_t getFeatureLevel() const { return impl.fl5.base.implFeatureLevel; }

  // Changed when importing from AOSP
  // TFLite cannot use C++17 and std::variant yet, switching to plain union
  // const NnApiSLDriverImplFL5* getFL5() const {
  //   return std::visit(
  //       [](auto&& impl) {
  //         return reinterpret_cast<const NnApiSLDriverImplFL5*>(&impl);
  //       },
  //       impl);
  // }
  ...
  //   return std::visit(
  //       [](auto&& impl) {
  //         return reinterpret_cast<const NnApiSLDriverImplFL6*>(&impl);
  //       },
  //       impl);
  // }
  ...
  //   return std::visit(
  //       [](auto&& impl) {
  //         return reinterpret_cast<const NnApiSLDriverImplFL7*>(&impl);
  //       },
  //       impl);
  // }

  const NnApiSLDriverImplFL5* getFL5() const { return &impl.fl5; }
  ...
  // Changed when importing from AOSP
  // TFLite cannot use C++17 and std::variant yet, switching to plain union
  // NnApiSLDriverImplFL[6-7] is a typedef of FL5, can't be explicitly
  // specified.
  // std::variant<
  //    NnApiSLDriverImplFL5 /*, NnApiSLDriverImplFL6, NnApiSLDriverImplFL7*/>
  //    impl;
  union {
    NnApiSLDriverImplFL5 fl5;
    NnApiSLDriverImplFL6 fl6;
    NnApiSLDriverImplFL7 fl7;
  } impl;
};
