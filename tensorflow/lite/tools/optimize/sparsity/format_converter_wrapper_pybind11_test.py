...
from tensorflow.lite.tools.optimize.sparsity import (
    format_converter_wrapper_pybind11 as format_converter,
)
...
class FormatConverterTest(absltest.TestCase):
    def test_bcsr_fp32(self):
        ...
        block_size = [2, 2]
        block_map = [0, 1]
        converter = format_converter.FormatConverterFp32(
            dense_shape, traversal_order, dim_types, block_size, block_map
        )
