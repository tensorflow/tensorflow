  ...
  static const std::map<std::pair<BuiltinOperator, int>,
      ...
      new std::map<std::pair<BuiltinOperator, int>, std::string>(
          {{{BuiltinOperator_AVERAGE_POOL_2D, 1}, "1.5.0"},
           ...
           {{BuiltinOperator_CONV_2D, 7}, "2.12.0"},
           {{BuiltinOperator_CONV_2D, 8}, "2.12.0"},
           ...
           {{BuiltinOperator_FULLY_CONNECTED, 10}, "2.12.0"},
           {{BuiltinOperator_FULLY_CONNECTED, 11}, "2.12.0"},
           ...
           {{BuiltinOperator_TRANSPOSE_CONV, 5}, "2.13.0"},
