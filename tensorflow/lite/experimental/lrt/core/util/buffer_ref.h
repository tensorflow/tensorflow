...
#ifndef TENSORFLOW_LITE_EXPERIMENTAL_LRT_CORE_UTIL_BUFFER_REF_H_
#define TENSORFLOW_LITE_EXPERIMENTAL_LRT_CORE_UTIL_BUFFER_REF_H_
...
#endif  // TENSORFLOW_LITE_EXPERIMENTAL_LRT_CORE_UTIL_BUFFER_REF_H_
