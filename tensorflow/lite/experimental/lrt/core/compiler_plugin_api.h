...
typedef LrtStatus (*LrtPluginApiGetSupportedSocModelId)(
    LrtCompilerPlugin, lrt_param_index_t config_idx, const char** config_id);
...
struct LrtPluginApi {
  ...
  LrtPluginApiGetSupportedSocModelId get_supported_soc_model_id = nullptr;
