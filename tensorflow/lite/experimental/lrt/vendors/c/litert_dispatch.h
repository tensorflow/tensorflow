...
#ifndef TENSORFLOW_LITE_EXPERIMENTAL_LRT_VENDORS_C_LITERT_DISPATCH_H_
#define TENSORFLOW_LITE_EXPERIMENTAL_LRT_VENDORS_C_LITERT_DISPATCH_H_
...
#endif  // TENSORFLOW_LITE_EXPERIMENTAL_LRT_VENDORS_C_LITERT_DISPATCH_H_
