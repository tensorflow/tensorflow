...
absl::StatusOr<std::unique_ptr<LrtDispatchDeviceContextT>>
LrtDispatchDeviceContextT::Create(const lrt::pixel::Southbound& southbound) {
  std::unique_ptr<LrtDispatchDeviceContextT> device_context(
      new LrtDispatchDeviceContextT(southbound));
