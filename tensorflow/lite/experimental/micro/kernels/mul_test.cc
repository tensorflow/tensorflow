...
TF_LITE_MICRO_TEST(Int8NoActivation) {
  ...
  tflite::testing::TestMulQuantized(
      {4, 1, 2, 2, 1},  // input1 dims
      {
          F2QS(-0.8, input_min, input_max), F2QS(0.2, input_min, input_max),
          F2QS(0.9, input_min, input_max), F2QS(0.7, input_min, input_max),
      },                // input1 data
      {4, 1, 2, 2, 1},  // input2 dims
      {
          F2QS(0.6, input_min, input_max), F2QS(0.4, input_min, input_max),
          F2QS(0.9, input_min, input_max), F2QS(0.8, input_min, input_max),
      },  // input2 data
      input_min,
      input_max, {4, 1, 2, 2, 1},  // output dims
      output_min, output_max,
      {
...
TF_LITE_MICRO_TEST(Int8NoActivationLargeMultiplier) {
  ...
  tflite::testing::TestMulQuantized(
      {4, 1, 2, 2, 1},
      {
          F2QS(-4, input_min, input_max), F2QS(2, input_min, input_max),
          F2QS(3, input_min, input_max), F2QS(1, input_min, input_max),
      },
      {4, 1, 2, 2, 1},
      {
      ...
      {
          F2QS(4, output_min, output_max), F2QS(-6, output_min, output_max),
          F2QS(12, output_min, output_max), F2QS(2, output_min, output_max),
      },
...
TF_LITE_MICRO_TEST(Int8NoActivationBroadcast) {
  ...
  tflite::testing::TestMulQuantized(
      ...
      {
          F2QS(-2.0, input_min, input_max), F2QS(0.2, input_min, input_max),
          F2QS(0.7, input_min, input_max), F2QS(0.8, input_min, input_max),
          F2QS(1.1, input_min, input_max), F2QS(2.0, input_min, input_max),
      },       // input1 data
      {1, 1},  // input2 shape
      {
      ...
      input_min,
      input_max, {4, 1, 3, 1, 2},  // output shape
      output_min, output_max,
      {
          ...
          F2QS(0.08, output_min, output_max),
          F2QS(0.11, output_min, output_max), F2QS(0.2, output_min, output_max),
      },  // expected output data
      output_data,
      kTfLiteActNone, 1);
}
...
TF_LITE_MICRO_TEST(UInt8NoActivation) {
  ...
  tflite::testing::TestMulQuantized(
      {4, 1, 2, 2, 1},  // input1 dims
      {
          F2Q(-0.8, input_min, input_max), F2Q(0.2, input_min, input_max),
          F2Q(0.9, input_min, input_max), F2Q(0.7, input_min, input_max),
      },                // input1 data
      {4, 1, 2, 2, 1},  // input2 dims
      {
          F2Q(0.6, input_min, input_max), F2Q(0.4, input_min, input_max),
          F2Q(0.9, input_min, input_max), F2Q(0.8, input_min, input_max),
      },  // input2 data
      input_min,
      input_max, {4, 1, 2, 2, 1},  // output dims
      output_min, output_max,
      {
          F2Q(-0.48, output_min, output_max), F2Q(0.08, output_min, output_max),
          F2Q(0.81, output_min, output_max), F2Q(0.56, output_min, output_max),
      },  // expected output data
      output_data,
      kTfLiteActNone, 1);
}
...
TF_LITE_MICRO_TEST(UInt8NoActivationLargeMultiplier) {
  ...
  tflite::testing::TestMulQuantized(
      {4, 1, 2, 2, 1},
      {
          F2Q(-4, input_min, input_max), F2Q(2, input_min, input_max),
          F2Q(3, input_min, input_max), F2Q(1, input_min, input_max),
      },
      {4, 1, 2, 2, 1},
      {
          F2Q(-1, input_min, input_max), F2Q(-3, input_min, input_max),
          F2Q(4, input_min, input_max), F2Q(2, input_min, input_max),
      },
      input_min, input_max, {4, 1, 2, 2, 1}, output_min, output_max,
      {
          F2Q(4, output_min, output_max), F2Q(-6, output_min, output_max),
          F2Q(12, output_min, output_max), F2Q(2, output_min, output_max),
      },
      // In Tensorflow Lite, this test have a max allowed error of 1.4f.
      // A difference of 1.4 in floating points corresponds to 18 quantized
      // for the output min/max [-10, 10].
...
TF_LITE_MICRO_TEST(UInt8NoActivationBroadcast) {
  ...
  tflite::testing::TestMulQuantized(
      {4, 1, 3, 1, 2},  // input1 shape
      {
          F2Q(-2.0, input_min, input_max), F2Q(0.2, input_min, input_max),
          F2Q(0.7, input_min, input_max), F2Q(0.8, input_min, input_max),
          F2Q(1.1, input_min, input_max), F2Q(2.0, input_min, input_max),
      },       // input1 data
      {1, 1},  // input2 shape
      {
      ...
      output_min, output_max,
      {
          F2Q(-0.2, output_min, output_max), F2Q(0.02, output_min, output_max),
          F2Q(0.07, output_min, output_max), F2Q(0.08, output_min, output_max),
          F2Q(0.11, output_min, output_max), F2Q(0.2, output_min, output_max),
      },  // expected output data
      output_data,
      kTfLiteActNone, 1);
}
