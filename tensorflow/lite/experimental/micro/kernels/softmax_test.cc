...
void TestSoftmaxQuantizedSigned(std::initializer_list<int> input_dims_data,
...
TF_LITE_MICRO_TEST(SimpleTestQuantizedSigned) {
  ...
  tflite::testing::TestSoftmaxQuantizedSigned(  //
      ...
      input_min, input_max,  // Input quantized range.
      {
          // Expected results.
          // b = 0
          F2QS(0.000006933, output_min, output_max), F2QS(0.017986099, output_min, output_max),
          F2QS(0.000000110, output_min, output_max), F2QS(0.982007754, output_min, output_max),
          F2QS(0.000000002, output_min, output_max),
          // b = 1
          F2QS(0.011656231, output_min, output_max), F2QS(0.031684921, output_min, output_max),
          F2QS(0.086128544, output_min, output_max), F2QS(0.234121657, output_min, output_max),
