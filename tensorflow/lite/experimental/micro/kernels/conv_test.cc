...
TF_LITE_MICRO_TEST(SimpleTestQuantized) {
  ...
  tflite::testing::TestConvQuantized(
      {4, 2, 2, 4, 1},
      {
          F2Q(1, input_min, input_max), F2Q(1, input_min, input_max),
          F2Q(1, input_min, input_max), F2Q(1, input_min, input_max),
          F2Q(2, input_min, input_max), F2Q(2, input_min, input_max),
          F2Q(2, input_min, input_max), F2Q(2, input_min, input_max),
      ...
      {
          F2Q(1, filter_min, filter_max), F2Q(2, filter_min, filter_max),
          F2Q(3, filter_min, filter_max), F2Q(4, filter_min, filter_max),
      ...
      {
          F2Q(18, output_min, output_max), F2Q(2, output_min, output_max),
          F2Q(5, output_min, output_max), F2Q(18, output_min, output_max),
          F2Q(2, output_min, output_max), F2Q(5, output_min, output_max),
          F2Q(17, output_min, output_max), F2Q(4, output_min, output_max),
          F2Q(3, output_min, output_max), F2Q(37, output_min, output_max),
          F2Q(4, output_min, output_max), F2Q(3, output_min, output_max),
      },
      output_min, output_max, kTfLiteActNone, output_data);
}
