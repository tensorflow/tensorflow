...
extern void DebugMonitor_ISR(void)        __attribute__((weak, alias("default_DebugMonitor_ISR")));
...
extern void SYSTICK_ISR(void)     __attribute__((weak, alias("default_SYSTICK_ISR")));
...
extern void RTC_TMR_ISR(void)       __attribute__((weak, alias("default_RTC_TMR_ISR")));
...
extern void IntDefaultHandler(void) __attribute__((weak)) NAKED;
