...
int _main(void)
{
    ...
    EtaCspUartInit(&g_sUart1, eUartNum0, eUartBaud115200, eUartFlowControlHardware); //initialize Uart
    EtaCspBuckInit(ETA_BSP_VDD_IO_SETTING, eBuckAo600Mv, eBuckM3Frequency60Mhz, eBuckMemVoltage900Mv);//set M3 freq
