/*
 * Test the use of the ExamplePlugin. Test that the value 0 and 1 can be sent
 * in both directions between the ports.
 *
 * NOTE: The src/plugins/ExamplePlugin must have been compiled for this to run without error.
 *
 */
#include <xs1.h>
#include <print.h>
