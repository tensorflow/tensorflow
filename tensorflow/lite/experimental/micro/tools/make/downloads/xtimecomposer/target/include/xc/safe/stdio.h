#ifndef _xc_safe_stdio_h_
#define _xc_safe_stdio_h_
...
size_t _safe_fread(char /* void */ ptr[size], size_t size, size_t n, FILE * fp);
size_t _safe_fwrite(const char /* void */ ptr[size], size_t size, size_t n, FILE * fp);
