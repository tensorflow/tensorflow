...
TEST(ExpectedTest, PrintingWorks) {
  EXPECT_THAT(testing::PrintToString(Expected<int>(3)), StrEq("3"));

  EXPECT_THAT(testing::PrintToString(Expected<void>()),
              StrEq("void expected value"));

  EXPECT_THAT(testing::PrintToString(Unexpected(kLiteRtStatusErrorNotFound)),
  ...
  EXPECT_THAT(testing::PrintToString(Error(kLiteRtStatusErrorNotFound)),
              StrEq("kLiteRtStatusErrorNotFound"));

  EXPECT_THAT(testing::PrintToString(
                  Error(kLiteRtStatusErrorNotFound, "Error not found message")),
              StrEq("kLiteRtStatusErrorNotFound: Error not found message"));

  struct UnknownStruct {};
  EXPECT_THAT(testing::PrintToString(Expected<UnknownStruct>({})),
