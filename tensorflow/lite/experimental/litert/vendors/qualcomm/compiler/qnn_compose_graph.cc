...
LiteRtStatus ConvertTensor(const litert::Tensor& litert_tensor,
  ...
  LITERT_RETURN_STATUS_IF_NOT_OK(
      ConvertDataType(ranked_tensor_type->ElementType(),
                      litert_tensor.HasQuantization(), qnn_data_type));
...
LiteRtStatus ConvertOp(
  ...
  switch (litert_op.Code()) {
    ...
    case LiteRtOpCode::kLiteRtOpCodeTflAdd: {
      ...
      LITERT_RETURN_STATUS_IF_NOT_OK(LiteRtGetAddFusedActivationOption(
    ...
    case LiteRtOpCode::kLiteRtOpCodeTflDiv: {
      uint32_t fused_activation{};
      LITERT_RETURN_STATUS_IF_NOT_OK(LiteRtGetDivFusedActivationOption(
          litert_op.Get(), &fused_activation));
    ...
    case LiteRtOpCode::kLiteRtOpCodeTflMul: {
      uint32_t fused_activation{};
      LITERT_RETURN_STATUS_IF_NOT_OK(LiteRtGetMulFusedActivationOption(
          litert_op.Get(), &fused_activation));
    ...
    case LiteRtOpCode::kLiteRtOpCodeTflSub: {
      uint32_t fused_activation{};
      LITERT_RETURN_STATUS_IF_NOT_OK(LiteRtGetSubFusedActivationOption(
          litert_op.Get(), &fused_activation));
    ...
    case LiteRtOpCode::kLiteRtOpCodeTflFullyConnected: {
      uint32_t fused_activation{};
      LITERT_RETURN_STATUS_IF_NOT_OK(
          LiteRtGetFullyConnectedFusedActivationOption(litert_op.Get(),
                                                       &fused_activation));
      bool keep_num_dims{};
      LITERT_RETURN_STATUS_IF_NOT_OK(LiteRtGetFullyConnectedKeepNumDimsOption(
