...
class QnnManager {
 ...
 public:
  ...
  std::optional<std::vector<QnnDevice_CustomConfig_t>>
 ...
 private:
  ...
  std::unique_ptr<::qnn::HtpDevicePlatformInfoConfig>
      htp_device_platform_info_config_;
  std::unique_ptr<::qnn::HtpDeviceCustomConfig> htp_device_custom_config_;
