...
class BenchmarkLiteRtModel : public BenchmarkModel {
 public:
  ...
  TfLiteStatus Init() override {
    ...
    auto use_gpu = params_.Get<bool>("use_gpu");
    litert::CompilationOptions compilation_options =
    ...
    auto singature = params_.Get<std::string>("signature_to_run_for");
    auto input_buffers_result = compiled_model_->CreateInputBuffers(singature);
    ...
    auto output_buffers_result =
        compiled_model_->CreateOutputBuffers(singature);
  ...
  TfLiteStatus RunImpl() override {
    ...
    auto singature = params_.Get<std::string>("signature_to_run_for");
    if (compiled_model_->Run(singature, *input_buffers_, *output_buffers_)) {
      return kTfLiteOk;
    } else {
