...
Violations of the Code of Conduct can be reported to TensorFlow’s Project Stewards, Sarah Novotny (sarahnovotny@google.com) or Edd Wilder-James (ewj@google.com). The Project Steward will determine whether the Code of Conduct was violated, and will issue an appropriate sanction, possibly including a written warning or expulsion from the project, project sponsored spaces, or project forums. We ask that you make a good-faith effort to resolve your conflict via the conflict resolution policy before submitting a report.
