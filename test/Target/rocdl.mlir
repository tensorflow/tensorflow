...
func @rocdl_special_regs() -> !llvm.i32 {
  ...
  // CHECK: call i32 @__ockl_get_local_size(i32 0)
  %7 = rocdl.workgroup.dim.x : !llvm.i32
  // CHECK: call i32 @__ockl_get_local_size(i32 1)
  %8 = rocdl.workgroup.dim.y : !llvm.i32
  // CHECK: call i32 @__ockl_get_local_size(i32 2)
  %9 = rocdl.workgroup.dim.z : !llvm.i32
  // CHECK: call i32 @__ockl_get_global_size(i32 0)
  %10 = rocdl.grid.dim.x : !llvm.i32
  // CHECK: call i32 @__ockl_get_global_size(i32 1)
  %11 = rocdl.grid.dim.y : !llvm.i32
  // CHECK: call i32 @__ockl_get_global_size(i32 2)
