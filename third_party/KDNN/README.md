...
KDNN v3.2.0 is provided as a Bazel external repository. The default build
...
The default archive is hosted on the BoostKit SRA public OBS mirror.

For an installed package use `KDNN_ROOT=/usr/local/kdnn`. For an offline build
use `KDNN_ARCHIVE=/path/to/BoostKit-boostcore-kdnn_3.2.0.zip`.
