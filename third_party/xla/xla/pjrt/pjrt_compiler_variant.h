...
// In OSS, only the default linked variant is defined. Custom implementations
// may define additional variants by casting integer values to this enum type
// as needed. For example:
//
//   constexpr CompilerVariant kMyVariant = static_cast<CompilerVariant>(1);
//
// Note: Conflicting values must be avoided.
