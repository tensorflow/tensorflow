...
class PjRtStreamExecutorBuffer : public PjRtBuffer {
 public:
  ...
  //
  // When called with wait_for_operations_to_complete=false, this function will
  // use a stream to drop the reference to the buffer after all events related
  // to this buffer are completed, except for the events that already holds a
