...
class PjRtStreamExecutorBuffer : public AbstractLocalPjRtBuffer {
 public:
  class ScopedHold : public AbstractLocalPjRtBuffer::ScopedHold {
   public:
    ...
    TrackedDeviceBuffer* buffer() const {
      return static_cast<TrackedDeviceBuffer*>(
          AbstractLocalPjRtBuffer::ScopedHold::buffer());
    }
    ...
    PjRtStreamExecutorBuffer* parent() const {
      return static_cast<PjRtStreamExecutorBuffer*>(
          AbstractLocalPjRtBuffer::ScopedHold::parent());
    }

   private:
    using AbstractLocalPjRtBuffer::ScopedHold::ScopedHold;
    friend class PjRtStreamExecutorBuffer;
 ...
 private:
  ...
  TrackedDeviceBuffer* device_buffer() const
    ...
    return static_cast<TrackedDeviceBuffer*>(
        AbstractLocalPjRtBuffer::device_buffer());
  }
