...
#ifndef XLA_PJRT_INTERPRETER_INTERPRETER_PJRT_COMPILER_H_
#define XLA_PJRT_INTERPRETER_INTERPRETER_PJRT_COMPILER_H_
...
class InterpreterPjRtCompiler : public PjRtCompiler {
 public:
...
#endif  // XLA_PJRT_INTERPRETER_INTERPRETER_PJRT_COMPILER_H_
