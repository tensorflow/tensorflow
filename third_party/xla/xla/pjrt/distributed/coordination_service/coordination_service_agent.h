...
#ifndef XLA_PJRT_DISTRIBUTED_COORDINATION_SERVICE_COORDINATION_SERVICE_AGENT_H_
#define XLA_PJRT_DISTRIBUTED_COORDINATION_SERVICE_COORDINATION_SERVICE_AGENT_H_
...
class CoordinationServiceAgent {
 public:
  ...
  // # An Example
  //
  // Imagine we have four tasks: A, B, C, and D. Further imagine that task D has
  // failed and that every task calls GetAliveTasks([A, B, C, D]). The
...
#endif  // XLA_PJRT_DISTRIBUTED_COORDINATION_SERVICE_COORDINATION_SERVICE_AGENT_H_
