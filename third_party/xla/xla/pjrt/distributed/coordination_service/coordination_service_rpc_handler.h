...
#ifndef XLA_PJRT_DISTRIBUTED_COORDINATION_SERVICE_COORDINATION_SERVICE_RPC_HANDLER_H_
#define XLA_PJRT_DISTRIBUTED_COORDINATION_SERVICE_COORDINATION_SERVICE_RPC_HANDLER_H_
...
class CoordinationServiceRpcHandler {
 ...
 private:
  absl::Mutex mu_;
  CoordinationServiceAgent* agent_ ABSL_GUARDED_BY(mu_) = nullptr;
  CoordinationService* service_ ABSL_GUARDED_BY(mu_) = nullptr;
};

}  // namespace xla

#endif  // XLA_PJRT_DISTRIBUTED_COORDINATION_SERVICE_COORDINATION_SERVICE_RPC_HANDLER_H_
