...
#ifndef XLA_PJRT_DISTRIBUTED_COORDINATION_SERVICE_KEY_VALUE_STORE_H_
#define XLA_PJRT_DISTRIBUTED_COORDINATION_SERVICE_KEY_VALUE_STORE_H_
...
#endif  // XLA_PJRT_DISTRIBUTED_COORDINATION_SERVICE_KEY_VALUE_STORE_H_
