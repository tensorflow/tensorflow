...
#ifndef XLA_PJRT_GPU_GPU_EVENT_H_
#define XLA_PJRT_GPU_GPU_EVENT_H_
...
// tfrt::AsyncValueRef<GpuEvent> is used to indicate the completion of a GPU
...
class TfrtEventSet {
 public:
  ...
  void Add(tfrt::AsyncValueRef<GpuEvent> event);
 ...
 private:
  absl::InlinedVector<tfrt::AsyncValueRef<GpuEvent>, 4> events_;
};

}  // namespace xla

#endif  // XLA_PJRT_GPU_GPU_EVENT_H_
