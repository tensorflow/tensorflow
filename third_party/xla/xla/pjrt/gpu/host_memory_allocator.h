...
#ifndef XLA_PJRT_GPU_HOST_MEMORY_ALLOCATOR_H_
#define XLA_PJRT_GPU_HOST_MEMORY_ALLOCATOR_H_
...
class HostMemoryAllocator {
 public:
  explicit HostMemoryAllocator(std::unique_ptr<tensorflow::Allocator> allocator)
  ...
  OwnedPtr Allocate(size_t size) {
    ...
    return OwnedPtr(allocator_->AllocateRaw(
...
#endif  // XLA_PJRT_GPU_HOST_MEMORY_ALLOCATOR_H_
