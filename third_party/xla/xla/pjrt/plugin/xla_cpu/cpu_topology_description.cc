...
CpuTopologyDescription::CpuTopologyDescription(
    ...
    const std::vector<::xla::CpuTopology::CpuDevice>& cpu_devices,
    const ::xla::cpu::TargetMachineOptions& target_machine_options)
    : platform_id_(platform_id),
      platform_name_(platform_name),
      platform_version_(platform_version),
      cpu_topology_(cpu_devices, target_machine_options) {}
...
CpuTopologyDescription::FromProto(
  ...
  auto cpu_topology = CpuTopology::FromProto(cpu_topology_proto);
  ...
  return std::make_unique<CpuTopologyDescription>(
      ...
      cpu_devices, cpu_topology->target_machine_options());
}
