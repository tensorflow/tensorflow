...
// TODO(~tbd need to find owner~): TFRT GPU currently does not provide a PJRT
// API. Once it does, we should register it here.
// inline constexpr absl::string_view kTfrtGpuPjrtName = "TFRT_GPU";
