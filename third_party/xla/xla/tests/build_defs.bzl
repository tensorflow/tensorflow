...
def xla_test(
        ...
        use_legacy_stream_executor_runtime = False,
        **kwargs):
    ...
    Args:
      ...
      use_legacy_stream_executor_runtime: If true, adds the required dependencies for writing tests
        using the legacy StreamExecutor runtime.
    ...
    for backend in backends:
        ...
        if backend == "cpu":
            ...
            if not use_legacy_stream_executor_runtime:
        ...
        if "pjrt_migration_candidate" in this_backend_tags and not use_legacy_stream_executor_runtime:
            fail("xla_tests that do not use the legacy StreamExecutor runtime should not be tagged `pjrt_migration_candidate`.")
        ...
        # supported.
        if device_type_for_env == "gpu" and "incompatible_with_pjrt_se_gpu_client" not in this_backend_tags and not use_legacy_stream_executor_runtime:
