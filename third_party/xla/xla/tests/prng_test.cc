...
// TODO(b/71543667): Fix Rng ops on LLVM backends.
// TODO(b/122047800): Interpreter does not support BF16 for RNG ops.
TEST_F(PrngTest, DISABLED_ON_INTERPRETER(
                     DISABLED_ON_GPU(DISABLED_ON_CPU(ScalarBF16CountTests)))) {
...
TEST_F(PrngTest, DISABLED_ON_GPU(DISABLED_ON_CPU(MapUsingRng))) {
