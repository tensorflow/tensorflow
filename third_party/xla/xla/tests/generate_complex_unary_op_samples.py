"""Generates samples and reference values for complex unary functions.

A script to generate complex_unary_op_samples.h file that contains
samples and reference values of complex unary functions used by the
complex_unary_op_test program.
...
def disable(op, real, im):  # pylint: disable=unused-argument
  # Return True to disable samples (real, im) that are know to be
