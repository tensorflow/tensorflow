...
UNARY_TEST_COMPLEX_64(Log, {
  ...
  Run([](XlaOp x) { return static_cast<XlaOp (*)(XlaOp)>(&Log)(x); },
      [](complex64 x) { return std::log(x); }, error_spec_gen);
})
...
UNARY_TEST_COMPLEX_64(Sqrt, {
  ...
  Run([](XlaOp x) { return static_cast<XlaOp (*)(XlaOp)>(&Sqrt)(x); },
      [](complex64 x) { return std::sqrt(x); }, error_spec_gen);
})
...
UNARY_TEST_COMPLEX_64(Rsqrt, {
  ...
  Run([](XlaOp x) { return static_cast<XlaOp (*)(XlaOp)>(&Rsqrt)(x); },
...
UNARY_TEST_COMPLEX_64(Tanh, {
  ...
  Run([](XlaOp x) { return static_cast<XlaOp (*)(XlaOp)>(&Tanh)(x); },
      +[](complex64 x) {
...
UNARY_TEST_COMPLEX_128(Log, {
  ...
  Run([](XlaOp x) { return static_cast<XlaOp (*)(XlaOp)>(&Log)(x); },
      [](complex128 x) { return std::log(x); }, error_spec_gen);
})
