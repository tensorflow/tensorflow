...
#ifndef XLA_TESTS_HLO_PJRT_REFERENCE_MIXIN_H_
#define XLA_TESTS_HLO_PJRT_REFERENCE_MIXIN_H_
...
template <typename T>
class HloPjRtReferenceMixin : public HloRunnerAgnosticReferenceMixin<T> {
 protected:
  template <typename... BaseArgs>
  explicit HloPjRtReferenceMixin(BaseArgs&&... base_args)
  ...
  ~HloPjRtReferenceMixin() override = default;
};

}  // namespace xla

#endif  // XLA_TESTS_HLO_PJRT_REFERENCE_MIXIN_H_
