...
TEST_F(CollectiveOpsTest, DISABLED_ON_CPU(AllReduce_sum_complex64)) {
...
TEST_F(CollectiveOpsTest, DISABLED_ON_CPU(AllReduce_sum_complex128)) {
...
TEST_F(CollectiveOpsTest, DISABLED_ON_GPU(AllReduce_ManyConcurrentAllReduces)) {
  const int64_t kNumElems = 1024;
...
TEST_F(CollectiveOpsTest, DISABLED_ON_CPU(AsyncAllReduce)) {
...
TEST_F(CollectiveOpsTest, DISABLED_ON_CPU(AsyncAllReduceTwoOperands)) {
  const absl::string_view kModuleStr = R"(
      HloModule test
...
TEST_F(CollectiveOpsTest, DISABLED_ON_CPU(CollectiveBroadcast_TwoGPUs)) {
  const char* const kModuleStr = R"(
  HloModule test
...
TEST_F(CollectiveOpsTest, DISABLED_ON_CPU(CollectiveBroadcast_Simple)) {
  const char* const kModuleStr = R"(
  HloModule test
...
TEST_F(CollectiveOpsTest, DISABLED_ON_CPU(AsyncCollectivePermute)) {
  const absl::string_view kModuleStr = R"(
      HloModule test
...
TEST_F(CollectiveOpsTest, DISABLED_ON_CPU(AllToAll_SplitDimension)) {
  const char* const kModuleStr = R"(
  HloModule test
  ENTRY test_computation {
    id = u32[] replica-id()
...
TEST_F(CollectiveOpsTest, DISABLED_ON_CPU(AllGatherMixedTypes)) {
  const char* const kModuleStr = R"(
  HloModule test
  ENTRY test_computation {
    id = u32[] replica-id()
...
TEST_F(CollectiveOpsTest, DISABLED_ON_CPU(ReduceScatterReassociate)) {
  const char* const kModuleStr = R"(
  HloModule m
  sum {
    a = u32[] parameter(0)
...
TEST_F(CollectiveOpsTest, DISABLED_ON_CPU(AllReduceReassociate)) {
  const char* const kModuleStr = R"(
  HloModule m
  sum {
    a = f32[] parameter(0)
...
TEST_F(CollectiveOpsTest, DISABLED_ON_CPU(AllGatherBroadcastReorder_Uniform)) {
  const char* const kModuleStr = R"(
  HloModule m
...
TEST_F(CollectiveOpsTest, DISABLED_ON_CPU(AsyncAllGather)) {
  const char* const kModuleStr = R"(
  HloModule test
  ENTRY test_computation {
    id = u32[] replica-id()
...
TEST_F(CollectiveOpsTest, DISABLED_ON_CPU(AsyncReduceScatter)) {
  const char* const kModuleStr = R"(
  HloModule test
  add {
    lhs = u32[] parameter(0)
...
TEST_F(CollectiveOpsTest, DISABLED_ON_CPU(AsyncAllToAll)) {
  const char* const kModuleStr = R"(
  HloModule test
...
TEST_F(CollectiveOpsTest, DISABLED_ON_CPU(SendRecv_Simple)) {
  const char* const kModuleStr = R"(
  HloModule test
  ENTRY test_computation {
    %replica = u32[] replica-id()
...
TEST_F(CollectiveOpsTest, DISABLED_ON_CPU(SendRecv_TwoConcurrentChains)) {
  const char* const kModuleStr = R"(
...
TEST_F(CollectiveOpsTest, DISABLED_ON_CPU(SendRecv_ValidationAttr1)) {
  const char* const kModuleStr = R"(
  HloModule test, is_scheduled=true
...
TEST_F(CollectiveOpsTest, DISABLED_ON_CPU(SendRecv_ValidationAttr2)) {
  const char* const kModuleStr = R"(
  HloModule test, is_scheduled=true
cond {
...
TEST_F(CollectiveOpsTest, DISABLED_ON_CPU(SendRecvCrossReplica)) {
  const char* const kModuleStr = R"(
    HloModule test
...
TEST_F(CollectiveOpsTest, DISABLED_ON_CPU(SendRecvCrossPartition)) {
  const char* const kModuleStr = R"(
    HloModule test
...
TEST_F(Fp8CollectiveOpsTest, DISABLED_ON_CPU(AllGather_8BitFloat)) {
...
TEST_F(Fp8CollectiveOpsTest, DISABLED_ON_CPU(AllToAll_8BitFloat)) {
  const char* const kModuleStr = R"(
  HloModule test
  ENTRY test_computation {
...
TEST_F(Fp8CollectiveOpsTest, DISABLED_ON_CPU(CollectivePermute_8BitFloat)) {
  const char* const kModuleStr = R"(
  HloModule test
  ENTRY test_computation {
