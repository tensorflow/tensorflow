...
TEST_P(R4ReduceWindowLargeTest,
...
TEST_P(R3ReduceWindowLargeTest, OVERSIZE_ON_GRM(DoIt)) { DoIt(); }
...
TEST_F(HloTestBase, DISABLED_ON_GPU(ReduceWindowVariadicSupport)) {
...
TEST_F(HloTestBase, DISABLED_ON_GPU(ReduceWindowVariadicSupport2)) {
  const char* const hlo_string = R"(
HloModule module
...
TEST_F(HloTestBase, DISABLED_ON_GPU(ReduceWindowVariadicSupport3)) {
  const char* const hlo_string = R"(
HloModule module
...
TEST_F(HloTestBase, DISABLED_ON_GPU(ReduceWindowVariadicSupport4)) {
  const char* const hlo_string = R"(
HloModule module
...
TEST_F(HloTestBase, DISABLED_ON_GPU(ReduceWindowS64Support)) {
  const char* const hlo_string = R"(
...
TEST_F(HloTestBase, DISABLED_ON_GPU(ReduceWindowS64Support2)) {
  const char* const hlo_string = R"(
...
TEST_F(HloTestBase, DISABLED_ON_GPU(VariadicWithNonTrivialWindows)) {
  const char* const hlo_string = R"(
    HloModule m
