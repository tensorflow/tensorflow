...
class ReduceWindowTestBase : public ClientLibraryTestRunnerMixin<
...
using ReduceWindowTextTest = HloInterpreterReferenceMixin<HloTestBase>;
...
using ReduceWindowHloTest = HloInterpreterReferenceMixin<HloTestBase>;
