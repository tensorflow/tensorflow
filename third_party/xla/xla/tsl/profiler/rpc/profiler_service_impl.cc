...
class ProfilerServiceImpl : public tensorflow::grpc::ProfilerService::Service {
 public:
  ...
  ::grpc::Status GetSnapshot(::grpc::ServerContext* ctx,
    ...
    session = *std::move(continuous_profiling_session_);
    ...
    session.request.mutable_opts()->set_session_id(new_session_id);
    ...
    continuous_profiling_session_ = {session.request, std::move(new_profiler)};
    return ::grpc::Status::OK;
  }
