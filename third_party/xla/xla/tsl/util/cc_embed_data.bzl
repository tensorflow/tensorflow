...
def _cc_skylark_embed_data_impl(ctx):
    ...
    compilation_context, compilation_outputs = cc_common.compile(
        ...
        # compilation_contexts behaves like deps in a cc_library.
        compilation_contexts = [
            ctx.attr._file_toc[CcInfo].compilation_context,
...
""",
        ...
        "_file_toc": attr.label(
            default = Label("//xla/tsl/util:file_toc"),
        ),
        # copybara:uncomment_begin
        # "_stl": attr.label(
        # default = Label("//third_party/stl"),
        # ),
        # copybara:uncomment_end

        # Cross-compilation setups in CI don't use the hermetic toolchain, so we
        # have to configure the toolchain dependency in the legacy way as well.
        # TODO(b/394414401): Drop this hack!
