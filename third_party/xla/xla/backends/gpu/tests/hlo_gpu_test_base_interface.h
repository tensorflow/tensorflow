...
#ifndef XLA_BACKENDS_GPU_TESTS_HLO_GPU_TEST_BASE_INTERFACE_H_
#define XLA_BACKENDS_GPU_TESTS_HLO_GPU_TEST_BASE_INTERFACE_H_
...
#endif  // XLA_BACKENDS_GPU_TESTS_HLO_GPU_TEST_BASE_INTERFACE_H_
