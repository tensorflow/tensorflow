...
#ifndef XLA_BACKENDS_GPU_TESTS_HLO_LEGACY_GPU_TEST_BASE_H_
#define XLA_BACKENDS_GPU_TESTS_HLO_LEGACY_GPU_TEST_BASE_H_
...
#endif  // XLA_BACKENDS_GPU_TESTS_HLO_LEGACY_GPU_TEST_BASE_H_
