...
Array<int64_t> RaggedAllToAllTestUtils::CalculateOffsetsFromSizes(
    const Array<int64_t>& sizes, int64_t gap) {
...
void RaggedAllToAllTestUtils::FillWithRandomData(
    std::vector<Array<float>>& input_data,
    std::vector<Array<float>>& output_data, const Array<int64_t>& input_offsets,
    const Array<int64_t>& output_offsets, const Array<int64_t>& input_sizes) {
