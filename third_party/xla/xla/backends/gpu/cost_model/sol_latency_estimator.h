...
#ifndef XLA_BACKENDS_GPU_COST_MODEL_SOL_LATENCY_ESTIMATOR_H_
#define XLA_BACKENDS_GPU_COST_MODEL_SOL_LATENCY_ESTIMATOR_H_
...
#endif  // XLA_BACKENDS_GPU_COST_MODEL_SOL_LATENCY_ESTIMATOR_H_
