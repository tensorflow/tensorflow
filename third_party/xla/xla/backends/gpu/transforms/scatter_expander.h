...
#ifndef XLA_BACKENDS_GPU_TRANSFORMS_SCATTER_EXPANDER_H_
#define XLA_BACKENDS_GPU_TRANSFORMS_SCATTER_EXPANDER_H_
...
#endif  // XLA_BACKENDS_GPU_TRANSFORMS_SCATTER_EXPANDER_H_
