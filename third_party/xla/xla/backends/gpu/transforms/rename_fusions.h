...
#ifndef XLA_BACKENDS_GPU_TRANSFORMS_RENAME_FUSIONS_H_
#define XLA_BACKENDS_GPU_TRANSFORMS_RENAME_FUSIONS_H_
...
#endif  // XLA_BACKENDS_GPU_TRANSFORMS_RENAME_FUSIONS_H_
