...
#ifndef XLA_BACKENDS_GPU_TRANSFORMS_CONSTANT_FILL_COPY_REWRITER_H_
#define XLA_BACKENDS_GPU_TRANSFORMS_CONSTANT_FILL_COPY_REWRITER_H_
...
class ConstantFillCopyRewriter : public HloModulePass {
 public:
  absl::string_view name() const override {
    return "constant-fill-copy-rewriter";
  }
...
#endif  // XLA_BACKENDS_GPU_TRANSFORMS_CONSTANT_FILL_COPY_REWRITER_H_
