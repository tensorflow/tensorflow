...
#ifndef XLA_BACKENDS_GPU_TRANSFORMS_SCALAR_CONSTANT_SINKER_H_
#define XLA_BACKENDS_GPU_TRANSFORMS_SCALAR_CONSTANT_SINKER_H_
...
#endif  // XLA_BACKENDS_GPU_TRANSFORMS_SCALAR_CONSTANT_SINKER_H_
