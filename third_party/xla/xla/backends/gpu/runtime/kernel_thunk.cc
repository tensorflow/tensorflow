...
std::vector<BufferUse> BufferUseFromKernelArguments(
...
std::vector<BufferUse> KernelThunk::GetBuffers() const {
...
std::vector<BufferUse> CustomKernelThunk::GetBuffers() const {
  return BufferUseFromKernelArguments(absl::MakeConstSpan(args_), written_);
}
