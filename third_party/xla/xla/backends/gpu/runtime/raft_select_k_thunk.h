...
#ifndef XLA_BACKENDS_GPU_RUNTIME_RAFT_SELECT_K_THUNK_H_
#define XLA_BACKENDS_GPU_RUNTIME_RAFT_SELECT_K_THUNK_H_
...
// RaftSelectKThunk executes raft::matrix::select_k on the given inputs.
class RaftSelectKThunk : public Thunk {
 public:
  // Constructor.
  // Parameters:
  ...
  //                      inputs/outputs.
  explicit RaftSelectKThunk(const HloInstruction* inst,
  ...
  // Prepares any resources needed before execution.
...
#endif  // XLA_BACKENDS_GPU_RUNTIME_RAFT_SELECT_K_THUNK_H_
