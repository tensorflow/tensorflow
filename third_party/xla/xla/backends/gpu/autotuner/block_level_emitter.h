...
class TritonBlockLevelFusionEmitterBackend : public GpuCodegenBackend {
 public:
  explicit TritonBlockLevelFusionEmitterBackend(
      stream_executor::StreamExecutor* stream_executor,
      const DebugOptions* debug_options, Compiler* compiler)
      : GpuCodegenBackend("TritonBlockLevelFusionEmitter", stream_executor,
