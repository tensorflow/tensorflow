...
#ifndef XLA_BACKENDS_GPU_FFI_FFI_ATTRIBUTES_FROM_BACKEND_CONFIG_H_
#define XLA_BACKENDS_GPU_FFI_FFI_ATTRIBUTES_FROM_BACKEND_CONFIG_H_
...
#endif  // XLA_BACKENDS_GPU_FFI_FFI_ATTRIBUTES_FROM_BACKEND_CONFIG_H_
