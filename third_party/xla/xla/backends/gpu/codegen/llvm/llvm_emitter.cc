...
class IrEmitter : public DfsHloVisitorWithDefault,
 ...
 public:
  ...
  // object.
  explicit IrEmitter(IrEmitterContext* ir_emitter_context, llvm::Module* module,
                     bool is_nested)
...
class IrEmitterNested : public IrEmitter {
 public:
  ...
  IrEmitterNested(const HloComputation& nested_computation,
                  llvm::Module* module, IrEmitterContext* ir_emitter_context)
      : IrEmitter(ir_emitter_context, module,
                  /*is_nested=*/true),
...
absl::Status CallNestedComputation(llvm::IRBuilderBase* builder,
  ...
  TF_ASSIGN_OR_RETURN(
      ...
      IrEmitterNested(computation, llvm_module, &ir_emitter_context)
...
absl::StatusOr<ThunkSequence> EmitPadToStaticLLVMIR(
  ...
  IrEmitter ir_emitter(ir_emitter_context, llvm_module,
                       /*nested=*/false);
