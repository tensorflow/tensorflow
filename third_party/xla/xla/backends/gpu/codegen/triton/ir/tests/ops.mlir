...
tt.func @xla_triton_extract(%arg0: tensor<512x128xbf16>) -> tensor<16x64xbf16> {
  %cst_0 = arith.constant 0 : index
  %cst_1 = arith.constant 1 : index
  %cst_128 = arith.constant 128 : index
  %extracted_tensor = triton_xla.extract %arg0 [%cst_0, %cst_0] [%cst_128, %cst_1]
...
tt.func @xla_triton_insert(%src: tensor<16x64xbf16>, %dst: tensor<512x128xbf16>)
  ...
  %cst_1 = arith.constant 1 : index
  %cst_128 = arith.constant 128 : index
  %updated_tensor = triton_xla.insert %src into %dst [%cst_0, %cst_0][%cst_128, %cst_1]
