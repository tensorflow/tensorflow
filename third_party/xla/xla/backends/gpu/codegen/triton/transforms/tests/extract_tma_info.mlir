...
// CHECK-SAME: #triton_xla.tma_descriptor<global_shape = [32, 256], block_shape = [16, 32], element_byte_size = 4, swizzle_mode = "128b">
...
// CHECK-SAME:  %[[ARG_0:.*]]: !tt.tensordesc<tensor<16x32xf32, #shared>>
// CHECK-SAME: #triton_xla.tma_descriptor<global_shape = [32, 256], block_shape = [16, 32], element_byte_size = 4, swizzle_mode = "64b">
...
// CHECK-SAME:  %[[ARG_0:.*]]: !tt.tensordesc<tensor<16x32xf32, #shared>>
// CHECK-SAME: #triton_xla.tma_descriptor<global_shape = [32, 256], block_shape = [16, 32], element_byte_size = 4, swizzle_mode = "32b">
...
// CHECK-SAME:  %[[ARG_0:.*]]: !tt.tensordesc<tensor<16x32xf32, #shared>>
// CHECK-SAME: #triton_xla.tma_descriptor<global_shape = [32, 256], block_shape = [16, 32], element_byte_size = 4, swizzle_mode = "none">
