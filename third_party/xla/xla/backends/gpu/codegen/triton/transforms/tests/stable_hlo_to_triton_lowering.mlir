...
xtile.entry_func @all_reduce_lowers_to_triton(%input: memref<1024xf32>, %output: memref<1024xf32>, %device_rank: i32, %signal_value: i32, %signal_buffer: !tt.ptr<!tt.ptr<i32>>, %remote_input_buffer: !tt.ptr<!tt.ptr<i64>>, %tile_id: index) attributes {num_opaque_args = 4 : i32} {
  // CHECK: tt.bitcast
  // CHECK: arith.extsi
  // CHECK: arith.andi
  // CHECK: arith.muli
