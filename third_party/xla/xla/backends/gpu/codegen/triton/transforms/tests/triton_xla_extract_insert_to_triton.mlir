...
func.func @lower_tile_extract_insert(%arg0: tensor<512x128xbf16>,
  ...
  %tiled_tensor_in = triton_xla.tile %arg0 [%cst_0, %cst_0] [%cst_16, %cst_64] [%cst_128, %cst_1]
    : !triton_xla.tiled_tensor<16x64|512x128xbf16>
  %tiled_tensor_out = triton_xla.tile %arg1 [%cst_0, %cst_0] [%cst_16, %cst_64] [%cst_128, %cst_1]
...
func.func @non_perfect_tile_shape(
  ...
  %cst_0 = arith.constant 0 : i32
  %cst_1 = arith.constant 1 : i64
  %cst_8 = arith.constant 8 : i64
  %tiled_tensor_in = triton_xla.tile %arg0 [%cst_0, %cst_0] [%cst_8, %cst_8] [%cst_1, %cst_1]
    : !triton_xla.tiled_tensor<8x8|300x300xbf16>
  %tiled_tensor_out = triton_xla.tile %arg1 [%cst_0, %cst_0] [%cst_8, %cst_8] [%cst_1, %cst_1]
    : !triton_xla.tiled_tensor<8x8|300x300xbf16>
  %extracted_tensor = triton_xla.extract %tiled_tensor_in [%cst_0, %cst_0]
    : tensor<300x300xbf16> to tensor<8x8xbf16>
  %updated_tensor = triton_xla.insert %extracted_tensor into
    %tiled_tensor_out [%cst_0, %cst_0] : tensor<8x8xbf16> into tensor<300x300xbf16>
...
func.func @incompatible_tma_shapes(%arg0: tensor<1000x1000xbf16>,
  ...
  %cst_0 = arith.constant 1 : i32
  %cst_1 = arith.constant 1 : i64
  %cst_512 = arith.constant 512 : i64
  %cst_256 = arith.constant 256 : i64
  %cst_128 = arith.constant 128 : i64
  %tiled_tensor_in = triton_xla.tile %arg0 [%cst_0, %cst_0] [%cst_512, %cst_256] [%cst_128, %cst_1]
    : !triton_xla.tiled_tensor<512x256|1000x1000xbf16>
  %tiled_tensor_out = triton_xla.tile %arg1 [%cst_0, %cst_0] [%cst_512, %cst_256] [%cst_128, %cst_1]
    : !triton_xla.tiled_tensor<512x256|1024x1024xbf16>
  %extracted_tensor = triton_xla.extract %tiled_tensor_in [%cst_0, %cst_0]
    : tensor<1000x1000xbf16> to tensor<512x256xbf16>
  %updated_tensor = triton_xla.insert %extracted_tensor into
    %tiled_tensor_out [%cst_0, %cst_0]
