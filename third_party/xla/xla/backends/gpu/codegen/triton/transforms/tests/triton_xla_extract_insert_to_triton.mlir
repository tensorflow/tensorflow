...
func.func @lower_tile_extract_insert(%arg0: tensor<512x128xbf16>,
  ...
  %c_1_i32 = arith.constant 1 : i32
  %c_1_i64 = arith.constant 1 : i64
  %c_16 = arith.constant 16 : i64
  %c_64 = arith.constant 64 : i64
  %c_128 = arith.constant 128 : i64
  %tiled_tensor_in = triton_xla.tile %arg0 [%c_0, %c_0] [%c_16, %c_64] [%c_128, %c_1_i64] {layout = array<i64:1, 0>}
    : !triton_xla.tiled_tensor<16x64|512x128xbf16>
  %tiled_tensor_out = triton_xla.tile %arg1 [%c_0, %c_0] [%c_16, %c_64] [%c_128, %c_1_i64] {layout = array<i64:1, 0>}
    : !triton_xla.tiled_tensor<16x64|256x256xbf16>
  %extracted_tensor = triton_xla.extract %tiled_tensor_in [%c_1_i32, %c_1_i32]
    : tensor<512x128xbf16> to tensor<16x64xbf16>
  %updated_tensor = triton_xla.insert %extracted_tensor into
    %tiled_tensor_out [%c_1_i32, %c_1_i32]
...
func.func @non_perfect_tile_shape(
  ...
  %c_0_i64 = arith.constant 0 : i64
  %c_1 = arith.constant 1 : i64
  %c_8 = arith.constant 8 : i64
  %tiled_tensor_in = triton_xla.tile %arg0 [%c_0_i64, %c_0_i64] [%c_8, %c_8] [%c_1, %c_1] {layout = array<i64:1, 0>}
    : !triton_xla.tiled_tensor<8x8|300x300xbf16>
  %tiled_tensor_out = triton_xla.tile %arg1 [%c_0_i64, %c_0_i64] [%c_8, %c_8] [%c_1, %c_1] {layout = array<i64:1, 0>}
    : !triton_xla.tiled_tensor<8x8|300x300xbf16>
  %extracted_tensor = triton_xla.extract %tiled_tensor_in [%c_0_i32, %c_0_i32]
    : tensor<300x300xbf16> to tensor<8x8xbf16>
  %updated_tensor = triton_xla.insert %extracted_tensor into
    %tiled_tensor_out [%c_0_i32, %c_0_i32] : tensor<8x8xbf16> into tensor<300x300xbf16>
...
func.func @incompatible_tma_shapes(%arg0: tensor<1000x1000xbf16>,
  ...
  %c_128 = arith.constant 128 : i64
  %tiled_tensor_in = triton_xla.tile %arg0 [%c_0, %c_0] [%c_512, %c_256] [%c_128, %c_1_i64] {layout = array<i64:1, 0>}
    : !triton_xla.tiled_tensor<512x256|1000x1000xbf16>
  %tiled_tensor_out = triton_xla.tile %arg1 [%c_0, %c_0] [%c_512, %c_256] [%c_128, %c_1_i64] {layout = array<i64:1, 0>}
