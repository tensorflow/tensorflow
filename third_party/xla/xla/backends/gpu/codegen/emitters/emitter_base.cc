...
absl::StatusOr<mlir::OwningOpRef<mlir::ModuleOp>> EmitterBase::CreateMLIRModule(
    ...
    const BufferAssignment* buffer_assignment) const {
  mlir::OpBuilder builder(symbolic_expr_context.GetMLIRContext());
  ...
  SetBackendKind(&symbolic_expr_context, entry_func, BackendKind::kGpu);
...
absl::Status EmitterBase::EmitMlir(mlir::ModuleOp module, FuncOp entry_function,
  ...
  SymbolicExprContext symbolic_expr_context(module->getContext());
