...
#ifndef XLA_BACKENDS_GPU_CODEGEN_EMITTERS_DYNAMIC_PADDER_H_
#define XLA_BACKENDS_GPU_CODEGEN_EMITTERS_DYNAMIC_PADDER_H_
...
// Emitter for custom calls produced by the DynamicPadder pass: "PadToStatic"
// and "SliceToDynamic".
class DynamicPadder final : public EmitterBase {
 public:
  DynamicPadder(const HloFusionAnalysis& analysis,
...
#endif  // XLA_BACKENDS_GPU_CODEGEN_EMITTERS_DYNAMIC_PADDER_H_
