...
class CuptiTracer {
 ...
 private:
  ...
  // Setting max api callback event, max annotation strings from collectgor_
  ...
  // Activity buffer size 64K (8 bytes alignment is needed).
  static constexpr size_t kBufferSizeInBytes = 64 * 1024;
