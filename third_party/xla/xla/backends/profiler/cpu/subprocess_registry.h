...
#ifndef XLA_BACKENDS_PROFILER_CPU_SUBPROCESS_REGISTRY_H_
#define XLA_BACKENDS_PROFILER_CPU_SUBPROCESS_REGISTRY_H_
...
#endif  // XLA_BACKENDS_PROFILER_CPU_SUBPROCESS_REGISTRY_H_
