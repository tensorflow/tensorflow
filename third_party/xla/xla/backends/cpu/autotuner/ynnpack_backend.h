...
#ifndef XLA_BACKENDS_CPU_AUTOTUNER_YNNPACK_BACKEND_H_
#define XLA_BACKENDS_CPU_AUTOTUNER_YNNPACK_BACKEND_H_
...
inline constexpr absl::string_view kYnnpackBackendName = "ynnpack";

class YnnpackBackend : public CpuCodegenBackend {
 public:
  ...
  autotuner::Backend backend() const final {
    return autotuner::Backend::YNNPACK;
  }

 protected:
  bool IsSupported(const HloInstruction& instr);

  explicit YnnpackBackend(Compiler* compiler)
      : CpuCodegenBackend(compiler, kYnnpackBackendName) {}
};

}  // namespace xla::cpu

#endif  // XLA_BACKENDS_CPU_AUTOTUNER_YNNPACK_BACKEND_H_
