 ...
 public:
  static std::string Name(
    ...
    std::string fusion_mode =
        info.param.xnn_fusion_mode == DebugOptions::XNN_GRAPH_FUSION_MODE_GREEDY
            ? "greedy"
            : "dot";
    return absl::StrCat(info.param.lib, "_", fusion_mode, "_",
 ...
 protected:
  ...
  void RunTest(absl::string_view hlo_template, FusionProperties expected) {
    ...
    DotLibraryRewriterOptions options = {
        /*use_onednn=*/spec.lib == "onednn",
        /*use_xnnpack=*/spec.lib == "xnn",
        /*xnn_fusion_mode=*/spec.xnn_fusion_mode};
...
TEST_P(CpuDotLibraryTest, AddMatMul) {
  ...
  if (spec.xnn_fusion_mode == DebugOptions::XNN_GRAPH_FUSION_MODE_GREEDY) {
...
TEST_P(CpuDotLibraryTest, MatMulAndAdd) {
  ...
  } else if (GetParam().xnn_fusion_mode ==
             DebugOptions::XNN_GRAPH_FUSION_MODE_GREEDY) {
...
std::vector<XnnDotRewriteTestSpec> GetXnnDotRewriteTestSpecs() {
  ...
  absl::flat_hash_map<std::string,
                      std::vector<DebugOptions::XnnGraphFusionMode>>
      fusion_modes = {
          {"xnn",
           {DebugOptions::XNN_GRAPH_FUSION_MODE_DISABLED,
            DebugOptions::XNN_GRAPH_FUSION_MODE_GREEDY}},
          {"onednn", {DebugOptions::XNN_GRAPH_FUSION_MODE_DISABLED}},
      };
