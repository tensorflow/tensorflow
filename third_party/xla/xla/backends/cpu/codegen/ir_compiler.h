...
class IrCompiler : public llvm::orc::IRCompileLayer::IRCompiler {
 public:
  ...
  struct Options {
    ...
    // This should be the _only_ place where an #ifdef determines whether the
    // generated code is msan-instrumented. This ensures an uninstrumented
    // compiler can produce msan-instrumented AOT objects, and viceversa.
#ifdef ABSL_HAVE_MEMORY_SANITIZER
