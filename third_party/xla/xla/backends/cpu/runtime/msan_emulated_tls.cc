...
extern "C" {
// Mark these initial-exec as compiler-rt does.
extern ABSL_ATTRIBUTE_INITIAL_EXEC __thread uint64_t __msan_param_tls[];
extern ABSL_ATTRIBUTE_INITIAL_EXEC __thread uint32_t __msan_param_origin_tls[];
extern ABSL_ATTRIBUTE_INITIAL_EXEC __thread uint64_t __msan_retval_tls[];
extern ABSL_ATTRIBUTE_INITIAL_EXEC __thread uint32_t __msan_retval_origin_tls;
extern ABSL_ATTRIBUTE_INITIAL_EXEC __thread uint64_t __msan_va_arg_tls[];
extern ABSL_ATTRIBUTE_INITIAL_EXEC __thread uint32_t __msan_va_arg_origin_tls[];
extern ABSL_ATTRIBUTE_INITIAL_EXEC __thread uintptr_t
    __msan_va_arg_overflow_size_tls;
extern ABSL_ATTRIBUTE_INITIAL_EXEC __thread uint32_t __msan_origin_tls;
}
#endif  // ABSL_HAVE_MEMORY_SANITIZER

static_assert(
    static_cast<uintptr_t>(xla::cpu::MsanTlsSelector::kParamTls) == 1 &&
        static_cast<uintptr_t>(xla::cpu::MsanTlsSelector::kOriginTls) == 8,
    "MsanTlsSelector must remain a contiguous 1..8 range");
...
ABSL_ATTRIBUTE_NO_SANITIZE_MEMORY void* __xla_cpu_runtime_emutls_get_address(
  ...
  DCHECK_GE(selector, static_cast<uintptr_t>(MsanTlsSelector::kParamTls));
  DCHECK_LE(selector, static_cast<uintptr_t>(MsanTlsSelector::kOriginTls));
