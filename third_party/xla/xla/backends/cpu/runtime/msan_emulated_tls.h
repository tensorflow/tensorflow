...
#ifndef XLA_BACKENDS_CPU_RUNTIME_MSAN_EMULATED_TLS_H_
#define XLA_BACKENDS_CPU_RUNTIME_MSAN_EMULATED_TLS_H_
...
ABSL_ATTRIBUTE_NO_SANITIZE_MEMORY void* __xla_cpu_runtime_emutls_get_address(
    void* control);
}  // extern "C"
...
#endif  // XLA_BACKENDS_CPU_RUNTIME_MSAN_EMULATED_TLS_H_
