...
class MockCodegenBackend : public CodegenBackend {
 public:
  ...
  MOCK_METHOD(absl::Status, ApplyConfig,
              ...
              (override));
  MOCK_METHOD(absl::Status, ConfigToAny,
              (const BackendConfig& config, google::protobuf::Any* any),
              (const));
  MOCK_METHOD(absl::StatusOr<std::unique_ptr<BackendConfig>>, ConfigFromAny,
