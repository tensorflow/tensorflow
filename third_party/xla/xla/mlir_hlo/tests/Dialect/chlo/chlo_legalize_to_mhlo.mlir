...
// CHECK:         func.func @polygamma_f32(%[[VAL_0:.*]]: tensor<f32>, %[[VAL_1:.*]]: tensor<f32>) -> tensor<f32> {
// CHECK-DAG:       %[[CONSTANT_0:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_1:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f32>
// CHECK:           %[[REMAINDER_0:.*]] = mhlo.remainder %[[VAL_0]], %[[CONSTANT_1]] : tensor<f32>
// CHECK:           %[[MULTIPLY_0:.*]] = mhlo.multiply %[[CONSTANT_1]], %[[REMAINDER_0]] : tensor<f32>
// CHECK:           %[[SUBTRACT_0:.*]] = mhlo.subtract %[[MULTIPLY_0]], %[[CONSTANT_0]] : tensor<f32>
// CHECK:           %[[ADD_0:.*]] = mhlo.add %[[VAL_0]], %[[CONSTANT_0]] : tensor<f32>
// CHECK:           %[[CONSTANT_2:.*]] = mhlo.constant dense<5.000000e-01> : tensor<f32>
// CHECK:           %[[COMPARE_0:.*]] = mhlo.compare LT, %[[ADD_0]], %[[CONSTANT_2]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[NEGATE_0:.*]] = mhlo.negate %[[ADD_0]] : tensor<f32>
// CHECK:           %[[CONSTANT_3:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK:           %[[SUBTRACT_1:.*]] = mhlo.subtract %[[ADD_0]], %[[CONSTANT_3]] : tensor<f32>
// CHECK:           %[[SELECT_0:.*]] = mhlo.select %[[COMPARE_0]], %[[NEGATE_0]], %[[SUBTRACT_1]] : tensor<i1>, tensor<f32>
// CHECK-DAG:       %[[CONSTANT_4:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_5:.*]] = mhlo.constant dense<676.520386> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_6:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_1:.*]] = mhlo.add %[[SELECT_0]], %[[CONSTANT_6]] : tensor<f32>
// CHECK:           %[[DIVIDE_0:.*]] = mhlo.divide %[[CONSTANT_5]], %[[ADD_1]] : tensor<f32>
// CHECK:           %[[ADD_2:.*]] = mhlo.add %[[CONSTANT_4]], %[[DIVIDE_0]] : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_7:.*]] = mhlo.constant dense<-1259.13916> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_8:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_3:.*]] = mhlo.add %[[SELECT_0]], %[[CONSTANT_8]] : tensor<f32>
// CHECK:           %[[DIVIDE_1:.*]] = mhlo.divide %[[CONSTANT_7]], %[[ADD_3]] : tensor<f32>
// CHECK:           %[[ADD_4:.*]] = mhlo.add %[[ADD_2]], %[[DIVIDE_1]] : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_9:.*]] = mhlo.constant dense<771.323425> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_10:.*]] = mhlo.constant dense<3.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_5:.*]] = mhlo.add %[[SELECT_0]], %[[CONSTANT_10]] : tensor<f32>
// CHECK:           %[[DIVIDE_2:.*]] = mhlo.divide %[[CONSTANT_9]], %[[ADD_5]] : tensor<f32>
// CHECK:           %[[ADD_6:.*]] = mhlo.add %[[ADD_4]], %[[DIVIDE_2]] : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_11:.*]] = mhlo.constant dense<-176.615036> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_12:.*]] = mhlo.constant dense<4.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_7:.*]] = mhlo.add %[[SELECT_0]], %[[CONSTANT_12]] : tensor<f32>
// CHECK:           %[[DIVIDE_3:.*]] = mhlo.divide %[[CONSTANT_11]], %[[ADD_7]] : tensor<f32>
// CHECK:           %[[ADD_8:.*]] = mhlo.add %[[ADD_6]], %[[DIVIDE_3]] : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_13:.*]] = mhlo.constant dense<12.5073433> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_14:.*]] = mhlo.constant dense<5.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_9:.*]] = mhlo.add %[[SELECT_0]], %[[CONSTANT_14]] : tensor<f32>
// CHECK:           %[[DIVIDE_4:.*]] = mhlo.divide %[[CONSTANT_13]], %[[ADD_9]] : tensor<f32>
// CHECK:           %[[ADD_10:.*]] = mhlo.add %[[ADD_8]], %[[DIVIDE_4]] : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_15:.*]] = mhlo.constant dense<-0.138571098> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_16:.*]] = mhlo.constant dense<6.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_11:.*]] = mhlo.add %[[SELECT_0]], %[[CONSTANT_16]] : tensor<f32>
// CHECK:           %[[DIVIDE_5:.*]] = mhlo.divide %[[CONSTANT_15]], %[[ADD_11]] : tensor<f32>
// CHECK:           %[[ADD_12:.*]] = mhlo.add %[[ADD_10]], %[[DIVIDE_5]] : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_17:.*]] = mhlo.constant dense<9.98436917E-6> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_18:.*]] = mhlo.constant dense<7.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_13:.*]] = mhlo.add %[[SELECT_0]], %[[CONSTANT_18]] : tensor<f32>
// CHECK:           %[[DIVIDE_6:.*]] = mhlo.divide %[[CONSTANT_17]], %[[ADD_13]] : tensor<f32>
// CHECK:           %[[ADD_14:.*]] = mhlo.add %[[ADD_12]], %[[DIVIDE_6]] : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_19:.*]] = mhlo.constant dense<1.50563267E-7> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_20:.*]] = mhlo.constant dense<8.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_15:.*]] = mhlo.add %[[SELECT_0]], %[[CONSTANT_20]] : tensor<f32>
// CHECK:           %[[DIVIDE_7:.*]] = mhlo.divide %[[CONSTANT_19]], %[[ADD_15]] : tensor<f32>
// CHECK:           %[[ADD_16:.*]] = mhlo.add %[[ADD_14]], %[[DIVIDE_7]] : tensor<f32>
// CHECK:           %[[CONSTANT_21:.*]] = mhlo.constant dense<7.500000e+00> : tensor<f32>
// CHECK:           %[[ADD_17:.*]] = mhlo.add %[[CONSTANT_21]], %[[SELECT_0]] : tensor<f32>
// CHECK:           %[[CONSTANT_22:.*]] = mhlo.constant dense<2.01490307> : tensor<f32>
// CHECK:           %[[DIVIDE_8:.*]] = mhlo.divide %[[SELECT_0]], %[[CONSTANT_21]] : tensor<f32>
// CHECK:           %[[LOG_PLUS_ONE_0:.*]] = mhlo.log_plus_one %[[DIVIDE_8]] : tensor<f32>
// CHECK:           %[[ADD_18:.*]] = mhlo.add %[[CONSTANT_22]], %[[LOG_PLUS_ONE_0]] : tensor<f32>
// CHECK:           %[[DIVIDE_9:.*]] = mhlo.divide %[[ADD_17]], %[[ADD_18]] : tensor<f32>
// CHECK:           %[[ADD_19:.*]] = mhlo.add %[[SELECT_0]], %[[CONSTANT_2]] : tensor<f32>
// CHECK:           %[[SUBTRACT_2:.*]] = mhlo.subtract %[[ADD_19]], %[[DIVIDE_9]] : tensor<f32>
// CHECK:           %[[MULTIPLY_1:.*]] = mhlo.multiply %[[SUBTRACT_2]], %[[ADD_18]] : tensor<f32>
// CHECK:           %[[LOG_0:.*]] = mhlo.log %[[ADD_16]] : tensor<f32>
// CHECK:           %[[CONSTANT_23:.*]] = mhlo.constant dense<0.918938517> : tensor<f32>
// CHECK:           %[[ADD_20:.*]] = mhlo.add %[[CONSTANT_23]], %[[MULTIPLY_1]] : tensor<f32>
// CHECK:           %[[ADD_21:.*]] = mhlo.add %[[ADD_20]], %[[LOG_0]] : tensor<f32>
// CHECK:           %[[ABS_0:.*]] = mhlo.abs %[[ADD_0]] : tensor<f32>
// CHECK:           %[[FLOOR_0:.*]] = mhlo.floor %[[ABS_0]] : tensor<f32>
// CHECK:           %[[SUBTRACT_3:.*]] = mhlo.subtract %[[ABS_0]], %[[FLOOR_0]] : tensor<f32>
// CHECK:           %[[COMPARE_1:.*]] = mhlo.compare LT, %[[CONSTANT_2]], %[[SUBTRACT_3]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[SUBTRACT_4:.*]] = mhlo.subtract %[[CONSTANT_3]], %[[SUBTRACT_3]] : tensor<f32>
// CHECK:           %[[SELECT_1:.*]] = mhlo.select %[[COMPARE_1]], %[[SUBTRACT_4]], %[[SUBTRACT_3]] : tensor<i1>, tensor<f32>
// CHECK:           %[[CONSTANT_24:.*]] = mhlo.constant dense<3.14159274> : tensor<f32>
// CHECK:           %[[MULTIPLY_2:.*]] = mhlo.multiply %[[CONSTANT_24]], %[[SELECT_1]] : tensor<f32>
// CHECK:           %[[SINE_0:.*]] = mhlo.sine %[[MULTIPLY_2]] : tensor<f32>
// CHECK:           %[[LOG_1:.*]] = mhlo.log %[[SINE_0]] : tensor<f32>
// CHECK:           %[[CONSTANT_25:.*]] = mhlo.constant dense<1.14472985> : tensor<f32>
// CHECK:           %[[SUBTRACT_5:.*]] = mhlo.subtract %[[CONSTANT_25]], %[[LOG_1]] : tensor<f32>
// CHECK:           %[[SUBTRACT_6:.*]] = mhlo.subtract %[[SUBTRACT_5]], %[[ADD_21]] : tensor<f32>
// CHECK:           %[[IS_FINITE_0:.*]] = mhlo.is_finite %[[LOG_1]] : (tensor<f32>) -> tensor<i1>
// CHECK:           %[[NEGATE_1:.*]] = mhlo.negate %[[LOG_1]] : tensor<f32>
// CHECK:           %[[SELECT_2:.*]] = mhlo.select %[[IS_FINITE_0]], %[[SUBTRACT_6]], %[[NEGATE_1]] : tensor<i1>, tensor<f32>
// CHECK:           %[[SELECT_3:.*]] = mhlo.select %[[COMPARE_0]], %[[SELECT_2]], %[[ADD_21]] : tensor<i1>, tensor<f32>
// CHECK:           %[[ABS_1:.*]] = mhlo.abs %[[ADD_0]] : tensor<f32>
// CHECK:           %[[CONSTANT_26:.*]] = mhlo.constant dense<0x7F800000> : tensor<f32>
// CHECK:           %[[COMPARE_2:.*]] = mhlo.compare EQ, %[[ABS_1]], %[[CONSTANT_26]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[CONSTANT_27:.*]] = mhlo.constant dense<0x7F800000> : tensor<f32>
// CHECK:           %[[SELECT_4:.*]] = mhlo.select %[[COMPARE_2]], %[[CONSTANT_27]], %[[SELECT_3]] : tensor<i1>, tensor<f32>
// CHECK:           %[[EXPONENTIAL_0:.*]] = mhlo.exponential %[[SELECT_4]] : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_28:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_29:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK:           %[[NEGATE_2:.*]] = mhlo.negate %[[ADD_0]] : tensor<f32>
// CHECK:           %[[POWER_0:.*]] = mhlo.power %[[VAL_1]], %[[NEGATE_2]] : tensor<f32>
// CHECK:           %[[ADD_22:.*]] = mhlo.add %[[VAL_1]], %[[CONSTANT_29]] : tensor<f32>
// CHECK:           %[[POWER_1:.*]] = mhlo.power %[[ADD_22]], %[[NEGATE_2]] : tensor<f32>
// CHECK:           %[[ADD_23:.*]] = mhlo.add %[[POWER_0]], %[[POWER_1]] : tensor<f32>
// CHECK:           %[[ADD_24:.*]] = mhlo.add %[[ADD_22]], %[[CONSTANT_29]] : tensor<f32>
// CHECK:           %[[POWER_2:.*]] = mhlo.power %[[ADD_24]], %[[NEGATE_2]] : tensor<f32>
// CHECK:           %[[ADD_25:.*]] = mhlo.add %[[ADD_23]], %[[POWER_2]] : tensor<f32>
// CHECK:           %[[ADD_26:.*]] = mhlo.add %[[ADD_24]], %[[CONSTANT_29]] : tensor<f32>
// CHECK:           %[[POWER_3:.*]] = mhlo.power %[[ADD_26]], %[[NEGATE_2]] : tensor<f32>
// CHECK:           %[[ADD_27:.*]] = mhlo.add %[[ADD_25]], %[[POWER_3]] : tensor<f32>
// CHECK:           %[[ADD_28:.*]] = mhlo.add %[[ADD_26]], %[[CONSTANT_29]] : tensor<f32>
// CHECK:           %[[POWER_4:.*]] = mhlo.power %[[ADD_28]], %[[NEGATE_2]] : tensor<f32>
// CHECK:           %[[ADD_29:.*]] = mhlo.add %[[ADD_27]], %[[POWER_4]] : tensor<f32>
// CHECK:           %[[ADD_30:.*]] = mhlo.add %[[ADD_28]], %[[CONSTANT_29]] : tensor<f32>
// CHECK:           %[[POWER_5:.*]] = mhlo.power %[[ADD_30]], %[[NEGATE_2]] : tensor<f32>
// CHECK:           %[[ADD_31:.*]] = mhlo.add %[[ADD_29]], %[[POWER_5]] : tensor<f32>
// CHECK:           %[[ADD_32:.*]] = mhlo.add %[[ADD_30]], %[[CONSTANT_29]] : tensor<f32>
// CHECK:           %[[POWER_6:.*]] = mhlo.power %[[ADD_32]], %[[NEGATE_2]] : tensor<f32>
// CHECK:           %[[ADD_33:.*]] = mhlo.add %[[ADD_31]], %[[POWER_6]] : tensor<f32>
// CHECK:           %[[ADD_34:.*]] = mhlo.add %[[ADD_32]], %[[CONSTANT_29]] : tensor<f32>
// CHECK:           %[[POWER_7:.*]] = mhlo.power %[[ADD_34]], %[[NEGATE_2]] : tensor<f32>
// CHECK:           %[[ADD_35:.*]] = mhlo.add %[[ADD_33]], %[[POWER_7]] : tensor<f32>
// CHECK:           %[[ADD_36:.*]] = mhlo.add %[[ADD_34]], %[[CONSTANT_29]] : tensor<f32>
// CHECK:           %[[POWER_8:.*]] = mhlo.power %[[ADD_36]], %[[NEGATE_2]] : tensor<f32>
// CHECK:           %[[ADD_37:.*]] = mhlo.add %[[ADD_35]], %[[POWER_8]] : tensor<f32>
// CHECK:           %[[ADD_38:.*]] = mhlo.add %[[ADD_36]], %[[CONSTANT_29]] : tensor<f32>
// CHECK:           %[[POWER_9:.*]] = mhlo.power %[[ADD_38]], %[[NEGATE_2]] : tensor<f32>
// CHECK:           %[[ADD_39:.*]] = mhlo.add %[[ADD_37]], %[[POWER_9]] : tensor<f32>
// CHECK:           %[[ADD_40:.*]] = mhlo.add %[[ADD_38]], %[[CONSTANT_29]] : tensor<f32>
// CHECK:           %[[POWER_10:.*]] = mhlo.power %[[ADD_40]], %[[NEGATE_2]] : tensor<f32>
// CHECK:           %[[CONSTANT_30:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK:           %[[MULTIPLY_3:.*]] = mhlo.multiply %[[POWER_10]], %[[ADD_40]] : tensor<f32>
// CHECK:           %[[SUBTRACT_7:.*]] = mhlo.subtract %[[ADD_0]], %[[CONSTANT_30]] : tensor<f32>
// CHECK:           %[[DIVIDE_10:.*]] = mhlo.divide %[[MULTIPLY_3]], %[[SUBTRACT_7]] : tensor<f32>
// CHECK:           %[[MULTIPLY_4:.*]] = mhlo.multiply %[[ADD_40]], %[[ADD_40]] : tensor<f32>
// CHECK:           %[[DIVIDE_11:.*]] = mhlo.divide %[[CONSTANT_29]], %[[MULTIPLY_4]] : tensor<f32>
// CHECK:           %[[CONSTANT_31:.*]] = mhlo.constant dense<2.200000e+01> : tensor<f32>
// CHECK:           %[[ADD_41:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_31]] : tensor<f32>
// CHECK:           %[[CONSTANT_32:.*]] = mhlo.constant dense<2.100000e+01> : tensor<f32>
// CHECK:           %[[ADD_42:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_32]] : tensor<f32>
// CHECK:           %[[MULTIPLY_5:.*]] = mhlo.multiply %[[ADD_41]], %[[ADD_42]] : tensor<f32>
// CHECK:           %[[CONSTANT_33:.*]] = mhlo.constant dense<-1.39544646E-19> : tensor<f32>
// CHECK:           %[[ADD_43:.*]] = mhlo.add %[[CONSTANT_28]], %[[CONSTANT_33]] : tensor<f32>
// CHECK:           %[[MULTIPLY_6:.*]] = mhlo.multiply %[[DIVIDE_11]], %[[ADD_43]] : tensor<f32>
// CHECK:           %[[MULTIPLY_7:.*]] = mhlo.multiply %[[MULTIPLY_5]], %[[MULTIPLY_6]] : tensor<f32>
// CHECK:           %[[CONSTANT_34:.*]] = mhlo.constant dense<2.000000e+01> : tensor<f32>
// CHECK:           %[[ADD_44:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_34]] : tensor<f32>
// CHECK:           %[[CONSTANT_35:.*]] = mhlo.constant dense<1.900000e+01> : tensor<f32>
// CHECK:           %[[ADD_45:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_35]] : tensor<f32>
// CHECK:           %[[MULTIPLY_8:.*]] = mhlo.multiply %[[ADD_44]], %[[ADD_45]] : tensor<f32>
// CHECK:           %[[CONSTANT_36:.*]] = mhlo.constant dense<5.50900303E-18> : tensor<f32>
// CHECK:           %[[ADD_46:.*]] = mhlo.add %[[MULTIPLY_7]], %[[CONSTANT_36]] : tensor<f32>
// CHECK:           %[[MULTIPLY_9:.*]] = mhlo.multiply %[[DIVIDE_11]], %[[ADD_46]] : tensor<f32>
// CHECK:           %[[MULTIPLY_10:.*]] = mhlo.multiply %[[MULTIPLY_8]], %[[MULTIPLY_9]] : tensor<f32>
// CHECK:           %[[CONSTANT_37:.*]] = mhlo.constant dense<1.800000e+01> : tensor<f32>
// CHECK:           %[[ADD_47:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_37]] : tensor<f32>
// CHECK:           %[[CONSTANT_38:.*]] = mhlo.constant dense<1.700000e+01> : tensor<f32>
// CHECK:           %[[ADD_48:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_38]] : tensor<f32>
// CHECK:           %[[MULTIPLY_11:.*]] = mhlo.multiply %[[ADD_47]], %[[ADD_48]] : tensor<f32>
// CHECK:           %[[CONSTANT_39:.*]] = mhlo.constant dense<-2.17486866E-16> : tensor<f32>
// CHECK:           %[[ADD_49:.*]] = mhlo.add %[[MULTIPLY_10]], %[[CONSTANT_39]] : tensor<f32>
// CHECK:           %[[MULTIPLY_12:.*]] = mhlo.multiply %[[DIVIDE_11]], %[[ADD_49]] : tensor<f32>
// CHECK:           %[[MULTIPLY_13:.*]] = mhlo.multiply %[[MULTIPLY_11]], %[[MULTIPLY_12]] : tensor<f32>
// CHECK:           %[[CONSTANT_40:.*]] = mhlo.constant dense<1.600000e+01> : tensor<f32>
// CHECK:           %[[ADD_50:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_40]] : tensor<f32>
// CHECK:           %[[CONSTANT_41:.*]] = mhlo.constant dense<1.500000e+01> : tensor<f32>
// CHECK:           %[[ADD_51:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_41]] : tensor<f32>
// CHECK:           %[[MULTIPLY_14:.*]] = mhlo.multiply %[[ADD_50]], %[[ADD_51]] : tensor<f32>
// CHECK:           %[[CONSTANT_42:.*]] = mhlo.constant dense<8.58606213E-15> : tensor<f32>
// CHECK:           %[[ADD_52:.*]] = mhlo.add %[[MULTIPLY_13]], %[[CONSTANT_42]] : tensor<f32>
// CHECK:           %[[MULTIPLY_15:.*]] = mhlo.multiply %[[DIVIDE_11]], %[[ADD_52]] : tensor<f32>
// CHECK:           %[[MULTIPLY_16:.*]] = mhlo.multiply %[[MULTIPLY_14]], %[[MULTIPLY_15]] : tensor<f32>
// CHECK:           %[[CONSTANT_43:.*]] = mhlo.constant dense<1.400000e+01> : tensor<f32>
// CHECK:           %[[ADD_53:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_43]] : tensor<f32>
// CHECK:           %[[CONSTANT_44:.*]] = mhlo.constant dense<1.300000e+01> : tensor<f32>
// CHECK:           %[[ADD_54:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_44]] : tensor<f32>
// CHECK:           %[[MULTIPLY_17:.*]] = mhlo.multiply %[[ADD_53]], %[[ADD_54]] : tensor<f32>
// CHECK:           %[[CONSTANT_45:.*]] = mhlo.constant dense<-3.3896803E-13> : tensor<f32>
// CHECK:           %[[ADD_55:.*]] = mhlo.add %[[MULTIPLY_16]], %[[CONSTANT_45]] : tensor<f32>
// CHECK:           %[[MULTIPLY_18:.*]] = mhlo.multiply %[[DIVIDE_11]], %[[ADD_55]] : tensor<f32>
// CHECK:           %[[MULTIPLY_19:.*]] = mhlo.multiply %[[MULTIPLY_17]], %[[MULTIPLY_18]] : tensor<f32>
// CHECK:           %[[CONSTANT_46:.*]] = mhlo.constant dense<1.200000e+01> : tensor<f32>
// CHECK:           %[[ADD_56:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_46]] : tensor<f32>
// CHECK:           %[[CONSTANT_47:.*]] = mhlo.constant dense<1.100000e+01> : tensor<f32>
// CHECK:           %[[ADD_57:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_47]] : tensor<f32>
// CHECK:           %[[MULTIPLY_20:.*]] = mhlo.multiply %[[ADD_56]], %[[ADD_57]] : tensor<f32>
// CHECK:           %[[CONSTANT_48:.*]] = mhlo.constant dense<1.33825364E-11> : tensor<f32>
// CHECK:           %[[ADD_58:.*]] = mhlo.add %[[MULTIPLY_19]], %[[CONSTANT_48]] : tensor<f32>
// CHECK:           %[[MULTIPLY_21:.*]] = mhlo.multiply %[[DIVIDE_11]], %[[ADD_58]] : tensor<f32>
// CHECK:           %[[MULTIPLY_22:.*]] = mhlo.multiply %[[MULTIPLY_20]], %[[MULTIPLY_21]] : tensor<f32>
// CHECK:           %[[CONSTANT_49:.*]] = mhlo.constant dense<1.000000e+01> : tensor<f32>
// CHECK:           %[[ADD_59:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_49]] : tensor<f32>
// CHECK:           %[[CONSTANT_50:.*]] = mhlo.constant dense<9.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_60:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_50]] : tensor<f32>
// CHECK:           %[[MULTIPLY_23:.*]] = mhlo.multiply %[[ADD_59]], %[[ADD_60]] : tensor<f32>
// CHECK:           %[[CONSTANT_51:.*]] = mhlo.constant dense<-5.28419031E-10> : tensor<f32>
// CHECK:           %[[ADD_61:.*]] = mhlo.add %[[MULTIPLY_22]], %[[CONSTANT_51]] : tensor<f32>
// CHECK:           %[[MULTIPLY_24:.*]] = mhlo.multiply %[[DIVIDE_11]], %[[ADD_61]] : tensor<f32>
// CHECK:           %[[MULTIPLY_25:.*]] = mhlo.multiply %[[MULTIPLY_23]], %[[MULTIPLY_24]] : tensor<f32>
// CHECK:           %[[CONSTANT_52:.*]] = mhlo.constant dense<8.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_62:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_52]] : tensor<f32>
// CHECK:           %[[CONSTANT_53:.*]] = mhlo.constant dense<7.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_63:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_53]] : tensor<f32>
// CHECK:           %[[MULTIPLY_26:.*]] = mhlo.multiply %[[ADD_62]], %[[ADD_63]] : tensor<f32>
// CHECK:           %[[CONSTANT_54:.*]] = mhlo.constant dense<2.08767563E-8> : tensor<f32>
// CHECK:           %[[ADD_64:.*]] = mhlo.add %[[MULTIPLY_25]], %[[CONSTANT_54]] : tensor<f32>
// CHECK:           %[[MULTIPLY_27:.*]] = mhlo.multiply %[[DIVIDE_11]], %[[ADD_64]] : tensor<f32>
// CHECK:           %[[MULTIPLY_28:.*]] = mhlo.multiply %[[MULTIPLY_26]], %[[MULTIPLY_27]] : tensor<f32>
// CHECK:           %[[CONSTANT_55:.*]] = mhlo.constant dense<6.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_65:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_55]] : tensor<f32>
// CHECK:           %[[CONSTANT_56:.*]] = mhlo.constant dense<5.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_66:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_56]] : tensor<f32>
// CHECK:           %[[MULTIPLY_29:.*]] = mhlo.multiply %[[ADD_65]], %[[ADD_66]] : tensor<f32>
// CHECK:           %[[CONSTANT_57:.*]] = mhlo.constant dense<-8.26719599E-7> : tensor<f32>
// CHECK:           %[[ADD_67:.*]] = mhlo.add %[[MULTIPLY_28]], %[[CONSTANT_57]] : tensor<f32>
// CHECK:           %[[MULTIPLY_30:.*]] = mhlo.multiply %[[DIVIDE_11]], %[[ADD_67]] : tensor<f32>
// CHECK:           %[[MULTIPLY_31:.*]] = mhlo.multiply %[[MULTIPLY_29]], %[[MULTIPLY_30]] : tensor<f32>
// CHECK:           %[[CONSTANT_58:.*]] = mhlo.constant dense<4.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_68:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_58]] : tensor<f32>
// CHECK:           %[[CONSTANT_59:.*]] = mhlo.constant dense<3.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_69:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_59]] : tensor<f32>
// CHECK:           %[[MULTIPLY_32:.*]] = mhlo.multiply %[[ADD_68]], %[[ADD_69]] : tensor<f32>
// CHECK:           %[[CONSTANT_60:.*]] = mhlo.constant dense<3.30687835E-5> : tensor<f32>
// CHECK:           %[[ADD_70:.*]] = mhlo.add %[[MULTIPLY_31]], %[[CONSTANT_60]] : tensor<f32>
// CHECK:           %[[MULTIPLY_33:.*]] = mhlo.multiply %[[DIVIDE_11]], %[[ADD_70]] : tensor<f32>
// CHECK:           %[[MULTIPLY_34:.*]] = mhlo.multiply %[[MULTIPLY_32]], %[[MULTIPLY_33]] : tensor<f32>
// CHECK:           %[[CONSTANT_61:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_71:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_61]] : tensor<f32>
// CHECK:           %[[CONSTANT_62:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_72:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_62]] : tensor<f32>
// CHECK:           %[[MULTIPLY_35:.*]] = mhlo.multiply %[[ADD_71]], %[[ADD_72]] : tensor<f32>
// CHECK:           %[[CONSTANT_63:.*]] = mhlo.constant dense<-0.00138888892> : tensor<f32>
// CHECK:           %[[ADD_73:.*]] = mhlo.add %[[MULTIPLY_34]], %[[CONSTANT_63]] : tensor<f32>
// CHECK:           %[[MULTIPLY_36:.*]] = mhlo.multiply %[[DIVIDE_11]], %[[ADD_73]] : tensor<f32>
// CHECK:           %[[MULTIPLY_37:.*]] = mhlo.multiply %[[MULTIPLY_35]], %[[MULTIPLY_36]] : tensor<f32>
// CHECK:           %[[CONSTANT_64:.*]] = mhlo.constant dense<5.000000e-01> : tensor<f32>
// CHECK:           %[[DIVIDE_12:.*]] = mhlo.divide %[[ADD_0]], %[[ADD_40]] : tensor<f32>
// CHECK:           %[[CONSTANT_65:.*]] = mhlo.constant dense<0.0833333358> : tensor<f32>
// CHECK:           %[[ADD_74:.*]] = mhlo.add %[[CONSTANT_65]], %[[MULTIPLY_37]] : tensor<f32>
// CHECK:           %[[MULTIPLY_38:.*]] = mhlo.multiply %[[DIVIDE_12]], %[[ADD_74]] : tensor<f32>
// CHECK:           %[[ADD_75:.*]] = mhlo.add %[[CONSTANT_64]], %[[MULTIPLY_38]] : tensor<f32>
// CHECK:           %[[MULTIPLY_39:.*]] = mhlo.multiply %[[POWER_10]], %[[ADD_75]] : tensor<f32>
// CHECK:           %[[ADD_76:.*]] = mhlo.add %[[ADD_39]], %[[DIVIDE_10]] : tensor<f32>
// CHECK:           %[[ADD_77:.*]] = mhlo.add %[[ADD_76]], %[[MULTIPLY_39]] : tensor<f32>
// CHECK:           %[[ABS_2:.*]] = mhlo.abs %[[POWER_10]] : tensor<f32>
// CHECK:           %[[ABS_3:.*]] = mhlo.abs %[[ADD_39]] : tensor<f32>
// CHECK:           %[[CONSTANT_66:.*]] = mhlo.constant dense<1.401300e-45> : tensor<f32>
// CHECK:           %[[MULTIPLY_40:.*]] = mhlo.multiply %[[ABS_3]], %[[CONSTANT_66]] : tensor<f32>
// CHECK:           %[[COMPARE_3:.*]] = mhlo.compare LT, %[[ABS_2]], %[[MULTIPLY_40]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[SELECT_5:.*]] = mhlo.select %[[COMPARE_3]], %[[ADD_39]], %[[ADD_77]] : tensor<i1>, tensor<f32>
// CHECK:           %[[CONSTANT_67:.*]] = mhlo.constant dense<0x7FC00000> : tensor<f32>
// CHECK:           %[[COMPARE_4:.*]] = mhlo.compare LT, %[[ADD_0]], %[[CONSTANT_30]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[SELECT_6:.*]] = mhlo.select %[[COMPARE_4]], %[[CONSTANT_67]], %[[SELECT_5]] : tensor<i1>, tensor<f32>
// CHECK:           %[[COMPARE_5:.*]] = mhlo.compare LE, %[[VAL_1]], %[[CONSTANT_28]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[FLOOR_1:.*]] = mhlo.floor %[[ADD_0]] : tensor<f32>
// CHECK:           %[[COMPARE_6:.*]] = mhlo.compare NE, %[[ADD_0]], %[[FLOOR_1]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[AND_0:.*]] = mhlo.and %[[COMPARE_5]], %[[COMPARE_6]] : tensor<i1>
// CHECK:           %[[SELECT_7:.*]] = mhlo.select %[[AND_0]], %[[CONSTANT_67]], %[[SELECT_6]] : tensor<i1>, tensor<f32>
// CHECK:           %[[CONSTANT_68:.*]] = mhlo.constant dense<0x7F800000> : tensor<f32>
// CHECK:           %[[FLOOR_2:.*]] = mhlo.floor %[[VAL_1]] : tensor<f32>
// CHECK:           %[[COMPARE_7:.*]] = mhlo.compare EQ, %[[VAL_1]], %[[FLOOR_2]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[AND_1:.*]] = mhlo.and %[[COMPARE_5]], %[[COMPARE_7]] : tensor<i1>
// CHECK:           %[[CONSTANT_69:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f32>
// CHECK:           %[[FLOOR_3:.*]] = mhlo.floor %[[ADD_0]] : tensor<f32>
// CHECK:           %[[COMPARE_8:.*]] = mhlo.compare EQ, %[[ADD_0]], %[[FLOOR_3]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[REMAINDER_1:.*]] = mhlo.remainder %[[ADD_0]], %[[CONSTANT_69]] : tensor<f32>
// CHECK:           %[[COMPARE_9:.*]] = mhlo.compare EQ, %[[REMAINDER_1]], %[[CONSTANT_28]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[AND_2:.*]] = mhlo.and %[[COMPARE_8]], %[[COMPARE_9]] : tensor<i1>
// CHECK:           %[[SELECT_8:.*]] = mhlo.select %[[AND_2]], %[[CONSTANT_68]], %[[CONSTANT_67]] : tensor<i1>, tensor<f32>
// CHECK:           %[[SELECT_9:.*]] = mhlo.select %[[AND_1]], %[[SELECT_8]], %[[SELECT_7]] : tensor<i1>, tensor<f32>
// CHECK:           %[[COMPARE_10:.*]] = mhlo.compare EQ, %[[ADD_0]], %[[CONSTANT_29]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[SELECT_10:.*]] = mhlo.select %[[COMPARE_10]], %[[CONSTANT_68]], %[[SELECT_9]] : tensor<i1>, tensor<f32>
// CHECK:           %[[MULTIPLY_41:.*]] = mhlo.multiply %[[SUBTRACT_0]], %[[EXPONENTIAL_0]] : tensor<f32>
// CHECK:           %[[MULTIPLY_42:.*]] = mhlo.multiply %[[MULTIPLY_41]], %[[SELECT_10]] : tensor<f32>
// CHECK:           %[[CONSTANT_70:.*]] = mhlo.constant dense<5.000000e-01> : tensor<f32>
// CHECK:           %[[ADD_78:.*]] = mhlo.add %[[VAL_1]], %[[CONSTANT_70]] : tensor<f32>
// CHECK:           %[[FLOOR_4:.*]] = mhlo.floor %[[ADD_78]] : tensor<f32>
// CHECK:           %[[ABS_4:.*]] = mhlo.abs %[[FLOOR_4]] : tensor<f32>
// CHECK:           %[[ADD_79:.*]] = mhlo.add %[[VAL_1]], %[[ABS_4]] : tensor<f32>
// CHECK:           %[[CONSTANT_71:.*]] = mhlo.constant dense<3.14159274> : tensor<f32>
// CHECK:           %[[MULTIPLY_43:.*]] = mhlo.multiply %[[CONSTANT_71]], %[[ADD_79]] : tensor<f32>
// CHECK:           %[[COSINE_0:.*]] = mhlo.cosine %[[MULTIPLY_43]] : tensor<f32>
// CHECK:           %[[SINE_1:.*]] = mhlo.sine %[[MULTIPLY_43]] : tensor<f32>
// CHECK:           %[[DIVIDE_13:.*]] = mhlo.divide %[[COSINE_0]], %[[SINE_1]] : tensor<f32>
// CHECK:           %[[FLOOR_5:.*]] = mhlo.floor %[[VAL_0]] : tensor<f32>
// CHECK:           %[[CONSTANT_72:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f32>
// CHECK:           %[[MULTIPLY_44:.*]] = mhlo.multiply %[[CONSTANT_72]], %[[DIVIDE_13]] : tensor<f32>
// CHECK:           %[[CONSTANT_73:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_80:.*]] = mhlo.add %[[MULTIPLY_44]], %[[CONSTANT_73]] : tensor<f32>
// CHECK:           %[[MULTIPLY_45:.*]] = mhlo.multiply %[[ADD_80]], %[[DIVIDE_13]] : tensor<f32>
// CHECK:           %[[CONSTANT_74:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_81:.*]] = mhlo.add %[[MULTIPLY_45]], %[[CONSTANT_74]] : tensor<f32>
// CHECK:           %[[MULTIPLY_46:.*]] = mhlo.multiply %[[ADD_81]], %[[DIVIDE_13]] : tensor<f32>
// CHECK:           %[[CONSTANT_75:.*]] = mhlo.constant dense<6.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_82:.*]] = mhlo.add %[[MULTIPLY_46]], %[[CONSTANT_75]] : tensor<f32>
// CHECK:           %[[MULTIPLY_47:.*]] = mhlo.multiply %[[ADD_82]], %[[DIVIDE_13]] : tensor<f32>
// CHECK:           %[[CONSTANT_76:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_83:.*]] = mhlo.add %[[MULTIPLY_47]], %[[CONSTANT_76]] : tensor<f32>
// CHECK:           %[[MULTIPLY_48:.*]] = mhlo.multiply %[[ADD_83]], %[[DIVIDE_13]] : tensor<f32>
// CHECK:           %[[CONSTANT_77:.*]] = mhlo.constant dense<8.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_84:.*]] = mhlo.add %[[MULTIPLY_48]], %[[CONSTANT_77]] : tensor<f32>
// CHECK:           %[[MULTIPLY_49:.*]] = mhlo.multiply %[[ADD_84]], %[[DIVIDE_13]] : tensor<f32>
// CHECK:           %[[CONSTANT_78:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_85:.*]] = mhlo.add %[[MULTIPLY_49]], %[[CONSTANT_78]] : tensor<f32>
// CHECK:           %[[MULTIPLY_50:.*]] = mhlo.multiply %[[ADD_85]], %[[DIVIDE_13]] : tensor<f32>
// CHECK:           %[[CONSTANT_79:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_86:.*]] = mhlo.add %[[MULTIPLY_50]], %[[CONSTANT_79]] : tensor<f32>
// CHECK:           %[[CONSTANT_80:.*]] = mhlo.constant dense<97.4090881> : tensor<f32>
// CHECK:           %[[MULTIPLY_51:.*]] = mhlo.multiply %[[CONSTANT_80]], %[[ADD_86]] : tensor<f32>
// CHECK:           %[[SUBTRACT_8:.*]] = mhlo.subtract %[[CONSTANT_0]], %[[VAL_1]] : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_81:.*]] = mhlo.constant dense<4.000000e+00> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_82:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_83:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK:           %[[NEGATE_3:.*]] = mhlo.negate %[[CONSTANT_81]] : tensor<f32>
// CHECK:           %[[POWER_11:.*]] = mhlo.power %[[SUBTRACT_8]], %[[NEGATE_3]] : tensor<f32>
// CHECK:           %[[ADD_87:.*]] = mhlo.add %[[SUBTRACT_8]], %[[CONSTANT_83]] : tensor<f32>
// CHECK:           %[[POWER_12:.*]] = mhlo.power %[[ADD_87]], %[[NEGATE_3]] : tensor<f32>
// CHECK:           %[[ADD_88:.*]] = mhlo.add %[[POWER_11]], %[[POWER_12]] : tensor<f32>
// CHECK:           %[[ADD_89:.*]] = mhlo.add %[[ADD_87]], %[[CONSTANT_83]] : tensor<f32>
// CHECK:           %[[POWER_13:.*]] = mhlo.power %[[ADD_89]], %[[NEGATE_3]] : tensor<f32>
// CHECK:           %[[ADD_90:.*]] = mhlo.add %[[ADD_88]], %[[POWER_13]] : tensor<f32>
// CHECK:           %[[ADD_91:.*]] = mhlo.add %[[ADD_89]], %[[CONSTANT_83]] : tensor<f32>
// CHECK:           %[[POWER_14:.*]] = mhlo.power %[[ADD_91]], %[[NEGATE_3]] : tensor<f32>
// CHECK:           %[[ADD_92:.*]] = mhlo.add %[[ADD_90]], %[[POWER_14]] : tensor<f32>
// CHECK:           %[[ADD_93:.*]] = mhlo.add %[[ADD_91]], %[[CONSTANT_83]] : tensor<f32>
// CHECK:           %[[POWER_15:.*]] = mhlo.power %[[ADD_93]], %[[NEGATE_3]] : tensor<f32>
// CHECK:           %[[ADD_94:.*]] = mhlo.add %[[ADD_92]], %[[POWER_15]] : tensor<f32>
// CHECK:           %[[ADD_95:.*]] = mhlo.add %[[ADD_93]], %[[CONSTANT_83]] : tensor<f32>
// CHECK:           %[[POWER_16:.*]] = mhlo.power %[[ADD_95]], %[[NEGATE_3]] : tensor<f32>
// CHECK:           %[[ADD_96:.*]] = mhlo.add %[[ADD_94]], %[[POWER_16]] : tensor<f32>
// CHECK:           %[[ADD_97:.*]] = mhlo.add %[[ADD_95]], %[[CONSTANT_83]] : tensor<f32>
// CHECK:           %[[POWER_17:.*]] = mhlo.power %[[ADD_97]], %[[NEGATE_3]] : tensor<f32>
// CHECK:           %[[ADD_98:.*]] = mhlo.add %[[ADD_96]], %[[POWER_17]] : tensor<f32>
// CHECK:           %[[ADD_99:.*]] = mhlo.add %[[ADD_97]], %[[CONSTANT_83]] : tensor<f32>
// CHECK:           %[[POWER_18:.*]] = mhlo.power %[[ADD_99]], %[[NEGATE_3]] : tensor<f32>
// CHECK:           %[[ADD_100:.*]] = mhlo.add %[[ADD_98]], %[[POWER_18]] : tensor<f32>
// CHECK:           %[[ADD_101:.*]] = mhlo.add %[[ADD_99]], %[[CONSTANT_83]] : tensor<f32>
// CHECK:           %[[POWER_19:.*]] = mhlo.power %[[ADD_101]], %[[NEGATE_3]] : tensor<f32>
// CHECK:           %[[ADD_102:.*]] = mhlo.add %[[ADD_100]], %[[POWER_19]] : tensor<f32>
// CHECK:           %[[ADD_103:.*]] = mhlo.add %[[ADD_101]], %[[CONSTANT_83]] : tensor<f32>
// CHECK:           %[[POWER_20:.*]] = mhlo.power %[[ADD_103]], %[[NEGATE_3]] : tensor<f32>
// CHECK:           %[[ADD_104:.*]] = mhlo.add %[[ADD_102]], %[[POWER_20]] : tensor<f32>
// CHECK:           %[[ADD_105:.*]] = mhlo.add %[[ADD_103]], %[[CONSTANT_83]] : tensor<f32>
// CHECK:           %[[POWER_21:.*]] = mhlo.power %[[ADD_105]], %[[NEGATE_3]] : tensor<f32>
// CHECK:           %[[CONSTANT_84:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK:           %[[MULTIPLY_52:.*]] = mhlo.multiply %[[POWER_21]], %[[ADD_105]] : tensor<f32>
// CHECK:           %[[SUBTRACT_9:.*]] = mhlo.subtract %[[CONSTANT_81]], %[[CONSTANT_84]] : tensor<f32>
// CHECK:           %[[DIVIDE_14:.*]] = mhlo.divide %[[MULTIPLY_52]], %[[SUBTRACT_9]] : tensor<f32>
// CHECK:           %[[MULTIPLY_53:.*]] = mhlo.multiply %[[ADD_105]], %[[ADD_105]] : tensor<f32>
// CHECK:           %[[DIVIDE_15:.*]] = mhlo.divide %[[CONSTANT_83]], %[[MULTIPLY_53]] : tensor<f32>
// CHECK:           %[[CONSTANT_85:.*]] = mhlo.constant dense<2.200000e+01> : tensor<f32>
// CHECK:           %[[ADD_106:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_85]] : tensor<f32>
// CHECK:           %[[CONSTANT_86:.*]] = mhlo.constant dense<2.100000e+01> : tensor<f32>
// CHECK:           %[[ADD_107:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_86]] : tensor<f32>
// CHECK:           %[[MULTIPLY_54:.*]] = mhlo.multiply %[[ADD_106]], %[[ADD_107]] : tensor<f32>
// CHECK:           %[[CONSTANT_87:.*]] = mhlo.constant dense<-1.39544646E-19> : tensor<f32>
// CHECK:           %[[ADD_108:.*]] = mhlo.add %[[CONSTANT_82]], %[[CONSTANT_87]] : tensor<f32>
// CHECK:           %[[MULTIPLY_55:.*]] = mhlo.multiply %[[DIVIDE_15]], %[[ADD_108]] : tensor<f32>
// CHECK:           %[[MULTIPLY_56:.*]] = mhlo.multiply %[[MULTIPLY_54]], %[[MULTIPLY_55]] : tensor<f32>
// CHECK:           %[[CONSTANT_88:.*]] = mhlo.constant dense<2.000000e+01> : tensor<f32>
// CHECK:           %[[ADD_109:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_88]] : tensor<f32>
// CHECK:           %[[CONSTANT_89:.*]] = mhlo.constant dense<1.900000e+01> : tensor<f32>
// CHECK:           %[[ADD_110:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_89]] : tensor<f32>
// CHECK:           %[[MULTIPLY_57:.*]] = mhlo.multiply %[[ADD_109]], %[[ADD_110]] : tensor<f32>
// CHECK:           %[[CONSTANT_90:.*]] = mhlo.constant dense<5.50900303E-18> : tensor<f32>
// CHECK:           %[[ADD_111:.*]] = mhlo.add %[[MULTIPLY_56]], %[[CONSTANT_90]] : tensor<f32>
// CHECK:           %[[MULTIPLY_58:.*]] = mhlo.multiply %[[DIVIDE_15]], %[[ADD_111]] : tensor<f32>
// CHECK:           %[[MULTIPLY_59:.*]] = mhlo.multiply %[[MULTIPLY_57]], %[[MULTIPLY_58]] : tensor<f32>
// CHECK:           %[[CONSTANT_91:.*]] = mhlo.constant dense<1.800000e+01> : tensor<f32>
// CHECK:           %[[ADD_112:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_91]] : tensor<f32>
// CHECK:           %[[CONSTANT_92:.*]] = mhlo.constant dense<1.700000e+01> : tensor<f32>
// CHECK:           %[[ADD_113:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_92]] : tensor<f32>
// CHECK:           %[[MULTIPLY_60:.*]] = mhlo.multiply %[[ADD_112]], %[[ADD_113]] : tensor<f32>
// CHECK:           %[[CONSTANT_93:.*]] = mhlo.constant dense<-2.17486866E-16> : tensor<f32>
// CHECK:           %[[ADD_114:.*]] = mhlo.add %[[MULTIPLY_59]], %[[CONSTANT_93]] : tensor<f32>
// CHECK:           %[[MULTIPLY_61:.*]] = mhlo.multiply %[[DIVIDE_15]], %[[ADD_114]] : tensor<f32>
// CHECK:           %[[MULTIPLY_62:.*]] = mhlo.multiply %[[MULTIPLY_60]], %[[MULTIPLY_61]] : tensor<f32>
// CHECK:           %[[CONSTANT_94:.*]] = mhlo.constant dense<1.600000e+01> : tensor<f32>
// CHECK:           %[[ADD_115:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_94]] : tensor<f32>
// CHECK:           %[[CONSTANT_95:.*]] = mhlo.constant dense<1.500000e+01> : tensor<f32>
// CHECK:           %[[ADD_116:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_95]] : tensor<f32>
// CHECK:           %[[MULTIPLY_63:.*]] = mhlo.multiply %[[ADD_115]], %[[ADD_116]] : tensor<f32>
// CHECK:           %[[CONSTANT_96:.*]] = mhlo.constant dense<8.58606213E-15> : tensor<f32>
// CHECK:           %[[ADD_117:.*]] = mhlo.add %[[MULTIPLY_62]], %[[CONSTANT_96]] : tensor<f32>
// CHECK:           %[[MULTIPLY_64:.*]] = mhlo.multiply %[[DIVIDE_15]], %[[ADD_117]] : tensor<f32>
// CHECK:           %[[MULTIPLY_65:.*]] = mhlo.multiply %[[MULTIPLY_63]], %[[MULTIPLY_64]] : tensor<f32>
// CHECK:           %[[CONSTANT_97:.*]] = mhlo.constant dense<1.400000e+01> : tensor<f32>
// CHECK:           %[[ADD_118:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_97]] : tensor<f32>
// CHECK:           %[[CONSTANT_98:.*]] = mhlo.constant dense<1.300000e+01> : tensor<f32>
// CHECK:           %[[ADD_119:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_98]] : tensor<f32>
// CHECK:           %[[MULTIPLY_66:.*]] = mhlo.multiply %[[ADD_118]], %[[ADD_119]] : tensor<f32>
// CHECK:           %[[CONSTANT_99:.*]] = mhlo.constant dense<-3.3896803E-13> : tensor<f32>
// CHECK:           %[[ADD_120:.*]] = mhlo.add %[[MULTIPLY_65]], %[[CONSTANT_99]] : tensor<f32>
// CHECK:           %[[MULTIPLY_67:.*]] = mhlo.multiply %[[DIVIDE_15]], %[[ADD_120]] : tensor<f32>
// CHECK:           %[[MULTIPLY_68:.*]] = mhlo.multiply %[[MULTIPLY_66]], %[[MULTIPLY_67]] : tensor<f32>
// CHECK:           %[[CONSTANT_100:.*]] = mhlo.constant dense<1.200000e+01> : tensor<f32>
// CHECK:           %[[ADD_121:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_100]] : tensor<f32>
// CHECK:           %[[CONSTANT_101:.*]] = mhlo.constant dense<1.100000e+01> : tensor<f32>
// CHECK:           %[[ADD_122:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_101]] : tensor<f32>
// CHECK:           %[[MULTIPLY_69:.*]] = mhlo.multiply %[[ADD_121]], %[[ADD_122]] : tensor<f32>
// CHECK:           %[[CONSTANT_102:.*]] = mhlo.constant dense<1.33825364E-11> : tensor<f32>
// CHECK:           %[[ADD_123:.*]] = mhlo.add %[[MULTIPLY_68]], %[[CONSTANT_102]] : tensor<f32>
// CHECK:           %[[MULTIPLY_70:.*]] = mhlo.multiply %[[DIVIDE_15]], %[[ADD_123]] : tensor<f32>
// CHECK:           %[[MULTIPLY_71:.*]] = mhlo.multiply %[[MULTIPLY_69]], %[[MULTIPLY_70]] : tensor<f32>
// CHECK:           %[[CONSTANT_103:.*]] = mhlo.constant dense<1.000000e+01> : tensor<f32>
// CHECK:           %[[ADD_124:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_103]] : tensor<f32>
// CHECK:           %[[CONSTANT_104:.*]] = mhlo.constant dense<9.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_125:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_104]] : tensor<f32>
// CHECK:           %[[MULTIPLY_72:.*]] = mhlo.multiply %[[ADD_124]], %[[ADD_125]] : tensor<f32>
// CHECK:           %[[CONSTANT_105:.*]] = mhlo.constant dense<-5.28419031E-10> : tensor<f32>
// CHECK:           %[[ADD_126:.*]] = mhlo.add %[[MULTIPLY_71]], %[[CONSTANT_105]] : tensor<f32>
// CHECK:           %[[MULTIPLY_73:.*]] = mhlo.multiply %[[DIVIDE_15]], %[[ADD_126]] : tensor<f32>
// CHECK:           %[[MULTIPLY_74:.*]] = mhlo.multiply %[[MULTIPLY_72]], %[[MULTIPLY_73]] : tensor<f32>
// CHECK:           %[[CONSTANT_106:.*]] = mhlo.constant dense<8.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_127:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_106]] : tensor<f32>
// CHECK:           %[[CONSTANT_107:.*]] = mhlo.constant dense<7.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_128:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_107]] : tensor<f32>
// CHECK:           %[[MULTIPLY_75:.*]] = mhlo.multiply %[[ADD_127]], %[[ADD_128]] : tensor<f32>
// CHECK:           %[[CONSTANT_108:.*]] = mhlo.constant dense<2.08767563E-8> : tensor<f32>
// CHECK:           %[[ADD_129:.*]] = mhlo.add %[[MULTIPLY_74]], %[[CONSTANT_108]] : tensor<f32>
// CHECK:           %[[MULTIPLY_76:.*]] = mhlo.multiply %[[DIVIDE_15]], %[[ADD_129]] : tensor<f32>
// CHECK:           %[[MULTIPLY_77:.*]] = mhlo.multiply %[[MULTIPLY_75]], %[[MULTIPLY_76]] : tensor<f32>
// CHECK:           %[[CONSTANT_109:.*]] = mhlo.constant dense<6.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_130:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_109]] : tensor<f32>
// CHECK:           %[[CONSTANT_110:.*]] = mhlo.constant dense<5.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_131:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_110]] : tensor<f32>
// CHECK:           %[[MULTIPLY_78:.*]] = mhlo.multiply %[[ADD_130]], %[[ADD_131]] : tensor<f32>
// CHECK:           %[[CONSTANT_111:.*]] = mhlo.constant dense<-8.26719599E-7> : tensor<f32>
// CHECK:           %[[ADD_132:.*]] = mhlo.add %[[MULTIPLY_77]], %[[CONSTANT_111]] : tensor<f32>
// CHECK:           %[[MULTIPLY_79:.*]] = mhlo.multiply %[[DIVIDE_15]], %[[ADD_132]] : tensor<f32>
// CHECK:           %[[MULTIPLY_80:.*]] = mhlo.multiply %[[MULTIPLY_78]], %[[MULTIPLY_79]] : tensor<f32>
// CHECK:           %[[CONSTANT_112:.*]] = mhlo.constant dense<4.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_133:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_112]] : tensor<f32>
// CHECK:           %[[CONSTANT_113:.*]] = mhlo.constant dense<3.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_134:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_113]] : tensor<f32>
// CHECK:           %[[MULTIPLY_81:.*]] = mhlo.multiply %[[ADD_133]], %[[ADD_134]] : tensor<f32>
// CHECK:           %[[CONSTANT_114:.*]] = mhlo.constant dense<3.30687835E-5> : tensor<f32>
// CHECK:           %[[ADD_135:.*]] = mhlo.add %[[MULTIPLY_80]], %[[CONSTANT_114]] : tensor<f32>
// CHECK:           %[[MULTIPLY_82:.*]] = mhlo.multiply %[[DIVIDE_15]], %[[ADD_135]] : tensor<f32>
// CHECK:           %[[MULTIPLY_83:.*]] = mhlo.multiply %[[MULTIPLY_81]], %[[MULTIPLY_82]] : tensor<f32>
// CHECK:           %[[CONSTANT_115:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_136:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_115]] : tensor<f32>
// CHECK:           %[[CONSTANT_116:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_137:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_116]] : tensor<f32>
// CHECK:           %[[MULTIPLY_84:.*]] = mhlo.multiply %[[ADD_136]], %[[ADD_137]] : tensor<f32>
// CHECK:           %[[CONSTANT_117:.*]] = mhlo.constant dense<-0.00138888892> : tensor<f32>
// CHECK:           %[[ADD_138:.*]] = mhlo.add %[[MULTIPLY_83]], %[[CONSTANT_117]] : tensor<f32>
// CHECK:           %[[MULTIPLY_85:.*]] = mhlo.multiply %[[DIVIDE_15]], %[[ADD_138]] : tensor<f32>
// CHECK:           %[[MULTIPLY_86:.*]] = mhlo.multiply %[[MULTIPLY_84]], %[[MULTIPLY_85]] : tensor<f32>
// CHECK:           %[[CONSTANT_118:.*]] = mhlo.constant dense<5.000000e-01> : tensor<f32>
// CHECK:           %[[DIVIDE_16:.*]] = mhlo.divide %[[CONSTANT_81]], %[[ADD_105]] : tensor<f32>
// CHECK:           %[[CONSTANT_119:.*]] = mhlo.constant dense<0.0833333358> : tensor<f32>
// CHECK:           %[[ADD_139:.*]] = mhlo.add %[[CONSTANT_119]], %[[MULTIPLY_86]] : tensor<f32>
// CHECK:           %[[MULTIPLY_87:.*]] = mhlo.multiply %[[DIVIDE_16]], %[[ADD_139]] : tensor<f32>
// CHECK:           %[[ADD_140:.*]] = mhlo.add %[[CONSTANT_118]], %[[MULTIPLY_87]] : tensor<f32>
// CHECK:           %[[MULTIPLY_88:.*]] = mhlo.multiply %[[POWER_21]], %[[ADD_140]] : tensor<f32>
// CHECK:           %[[ADD_141:.*]] = mhlo.add %[[ADD_104]], %[[DIVIDE_14]] : tensor<f32>
// CHECK:           %[[ADD_142:.*]] = mhlo.add %[[ADD_141]], %[[MULTIPLY_88]] : tensor<f32>
// CHECK:           %[[ABS_5:.*]] = mhlo.abs %[[POWER_21]] : tensor<f32>
// CHECK:           %[[ABS_6:.*]] = mhlo.abs %[[ADD_104]] : tensor<f32>
// CHECK:           %[[CONSTANT_120:.*]] = mhlo.constant dense<1.401300e-45> : tensor<f32>
// CHECK:           %[[MULTIPLY_89:.*]] = mhlo.multiply %[[ABS_6]], %[[CONSTANT_120]] : tensor<f32>
// CHECK:           %[[COMPARE_11:.*]] = mhlo.compare LT, %[[ABS_5]], %[[MULTIPLY_89]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[SELECT_11:.*]] = mhlo.select %[[COMPARE_11]], %[[ADD_104]], %[[ADD_142]] : tensor<i1>, tensor<f32>
// CHECK:           %[[CONSTANT_121:.*]] = mhlo.constant dense<0x7FC00000> : tensor<f32>
// CHECK:           %[[COMPARE_12:.*]] = mhlo.compare LT, %[[CONSTANT_81]], %[[CONSTANT_84]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[SELECT_12:.*]] = mhlo.select %[[COMPARE_12]], %[[CONSTANT_121]], %[[SELECT_11]] : tensor<i1>, tensor<f32>
// CHECK:           %[[COMPARE_13:.*]] = mhlo.compare LE, %[[SUBTRACT_8]], %[[CONSTANT_82]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[FLOOR_6:.*]] = mhlo.floor %[[CONSTANT_81]] : tensor<f32>
// CHECK:           %[[COMPARE_14:.*]] = mhlo.compare NE, %[[CONSTANT_81]], %[[FLOOR_6]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[AND_3:.*]] = mhlo.and %[[COMPARE_13]], %[[COMPARE_14]] : tensor<i1>
// CHECK:           %[[SELECT_13:.*]] = mhlo.select %[[AND_3]], %[[CONSTANT_121]], %[[SELECT_12]] : tensor<i1>, tensor<f32>
// CHECK:           %[[CONSTANT_122:.*]] = mhlo.constant dense<0x7F800000> : tensor<f32>
// CHECK:           %[[FLOOR_7:.*]] = mhlo.floor %[[SUBTRACT_8]] : tensor<f32>
// CHECK:           %[[COMPARE_15:.*]] = mhlo.compare EQ, %[[SUBTRACT_8]], %[[FLOOR_7]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[AND_4:.*]] = mhlo.and %[[COMPARE_13]], %[[COMPARE_15]] : tensor<i1>
// CHECK:           %[[CONSTANT_123:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f32>
// CHECK:           %[[FLOOR_8:.*]] = mhlo.floor %[[CONSTANT_81]] : tensor<f32>
// CHECK:           %[[COMPARE_16:.*]] = mhlo.compare EQ, %[[CONSTANT_81]], %[[FLOOR_8]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[REMAINDER_2:.*]] = mhlo.remainder %[[CONSTANT_81]], %[[CONSTANT_123]] : tensor<f32>
// CHECK:           %[[COMPARE_17:.*]] = mhlo.compare EQ, %[[REMAINDER_2]], %[[CONSTANT_82]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[AND_5:.*]] = mhlo.and %[[COMPARE_16]], %[[COMPARE_17]] : tensor<i1>
// CHECK:           %[[SELECT_14:.*]] = mhlo.select %[[AND_5]], %[[CONSTANT_122]], %[[CONSTANT_121]] : tensor<i1>, tensor<f32>
// CHECK:           %[[SELECT_15:.*]] = mhlo.select %[[AND_4]], %[[SELECT_14]], %[[SELECT_13]] : tensor<i1>, tensor<f32>
// CHECK:           %[[COMPARE_18:.*]] = mhlo.compare EQ, %[[CONSTANT_81]], %[[CONSTANT_83]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[SELECT_16:.*]] = mhlo.select %[[COMPARE_18]], %[[CONSTANT_122]], %[[SELECT_15]] : tensor<i1>, tensor<f32>
// CHECK:           %[[CONSTANT_124:.*]] = mhlo.constant dense<6.000000e+00> : tensor<f32>
// CHECK:           %[[MULTIPLY_90:.*]] = mhlo.multiply %[[CONSTANT_124]], %[[SELECT_16]] : tensor<f32>
// CHECK:           %[[CONSTANT_125:.*]] = mhlo.constant dense<-1.000000e+00> : tensor<f32>
// CHECK:           %[[MULTIPLY_91:.*]] = mhlo.multiply %[[CONSTANT_125]], %[[MULTIPLY_90]] : tensor<f32>
// CHECK:           %[[ADD_143:.*]] = mhlo.add %[[MULTIPLY_51]], %[[MULTIPLY_91]] : tensor<f32>
// CHECK:           %[[CONSTANT_126:.*]] = mhlo.constant dense<3.000000e+00> : tensor<f32>
// CHECK:           %[[COMPARE_19:.*]] = mhlo.compare EQ, %[[FLOOR_5]], %[[CONSTANT_126]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[SELECT_17:.*]] = mhlo.select %[[COMPARE_19]], %[[ADD_143]], %[[MULTIPLY_42]] : tensor<i1>, tensor<f32>
// CHECK:           %[[CONSTANT_127:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f32>
// CHECK:           %[[MULTIPLY_92:.*]] = mhlo.multiply %[[CONSTANT_127]], %[[DIVIDE_13]] : tensor<f32>
// CHECK:           %[[CONSTANT_128:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_144:.*]] = mhlo.add %[[MULTIPLY_92]], %[[CONSTANT_128]] : tensor<f32>
// CHECK:           %[[MULTIPLY_93:.*]] = mhlo.multiply %[[ADD_144]], %[[DIVIDE_13]] : tensor<f32>
// CHECK:           %[[CONSTANT_129:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_145:.*]] = mhlo.add %[[MULTIPLY_93]], %[[CONSTANT_129]] : tensor<f32>
// CHECK:           %[[MULTIPLY_94:.*]] = mhlo.multiply %[[ADD_145]], %[[DIVIDE_13]] : tensor<f32>
// CHECK:           %[[CONSTANT_130:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_146:.*]] = mhlo.add %[[MULTIPLY_94]], %[[CONSTANT_130]] : tensor<f32>
// CHECK:           %[[MULTIPLY_95:.*]] = mhlo.multiply %[[ADD_146]], %[[DIVIDE_13]] : tensor<f32>
// CHECK:           %[[CONSTANT_131:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_147:.*]] = mhlo.add %[[MULTIPLY_95]], %[[CONSTANT_131]] : tensor<f32>
// CHECK:           %[[MULTIPLY_96:.*]] = mhlo.multiply %[[ADD_147]], %[[DIVIDE_13]] : tensor<f32>
// CHECK:           %[[CONSTANT_132:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_148:.*]] = mhlo.add %[[MULTIPLY_96]], %[[CONSTANT_132]] : tensor<f32>
// CHECK:           %[[CONSTANT_133:.*]] = mhlo.constant dense<-31.0062771> : tensor<f32>
// CHECK:           %[[MULTIPLY_97:.*]] = mhlo.multiply %[[CONSTANT_133]], %[[ADD_148]] : tensor<f32>
// CHECK:           %[[SUBTRACT_10:.*]] = mhlo.subtract %[[CONSTANT_0]], %[[VAL_1]] : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_134:.*]] = mhlo.constant dense<3.000000e+00> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_135:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_136:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK:           %[[NEGATE_4:.*]] = mhlo.negate %[[CONSTANT_134]] : tensor<f32>
// CHECK:           %[[POWER_22:.*]] = mhlo.power %[[SUBTRACT_10]], %[[NEGATE_4]] : tensor<f32>
// CHECK:           %[[ADD_149:.*]] = mhlo.add %[[SUBTRACT_10]], %[[CONSTANT_136]] : tensor<f32>
// CHECK:           %[[POWER_23:.*]] = mhlo.power %[[ADD_149]], %[[NEGATE_4]] : tensor<f32>
// CHECK:           %[[ADD_150:.*]] = mhlo.add %[[POWER_22]], %[[POWER_23]] : tensor<f32>
// CHECK:           %[[ADD_151:.*]] = mhlo.add %[[ADD_149]], %[[CONSTANT_136]] : tensor<f32>
// CHECK:           %[[POWER_24:.*]] = mhlo.power %[[ADD_151]], %[[NEGATE_4]] : tensor<f32>
// CHECK:           %[[ADD_152:.*]] = mhlo.add %[[ADD_150]], %[[POWER_24]] : tensor<f32>
// CHECK:           %[[ADD_153:.*]] = mhlo.add %[[ADD_151]], %[[CONSTANT_136]] : tensor<f32>
// CHECK:           %[[POWER_25:.*]] = mhlo.power %[[ADD_153]], %[[NEGATE_4]] : tensor<f32>
// CHECK:           %[[ADD_154:.*]] = mhlo.add %[[ADD_152]], %[[POWER_25]] : tensor<f32>
// CHECK:           %[[ADD_155:.*]] = mhlo.add %[[ADD_153]], %[[CONSTANT_136]] : tensor<f32>
// CHECK:           %[[POWER_26:.*]] = mhlo.power %[[ADD_155]], %[[NEGATE_4]] : tensor<f32>
// CHECK:           %[[ADD_156:.*]] = mhlo.add %[[ADD_154]], %[[POWER_26]] : tensor<f32>
// CHECK:           %[[ADD_157:.*]] = mhlo.add %[[ADD_155]], %[[CONSTANT_136]] : tensor<f32>
// CHECK:           %[[POWER_27:.*]] = mhlo.power %[[ADD_157]], %[[NEGATE_4]] : tensor<f32>
// CHECK:           %[[ADD_158:.*]] = mhlo.add %[[ADD_156]], %[[POWER_27]] : tensor<f32>
// CHECK:           %[[ADD_159:.*]] = mhlo.add %[[ADD_157]], %[[CONSTANT_136]] : tensor<f32>
// CHECK:           %[[POWER_28:.*]] = mhlo.power %[[ADD_159]], %[[NEGATE_4]] : tensor<f32>
// CHECK:           %[[ADD_160:.*]] = mhlo.add %[[ADD_158]], %[[POWER_28]] : tensor<f32>
// CHECK:           %[[ADD_161:.*]] = mhlo.add %[[ADD_159]], %[[CONSTANT_136]] : tensor<f32>
// CHECK:           %[[POWER_29:.*]] = mhlo.power %[[ADD_161]], %[[NEGATE_4]] : tensor<f32>
// CHECK:           %[[ADD_162:.*]] = mhlo.add %[[ADD_160]], %[[POWER_29]] : tensor<f32>
// CHECK:           %[[ADD_163:.*]] = mhlo.add %[[ADD_161]], %[[CONSTANT_136]] : tensor<f32>
// CHECK:           %[[POWER_30:.*]] = mhlo.power %[[ADD_163]], %[[NEGATE_4]] : tensor<f32>
// CHECK:           %[[ADD_164:.*]] = mhlo.add %[[ADD_162]], %[[POWER_30]] : tensor<f32>
// CHECK:           %[[ADD_165:.*]] = mhlo.add %[[ADD_163]], %[[CONSTANT_136]] : tensor<f32>
// CHECK:           %[[POWER_31:.*]] = mhlo.power %[[ADD_165]], %[[NEGATE_4]] : tensor<f32>
// CHECK:           %[[ADD_166:.*]] = mhlo.add %[[ADD_164]], %[[POWER_31]] : tensor<f32>
// CHECK:           %[[ADD_167:.*]] = mhlo.add %[[ADD_165]], %[[CONSTANT_136]] : tensor<f32>
// CHECK:           %[[POWER_32:.*]] = mhlo.power %[[ADD_167]], %[[NEGATE_4]] : tensor<f32>
// CHECK:           %[[CONSTANT_137:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK:           %[[MULTIPLY_98:.*]] = mhlo.multiply %[[POWER_32]], %[[ADD_167]] : tensor<f32>
// CHECK:           %[[SUBTRACT_11:.*]] = mhlo.subtract %[[CONSTANT_134]], %[[CONSTANT_137]] : tensor<f32>
// CHECK:           %[[DIVIDE_17:.*]] = mhlo.divide %[[MULTIPLY_98]], %[[SUBTRACT_11]] : tensor<f32>
// CHECK:           %[[MULTIPLY_99:.*]] = mhlo.multiply %[[ADD_167]], %[[ADD_167]] : tensor<f32>
// CHECK:           %[[DIVIDE_18:.*]] = mhlo.divide %[[CONSTANT_136]], %[[MULTIPLY_99]] : tensor<f32>
// CHECK:           %[[CONSTANT_138:.*]] = mhlo.constant dense<2.200000e+01> : tensor<f32>
// CHECK:           %[[ADD_168:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_138]] : tensor<f32>
// CHECK:           %[[CONSTANT_139:.*]] = mhlo.constant dense<2.100000e+01> : tensor<f32>
// CHECK:           %[[ADD_169:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_139]] : tensor<f32>
// CHECK:           %[[MULTIPLY_100:.*]] = mhlo.multiply %[[ADD_168]], %[[ADD_169]] : tensor<f32>
// CHECK:           %[[CONSTANT_140:.*]] = mhlo.constant dense<-1.39544646E-19> : tensor<f32>
// CHECK:           %[[ADD_170:.*]] = mhlo.add %[[CONSTANT_135]], %[[CONSTANT_140]] : tensor<f32>
// CHECK:           %[[MULTIPLY_101:.*]] = mhlo.multiply %[[DIVIDE_18]], %[[ADD_170]] : tensor<f32>
// CHECK:           %[[MULTIPLY_102:.*]] = mhlo.multiply %[[MULTIPLY_100]], %[[MULTIPLY_101]] : tensor<f32>
// CHECK:           %[[CONSTANT_141:.*]] = mhlo.constant dense<2.000000e+01> : tensor<f32>
// CHECK:           %[[ADD_171:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_141]] : tensor<f32>
// CHECK:           %[[CONSTANT_142:.*]] = mhlo.constant dense<1.900000e+01> : tensor<f32>
// CHECK:           %[[ADD_172:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_142]] : tensor<f32>
// CHECK:           %[[MULTIPLY_103:.*]] = mhlo.multiply %[[ADD_171]], %[[ADD_172]] : tensor<f32>
// CHECK:           %[[CONSTANT_143:.*]] = mhlo.constant dense<5.50900303E-18> : tensor<f32>
// CHECK:           %[[ADD_173:.*]] = mhlo.add %[[MULTIPLY_102]], %[[CONSTANT_143]] : tensor<f32>
// CHECK:           %[[MULTIPLY_104:.*]] = mhlo.multiply %[[DIVIDE_18]], %[[ADD_173]] : tensor<f32>
// CHECK:           %[[MULTIPLY_105:.*]] = mhlo.multiply %[[MULTIPLY_103]], %[[MULTIPLY_104]] : tensor<f32>
// CHECK:           %[[CONSTANT_144:.*]] = mhlo.constant dense<1.800000e+01> : tensor<f32>
// CHECK:           %[[ADD_174:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_144]] : tensor<f32>
// CHECK:           %[[CONSTANT_145:.*]] = mhlo.constant dense<1.700000e+01> : tensor<f32>
// CHECK:           %[[ADD_175:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_145]] : tensor<f32>
// CHECK:           %[[MULTIPLY_106:.*]] = mhlo.multiply %[[ADD_174]], %[[ADD_175]] : tensor<f32>
// CHECK:           %[[CONSTANT_146:.*]] = mhlo.constant dense<-2.17486866E-16> : tensor<f32>
// CHECK:           %[[ADD_176:.*]] = mhlo.add %[[MULTIPLY_105]], %[[CONSTANT_146]] : tensor<f32>
// CHECK:           %[[MULTIPLY_107:.*]] = mhlo.multiply %[[DIVIDE_18]], %[[ADD_176]] : tensor<f32>
// CHECK:           %[[MULTIPLY_108:.*]] = mhlo.multiply %[[MULTIPLY_106]], %[[MULTIPLY_107]] : tensor<f32>
// CHECK:           %[[CONSTANT_147:.*]] = mhlo.constant dense<1.600000e+01> : tensor<f32>
// CHECK:           %[[ADD_177:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_147]] : tensor<f32>
// CHECK:           %[[CONSTANT_148:.*]] = mhlo.constant dense<1.500000e+01> : tensor<f32>
// CHECK:           %[[ADD_178:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_148]] : tensor<f32>
// CHECK:           %[[MULTIPLY_109:.*]] = mhlo.multiply %[[ADD_177]], %[[ADD_178]] : tensor<f32>
// CHECK:           %[[CONSTANT_149:.*]] = mhlo.constant dense<8.58606213E-15> : tensor<f32>
// CHECK:           %[[ADD_179:.*]] = mhlo.add %[[MULTIPLY_108]], %[[CONSTANT_149]] : tensor<f32>
// CHECK:           %[[MULTIPLY_110:.*]] = mhlo.multiply %[[DIVIDE_18]], %[[ADD_179]] : tensor<f32>
// CHECK:           %[[MULTIPLY_111:.*]] = mhlo.multiply %[[MULTIPLY_109]], %[[MULTIPLY_110]] : tensor<f32>
// CHECK:           %[[CONSTANT_150:.*]] = mhlo.constant dense<1.400000e+01> : tensor<f32>
// CHECK:           %[[ADD_180:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_150]] : tensor<f32>
// CHECK:           %[[CONSTANT_151:.*]] = mhlo.constant dense<1.300000e+01> : tensor<f32>
// CHECK:           %[[ADD_181:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_151]] : tensor<f32>
// CHECK:           %[[MULTIPLY_112:.*]] = mhlo.multiply %[[ADD_180]], %[[ADD_181]] : tensor<f32>
// CHECK:           %[[CONSTANT_152:.*]] = mhlo.constant dense<-3.3896803E-13> : tensor<f32>
// CHECK:           %[[ADD_182:.*]] = mhlo.add %[[MULTIPLY_111]], %[[CONSTANT_152]] : tensor<f32>
// CHECK:           %[[MULTIPLY_113:.*]] = mhlo.multiply %[[DIVIDE_18]], %[[ADD_182]] : tensor<f32>
// CHECK:           %[[MULTIPLY_114:.*]] = mhlo.multiply %[[MULTIPLY_112]], %[[MULTIPLY_113]] : tensor<f32>
// CHECK:           %[[CONSTANT_153:.*]] = mhlo.constant dense<1.200000e+01> : tensor<f32>
// CHECK:           %[[ADD_183:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_153]] : tensor<f32>
// CHECK:           %[[CONSTANT_154:.*]] = mhlo.constant dense<1.100000e+01> : tensor<f32>
// CHECK:           %[[ADD_184:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_154]] : tensor<f32>
// CHECK:           %[[MULTIPLY_115:.*]] = mhlo.multiply %[[ADD_183]], %[[ADD_184]] : tensor<f32>
// CHECK:           %[[CONSTANT_155:.*]] = mhlo.constant dense<1.33825364E-11> : tensor<f32>
// CHECK:           %[[ADD_185:.*]] = mhlo.add %[[MULTIPLY_114]], %[[CONSTANT_155]] : tensor<f32>
// CHECK:           %[[MULTIPLY_116:.*]] = mhlo.multiply %[[DIVIDE_18]], %[[ADD_185]] : tensor<f32>
// CHECK:           %[[MULTIPLY_117:.*]] = mhlo.multiply %[[MULTIPLY_115]], %[[MULTIPLY_116]] : tensor<f32>
// CHECK:           %[[CONSTANT_156:.*]] = mhlo.constant dense<1.000000e+01> : tensor<f32>
// CHECK:           %[[ADD_186:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_156]] : tensor<f32>
// CHECK:           %[[CONSTANT_157:.*]] = mhlo.constant dense<9.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_187:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_157]] : tensor<f32>
// CHECK:           %[[MULTIPLY_118:.*]] = mhlo.multiply %[[ADD_186]], %[[ADD_187]] : tensor<f32>
// CHECK:           %[[CONSTANT_158:.*]] = mhlo.constant dense<-5.28419031E-10> : tensor<f32>
// CHECK:           %[[ADD_188:.*]] = mhlo.add %[[MULTIPLY_117]], %[[CONSTANT_158]] : tensor<f32>
// CHECK:           %[[MULTIPLY_119:.*]] = mhlo.multiply %[[DIVIDE_18]], %[[ADD_188]] : tensor<f32>
// CHECK:           %[[MULTIPLY_120:.*]] = mhlo.multiply %[[MULTIPLY_118]], %[[MULTIPLY_119]] : tensor<f32>
// CHECK:           %[[CONSTANT_159:.*]] = mhlo.constant dense<8.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_189:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_159]] : tensor<f32>
// CHECK:           %[[CONSTANT_160:.*]] = mhlo.constant dense<7.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_190:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_160]] : tensor<f32>
// CHECK:           %[[MULTIPLY_121:.*]] = mhlo.multiply %[[ADD_189]], %[[ADD_190]] : tensor<f32>
// CHECK:           %[[CONSTANT_161:.*]] = mhlo.constant dense<2.08767563E-8> : tensor<f32>
// CHECK:           %[[ADD_191:.*]] = mhlo.add %[[MULTIPLY_120]], %[[CONSTANT_161]] : tensor<f32>
// CHECK:           %[[MULTIPLY_122:.*]] = mhlo.multiply %[[DIVIDE_18]], %[[ADD_191]] : tensor<f32>
// CHECK:           %[[MULTIPLY_123:.*]] = mhlo.multiply %[[MULTIPLY_121]], %[[MULTIPLY_122]] : tensor<f32>
// CHECK:           %[[CONSTANT_162:.*]] = mhlo.constant dense<6.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_192:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_162]] : tensor<f32>
// CHECK:           %[[CONSTANT_163:.*]] = mhlo.constant dense<5.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_193:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_163]] : tensor<f32>
// CHECK:           %[[MULTIPLY_124:.*]] = mhlo.multiply %[[ADD_192]], %[[ADD_193]] : tensor<f32>
// CHECK:           %[[CONSTANT_164:.*]] = mhlo.constant dense<-8.26719599E-7> : tensor<f32>
// CHECK:           %[[ADD_194:.*]] = mhlo.add %[[MULTIPLY_123]], %[[CONSTANT_164]] : tensor<f32>
// CHECK:           %[[MULTIPLY_125:.*]] = mhlo.multiply %[[DIVIDE_18]], %[[ADD_194]] : tensor<f32>
// CHECK:           %[[MULTIPLY_126:.*]] = mhlo.multiply %[[MULTIPLY_124]], %[[MULTIPLY_125]] : tensor<f32>
// CHECK:           %[[CONSTANT_165:.*]] = mhlo.constant dense<4.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_195:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_165]] : tensor<f32>
// CHECK:           %[[CONSTANT_166:.*]] = mhlo.constant dense<3.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_196:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_166]] : tensor<f32>
// CHECK:           %[[MULTIPLY_127:.*]] = mhlo.multiply %[[ADD_195]], %[[ADD_196]] : tensor<f32>
// CHECK:           %[[CONSTANT_167:.*]] = mhlo.constant dense<3.30687835E-5> : tensor<f32>
// CHECK:           %[[ADD_197:.*]] = mhlo.add %[[MULTIPLY_126]], %[[CONSTANT_167]] : tensor<f32>
// CHECK:           %[[MULTIPLY_128:.*]] = mhlo.multiply %[[DIVIDE_18]], %[[ADD_197]] : tensor<f32>
// CHECK:           %[[MULTIPLY_129:.*]] = mhlo.multiply %[[MULTIPLY_127]], %[[MULTIPLY_128]] : tensor<f32>
// CHECK:           %[[CONSTANT_168:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_198:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_168]] : tensor<f32>
// CHECK:           %[[CONSTANT_169:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_199:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_169]] : tensor<f32>
// CHECK:           %[[MULTIPLY_130:.*]] = mhlo.multiply %[[ADD_198]], %[[ADD_199]] : tensor<f32>
// CHECK:           %[[CONSTANT_170:.*]] = mhlo.constant dense<-0.00138888892> : tensor<f32>
// CHECK:           %[[ADD_200:.*]] = mhlo.add %[[MULTIPLY_129]], %[[CONSTANT_170]] : tensor<f32>
// CHECK:           %[[MULTIPLY_131:.*]] = mhlo.multiply %[[DIVIDE_18]], %[[ADD_200]] : tensor<f32>
// CHECK:           %[[MULTIPLY_132:.*]] = mhlo.multiply %[[MULTIPLY_130]], %[[MULTIPLY_131]] : tensor<f32>
// CHECK:           %[[CONSTANT_171:.*]] = mhlo.constant dense<5.000000e-01> : tensor<f32>
// CHECK:           %[[DIVIDE_19:.*]] = mhlo.divide %[[CONSTANT_134]], %[[ADD_167]] : tensor<f32>
// CHECK:           %[[CONSTANT_172:.*]] = mhlo.constant dense<0.0833333358> : tensor<f32>
// CHECK:           %[[ADD_201:.*]] = mhlo.add %[[CONSTANT_172]], %[[MULTIPLY_132]] : tensor<f32>
// CHECK:           %[[MULTIPLY_133:.*]] = mhlo.multiply %[[DIVIDE_19]], %[[ADD_201]] : tensor<f32>
// CHECK:           %[[ADD_202:.*]] = mhlo.add %[[CONSTANT_171]], %[[MULTIPLY_133]] : tensor<f32>
// CHECK:           %[[MULTIPLY_134:.*]] = mhlo.multiply %[[POWER_32]], %[[ADD_202]] : tensor<f32>
// CHECK:           %[[ADD_203:.*]] = mhlo.add %[[ADD_166]], %[[DIVIDE_17]] : tensor<f32>
// CHECK:           %[[ADD_204:.*]] = mhlo.add %[[ADD_203]], %[[MULTIPLY_134]] : tensor<f32>
// CHECK:           %[[ABS_7:.*]] = mhlo.abs %[[POWER_32]] : tensor<f32>
// CHECK:           %[[ABS_8:.*]] = mhlo.abs %[[ADD_166]] : tensor<f32>
// CHECK:           %[[CONSTANT_173:.*]] = mhlo.constant dense<1.401300e-45> : tensor<f32>
// CHECK:           %[[MULTIPLY_135:.*]] = mhlo.multiply %[[ABS_8]], %[[CONSTANT_173]] : tensor<f32>
// CHECK:           %[[COMPARE_20:.*]] = mhlo.compare LT, %[[ABS_7]], %[[MULTIPLY_135]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[SELECT_18:.*]] = mhlo.select %[[COMPARE_20]], %[[ADD_166]], %[[ADD_204]] : tensor<i1>, tensor<f32>
// CHECK:           %[[CONSTANT_174:.*]] = mhlo.constant dense<0x7FC00000> : tensor<f32>
// CHECK:           %[[COMPARE_21:.*]] = mhlo.compare LT, %[[CONSTANT_134]], %[[CONSTANT_137]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[SELECT_19:.*]] = mhlo.select %[[COMPARE_21]], %[[CONSTANT_174]], %[[SELECT_18]] : tensor<i1>, tensor<f32>
// CHECK:           %[[COMPARE_22:.*]] = mhlo.compare LE, %[[SUBTRACT_10]], %[[CONSTANT_135]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[FLOOR_9:.*]] = mhlo.floor %[[CONSTANT_134]] : tensor<f32>
// CHECK:           %[[COMPARE_23:.*]] = mhlo.compare NE, %[[CONSTANT_134]], %[[FLOOR_9]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[AND_6:.*]] = mhlo.and %[[COMPARE_22]], %[[COMPARE_23]] : tensor<i1>
// CHECK:           %[[SELECT_20:.*]] = mhlo.select %[[AND_6]], %[[CONSTANT_174]], %[[SELECT_19]] : tensor<i1>, tensor<f32>
// CHECK:           %[[CONSTANT_175:.*]] = mhlo.constant dense<0x7F800000> : tensor<f32>
// CHECK:           %[[FLOOR_10:.*]] = mhlo.floor %[[SUBTRACT_10]] : tensor<f32>
// CHECK:           %[[COMPARE_24:.*]] = mhlo.compare EQ, %[[SUBTRACT_10]], %[[FLOOR_10]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[AND_7:.*]] = mhlo.and %[[COMPARE_22]], %[[COMPARE_24]] : tensor<i1>
// CHECK:           %[[CONSTANT_176:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f32>
// CHECK:           %[[FLOOR_11:.*]] = mhlo.floor %[[CONSTANT_134]] : tensor<f32>
// CHECK:           %[[COMPARE_25:.*]] = mhlo.compare EQ, %[[CONSTANT_134]], %[[FLOOR_11]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[REMAINDER_3:.*]] = mhlo.remainder %[[CONSTANT_134]], %[[CONSTANT_176]] : tensor<f32>
// CHECK:           %[[COMPARE_26:.*]] = mhlo.compare EQ, %[[REMAINDER_3]], %[[CONSTANT_135]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[AND_8:.*]] = mhlo.and %[[COMPARE_25]], %[[COMPARE_26]] : tensor<i1>
// CHECK:           %[[SELECT_21:.*]] = mhlo.select %[[AND_8]], %[[CONSTANT_175]], %[[CONSTANT_174]] : tensor<i1>, tensor<f32>
// CHECK:           %[[SELECT_22:.*]] = mhlo.select %[[AND_7]], %[[SELECT_21]], %[[SELECT_20]] : tensor<i1>, tensor<f32>
// CHECK:           %[[COMPARE_27:.*]] = mhlo.compare EQ, %[[CONSTANT_134]], %[[CONSTANT_136]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[SELECT_23:.*]] = mhlo.select %[[COMPARE_27]], %[[CONSTANT_175]], %[[SELECT_22]] : tensor<i1>, tensor<f32>
// CHECK:           %[[CONSTANT_177:.*]] = mhlo.constant dense<-2.000000e+00> : tensor<f32>
// CHECK:           %[[MULTIPLY_136:.*]] = mhlo.multiply %[[CONSTANT_177]], %[[SELECT_23]] : tensor<f32>
// CHECK:           %[[CONSTANT_178:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK:           %[[MULTIPLY_137:.*]] = mhlo.multiply %[[CONSTANT_178]], %[[MULTIPLY_136]] : tensor<f32>
// CHECK:           %[[ADD_205:.*]] = mhlo.add %[[MULTIPLY_97]], %[[MULTIPLY_137]] : tensor<f32>
// CHECK:           %[[CONSTANT_179:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f32>
// CHECK:           %[[COMPARE_28:.*]] = mhlo.compare EQ, %[[FLOOR_5]], %[[CONSTANT_179]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[SELECT_24:.*]] = mhlo.select %[[COMPARE_28]], %[[ADD_205]], %[[SELECT_17]] : tensor<i1>, tensor<f32>
// CHECK:           %[[CONSTANT_180:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f32>
// CHECK:           %[[MULTIPLY_138:.*]] = mhlo.multiply %[[CONSTANT_180]], %[[DIVIDE_13]] : tensor<f32>
// CHECK:           %[[CONSTANT_181:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_206:.*]] = mhlo.add %[[MULTIPLY_138]], %[[CONSTANT_181]] : tensor<f32>
// CHECK:           %[[MULTIPLY_139:.*]] = mhlo.multiply %[[ADD_206]], %[[DIVIDE_13]] : tensor<f32>
// CHECK:           %[[CONSTANT_182:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_207:.*]] = mhlo.add %[[MULTIPLY_139]], %[[CONSTANT_182]] : tensor<f32>
// CHECK:           %[[MULTIPLY_140:.*]] = mhlo.multiply %[[ADD_207]], %[[DIVIDE_13]] : tensor<f32>
// CHECK:           %[[CONSTANT_183:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_208:.*]] = mhlo.add %[[MULTIPLY_140]], %[[CONSTANT_183]] : tensor<f32>
// CHECK:           %[[CONSTANT_184:.*]] = mhlo.constant dense<9.86960411> : tensor<f32>
// CHECK:           %[[MULTIPLY_141:.*]] = mhlo.multiply %[[CONSTANT_184]], %[[ADD_208]] : tensor<f32>
// CHECK:           %[[SUBTRACT_12:.*]] = mhlo.subtract %[[CONSTANT_0]], %[[VAL_1]] : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_185:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_186:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_187:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK:           %[[NEGATE_5:.*]] = mhlo.negate %[[CONSTANT_185]] : tensor<f32>
// CHECK:           %[[POWER_33:.*]] = mhlo.power %[[SUBTRACT_12]], %[[NEGATE_5]] : tensor<f32>
// CHECK:           %[[ADD_209:.*]] = mhlo.add %[[SUBTRACT_12]], %[[CONSTANT_187]] : tensor<f32>
// CHECK:           %[[POWER_34:.*]] = mhlo.power %[[ADD_209]], %[[NEGATE_5]] : tensor<f32>
// CHECK:           %[[ADD_210:.*]] = mhlo.add %[[POWER_33]], %[[POWER_34]] : tensor<f32>
// CHECK:           %[[ADD_211:.*]] = mhlo.add %[[ADD_209]], %[[CONSTANT_187]] : tensor<f32>
// CHECK:           %[[POWER_35:.*]] = mhlo.power %[[ADD_211]], %[[NEGATE_5]] : tensor<f32>
// CHECK:           %[[ADD_212:.*]] = mhlo.add %[[ADD_210]], %[[POWER_35]] : tensor<f32>
// CHECK:           %[[ADD_213:.*]] = mhlo.add %[[ADD_211]], %[[CONSTANT_187]] : tensor<f32>
// CHECK:           %[[POWER_36:.*]] = mhlo.power %[[ADD_213]], %[[NEGATE_5]] : tensor<f32>
// CHECK:           %[[ADD_214:.*]] = mhlo.add %[[ADD_212]], %[[POWER_36]] : tensor<f32>
// CHECK:           %[[ADD_215:.*]] = mhlo.add %[[ADD_213]], %[[CONSTANT_187]] : tensor<f32>
// CHECK:           %[[POWER_37:.*]] = mhlo.power %[[ADD_215]], %[[NEGATE_5]] : tensor<f32>
// CHECK:           %[[ADD_216:.*]] = mhlo.add %[[ADD_214]], %[[POWER_37]] : tensor<f32>
// CHECK:           %[[ADD_217:.*]] = mhlo.add %[[ADD_215]], %[[CONSTANT_187]] : tensor<f32>
// CHECK:           %[[POWER_38:.*]] = mhlo.power %[[ADD_217]], %[[NEGATE_5]] : tensor<f32>
// CHECK:           %[[ADD_218:.*]] = mhlo.add %[[ADD_216]], %[[POWER_38]] : tensor<f32>
// CHECK:           %[[ADD_219:.*]] = mhlo.add %[[ADD_217]], %[[CONSTANT_187]] : tensor<f32>
// CHECK:           %[[POWER_39:.*]] = mhlo.power %[[ADD_219]], %[[NEGATE_5]] : tensor<f32>
// CHECK:           %[[ADD_220:.*]] = mhlo.add %[[ADD_218]], %[[POWER_39]] : tensor<f32>
// CHECK:           %[[ADD_221:.*]] = mhlo.add %[[ADD_219]], %[[CONSTANT_187]] : tensor<f32>
// CHECK:           %[[POWER_40:.*]] = mhlo.power %[[ADD_221]], %[[NEGATE_5]] : tensor<f32>
// CHECK:           %[[ADD_222:.*]] = mhlo.add %[[ADD_220]], %[[POWER_40]] : tensor<f32>
// CHECK:           %[[ADD_223:.*]] = mhlo.add %[[ADD_221]], %[[CONSTANT_187]] : tensor<f32>
// CHECK:           %[[POWER_41:.*]] = mhlo.power %[[ADD_223]], %[[NEGATE_5]] : tensor<f32>
// CHECK:           %[[ADD_224:.*]] = mhlo.add %[[ADD_222]], %[[POWER_41]] : tensor<f32>
// CHECK:           %[[ADD_225:.*]] = mhlo.add %[[ADD_223]], %[[CONSTANT_187]] : tensor<f32>
// CHECK:           %[[POWER_42:.*]] = mhlo.power %[[ADD_225]], %[[NEGATE_5]] : tensor<f32>
// CHECK:           %[[ADD_226:.*]] = mhlo.add %[[ADD_224]], %[[POWER_42]] : tensor<f32>
// CHECK:           %[[ADD_227:.*]] = mhlo.add %[[ADD_225]], %[[CONSTANT_187]] : tensor<f32>
// CHECK:           %[[POWER_43:.*]] = mhlo.power %[[ADD_227]], %[[NEGATE_5]] : tensor<f32>
// CHECK:           %[[CONSTANT_188:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK:           %[[MULTIPLY_142:.*]] = mhlo.multiply %[[POWER_43]], %[[ADD_227]] : tensor<f32>
// CHECK:           %[[SUBTRACT_13:.*]] = mhlo.subtract %[[CONSTANT_185]], %[[CONSTANT_188]] : tensor<f32>
// CHECK:           %[[DIVIDE_20:.*]] = mhlo.divide %[[MULTIPLY_142]], %[[SUBTRACT_13]] : tensor<f32>
// CHECK:           %[[MULTIPLY_143:.*]] = mhlo.multiply %[[ADD_227]], %[[ADD_227]] : tensor<f32>
// CHECK:           %[[DIVIDE_21:.*]] = mhlo.divide %[[CONSTANT_187]], %[[MULTIPLY_143]] : tensor<f32>
// CHECK:           %[[CONSTANT_189:.*]] = mhlo.constant dense<2.200000e+01> : tensor<f32>
// CHECK:           %[[ADD_228:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_189]] : tensor<f32>
// CHECK:           %[[CONSTANT_190:.*]] = mhlo.constant dense<2.100000e+01> : tensor<f32>
// CHECK:           %[[ADD_229:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_190]] : tensor<f32>
// CHECK:           %[[MULTIPLY_144:.*]] = mhlo.multiply %[[ADD_228]], %[[ADD_229]] : tensor<f32>
// CHECK:           %[[CONSTANT_191:.*]] = mhlo.constant dense<-1.39544646E-19> : tensor<f32>
// CHECK:           %[[ADD_230:.*]] = mhlo.add %[[CONSTANT_186]], %[[CONSTANT_191]] : tensor<f32>
// CHECK:           %[[MULTIPLY_145:.*]] = mhlo.multiply %[[DIVIDE_21]], %[[ADD_230]] : tensor<f32>
// CHECK:           %[[MULTIPLY_146:.*]] = mhlo.multiply %[[MULTIPLY_144]], %[[MULTIPLY_145]] : tensor<f32>
// CHECK:           %[[CONSTANT_192:.*]] = mhlo.constant dense<2.000000e+01> : tensor<f32>
// CHECK:           %[[ADD_231:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_192]] : tensor<f32>
// CHECK:           %[[CONSTANT_193:.*]] = mhlo.constant dense<1.900000e+01> : tensor<f32>
// CHECK:           %[[ADD_232:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_193]] : tensor<f32>
// CHECK:           %[[MULTIPLY_147:.*]] = mhlo.multiply %[[ADD_231]], %[[ADD_232]] : tensor<f32>
// CHECK:           %[[CONSTANT_194:.*]] = mhlo.constant dense<5.50900303E-18> : tensor<f32>
// CHECK:           %[[ADD_233:.*]] = mhlo.add %[[MULTIPLY_146]], %[[CONSTANT_194]] : tensor<f32>
// CHECK:           %[[MULTIPLY_148:.*]] = mhlo.multiply %[[DIVIDE_21]], %[[ADD_233]] : tensor<f32>
// CHECK:           %[[MULTIPLY_149:.*]] = mhlo.multiply %[[MULTIPLY_147]], %[[MULTIPLY_148]] : tensor<f32>
// CHECK:           %[[CONSTANT_195:.*]] = mhlo.constant dense<1.800000e+01> : tensor<f32>
// CHECK:           %[[ADD_234:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_195]] : tensor<f32>
// CHECK:           %[[CONSTANT_196:.*]] = mhlo.constant dense<1.700000e+01> : tensor<f32>
// CHECK:           %[[ADD_235:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_196]] : tensor<f32>
// CHECK:           %[[MULTIPLY_150:.*]] = mhlo.multiply %[[ADD_234]], %[[ADD_235]] : tensor<f32>
// CHECK:           %[[CONSTANT_197:.*]] = mhlo.constant dense<-2.17486866E-16> : tensor<f32>
// CHECK:           %[[ADD_236:.*]] = mhlo.add %[[MULTIPLY_149]], %[[CONSTANT_197]] : tensor<f32>
// CHECK:           %[[MULTIPLY_151:.*]] = mhlo.multiply %[[DIVIDE_21]], %[[ADD_236]] : tensor<f32>
// CHECK:           %[[MULTIPLY_152:.*]] = mhlo.multiply %[[MULTIPLY_150]], %[[MULTIPLY_151]] : tensor<f32>
// CHECK:           %[[CONSTANT_198:.*]] = mhlo.constant dense<1.600000e+01> : tensor<f32>
// CHECK:           %[[ADD_237:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_198]] : tensor<f32>
// CHECK:           %[[CONSTANT_199:.*]] = mhlo.constant dense<1.500000e+01> : tensor<f32>
// CHECK:           %[[ADD_238:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_199]] : tensor<f32>
// CHECK:           %[[MULTIPLY_153:.*]] = mhlo.multiply %[[ADD_237]], %[[ADD_238]] : tensor<f32>
// CHECK:           %[[CONSTANT_200:.*]] = mhlo.constant dense<8.58606213E-15> : tensor<f32>
// CHECK:           %[[ADD_239:.*]] = mhlo.add %[[MULTIPLY_152]], %[[CONSTANT_200]] : tensor<f32>
// CHECK:           %[[MULTIPLY_154:.*]] = mhlo.multiply %[[DIVIDE_21]], %[[ADD_239]] : tensor<f32>
// CHECK:           %[[MULTIPLY_155:.*]] = mhlo.multiply %[[MULTIPLY_153]], %[[MULTIPLY_154]] : tensor<f32>
// CHECK:           %[[CONSTANT_201:.*]] = mhlo.constant dense<1.400000e+01> : tensor<f32>
// CHECK:           %[[ADD_240:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_201]] : tensor<f32>
// CHECK:           %[[CONSTANT_202:.*]] = mhlo.constant dense<1.300000e+01> : tensor<f32>
// CHECK:           %[[ADD_241:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_202]] : tensor<f32>
// CHECK:           %[[MULTIPLY_156:.*]] = mhlo.multiply %[[ADD_240]], %[[ADD_241]] : tensor<f32>
// CHECK:           %[[CONSTANT_203:.*]] = mhlo.constant dense<-3.3896803E-13> : tensor<f32>
// CHECK:           %[[ADD_242:.*]] = mhlo.add %[[MULTIPLY_155]], %[[CONSTANT_203]] : tensor<f32>
// CHECK:           %[[MULTIPLY_157:.*]] = mhlo.multiply %[[DIVIDE_21]], %[[ADD_242]] : tensor<f32>
// CHECK:           %[[MULTIPLY_158:.*]] = mhlo.multiply %[[MULTIPLY_156]], %[[MULTIPLY_157]] : tensor<f32>
// CHECK:           %[[CONSTANT_204:.*]] = mhlo.constant dense<1.200000e+01> : tensor<f32>
// CHECK:           %[[ADD_243:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_204]] : tensor<f32>
// CHECK:           %[[CONSTANT_205:.*]] = mhlo.constant dense<1.100000e+01> : tensor<f32>
// CHECK:           %[[ADD_244:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_205]] : tensor<f32>
// CHECK:           %[[MULTIPLY_159:.*]] = mhlo.multiply %[[ADD_243]], %[[ADD_244]] : tensor<f32>
// CHECK:           %[[CONSTANT_206:.*]] = mhlo.constant dense<1.33825364E-11> : tensor<f32>
// CHECK:           %[[ADD_245:.*]] = mhlo.add %[[MULTIPLY_158]], %[[CONSTANT_206]] : tensor<f32>
// CHECK:           %[[MULTIPLY_160:.*]] = mhlo.multiply %[[DIVIDE_21]], %[[ADD_245]] : tensor<f32>
// CHECK:           %[[MULTIPLY_161:.*]] = mhlo.multiply %[[MULTIPLY_159]], %[[MULTIPLY_160]] : tensor<f32>
// CHECK:           %[[CONSTANT_207:.*]] = mhlo.constant dense<1.000000e+01> : tensor<f32>
// CHECK:           %[[ADD_246:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_207]] : tensor<f32>
// CHECK:           %[[CONSTANT_208:.*]] = mhlo.constant dense<9.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_247:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_208]] : tensor<f32>
// CHECK:           %[[MULTIPLY_162:.*]] = mhlo.multiply %[[ADD_246]], %[[ADD_247]] : tensor<f32>
// CHECK:           %[[CONSTANT_209:.*]] = mhlo.constant dense<-5.28419031E-10> : tensor<f32>
// CHECK:           %[[ADD_248:.*]] = mhlo.add %[[MULTIPLY_161]], %[[CONSTANT_209]] : tensor<f32>
// CHECK:           %[[MULTIPLY_163:.*]] = mhlo.multiply %[[DIVIDE_21]], %[[ADD_248]] : tensor<f32>
// CHECK:           %[[MULTIPLY_164:.*]] = mhlo.multiply %[[MULTIPLY_162]], %[[MULTIPLY_163]] : tensor<f32>
// CHECK:           %[[CONSTANT_210:.*]] = mhlo.constant dense<8.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_249:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_210]] : tensor<f32>
// CHECK:           %[[CONSTANT_211:.*]] = mhlo.constant dense<7.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_250:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_211]] : tensor<f32>
// CHECK:           %[[MULTIPLY_165:.*]] = mhlo.multiply %[[ADD_249]], %[[ADD_250]] : tensor<f32>
// CHECK:           %[[CONSTANT_212:.*]] = mhlo.constant dense<2.08767563E-8> : tensor<f32>
// CHECK:           %[[ADD_251:.*]] = mhlo.add %[[MULTIPLY_164]], %[[CONSTANT_212]] : tensor<f32>
// CHECK:           %[[MULTIPLY_166:.*]] = mhlo.multiply %[[DIVIDE_21]], %[[ADD_251]] : tensor<f32>
// CHECK:           %[[MULTIPLY_167:.*]] = mhlo.multiply %[[MULTIPLY_165]], %[[MULTIPLY_166]] : tensor<f32>
// CHECK:           %[[CONSTANT_213:.*]] = mhlo.constant dense<6.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_252:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_213]] : tensor<f32>
// CHECK:           %[[CONSTANT_214:.*]] = mhlo.constant dense<5.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_253:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_214]] : tensor<f32>
// CHECK:           %[[MULTIPLY_168:.*]] = mhlo.multiply %[[ADD_252]], %[[ADD_253]] : tensor<f32>
// CHECK:           %[[CONSTANT_215:.*]] = mhlo.constant dense<-8.26719599E-7> : tensor<f32>
// CHECK:           %[[ADD_254:.*]] = mhlo.add %[[MULTIPLY_167]], %[[CONSTANT_215]] : tensor<f32>
// CHECK:           %[[MULTIPLY_169:.*]] = mhlo.multiply %[[DIVIDE_21]], %[[ADD_254]] : tensor<f32>
// CHECK:           %[[MULTIPLY_170:.*]] = mhlo.multiply %[[MULTIPLY_168]], %[[MULTIPLY_169]] : tensor<f32>
// CHECK:           %[[CONSTANT_216:.*]] = mhlo.constant dense<4.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_255:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_216]] : tensor<f32>
// CHECK:           %[[CONSTANT_217:.*]] = mhlo.constant dense<3.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_256:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_217]] : tensor<f32>
// CHECK:           %[[MULTIPLY_171:.*]] = mhlo.multiply %[[ADD_255]], %[[ADD_256]] : tensor<f32>
// CHECK:           %[[CONSTANT_218:.*]] = mhlo.constant dense<3.30687835E-5> : tensor<f32>
// CHECK:           %[[ADD_257:.*]] = mhlo.add %[[MULTIPLY_170]], %[[CONSTANT_218]] : tensor<f32>
// CHECK:           %[[MULTIPLY_172:.*]] = mhlo.multiply %[[DIVIDE_21]], %[[ADD_257]] : tensor<f32>
// CHECK:           %[[MULTIPLY_173:.*]] = mhlo.multiply %[[MULTIPLY_171]], %[[MULTIPLY_172]] : tensor<f32>
// CHECK:           %[[CONSTANT_219:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_258:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_219]] : tensor<f32>
// CHECK:           %[[CONSTANT_220:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_259:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_220]] : tensor<f32>
// CHECK:           %[[MULTIPLY_174:.*]] = mhlo.multiply %[[ADD_258]], %[[ADD_259]] : tensor<f32>
// CHECK:           %[[CONSTANT_221:.*]] = mhlo.constant dense<-0.00138888892> : tensor<f32>
// CHECK:           %[[ADD_260:.*]] = mhlo.add %[[MULTIPLY_173]], %[[CONSTANT_221]] : tensor<f32>
// CHECK:           %[[MULTIPLY_175:.*]] = mhlo.multiply %[[DIVIDE_21]], %[[ADD_260]] : tensor<f32>
// CHECK:           %[[MULTIPLY_176:.*]] = mhlo.multiply %[[MULTIPLY_174]], %[[MULTIPLY_175]] : tensor<f32>
// CHECK:           %[[CONSTANT_222:.*]] = mhlo.constant dense<5.000000e-01> : tensor<f32>
// CHECK:           %[[DIVIDE_22:.*]] = mhlo.divide %[[CONSTANT_185]], %[[ADD_227]] : tensor<f32>
// CHECK:           %[[CONSTANT_223:.*]] = mhlo.constant dense<0.0833333358> : tensor<f32>
// CHECK:           %[[ADD_261:.*]] = mhlo.add %[[CONSTANT_223]], %[[MULTIPLY_176]] : tensor<f32>
// CHECK:           %[[MULTIPLY_177:.*]] = mhlo.multiply %[[DIVIDE_22]], %[[ADD_261]] : tensor<f32>
// CHECK:           %[[ADD_262:.*]] = mhlo.add %[[CONSTANT_222]], %[[MULTIPLY_177]] : tensor<f32>
// CHECK:           %[[MULTIPLY_178:.*]] = mhlo.multiply %[[POWER_43]], %[[ADD_262]] : tensor<f32>
// CHECK:           %[[ADD_263:.*]] = mhlo.add %[[ADD_226]], %[[DIVIDE_20]] : tensor<f32>
// CHECK:           %[[ADD_264:.*]] = mhlo.add %[[ADD_263]], %[[MULTIPLY_178]] : tensor<f32>
// CHECK:           %[[ABS_9:.*]] = mhlo.abs %[[POWER_43]] : tensor<f32>
// CHECK:           %[[ABS_10:.*]] = mhlo.abs %[[ADD_226]] : tensor<f32>
// CHECK:           %[[CONSTANT_224:.*]] = mhlo.constant dense<1.401300e-45> : tensor<f32>
// CHECK:           %[[MULTIPLY_179:.*]] = mhlo.multiply %[[ABS_10]], %[[CONSTANT_224]] : tensor<f32>
// CHECK:           %[[COMPARE_29:.*]] = mhlo.compare LT, %[[ABS_9]], %[[MULTIPLY_179]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[SELECT_25:.*]] = mhlo.select %[[COMPARE_29]], %[[ADD_226]], %[[ADD_264]] : tensor<i1>, tensor<f32>
// CHECK:           %[[CONSTANT_225:.*]] = mhlo.constant dense<0x7FC00000> : tensor<f32>
// CHECK:           %[[COMPARE_30:.*]] = mhlo.compare LT, %[[CONSTANT_185]], %[[CONSTANT_188]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[SELECT_26:.*]] = mhlo.select %[[COMPARE_30]], %[[CONSTANT_225]], %[[SELECT_25]] : tensor<i1>, tensor<f32>
// CHECK:           %[[COMPARE_31:.*]] = mhlo.compare LE, %[[SUBTRACT_12]], %[[CONSTANT_186]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[FLOOR_12:.*]] = mhlo.floor %[[CONSTANT_185]] : tensor<f32>
// CHECK:           %[[COMPARE_32:.*]] = mhlo.compare NE, %[[CONSTANT_185]], %[[FLOOR_12]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[AND_9:.*]] = mhlo.and %[[COMPARE_31]], %[[COMPARE_32]] : tensor<i1>
// CHECK:           %[[SELECT_27:.*]] = mhlo.select %[[AND_9]], %[[CONSTANT_225]], %[[SELECT_26]] : tensor<i1>, tensor<f32>
// CHECK:           %[[CONSTANT_226:.*]] = mhlo.constant dense<0x7F800000> : tensor<f32>
// CHECK:           %[[FLOOR_13:.*]] = mhlo.floor %[[SUBTRACT_12]] : tensor<f32>
// CHECK:           %[[COMPARE_33:.*]] = mhlo.compare EQ, %[[SUBTRACT_12]], %[[FLOOR_13]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[AND_10:.*]] = mhlo.and %[[COMPARE_31]], %[[COMPARE_33]] : tensor<i1>
// CHECK:           %[[CONSTANT_227:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f32>
// CHECK:           %[[FLOOR_14:.*]] = mhlo.floor %[[CONSTANT_185]] : tensor<f32>
// CHECK:           %[[COMPARE_34:.*]] = mhlo.compare EQ, %[[CONSTANT_185]], %[[FLOOR_14]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[REMAINDER_4:.*]] = mhlo.remainder %[[CONSTANT_185]], %[[CONSTANT_227]] : tensor<f32>
// CHECK:           %[[COMPARE_35:.*]] = mhlo.compare EQ, %[[REMAINDER_4]], %[[CONSTANT_186]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[AND_11:.*]] = mhlo.and %[[COMPARE_34]], %[[COMPARE_35]] : tensor<i1>
// CHECK:           %[[SELECT_28:.*]] = mhlo.select %[[AND_11]], %[[CONSTANT_226]], %[[CONSTANT_225]] : tensor<i1>, tensor<f32>
// CHECK:           %[[SELECT_29:.*]] = mhlo.select %[[AND_10]], %[[SELECT_28]], %[[SELECT_27]] : tensor<i1>, tensor<f32>
// CHECK:           %[[COMPARE_36:.*]] = mhlo.compare EQ, %[[CONSTANT_185]], %[[CONSTANT_187]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[SELECT_30:.*]] = mhlo.select %[[COMPARE_36]], %[[CONSTANT_226]], %[[SELECT_29]] : tensor<i1>, tensor<f32>
// CHECK:           %[[CONSTANT_228:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK:           %[[MULTIPLY_180:.*]] = mhlo.multiply %[[CONSTANT_228]], %[[SELECT_30]] : tensor<f32>
// CHECK:           %[[CONSTANT_229:.*]] = mhlo.constant dense<-1.000000e+00> : tensor<f32>
// CHECK:           %[[MULTIPLY_181:.*]] = mhlo.multiply %[[CONSTANT_229]], %[[MULTIPLY_180]] : tensor<f32>
// CHECK:           %[[ADD_265:.*]] = mhlo.add %[[MULTIPLY_141]], %[[MULTIPLY_181]] : tensor<f32>
// CHECK:           %[[CONSTANT_230:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK:           %[[COMPARE_37:.*]] = mhlo.compare EQ, %[[FLOOR_5]], %[[CONSTANT_230]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[SELECT_31:.*]] = mhlo.select %[[COMPARE_37]], %[[ADD_265]], %[[SELECT_24]] : tensor<i1>, tensor<f32>
// CHECK:           %[[CONSTANT_231:.*]] = mhlo.constant dense<5.000000e-01> : tensor<f32>
// CHECK:           %[[COMPARE_38:.*]] = mhlo.compare LT, %[[VAL_1]], %[[CONSTANT_231]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[SELECT_32:.*]] = mhlo.select %[[COMPARE_38]], %[[SELECT_31]], %[[MULTIPLY_42]] : tensor<i1>, tensor<f32>
// CHECK:           %[[CONSTANT_232:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f32>
// CHECK:           %[[COMPARE_39:.*]] = mhlo.compare EQ, %[[VAL_0]], %[[CONSTANT_232]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[CONSTANT_233:.*]] = mhlo.constant dense<5.000000e-01> : tensor<f32>
// CHECK:           %[[COMPARE_40:.*]] = mhlo.compare LT, %[[VAL_1]], %[[CONSTANT_233]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[NEGATE_6:.*]] = mhlo.negate %[[VAL_1]] : tensor<f32>
// CHECK:           %[[CONSTANT_234:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK:           %[[SUBTRACT_14:.*]] = mhlo.subtract %[[VAL_1]], %[[CONSTANT_234]] : tensor<f32>
// CHECK:           %[[SELECT_33:.*]] = mhlo.select %[[COMPARE_40]], %[[NEGATE_6]], %[[SUBTRACT_14]] : tensor<i1>, tensor<f32>
// CHECK-DAG:       %[[CONSTANT_235:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_236:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_237:.*]] = mhlo.constant dense<676.520386> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_238:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_266:.*]] = mhlo.add %[[SELECT_33]], %[[CONSTANT_238]] : tensor<f32>
// CHECK:           %[[MULTIPLY_182:.*]] = mhlo.multiply %[[ADD_266]], %[[ADD_266]] : tensor<f32>
// CHECK:           %[[DIVIDE_23:.*]] = mhlo.divide %[[CONSTANT_237]], %[[MULTIPLY_182]] : tensor<f32>
// CHECK:           %[[SUBTRACT_15:.*]] = mhlo.subtract %[[CONSTANT_235]], %[[DIVIDE_23]] : tensor<f32>
// CHECK:           %[[DIVIDE_24:.*]] = mhlo.divide %[[CONSTANT_237]], %[[ADD_266]] : tensor<f32>
// CHECK:           %[[ADD_267:.*]] = mhlo.add %[[CONSTANT_236]], %[[DIVIDE_24]] : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_239:.*]] = mhlo.constant dense<-1259.13916> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_240:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_268:.*]] = mhlo.add %[[SELECT_33]], %[[CONSTANT_240]] : tensor<f32>
// CHECK:           %[[MULTIPLY_183:.*]] = mhlo.multiply %[[ADD_268]], %[[ADD_268]] : tensor<f32>
// CHECK:           %[[DIVIDE_25:.*]] = mhlo.divide %[[CONSTANT_239]], %[[MULTIPLY_183]] : tensor<f32>
// CHECK:           %[[SUBTRACT_16:.*]] = mhlo.subtract %[[SUBTRACT_15]], %[[DIVIDE_25]] : tensor<f32>
// CHECK:           %[[DIVIDE_26:.*]] = mhlo.divide %[[CONSTANT_239]], %[[ADD_268]] : tensor<f32>
// CHECK:           %[[ADD_269:.*]] = mhlo.add %[[ADD_267]], %[[DIVIDE_26]] : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_241:.*]] = mhlo.constant dense<771.323425> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_242:.*]] = mhlo.constant dense<3.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_270:.*]] = mhlo.add %[[SELECT_33]], %[[CONSTANT_242]] : tensor<f32>
// CHECK:           %[[MULTIPLY_184:.*]] = mhlo.multiply %[[ADD_270]], %[[ADD_270]] : tensor<f32>
// CHECK:           %[[DIVIDE_27:.*]] = mhlo.divide %[[CONSTANT_241]], %[[MULTIPLY_184]] : tensor<f32>
// CHECK:           %[[SUBTRACT_17:.*]] = mhlo.subtract %[[SUBTRACT_16]], %[[DIVIDE_27]] : tensor<f32>
// CHECK:           %[[DIVIDE_28:.*]] = mhlo.divide %[[CONSTANT_241]], %[[ADD_270]] : tensor<f32>
// CHECK:           %[[ADD_271:.*]] = mhlo.add %[[ADD_269]], %[[DIVIDE_28]] : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_243:.*]] = mhlo.constant dense<-176.615036> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_244:.*]] = mhlo.constant dense<4.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_272:.*]] = mhlo.add %[[SELECT_33]], %[[CONSTANT_244]] : tensor<f32>
// CHECK:           %[[MULTIPLY_185:.*]] = mhlo.multiply %[[ADD_272]], %[[ADD_272]] : tensor<f32>
// CHECK:           %[[DIVIDE_29:.*]] = mhlo.divide %[[CONSTANT_243]], %[[MULTIPLY_185]] : tensor<f32>
// CHECK:           %[[SUBTRACT_18:.*]] = mhlo.subtract %[[SUBTRACT_17]], %[[DIVIDE_29]] : tensor<f32>
// CHECK:           %[[DIVIDE_30:.*]] = mhlo.divide %[[CONSTANT_243]], %[[ADD_272]] : tensor<f32>
// CHECK:           %[[ADD_273:.*]] = mhlo.add %[[ADD_271]], %[[DIVIDE_30]] : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_245:.*]] = mhlo.constant dense<12.5073433> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_246:.*]] = mhlo.constant dense<5.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_274:.*]] = mhlo.add %[[SELECT_33]], %[[CONSTANT_246]] : tensor<f32>
// CHECK:           %[[MULTIPLY_186:.*]] = mhlo.multiply %[[ADD_274]], %[[ADD_274]] : tensor<f32>
// CHECK:           %[[DIVIDE_31:.*]] = mhlo.divide %[[CONSTANT_245]], %[[MULTIPLY_186]] : tensor<f32>
// CHECK:           %[[SUBTRACT_19:.*]] = mhlo.subtract %[[SUBTRACT_18]], %[[DIVIDE_31]] : tensor<f32>
// CHECK:           %[[DIVIDE_32:.*]] = mhlo.divide %[[CONSTANT_245]], %[[ADD_274]] : tensor<f32>
// CHECK:           %[[ADD_275:.*]] = mhlo.add %[[ADD_273]], %[[DIVIDE_32]] : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_247:.*]] = mhlo.constant dense<-0.138571098> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_248:.*]] = mhlo.constant dense<6.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_276:.*]] = mhlo.add %[[SELECT_33]], %[[CONSTANT_248]] : tensor<f32>
// CHECK:           %[[MULTIPLY_187:.*]] = mhlo.multiply %[[ADD_276]], %[[ADD_276]] : tensor<f32>
// CHECK:           %[[DIVIDE_33:.*]] = mhlo.divide %[[CONSTANT_247]], %[[MULTIPLY_187]] : tensor<f32>
// CHECK:           %[[SUBTRACT_20:.*]] = mhlo.subtract %[[SUBTRACT_19]], %[[DIVIDE_33]] : tensor<f32>
// CHECK:           %[[DIVIDE_34:.*]] = mhlo.divide %[[CONSTANT_247]], %[[ADD_276]] : tensor<f32>
// CHECK:           %[[ADD_277:.*]] = mhlo.add %[[ADD_275]], %[[DIVIDE_34]] : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_249:.*]] = mhlo.constant dense<9.98436917E-6> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_250:.*]] = mhlo.constant dense<7.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_278:.*]] = mhlo.add %[[SELECT_33]], %[[CONSTANT_250]] : tensor<f32>
// CHECK:           %[[MULTIPLY_188:.*]] = mhlo.multiply %[[ADD_278]], %[[ADD_278]] : tensor<f32>
// CHECK:           %[[DIVIDE_35:.*]] = mhlo.divide %[[CONSTANT_249]], %[[MULTIPLY_188]] : tensor<f32>
// CHECK:           %[[SUBTRACT_21:.*]] = mhlo.subtract %[[SUBTRACT_20]], %[[DIVIDE_35]] : tensor<f32>
// CHECK:           %[[DIVIDE_36:.*]] = mhlo.divide %[[CONSTANT_249]], %[[ADD_278]] : tensor<f32>
// CHECK:           %[[ADD_279:.*]] = mhlo.add %[[ADD_277]], %[[DIVIDE_36]] : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_251:.*]] = mhlo.constant dense<1.50563267E-7> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_252:.*]] = mhlo.constant dense<8.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_280:.*]] = mhlo.add %[[SELECT_33]], %[[CONSTANT_252]] : tensor<f32>
// CHECK:           %[[MULTIPLY_189:.*]] = mhlo.multiply %[[ADD_280]], %[[ADD_280]] : tensor<f32>
// CHECK:           %[[DIVIDE_37:.*]] = mhlo.divide %[[CONSTANT_251]], %[[MULTIPLY_189]] : tensor<f32>
// CHECK:           %[[SUBTRACT_22:.*]] = mhlo.subtract %[[SUBTRACT_21]], %[[DIVIDE_37]] : tensor<f32>
// CHECK:           %[[DIVIDE_38:.*]] = mhlo.divide %[[CONSTANT_251]], %[[ADD_280]] : tensor<f32>
// CHECK:           %[[ADD_281:.*]] = mhlo.add %[[ADD_279]], %[[DIVIDE_38]] : tensor<f32>
// CHECK:           %[[CONSTANT_253:.*]] = mhlo.constant dense<7.500000e+00> : tensor<f32>
// CHECK:           %[[ADD_282:.*]] = mhlo.add %[[CONSTANT_253]], %[[SELECT_33]] : tensor<f32>
// CHECK:           %[[CONSTANT_254:.*]] = mhlo.constant dense<2.01490307> : tensor<f32>
// CHECK:           %[[DIVIDE_39:.*]] = mhlo.divide %[[SELECT_33]], %[[CONSTANT_253]] : tensor<f32>
// CHECK:           %[[LOG_PLUS_ONE_1:.*]] = mhlo.log_plus_one %[[DIVIDE_39]] : tensor<f32>
// CHECK:           %[[ADD_283:.*]] = mhlo.add %[[CONSTANT_254]], %[[LOG_PLUS_ONE_1]] : tensor<f32>
// CHECK:           %[[DIVIDE_40:.*]] = mhlo.divide %[[SUBTRACT_22]], %[[ADD_281]] : tensor<f32>
// CHECK:           %[[CONSTANT_255:.*]] = mhlo.constant dense<7.000000e+00> : tensor<f32>
// CHECK:           %[[DIVIDE_41:.*]] = mhlo.divide %[[CONSTANT_255]], %[[ADD_282]] : tensor<f32>
// CHECK:           %[[ADD_284:.*]] = mhlo.add %[[ADD_283]], %[[DIVIDE_40]] : tensor<f32>
// CHECK:           %[[SUBTRACT_23:.*]] = mhlo.subtract %[[ADD_284]], %[[DIVIDE_41]] : tensor<f32>
// CHECK:           %[[CONSTANT_256:.*]] = mhlo.constant dense<5.000000e-01> : tensor<f32>
// CHECK:           %[[ADD_285:.*]] = mhlo.add %[[VAL_1]], %[[CONSTANT_256]] : tensor<f32>
// CHECK:           %[[FLOOR_15:.*]] = mhlo.floor %[[ADD_285]] : tensor<f32>
// CHECK:           %[[ABS_11:.*]] = mhlo.abs %[[FLOOR_15]] : tensor<f32>
// CHECK:           %[[ADD_286:.*]] = mhlo.add %[[VAL_1]], %[[ABS_11]] : tensor<f32>
// CHECK:           %[[CONSTANT_257:.*]] = mhlo.constant dense<3.14159274> : tensor<f32>
// CHECK:           %[[MULTIPLY_190:.*]] = mhlo.multiply %[[CONSTANT_257]], %[[ADD_286]] : tensor<f32>
// CHECK:           %[[COSINE_1:.*]] = mhlo.cosine %[[MULTIPLY_190]] : tensor<f32>
// CHECK:           %[[SINE_2:.*]] = mhlo.sine %[[MULTIPLY_190]] : tensor<f32>
// CHECK:           %[[MULTIPLY_191:.*]] = mhlo.multiply %[[CONSTANT_257]], %[[COSINE_1]] : tensor<f32>
// CHECK:           %[[DIVIDE_42:.*]] = mhlo.divide %[[MULTIPLY_191]], %[[SINE_2]] : tensor<f32>
// CHECK:           %[[SUBTRACT_24:.*]] = mhlo.subtract %[[SUBTRACT_23]], %[[DIVIDE_42]] : tensor<f32>
// CHECK:           %[[SELECT_34:.*]] = mhlo.select %[[COMPARE_40]], %[[SUBTRACT_24]], %[[SUBTRACT_23]] : tensor<i1>, tensor<f32>
// CHECK:           %[[COMPARE_41:.*]] = mhlo.compare LE, %[[VAL_1]], %[[CONSTANT_235]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[FLOOR_16:.*]] = mhlo.floor %[[VAL_1]] : tensor<f32>
// CHECK:           %[[COMPARE_42:.*]] = mhlo.compare EQ, %[[VAL_1]], %[[FLOOR_16]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[AND_12:.*]] = mhlo.and %[[COMPARE_41]], %[[COMPARE_42]] : tensor<i1>
// CHECK:           %[[CONSTANT_258:.*]] = mhlo.constant dense<0x7FC00000> : tensor<f32>
// CHECK:           %[[SELECT_35:.*]] = mhlo.select %[[AND_12]], %[[CONSTANT_258]], %[[SELECT_34]] : tensor<i1>, tensor<f32>
// CHECK:           %[[SELECT_36:.*]] = mhlo.select %[[COMPARE_39]], %[[SELECT_35]], %[[SELECT_32]] : tensor<i1>, tensor<f32>
// CHECK:           %[[FLOOR_17:.*]] = mhlo.floor %[[VAL_0]] : tensor<f32>
// CHECK:           %[[COMPARE_43:.*]] = mhlo.compare NE, %[[VAL_0]], %[[FLOOR_17]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[COMPARE_44:.*]] = mhlo.compare LT, %[[VAL_0]], %[[CONSTANT_232]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[OR_0:.*]] = mhlo.or %[[COMPARE_43]], %[[COMPARE_44]] : tensor<i1>
// CHECK:           %[[CONSTANT_259:.*]] = mhlo.constant dense<0x7FC00000> : tensor<f32>
// CHECK:           %[[SELECT_37:.*]] = mhlo.select %[[OR_0]], %[[CONSTANT_259]], %[[SELECT_36]] : tensor<i1>, tensor<f32>
// CHECK:           return %[[SELECT_37]] : tensor<f32>
// CHECK:         }
...
// CHECK:         func.func @polygamma_f64(%[[VAL_0:.*]]: tensor<f64>, %[[VAL_1:.*]]: tensor<f64>) -> tensor<f64> {
// CHECK-DAG:       %[[CONSTANT_0:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_1:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f64>
// CHECK:           %[[REMAINDER_0:.*]] = mhlo.remainder %[[VAL_0]], %[[CONSTANT_1]] : tensor<f64>
// CHECK:           %[[MULTIPLY_0:.*]] = mhlo.multiply %[[CONSTANT_1]], %[[REMAINDER_0]] : tensor<f64>
// CHECK:           %[[SUBTRACT_0:.*]] = mhlo.subtract %[[MULTIPLY_0]], %[[CONSTANT_0]] : tensor<f64>
// CHECK:           %[[ADD_0:.*]] = mhlo.add %[[VAL_0]], %[[CONSTANT_0]] : tensor<f64>
// CHECK:           %[[CONSTANT_2:.*]] = mhlo.constant dense<5.000000e-01> : tensor<f64>
// CHECK:           %[[COMPARE_0:.*]] = mhlo.compare LT, %[[ADD_0]], %[[CONSTANT_2]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[NEGATE_0:.*]] = mhlo.negate %[[ADD_0]] : tensor<f64>
// CHECK:           %[[CONSTANT_3:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f64>
// CHECK:           %[[SUBTRACT_1:.*]] = mhlo.subtract %[[ADD_0]], %[[CONSTANT_3]] : tensor<f64>
// CHECK:           %[[SELECT_0:.*]] = mhlo.select %[[COMPARE_0]], %[[NEGATE_0]], %[[SUBTRACT_1]] : tensor<i1>, tensor<f64>
// CHECK-DAG:       %[[CONSTANT_4:.*]] = mhlo.constant dense<0.99999999999980993> : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_5:.*]] = mhlo.constant dense<676.5203681218851> : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_6:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_1:.*]] = mhlo.add %[[SELECT_0]], %[[CONSTANT_6]] : tensor<f64>
// CHECK:           %[[DIVIDE_0:.*]] = mhlo.divide %[[CONSTANT_5]], %[[ADD_1]] : tensor<f64>
// CHECK:           %[[ADD_2:.*]] = mhlo.add %[[CONSTANT_4]], %[[DIVIDE_0]] : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_7:.*]] = mhlo.constant dense<-1259.1392167224028> : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_8:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_3:.*]] = mhlo.add %[[SELECT_0]], %[[CONSTANT_8]] : tensor<f64>
// CHECK:           %[[DIVIDE_1:.*]] = mhlo.divide %[[CONSTANT_7]], %[[ADD_3]] : tensor<f64>
// CHECK:           %[[ADD_4:.*]] = mhlo.add %[[ADD_2]], %[[DIVIDE_1]] : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_9:.*]] = mhlo.constant dense<771.32342877765313> : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_10:.*]] = mhlo.constant dense<3.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_5:.*]] = mhlo.add %[[SELECT_0]], %[[CONSTANT_10]] : tensor<f64>
// CHECK:           %[[DIVIDE_2:.*]] = mhlo.divide %[[CONSTANT_9]], %[[ADD_5]] : tensor<f64>
// CHECK:           %[[ADD_6:.*]] = mhlo.add %[[ADD_4]], %[[DIVIDE_2]] : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_11:.*]] = mhlo.constant dense<-176.61502916214059> : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_12:.*]] = mhlo.constant dense<4.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_7:.*]] = mhlo.add %[[SELECT_0]], %[[CONSTANT_12]] : tensor<f64>
// CHECK:           %[[DIVIDE_3:.*]] = mhlo.divide %[[CONSTANT_11]], %[[ADD_7]] : tensor<f64>
// CHECK:           %[[ADD_8:.*]] = mhlo.add %[[ADD_6]], %[[DIVIDE_3]] : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_13:.*]] = mhlo.constant dense<12.507343278686905> : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_14:.*]] = mhlo.constant dense<5.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_9:.*]] = mhlo.add %[[SELECT_0]], %[[CONSTANT_14]] : tensor<f64>
// CHECK:           %[[DIVIDE_4:.*]] = mhlo.divide %[[CONSTANT_13]], %[[ADD_9]] : tensor<f64>
// CHECK:           %[[ADD_10:.*]] = mhlo.add %[[ADD_8]], %[[DIVIDE_4]] : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_15:.*]] = mhlo.constant dense<-0.13857109526572012> : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_16:.*]] = mhlo.constant dense<6.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_11:.*]] = mhlo.add %[[SELECT_0]], %[[CONSTANT_16]] : tensor<f64>
// CHECK:           %[[DIVIDE_5:.*]] = mhlo.divide %[[CONSTANT_15]], %[[ADD_11]] : tensor<f64>
// CHECK:           %[[ADD_12:.*]] = mhlo.add %[[ADD_10]], %[[DIVIDE_5]] : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_17:.*]] = mhlo.constant dense<9.9843695780195716E-6> : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_18:.*]] = mhlo.constant dense<7.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_13:.*]] = mhlo.add %[[SELECT_0]], %[[CONSTANT_18]] : tensor<f64>
// CHECK:           %[[DIVIDE_6:.*]] = mhlo.divide %[[CONSTANT_17]], %[[ADD_13]] : tensor<f64>
// CHECK:           %[[ADD_14:.*]] = mhlo.add %[[ADD_12]], %[[DIVIDE_6]] : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_19:.*]] = mhlo.constant dense<1.5056327351493116E-7> : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_20:.*]] = mhlo.constant dense<8.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_15:.*]] = mhlo.add %[[SELECT_0]], %[[CONSTANT_20]] : tensor<f64>
// CHECK:           %[[DIVIDE_7:.*]] = mhlo.divide %[[CONSTANT_19]], %[[ADD_15]] : tensor<f64>
// CHECK:           %[[ADD_16:.*]] = mhlo.add %[[ADD_14]], %[[DIVIDE_7]] : tensor<f64>
// CHECK:           %[[CONSTANT_21:.*]] = mhlo.constant dense<7.500000e+00> : tensor<f64>
// CHECK:           %[[ADD_17:.*]] = mhlo.add %[[CONSTANT_21]], %[[SELECT_0]] : tensor<f64>
// CHECK:           %[[CONSTANT_22:.*]] = mhlo.constant dense<2.0149030205422647> : tensor<f64>
// CHECK:           %[[DIVIDE_8:.*]] = mhlo.divide %[[SELECT_0]], %[[CONSTANT_21]] : tensor<f64>
// CHECK:           %[[LOG_PLUS_ONE_0:.*]] = mhlo.log_plus_one %[[DIVIDE_8]] : tensor<f64>
// CHECK:           %[[ADD_18:.*]] = mhlo.add %[[CONSTANT_22]], %[[LOG_PLUS_ONE_0]] : tensor<f64>
// CHECK:           %[[DIVIDE_9:.*]] = mhlo.divide %[[ADD_17]], %[[ADD_18]] : tensor<f64>
// CHECK:           %[[ADD_19:.*]] = mhlo.add %[[SELECT_0]], %[[CONSTANT_2]] : tensor<f64>
// CHECK:           %[[SUBTRACT_2:.*]] = mhlo.subtract %[[ADD_19]], %[[DIVIDE_9]] : tensor<f64>
// CHECK:           %[[MULTIPLY_1:.*]] = mhlo.multiply %[[SUBTRACT_2]], %[[ADD_18]] : tensor<f64>
// CHECK:           %[[LOG_0:.*]] = mhlo.log %[[ADD_16]] : tensor<f64>
// CHECK:           %[[CONSTANT_23:.*]] = mhlo.constant dense<0.91893853320467266> : tensor<f64>
// CHECK:           %[[ADD_20:.*]] = mhlo.add %[[CONSTANT_23]], %[[MULTIPLY_1]] : tensor<f64>
// CHECK:           %[[ADD_21:.*]] = mhlo.add %[[ADD_20]], %[[LOG_0]] : tensor<f64>
// CHECK:           %[[ABS_0:.*]] = mhlo.abs %[[ADD_0]] : tensor<f64>
// CHECK:           %[[FLOOR_0:.*]] = mhlo.floor %[[ABS_0]] : tensor<f64>
// CHECK:           %[[SUBTRACT_3:.*]] = mhlo.subtract %[[ABS_0]], %[[FLOOR_0]] : tensor<f64>
// CHECK:           %[[COMPARE_1:.*]] = mhlo.compare LT, %[[CONSTANT_2]], %[[SUBTRACT_3]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[SUBTRACT_4:.*]] = mhlo.subtract %[[CONSTANT_3]], %[[SUBTRACT_3]] : tensor<f64>
// CHECK:           %[[SELECT_1:.*]] = mhlo.select %[[COMPARE_1]], %[[SUBTRACT_4]], %[[SUBTRACT_3]] : tensor<i1>, tensor<f64>
// CHECK:           %[[CONSTANT_24:.*]] = mhlo.constant dense<3.1415926535897931> : tensor<f64>
// CHECK:           %[[MULTIPLY_2:.*]] = mhlo.multiply %[[CONSTANT_24]], %[[SELECT_1]] : tensor<f64>
// CHECK:           %[[SINE_0:.*]] = mhlo.sine %[[MULTIPLY_2]] : tensor<f64>
// CHECK:           %[[LOG_1:.*]] = mhlo.log %[[SINE_0]] : tensor<f64>
// CHECK:           %[[CONSTANT_25:.*]] = mhlo.constant dense<1.1447298858494002> : tensor<f64>
// CHECK:           %[[SUBTRACT_5:.*]] = mhlo.subtract %[[CONSTANT_25]], %[[LOG_1]] : tensor<f64>
// CHECK:           %[[SUBTRACT_6:.*]] = mhlo.subtract %[[SUBTRACT_5]], %[[ADD_21]] : tensor<f64>
// CHECK:           %[[IS_FINITE_0:.*]] = mhlo.is_finite %[[LOG_1]] : (tensor<f64>) -> tensor<i1>
// CHECK:           %[[NEGATE_1:.*]] = mhlo.negate %[[LOG_1]] : tensor<f64>
// CHECK:           %[[SELECT_2:.*]] = mhlo.select %[[IS_FINITE_0]], %[[SUBTRACT_6]], %[[NEGATE_1]] : tensor<i1>, tensor<f64>
// CHECK:           %[[SELECT_3:.*]] = mhlo.select %[[COMPARE_0]], %[[SELECT_2]], %[[ADD_21]] : tensor<i1>, tensor<f64>
// CHECK:           %[[ABS_1:.*]] = mhlo.abs %[[ADD_0]] : tensor<f64>
// CHECK:           %[[CONSTANT_26:.*]] = mhlo.constant dense<0x7FF0000000000000> : tensor<f64>
// CHECK:           %[[COMPARE_2:.*]] = mhlo.compare EQ, %[[ABS_1]], %[[CONSTANT_26]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[CONSTANT_27:.*]] = mhlo.constant dense<0x7FF0000000000000> : tensor<f64>
// CHECK:           %[[SELECT_4:.*]] = mhlo.select %[[COMPARE_2]], %[[CONSTANT_27]], %[[SELECT_3]] : tensor<i1>, tensor<f64>
// CHECK:           %[[EXPONENTIAL_0:.*]] = mhlo.exponential %[[SELECT_4]] : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_28:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_29:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f64>
// CHECK:           %[[NEGATE_2:.*]] = mhlo.negate %[[ADD_0]] : tensor<f64>
// CHECK:           %[[POWER_0:.*]] = mhlo.power %[[VAL_1]], %[[NEGATE_2]] : tensor<f64>
// CHECK:           %[[ADD_22:.*]] = mhlo.add %[[VAL_1]], %[[CONSTANT_29]] : tensor<f64>
// CHECK:           %[[POWER_1:.*]] = mhlo.power %[[ADD_22]], %[[NEGATE_2]] : tensor<f64>
// CHECK:           %[[ADD_23:.*]] = mhlo.add %[[POWER_0]], %[[POWER_1]] : tensor<f64>
// CHECK:           %[[ADD_24:.*]] = mhlo.add %[[ADD_22]], %[[CONSTANT_29]] : tensor<f64>
// CHECK:           %[[POWER_2:.*]] = mhlo.power %[[ADD_24]], %[[NEGATE_2]] : tensor<f64>
// CHECK:           %[[ADD_25:.*]] = mhlo.add %[[ADD_23]], %[[POWER_2]] : tensor<f64>
// CHECK:           %[[ADD_26:.*]] = mhlo.add %[[ADD_24]], %[[CONSTANT_29]] : tensor<f64>
// CHECK:           %[[POWER_3:.*]] = mhlo.power %[[ADD_26]], %[[NEGATE_2]] : tensor<f64>
// CHECK:           %[[ADD_27:.*]] = mhlo.add %[[ADD_25]], %[[POWER_3]] : tensor<f64>
// CHECK:           %[[ADD_28:.*]] = mhlo.add %[[ADD_26]], %[[CONSTANT_29]] : tensor<f64>
// CHECK:           %[[POWER_4:.*]] = mhlo.power %[[ADD_28]], %[[NEGATE_2]] : tensor<f64>
// CHECK:           %[[ADD_29:.*]] = mhlo.add %[[ADD_27]], %[[POWER_4]] : tensor<f64>
// CHECK:           %[[ADD_30:.*]] = mhlo.add %[[ADD_28]], %[[CONSTANT_29]] : tensor<f64>
// CHECK:           %[[POWER_5:.*]] = mhlo.power %[[ADD_30]], %[[NEGATE_2]] : tensor<f64>
// CHECK:           %[[ADD_31:.*]] = mhlo.add %[[ADD_29]], %[[POWER_5]] : tensor<f64>
// CHECK:           %[[ADD_32:.*]] = mhlo.add %[[ADD_30]], %[[CONSTANT_29]] : tensor<f64>
// CHECK:           %[[POWER_6:.*]] = mhlo.power %[[ADD_32]], %[[NEGATE_2]] : tensor<f64>
// CHECK:           %[[ADD_33:.*]] = mhlo.add %[[ADD_31]], %[[POWER_6]] : tensor<f64>
// CHECK:           %[[ADD_34:.*]] = mhlo.add %[[ADD_32]], %[[CONSTANT_29]] : tensor<f64>
// CHECK:           %[[POWER_7:.*]] = mhlo.power %[[ADD_34]], %[[NEGATE_2]] : tensor<f64>
// CHECK:           %[[ADD_35:.*]] = mhlo.add %[[ADD_33]], %[[POWER_7]] : tensor<f64>
// CHECK:           %[[ADD_36:.*]] = mhlo.add %[[ADD_34]], %[[CONSTANT_29]] : tensor<f64>
// CHECK:           %[[POWER_8:.*]] = mhlo.power %[[ADD_36]], %[[NEGATE_2]] : tensor<f64>
// CHECK:           %[[ADD_37:.*]] = mhlo.add %[[ADD_35]], %[[POWER_8]] : tensor<f64>
// CHECK:           %[[ADD_38:.*]] = mhlo.add %[[ADD_36]], %[[CONSTANT_29]] : tensor<f64>
// CHECK:           %[[POWER_9:.*]] = mhlo.power %[[ADD_38]], %[[NEGATE_2]] : tensor<f64>
// CHECK:           %[[ADD_39:.*]] = mhlo.add %[[ADD_37]], %[[POWER_9]] : tensor<f64>
// CHECK:           %[[ADD_40:.*]] = mhlo.add %[[ADD_38]], %[[CONSTANT_29]] : tensor<f64>
// CHECK:           %[[POWER_10:.*]] = mhlo.power %[[ADD_40]], %[[NEGATE_2]] : tensor<f64>
// CHECK:           %[[CONSTANT_30:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f64>
// CHECK:           %[[MULTIPLY_3:.*]] = mhlo.multiply %[[POWER_10]], %[[ADD_40]] : tensor<f64>
// CHECK:           %[[SUBTRACT_7:.*]] = mhlo.subtract %[[ADD_0]], %[[CONSTANT_30]] : tensor<f64>
// CHECK:           %[[DIVIDE_10:.*]] = mhlo.divide %[[MULTIPLY_3]], %[[SUBTRACT_7]] : tensor<f64>
// CHECK:           %[[MULTIPLY_4:.*]] = mhlo.multiply %[[ADD_40]], %[[ADD_40]] : tensor<f64>
// CHECK:           %[[DIVIDE_11:.*]] = mhlo.divide %[[CONSTANT_29]], %[[MULTIPLY_4]] : tensor<f64>
// CHECK:           %[[CONSTANT_31:.*]] = mhlo.constant dense<2.200000e+01> : tensor<f64>
// CHECK:           %[[ADD_41:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_31]] : tensor<f64>
// CHECK:           %[[CONSTANT_32:.*]] = mhlo.constant dense<2.100000e+01> : tensor<f64>
// CHECK:           %[[ADD_42:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_32]] : tensor<f64>
// CHECK:           %[[MULTIPLY_5:.*]] = mhlo.multiply %[[ADD_41]], %[[ADD_42]] : tensor<f64>
// CHECK:           %[[CONSTANT_33:.*]] = mhlo.constant dense<-1.3954464685812522E-19> : tensor<f64>
// CHECK:           %[[ADD_43:.*]] = mhlo.add %[[CONSTANT_28]], %[[CONSTANT_33]] : tensor<f64>
// CHECK:           %[[MULTIPLY_6:.*]] = mhlo.multiply %[[DIVIDE_11]], %[[ADD_43]] : tensor<f64>
// CHECK:           %[[MULTIPLY_7:.*]] = mhlo.multiply %[[MULTIPLY_5]], %[[MULTIPLY_6]] : tensor<f64>
// CHECK:           %[[CONSTANT_34:.*]] = mhlo.constant dense<2.000000e+01> : tensor<f64>
// CHECK:           %[[ADD_44:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_34]] : tensor<f64>
// CHECK:           %[[CONSTANT_35:.*]] = mhlo.constant dense<1.900000e+01> : tensor<f64>
// CHECK:           %[[ADD_45:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_35]] : tensor<f64>
// CHECK:           %[[MULTIPLY_8:.*]] = mhlo.multiply %[[ADD_44]], %[[ADD_45]] : tensor<f64>
// CHECK:           %[[CONSTANT_36:.*]] = mhlo.constant dense<5.5090028283602295E-18> : tensor<f64>
// CHECK:           %[[ADD_46:.*]] = mhlo.add %[[MULTIPLY_7]], %[[CONSTANT_36]] : tensor<f64>
// CHECK:           %[[MULTIPLY_9:.*]] = mhlo.multiply %[[DIVIDE_11]], %[[ADD_46]] : tensor<f64>
// CHECK:           %[[MULTIPLY_10:.*]] = mhlo.multiply %[[MULTIPLY_8]], %[[MULTIPLY_9]] : tensor<f64>
// CHECK:           %[[CONSTANT_37:.*]] = mhlo.constant dense<1.800000e+01> : tensor<f64>
// CHECK:           %[[ADD_47:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_37]] : tensor<f64>
// CHECK:           %[[CONSTANT_38:.*]] = mhlo.constant dense<1.700000e+01> : tensor<f64>
// CHECK:           %[[ADD_48:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_38]] : tensor<f64>
// CHECK:           %[[MULTIPLY_11:.*]] = mhlo.multiply %[[ADD_47]], %[[ADD_48]] : tensor<f64>
// CHECK:           %[[CONSTANT_39:.*]] = mhlo.constant dense<-2.1748686985580617E-16> : tensor<f64>
// CHECK:           %[[ADD_49:.*]] = mhlo.add %[[MULTIPLY_10]], %[[CONSTANT_39]] : tensor<f64>
// CHECK:           %[[MULTIPLY_12:.*]] = mhlo.multiply %[[DIVIDE_11]], %[[ADD_49]] : tensor<f64>
// CHECK:           %[[MULTIPLY_13:.*]] = mhlo.multiply %[[MULTIPLY_11]], %[[MULTIPLY_12]] : tensor<f64>
// CHECK:           %[[CONSTANT_40:.*]] = mhlo.constant dense<1.600000e+01> : tensor<f64>
// CHECK:           %[[ADD_50:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_40]] : tensor<f64>
// CHECK:           %[[CONSTANT_41:.*]] = mhlo.constant dense<1.500000e+01> : tensor<f64>
// CHECK:           %[[ADD_51:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_41]] : tensor<f64>
// CHECK:           %[[MULTIPLY_14:.*]] = mhlo.multiply %[[ADD_50]], %[[ADD_51]] : tensor<f64>
// CHECK:           %[[CONSTANT_42:.*]] = mhlo.constant dense<8.5860620562778452E-15> : tensor<f64>
// CHECK:           %[[ADD_52:.*]] = mhlo.add %[[MULTIPLY_13]], %[[CONSTANT_42]] : tensor<f64>
// CHECK:           %[[MULTIPLY_15:.*]] = mhlo.multiply %[[DIVIDE_11]], %[[ADD_52]] : tensor<f64>
// CHECK:           %[[MULTIPLY_16:.*]] = mhlo.multiply %[[MULTIPLY_14]], %[[MULTIPLY_15]] : tensor<f64>
// CHECK:           %[[CONSTANT_43:.*]] = mhlo.constant dense<1.400000e+01> : tensor<f64>
// CHECK:           %[[ADD_53:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_43]] : tensor<f64>
// CHECK:           %[[CONSTANT_44:.*]] = mhlo.constant dense<1.300000e+01> : tensor<f64>
// CHECK:           %[[ADD_54:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_44]] : tensor<f64>
// CHECK:           %[[MULTIPLY_17:.*]] = mhlo.multiply %[[ADD_53]], %[[ADD_54]] : tensor<f64>
// CHECK:           %[[CONSTANT_45:.*]] = mhlo.constant dense<-3.3896802963225832E-13> : tensor<f64>
// CHECK:           %[[ADD_55:.*]] = mhlo.add %[[MULTIPLY_16]], %[[CONSTANT_45]] : tensor<f64>
// CHECK:           %[[MULTIPLY_18:.*]] = mhlo.multiply %[[DIVIDE_11]], %[[ADD_55]] : tensor<f64>
// CHECK:           %[[MULTIPLY_19:.*]] = mhlo.multiply %[[MULTIPLY_17]], %[[MULTIPLY_18]] : tensor<f64>
// CHECK:           %[[CONSTANT_46:.*]] = mhlo.constant dense<1.200000e+01> : tensor<f64>
// CHECK:           %[[ADD_56:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_46]] : tensor<f64>
// CHECK:           %[[CONSTANT_47:.*]] = mhlo.constant dense<1.100000e+01> : tensor<f64>
// CHECK:           %[[ADD_57:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_47]] : tensor<f64>
// CHECK:           %[[MULTIPLY_20:.*]] = mhlo.multiply %[[ADD_56]], %[[ADD_57]] : tensor<f64>
// CHECK:           %[[CONSTANT_48:.*]] = mhlo.constant dense<1.3382536530684679E-11> : tensor<f64>
// CHECK:           %[[ADD_58:.*]] = mhlo.add %[[MULTIPLY_19]], %[[CONSTANT_48]] : tensor<f64>
// CHECK:           %[[MULTIPLY_21:.*]] = mhlo.multiply %[[DIVIDE_11]], %[[ADD_58]] : tensor<f64>
// CHECK:           %[[MULTIPLY_22:.*]] = mhlo.multiply %[[MULTIPLY_20]], %[[MULTIPLY_21]] : tensor<f64>
// CHECK:           %[[CONSTANT_49:.*]] = mhlo.constant dense<1.000000e+01> : tensor<f64>
// CHECK:           %[[ADD_59:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_49]] : tensor<f64>
// CHECK:           %[[CONSTANT_50:.*]] = mhlo.constant dense<9.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_60:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_50]] : tensor<f64>
// CHECK:           %[[MULTIPLY_23:.*]] = mhlo.multiply %[[ADD_59]], %[[ADD_60]] : tensor<f64>
// CHECK:           %[[CONSTANT_51:.*]] = mhlo.constant dense<-5.2841901386874932E-10> : tensor<f64>
// CHECK:           %[[ADD_61:.*]] = mhlo.add %[[MULTIPLY_22]], %[[CONSTANT_51]] : tensor<f64>
// CHECK:           %[[MULTIPLY_24:.*]] = mhlo.multiply %[[DIVIDE_11]], %[[ADD_61]] : tensor<f64>
// CHECK:           %[[MULTIPLY_25:.*]] = mhlo.multiply %[[MULTIPLY_23]], %[[MULTIPLY_24]] : tensor<f64>
// CHECK:           %[[CONSTANT_52:.*]] = mhlo.constant dense<8.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_62:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_52]] : tensor<f64>
// CHECK:           %[[CONSTANT_53:.*]] = mhlo.constant dense<7.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_63:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_53]] : tensor<f64>
// CHECK:           %[[MULTIPLY_26:.*]] = mhlo.multiply %[[ADD_62]], %[[ADD_63]] : tensor<f64>
// CHECK:           %[[CONSTANT_54:.*]] = mhlo.constant dense<2.08767569878681E-8> : tensor<f64>
// CHECK:           %[[ADD_64:.*]] = mhlo.add %[[MULTIPLY_25]], %[[CONSTANT_54]] : tensor<f64>
// CHECK:           %[[MULTIPLY_27:.*]] = mhlo.multiply %[[DIVIDE_11]], %[[ADD_64]] : tensor<f64>
// CHECK:           %[[MULTIPLY_28:.*]] = mhlo.multiply %[[MULTIPLY_26]], %[[MULTIPLY_27]] : tensor<f64>
// CHECK:           %[[CONSTANT_55:.*]] = mhlo.constant dense<6.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_65:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_55]] : tensor<f64>
// CHECK:           %[[CONSTANT_56:.*]] = mhlo.constant dense<5.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_66:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_56]] : tensor<f64>
// CHECK:           %[[MULTIPLY_29:.*]] = mhlo.multiply %[[ADD_65]], %[[ADD_66]] : tensor<f64>
// CHECK:           %[[CONSTANT_57:.*]] = mhlo.constant dense<-8.2671957671957675E-7> : tensor<f64>
// CHECK:           %[[ADD_67:.*]] = mhlo.add %[[MULTIPLY_28]], %[[CONSTANT_57]] : tensor<f64>
// CHECK:           %[[MULTIPLY_30:.*]] = mhlo.multiply %[[DIVIDE_11]], %[[ADD_67]] : tensor<f64>
// CHECK:           %[[MULTIPLY_31:.*]] = mhlo.multiply %[[MULTIPLY_29]], %[[MULTIPLY_30]] : tensor<f64>
// CHECK:           %[[CONSTANT_58:.*]] = mhlo.constant dense<4.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_68:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_58]] : tensor<f64>
// CHECK:           %[[CONSTANT_59:.*]] = mhlo.constant dense<3.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_69:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_59]] : tensor<f64>
// CHECK:           %[[MULTIPLY_32:.*]] = mhlo.multiply %[[ADD_68]], %[[ADD_69]] : tensor<f64>
// CHECK:           %[[CONSTANT_60:.*]] = mhlo.constant dense<3.3068783068783071E-5> : tensor<f64>
// CHECK:           %[[ADD_70:.*]] = mhlo.add %[[MULTIPLY_31]], %[[CONSTANT_60]] : tensor<f64>
// CHECK:           %[[MULTIPLY_33:.*]] = mhlo.multiply %[[DIVIDE_11]], %[[ADD_70]] : tensor<f64>
// CHECK:           %[[MULTIPLY_34:.*]] = mhlo.multiply %[[MULTIPLY_32]], %[[MULTIPLY_33]] : tensor<f64>
// CHECK:           %[[CONSTANT_61:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_71:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_61]] : tensor<f64>
// CHECK:           %[[CONSTANT_62:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_72:.*]] = mhlo.add %[[ADD_0]], %[[CONSTANT_62]] : tensor<f64>
// CHECK:           %[[MULTIPLY_35:.*]] = mhlo.multiply %[[ADD_71]], %[[ADD_72]] : tensor<f64>
// CHECK:           %[[CONSTANT_63:.*]] = mhlo.constant dense<-0.0013888888888888889> : tensor<f64>
// CHECK:           %[[ADD_73:.*]] = mhlo.add %[[MULTIPLY_34]], %[[CONSTANT_63]] : tensor<f64>
// CHECK:           %[[MULTIPLY_36:.*]] = mhlo.multiply %[[DIVIDE_11]], %[[ADD_73]] : tensor<f64>
// CHECK:           %[[MULTIPLY_37:.*]] = mhlo.multiply %[[MULTIPLY_35]], %[[MULTIPLY_36]] : tensor<f64>
// CHECK:           %[[CONSTANT_64:.*]] = mhlo.constant dense<5.000000e-01> : tensor<f64>
// CHECK:           %[[DIVIDE_12:.*]] = mhlo.divide %[[ADD_0]], %[[ADD_40]] : tensor<f64>
// CHECK:           %[[CONSTANT_65:.*]] = mhlo.constant dense<0.083333333333333329> : tensor<f64>
// CHECK:           %[[ADD_74:.*]] = mhlo.add %[[CONSTANT_65]], %[[MULTIPLY_37]] : tensor<f64>
// CHECK:           %[[MULTIPLY_38:.*]] = mhlo.multiply %[[DIVIDE_12]], %[[ADD_74]] : tensor<f64>
// CHECK:           %[[ADD_75:.*]] = mhlo.add %[[CONSTANT_64]], %[[MULTIPLY_38]] : tensor<f64>
// CHECK:           %[[MULTIPLY_39:.*]] = mhlo.multiply %[[POWER_10]], %[[ADD_75]] : tensor<f64>
// CHECK:           %[[ADD_76:.*]] = mhlo.add %[[ADD_39]], %[[DIVIDE_10]] : tensor<f64>
// CHECK:           %[[ADD_77:.*]] = mhlo.add %[[ADD_76]], %[[MULTIPLY_39]] : tensor<f64>
// CHECK:           %[[ABS_2:.*]] = mhlo.abs %[[POWER_10]] : tensor<f64>
// CHECK:           %[[ABS_3:.*]] = mhlo.abs %[[ADD_39]] : tensor<f64>
// CHECK:           %[[CONSTANT_66:.*]] = mhlo.constant dense<4.940660e-324> : tensor<f64>
// CHECK:           %[[MULTIPLY_40:.*]] = mhlo.multiply %[[ABS_3]], %[[CONSTANT_66]] : tensor<f64>
// CHECK:           %[[COMPARE_3:.*]] = mhlo.compare LT, %[[ABS_2]], %[[MULTIPLY_40]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[SELECT_5:.*]] = mhlo.select %[[COMPARE_3]], %[[ADD_39]], %[[ADD_77]] : tensor<i1>, tensor<f64>
// CHECK:           %[[CONSTANT_67:.*]] = mhlo.constant dense<0x7FF8000000000000> : tensor<f64>
// CHECK:           %[[COMPARE_4:.*]] = mhlo.compare LT, %[[ADD_0]], %[[CONSTANT_30]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[SELECT_6:.*]] = mhlo.select %[[COMPARE_4]], %[[CONSTANT_67]], %[[SELECT_5]] : tensor<i1>, tensor<f64>
// CHECK:           %[[COMPARE_5:.*]] = mhlo.compare LE, %[[VAL_1]], %[[CONSTANT_28]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[FLOOR_1:.*]] = mhlo.floor %[[ADD_0]] : tensor<f64>
// CHECK:           %[[COMPARE_6:.*]] = mhlo.compare NE, %[[ADD_0]], %[[FLOOR_1]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[AND_0:.*]] = mhlo.and %[[COMPARE_5]], %[[COMPARE_6]] : tensor<i1>
// CHECK:           %[[SELECT_7:.*]] = mhlo.select %[[AND_0]], %[[CONSTANT_67]], %[[SELECT_6]] : tensor<i1>, tensor<f64>
// CHECK:           %[[CONSTANT_68:.*]] = mhlo.constant dense<0x7FF0000000000000> : tensor<f64>
// CHECK:           %[[FLOOR_2:.*]] = mhlo.floor %[[VAL_1]] : tensor<f64>
// CHECK:           %[[COMPARE_7:.*]] = mhlo.compare EQ, %[[VAL_1]], %[[FLOOR_2]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[AND_1:.*]] = mhlo.and %[[COMPARE_5]], %[[COMPARE_7]] : tensor<i1>
// CHECK:           %[[CONSTANT_69:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f64>
// CHECK:           %[[FLOOR_3:.*]] = mhlo.floor %[[ADD_0]] : tensor<f64>
// CHECK:           %[[COMPARE_8:.*]] = mhlo.compare EQ, %[[ADD_0]], %[[FLOOR_3]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[REMAINDER_1:.*]] = mhlo.remainder %[[ADD_0]], %[[CONSTANT_69]] : tensor<f64>
// CHECK:           %[[COMPARE_9:.*]] = mhlo.compare EQ, %[[REMAINDER_1]], %[[CONSTANT_28]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[AND_2:.*]] = mhlo.and %[[COMPARE_8]], %[[COMPARE_9]] : tensor<i1>
// CHECK:           %[[SELECT_8:.*]] = mhlo.select %[[AND_2]], %[[CONSTANT_68]], %[[CONSTANT_67]] : tensor<i1>, tensor<f64>
// CHECK:           %[[SELECT_9:.*]] = mhlo.select %[[AND_1]], %[[SELECT_8]], %[[SELECT_7]] : tensor<i1>, tensor<f64>
// CHECK:           %[[COMPARE_10:.*]] = mhlo.compare EQ, %[[ADD_0]], %[[CONSTANT_29]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[SELECT_10:.*]] = mhlo.select %[[COMPARE_10]], %[[CONSTANT_68]], %[[SELECT_9]] : tensor<i1>, tensor<f64>
// CHECK:           %[[MULTIPLY_41:.*]] = mhlo.multiply %[[SUBTRACT_0]], %[[EXPONENTIAL_0]] : tensor<f64>
// CHECK:           %[[MULTIPLY_42:.*]] = mhlo.multiply %[[MULTIPLY_41]], %[[SELECT_10]] : tensor<f64>
// CHECK:           %[[CONSTANT_70:.*]] = mhlo.constant dense<5.000000e-01> : tensor<f64>
// CHECK:           %[[ADD_78:.*]] = mhlo.add %[[VAL_1]], %[[CONSTANT_70]] : tensor<f64>
// CHECK:           %[[FLOOR_4:.*]] = mhlo.floor %[[ADD_78]] : tensor<f64>
// CHECK:           %[[ABS_4:.*]] = mhlo.abs %[[FLOOR_4]] : tensor<f64>
// CHECK:           %[[ADD_79:.*]] = mhlo.add %[[VAL_1]], %[[ABS_4]] : tensor<f64>
// CHECK:           %[[CONSTANT_71:.*]] = mhlo.constant dense<3.1415926535897931> : tensor<f64>
// CHECK:           %[[MULTIPLY_43:.*]] = mhlo.multiply %[[CONSTANT_71]], %[[ADD_79]] : tensor<f64>
// CHECK:           %[[COSINE_0:.*]] = mhlo.cosine %[[MULTIPLY_43]] : tensor<f64>
// CHECK:           %[[SINE_1:.*]] = mhlo.sine %[[MULTIPLY_43]] : tensor<f64>
// CHECK:           %[[DIVIDE_13:.*]] = mhlo.divide %[[COSINE_0]], %[[SINE_1]] : tensor<f64>
// CHECK:           %[[FLOOR_5:.*]] = mhlo.floor %[[VAL_0]] : tensor<f64>
// CHECK:           %[[CONSTANT_72:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f64>
// CHECK:           %[[MULTIPLY_44:.*]] = mhlo.multiply %[[CONSTANT_72]], %[[DIVIDE_13]] : tensor<f64>
// CHECK:           %[[CONSTANT_73:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_80:.*]] = mhlo.add %[[MULTIPLY_44]], %[[CONSTANT_73]] : tensor<f64>
// CHECK:           %[[MULTIPLY_45:.*]] = mhlo.multiply %[[ADD_80]], %[[DIVIDE_13]] : tensor<f64>
// CHECK:           %[[CONSTANT_74:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_81:.*]] = mhlo.add %[[MULTIPLY_45]], %[[CONSTANT_74]] : tensor<f64>
// CHECK:           %[[MULTIPLY_46:.*]] = mhlo.multiply %[[ADD_81]], %[[DIVIDE_13]] : tensor<f64>
// CHECK:           %[[CONSTANT_75:.*]] = mhlo.constant dense<6.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_82:.*]] = mhlo.add %[[MULTIPLY_46]], %[[CONSTANT_75]] : tensor<f64>
// CHECK:           %[[MULTIPLY_47:.*]] = mhlo.multiply %[[ADD_82]], %[[DIVIDE_13]] : tensor<f64>
// CHECK:           %[[CONSTANT_76:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_83:.*]] = mhlo.add %[[MULTIPLY_47]], %[[CONSTANT_76]] : tensor<f64>
// CHECK:           %[[MULTIPLY_48:.*]] = mhlo.multiply %[[ADD_83]], %[[DIVIDE_13]] : tensor<f64>
// CHECK:           %[[CONSTANT_77:.*]] = mhlo.constant dense<8.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_84:.*]] = mhlo.add %[[MULTIPLY_48]], %[[CONSTANT_77]] : tensor<f64>
// CHECK:           %[[MULTIPLY_49:.*]] = mhlo.multiply %[[ADD_84]], %[[DIVIDE_13]] : tensor<f64>
// CHECK:           %[[CONSTANT_78:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_85:.*]] = mhlo.add %[[MULTIPLY_49]], %[[CONSTANT_78]] : tensor<f64>
// CHECK:           %[[MULTIPLY_50:.*]] = mhlo.multiply %[[ADD_85]], %[[DIVIDE_13]] : tensor<f64>
// CHECK:           %[[CONSTANT_79:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_86:.*]] = mhlo.add %[[MULTIPLY_50]], %[[CONSTANT_79]] : tensor<f64>
// CHECK:           %[[CONSTANT_80:.*]] = mhlo.constant dense<97.409091034002415> : tensor<f64>
// CHECK:           %[[MULTIPLY_51:.*]] = mhlo.multiply %[[CONSTANT_80]], %[[ADD_86]] : tensor<f64>
// CHECK:           %[[SUBTRACT_8:.*]] = mhlo.subtract %[[CONSTANT_0]], %[[VAL_1]] : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_81:.*]] = mhlo.constant dense<4.000000e+00> : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_82:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_83:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f64>
// CHECK:           %[[NEGATE_3:.*]] = mhlo.negate %[[CONSTANT_81]] : tensor<f64>
// CHECK:           %[[POWER_11:.*]] = mhlo.power %[[SUBTRACT_8]], %[[NEGATE_3]] : tensor<f64>
// CHECK:           %[[ADD_87:.*]] = mhlo.add %[[SUBTRACT_8]], %[[CONSTANT_83]] : tensor<f64>
// CHECK:           %[[POWER_12:.*]] = mhlo.power %[[ADD_87]], %[[NEGATE_3]] : tensor<f64>
// CHECK:           %[[ADD_88:.*]] = mhlo.add %[[POWER_11]], %[[POWER_12]] : tensor<f64>
// CHECK:           %[[ADD_89:.*]] = mhlo.add %[[ADD_87]], %[[CONSTANT_83]] : tensor<f64>
// CHECK:           %[[POWER_13:.*]] = mhlo.power %[[ADD_89]], %[[NEGATE_3]] : tensor<f64>
// CHECK:           %[[ADD_90:.*]] = mhlo.add %[[ADD_88]], %[[POWER_13]] : tensor<f64>
// CHECK:           %[[ADD_91:.*]] = mhlo.add %[[ADD_89]], %[[CONSTANT_83]] : tensor<f64>
// CHECK:           %[[POWER_14:.*]] = mhlo.power %[[ADD_91]], %[[NEGATE_3]] : tensor<f64>
// CHECK:           %[[ADD_92:.*]] = mhlo.add %[[ADD_90]], %[[POWER_14]] : tensor<f64>
// CHECK:           %[[ADD_93:.*]] = mhlo.add %[[ADD_91]], %[[CONSTANT_83]] : tensor<f64>
// CHECK:           %[[POWER_15:.*]] = mhlo.power %[[ADD_93]], %[[NEGATE_3]] : tensor<f64>
// CHECK:           %[[ADD_94:.*]] = mhlo.add %[[ADD_92]], %[[POWER_15]] : tensor<f64>
// CHECK:           %[[ADD_95:.*]] = mhlo.add %[[ADD_93]], %[[CONSTANT_83]] : tensor<f64>
// CHECK:           %[[POWER_16:.*]] = mhlo.power %[[ADD_95]], %[[NEGATE_3]] : tensor<f64>
// CHECK:           %[[ADD_96:.*]] = mhlo.add %[[ADD_94]], %[[POWER_16]] : tensor<f64>
// CHECK:           %[[ADD_97:.*]] = mhlo.add %[[ADD_95]], %[[CONSTANT_83]] : tensor<f64>
// CHECK:           %[[POWER_17:.*]] = mhlo.power %[[ADD_97]], %[[NEGATE_3]] : tensor<f64>
// CHECK:           %[[ADD_98:.*]] = mhlo.add %[[ADD_96]], %[[POWER_17]] : tensor<f64>
// CHECK:           %[[ADD_99:.*]] = mhlo.add %[[ADD_97]], %[[CONSTANT_83]] : tensor<f64>
// CHECK:           %[[POWER_18:.*]] = mhlo.power %[[ADD_99]], %[[NEGATE_3]] : tensor<f64>
// CHECK:           %[[ADD_100:.*]] = mhlo.add %[[ADD_98]], %[[POWER_18]] : tensor<f64>
// CHECK:           %[[ADD_101:.*]] = mhlo.add %[[ADD_99]], %[[CONSTANT_83]] : tensor<f64>
// CHECK:           %[[POWER_19:.*]] = mhlo.power %[[ADD_101]], %[[NEGATE_3]] : tensor<f64>
// CHECK:           %[[ADD_102:.*]] = mhlo.add %[[ADD_100]], %[[POWER_19]] : tensor<f64>
// CHECK:           %[[ADD_103:.*]] = mhlo.add %[[ADD_101]], %[[CONSTANT_83]] : tensor<f64>
// CHECK:           %[[POWER_20:.*]] = mhlo.power %[[ADD_103]], %[[NEGATE_3]] : tensor<f64>
// CHECK:           %[[ADD_104:.*]] = mhlo.add %[[ADD_102]], %[[POWER_20]] : tensor<f64>
// CHECK:           %[[ADD_105:.*]] = mhlo.add %[[ADD_103]], %[[CONSTANT_83]] : tensor<f64>
// CHECK:           %[[POWER_21:.*]] = mhlo.power %[[ADD_105]], %[[NEGATE_3]] : tensor<f64>
// CHECK:           %[[CONSTANT_84:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f64>
// CHECK:           %[[MULTIPLY_52:.*]] = mhlo.multiply %[[POWER_21]], %[[ADD_105]] : tensor<f64>
// CHECK:           %[[SUBTRACT_9:.*]] = mhlo.subtract %[[CONSTANT_81]], %[[CONSTANT_84]] : tensor<f64>
// CHECK:           %[[DIVIDE_14:.*]] = mhlo.divide %[[MULTIPLY_52]], %[[SUBTRACT_9]] : tensor<f64>
// CHECK:           %[[MULTIPLY_53:.*]] = mhlo.multiply %[[ADD_105]], %[[ADD_105]] : tensor<f64>
// CHECK:           %[[DIVIDE_15:.*]] = mhlo.divide %[[CONSTANT_83]], %[[MULTIPLY_53]] : tensor<f64>
// CHECK:           %[[CONSTANT_85:.*]] = mhlo.constant dense<2.200000e+01> : tensor<f64>
// CHECK:           %[[ADD_106:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_85]] : tensor<f64>
// CHECK:           %[[CONSTANT_86:.*]] = mhlo.constant dense<2.100000e+01> : tensor<f64>
// CHECK:           %[[ADD_107:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_86]] : tensor<f64>
// CHECK:           %[[MULTIPLY_54:.*]] = mhlo.multiply %[[ADD_106]], %[[ADD_107]] : tensor<f64>
// CHECK:           %[[CONSTANT_87:.*]] = mhlo.constant dense<-1.3954464685812522E-19> : tensor<f64>
// CHECK:           %[[ADD_108:.*]] = mhlo.add %[[CONSTANT_82]], %[[CONSTANT_87]] : tensor<f64>
// CHECK:           %[[MULTIPLY_55:.*]] = mhlo.multiply %[[DIVIDE_15]], %[[ADD_108]] : tensor<f64>
// CHECK:           %[[MULTIPLY_56:.*]] = mhlo.multiply %[[MULTIPLY_54]], %[[MULTIPLY_55]] : tensor<f64>
// CHECK:           %[[CONSTANT_88:.*]] = mhlo.constant dense<2.000000e+01> : tensor<f64>
// CHECK:           %[[ADD_109:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_88]] : tensor<f64>
// CHECK:           %[[CONSTANT_89:.*]] = mhlo.constant dense<1.900000e+01> : tensor<f64>
// CHECK:           %[[ADD_110:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_89]] : tensor<f64>
// CHECK:           %[[MULTIPLY_57:.*]] = mhlo.multiply %[[ADD_109]], %[[ADD_110]] : tensor<f64>
// CHECK:           %[[CONSTANT_90:.*]] = mhlo.constant dense<5.5090028283602295E-18> : tensor<f64>
// CHECK:           %[[ADD_111:.*]] = mhlo.add %[[MULTIPLY_56]], %[[CONSTANT_90]] : tensor<f64>
// CHECK:           %[[MULTIPLY_58:.*]] = mhlo.multiply %[[DIVIDE_15]], %[[ADD_111]] : tensor<f64>
// CHECK:           %[[MULTIPLY_59:.*]] = mhlo.multiply %[[MULTIPLY_57]], %[[MULTIPLY_58]] : tensor<f64>
// CHECK:           %[[CONSTANT_91:.*]] = mhlo.constant dense<1.800000e+01> : tensor<f64>
// CHECK:           %[[ADD_112:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_91]] : tensor<f64>
// CHECK:           %[[CONSTANT_92:.*]] = mhlo.constant dense<1.700000e+01> : tensor<f64>
// CHECK:           %[[ADD_113:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_92]] : tensor<f64>
// CHECK:           %[[MULTIPLY_60:.*]] = mhlo.multiply %[[ADD_112]], %[[ADD_113]] : tensor<f64>
// CHECK:           %[[CONSTANT_93:.*]] = mhlo.constant dense<-2.1748686985580617E-16> : tensor<f64>
// CHECK:           %[[ADD_114:.*]] = mhlo.add %[[MULTIPLY_59]], %[[CONSTANT_93]] : tensor<f64>
// CHECK:           %[[MULTIPLY_61:.*]] = mhlo.multiply %[[DIVIDE_15]], %[[ADD_114]] : tensor<f64>
// CHECK:           %[[MULTIPLY_62:.*]] = mhlo.multiply %[[MULTIPLY_60]], %[[MULTIPLY_61]] : tensor<f64>
// CHECK:           %[[CONSTANT_94:.*]] = mhlo.constant dense<1.600000e+01> : tensor<f64>
// CHECK:           %[[ADD_115:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_94]] : tensor<f64>
// CHECK:           %[[CONSTANT_95:.*]] = mhlo.constant dense<1.500000e+01> : tensor<f64>
// CHECK:           %[[ADD_116:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_95]] : tensor<f64>
// CHECK:           %[[MULTIPLY_63:.*]] = mhlo.multiply %[[ADD_115]], %[[ADD_116]] : tensor<f64>
// CHECK:           %[[CONSTANT_96:.*]] = mhlo.constant dense<8.5860620562778452E-15> : tensor<f64>
// CHECK:           %[[ADD_117:.*]] = mhlo.add %[[MULTIPLY_62]], %[[CONSTANT_96]] : tensor<f64>
// CHECK:           %[[MULTIPLY_64:.*]] = mhlo.multiply %[[DIVIDE_15]], %[[ADD_117]] : tensor<f64>
// CHECK:           %[[MULTIPLY_65:.*]] = mhlo.multiply %[[MULTIPLY_63]], %[[MULTIPLY_64]] : tensor<f64>
// CHECK:           %[[CONSTANT_97:.*]] = mhlo.constant dense<1.400000e+01> : tensor<f64>
// CHECK:           %[[ADD_118:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_97]] : tensor<f64>
// CHECK:           %[[CONSTANT_98:.*]] = mhlo.constant dense<1.300000e+01> : tensor<f64>
// CHECK:           %[[ADD_119:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_98]] : tensor<f64>
// CHECK:           %[[MULTIPLY_66:.*]] = mhlo.multiply %[[ADD_118]], %[[ADD_119]] : tensor<f64>
// CHECK:           %[[CONSTANT_99:.*]] = mhlo.constant dense<-3.3896802963225832E-13> : tensor<f64>
// CHECK:           %[[ADD_120:.*]] = mhlo.add %[[MULTIPLY_65]], %[[CONSTANT_99]] : tensor<f64>
// CHECK:           %[[MULTIPLY_67:.*]] = mhlo.multiply %[[DIVIDE_15]], %[[ADD_120]] : tensor<f64>
// CHECK:           %[[MULTIPLY_68:.*]] = mhlo.multiply %[[MULTIPLY_66]], %[[MULTIPLY_67]] : tensor<f64>
// CHECK:           %[[CONSTANT_100:.*]] = mhlo.constant dense<1.200000e+01> : tensor<f64>
// CHECK:           %[[ADD_121:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_100]] : tensor<f64>
// CHECK:           %[[CONSTANT_101:.*]] = mhlo.constant dense<1.100000e+01> : tensor<f64>
// CHECK:           %[[ADD_122:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_101]] : tensor<f64>
// CHECK:           %[[MULTIPLY_69:.*]] = mhlo.multiply %[[ADD_121]], %[[ADD_122]] : tensor<f64>
// CHECK:           %[[CONSTANT_102:.*]] = mhlo.constant dense<1.3382536530684679E-11> : tensor<f64>
// CHECK:           %[[ADD_123:.*]] = mhlo.add %[[MULTIPLY_68]], %[[CONSTANT_102]] : tensor<f64>
// CHECK:           %[[MULTIPLY_70:.*]] = mhlo.multiply %[[DIVIDE_15]], %[[ADD_123]] : tensor<f64>
// CHECK:           %[[MULTIPLY_71:.*]] = mhlo.multiply %[[MULTIPLY_69]], %[[MULTIPLY_70]] : tensor<f64>
// CHECK:           %[[CONSTANT_103:.*]] = mhlo.constant dense<1.000000e+01> : tensor<f64>
// CHECK:           %[[ADD_124:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_103]] : tensor<f64>
// CHECK:           %[[CONSTANT_104:.*]] = mhlo.constant dense<9.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_125:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_104]] : tensor<f64>
// CHECK:           %[[MULTIPLY_72:.*]] = mhlo.multiply %[[ADD_124]], %[[ADD_125]] : tensor<f64>
// CHECK:           %[[CONSTANT_105:.*]] = mhlo.constant dense<-5.2841901386874932E-10> : tensor<f64>
// CHECK:           %[[ADD_126:.*]] = mhlo.add %[[MULTIPLY_71]], %[[CONSTANT_105]] : tensor<f64>
// CHECK:           %[[MULTIPLY_73:.*]] = mhlo.multiply %[[DIVIDE_15]], %[[ADD_126]] : tensor<f64>
// CHECK:           %[[MULTIPLY_74:.*]] = mhlo.multiply %[[MULTIPLY_72]], %[[MULTIPLY_73]] : tensor<f64>
// CHECK:           %[[CONSTANT_106:.*]] = mhlo.constant dense<8.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_127:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_106]] : tensor<f64>
// CHECK:           %[[CONSTANT_107:.*]] = mhlo.constant dense<7.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_128:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_107]] : tensor<f64>
// CHECK:           %[[MULTIPLY_75:.*]] = mhlo.multiply %[[ADD_127]], %[[ADD_128]] : tensor<f64>
// CHECK:           %[[CONSTANT_108:.*]] = mhlo.constant dense<2.08767569878681E-8> : tensor<f64>
// CHECK:           %[[ADD_129:.*]] = mhlo.add %[[MULTIPLY_74]], %[[CONSTANT_108]] : tensor<f64>
// CHECK:           %[[MULTIPLY_76:.*]] = mhlo.multiply %[[DIVIDE_15]], %[[ADD_129]] : tensor<f64>
// CHECK:           %[[MULTIPLY_77:.*]] = mhlo.multiply %[[MULTIPLY_75]], %[[MULTIPLY_76]] : tensor<f64>
// CHECK:           %[[CONSTANT_109:.*]] = mhlo.constant dense<6.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_130:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_109]] : tensor<f64>
// CHECK:           %[[CONSTANT_110:.*]] = mhlo.constant dense<5.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_131:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_110]] : tensor<f64>
// CHECK:           %[[MULTIPLY_78:.*]] = mhlo.multiply %[[ADD_130]], %[[ADD_131]] : tensor<f64>
// CHECK:           %[[CONSTANT_111:.*]] = mhlo.constant dense<-8.2671957671957675E-7> : tensor<f64>
// CHECK:           %[[ADD_132:.*]] = mhlo.add %[[MULTIPLY_77]], %[[CONSTANT_111]] : tensor<f64>
// CHECK:           %[[MULTIPLY_79:.*]] = mhlo.multiply %[[DIVIDE_15]], %[[ADD_132]] : tensor<f64>
// CHECK:           %[[MULTIPLY_80:.*]] = mhlo.multiply %[[MULTIPLY_78]], %[[MULTIPLY_79]] : tensor<f64>
// CHECK:           %[[CONSTANT_112:.*]] = mhlo.constant dense<4.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_133:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_112]] : tensor<f64>
// CHECK:           %[[CONSTANT_113:.*]] = mhlo.constant dense<3.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_134:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_113]] : tensor<f64>
// CHECK:           %[[MULTIPLY_81:.*]] = mhlo.multiply %[[ADD_133]], %[[ADD_134]] : tensor<f64>
// CHECK:           %[[CONSTANT_114:.*]] = mhlo.constant dense<3.3068783068783071E-5> : tensor<f64>
// CHECK:           %[[ADD_135:.*]] = mhlo.add %[[MULTIPLY_80]], %[[CONSTANT_114]] : tensor<f64>
// CHECK:           %[[MULTIPLY_82:.*]] = mhlo.multiply %[[DIVIDE_15]], %[[ADD_135]] : tensor<f64>
// CHECK:           %[[MULTIPLY_83:.*]] = mhlo.multiply %[[MULTIPLY_81]], %[[MULTIPLY_82]] : tensor<f64>
// CHECK:           %[[CONSTANT_115:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_136:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_115]] : tensor<f64>
// CHECK:           %[[CONSTANT_116:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_137:.*]] = mhlo.add %[[CONSTANT_81]], %[[CONSTANT_116]] : tensor<f64>
// CHECK:           %[[MULTIPLY_84:.*]] = mhlo.multiply %[[ADD_136]], %[[ADD_137]] : tensor<f64>
// CHECK:           %[[CONSTANT_117:.*]] = mhlo.constant dense<-0.0013888888888888889> : tensor<f64>
// CHECK:           %[[ADD_138:.*]] = mhlo.add %[[MULTIPLY_83]], %[[CONSTANT_117]] : tensor<f64>
// CHECK:           %[[MULTIPLY_85:.*]] = mhlo.multiply %[[DIVIDE_15]], %[[ADD_138]] : tensor<f64>
// CHECK:           %[[MULTIPLY_86:.*]] = mhlo.multiply %[[MULTIPLY_84]], %[[MULTIPLY_85]] : tensor<f64>
// CHECK:           %[[CONSTANT_118:.*]] = mhlo.constant dense<5.000000e-01> : tensor<f64>
// CHECK:           %[[DIVIDE_16:.*]] = mhlo.divide %[[CONSTANT_81]], %[[ADD_105]] : tensor<f64>
// CHECK:           %[[CONSTANT_119:.*]] = mhlo.constant dense<0.083333333333333329> : tensor<f64>
// CHECK:           %[[ADD_139:.*]] = mhlo.add %[[CONSTANT_119]], %[[MULTIPLY_86]] : tensor<f64>
// CHECK:           %[[MULTIPLY_87:.*]] = mhlo.multiply %[[DIVIDE_16]], %[[ADD_139]] : tensor<f64>
// CHECK:           %[[ADD_140:.*]] = mhlo.add %[[CONSTANT_118]], %[[MULTIPLY_87]] : tensor<f64>
// CHECK:           %[[MULTIPLY_88:.*]] = mhlo.multiply %[[POWER_21]], %[[ADD_140]] : tensor<f64>
// CHECK:           %[[ADD_141:.*]] = mhlo.add %[[ADD_104]], %[[DIVIDE_14]] : tensor<f64>
// CHECK:           %[[ADD_142:.*]] = mhlo.add %[[ADD_141]], %[[MULTIPLY_88]] : tensor<f64>
// CHECK:           %[[ABS_5:.*]] = mhlo.abs %[[POWER_21]] : tensor<f64>
// CHECK:           %[[ABS_6:.*]] = mhlo.abs %[[ADD_104]] : tensor<f64>
// CHECK:           %[[CONSTANT_120:.*]] = mhlo.constant dense<4.940660e-324> : tensor<f64>
// CHECK:           %[[MULTIPLY_89:.*]] = mhlo.multiply %[[ABS_6]], %[[CONSTANT_120]] : tensor<f64>
// CHECK:           %[[COMPARE_11:.*]] = mhlo.compare LT, %[[ABS_5]], %[[MULTIPLY_89]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[SELECT_11:.*]] = mhlo.select %[[COMPARE_11]], %[[ADD_104]], %[[ADD_142]] : tensor<i1>, tensor<f64>
// CHECK:           %[[CONSTANT_121:.*]] = mhlo.constant dense<0x7FF8000000000000> : tensor<f64>
// CHECK:           %[[COMPARE_12:.*]] = mhlo.compare LT, %[[CONSTANT_81]], %[[CONSTANT_84]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[SELECT_12:.*]] = mhlo.select %[[COMPARE_12]], %[[CONSTANT_121]], %[[SELECT_11]] : tensor<i1>, tensor<f64>
// CHECK:           %[[COMPARE_13:.*]] = mhlo.compare LE, %[[SUBTRACT_8]], %[[CONSTANT_82]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[FLOOR_6:.*]] = mhlo.floor %[[CONSTANT_81]] : tensor<f64>
// CHECK:           %[[COMPARE_14:.*]] = mhlo.compare NE, %[[CONSTANT_81]], %[[FLOOR_6]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[AND_3:.*]] = mhlo.and %[[COMPARE_13]], %[[COMPARE_14]] : tensor<i1>
// CHECK:           %[[SELECT_13:.*]] = mhlo.select %[[AND_3]], %[[CONSTANT_121]], %[[SELECT_12]] : tensor<i1>, tensor<f64>
// CHECK:           %[[CONSTANT_122:.*]] = mhlo.constant dense<0x7FF0000000000000> : tensor<f64>
// CHECK:           %[[FLOOR_7:.*]] = mhlo.floor %[[SUBTRACT_8]] : tensor<f64>
// CHECK:           %[[COMPARE_15:.*]] = mhlo.compare EQ, %[[SUBTRACT_8]], %[[FLOOR_7]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[AND_4:.*]] = mhlo.and %[[COMPARE_13]], %[[COMPARE_15]] : tensor<i1>
// CHECK:           %[[CONSTANT_123:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f64>
// CHECK:           %[[FLOOR_8:.*]] = mhlo.floor %[[CONSTANT_81]] : tensor<f64>
// CHECK:           %[[COMPARE_16:.*]] = mhlo.compare EQ, %[[CONSTANT_81]], %[[FLOOR_8]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[REMAINDER_2:.*]] = mhlo.remainder %[[CONSTANT_81]], %[[CONSTANT_123]] : tensor<f64>
// CHECK:           %[[COMPARE_17:.*]] = mhlo.compare EQ, %[[REMAINDER_2]], %[[CONSTANT_82]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[AND_5:.*]] = mhlo.and %[[COMPARE_16]], %[[COMPARE_17]] : tensor<i1>
// CHECK:           %[[SELECT_14:.*]] = mhlo.select %[[AND_5]], %[[CONSTANT_122]], %[[CONSTANT_121]] : tensor<i1>, tensor<f64>
// CHECK:           %[[SELECT_15:.*]] = mhlo.select %[[AND_4]], %[[SELECT_14]], %[[SELECT_13]] : tensor<i1>, tensor<f64>
// CHECK:           %[[COMPARE_18:.*]] = mhlo.compare EQ, %[[CONSTANT_81]], %[[CONSTANT_83]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[SELECT_16:.*]] = mhlo.select %[[COMPARE_18]], %[[CONSTANT_122]], %[[SELECT_15]] : tensor<i1>, tensor<f64>
// CHECK:           %[[CONSTANT_124:.*]] = mhlo.constant dense<6.000000e+00> : tensor<f64>
// CHECK:           %[[MULTIPLY_90:.*]] = mhlo.multiply %[[CONSTANT_124]], %[[SELECT_16]] : tensor<f64>
// CHECK:           %[[CONSTANT_125:.*]] = mhlo.constant dense<-1.000000e+00> : tensor<f64>
// CHECK:           %[[MULTIPLY_91:.*]] = mhlo.multiply %[[CONSTANT_125]], %[[MULTIPLY_90]] : tensor<f64>
// CHECK:           %[[ADD_143:.*]] = mhlo.add %[[MULTIPLY_51]], %[[MULTIPLY_91]] : tensor<f64>
// CHECK:           %[[CONSTANT_126:.*]] = mhlo.constant dense<3.000000e+00> : tensor<f64>
// CHECK:           %[[COMPARE_19:.*]] = mhlo.compare EQ, %[[FLOOR_5]], %[[CONSTANT_126]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[SELECT_17:.*]] = mhlo.select %[[COMPARE_19]], %[[ADD_143]], %[[MULTIPLY_42]] : tensor<i1>, tensor<f64>
// CHECK:           %[[CONSTANT_127:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f64>
// CHECK:           %[[MULTIPLY_92:.*]] = mhlo.multiply %[[CONSTANT_127]], %[[DIVIDE_13]] : tensor<f64>
// CHECK:           %[[CONSTANT_128:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_144:.*]] = mhlo.add %[[MULTIPLY_92]], %[[CONSTANT_128]] : tensor<f64>
// CHECK:           %[[MULTIPLY_93:.*]] = mhlo.multiply %[[ADD_144]], %[[DIVIDE_13]] : tensor<f64>
// CHECK:           %[[CONSTANT_129:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_145:.*]] = mhlo.add %[[MULTIPLY_93]], %[[CONSTANT_129]] : tensor<f64>
// CHECK:           %[[MULTIPLY_94:.*]] = mhlo.multiply %[[ADD_145]], %[[DIVIDE_13]] : tensor<f64>
// CHECK:           %[[CONSTANT_130:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_146:.*]] = mhlo.add %[[MULTIPLY_94]], %[[CONSTANT_130]] : tensor<f64>
// CHECK:           %[[MULTIPLY_95:.*]] = mhlo.multiply %[[ADD_146]], %[[DIVIDE_13]] : tensor<f64>
// CHECK:           %[[CONSTANT_131:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_147:.*]] = mhlo.add %[[MULTIPLY_95]], %[[CONSTANT_131]] : tensor<f64>
// CHECK:           %[[MULTIPLY_96:.*]] = mhlo.multiply %[[ADD_147]], %[[DIVIDE_13]] : tensor<f64>
// CHECK:           %[[CONSTANT_132:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_148:.*]] = mhlo.add %[[MULTIPLY_96]], %[[CONSTANT_132]] : tensor<f64>
// CHECK:           %[[CONSTANT_133:.*]] = mhlo.constant dense<-31.006276680299816> : tensor<f64>
// CHECK:           %[[MULTIPLY_97:.*]] = mhlo.multiply %[[CONSTANT_133]], %[[ADD_148]] : tensor<f64>
// CHECK:           %[[SUBTRACT_10:.*]] = mhlo.subtract %[[CONSTANT_0]], %[[VAL_1]] : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_134:.*]] = mhlo.constant dense<3.000000e+00> : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_135:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_136:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f64>
// CHECK:           %[[NEGATE_4:.*]] = mhlo.negate %[[CONSTANT_134]] : tensor<f64>
// CHECK:           %[[POWER_22:.*]] = mhlo.power %[[SUBTRACT_10]], %[[NEGATE_4]] : tensor<f64>
// CHECK:           %[[ADD_149:.*]] = mhlo.add %[[SUBTRACT_10]], %[[CONSTANT_136]] : tensor<f64>
// CHECK:           %[[POWER_23:.*]] = mhlo.power %[[ADD_149]], %[[NEGATE_4]] : tensor<f64>
// CHECK:           %[[ADD_150:.*]] = mhlo.add %[[POWER_22]], %[[POWER_23]] : tensor<f64>
// CHECK:           %[[ADD_151:.*]] = mhlo.add %[[ADD_149]], %[[CONSTANT_136]] : tensor<f64>
// CHECK:           %[[POWER_24:.*]] = mhlo.power %[[ADD_151]], %[[NEGATE_4]] : tensor<f64>
// CHECK:           %[[ADD_152:.*]] = mhlo.add %[[ADD_150]], %[[POWER_24]] : tensor<f64>
// CHECK:           %[[ADD_153:.*]] = mhlo.add %[[ADD_151]], %[[CONSTANT_136]] : tensor<f64>
// CHECK:           %[[POWER_25:.*]] = mhlo.power %[[ADD_153]], %[[NEGATE_4]] : tensor<f64>
// CHECK:           %[[ADD_154:.*]] = mhlo.add %[[ADD_152]], %[[POWER_25]] : tensor<f64>
// CHECK:           %[[ADD_155:.*]] = mhlo.add %[[ADD_153]], %[[CONSTANT_136]] : tensor<f64>
// CHECK:           %[[POWER_26:.*]] = mhlo.power %[[ADD_155]], %[[NEGATE_4]] : tensor<f64>
// CHECK:           %[[ADD_156:.*]] = mhlo.add %[[ADD_154]], %[[POWER_26]] : tensor<f64>
// CHECK:           %[[ADD_157:.*]] = mhlo.add %[[ADD_155]], %[[CONSTANT_136]] : tensor<f64>
// CHECK:           %[[POWER_27:.*]] = mhlo.power %[[ADD_157]], %[[NEGATE_4]] : tensor<f64>
// CHECK:           %[[ADD_158:.*]] = mhlo.add %[[ADD_156]], %[[POWER_27]] : tensor<f64>
// CHECK:           %[[ADD_159:.*]] = mhlo.add %[[ADD_157]], %[[CONSTANT_136]] : tensor<f64>
// CHECK:           %[[POWER_28:.*]] = mhlo.power %[[ADD_159]], %[[NEGATE_4]] : tensor<f64>
// CHECK:           %[[ADD_160:.*]] = mhlo.add %[[ADD_158]], %[[POWER_28]] : tensor<f64>
// CHECK:           %[[ADD_161:.*]] = mhlo.add %[[ADD_159]], %[[CONSTANT_136]] : tensor<f64>
// CHECK:           %[[POWER_29:.*]] = mhlo.power %[[ADD_161]], %[[NEGATE_4]] : tensor<f64>
// CHECK:           %[[ADD_162:.*]] = mhlo.add %[[ADD_160]], %[[POWER_29]] : tensor<f64>
// CHECK:           %[[ADD_163:.*]] = mhlo.add %[[ADD_161]], %[[CONSTANT_136]] : tensor<f64>
// CHECK:           %[[POWER_30:.*]] = mhlo.power %[[ADD_163]], %[[NEGATE_4]] : tensor<f64>
// CHECK:           %[[ADD_164:.*]] = mhlo.add %[[ADD_162]], %[[POWER_30]] : tensor<f64>
// CHECK:           %[[ADD_165:.*]] = mhlo.add %[[ADD_163]], %[[CONSTANT_136]] : tensor<f64>
// CHECK:           %[[POWER_31:.*]] = mhlo.power %[[ADD_165]], %[[NEGATE_4]] : tensor<f64>
// CHECK:           %[[ADD_166:.*]] = mhlo.add %[[ADD_164]], %[[POWER_31]] : tensor<f64>
// CHECK:           %[[ADD_167:.*]] = mhlo.add %[[ADD_165]], %[[CONSTANT_136]] : tensor<f64>
// CHECK:           %[[POWER_32:.*]] = mhlo.power %[[ADD_167]], %[[NEGATE_4]] : tensor<f64>
// CHECK:           %[[CONSTANT_137:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f64>
// CHECK:           %[[MULTIPLY_98:.*]] = mhlo.multiply %[[POWER_32]], %[[ADD_167]] : tensor<f64>
// CHECK:           %[[SUBTRACT_11:.*]] = mhlo.subtract %[[CONSTANT_134]], %[[CONSTANT_137]] : tensor<f64>
// CHECK:           %[[DIVIDE_17:.*]] = mhlo.divide %[[MULTIPLY_98]], %[[SUBTRACT_11]] : tensor<f64>
// CHECK:           %[[MULTIPLY_99:.*]] = mhlo.multiply %[[ADD_167]], %[[ADD_167]] : tensor<f64>
// CHECK:           %[[DIVIDE_18:.*]] = mhlo.divide %[[CONSTANT_136]], %[[MULTIPLY_99]] : tensor<f64>
// CHECK:           %[[CONSTANT_138:.*]] = mhlo.constant dense<2.200000e+01> : tensor<f64>
// CHECK:           %[[ADD_168:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_138]] : tensor<f64>
// CHECK:           %[[CONSTANT_139:.*]] = mhlo.constant dense<2.100000e+01> : tensor<f64>
// CHECK:           %[[ADD_169:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_139]] : tensor<f64>
// CHECK:           %[[MULTIPLY_100:.*]] = mhlo.multiply %[[ADD_168]], %[[ADD_169]] : tensor<f64>
// CHECK:           %[[CONSTANT_140:.*]] = mhlo.constant dense<-1.3954464685812522E-19> : tensor<f64>
// CHECK:           %[[ADD_170:.*]] = mhlo.add %[[CONSTANT_135]], %[[CONSTANT_140]] : tensor<f64>
// CHECK:           %[[MULTIPLY_101:.*]] = mhlo.multiply %[[DIVIDE_18]], %[[ADD_170]] : tensor<f64>
// CHECK:           %[[MULTIPLY_102:.*]] = mhlo.multiply %[[MULTIPLY_100]], %[[MULTIPLY_101]] : tensor<f64>
// CHECK:           %[[CONSTANT_141:.*]] = mhlo.constant dense<2.000000e+01> : tensor<f64>
// CHECK:           %[[ADD_171:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_141]] : tensor<f64>
// CHECK:           %[[CONSTANT_142:.*]] = mhlo.constant dense<1.900000e+01> : tensor<f64>
// CHECK:           %[[ADD_172:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_142]] : tensor<f64>
// CHECK:           %[[MULTIPLY_103:.*]] = mhlo.multiply %[[ADD_171]], %[[ADD_172]] : tensor<f64>
// CHECK:           %[[CONSTANT_143:.*]] = mhlo.constant dense<5.5090028283602295E-18> : tensor<f64>
// CHECK:           %[[ADD_173:.*]] = mhlo.add %[[MULTIPLY_102]], %[[CONSTANT_143]] : tensor<f64>
// CHECK:           %[[MULTIPLY_104:.*]] = mhlo.multiply %[[DIVIDE_18]], %[[ADD_173]] : tensor<f64>
// CHECK:           %[[MULTIPLY_105:.*]] = mhlo.multiply %[[MULTIPLY_103]], %[[MULTIPLY_104]] : tensor<f64>
// CHECK:           %[[CONSTANT_144:.*]] = mhlo.constant dense<1.800000e+01> : tensor<f64>
// CHECK:           %[[ADD_174:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_144]] : tensor<f64>
// CHECK:           %[[CONSTANT_145:.*]] = mhlo.constant dense<1.700000e+01> : tensor<f64>
// CHECK:           %[[ADD_175:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_145]] : tensor<f64>
// CHECK:           %[[MULTIPLY_106:.*]] = mhlo.multiply %[[ADD_174]], %[[ADD_175]] : tensor<f64>
// CHECK:           %[[CONSTANT_146:.*]] = mhlo.constant dense<-2.1748686985580617E-16> : tensor<f64>
// CHECK:           %[[ADD_176:.*]] = mhlo.add %[[MULTIPLY_105]], %[[CONSTANT_146]] : tensor<f64>
// CHECK:           %[[MULTIPLY_107:.*]] = mhlo.multiply %[[DIVIDE_18]], %[[ADD_176]] : tensor<f64>
// CHECK:           %[[MULTIPLY_108:.*]] = mhlo.multiply %[[MULTIPLY_106]], %[[MULTIPLY_107]] : tensor<f64>
// CHECK:           %[[CONSTANT_147:.*]] = mhlo.constant dense<1.600000e+01> : tensor<f64>
// CHECK:           %[[ADD_177:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_147]] : tensor<f64>
// CHECK:           %[[CONSTANT_148:.*]] = mhlo.constant dense<1.500000e+01> : tensor<f64>
// CHECK:           %[[ADD_178:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_148]] : tensor<f64>
// CHECK:           %[[MULTIPLY_109:.*]] = mhlo.multiply %[[ADD_177]], %[[ADD_178]] : tensor<f64>
// CHECK:           %[[CONSTANT_149:.*]] = mhlo.constant dense<8.5860620562778452E-15> : tensor<f64>
// CHECK:           %[[ADD_179:.*]] = mhlo.add %[[MULTIPLY_108]], %[[CONSTANT_149]] : tensor<f64>
// CHECK:           %[[MULTIPLY_110:.*]] = mhlo.multiply %[[DIVIDE_18]], %[[ADD_179]] : tensor<f64>
// CHECK:           %[[MULTIPLY_111:.*]] = mhlo.multiply %[[MULTIPLY_109]], %[[MULTIPLY_110]] : tensor<f64>
// CHECK:           %[[CONSTANT_150:.*]] = mhlo.constant dense<1.400000e+01> : tensor<f64>
// CHECK:           %[[ADD_180:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_150]] : tensor<f64>
// CHECK:           %[[CONSTANT_151:.*]] = mhlo.constant dense<1.300000e+01> : tensor<f64>
// CHECK:           %[[ADD_181:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_151]] : tensor<f64>
// CHECK:           %[[MULTIPLY_112:.*]] = mhlo.multiply %[[ADD_180]], %[[ADD_181]] : tensor<f64>
// CHECK:           %[[CONSTANT_152:.*]] = mhlo.constant dense<-3.3896802963225832E-13> : tensor<f64>
// CHECK:           %[[ADD_182:.*]] = mhlo.add %[[MULTIPLY_111]], %[[CONSTANT_152]] : tensor<f64>
// CHECK:           %[[MULTIPLY_113:.*]] = mhlo.multiply %[[DIVIDE_18]], %[[ADD_182]] : tensor<f64>
// CHECK:           %[[MULTIPLY_114:.*]] = mhlo.multiply %[[MULTIPLY_112]], %[[MULTIPLY_113]] : tensor<f64>
// CHECK:           %[[CONSTANT_153:.*]] = mhlo.constant dense<1.200000e+01> : tensor<f64>
// CHECK:           %[[ADD_183:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_153]] : tensor<f64>
// CHECK:           %[[CONSTANT_154:.*]] = mhlo.constant dense<1.100000e+01> : tensor<f64>
// CHECK:           %[[ADD_184:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_154]] : tensor<f64>
// CHECK:           %[[MULTIPLY_115:.*]] = mhlo.multiply %[[ADD_183]], %[[ADD_184]] : tensor<f64>
// CHECK:           %[[CONSTANT_155:.*]] = mhlo.constant dense<1.3382536530684679E-11> : tensor<f64>
// CHECK:           %[[ADD_185:.*]] = mhlo.add %[[MULTIPLY_114]], %[[CONSTANT_155]] : tensor<f64>
// CHECK:           %[[MULTIPLY_116:.*]] = mhlo.multiply %[[DIVIDE_18]], %[[ADD_185]] : tensor<f64>
// CHECK:           %[[MULTIPLY_117:.*]] = mhlo.multiply %[[MULTIPLY_115]], %[[MULTIPLY_116]] : tensor<f64>
// CHECK:           %[[CONSTANT_156:.*]] = mhlo.constant dense<1.000000e+01> : tensor<f64>
// CHECK:           %[[ADD_186:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_156]] : tensor<f64>
// CHECK:           %[[CONSTANT_157:.*]] = mhlo.constant dense<9.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_187:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_157]] : tensor<f64>
// CHECK:           %[[MULTIPLY_118:.*]] = mhlo.multiply %[[ADD_186]], %[[ADD_187]] : tensor<f64>
// CHECK:           %[[CONSTANT_158:.*]] = mhlo.constant dense<-5.2841901386874932E-10> : tensor<f64>
// CHECK:           %[[ADD_188:.*]] = mhlo.add %[[MULTIPLY_117]], %[[CONSTANT_158]] : tensor<f64>
// CHECK:           %[[MULTIPLY_119:.*]] = mhlo.multiply %[[DIVIDE_18]], %[[ADD_188]] : tensor<f64>
// CHECK:           %[[MULTIPLY_120:.*]] = mhlo.multiply %[[MULTIPLY_118]], %[[MULTIPLY_119]] : tensor<f64>
// CHECK:           %[[CONSTANT_159:.*]] = mhlo.constant dense<8.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_189:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_159]] : tensor<f64>
// CHECK:           %[[CONSTANT_160:.*]] = mhlo.constant dense<7.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_190:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_160]] : tensor<f64>
// CHECK:           %[[MULTIPLY_121:.*]] = mhlo.multiply %[[ADD_189]], %[[ADD_190]] : tensor<f64>
// CHECK:           %[[CONSTANT_161:.*]] = mhlo.constant dense<2.08767569878681E-8> : tensor<f64>
// CHECK:           %[[ADD_191:.*]] = mhlo.add %[[MULTIPLY_120]], %[[CONSTANT_161]] : tensor<f64>
// CHECK:           %[[MULTIPLY_122:.*]] = mhlo.multiply %[[DIVIDE_18]], %[[ADD_191]] : tensor<f64>
// CHECK:           %[[MULTIPLY_123:.*]] = mhlo.multiply %[[MULTIPLY_121]], %[[MULTIPLY_122]] : tensor<f64>
// CHECK:           %[[CONSTANT_162:.*]] = mhlo.constant dense<6.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_192:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_162]] : tensor<f64>
// CHECK:           %[[CONSTANT_163:.*]] = mhlo.constant dense<5.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_193:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_163]] : tensor<f64>
// CHECK:           %[[MULTIPLY_124:.*]] = mhlo.multiply %[[ADD_192]], %[[ADD_193]] : tensor<f64>
// CHECK:           %[[CONSTANT_164:.*]] = mhlo.constant dense<-8.2671957671957675E-7> : tensor<f64>
// CHECK:           %[[ADD_194:.*]] = mhlo.add %[[MULTIPLY_123]], %[[CONSTANT_164]] : tensor<f64>
// CHECK:           %[[MULTIPLY_125:.*]] = mhlo.multiply %[[DIVIDE_18]], %[[ADD_194]] : tensor<f64>
// CHECK:           %[[MULTIPLY_126:.*]] = mhlo.multiply %[[MULTIPLY_124]], %[[MULTIPLY_125]] : tensor<f64>
// CHECK:           %[[CONSTANT_165:.*]] = mhlo.constant dense<4.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_195:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_165]] : tensor<f64>
// CHECK:           %[[CONSTANT_166:.*]] = mhlo.constant dense<3.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_196:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_166]] : tensor<f64>
// CHECK:           %[[MULTIPLY_127:.*]] = mhlo.multiply %[[ADD_195]], %[[ADD_196]] : tensor<f64>
// CHECK:           %[[CONSTANT_167:.*]] = mhlo.constant dense<3.3068783068783071E-5> : tensor<f64>
// CHECK:           %[[ADD_197:.*]] = mhlo.add %[[MULTIPLY_126]], %[[CONSTANT_167]] : tensor<f64>
// CHECK:           %[[MULTIPLY_128:.*]] = mhlo.multiply %[[DIVIDE_18]], %[[ADD_197]] : tensor<f64>
// CHECK:           %[[MULTIPLY_129:.*]] = mhlo.multiply %[[MULTIPLY_127]], %[[MULTIPLY_128]] : tensor<f64>
// CHECK:           %[[CONSTANT_168:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_198:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_168]] : tensor<f64>
// CHECK:           %[[CONSTANT_169:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_199:.*]] = mhlo.add %[[CONSTANT_134]], %[[CONSTANT_169]] : tensor<f64>
// CHECK:           %[[MULTIPLY_130:.*]] = mhlo.multiply %[[ADD_198]], %[[ADD_199]] : tensor<f64>
// CHECK:           %[[CONSTANT_170:.*]] = mhlo.constant dense<-0.0013888888888888889> : tensor<f64>
// CHECK:           %[[ADD_200:.*]] = mhlo.add %[[MULTIPLY_129]], %[[CONSTANT_170]] : tensor<f64>
// CHECK:           %[[MULTIPLY_131:.*]] = mhlo.multiply %[[DIVIDE_18]], %[[ADD_200]] : tensor<f64>
// CHECK:           %[[MULTIPLY_132:.*]] = mhlo.multiply %[[MULTIPLY_130]], %[[MULTIPLY_131]] : tensor<f64>
// CHECK:           %[[CONSTANT_171:.*]] = mhlo.constant dense<5.000000e-01> : tensor<f64>
// CHECK:           %[[DIVIDE_19:.*]] = mhlo.divide %[[CONSTANT_134]], %[[ADD_167]] : tensor<f64>
// CHECK:           %[[CONSTANT_172:.*]] = mhlo.constant dense<0.083333333333333329> : tensor<f64>
// CHECK:           %[[ADD_201:.*]] = mhlo.add %[[CONSTANT_172]], %[[MULTIPLY_132]] : tensor<f64>
// CHECK:           %[[MULTIPLY_133:.*]] = mhlo.multiply %[[DIVIDE_19]], %[[ADD_201]] : tensor<f64>
// CHECK:           %[[ADD_202:.*]] = mhlo.add %[[CONSTANT_171]], %[[MULTIPLY_133]] : tensor<f64>
// CHECK:           %[[MULTIPLY_134:.*]] = mhlo.multiply %[[POWER_32]], %[[ADD_202]] : tensor<f64>
// CHECK:           %[[ADD_203:.*]] = mhlo.add %[[ADD_166]], %[[DIVIDE_17]] : tensor<f64>
// CHECK:           %[[ADD_204:.*]] = mhlo.add %[[ADD_203]], %[[MULTIPLY_134]] : tensor<f64>
// CHECK:           %[[ABS_7:.*]] = mhlo.abs %[[POWER_32]] : tensor<f64>
// CHECK:           %[[ABS_8:.*]] = mhlo.abs %[[ADD_166]] : tensor<f64>
// CHECK:           %[[CONSTANT_173:.*]] = mhlo.constant dense<4.940660e-324> : tensor<f64>
// CHECK:           %[[MULTIPLY_135:.*]] = mhlo.multiply %[[ABS_8]], %[[CONSTANT_173]] : tensor<f64>
// CHECK:           %[[COMPARE_20:.*]] = mhlo.compare LT, %[[ABS_7]], %[[MULTIPLY_135]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[SELECT_18:.*]] = mhlo.select %[[COMPARE_20]], %[[ADD_166]], %[[ADD_204]] : tensor<i1>, tensor<f64>
// CHECK:           %[[CONSTANT_174:.*]] = mhlo.constant dense<0x7FF8000000000000> : tensor<f64>
// CHECK:           %[[COMPARE_21:.*]] = mhlo.compare LT, %[[CONSTANT_134]], %[[CONSTANT_137]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[SELECT_19:.*]] = mhlo.select %[[COMPARE_21]], %[[CONSTANT_174]], %[[SELECT_18]] : tensor<i1>, tensor<f64>
// CHECK:           %[[COMPARE_22:.*]] = mhlo.compare LE, %[[SUBTRACT_10]], %[[CONSTANT_135]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[FLOOR_9:.*]] = mhlo.floor %[[CONSTANT_134]] : tensor<f64>
// CHECK:           %[[COMPARE_23:.*]] = mhlo.compare NE, %[[CONSTANT_134]], %[[FLOOR_9]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[AND_6:.*]] = mhlo.and %[[COMPARE_22]], %[[COMPARE_23]] : tensor<i1>
// CHECK:           %[[SELECT_20:.*]] = mhlo.select %[[AND_6]], %[[CONSTANT_174]], %[[SELECT_19]] : tensor<i1>, tensor<f64>
// CHECK:           %[[CONSTANT_175:.*]] = mhlo.constant dense<0x7FF0000000000000> : tensor<f64>
// CHECK:           %[[FLOOR_10:.*]] = mhlo.floor %[[SUBTRACT_10]] : tensor<f64>
// CHECK:           %[[COMPARE_24:.*]] = mhlo.compare EQ, %[[SUBTRACT_10]], %[[FLOOR_10]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[AND_7:.*]] = mhlo.and %[[COMPARE_22]], %[[COMPARE_24]] : tensor<i1>
// CHECK:           %[[CONSTANT_176:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f64>
// CHECK:           %[[FLOOR_11:.*]] = mhlo.floor %[[CONSTANT_134]] : tensor<f64>
// CHECK:           %[[COMPARE_25:.*]] = mhlo.compare EQ, %[[CONSTANT_134]], %[[FLOOR_11]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[REMAINDER_3:.*]] = mhlo.remainder %[[CONSTANT_134]], %[[CONSTANT_176]] : tensor<f64>
// CHECK:           %[[COMPARE_26:.*]] = mhlo.compare EQ, %[[REMAINDER_3]], %[[CONSTANT_135]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[AND_8:.*]] = mhlo.and %[[COMPARE_25]], %[[COMPARE_26]] : tensor<i1>
// CHECK:           %[[SELECT_21:.*]] = mhlo.select %[[AND_8]], %[[CONSTANT_175]], %[[CONSTANT_174]] : tensor<i1>, tensor<f64>
// CHECK:           %[[SELECT_22:.*]] = mhlo.select %[[AND_7]], %[[SELECT_21]], %[[SELECT_20]] : tensor<i1>, tensor<f64>
// CHECK:           %[[COMPARE_27:.*]] = mhlo.compare EQ, %[[CONSTANT_134]], %[[CONSTANT_136]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[SELECT_23:.*]] = mhlo.select %[[COMPARE_27]], %[[CONSTANT_175]], %[[SELECT_22]] : tensor<i1>, tensor<f64>
// CHECK:           %[[CONSTANT_177:.*]] = mhlo.constant dense<-2.000000e+00> : tensor<f64>
// CHECK:           %[[MULTIPLY_136:.*]] = mhlo.multiply %[[CONSTANT_177]], %[[SELECT_23]] : tensor<f64>
// CHECK:           %[[CONSTANT_178:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f64>
// CHECK:           %[[MULTIPLY_137:.*]] = mhlo.multiply %[[CONSTANT_178]], %[[MULTIPLY_136]] : tensor<f64>
// CHECK:           %[[ADD_205:.*]] = mhlo.add %[[MULTIPLY_97]], %[[MULTIPLY_137]] : tensor<f64>
// CHECK:           %[[CONSTANT_179:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f64>
// CHECK:           %[[COMPARE_28:.*]] = mhlo.compare EQ, %[[FLOOR_5]], %[[CONSTANT_179]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[SELECT_24:.*]] = mhlo.select %[[COMPARE_28]], %[[ADD_205]], %[[SELECT_17]] : tensor<i1>, tensor<f64>
// CHECK:           %[[CONSTANT_180:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f64>
// CHECK:           %[[MULTIPLY_138:.*]] = mhlo.multiply %[[CONSTANT_180]], %[[DIVIDE_13]] : tensor<f64>
// CHECK:           %[[CONSTANT_181:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_206:.*]] = mhlo.add %[[MULTIPLY_138]], %[[CONSTANT_181]] : tensor<f64>
// CHECK:           %[[MULTIPLY_139:.*]] = mhlo.multiply %[[ADD_206]], %[[DIVIDE_13]] : tensor<f64>
// CHECK:           %[[CONSTANT_182:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_207:.*]] = mhlo.add %[[MULTIPLY_139]], %[[CONSTANT_182]] : tensor<f64>
// CHECK:           %[[MULTIPLY_140:.*]] = mhlo.multiply %[[ADD_207]], %[[DIVIDE_13]] : tensor<f64>
// CHECK:           %[[CONSTANT_183:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_208:.*]] = mhlo.add %[[MULTIPLY_140]], %[[CONSTANT_183]] : tensor<f64>
// CHECK:           %[[CONSTANT_184:.*]] = mhlo.constant dense<9.869604401089358> : tensor<f64>
// CHECK:           %[[MULTIPLY_141:.*]] = mhlo.multiply %[[CONSTANT_184]], %[[ADD_208]] : tensor<f64>
// CHECK:           %[[SUBTRACT_12:.*]] = mhlo.subtract %[[CONSTANT_0]], %[[VAL_1]] : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_185:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_186:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_187:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f64>
// CHECK:           %[[NEGATE_5:.*]] = mhlo.negate %[[CONSTANT_185]] : tensor<f64>
// CHECK:           %[[POWER_33:.*]] = mhlo.power %[[SUBTRACT_12]], %[[NEGATE_5]] : tensor<f64>
// CHECK:           %[[ADD_209:.*]] = mhlo.add %[[SUBTRACT_12]], %[[CONSTANT_187]] : tensor<f64>
// CHECK:           %[[POWER_34:.*]] = mhlo.power %[[ADD_209]], %[[NEGATE_5]] : tensor<f64>
// CHECK:           %[[ADD_210:.*]] = mhlo.add %[[POWER_33]], %[[POWER_34]] : tensor<f64>
// CHECK:           %[[ADD_211:.*]] = mhlo.add %[[ADD_209]], %[[CONSTANT_187]] : tensor<f64>
// CHECK:           %[[POWER_35:.*]] = mhlo.power %[[ADD_211]], %[[NEGATE_5]] : tensor<f64>
// CHECK:           %[[ADD_212:.*]] = mhlo.add %[[ADD_210]], %[[POWER_35]] : tensor<f64>
// CHECK:           %[[ADD_213:.*]] = mhlo.add %[[ADD_211]], %[[CONSTANT_187]] : tensor<f64>
// CHECK:           %[[POWER_36:.*]] = mhlo.power %[[ADD_213]], %[[NEGATE_5]] : tensor<f64>
// CHECK:           %[[ADD_214:.*]] = mhlo.add %[[ADD_212]], %[[POWER_36]] : tensor<f64>
// CHECK:           %[[ADD_215:.*]] = mhlo.add %[[ADD_213]], %[[CONSTANT_187]] : tensor<f64>
// CHECK:           %[[POWER_37:.*]] = mhlo.power %[[ADD_215]], %[[NEGATE_5]] : tensor<f64>
// CHECK:           %[[ADD_216:.*]] = mhlo.add %[[ADD_214]], %[[POWER_37]] : tensor<f64>
// CHECK:           %[[ADD_217:.*]] = mhlo.add %[[ADD_215]], %[[CONSTANT_187]] : tensor<f64>
// CHECK:           %[[POWER_38:.*]] = mhlo.power %[[ADD_217]], %[[NEGATE_5]] : tensor<f64>
// CHECK:           %[[ADD_218:.*]] = mhlo.add %[[ADD_216]], %[[POWER_38]] : tensor<f64>
// CHECK:           %[[ADD_219:.*]] = mhlo.add %[[ADD_217]], %[[CONSTANT_187]] : tensor<f64>
// CHECK:           %[[POWER_39:.*]] = mhlo.power %[[ADD_219]], %[[NEGATE_5]] : tensor<f64>
// CHECK:           %[[ADD_220:.*]] = mhlo.add %[[ADD_218]], %[[POWER_39]] : tensor<f64>
// CHECK:           %[[ADD_221:.*]] = mhlo.add %[[ADD_219]], %[[CONSTANT_187]] : tensor<f64>
// CHECK:           %[[POWER_40:.*]] = mhlo.power %[[ADD_221]], %[[NEGATE_5]] : tensor<f64>
// CHECK:           %[[ADD_222:.*]] = mhlo.add %[[ADD_220]], %[[POWER_40]] : tensor<f64>
// CHECK:           %[[ADD_223:.*]] = mhlo.add %[[ADD_221]], %[[CONSTANT_187]] : tensor<f64>
// CHECK:           %[[POWER_41:.*]] = mhlo.power %[[ADD_223]], %[[NEGATE_5]] : tensor<f64>
// CHECK:           %[[ADD_224:.*]] = mhlo.add %[[ADD_222]], %[[POWER_41]] : tensor<f64>
// CHECK:           %[[ADD_225:.*]] = mhlo.add %[[ADD_223]], %[[CONSTANT_187]] : tensor<f64>
// CHECK:           %[[POWER_42:.*]] = mhlo.power %[[ADD_225]], %[[NEGATE_5]] : tensor<f64>
// CHECK:           %[[ADD_226:.*]] = mhlo.add %[[ADD_224]], %[[POWER_42]] : tensor<f64>
// CHECK:           %[[ADD_227:.*]] = mhlo.add %[[ADD_225]], %[[CONSTANT_187]] : tensor<f64>
// CHECK:           %[[POWER_43:.*]] = mhlo.power %[[ADD_227]], %[[NEGATE_5]] : tensor<f64>
// CHECK:           %[[CONSTANT_188:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f64>
// CHECK:           %[[MULTIPLY_142:.*]] = mhlo.multiply %[[POWER_43]], %[[ADD_227]] : tensor<f64>
// CHECK:           %[[SUBTRACT_13:.*]] = mhlo.subtract %[[CONSTANT_185]], %[[CONSTANT_188]] : tensor<f64>
// CHECK:           %[[DIVIDE_20:.*]] = mhlo.divide %[[MULTIPLY_142]], %[[SUBTRACT_13]] : tensor<f64>
// CHECK:           %[[MULTIPLY_143:.*]] = mhlo.multiply %[[ADD_227]], %[[ADD_227]] : tensor<f64>
// CHECK:           %[[DIVIDE_21:.*]] = mhlo.divide %[[CONSTANT_187]], %[[MULTIPLY_143]] : tensor<f64>
// CHECK:           %[[CONSTANT_189:.*]] = mhlo.constant dense<2.200000e+01> : tensor<f64>
// CHECK:           %[[ADD_228:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_189]] : tensor<f64>
// CHECK:           %[[CONSTANT_190:.*]] = mhlo.constant dense<2.100000e+01> : tensor<f64>
// CHECK:           %[[ADD_229:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_190]] : tensor<f64>
// CHECK:           %[[MULTIPLY_144:.*]] = mhlo.multiply %[[ADD_228]], %[[ADD_229]] : tensor<f64>
// CHECK:           %[[CONSTANT_191:.*]] = mhlo.constant dense<-1.3954464685812522E-19> : tensor<f64>
// CHECK:           %[[ADD_230:.*]] = mhlo.add %[[CONSTANT_186]], %[[CONSTANT_191]] : tensor<f64>
// CHECK:           %[[MULTIPLY_145:.*]] = mhlo.multiply %[[DIVIDE_21]], %[[ADD_230]] : tensor<f64>
// CHECK:           %[[MULTIPLY_146:.*]] = mhlo.multiply %[[MULTIPLY_144]], %[[MULTIPLY_145]] : tensor<f64>
// CHECK:           %[[CONSTANT_192:.*]] = mhlo.constant dense<2.000000e+01> : tensor<f64>
// CHECK:           %[[ADD_231:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_192]] : tensor<f64>
// CHECK:           %[[CONSTANT_193:.*]] = mhlo.constant dense<1.900000e+01> : tensor<f64>
// CHECK:           %[[ADD_232:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_193]] : tensor<f64>
// CHECK:           %[[MULTIPLY_147:.*]] = mhlo.multiply %[[ADD_231]], %[[ADD_232]] : tensor<f64>
// CHECK:           %[[CONSTANT_194:.*]] = mhlo.constant dense<5.5090028283602295E-18> : tensor<f64>
// CHECK:           %[[ADD_233:.*]] = mhlo.add %[[MULTIPLY_146]], %[[CONSTANT_194]] : tensor<f64>
// CHECK:           %[[MULTIPLY_148:.*]] = mhlo.multiply %[[DIVIDE_21]], %[[ADD_233]] : tensor<f64>
// CHECK:           %[[MULTIPLY_149:.*]] = mhlo.multiply %[[MULTIPLY_147]], %[[MULTIPLY_148]] : tensor<f64>
// CHECK:           %[[CONSTANT_195:.*]] = mhlo.constant dense<1.800000e+01> : tensor<f64>
// CHECK:           %[[ADD_234:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_195]] : tensor<f64>
// CHECK:           %[[CONSTANT_196:.*]] = mhlo.constant dense<1.700000e+01> : tensor<f64>
// CHECK:           %[[ADD_235:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_196]] : tensor<f64>
// CHECK:           %[[MULTIPLY_150:.*]] = mhlo.multiply %[[ADD_234]], %[[ADD_235]] : tensor<f64>
// CHECK:           %[[CONSTANT_197:.*]] = mhlo.constant dense<-2.1748686985580617E-16> : tensor<f64>
// CHECK:           %[[ADD_236:.*]] = mhlo.add %[[MULTIPLY_149]], %[[CONSTANT_197]] : tensor<f64>
// CHECK:           %[[MULTIPLY_151:.*]] = mhlo.multiply %[[DIVIDE_21]], %[[ADD_236]] : tensor<f64>
// CHECK:           %[[MULTIPLY_152:.*]] = mhlo.multiply %[[MULTIPLY_150]], %[[MULTIPLY_151]] : tensor<f64>
// CHECK:           %[[CONSTANT_198:.*]] = mhlo.constant dense<1.600000e+01> : tensor<f64>
// CHECK:           %[[ADD_237:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_198]] : tensor<f64>
// CHECK:           %[[CONSTANT_199:.*]] = mhlo.constant dense<1.500000e+01> : tensor<f64>
// CHECK:           %[[ADD_238:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_199]] : tensor<f64>
// CHECK:           %[[MULTIPLY_153:.*]] = mhlo.multiply %[[ADD_237]], %[[ADD_238]] : tensor<f64>
// CHECK:           %[[CONSTANT_200:.*]] = mhlo.constant dense<8.5860620562778452E-15> : tensor<f64>
// CHECK:           %[[ADD_239:.*]] = mhlo.add %[[MULTIPLY_152]], %[[CONSTANT_200]] : tensor<f64>
// CHECK:           %[[MULTIPLY_154:.*]] = mhlo.multiply %[[DIVIDE_21]], %[[ADD_239]] : tensor<f64>
// CHECK:           %[[MULTIPLY_155:.*]] = mhlo.multiply %[[MULTIPLY_153]], %[[MULTIPLY_154]] : tensor<f64>
// CHECK:           %[[CONSTANT_201:.*]] = mhlo.constant dense<1.400000e+01> : tensor<f64>
// CHECK:           %[[ADD_240:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_201]] : tensor<f64>
// CHECK:           %[[CONSTANT_202:.*]] = mhlo.constant dense<1.300000e+01> : tensor<f64>
// CHECK:           %[[ADD_241:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_202]] : tensor<f64>
// CHECK:           %[[MULTIPLY_156:.*]] = mhlo.multiply %[[ADD_240]], %[[ADD_241]] : tensor<f64>
// CHECK:           %[[CONSTANT_203:.*]] = mhlo.constant dense<-3.3896802963225832E-13> : tensor<f64>
// CHECK:           %[[ADD_242:.*]] = mhlo.add %[[MULTIPLY_155]], %[[CONSTANT_203]] : tensor<f64>
// CHECK:           %[[MULTIPLY_157:.*]] = mhlo.multiply %[[DIVIDE_21]], %[[ADD_242]] : tensor<f64>
// CHECK:           %[[MULTIPLY_158:.*]] = mhlo.multiply %[[MULTIPLY_156]], %[[MULTIPLY_157]] : tensor<f64>
// CHECK:           %[[CONSTANT_204:.*]] = mhlo.constant dense<1.200000e+01> : tensor<f64>
// CHECK:           %[[ADD_243:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_204]] : tensor<f64>
// CHECK:           %[[CONSTANT_205:.*]] = mhlo.constant dense<1.100000e+01> : tensor<f64>
// CHECK:           %[[ADD_244:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_205]] : tensor<f64>
// CHECK:           %[[MULTIPLY_159:.*]] = mhlo.multiply %[[ADD_243]], %[[ADD_244]] : tensor<f64>
// CHECK:           %[[CONSTANT_206:.*]] = mhlo.constant dense<1.3382536530684679E-11> : tensor<f64>
// CHECK:           %[[ADD_245:.*]] = mhlo.add %[[MULTIPLY_158]], %[[CONSTANT_206]] : tensor<f64>
// CHECK:           %[[MULTIPLY_160:.*]] = mhlo.multiply %[[DIVIDE_21]], %[[ADD_245]] : tensor<f64>
// CHECK:           %[[MULTIPLY_161:.*]] = mhlo.multiply %[[MULTIPLY_159]], %[[MULTIPLY_160]] : tensor<f64>
// CHECK:           %[[CONSTANT_207:.*]] = mhlo.constant dense<1.000000e+01> : tensor<f64>
// CHECK:           %[[ADD_246:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_207]] : tensor<f64>
// CHECK:           %[[CONSTANT_208:.*]] = mhlo.constant dense<9.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_247:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_208]] : tensor<f64>
// CHECK:           %[[MULTIPLY_162:.*]] = mhlo.multiply %[[ADD_246]], %[[ADD_247]] : tensor<f64>
// CHECK:           %[[CONSTANT_209:.*]] = mhlo.constant dense<-5.2841901386874932E-10> : tensor<f64>
// CHECK:           %[[ADD_248:.*]] = mhlo.add %[[MULTIPLY_161]], %[[CONSTANT_209]] : tensor<f64>
// CHECK:           %[[MULTIPLY_163:.*]] = mhlo.multiply %[[DIVIDE_21]], %[[ADD_248]] : tensor<f64>
// CHECK:           %[[MULTIPLY_164:.*]] = mhlo.multiply %[[MULTIPLY_162]], %[[MULTIPLY_163]] : tensor<f64>
// CHECK:           %[[CONSTANT_210:.*]] = mhlo.constant dense<8.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_249:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_210]] : tensor<f64>
// CHECK:           %[[CONSTANT_211:.*]] = mhlo.constant dense<7.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_250:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_211]] : tensor<f64>
// CHECK:           %[[MULTIPLY_165:.*]] = mhlo.multiply %[[ADD_249]], %[[ADD_250]] : tensor<f64>
// CHECK:           %[[CONSTANT_212:.*]] = mhlo.constant dense<2.08767569878681E-8> : tensor<f64>
// CHECK:           %[[ADD_251:.*]] = mhlo.add %[[MULTIPLY_164]], %[[CONSTANT_212]] : tensor<f64>
// CHECK:           %[[MULTIPLY_166:.*]] = mhlo.multiply %[[DIVIDE_21]], %[[ADD_251]] : tensor<f64>
// CHECK:           %[[MULTIPLY_167:.*]] = mhlo.multiply %[[MULTIPLY_165]], %[[MULTIPLY_166]] : tensor<f64>
// CHECK:           %[[CONSTANT_213:.*]] = mhlo.constant dense<6.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_252:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_213]] : tensor<f64>
// CHECK:           %[[CONSTANT_214:.*]] = mhlo.constant dense<5.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_253:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_214]] : tensor<f64>
// CHECK:           %[[MULTIPLY_168:.*]] = mhlo.multiply %[[ADD_252]], %[[ADD_253]] : tensor<f64>
// CHECK:           %[[CONSTANT_215:.*]] = mhlo.constant dense<-8.2671957671957675E-7> : tensor<f64>
// CHECK:           %[[ADD_254:.*]] = mhlo.add %[[MULTIPLY_167]], %[[CONSTANT_215]] : tensor<f64>
// CHECK:           %[[MULTIPLY_169:.*]] = mhlo.multiply %[[DIVIDE_21]], %[[ADD_254]] : tensor<f64>
// CHECK:           %[[MULTIPLY_170:.*]] = mhlo.multiply %[[MULTIPLY_168]], %[[MULTIPLY_169]] : tensor<f64>
// CHECK:           %[[CONSTANT_216:.*]] = mhlo.constant dense<4.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_255:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_216]] : tensor<f64>
// CHECK:           %[[CONSTANT_217:.*]] = mhlo.constant dense<3.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_256:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_217]] : tensor<f64>
// CHECK:           %[[MULTIPLY_171:.*]] = mhlo.multiply %[[ADD_255]], %[[ADD_256]] : tensor<f64>
// CHECK:           %[[CONSTANT_218:.*]] = mhlo.constant dense<3.3068783068783071E-5> : tensor<f64>
// CHECK:           %[[ADD_257:.*]] = mhlo.add %[[MULTIPLY_170]], %[[CONSTANT_218]] : tensor<f64>
// CHECK:           %[[MULTIPLY_172:.*]] = mhlo.multiply %[[DIVIDE_21]], %[[ADD_257]] : tensor<f64>
// CHECK:           %[[MULTIPLY_173:.*]] = mhlo.multiply %[[MULTIPLY_171]], %[[MULTIPLY_172]] : tensor<f64>
// CHECK:           %[[CONSTANT_219:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_258:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_219]] : tensor<f64>
// CHECK:           %[[CONSTANT_220:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_259:.*]] = mhlo.add %[[CONSTANT_185]], %[[CONSTANT_220]] : tensor<f64>
// CHECK:           %[[MULTIPLY_174:.*]] = mhlo.multiply %[[ADD_258]], %[[ADD_259]] : tensor<f64>
// CHECK:           %[[CONSTANT_221:.*]] = mhlo.constant dense<-0.0013888888888888889> : tensor<f64>
// CHECK:           %[[ADD_260:.*]] = mhlo.add %[[MULTIPLY_173]], %[[CONSTANT_221]] : tensor<f64>
// CHECK:           %[[MULTIPLY_175:.*]] = mhlo.multiply %[[DIVIDE_21]], %[[ADD_260]] : tensor<f64>
// CHECK:           %[[MULTIPLY_176:.*]] = mhlo.multiply %[[MULTIPLY_174]], %[[MULTIPLY_175]] : tensor<f64>
// CHECK:           %[[CONSTANT_222:.*]] = mhlo.constant dense<5.000000e-01> : tensor<f64>
// CHECK:           %[[DIVIDE_22:.*]] = mhlo.divide %[[CONSTANT_185]], %[[ADD_227]] : tensor<f64>
// CHECK:           %[[CONSTANT_223:.*]] = mhlo.constant dense<0.083333333333333329> : tensor<f64>
// CHECK:           %[[ADD_261:.*]] = mhlo.add %[[CONSTANT_223]], %[[MULTIPLY_176]] : tensor<f64>
// CHECK:           %[[MULTIPLY_177:.*]] = mhlo.multiply %[[DIVIDE_22]], %[[ADD_261]] : tensor<f64>
// CHECK:           %[[ADD_262:.*]] = mhlo.add %[[CONSTANT_222]], %[[MULTIPLY_177]] : tensor<f64>
// CHECK:           %[[MULTIPLY_178:.*]] = mhlo.multiply %[[POWER_43]], %[[ADD_262]] : tensor<f64>
// CHECK:           %[[ADD_263:.*]] = mhlo.add %[[ADD_226]], %[[DIVIDE_20]] : tensor<f64>
// CHECK:           %[[ADD_264:.*]] = mhlo.add %[[ADD_263]], %[[MULTIPLY_178]] : tensor<f64>
// CHECK:           %[[ABS_9:.*]] = mhlo.abs %[[POWER_43]] : tensor<f64>
// CHECK:           %[[ABS_10:.*]] = mhlo.abs %[[ADD_226]] : tensor<f64>
// CHECK:           %[[CONSTANT_224:.*]] = mhlo.constant dense<4.940660e-324> : tensor<f64>
// CHECK:           %[[MULTIPLY_179:.*]] = mhlo.multiply %[[ABS_10]], %[[CONSTANT_224]] : tensor<f64>
// CHECK:           %[[COMPARE_29:.*]] = mhlo.compare LT, %[[ABS_9]], %[[MULTIPLY_179]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[SELECT_25:.*]] = mhlo.select %[[COMPARE_29]], %[[ADD_226]], %[[ADD_264]] : tensor<i1>, tensor<f64>
// CHECK:           %[[CONSTANT_225:.*]] = mhlo.constant dense<0x7FF8000000000000> : tensor<f64>
// CHECK:           %[[COMPARE_30:.*]] = mhlo.compare LT, %[[CONSTANT_185]], %[[CONSTANT_188]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[SELECT_26:.*]] = mhlo.select %[[COMPARE_30]], %[[CONSTANT_225]], %[[SELECT_25]] : tensor<i1>, tensor<f64>
// CHECK:           %[[COMPARE_31:.*]] = mhlo.compare LE, %[[SUBTRACT_12]], %[[CONSTANT_186]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[FLOOR_12:.*]] = mhlo.floor %[[CONSTANT_185]] : tensor<f64>
// CHECK:           %[[COMPARE_32:.*]] = mhlo.compare NE, %[[CONSTANT_185]], %[[FLOOR_12]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[AND_9:.*]] = mhlo.and %[[COMPARE_31]], %[[COMPARE_32]] : tensor<i1>
// CHECK:           %[[SELECT_27:.*]] = mhlo.select %[[AND_9]], %[[CONSTANT_225]], %[[SELECT_26]] : tensor<i1>, tensor<f64>
// CHECK:           %[[CONSTANT_226:.*]] = mhlo.constant dense<0x7FF0000000000000> : tensor<f64>
// CHECK:           %[[FLOOR_13:.*]] = mhlo.floor %[[SUBTRACT_12]] : tensor<f64>
// CHECK:           %[[COMPARE_33:.*]] = mhlo.compare EQ, %[[SUBTRACT_12]], %[[FLOOR_13]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[AND_10:.*]] = mhlo.and %[[COMPARE_31]], %[[COMPARE_33]] : tensor<i1>
// CHECK:           %[[CONSTANT_227:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f64>
// CHECK:           %[[FLOOR_14:.*]] = mhlo.floor %[[CONSTANT_185]] : tensor<f64>
// CHECK:           %[[COMPARE_34:.*]] = mhlo.compare EQ, %[[CONSTANT_185]], %[[FLOOR_14]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[REMAINDER_4:.*]] = mhlo.remainder %[[CONSTANT_185]], %[[CONSTANT_227]] : tensor<f64>
// CHECK:           %[[COMPARE_35:.*]] = mhlo.compare EQ, %[[REMAINDER_4]], %[[CONSTANT_186]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[AND_11:.*]] = mhlo.and %[[COMPARE_34]], %[[COMPARE_35]] : tensor<i1>
// CHECK:           %[[SELECT_28:.*]] = mhlo.select %[[AND_11]], %[[CONSTANT_226]], %[[CONSTANT_225]] : tensor<i1>, tensor<f64>
// CHECK:           %[[SELECT_29:.*]] = mhlo.select %[[AND_10]], %[[SELECT_28]], %[[SELECT_27]] : tensor<i1>, tensor<f64>
// CHECK:           %[[COMPARE_36:.*]] = mhlo.compare EQ, %[[CONSTANT_185]], %[[CONSTANT_187]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[SELECT_30:.*]] = mhlo.select %[[COMPARE_36]], %[[CONSTANT_226]], %[[SELECT_29]] : tensor<i1>, tensor<f64>
// CHECK:           %[[CONSTANT_228:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f64>
// CHECK:           %[[MULTIPLY_180:.*]] = mhlo.multiply %[[CONSTANT_228]], %[[SELECT_30]] : tensor<f64>
// CHECK:           %[[CONSTANT_229:.*]] = mhlo.constant dense<-1.000000e+00> : tensor<f64>
// CHECK:           %[[MULTIPLY_181:.*]] = mhlo.multiply %[[CONSTANT_229]], %[[MULTIPLY_180]] : tensor<f64>
// CHECK:           %[[ADD_265:.*]] = mhlo.add %[[MULTIPLY_141]], %[[MULTIPLY_181]] : tensor<f64>
// CHECK:           %[[CONSTANT_230:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f64>
// CHECK:           %[[COMPARE_37:.*]] = mhlo.compare EQ, %[[FLOOR_5]], %[[CONSTANT_230]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[SELECT_31:.*]] = mhlo.select %[[COMPARE_37]], %[[ADD_265]], %[[SELECT_24]] : tensor<i1>, tensor<f64>
// CHECK:           %[[CONSTANT_231:.*]] = mhlo.constant dense<5.000000e-01> : tensor<f64>
// CHECK:           %[[COMPARE_38:.*]] = mhlo.compare LT, %[[VAL_1]], %[[CONSTANT_231]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[SELECT_32:.*]] = mhlo.select %[[COMPARE_38]], %[[SELECT_31]], %[[MULTIPLY_42]] : tensor<i1>, tensor<f64>
// CHECK:           %[[CONSTANT_232:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f64>
// CHECK:           %[[COMPARE_39:.*]] = mhlo.compare EQ, %[[VAL_0]], %[[CONSTANT_232]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[CONSTANT_233:.*]] = mhlo.constant dense<5.000000e-01> : tensor<f64>
// CHECK:           %[[COMPARE_40:.*]] = mhlo.compare LT, %[[VAL_1]], %[[CONSTANT_233]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[NEGATE_6:.*]] = mhlo.negate %[[VAL_1]] : tensor<f64>
// CHECK:           %[[CONSTANT_234:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f64>
// CHECK:           %[[SUBTRACT_14:.*]] = mhlo.subtract %[[VAL_1]], %[[CONSTANT_234]] : tensor<f64>
// CHECK:           %[[SELECT_33:.*]] = mhlo.select %[[COMPARE_40]], %[[NEGATE_6]], %[[SUBTRACT_14]] : tensor<i1>, tensor<f64>
// CHECK-DAG:       %[[CONSTANT_235:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_236:.*]] = mhlo.constant dense<0.99999999999980993> : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_237:.*]] = mhlo.constant dense<676.5203681218851> : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_238:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_266:.*]] = mhlo.add %[[SELECT_33]], %[[CONSTANT_238]] : tensor<f64>
// CHECK:           %[[MULTIPLY_182:.*]] = mhlo.multiply %[[ADD_266]], %[[ADD_266]] : tensor<f64>
// CHECK:           %[[DIVIDE_23:.*]] = mhlo.divide %[[CONSTANT_237]], %[[MULTIPLY_182]] : tensor<f64>
// CHECK:           %[[SUBTRACT_15:.*]] = mhlo.subtract %[[CONSTANT_235]], %[[DIVIDE_23]] : tensor<f64>
// CHECK:           %[[DIVIDE_24:.*]] = mhlo.divide %[[CONSTANT_237]], %[[ADD_266]] : tensor<f64>
// CHECK:           %[[ADD_267:.*]] = mhlo.add %[[CONSTANT_236]], %[[DIVIDE_24]] : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_239:.*]] = mhlo.constant dense<-1259.1392167224028> : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_240:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_268:.*]] = mhlo.add %[[SELECT_33]], %[[CONSTANT_240]] : tensor<f64>
// CHECK:           %[[MULTIPLY_183:.*]] = mhlo.multiply %[[ADD_268]], %[[ADD_268]] : tensor<f64>
// CHECK:           %[[DIVIDE_25:.*]] = mhlo.divide %[[CONSTANT_239]], %[[MULTIPLY_183]] : tensor<f64>
// CHECK:           %[[SUBTRACT_16:.*]] = mhlo.subtract %[[SUBTRACT_15]], %[[DIVIDE_25]] : tensor<f64>
// CHECK:           %[[DIVIDE_26:.*]] = mhlo.divide %[[CONSTANT_239]], %[[ADD_268]] : tensor<f64>
// CHECK:           %[[ADD_269:.*]] = mhlo.add %[[ADD_267]], %[[DIVIDE_26]] : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_241:.*]] = mhlo.constant dense<771.32342877765313> : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_242:.*]] = mhlo.constant dense<3.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_270:.*]] = mhlo.add %[[SELECT_33]], %[[CONSTANT_242]] : tensor<f64>
// CHECK:           %[[MULTIPLY_184:.*]] = mhlo.multiply %[[ADD_270]], %[[ADD_270]] : tensor<f64>
// CHECK:           %[[DIVIDE_27:.*]] = mhlo.divide %[[CONSTANT_241]], %[[MULTIPLY_184]] : tensor<f64>
// CHECK:           %[[SUBTRACT_17:.*]] = mhlo.subtract %[[SUBTRACT_16]], %[[DIVIDE_27]] : tensor<f64>
// CHECK:           %[[DIVIDE_28:.*]] = mhlo.divide %[[CONSTANT_241]], %[[ADD_270]] : tensor<f64>
// CHECK:           %[[ADD_271:.*]] = mhlo.add %[[ADD_269]], %[[DIVIDE_28]] : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_243:.*]] = mhlo.constant dense<-176.61502916214059> : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_244:.*]] = mhlo.constant dense<4.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_272:.*]] = mhlo.add %[[SELECT_33]], %[[CONSTANT_244]] : tensor<f64>
// CHECK:           %[[MULTIPLY_185:.*]] = mhlo.multiply %[[ADD_272]], %[[ADD_272]] : tensor<f64>
// CHECK:           %[[DIVIDE_29:.*]] = mhlo.divide %[[CONSTANT_243]], %[[MULTIPLY_185]] : tensor<f64>
// CHECK:           %[[SUBTRACT_18:.*]] = mhlo.subtract %[[SUBTRACT_17]], %[[DIVIDE_29]] : tensor<f64>
// CHECK:           %[[DIVIDE_30:.*]] = mhlo.divide %[[CONSTANT_243]], %[[ADD_272]] : tensor<f64>
// CHECK:           %[[ADD_273:.*]] = mhlo.add %[[ADD_271]], %[[DIVIDE_30]] : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_245:.*]] = mhlo.constant dense<12.507343278686905> : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_246:.*]] = mhlo.constant dense<5.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_274:.*]] = mhlo.add %[[SELECT_33]], %[[CONSTANT_246]] : tensor<f64>
// CHECK:           %[[MULTIPLY_186:.*]] = mhlo.multiply %[[ADD_274]], %[[ADD_274]] : tensor<f64>
// CHECK:           %[[DIVIDE_31:.*]] = mhlo.divide %[[CONSTANT_245]], %[[MULTIPLY_186]] : tensor<f64>
// CHECK:           %[[SUBTRACT_19:.*]] = mhlo.subtract %[[SUBTRACT_18]], %[[DIVIDE_31]] : tensor<f64>
// CHECK:           %[[DIVIDE_32:.*]] = mhlo.divide %[[CONSTANT_245]], %[[ADD_274]] : tensor<f64>
// CHECK:           %[[ADD_275:.*]] = mhlo.add %[[ADD_273]], %[[DIVIDE_32]] : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_247:.*]] = mhlo.constant dense<-0.13857109526572012> : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_248:.*]] = mhlo.constant dense<6.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_276:.*]] = mhlo.add %[[SELECT_33]], %[[CONSTANT_248]] : tensor<f64>
// CHECK:           %[[MULTIPLY_187:.*]] = mhlo.multiply %[[ADD_276]], %[[ADD_276]] : tensor<f64>
// CHECK:           %[[DIVIDE_33:.*]] = mhlo.divide %[[CONSTANT_247]], %[[MULTIPLY_187]] : tensor<f64>
// CHECK:           %[[SUBTRACT_20:.*]] = mhlo.subtract %[[SUBTRACT_19]], %[[DIVIDE_33]] : tensor<f64>
// CHECK:           %[[DIVIDE_34:.*]] = mhlo.divide %[[CONSTANT_247]], %[[ADD_276]] : tensor<f64>
// CHECK:           %[[ADD_277:.*]] = mhlo.add %[[ADD_275]], %[[DIVIDE_34]] : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_249:.*]] = mhlo.constant dense<9.9843695780195716E-6> : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_250:.*]] = mhlo.constant dense<7.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_278:.*]] = mhlo.add %[[SELECT_33]], %[[CONSTANT_250]] : tensor<f64>
// CHECK:           %[[MULTIPLY_188:.*]] = mhlo.multiply %[[ADD_278]], %[[ADD_278]] : tensor<f64>
// CHECK:           %[[DIVIDE_35:.*]] = mhlo.divide %[[CONSTANT_249]], %[[MULTIPLY_188]] : tensor<f64>
// CHECK:           %[[SUBTRACT_21:.*]] = mhlo.subtract %[[SUBTRACT_20]], %[[DIVIDE_35]] : tensor<f64>
// CHECK:           %[[DIVIDE_36:.*]] = mhlo.divide %[[CONSTANT_249]], %[[ADD_278]] : tensor<f64>
// CHECK:           %[[ADD_279:.*]] = mhlo.add %[[ADD_277]], %[[DIVIDE_36]] : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_251:.*]] = mhlo.constant dense<1.5056327351493116E-7> : tensor<f64>
// CHECK-DAG:       %[[CONSTANT_252:.*]] = mhlo.constant dense<8.000000e+00> : tensor<f64>
// CHECK:           %[[ADD_280:.*]] = mhlo.add %[[SELECT_33]], %[[CONSTANT_252]] : tensor<f64>
// CHECK:           %[[MULTIPLY_189:.*]] = mhlo.multiply %[[ADD_280]], %[[ADD_280]] : tensor<f64>
// CHECK:           %[[DIVIDE_37:.*]] = mhlo.divide %[[CONSTANT_251]], %[[MULTIPLY_189]] : tensor<f64>
// CHECK:           %[[SUBTRACT_22:.*]] = mhlo.subtract %[[SUBTRACT_21]], %[[DIVIDE_37]] : tensor<f64>
// CHECK:           %[[DIVIDE_38:.*]] = mhlo.divide %[[CONSTANT_251]], %[[ADD_280]] : tensor<f64>
// CHECK:           %[[ADD_281:.*]] = mhlo.add %[[ADD_279]], %[[DIVIDE_38]] : tensor<f64>
// CHECK:           %[[CONSTANT_253:.*]] = mhlo.constant dense<7.500000e+00> : tensor<f64>
// CHECK:           %[[ADD_282:.*]] = mhlo.add %[[CONSTANT_253]], %[[SELECT_33]] : tensor<f64>
// CHECK:           %[[CONSTANT_254:.*]] = mhlo.constant dense<2.0149030205422647> : tensor<f64>
// CHECK:           %[[DIVIDE_39:.*]] = mhlo.divide %[[SELECT_33]], %[[CONSTANT_253]] : tensor<f64>
// CHECK:           %[[LOG_PLUS_ONE_1:.*]] = mhlo.log_plus_one %[[DIVIDE_39]] : tensor<f64>
// CHECK:           %[[ADD_283:.*]] = mhlo.add %[[CONSTANT_254]], %[[LOG_PLUS_ONE_1]] : tensor<f64>
// CHECK:           %[[DIVIDE_40:.*]] = mhlo.divide %[[SUBTRACT_22]], %[[ADD_281]] : tensor<f64>
// CHECK:           %[[CONSTANT_255:.*]] = mhlo.constant dense<7.000000e+00> : tensor<f64>
// CHECK:           %[[DIVIDE_41:.*]] = mhlo.divide %[[CONSTANT_255]], %[[ADD_282]] : tensor<f64>
// CHECK:           %[[ADD_284:.*]] = mhlo.add %[[ADD_283]], %[[DIVIDE_40]] : tensor<f64>
// CHECK:           %[[SUBTRACT_23:.*]] = mhlo.subtract %[[ADD_284]], %[[DIVIDE_41]] : tensor<f64>
// CHECK:           %[[CONSTANT_256:.*]] = mhlo.constant dense<5.000000e-01> : tensor<f64>
// CHECK:           %[[ADD_285:.*]] = mhlo.add %[[VAL_1]], %[[CONSTANT_256]] : tensor<f64>
// CHECK:           %[[FLOOR_15:.*]] = mhlo.floor %[[ADD_285]] : tensor<f64>
// CHECK:           %[[ABS_11:.*]] = mhlo.abs %[[FLOOR_15]] : tensor<f64>
// CHECK:           %[[ADD_286:.*]] = mhlo.add %[[VAL_1]], %[[ABS_11]] : tensor<f64>
// CHECK:           %[[CONSTANT_257:.*]] = mhlo.constant dense<3.1415926535897931> : tensor<f64>
// CHECK:           %[[MULTIPLY_190:.*]] = mhlo.multiply %[[CONSTANT_257]], %[[ADD_286]] : tensor<f64>
// CHECK:           %[[COSINE_1:.*]] = mhlo.cosine %[[MULTIPLY_190]] : tensor<f64>
// CHECK:           %[[SINE_2:.*]] = mhlo.sine %[[MULTIPLY_190]] : tensor<f64>
// CHECK:           %[[MULTIPLY_191:.*]] = mhlo.multiply %[[CONSTANT_257]], %[[COSINE_1]] : tensor<f64>
// CHECK:           %[[DIVIDE_42:.*]] = mhlo.divide %[[MULTIPLY_191]], %[[SINE_2]] : tensor<f64>
// CHECK:           %[[SUBTRACT_24:.*]] = mhlo.subtract %[[SUBTRACT_23]], %[[DIVIDE_42]] : tensor<f64>
// CHECK:           %[[SELECT_34:.*]] = mhlo.select %[[COMPARE_40]], %[[SUBTRACT_24]], %[[SUBTRACT_23]] : tensor<i1>, tensor<f64>
// CHECK:           %[[COMPARE_41:.*]] = mhlo.compare LE, %[[VAL_1]], %[[CONSTANT_235]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[FLOOR_16:.*]] = mhlo.floor %[[VAL_1]] : tensor<f64>
// CHECK:           %[[COMPARE_42:.*]] = mhlo.compare EQ, %[[VAL_1]], %[[FLOOR_16]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[AND_12:.*]] = mhlo.and %[[COMPARE_41]], %[[COMPARE_42]] : tensor<i1>
// CHECK:           %[[CONSTANT_258:.*]] = mhlo.constant dense<0x7FF8000000000000> : tensor<f64>
// CHECK:           %[[SELECT_35:.*]] = mhlo.select %[[AND_12]], %[[CONSTANT_258]], %[[SELECT_34]] : tensor<i1>, tensor<f64>
// CHECK:           %[[SELECT_36:.*]] = mhlo.select %[[COMPARE_39]], %[[SELECT_35]], %[[SELECT_32]] : tensor<i1>, tensor<f64>
// CHECK:           %[[FLOOR_17:.*]] = mhlo.floor %[[VAL_0]] : tensor<f64>
// CHECK:           %[[COMPARE_43:.*]] = mhlo.compare NE, %[[VAL_0]], %[[FLOOR_17]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[COMPARE_44:.*]] = mhlo.compare LT, %[[VAL_0]], %[[CONSTANT_232]] : (tensor<f64>, tensor<f64>) -> tensor<i1>
// CHECK:           %[[OR_0:.*]] = mhlo.or %[[COMPARE_43]], %[[COMPARE_44]] : tensor<i1>
// CHECK:           %[[CONSTANT_259:.*]] = mhlo.constant dense<0x7FF8000000000000> : tensor<f64>
// CHECK:           %[[SELECT_37:.*]] = mhlo.select %[[OR_0]], %[[CONSTANT_259]], %[[SELECT_36]] : tensor<i1>, tensor<f64>
// CHECK:           return %[[SELECT_37]] : tensor<f64>
// CHECK:         }
...
// CHECK:         func.func @polygamma_f16(%[[VAL_0:.*]]: tensor<f16>, %[[VAL_1:.*]]: tensor<f16>) -> tensor<f16> {
// CHECK:           %[[CONVERT_0:.*]] = mhlo.convert %[[VAL_0]] : (tensor<f16>) -> tensor<f32>
// CHECK:           %[[CONVERT_1:.*]] = mhlo.convert %[[VAL_1]] : (tensor<f16>) -> tensor<f32>
// CHECK-DAG:       %[[CONSTANT_0:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_1:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f32>
// CHECK:           %[[REMAINDER_0:.*]] = mhlo.remainder %[[CONVERT_0]], %[[CONSTANT_1]] : tensor<f32>
// CHECK:           %[[MULTIPLY_0:.*]] = mhlo.multiply %[[CONSTANT_1]], %[[REMAINDER_0]] : tensor<f32>
// CHECK:           %[[SUBTRACT_0:.*]] = mhlo.subtract %[[MULTIPLY_0]], %[[CONSTANT_0]] : tensor<f32>
// CHECK:           %[[ADD_0:.*]] = mhlo.add %[[CONVERT_0]], %[[CONSTANT_0]] : tensor<f32>
// CHECK:           %[[CONSTANT_2:.*]] = mhlo.constant dense<5.000000e-01> : tensor<f32>
// CHECK:           %[[COMPARE_0:.*]] = mhlo.compare LT, %[[ADD_0]], %[[CONSTANT_2]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[NEGATE_0:.*]] = mhlo.negate %[[ADD_0]] : tensor<f32>
// CHECK:           %[[CONSTANT_3:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
...
// CHECK-DAG:       %[[CONSTANT_29:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK:           %[[NEGATE_2:.*]] = mhlo.negate %[[ADD_0]] : tensor<f32>
// CHECK:           %[[POWER_0:.*]] = mhlo.power %[[CONVERT_1]], %[[NEGATE_2]] : tensor<f32>
// CHECK:           %[[ADD_22:.*]] = mhlo.add %[[CONVERT_1]], %[[CONSTANT_29]] : tensor<f32>
// CHECK:           %[[POWER_1:.*]] = mhlo.power %[[ADD_22]], %[[NEGATE_2]] : tensor<f32>
// CHECK:           %[[ADD_23:.*]] = mhlo.add %[[POWER_0]], %[[POWER_1]] : tensor<f32>
// CHECK:           %[[ADD_24:.*]] = mhlo.add %[[ADD_22]], %[[CONSTANT_29]] : tensor<f32>
// CHECK:           %[[POWER_2:.*]] = mhlo.power %[[ADD_24]], %[[NEGATE_2]] : tensor<f32>
...
// CHECK:           %[[COMPARE_4:.*]] = mhlo.compare LT, %[[ADD_0]], %[[CONSTANT_30]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[SELECT_6:.*]] = mhlo.select %[[COMPARE_4]], %[[CONSTANT_67]], %[[SELECT_5]] : tensor<i1>, tensor<f32>
// CHECK:           %[[COMPARE_5:.*]] = mhlo.compare LE, %[[CONVERT_1]], %[[CONSTANT_28]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[FLOOR_1:.*]] = mhlo.floor %[[ADD_0]] : tensor<f32>
// CHECK:           %[[COMPARE_6:.*]] = mhlo.compare NE, %[[ADD_0]], %[[FLOOR_1]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[AND_0:.*]] = mhlo.and %[[COMPARE_5]], %[[COMPARE_6]] : tensor<i1>
// CHECK:           %[[SELECT_7:.*]] = mhlo.select %[[AND_0]], %[[CONSTANT_67]], %[[SELECT_6]] : tensor<i1>, tensor<f32>
// CHECK:           %[[CONSTANT_68:.*]] = mhlo.constant dense<0x7F800000> : tensor<f32>
// CHECK:           %[[FLOOR_2:.*]] = mhlo.floor %[[CONVERT_1]] : tensor<f32>
// CHECK:           %[[COMPARE_7:.*]] = mhlo.compare EQ, %[[CONVERT_1]], %[[FLOOR_2]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[AND_1:.*]] = mhlo.and %[[COMPARE_5]], %[[COMPARE_7]] : tensor<i1>
// CHECK:           %[[CONSTANT_69:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f32>
// CHECK:           %[[FLOOR_3:.*]] = mhlo.floor %[[ADD_0]] : tensor<f32>
// CHECK:           %[[COMPARE_8:.*]] = mhlo.compare EQ, %[[ADD_0]], %[[FLOOR_3]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
...
// CHECK:           %[[MULTIPLY_42:.*]] = mhlo.multiply %[[MULTIPLY_41]], %[[SELECT_10]] : tensor<f32>
// CHECK:           %[[CONSTANT_70:.*]] = mhlo.constant dense<5.000000e-01> : tensor<f32>
// CHECK:           %[[ADD_78:.*]] = mhlo.add %[[CONVERT_1]], %[[CONSTANT_70]] : tensor<f32>
// CHECK:           %[[FLOOR_4:.*]] = mhlo.floor %[[ADD_78]] : tensor<f32>
// CHECK:           %[[ABS_4:.*]] = mhlo.abs %[[FLOOR_4]] : tensor<f32>
// CHECK:           %[[ADD_79:.*]] = mhlo.add %[[CONVERT_1]], %[[ABS_4]] : tensor<f32>
// CHECK:           %[[CONSTANT_71:.*]] = mhlo.constant dense<3.14159274> : tensor<f32>
// CHECK:           %[[MULTIPLY_43:.*]] = mhlo.multiply %[[CONSTANT_71]], %[[ADD_79]] : tensor<f32>
// CHECK:           %[[COSINE_0:.*]] = mhlo.cosine %[[MULTIPLY_43]] : tensor<f32>
// CHECK:           %[[SINE_1:.*]] = mhlo.sine %[[MULTIPLY_43]] : tensor<f32>
// CHECK:           %[[DIVIDE_13:.*]] = mhlo.divide %[[COSINE_0]], %[[SINE_1]] : tensor<f32>
// CHECK:           %[[FLOOR_5:.*]] = mhlo.floor %[[CONVERT_0]] : tensor<f32>
// CHECK:           %[[CONSTANT_72:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f32>
// CHECK:           %[[MULTIPLY_44:.*]] = mhlo.multiply %[[CONSTANT_72]], %[[DIVIDE_13]] : tensor<f32>
// CHECK:           %[[CONSTANT_73:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f32>
// CHECK:           %[[ADD_80:.*]] = mhlo.add %[[MULTIPLY_44]], %[[CONSTANT_73]] : tensor<f32>
...
// CHECK:           %[[CONSTANT_80:.*]] = mhlo.constant dense<97.4090881> : tensor<f32>
// CHECK:           %[[MULTIPLY_51:.*]] = mhlo.multiply %[[CONSTANT_80]], %[[ADD_86]] : tensor<f32>
// CHECK:           %[[SUBTRACT_8:.*]] = mhlo.subtract %[[CONSTANT_0]], %[[CONVERT_1]] : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_81:.*]] = mhlo.constant dense<4.000000e+00> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_82:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_83:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK:           %[[NEGATE_3:.*]] = mhlo.negate %[[CONSTANT_81]] : tensor<f32>
...
// CHECK:           %[[CONSTANT_133:.*]] = mhlo.constant dense<-31.0062771> : tensor<f32>
// CHECK:           %[[MULTIPLY_97:.*]] = mhlo.multiply %[[CONSTANT_133]], %[[ADD_148]] : tensor<f32>
// CHECK:           %[[SUBTRACT_10:.*]] = mhlo.subtract %[[CONSTANT_0]], %[[CONVERT_1]] : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_134:.*]] = mhlo.constant dense<3.000000e+00> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_135:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_136:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK:           %[[NEGATE_4:.*]] = mhlo.negate %[[CONSTANT_134]] : tensor<f32>
...
// CHECK:           %[[CONSTANT_184:.*]] = mhlo.constant dense<9.86960411> : tensor<f32>
// CHECK:           %[[MULTIPLY_141:.*]] = mhlo.multiply %[[CONSTANT_184]], %[[ADD_208]] : tensor<f32>
// CHECK:           %[[SUBTRACT_12:.*]] = mhlo.subtract %[[CONSTANT_0]], %[[CONVERT_1]] : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_185:.*]] = mhlo.constant dense<2.000000e+00> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_186:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_187:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK:           %[[NEGATE_5:.*]] = mhlo.negate %[[CONSTANT_185]] : tensor<f32>
...
// CHECK:           %[[SELECT_31:.*]] = mhlo.select %[[COMPARE_37]], %[[ADD_265]], %[[SELECT_24]] : tensor<i1>, tensor<f32>
// CHECK:           %[[CONSTANT_231:.*]] = mhlo.constant dense<5.000000e-01> : tensor<f32>
// CHECK:           %[[COMPARE_38:.*]] = mhlo.compare LT, %[[CONVERT_1]], %[[CONSTANT_231]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[SELECT_32:.*]] = mhlo.select %[[COMPARE_38]], %[[SELECT_31]], %[[MULTIPLY_42]] : tensor<i1>, tensor<f32>
// CHECK:           %[[CONSTANT_232:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f32>
// CHECK:           %[[COMPARE_39:.*]] = mhlo.compare EQ, %[[CONVERT_0]], %[[CONSTANT_232]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[CONSTANT_233:.*]] = mhlo.constant dense<5.000000e-01> : tensor<f32>
// CHECK:           %[[COMPARE_40:.*]] = mhlo.compare LT, %[[CONVERT_1]], %[[CONSTANT_233]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[NEGATE_6:.*]] = mhlo.negate %[[CONVERT_1]] : tensor<f32>
// CHECK:           %[[CONSTANT_234:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK:           %[[SUBTRACT_14:.*]] = mhlo.subtract %[[CONVERT_1]], %[[CONSTANT_234]] : tensor<f32>
// CHECK:           %[[SELECT_33:.*]] = mhlo.select %[[COMPARE_40]], %[[NEGATE_6]], %[[SUBTRACT_14]] : tensor<i1>, tensor<f32>
// CHECK-DAG:       %[[CONSTANT_235:.*]] = mhlo.constant dense<0.000000e+00> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_236:.*]] = mhlo.constant dense<1.000000e+00> : tensor<f32>
// CHECK-DAG:       %[[CONSTANT_237:.*]] = mhlo.constant dense<676.520386> : tensor<f32>
...
// CHECK:           %[[SUBTRACT_23:.*]] = mhlo.subtract %[[ADD_284]], %[[DIVIDE_41]] : tensor<f32>
// CHECK:           %[[CONSTANT_256:.*]] = mhlo.constant dense<5.000000e-01> : tensor<f32>
// CHECK:           %[[ADD_285:.*]] = mhlo.add %[[CONVERT_1]], %[[CONSTANT_256]] : tensor<f32>
// CHECK:           %[[FLOOR_15:.*]] = mhlo.floor %[[ADD_285]] : tensor<f32>
// CHECK:           %[[ABS_11:.*]] = mhlo.abs %[[FLOOR_15]] : tensor<f32>
// CHECK:           %[[ADD_286:.*]] = mhlo.add %[[CONVERT_1]], %[[ABS_11]] : tensor<f32>
// CHECK:           %[[CONSTANT_257:.*]] = mhlo.constant dense<3.14159274> : tensor<f32>
// CHECK:           %[[MULTIPLY_190:.*]] = mhlo.multiply %[[CONSTANT_257]], %[[ADD_286]] : tensor<f32>
// CHECK:           %[[COSINE_1:.*]] = mhlo.cosine %[[MULTIPLY_190]] : tensor<f32>
// CHECK:           %[[SINE_2:.*]] = mhlo.sine %[[MULTIPLY_190]] : tensor<f32>
...
// CHECK:           %[[SUBTRACT_24:.*]] = mhlo.subtract %[[SUBTRACT_23]], %[[DIVIDE_42]] : tensor<f32>
// CHECK:           %[[SELECT_34:.*]] = mhlo.select %[[COMPARE_40]], %[[SUBTRACT_24]], %[[SUBTRACT_23]] : tensor<i1>, tensor<f32>
// CHECK:           %[[COMPARE_41:.*]] = mhlo.compare LE, %[[CONVERT_1]], %[[CONSTANT_235]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[FLOOR_16:.*]] = mhlo.floor %[[CONVERT_1]] : tensor<f32>
// CHECK:           %[[COMPARE_42:.*]] = mhlo.compare EQ, %[[CONVERT_1]], %[[FLOOR_16]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[AND_12:.*]] = mhlo.and %[[COMPARE_41]], %[[COMPARE_42]] : tensor<i1>
// CHECK:           %[[CONSTANT_258:.*]] = mhlo.constant dense<0x7FC00000> : tensor<f32>
// CHECK:           %[[SELECT_35:.*]] = mhlo.select %[[AND_12]], %[[CONSTANT_258]], %[[SELECT_34]] : tensor<i1>, tensor<f32>
// CHECK:           %[[SELECT_36:.*]] = mhlo.select %[[COMPARE_39]], %[[SELECT_35]], %[[SELECT_32]] : tensor<i1>, tensor<f32>
// CHECK:           %[[FLOOR_17:.*]] = mhlo.floor %[[CONVERT_0]] : tensor<f32>
// CHECK:           %[[COMPARE_43:.*]] = mhlo.compare NE, %[[CONVERT_0]], %[[FLOOR_17]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[COMPARE_44:.*]] = mhlo.compare LT, %[[CONVERT_0]], %[[CONSTANT_232]] : (tensor<f32>, tensor<f32>) -> tensor<i1>
// CHECK:           %[[OR_0:.*]] = mhlo.or %[[COMPARE_43]], %[[COMPARE_44]] : tensor<i1>
// CHECK:           %[[CONSTANT_259:.*]] = mhlo.constant dense<0x7FC00000> : tensor<f32>
// CHECK:           %[[SELECT_37:.*]] = mhlo.select %[[OR_0]], %[[CONSTANT_259]], %[[SELECT_36]] : tensor<i1>, tensor<f32>
// CHECK:           %[[CONVERT_2:.*]] = mhlo.convert %[[SELECT_37]] : (tensor<f32>) -> tensor<f16>
