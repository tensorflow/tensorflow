...
// RUN: mlir-hlo-opt --chlo-legalize-to-high-level-mhlo="enable-acosh enable-erf enable-ragged-dot enable-topk" --split-input-file -verify-diagnostics %s | FileCheck %s --check-prefix=CHECK-HIGH-LEVEL
