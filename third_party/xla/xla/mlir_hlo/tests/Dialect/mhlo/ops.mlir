...
// ragged_dot mode 1: [m,k], [g,k,n], [g] -> [m,n]
func.func @ragged_dot_non_contracting(%lhs : tensor<11x5xf32>, %rhs : tensor<3x5x7xf32>, %group_sizes : tensor<3xi64>) -> tensor<11x7xf32> {
...
func.func @ragged_dot_contracting(%lhs : tensor<11x5xf32>, %rhs : tensor<5x7xf32>, %group_sizes : tensor<3xi64>) -> tensor<3x11x7xf32> {
  %0 = "mhlo.ragged_dot"(%lhs, %rhs, %group_sizes) {
    ragged_dot_dimension_numbers = #mhlo.ragged_dot<
      dot_dimension_numbers = <
        lhs_batching_dimensions = [],
