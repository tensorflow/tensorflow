...
ShapedType getHloOpResultType(Operation* op) {
  return cast<ShapedType>(getResultValue(op).getType());
}
...
struct RngUniformConversion : public OpConversionPattern<mhlo::RngOp> {
  ...
  LogicalResult matchAndRewrite(
    ...
    auto maxTy = dyn_cast<ShapedType>(adaptor.getOperands()[0].getType());
...
SmallVector<Value, 2> extractDynamicEinsumSizes(
  ...
  for (const std::string& dimInd : outputLoopVec) {
    ...
    if (dimIndIt != lhsLoopVec.end()) {
      ...
      auto lhsShape = dyn_cast<RankedTensorType>(lhs.getType()).getShape();
      ...
      auto rhsShape = dyn_cast<RankedTensorType>(rhs.getType()).getShape();
...
class DataMovementOpConverter : public OpConversionPattern<OpTy> {
 public:
  ...
  LogicalResult matchAndRewrite(
    ...
    resultType = cast<ShapedType>(this->typeConverter->convertType(resultType));
...
class BroadcastConverter
 ...
 public:
  ...
  static SmallVector<AffineMap, 2> getIndexingMaps(OpTy broadcastOp,
                                                   Builder* b) {
    ShapedType inputType = cast<ShapedType>(broadcastOp.getOperand().getType());
...
class TransposeConverter
 ...
 public:
  ...
  static SmallVector<AffineMap, 2> getIndexingMaps(OpTy op, Builder* b) {
    auto resultType = cast<ShapedType>(getHloOpResultType(op));
    auto nloops = resultType.getRank();
...
class RealDynamicSliceConverter
 ...
 public:
  ...
  LogicalResult matchAndRewrite(
    ...
    auto argType = dyn_cast<ShapedType>(adaptor.getOperand().getType());
...
class ReshapeOpConverter : public OpConversionPattern<mhlo::ReshapeOp> {
 public:
  ...
  LogicalResult matchAndRewrite(
    ...
    auto resultType = cast<ShapedType>(reshapeOp.getType());
    ...
    resultType = cast<ShapedType>(typeConverter->convertType(resultType));
...
class IotaConverter : public OpConversionPattern<OpTy> {
 public:
  ...
  LogicalResult matchAndRewrite(
    ...
    resultShapedType = dyn_cast<ShapedType>(
    ...
    auto linalgOp = rewriter.create<linalg::GenericOp>(
        ...
        [&](OpBuilder& nestedBuilder, Location nestedLoc, ValueRange /*args*/) {
          ...
          if (auto complexType =
                  dyn_cast<ComplexType>(unwrappedResultElementType))
...
class IotaToMapConverter : public OpConversionPattern<OpTy> {
 public:
  ...
  LogicalResult matchAndRewrite(
    ...
    resultTy = dyn_cast<ShapedType>(this->typeConverter->convertType(resultTy));
...
class ConstConverterTensor : public OpConversionPattern<mhlo::ConstantOp> {
 public:
  ...
  LogicalResult matchAndRewrite(
      ...
      ConversionPatternRewriter& rewriter) const final {
    auto valueAttr = cast<DenseElementsAttr>(constOp.getValue());
    auto type = cast<ShapedType>(typeConverter->convertType(constOp.getType()));
...
class DynamicUpdateSliceConverter
 ...
 public:
  ...
  LogicalResult matchAndRewrite(
    ...
    auto updateType = dyn_cast<RankedTensorType>(adaptor.getUpdate().getType());
...
SmallVector<Value, 2> getDotOpEmptyTensorDynSizes(OpBuilder& b, Location loc,
  ...
  switch (type) {
    case DotOperationType::kMatrixMatrix: {
      if (cast<ShapedType>(lhs.getType()).isDynamicDim(0))
        dynShape.push_back(b.create<tensor::DimOp>(loc, lhs, 0));
      if (cast<ShapedType>(rhs.getType()).isDynamicDim(1))
...
class DotGeneralBatchMatMulOpConversion
 ...
 public:
  ...
  LogicalResult matchAndRewrite(
    ...
    if (cast<RankedTensorType>(op.getType()).getRank() != 3) {
    ...
    for (const auto& it : llvm::enumerate(op.getOperation()->getOperands())) {
      signatureConverter.addInputs(
          ...
          typeConverter->convertType(
              cast<ShapedType>(it.value().getType()).getElementType()));
    }
 ...
 public:
  ...
  LogicalResult matchAndRewrite(
    ...
    for (size_t i = 0; i < operands.size(); ++i) {
      if (isa<ShapedType>(operands[i].getType())) {
...
class RngBitGeneratorConverter
  ...
  LogicalResult matchAndRewrite(
    ...
    ShapedType resultTy = cast<ShapedType>(
...
struct SelectAndScatterNoOverlapConverter
  ...
  LogicalResult matchAndRewrite(
    ...
    ShapedType reduceIndexTy = cast<ShapedType>(reduceIndex.getType());
    ...
    auto collapseTy = cast<ShapedType>(collapse.getType());
...
struct PadOpConversion : public OpConversionPattern<mhlo::PadOp> {
  ...
  LogicalResult matchAndRewrite(
    ...
    auto operandType = cast<ShapedType>(adaptor.getOperand().getType());
...
struct NormalConvolutionOpConversion
  ...
  LogicalResult matchAndRewrite(
    ...
    auto resultType =
        cast<ShapedType>(typeConverter->convertType(op.getResult().getType()));
...
struct ReduceWindowOpOnTensorsGenericConversion
  ...
  LogicalResult matchAndRewrite(
    ...
    for (uint64_t i = 0, s = initValues.size(); i < s; i++) {
      ...
      auto resultTy = cast<ShapedType>(resultTypes[i]);
...
struct TorchIndexSelectOpConversion
  ...
  LogicalResult matchAndRewrite(
    ...
    auto indexShapedType = cast<ShapedType>(adaptor.getIndex().getType());
    int numIndices = static_cast<int>(indexShapedType.getRank());
    auto operandShapedType = cast<ShapedType>(adaptor.getOperand().getType());
    ...
    for (auto blockArgs : linalgOpArgs) {
      bodyArgTypes.push_back(
          cast<ShapedType>(blockArgs.getType()).getElementType());
    }
...
class DotGeneralOpConversion : public OpConversionPattern<mhlo::DotGeneralOp> {
 public:
  ...
  LogicalResult matchAndRewrite(
    ...
    auto lhsRank = cast<ShapedType>(adaptor.getLhs().getType()).getRank();
    auto lhsExtraDims =
        lhsRank - lhsBatchingDims.size() - lhsContractingDims.size();
    auto rhsRank = cast<ShapedType>(adaptor.getRhs().getType()).getRank();
