...
func.func @compute(%a: memref<2x6x2x2xf32>,
  ...
  // CHECK: @local_xla.gpu.cublas.lt.matmul(%[[A]], %[[B]], %[[C]], %[[D]])
...
// CHECK: func private @local_xla.gpu.cublas.lt.matmul(
...
func.func @compute(%a: memref<2x6x2x2xf32>,
  ...
  // CHECK: @local_xla.gpu.cublas.lt.matmul.bias(%[[A]], %[[B]], %[[C]], %[[D]],
  // CHECK-SAME:                           %[[BIAS]])
  // CHECK-SAME:   alpha_imag = 0.000000e+00 : f64
  // CHECK-SAME:   alpha_real = 1.000000e+00 : f64
  // CHECK-SAME:   beta = 0.000000e+00 : f64
...
// CHECK: func private @local_xla.gpu.cublas.lt.matmul.bias(
