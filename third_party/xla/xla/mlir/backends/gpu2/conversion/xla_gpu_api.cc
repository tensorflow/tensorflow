...
<<<<<<< HEAD:tensorflow/compiler/xla/mlir/backends/gpu2/conversion/xla_gpu_api.cc
//===--------------------------------------------------------------------===//
// XLA:GPU memcpy APIs
//===--------------------------------------------------------------------===//
...
=======
>>>>>>> upstream/master:third_party/xla/xla/mlir/backends/gpu2/conversion/xla_gpu_api.cc
//===----------------------------------------------------------------------===//
