...
//===----------------------------------------------------------------------===//
<<<<<<< HEAD:tensorflow/compiler/xla/mlir/backends/gpu2/conversion/convert_compiled_ops.cc
...
>>>>>>> upstream/master:third_party/xla/xla/mlir/backends/gpu2/conversion/convert_compiled_ops.cc
//===----------------------------------------------------------------------===//
