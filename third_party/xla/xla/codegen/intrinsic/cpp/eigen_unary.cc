...
// Half precision is not vectorized in Eigen yet.
// Eigen::half tanh_f16(Eigen::half x) { return Eigen::internal::ptanh(x); }
// Vec16h tanh_v16f16(Vec16h x) { return VectorTanh(x); }
