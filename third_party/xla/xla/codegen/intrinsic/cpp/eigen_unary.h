...
float log_f32(float x) asm("xla.unused.log.f32");
Vec4f log_v4f32(Vec4f x) asm("xla.unused.log.v4f32");
Vec8f log_v8f32(Vec8f x) asm("xla.unused.log.v8f32");
Vec16f log_v16f32(Vec16f x) asm("xla.unused.log.v16f32");
...
double log_f64(double x) asm("xla.unused.log.f64");
Vec4d log_v4f64(Vec4d x) asm("xla.unused.log.v4f64");
Vec8d log_v8f64(Vec8d x) asm("xla.unused.log.v8f64");
