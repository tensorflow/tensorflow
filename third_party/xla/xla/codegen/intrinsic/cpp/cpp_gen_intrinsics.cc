...
std::string GetCppGenIrString(absl::string_view features) {
#ifdef __x86_64__
  if (absl::StrContains(features, "avx512f")) {
    return ::llvm_ir::kEigenUnaryLlAvx512Ir;
  }
  return ::llvm_ir::kEigenUnaryLlAvx2Ir;
#endif
#ifdef __aarch64__
  return ::llvm_ir::kEigenUnaryLlNeonIr;
#endif
}
