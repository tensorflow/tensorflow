...
std::optional<absl::string_view> IsLegalStablehloOp(mlir::Operation* op) {
  if (mlir::isa<mlir::stablehlo::BroadcastInDimOp, mlir::stablehlo::ReduceOp,
                ...
                mlir::stablehlo::AddOp, mlir::stablehlo::DivOp,
                mlir::stablehlo::RemOp, mlir::stablehlo::MaxOp,
                mlir::stablehlo::MinOp, mlir::stablehlo::MulOp,
                mlir::stablehlo::SubtractOp, mlir::stablehlo::XorOp,
                mlir::stablehlo::AndOp, mlir::stablehlo::OrOp,
                mlir::stablehlo::ConvertOp, mlir::stablehlo::CompareOp>(op)) {
    return std::nullopt;
  }
