...
llvm::Function* EmitLdexpF64(llvm::Module* module, llvm::Type* vector_type) {
  ...
  llvm::Function* ldexp_func = llvm::Function::Create(
      ...
      absl::StrCat("xla.libm.ldexp.", num_elements, "xf64"), module);
  ...
  llvm::Argument* a = ldexp_func->arg_begin();
  a->setName("a");
  llvm::Argument* exponent = std::next(ldexp_func->arg_begin());
