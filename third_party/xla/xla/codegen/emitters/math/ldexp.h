...
#ifndef XLA_CODEGEN_EMITTERS_MATH_LDEXP_H_
#define XLA_CODEGEN_EMITTERS_MATH_LDEXP_H_

#include "llvm/IR/Value.h"

namespace xla::codegen::math {
// Returns a fast bit-shifting f64 implementation of ldexp for F64 based on
// Eigen. Function is named `xla.libm.ldexp.<vector_size>xf64`.
...
#endif  // XLA_CODEGEN_EMITTERS_MATH_LDEXP_H_
