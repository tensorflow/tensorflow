...
void SetBackendKind(SymbolicExprContext* context, mlir::func::FuncOp fn,
                    xla::BackendKind backend_kind) {
  fn->setAttr(
      xla::BackendKindAttr::name,
      xla::BackendKindAttr::get(context->GetMLIRContext(), backend_kind));
}
