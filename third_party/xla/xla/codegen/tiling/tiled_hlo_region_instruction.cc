...
/*static*/ absl::StatusOr<std::unique_ptr<TiledHloRegionInstruction>>
TiledHloRegionInstruction::Create(
  ...
  return absl::WrapUnique(new TiledHloRegionInstruction(
      std::move(*tiled_hlo_instruction), std::move(called_computation)));
}

TiledHloRegionInstruction::TiledHloRegionInstruction(
