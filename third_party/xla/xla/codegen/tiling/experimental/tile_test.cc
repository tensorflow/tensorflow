...
TEST_F(TileTest, StringFormat) {
  ...
  // ts variables have ID 0, 1. rt variable has ID 2.
  SymbolicExpr ts0 = CreateSymbolExpr(0, 2, &mlir_context_);
  SymbolicExpr ts1 = CreateSymbolExpr(1, 2, &mlir_context_);
  SymbolicExpr rt = CreateSymbolExpr(2, 2, &mlir_context_);
