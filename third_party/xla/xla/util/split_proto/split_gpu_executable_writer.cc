...
absl::Status WriteSplitGpuExecutable(gpu::GpuExecutableProto executable,
  ...
  *dnn_graphs_wrapper.mutable_dnn_compiled_graphs() =
  ...
  TF_RETURN_WITH_CONTEXT_IF_ERROR(
      ...
      "dnn_compiled_graphs, constants, and kernel_specs)");
