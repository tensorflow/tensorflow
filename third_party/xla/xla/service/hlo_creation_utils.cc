...
absl::StatusOr<HloInstruction*> MakeUnaryHlo(HloOpcode opcode,
  ...
  TF_XLA_ASSIGN_OR_RETURN(Shape unary_op_shape,
...
absl::StatusOr<HloInstruction*> MakeBinaryHlo(
  ...
  TF_XLA_ASSIGN_OR_RETURN(Shape binary_op_shape,
...
absl::StatusOr<HloInstruction*> MakeSliceHlo(
    ...
    const OpMetadata* metadata, const FrontendAttributes* frontend_attributes) {
  HloComputation* computation = operand->parent();
  TF_XLA_ASSIGN_OR_RETURN(Shape slice_shape, ShapeInference::InferSliceShape(
...
absl::StatusOr<HloInstruction*> MakeConcatHlo(
  ...
  TF_XLA_ASSIGN_OR_RETURN(Shape concat_shape, ShapeInference::InferConcatOpShape(
...
absl::StatusOr<HloInstruction*> MakeRaggedDotHlo(
  ...
  TF_XLA_ASSIGN_OR_RETURN(Shape ragged_dot_shape,
...
absl::StatusOr<HloInstruction*> MakeReduceWindowHlo(
  ...
  TF_XLA_ASSIGN_OR_RETURN(Shape inferred_shape,
...
absl::StatusOr<HloInstruction*> MakeReduceHlo(
  ...
  TF_XLA_ASSIGN_OR_RETURN(auto output_shape,
...
absl::StatusOr<HloInstruction*> MakeReverseHlo(
    ...
    const OpMetadata* metadata) {
  HloComputation* computation = operand->parent();
  TF_XLA_ASSIGN_OR_RETURN(Shape reverse_shape, ShapeInference::InferReverseShape(
...
absl::StatusOr<HloInstruction*> MakeSelectHlo(
  ...
  TF_XLA_ASSIGN_OR_RETURN(Shape select_shape,
...
absl::StatusOr<HloInstruction*> MakeFusionInstruction(
  ...
  TF_XLA_RETURN_IF_ERROR(comp->ReplaceInstruction(fused, fusion_instruction));
