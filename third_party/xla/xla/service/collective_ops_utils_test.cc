...
TEST(CollectiveOpsUtilsTest, GetReplicaGroups) {
  ...
  ASSERT_OK_AND_ASSIGN(std::vector<std::vector<int64_t>> permute_groups,
  ...
  ASSERT_OK_AND_ASSIGN(std::vector<std::vector<int64_t>> all_gather_groups,
  ...
  ASSERT_OK_AND_ASSIGN(std::vector<std::vector<int64_t>> all_reduce_groups,
