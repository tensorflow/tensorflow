...
module attributes {"triton_gpu.num-warps" = 4 : i32} {
  tt.func @sparse_dot_metadata(%meta: tensor<64x4xi16, #blocked>) {
    ...
    // CHECK: triton_gpu.local_load %[[META]] : !tt.memdesc<64x4xi16, #[[SHARED]], #triton_gpu.shared_memory> -> tensor<64x4xi16, #triton_xla.sparse_dot_meta<{parent = #mma}>>
    %0 = triton_gpu.convert_layout %meta : tensor<64x4xi16, #blocked> -> tensor<64x4xi16, #triton_xla.sparse_dot_meta<{parent = #mma}>>
    tt.return
  }
}
