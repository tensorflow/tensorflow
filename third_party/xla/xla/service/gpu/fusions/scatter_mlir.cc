...
absl::Status ScatterWithDistributedUpdates::EmitEntryFunctionImpl(
  ...
  Value in_bounds = EmitBoundsCheck(b, description_.slice_shape,
                                    description_.output_shape, update_offsets);
...
absl::Status ScatterWithDistributedIndices::EmitEntryFunctionImpl(
  ...
  SmallVector<Value> indices_init(description_.index_vector_length,
...
std::unique_ptr<MlirScatterFusion> CreateMlirScatterFusion(
  ...
  // TODO(b/385081952): Investigate why bf16 leads to incorrect results.
