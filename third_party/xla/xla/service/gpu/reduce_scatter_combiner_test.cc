...
while_body {
  ...
  ag.pipelined.0 = bf16[6,8,128] reduce-scatter(param.pipelined.0), dimensions={0},
    backend_config={"collective_backend_config": {"is_pipelined": true}}, to_apply=add
  ag.pipelined.1 = bf16[6,8,128] reduce-scatter(param.pipelined.1), dimensions={0},
    backend_config={"collective_backend_config": {"is_pipelined": true}}, to_apply=add
  ag.pipelined.2 = bf16[6,8,128] reduce-scatter(param.pipelined.2), dimensions={0},
    backend_config={"collective_backend_config": {"is_pipelined": true}}, to_apply=add
