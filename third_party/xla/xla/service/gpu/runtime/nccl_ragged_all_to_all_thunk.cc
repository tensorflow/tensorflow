...
absl::Status RunRaggedAllToAll(
  ...
  TF_RETURN_IF_ERROR(RunAllToAllOnIndexBuffer(
      collectives, buffers[4].source_buffer, output_offsets_device_buffer,
      buffers[4].element_type, stream, comm));
  buffers[4].source_buffer = output_offsets_device_buffer;
