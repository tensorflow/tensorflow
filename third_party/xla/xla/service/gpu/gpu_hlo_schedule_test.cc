...
// This test verifies that the scheduling fails if the size of input/output
// arguments exceeds the base limit.
TEST_F(GpuHloScheduleTest, FailsWhenArgumentSizeExceedsMemoryLimit) {
  ...
  EXPECT_THAT(
      ...
      StatusIs(absl::StatusCode::kInternal,
               MatchesRegex("The byte size of input/output arguments "
                            "\\(\\d+\\) exceeds the base limit \\(1\\). This "
