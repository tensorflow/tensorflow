...
// Rewrite a matrix-vector multiplication into a matrix-matrix multiplication
// with a trivial dimension. For example, [m x n] @ [n] is rewritten to
// [m x n] @ [n x 1], and [n] @ [m x n] is rewritten to [n x 1] @ [m x n].
