...
std::vector<std::string> GetNVPTXBackendOptions(
  ...
  auto llvm_opts = llvm_ir::ExtractXlaBackendOptions(
  ...
  // better cost model.
  llvm_opts.emplace_back("-bonus-inst-threshold=2");
  ...
  llvm_opts.emplace_back("-nvptx-prec-divf32=1");
  ...
  llvm_opts.emplace_back("-slp-vectorize-hor=false");
  llvm_opts.emplace_back("-slp-max-reg-size=32");
...
std::vector<std::string> GetAMDGPUBackendOptions(
    const DebugOptions& debug_options) {
  return llvm_ir::ExtractXlaBackendOptions(
      debug_options.xla_backend_extra_options());
}
...
std::vector<std::string> GetSPIRBackendOptions(
  ...
  llvm_opts.emplace_back("-slp-vectorize-hor=false");
  llvm_opts.emplace_back("-slp-min-reg-size=64");
  llvm_opts.emplace_back("-slp-max-reg-size=64");
