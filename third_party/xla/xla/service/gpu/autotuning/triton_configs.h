...
static const std::vector<TritonGemmConfig>* const kHopperAmpereConfigs =
    new std::vector<TritonGemmConfig>(
        {Config(16, 16, 64, 1, 4, 2),    Config(16, 16, 128, 1, 4, 4),
         ...
         Config(16, 256, 16, 1, 1, 2),   Config(16, 16, 256, 1, 5, 2),
         Config(16, 16, 256, 1, 4, 2),   Config(16, 16, 256, 1, 3, 2),
         Config(32, 32, 128, 16, 1, 4),  Config(32, 16, 256, 1, 2, 2),
         Config(32, 16, 256, 1, 3, 4),   Config(32, 32, 256, 1, 4, 4),
         Config(32, 256, 32, 1, 3, 4),   Config(32, 256, 32, 16, 3, 8),
         Config(64, 16, 32, 16, 4, 2),   Config(64, 16, 32, 1, 4, 2),
