...
int RunProfiler(int argc, char** argv) {
  ...
  const std::vector<HloOpcode> ops = {
      // Unary
      HloOpcode::kAbs, HloOpcode::kAllGatherDone, HloOpcode::kAllReduceDone,
      HloOpcode::kAsyncDone, HloOpcode::kAsyncUpdate, HloOpcode::kBitcast,
      HloOpcode::kBitcastConvert, HloOpcode::kBroadcast, HloOpcode::kCbrt,
      HloOpcode::kCeil, HloOpcode::kCholesky, HloOpcode::kClz,
      HloOpcode::kCollectivePermuteDone, HloOpcode::kConvert, HloOpcode::kCopy,
      HloOpcode::kCopyDone, HloOpcode::kCopyStart, HloOpcode::kCos,
      HloOpcode::kDomain, HloOpcode::kErf, HloOpcode::kExp, HloOpcode::kExpm1,
      HloOpcode::kFft, HloOpcode::kFloor, HloOpcode::kGetDimensionSize,
      HloOpcode::kGetTupleElement, HloOpcode::kImag, HloOpcode::kInfeed,
      HloOpcode::kIsFinite, HloOpcode::kLog, HloOpcode::kLog1p,
      HloOpcode::kLogistic, HloOpcode::kNegate, HloOpcode::kNot,
      HloOpcode::kOptimizationBarrier, HloOpcode::kPopulationCount,
      HloOpcode::kReal, HloOpcode::kRecv, HloOpcode::kRecvDone,
      HloOpcode::kReducePrecision, HloOpcode::kReshape, HloOpcode::kReverse,
      HloOpcode::kRngBitGenerator, HloOpcode::kRoundNearestAfz,
      HloOpcode::kRoundNearestEven, HloOpcode::kRsqrt, HloOpcode::kSendDone,
      HloOpcode::kSign, HloOpcode::kSin, HloOpcode::kSlice, HloOpcode::kSqrt,
      HloOpcode::kTan, HloOpcode::kTanh, HloOpcode::kTopK,
      HloOpcode::kTranspose, HloOpcode::kWhile,
      // Binary
      ...
      HloOpcode::kMultiply, HloOpcode::kOr, HloOpcode::kOutfeed,
      HloOpcode::kPad, HloOpcode::kPower, HloOpcode::kRemainder,
      HloOpcode::kSend, HloOpcode::kSetDimensionSize, HloOpcode::kShiftLeft,
      HloOpcode::kShiftRightArithmetic, HloOpcode::kShiftRightLogical,
      HloOpcode::kStochasticConvert, HloOpcode::kSubtract,
      HloOpcode::kTriangularSolve, HloOpcode::kXor};
