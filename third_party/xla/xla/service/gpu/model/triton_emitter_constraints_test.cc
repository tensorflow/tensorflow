...
fused_computation (p0: f32[4,5376], p1: f32[32768,5376]) -> f32[4,32768] {
  %p0 = f32[4,5376]{1,0} parameter(0)
  %p1 = f32[32768,5376]{1,0} parameter(1)  
  ROOT %dot.2686 = f32[4,32768]{1,0} dot(%p0, %p1), lhs_contracting_dims={1}, rhs_contracting_dims={1}
}
