...
ENTRY main {
  ...
  return {all_gather_intra_host,     all_gather_inter_host_pairwise,
          all_gather_all_ranks,      reduce_scatter_all_ranks,
          matmul_bf16_1024_4096_512, matmul_f32_batch4_256_1024_256};
}
