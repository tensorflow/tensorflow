      ...
      *grouped_indexing,
      UnorderedElementsAre(
          Pair(root, ElementsAre(MatchIndexingMap(
                         "(d0, d1) -> (d0, d1)",
                         MatchDomain(ElementsAre(MatchRange(0, 999),
                                                 MatchRange(0, 999)),
                                     IsEmpty())))),
          Pair(transpose, ElementsAre(MatchIndexingMap(
                              "(d0, d1) -> (d0, d1)",
                              MatchDomain(ElementsAre(MatchRange(0, 999),
                                                      MatchRange(0, 999)),
                                          IsEmpty())))),
  ...
  EXPECT_THAT(
      ...
      ElementsAre(
          ElementsAre(MatchIndexingMap(
              "(d0, d1) -> (d0, d1)",
              MatchDomain(ElementsAre(MatchRange(0, 9), MatchRange(0, 19)),
                          IsEmpty()))),
          ElementsAre(MatchIndexingMap(
              "(d0, d1) -> (d0, d1)",
              MatchDomain(ElementsAre(MatchRange(0, 9), MatchRange(0, 19)),
...
TEST_F(IndexingAnalysisTest, BitcastIsReshape) {
  ...
  EXPECT_THAT(input_indexing.indexing_maps,
              ElementsAre(ElementsAre(MatchIndexingMap(
                  "(d0, d1, d2) -> (d0, d1 * 4 + d2)",
                  MatchDomain(ElementsAre(MatchRange(0, 3), MatchRange(0, 7),
                                          MatchRange(0, 3)),
                              IsEmpty())))));
}
...
TEST_F(IndexingAnalysisTest, BitcastIsTranspose) {
  ...
  EXPECT_THAT(
      ...
      ElementsAre(ElementsAre(MatchIndexingMap(
          ...
          MatchDomain(ElementsAre(MatchRange(0, 2), MatchRange(0, 5),
...
TEST_F(IndexingAnalysisTest, BitcastIsTransposeReshapeTranspose) {
  ...
  EXPECT_THAT(input_indexing.indexing_maps,
              ElementsAre(ElementsAre(MatchIndexingMap(
                  ...
                  MatchDomain(ElementsAre(MatchRange(0, 50), MatchRange(0, 15)),
                              IsEmpty())))));
  auto output_indexing = GetInputToOutputIndexingForEntryComputation(ir);
  EXPECT_THAT(output_indexing.indexing_maps,
              ElementsAre(ElementsAre(MatchIndexingMap(
                  "(d0, d1, d2) -> (d1 * 3 + d2, d0)",
                  MatchDomain(ElementsAre(MatchRange(0, 15), MatchRange(0, 16),
                                          MatchRange(0, 2)),
                              IsEmpty())))));
}
...
TEST_F(IndexingAnalysisTest, BroadcastOp) {
  ...
  EXPECT_THAT(
      ...
      ElementsAre(ElementsAre(MatchIndexingMap(
          "(d0)[s0, s1] -> (s0, d0, s1)",
          MatchDomain(ElementsAre(MatchRange(0, 19)),
...
TEST_F(IndexingAnalysisTest, ConcatenateOp) {
  ...
  EXPECT_THAT(
      ...
      ElementsAre(
          ElementsAre(MatchIndexingMap(
              "(d0, d1, d2) -> (d0, d1, d2)",
              MatchDomain(ElementsAre(MatchRange(0, 1), MatchRange(0, 4),
                                      MatchRange(0, 6)),
                          IsEmpty()))),
          ElementsAre(MatchIndexingMap(
              "(d0, d1, d2) -> (d0, d1 - 5, d2)",
              MatchDomain(ElementsAre(MatchRange(0, 1), MatchRange(5, 15),
                                      MatchRange(0, 6)),
                          IsEmpty()))),
          ElementsAre(MatchIndexingMap(
              "(d0, d1, d2) -> (d0, d1 - 16, d2)",
              MatchDomain(ElementsAre(MatchRange(0, 1), MatchRange(16, 32),
                                      MatchRange(0, 6)),
                          IsEmpty())))));
  ...
  EXPECT_THAT(output_indexing_1.indexing_maps,
              ElementsAre(ElementsAre(MatchIndexingMap(
                  "(d0, d1, d2) -> (d0, d1 + 5, d2)",
                  MatchDomain(ElementsAre(MatchRange(0, 1), MatchRange(0, 10),
                                          MatchRange(0, 6)),
                              IsEmpty())))));
  ...
  EXPECT_THAT(output_indexing_2.indexing_maps,
              ElementsAre(ElementsAre(MatchIndexingMap(
                  "(d0, d1, d2) -> (d0, d1 + 16, d2)",
                  MatchDomain(ElementsAre(MatchRange(0, 1), MatchRange(0, 16),
                                          MatchRange(0, 6)),
                              IsEmpty())))));
}
...
TEST_F(IndexingAnalysisTest, FusionOpWithSingleBinaryOp) {
  ...
  EXPECT_THAT(
      ...
      ElementsAre(
          ElementsAre(MatchIndexingMap(
              "(d0) -> (d0)",
              MatchDomain(ElementsAre(MatchRange(0, 99)), IsEmpty()))),
          ElementsAre(MatchIndexingMap(
              "(d0) -> (d0)",
              MatchDomain(ElementsAre(MatchRange(0, 99)), IsEmpty())))));
}
  ...
  EXPECT_THAT(
      ...
      ElementsAre(
          ElementsAre(MatchIndexingMap(
              ...
              "(d2, d0 * 768 + s0, d4, d5)",
              MatchDomain(ElementsAre(MatchRange(0, 15), MatchRange(0, 15),
...
TEST_F(IndexingAnalysisTest, FusionOpWithSoftmax) {
  ...
  EXPECT_THAT(
      ...
      ElementsAre(UnorderedElementsAre(
          MatchIndexingMap(
              "(d0, d1, d2) -> (d0, d1, d2)",
              MatchDomain(ElementsAre(MatchRange(0, 1), MatchRange(0, 64),
                                      MatchRange(0, 124)),
                          IsEmpty())),
          MatchIndexingMap(
...
TEST_F(IndexingAnalysisTest, FusionOpTensorPlusTransposedTensor) {
  ...
  EXPECT_THAT(
      ...
      ElementsAre(UnorderedElementsAre(
          MatchIndexingMap(
              "(d0, d1) -> (d1, d0)",
              MatchDomain(ElementsAre(MatchRange(0, 999), MatchRange(0, 999)),
                          IsEmpty())),
          MatchIndexingMap(
              "(d0, d1) -> (d0, d1)",
              MatchDomain(ElementsAre(MatchRange(0, 999), MatchRange(0, 999)),
  ...
  EXPECT_THAT(
      ...
      ElementsAre(
          UnorderedElementsAre(
              MatchIndexingMap(
                  "(d0) -> (d0)",
                  MatchDomain(ElementsAre(MatchRange(0, 1)), IsEmpty())),
              MatchIndexingMap(
                  "(d0) -> (d0 + 1)",
                  MatchDomain(ElementsAre(MatchRange(0, 1)), IsEmpty())),
              MatchIndexingMap(
  ...
  EXPECT_THAT(
      ...
      ElementsAre(
          ElementsAre(MatchIndexingMap(
              ...
              MatchDomain(ElementsAre(MatchRange(0, 9)),
                          ElementsAre(MatchRange(0, 149), MatchRange(0, 49),
                                      MatchRange(0, 19))))),
          ElementsAre(MatchIndexingMap(
              "(d0) -> ()",
              MatchDomain(ElementsAre(MatchRange(0, 9)), IsEmpty())))));
}
...
TEST_F(IndexingAnalysisTest, FusionOpWithReduceOfBroadcast) {
  ...
  EXPECT_THAT(
      ...
      ElementsAre(
          ElementsAre(MatchIndexingMap(
              "(d0, d1)[s0] -> (d0, s0)",
              MatchDomain(ElementsAre(MatchRange(0, 14), MatchRange(0, 63)),
...
TEST_F(IndexingAnalysisTest, FusionOpWithTransposeOfTranspose) {
  ...
  EXPECT_THAT(input_indexing.indexing_maps,
              ElementsAre(ElementsAre(MatchIndexingMap(
                  "(d0, d1, d2) -> (d2, d0, d1)",
                  MatchDomain(ElementsAre(MatchRange(0, 9), MatchRange(0, 49),
                                          MatchRange(0, 19)),
                              IsEmpty())))));
}
  ...
  EXPECT_THAT(
      ...
      ElementsAre(
          ElementsAre(MatchIndexingMap(
              ...
              MatchDomain(ElementsAre(MatchRange(0, 31)),
                          ElementsAre(MatchRange(0, 15), MatchRange(0, 127))))),
          ElementsAre(MatchIndexingMap(
              "(d0) -> ()",
              MatchDomain(ElementsAre(MatchRange(0, 31)), IsEmpty())))));
}
...
TEST_F(IndexingAnalysisTest, FusionOpWithReshape_CollapseOfExpand) {
  ...
  EXPECT_THAT(input_indexing.indexing_maps,
              ElementsAre(ElementsAre(MatchIndexingMap(
                  "(d0) -> (d0)",
                  MatchDomain(ElementsAre(MatchRange(0, 127)), IsEmpty())))));
}
...
TEST_F(IndexingAnalysisTest, FusionOpWithReshape_ExpandOfCollapse) {
  ...
  EXPECT_THAT(input_indexing.indexing_maps,
              ElementsAre(ElementsAre(MatchIndexingMap(
                  "(d0, d1) -> (d0, d1)",
                  MatchDomain(ElementsAre(MatchRange(0, 7), MatchRange(0, 15)),
                              IsEmpty())))));
}
...
TEST_F(IndexingAnalysisTest, FusionOpWithReshape_ChainedGenericReshapes) {
  ...
  EXPECT_THAT(input_indexing.indexing_maps,
              ElementsAre(ElementsAre(MatchIndexingMap(
                  "(d0, d1, d2) -> (d0, d1, d2)",
                  MatchDomain(ElementsAre(MatchRange(0, 9), MatchRange(0, 9),
                                          MatchRange(0, 9)),
                              IsEmpty())))));
}
...
TEST_F(IndexingAnalysisTest, FusionOpWithSliceOfSlice) {
  ...
  EXPECT_THAT(input_indexing.indexing_maps,
              ElementsAre(ElementsAre(MatchIndexingMap(
                  ...
                  MatchDomain(ElementsAre(MatchRange(0, 6), MatchRange(0, 8),
                                          MatchRange(0, 23)),
                              IsEmpty())))));
}
...
TEST_F(IndexingAnalysisTest, FusionOpSliceOfAllConcatenateOpInputs) {
  ...
  EXPECT_THAT(
      ...
      ElementsAre(
          ElementsAre(MatchIndexingMap(
              "(d0, d1, d2) -> (d0, d1 * 3, d2)",
              MatchDomain(ElementsAre(MatchRange(0, 1), MatchRange(0, 1),
                                      MatchRange(0, 6)),
                          IsEmpty()))),
          ElementsAre(MatchIndexingMap(
              "(d0, d1, d2) -> (d0, d1 * 3 - 5, d2)",
              MatchDomain(ElementsAre(MatchRange(0, 1), MatchRange(2, 5),
                                      MatchRange(0, 6)),
                          IsEmpty()))),
          ElementsAre(MatchIndexingMap(
              "(d0, d1, d2) -> (d0, d1 * 3 - 16, d2)",
              MatchDomain(ElementsAre(MatchRange(0, 1), MatchRange(6, 10),
                                      MatchRange(0, 6)),
                          IsEmpty())))));
}
...
TEST_F(IndexingAnalysisTest, FusionOpSliceOfOneOfConcatenateOpInputs) {
  ...
  EXPECT_THAT(
      ...
      ElementsAre(
          ElementsAre(MatchIndexingMap(
              "(d0, d1, d2) -> (d0, d1 * 2, d2)",
              MatchDomain(ElementsAre(MatchRange(0, 1), MatchRange(0, 2),
                                      MatchRange(0, 6)),
                          IsEmpty()))),
          ElementsAre(MatchIndexingMap("(d0, d1, d2) -> (d0, d1 * 2 - 5, d2)",
                                       IsEmptyDomain())),
          ElementsAre(MatchIndexingMap("(d0, d1, d2) -> (d0, d1 * 2 - 16, d2)",
                                       IsEmptyDomain()))));
}
      ...
      ElementsAre(
          ElementsAre(MatchIndexingMap(
              ...
              MatchDomainWithGenericConstraints(
                  ...
                  UnorderedElementsAre(
                      MatchExprRange("d0 * 8 + d1", MatchRange(0, 1)))))),
          ElementsAre(MatchIndexingMap(
              "(d0, d1) -> (d0 * 8 + d1 - 2)",
              MatchDomainWithGenericConstraints(
                  ElementsAre(MatchRange(0, 3), MatchRange(0, 7)), IsEmpty(),
                  UnorderedElementsAre(
                      MatchExprRange("d0 * 8 + d1", MatchRange(2, 31))))))));
}
...
TEST_F(IndexingAnalysisTest, ReshapeOpExpandAndCollapseShape) {
  ...
  EXPECT_THAT(input_indexing.indexing_maps,
              ElementsAre(ElementsAre(MatchIndexingMap(
                  ...
                  MatchDomain(ElementsAre(MatchRange(0, 31), MatchRange(0, 2),
                                          MatchRange(0, 3)),
                              IsEmpty())))));
...
TEST_F(IndexingAnalysisTest, ReshapeOpExpandSubshapeOnly) {
  ...
  EXPECT_THAT(input_indexing.indexing_maps,
              ElementsAre(ElementsAre(MatchIndexingMap(
                  "(d0, d1, d2) -> (d0 * 4 + d1, d2)",
                  MatchDomain(ElementsAre(MatchRange(0, 3), MatchRange(0, 3),
                                          MatchRange(0, 7)),
                              IsEmpty())))));
}
...
TEST_F(IndexingAnalysisTest, ReshapeOpGenericReshape2DTO3D) {
  ...
  EXPECT_THAT(input_indexing.indexing_maps,
              ElementsAre(ElementsAre(MatchIndexingMap(
                  ...
                  "(d1 * 4 + d2) mod 8)",
                  MatchDomain(ElementsAre(MatchRange(0, 1), MatchRange(0, 3),
                                          MatchRange(0, 3)),
                              IsEmpty())))));
}
...
TEST_F(IndexingAnalysisTest, ReduceOp) {
  ...
  EXPECT_THAT(
      ...
      ElementsAre(
          ElementsAre(MatchIndexingMap(
              ...
              MatchDomain(ElementsAre(MatchRange(0, 149), MatchRange(0, 9)),
  ...
  EXPECT_THAT(
      ...
      ElementsAre(
          ElementsAre(MatchIndexingMap(
              "(d0, d1, d2, d3) -> (d0, d2)",
              MatchDomain(ElementsAre(MatchRange(0, 149), MatchRange(0, 19),
                                      MatchRange(0, 9), MatchRange(0, 49)),
                          IsEmpty()))),
          ElementsAre(MatchIndexingMap(
              "()[s0, s1] -> (s0, s1)",
              MatchDomain(IsEmpty(), ElementsAre(MatchRange(0, 149),
                                                 MatchRange(0, 9)))))));
}
...
TEST_F(IndexingAnalysisTest, VariadicReduceOp) {
  ...
  EXPECT_THAT(
      ...
      ElementsAre(
          ElementsAre(MatchIndexingMap(
              "(d0, d1) -> (d1)",
              MatchDomain(ElementsAre(MatchRange(0, 255), MatchRange(0, 9)),
                          IsEmpty()))),
          ElementsAre(MatchIndexingMap(
              "(d0, d1) -> (d1)",
              MatchDomain(ElementsAre(MatchRange(0, 255), MatchRange(0, 9)),
          ...
          ElementsAre(MatchIndexingMap(
              "()[s0] -> (s0)",
              MatchDomain(IsEmpty(), ElementsAre(MatchRange(0, 9))))),
...
TEST_F(IndexingAnalysisTest, ReverseOp) {
  ...
  EXPECT_THAT(input_indexing.indexing_maps,
              ElementsAre(ElementsAre(MatchIndexingMap(
                  ...
                  MatchDomain(ElementsAre(MatchRange(0, 0), MatchRange(0, 16),
...
TEST_F(IndexingAnalysisTest, ReverseReshape) {
  ...
  EXPECT_THAT(input_indexing.indexing_maps,
              ElementsAre(ElementsAre(MatchIndexingMap(
                  "(d0, d1) -> (d0, d1)",
                  MatchDomain(ElementsAre(MatchRange(0, 9), MatchRange(0, 10)),
                              IsEmpty())))));
}
...
TEST_F(IndexingAnalysisTest, SliceOp) {
  ...
  EXPECT_THAT(input_indexing.indexing_maps,
              ElementsAre(ElementsAre(MatchIndexingMap(
                  ...
                  MatchDomain(ElementsAre(MatchRange(0, 4), MatchRange(0, 2),
                                          MatchRange(0, 24)),
                              IsEmpty())))));
}
...
TEST_F(IndexingAnalysisTest, TransposeOp) {
  ...
  EXPECT_THAT(
      ...
      ElementsAre(ElementsAre(MatchIndexingMap(
          ...
          MatchDomain(ElementsAre(MatchRange(0, 2), MatchRange(0, 12287),
                                  MatchRange(0, 5), MatchRange(0, 127)),
                      IsEmpty())))));
}
  ...
  EXPECT_THAT(
      ...
      ElementsAre(
          ElementsAre(MatchIndexingMap(
              ...
              "(d2, d1, s1, d3, s0, d0)",
              MatchDomain(ElementsAre(MatchRange(0, 9), MatchRange(0, 37),
  ...
  EXPECT_THAT(
      ...
      ElementsAre(
          UnorderedElementsAre(
              MatchIndexingMap(
                  "(d0, d1) -> (d0 * 4, d1)",
                  MatchDomain(ElementsAre(MatchRange(0, 4), MatchRange(0, 4)),
                              IsEmpty())),
              std::nullopt),
          ElementsAre(std::nullopt)));
}
