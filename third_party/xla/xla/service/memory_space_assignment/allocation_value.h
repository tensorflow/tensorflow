...
class AllocationValue {
 public:
  ...
  AllocationValue(const AllocationValue& other) = default;
  AllocationValue(AllocationValue&& other) = default;
  AllocationValue& operator=(const AllocationValue& other) = default;
  AllocationValue& operator=(AllocationValue&& other) = default;
