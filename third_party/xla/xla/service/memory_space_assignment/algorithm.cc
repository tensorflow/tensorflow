...
absl::Status MsaAlgorithm::PinScalarBufferInAlternateMemory(
  ...
  //    extending the last position to the end of the program.
  ...
  MsaBufferInterval interval = MsaBufferInterval{/*buffer=*/first_value,
                                                 /*size=*/buffer_size,
