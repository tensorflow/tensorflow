...
class MsaAlgorithm : public GlobalDecreasingSizeBestFitHeap<HloValue> {
 ...
 private:
  ...
  void MaybeCreateMirroredParentAllocationForConditionalParameterUse(
  ...
  // Maps from a root instruction of a branched computation of a conditional
  // instruction to the conditional instruction.
