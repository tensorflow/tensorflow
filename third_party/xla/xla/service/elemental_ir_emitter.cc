...
absl::StatusOr<llvm::Value*> EmitFxToF8e(llvm::Module* module,
                                         PrimitiveType fx_type,
                                         PrimitiveType f8_type,
                                         llvm::Value* fx_value,
                                         llvm::IRBuilderBase* b) {
...
llvm::Value* EmitF16ToF8e4m3b11fnuz(llvm::Value* f16_value,
  ...
  auto* f8_value = EmitFxToF8e(module, F16, F8E4M3FN, f16_value, b).value();
