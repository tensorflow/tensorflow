...
// TEST_F(LayoutCanonicalizerTest, CanonicalizeBitcastOnlyLayoutMultipleUse) {
//   const std::string hlo_string = R"(
//   HloModule broadcast_module
//     ENTRY %main {
//       %p0 = bf16[32,1,58,50]{3,2,1,0} parameter(0)
//       %bitcast = bf16[32,1,58,50]{1,3,2,0} bitcast(%p0)
//       %broadcast1 = bf16[32,1,58,50]{1,0,2,3} broadcast(%bitcast),
//       dimensions={0,1,2,3} %broadcast2 = bf16[32,1,58,50]{1,0,2,3}
//       broadcast(%bitcast), dimensions={0,1,2,3} ROOT out =
//       bf16[32,1,58,50]{1,0,2,3} add (broadcast1, broadcast2)
//     }
//   )";
