...
CreateIrEmitterForConstantEmittionTests(HloModule& module,
...
ENTRY main {
  ...
  TF_ASSERT_OK_AND_ASSIGN(
      ...
      CreateIrEmitterForConstantEmittionTests(*module, *llvm_module));

  TF_ASSERT_OK(wrapped_ir_emitter->ir_emitter->EmitConstantGlobals());
