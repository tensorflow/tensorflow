...
absl::StatusOr<ThunkSequence> ThunkEmitter::EmitConcatenateKernelThunk(
  ...
  return MakeThunkSequence(instruction, buffers, kernel,
...
absl::StatusOr<ThunkSequence> ThunkEmitter::EmitPadKernelThunk(
  ...
  return MakeThunkSequence(padInstr, buffers, kernel,
                           /*min_alignment=*/cpu_function_runtime::MinAlign());
}
...
absl::StatusOr<ThunkSequence> ThunkEmitter::MakeThunkSequence(
    const HloInstruction* instruction,
  ...
  return ThunkSequence::Of<KernelThunk>(
      ...
      kernel.thread_dims, kernel.readonly_buffers, min_alignment);
}
