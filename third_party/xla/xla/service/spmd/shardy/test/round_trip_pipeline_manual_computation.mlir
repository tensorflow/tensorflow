...
// ==============================================================================
// RUN: sdy_opt %s -xla-sdy-round-trip-testing-pipeline -split-input-file | FileCheck %s
// RUN: sdy_opt %s -xla-sdy-round-trip-testing-pipeline='enable-hlo-sharding-v3=true' -split-input-file | FileCheck %s
