...
func.func @using_same_body_func(%arg0: tensor<8x8xf32>) -> tensor<8x8xf32> {
  %0 = mhlo.custom_call @SPMDFullToShardShape(%arg0) : (tensor<8x8xf32>) -> (tensor<2x8xf32>)
  ...
  %2 = mhlo.custom_call @SPMDShardToFullShape(%1) : (tensor<2x8xf32>) -> (tensor<8x8xf32>)
  %3 = mhlo.custom_call @SPMDFullToShardShape(%2) : (tensor<8x8xf32>) -> (tensor<2x8xf32>)
  ...
  %5 = mhlo.custom_call @SPMDShardToFullShape(%4) : (tensor<2x8xf32>) -> (tensor<8x8xf32>)
