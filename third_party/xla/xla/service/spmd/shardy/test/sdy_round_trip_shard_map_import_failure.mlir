...
func.func @using_same_body_func(%arg0: tensor<8x8xf32>) -> tensor<8x8xf32> {
  ...
  %3 = stablehlo.custom_call @SPMDFullToShardShape(%2) : (tensor<8x8xf32>) -> (tensor<2x8xf32>)
  ...
  %5 = stablehlo.custom_call @SPMDShardToFullShape(%4) : (tensor<2x8xf32>) -> (tensor<8x8xf32>)
