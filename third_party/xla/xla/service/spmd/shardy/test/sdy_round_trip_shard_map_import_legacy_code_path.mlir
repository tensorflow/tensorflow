...
func.func @manual_computation_no_inputs_no_outputs() {
  ...
  // CHECK-NEXT: } : () -> ()
  // CHECK-NEXT: return
  call @xla.sdy.manual_computation_body_8() {mhlo.frontend_attributes = {xla.sdy.in_shardings = "#sdy.sharding_per_value<[]>", xla.sdy.manual_axes = "#sdy<manual_axes{}>", xla.sdy.out_shardings = "#sdy.sharding_per_value<[]>"}} : () -> ()
  return
}
