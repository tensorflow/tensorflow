...
// CHECK-LABEL: func @three_named_computations_same_origin_func_with_two_calls_results_no_sharding(
func.func @three_named_computations_same_origin_func_with_two_calls_results_no_sharding(%arg0: tensor<8x2xi32> {sdy.sharding = #sdy.sharding<@mesh, [{}, {"y"}]>}) -> tensor<8x2xi32> {
