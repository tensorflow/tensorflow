...
// CHECK-SAME:      attributes {xla.sdy.manual_axes = #sdy<manual_axes{"a"}>, xla.sdy.original_func_name = "foo"} {
...
// CHECK-SAME:      attributes {xla.sdy.manual_axes = #sdy<manual_axes{"a"}>, xla.sdy.original_func_name = "bar"} {
