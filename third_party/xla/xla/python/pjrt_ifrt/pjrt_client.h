...
class PjRtClient final
 ...
 public:
  ...
  // Creates a unique identifier for each cross-host transfer. The returned
  // value must be the same in all processes.
  int create_new_transfer_key();
