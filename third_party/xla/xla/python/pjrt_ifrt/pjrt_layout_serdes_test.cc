...
class PjRtLayoutSerDesTest : public testing::TestWithParam</*version=*/int>,
                             public test_util::SerDesVersionMixin {
 public:
  PjRtLayoutSerDesTest() : test_util::SerDesVersionMixin(GetParam()) {}
};
...
INSTANTIATE_TEST_SUITE_P(SerDesVersion, PjRtLayoutSerDesTest,
                         testing::Values(SerDesVersion::kV0Initial));
