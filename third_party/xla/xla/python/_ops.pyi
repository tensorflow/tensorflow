...
def Cholesky(a: _xla_builder.XlaOp, lower: bool = ...) -> _xla_builder.XlaOp: ...
def Clamp(
...
def GetDimensionSize(operand: _xla_builder.XlaOp, index: int) -> _xla_builder.XlaOp: ...
def GetTupleElement(
...
def Igamma(a: _xla_builder.XlaOp, x: _xla_builder.XlaOp) -> _xla_builder.XlaOp: ...
def Igammac(a: _xla_builder.XlaOp, x: _xla_builder.XlaOp) -> _xla_builder.XlaOp: ...
def IgammaGradA(a: _xla_builder.XlaOp, x: _xla_builder.XlaOp) -> _xla_builder.XlaOp: ...
def RandomGammaGrad(
...
def Zeta(a: _xla_builder.XlaOp, q: _xla_builder.XlaOp) -> _xla_builder.XlaOp: ...
def Eq(
    lhs: _xla_builder.XlaOp,
    rhs: _xla_builder.XlaOp,
    broadcast_dimensions: Sequence[int] = ...,
