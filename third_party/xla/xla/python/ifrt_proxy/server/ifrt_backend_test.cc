...
TEST_F(IfrtBackendHandlerTest, LoadedExecutableMetadata) {
...

  {
    ...
    parameter_layouts.reserve(2);
    parameter_layouts.emplace_back(std::make_unique<xla::PjRtXlaLayout>(
    ...
    output_layouts.reserve(1);
    output_layouts.emplace_back(std::make_unique<xla::PjRtXlaLayout>(
        xla::LayoutUtil::MakeDescendingLayout(/*rank=*/2)));
