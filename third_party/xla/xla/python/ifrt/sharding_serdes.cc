...
class SingleDeviceShardingSerDes
 ...
 public:
  ...
  absl::StatusOr<std::unique_ptr<Serializable>> Deserialize(
    ...
    TF_XLA_ASSIGN_OR_RETURN(Device * device,
...
class OpaqueShardingSerDes
 ...
 public:
  ...
  absl::StatusOr<std::unique_ptr<Serializable>> Deserialize(
    ...
    TF_XLA_ASSIGN_OR_RETURN(auto devices, DeviceList::FromProto(
...
class ConcreteShardingSerDes
 ...
 public:
  ...
  absl::StatusOr<std::unique_ptr<Serializable>> Deserialize(
    ...
    TF_XLA_ASSIGN_OR_RETURN(auto dynamic_shape,
 ...
 public:
  ...
  absl::StatusOr<std::string> Serialize(
    ...
    *proto.mutable_devices() = sharding.devices()->ToProto(version);
    ...
    TF_XLA_ASSIGN_OR_RETURN(*proto.mutable_sharding_param(),
  ...
  absl::StatusOr<std::unique_ptr<Serializable>> Deserialize(
    ...
    TF_XLA_ASSIGN_OR_RETURN(ShardingParam sharding_param,
