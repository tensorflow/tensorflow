...
class SerDesVersion {
 public:
  ...
  enum {
    kV0Initial = 0,  // 2025-05-15, initial version.
  };
  ...
  friend void AbslStringify(Sink& sink, const SerDesVersion& version) {
    sink.Append("SerDesVersion(", version.version(), ")");
  }
 ...
 private:
  ...
  // Returns a version that was introduced on/before 4 weeks ago from now.
  ...
  friend class SerDesTestOnlyAnyVersionAccessor;
