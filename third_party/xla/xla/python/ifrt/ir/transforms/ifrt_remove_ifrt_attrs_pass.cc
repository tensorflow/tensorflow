...
#include "third_party/tensorflow/compiler/mlir/tensorflow/ir/tf_dialect.h"
...
class IfrtRemoveIfrtAttrsPass
 ...
 public:
  ...
  void getDependentDialects(mlir::DialectRegistry& registry) const override {
    // Add the TF dialect to the dependent dialect because this is the only
    // pass that we control within the TFCPU preprocessing pipeline. Without
    // this dependency the FileCheck tests of the pipeline would fail because
    // the TF dialect would not be loaded.
