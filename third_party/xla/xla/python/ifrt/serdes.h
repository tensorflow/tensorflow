...
// Returns the requested SerDes version for serialization. `this` can be
// `nullptr`. Serializers should use the highest version that is no greater
// than the version returned by this function.
