...
class ShapeSerDesTest : public testing::TestWithParam</*version=*/int>,
                        public test_util::SerDesVersionMixin {
 public:
  ShapeSerDesTest() : test_util::SerDesVersionMixin(GetParam()) {}
};
...
INSTANTIATE_TEST_SUITE_P(SerDesVersion, ShapeSerDesTest,
...
INSTANTIATE_TEST_SUITE_P(SerDesVersion, BoundedDynamicShapeTagSerDesTest,
                         testing::Values(SerDesVersion::kV0Initial));
...
INSTANTIATE_TEST_SUITE_P(SerDesVersion, DynamicShapeSerDesTest,
                         testing::Values(SerDesVersion::kV0Initial));
