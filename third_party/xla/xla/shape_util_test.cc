...
TEST(ShapeUtilTest, GetDimensionHelperCanNegativeIndex) {
  Shape matrix = ShapeUtil::MakeValidatedShape(F32, {2, 3}).value();
...
TEST(ShapeUtilTest, GetDimensionHelperExampleInDocumentationTest) {
  auto shape = ShapeUtil::MakeValidatedShape(F32, {1, 2, 3, 4}).value();
...
TEST(ShapeUtilTest, CreateRank3DimensionVectorFromShape) {
  Shape shape = ShapeUtil::MakeValidatedShape(F32, {3, 2, 7}).value();
...
TEST(ShapeUtilTest, Rank1DimensionIndexing) {
  Shape shape = ShapeUtil::MakeValidatedShape(F32, {3}).value();
...
TEST(ShapeUtilTest, Rank4DimensionIndexing) {
  Shape shape = ShapeUtil::MakeValidatedShape(F32, {3, 2, 7, 8}).value();
...
TEST(ShapeUtilTest, CompatibleIdenticalShapes) {
  Shape shape1 = ShapeUtil::MakeValidatedShape(F32, {3, 2}).value();
...
TEST(ShapeUtilTest, TokenCompatibility) {
  ...
  EXPECT_FALSE(
      ShapeUtil::Compatible(ShapeUtil::MakeTokenShape(),
                            ShapeUtil::MakeValidatedShape(F32, {}).value()));
  EXPECT_FALSE(
      ShapeUtil::Compatible(ShapeUtil::MakeValidatedShape(F32, {}).value(),
                            ShapeUtil::MakeTokenShape()));
  EXPECT_TRUE(ShapeUtil::Compatible(
      ShapeUtil::MakeValidatedTupleShape({ShapeUtil::MakeTokenShape()}).value(),
      ShapeUtil::MakeValidatedTupleShape({ShapeUtil::MakeTokenShape()})
          .value()));
}
...
TEST(ShapeUtilTest, TokensEqualShapes) {
  EXPECT_TRUE(ShapeUtil::Equal(ShapeUtil::MakeTokenShape(),
                               ShapeUtil::MakeTokenShape()));
  EXPECT_FALSE(
      ShapeUtil::Equal(ShapeUtil::MakeTokenShape(),
                       ShapeUtil::MakeValidatedShape(F32, {}).value()));
  EXPECT_FALSE(ShapeUtil::Equal(ShapeUtil::MakeValidatedShape(F32, {}).value(),
                                ShapeUtil::MakeTokenShape()));
...
TEST(ShapeUtilTest, CompatibleNotIdenticalShapes) {
  Shape shape_1 = ShapeUtil::MakeValidatedShape(F32, {3, 2}).value();
  ...
  Shape shape_2 = ShapeUtil::MakeValidatedShape(F32, {3, 2}).value();
...
TEST(ShapeUtilTest, CompatibleIgnoringFpPrecision) {
  Shape shape1 = ShapeUtil::MakeValidatedShape(BF16, {3, 2}).value();
  Shape shape2 = ShapeUtil::MakeValidatedShape(F32, {3, 2}).value();
...
TEST(ShapeUtilTest, EqualDynamicShapes) {
  EXPECT_TRUE(ShapeUtil::Equal(
      ShapeUtil::MakeValidatedShape(F32, {4, 3}, {true, false}).value(),
      ShapeUtil::MakeValidatedShape(F32, {4, 3}, {true, false}).value()));
  EXPECT_FALSE(ShapeUtil::Equal(
      ShapeUtil::MakeValidatedShape(F32, {4, 3}, {true, false}).value(),
      ShapeUtil::MakeValidatedShape(F32, {4, 3}, {false, false}).value()));
  EXPECT_FALSE(ShapeUtil::Equal(
      ShapeUtil::MakeValidatedShape(F32, {Shape::kUnboundedSize}, {true})
          .value(),
      ShapeUtil::MakeValidatedShape(F32, {2}, {true}).value()));
}
...
TEST(ShapeUtilTest, CompatibleDynamicShapes) {
  ...
  *shape_b.mutable_layout() = Layout({0, 1});
  Shape shape_c =
      ShapeUtil::MakeValidatedShape(F32, {4, 3}, {false, true}).value();
...
TEST(ShapeUtilTest, MakeMaybeTupleShape) {
  Shape s1 = ShapeUtil::MakeValidatedMaybeTupleShape(
                 ...
                 .value();
  EXPECT_TRUE(ShapeUtil::Compatible(
      s1, ShapeUtil::MakeValidatedShape(F32, {3, 2}).value()));
}

TEST(ShapeUtilTest, CompatibleTuplesIgnoringFpPrecision) {
  Shape tuple1 =
      ShapeUtil::MakeValidatedTupleShape({ShapeUtil::MakeShape(BF16, {3, 2}),
                                          ShapeUtil::MakeShape(F32, {4, 5})})
          .value();
  Shape tuple2 =
      ShapeUtil::MakeValidatedTupleShape({ShapeUtil::MakeShape(F64, {3, 2}),
                                          ShapeUtil::MakeShape(BF16, {4, 5})})
          .value();
...
TEST(ShapeUtilTest, IncompatibleTuplesWithSwappedElements) {
  Shape tuple1 =
      ShapeUtil::MakeValidatedTupleShape({ShapeUtil::MakeShape(PRED, {4, 5}),
                                          ShapeUtil::MakeShape(F32, {3, 2})})
          .value();
  Shape tuple2 =
      ShapeUtil::MakeValidatedTupleShape({ShapeUtil::MakeShape(F32, {3, 2}),
...
TEST(ShapeUtilTest, IncompatibleTuplesIgnoringFpPrecision) {
  Shape tuple1 =
      ShapeUtil::MakeValidatedTupleShape({ShapeUtil::MakeShape(BF16, {4, 5}),
                                          ShapeUtil::MakeShape(F32, {3, 2})})
          .value();
  Shape tuple2 =
      ShapeUtil::MakeValidatedTupleShape({ShapeUtil::MakeShape(F32, {3, 2}),
...
TEST(ShapeUtilTest, IncompatibleTuplesWithDifferentDimensions) {
  ...
  Shape tuple2 =
      ShapeUtil::MakeValidatedTupleShape({ShapeUtil::MakeShape(PRED, {4, 5}),
                                          ShapeUtil::MakeShape(F32, {4, 2})})
          .value();
  EXPECT_FALSE(ShapeUtil::Compatible(tuple1, tuple2));
}

TEST(ShapeUtilTest, IncompatibleScalarVsTuple) {
  Shape shape1 = ShapeUtil::MakeValidatedShape(F32, {}).value();
  Shape shape2 =
      ShapeUtil::MakeValidatedTupleShape(
...
TEST(ShapeUtilTest, OpaqueVsArray) {
  Shape shape1 = ShapeUtil::MakeValidatedShape(F32, {5, 7}).value();
...
TEST(ShapeUtilTest, ScalarDefaultLayoutEqualsScalarEmptyMin2Maj) {
  Shape scalar_default_layout = ShapeUtil::MakeValidatedShape(F32, {}).value();
...
TEST(ShapeUtilTest, ByteSizeOfWithoutPadding) {
  ...
  EXPECT_EQ(
      4, ShapeUtil::ByteSizeOf(ShapeUtil::MakeValidatedShape(F32, {}).value()));
  EXPECT_EQ(800, ShapeUtil::ByteSizeOf(
                     ShapeUtil::MakeValidatedShape(F32, {10, 20}).value()));

  EXPECT_EQ(8, ShapeUtil::ByteSizeOfPrimitiveType(F64));
  EXPECT_EQ(
      8, ShapeUtil::ByteSizeOf(ShapeUtil::MakeValidatedShape(F64, {}).value()));
  EXPECT_EQ(1600, ShapeUtil::ByteSizeOf(
                      ShapeUtil::MakeValidatedShape(F64, {10, 20}).value()));

  EXPECT_EQ(8, ShapeUtil::ByteSizeOfPrimitiveType(C64));
  EXPECT_EQ(
      8, ShapeUtil::ByteSizeOf(ShapeUtil::MakeValidatedShape(C64, {}).value()));
  EXPECT_EQ(1600, ShapeUtil::ByteSizeOf(
                      ShapeUtil::MakeValidatedShape(C64, {10, 20}).value()));
}

TEST(ShapeUtilTest, ByteStrides) {
  Shape shape1 = ShapeUtil::MakeValidatedShape(F32, {3, 5, 7}).value();
  Shape shape2 = ShapeUtil::MakeValidatedShape(F16, {5, 7, 9}).value();
...
TEST(ShapeUtilTest, NilShape) {
  ...
  EXPECT_FALSE(ShapeUtil::IsEmptyTuple(
      ShapeUtil::MakeValidatedShape(F32, {1, 2, 3}).value()));
  EXPECT_FALSE(ShapeUtil::IsEmptyTuple(
      ShapeUtil::MakeValidatedShape(F32, {0, 1}).value()));
  EXPECT_FALSE(ShapeUtil::IsEmptyTuple(
      ShapeUtil::MakeValidatedTupleShape({ShapeUtil::MakeShape(S32, {})})
          .value()));
  EXPECT_FALSE(ShapeUtil::IsEmptyTuple(
      ShapeUtil::MakeValidatedTupleShape({ShapeUtil::MakeShape(F32, {0})})
          .value()));
}

TEST(ShapeUtilTest, NestedTuple) {
  EXPECT_FALSE(
      ShapeUtil::IsNestedTuple(ShapeUtil::MakeValidatedTupleShape({}).value()));
  EXPECT_FALSE(ShapeUtil::IsNestedTuple(
      ShapeUtil::MakeValidatedTupleShape({ShapeUtil::MakeShape(S32, {})})
          .value()));
  EXPECT_TRUE(ShapeUtil::IsNestedTuple(
      ShapeUtil::MakeValidatedTupleShape({ShapeUtil::MakeTupleShape({})})
          .value()));
  EXPECT_FALSE(ShapeUtil::IsNestedTuple(
      ShapeUtil::MakeValidatedTupleShape(
...
TEST(ShapeUtilTest, NestedTupleWithPtrs) {
  ...
  const Shape s32 = ShapeUtil::MakeValidatedShape(S32, {}).value();
  EXPECT_FALSE(ShapeUtil::IsNestedTuple(nil));
  EXPECT_FALSE(ShapeUtil::IsNestedTuple(
      ShapeUtil::MakeValidatedTupleShapeWithPtrs({&s32}).value()));
  EXPECT_TRUE(ShapeUtil::IsNestedTuple(
      ShapeUtil::MakeValidatedTupleShapeWithPtrs({&nil}).value()));
  EXPECT_FALSE(ShapeUtil::IsNestedTuple(
      ShapeUtil::MakeValidatedTupleShapeWithPtrs({&s32, &s32}).value()));
  EXPECT_TRUE(ShapeUtil::IsNestedTuple(
      ShapeUtil::MakeValidatedTupleShapeWithPtrs({&s32, &nil}).value()));
  EXPECT_TRUE(ShapeUtil::IsNestedTuple(
      ShapeUtil::MakeValidatedTupleShapeWithPtrs({&nil, &s32}).value()));
  EXPECT_TRUE(ShapeUtil::IsNestedTuple(
      ShapeUtil::MakeValidatedTupleShapeWithPtrs({&nil, &nil}).value()));
}

TEST(ShapeUtilTest, ElementsIn) {
  EXPECT_EQ(
      1, ShapeUtil::ElementsIn(ShapeUtil::MakeValidatedShape(S32, {}).value()));
  EXPECT_EQ(0, ShapeUtil::ElementsIn(
                   ShapeUtil::MakeValidatedShape(S32, {0}).value()));
  EXPECT_EQ(1, ShapeUtil::ElementsIn(
                   ShapeUtil::MakeValidatedShape(S32, {1}).value()));
  EXPECT_EQ(1, ShapeUtil::ElementsIn(
                   ShapeUtil::MakeValidatedShape(S32, {1, 1}).value()));
  EXPECT_EQ(2, ShapeUtil::ElementsIn(
                   ShapeUtil::MakeValidatedShape(S32, {2}).value()));
  EXPECT_EQ(2, ShapeUtil::ElementsIn(
                   ShapeUtil::MakeValidatedShape(S32, {2, 1}).value()));
  EXPECT_EQ(15, ShapeUtil::ElementsIn(
                    ShapeUtil::MakeValidatedShape(S32, {3, 5}).value()));
  EXPECT_EQ(0, ShapeUtil::ElementsIn(
                   ShapeUtil::MakeValidatedShape(S32, {3, 0, 5}).value()));
  EXPECT_EQ(0, ShapeUtil::ElementsIn(
                   ShapeUtil::MakeValidatedShape(S32, {0, 3, 0}).value()));
  EXPECT_EQ(15, ShapeUtil::ElementsIn(
                    ShapeUtil::MakeValidatedShape(S32, {1, 3, 5}).value()));
  EXPECT_EQ(221, ShapeUtil::ElementsIn(
                     ShapeUtil::MakeValidatedShape(S32, {13, 17}).value()));
}

TEST(ShapeUtilTest, HasPrimitiveType) {
  EXPECT_TRUE(ShapeUtil::HasPrimitiveType(
      ShapeUtil::MakeValidatedShape(S32, {}).value(), S32));
  EXPECT_FALSE(ShapeUtil::HasPrimitiveType(
      ShapeUtil::MakeValidatedShape(S32, {}).value(), S16));
  EXPECT_TRUE(ShapeUtil::HasPrimitiveType(
      ShapeUtil::MakeValidatedShape(S32, {0}).value(), S32));
  EXPECT_FALSE(ShapeUtil::HasPrimitiveType(
      ShapeUtil::MakeValidatedTupleShape({}).value(), S32));
  EXPECT_TRUE(ShapeUtil::HasPrimitiveType(
      ShapeUtil::MakeValidatedTupleShape(
          {ShapeUtil::MakeShape(S32, {}), ShapeUtil::MakeShape(S32, {})})
          .value(),
...
TEST(ShapeUtilTest, IsZeroElementArray) {
  ...
  EXPECT_TRUE(ShapeUtil::IsZeroElementArray(
      ShapeUtil::MakeValidatedShape(S32, {0}).value()));
  EXPECT_FALSE(ShapeUtil::IsZeroElementArray(
      ShapeUtil::MakeValidatedShape(S32, {1}).value()));
  EXPECT_FALSE(ShapeUtil::IsZeroElementArray(
  ...
  EXPECT_FALSE(ShapeUtil::IsZeroElementArray(
      ShapeUtil::MakeValidatedTupleShape({}).value()));
  EXPECT_FALSE(ShapeUtil::IsZeroElementArray(
      ShapeUtil::MakeValidatedTupleShape({ShapeUtil::MakeShape(S32, {0, 3, 0})})
          .value()));
}
...
TEST(ShapeUtilTest, SameDimensions) {
  ...
  EXPECT_TRUE(ShapeUtil::SameDimensions(
      ShapeUtil::MakeValidatedShape(S32, {2}).value(),
      ShapeUtil::MakeValidatedShape(S32, {2}).value()));
  EXPECT_FALSE(ShapeUtil::SameDimensions(
      ShapeUtil::MakeValidatedShape(S32, {1}).value(),
      ShapeUtil::MakeValidatedShape(F32, {2}).value()));
  EXPECT_FALSE(ShapeUtil::SameDimensions(
      ShapeUtil::MakeValidatedShape(S32, {0, 0}).value(),
      ShapeUtil::MakeValidatedShape(F32, {0}).value()));
  EXPECT_FALSE(ShapeUtil::SameDimensions(
      ShapeUtil::MakeValidatedShape(S32, {1}).value(),
      ShapeUtil::MakeValidatedShape(F32, {1, 1}).value()));
  EXPECT_FALSE(ShapeUtil::SameDimensions(
      ShapeUtil::MakeValidatedShape(S32, {}).value(),
  ...
  EXPECT_FALSE(ShapeUtil::SameDimensions(
      ShapeUtil::MakeValidatedShape(S32, {1}).value(),
      ShapeUtil::MakeValidatedShape(F32, {1, 0}).value()));
  EXPECT_FALSE(ShapeUtil::SameDimensions(
      ShapeUtil::MakeValidatedShape(S32, {1, 1}).value(),
      ShapeUtil::MakeValidatedShape(F32, {1, 2}).value()));
}

TEST(ShapeUtilTest, GetSubshape) {
  // Test array shape.
  Shape array_shape = ShapeUtil::MakeValidatedShape(F32, {42, 42, 123}).value();
  EXPECT_TRUE(
  ...
  // Test tuple shape.
  Shape tuple_shape = ShapeUtil::MakeValidatedTupleShape(
...
TEST(ShapeUtilTest, ForEachSubshapeArray) {
  const Shape shape = ShapeUtil::MakeValidatedShape(F32, {2, 3}).value();
  int calls = 0;
...
TEST(ShapeUtilTest, InsertedOrDeleted1SizedDimensions) {
  Shape shape0 = ShapeUtil::MakeValidatedShape(S32, {9, 1, 4}).value();
  Shape shape1 = ShapeUtil::MakeValidatedShape(S32, {1, 9, 4, 1}).value();
  Shape shape2 = ShapeUtil::MakeValidatedShape(S32, {3, 1, 12}).value();
  EXPECT_TRUE(
...
TEST(ShapeUtilTest, ForEachIndex) {
  ...
  for (const auto& data : test_data) {
    Shape shape = ShapeUtil::MakeValidatedShape(F32, data.dimensions).value();
...
TEST(ShapeUtilTest, ForEachIndexWithStatus) {
  Shape shape = ShapeUtil::MakeValidatedShape(F32, {10, 10}).value();
  // Increments at every invocation.
  int invocations = 0;
  auto increment_func =
      [&invocations](
...
TEST(ShapeUtilTest, ForEachIndexParallel_Empty) {
  Shape shape = ShapeUtil::MakeValidatedShape(F32, {2, 0}).value();
  bool called = false;
  auto set_func = [&](absl::Span<const int64_t> indexes,
                      int /*thread_id*/) -> absl::StatusOr<bool> {
    called = true;
...
TEST(ShapeUtilTest, ForEachIndexParallel_CalledFromMultipleThreads) {
  ...
  const Shape kShape =
      ShapeUtil::MakeValidatedShape(F32, {kDim0, kDim1}).value();
...
TEST(ShapeUtilTest, DimensionsUnmodifiedByReshape_1x1x1x1_to_1x1x1) {
  ...
  EXPECT_THAT(ShapeUtil::DimensionsUnmodifiedByReshape(
                  ShapeUtil::MakeValidatedShape(S32, {1, 1, 1, 1}).value(),
                  ShapeUtil::MakeValidatedShape(S32, {1, 1, 1}).value()),
...
TEST(ShapeUtilTest, DimensionsUnmodifiedByReshape_4x1x3x5x6x7_to_2x6x1x5x1x42) {
  ...
  EXPECT_THAT(
      ShapeUtil::DimensionsUnmodifiedByReshape(
          ShapeUtil::MakeValidatedShape(S32, {4, 1, 3, 5, 6, 7}).value(),
          ShapeUtil::MakeValidatedShape(S32, {2, 6, 1, 5, 1, 42}).value()),
...
TEST(ShapeUtilTest, HasDegenerateDimensions) {
  EXPECT_TRUE(ShapeUtil::HasDegenerateDimensions(
      ShapeUtil::MakeValidatedShape(F32, {3, 1, 2}).value()));
  EXPECT_TRUE(ShapeUtil::HasDegenerateDimensions(
      ShapeUtil::MakeValidatedShape(F32, {3, 1, 1}).value()));
  EXPECT_FALSE(ShapeUtil::HasDegenerateDimensions(
      ShapeUtil::MakeValidatedShape(F32, {3, 3, 5}).value()));
  EXPECT_FALSE(ShapeUtil::HasDegenerateDimensions(
      ShapeUtil::MakeValidatedShape(F32, {3, 0, 5}).value()));
}
...
TEST(ShapeUtilTest, UpdateDynamicDimensions) {
  ...
  Shape tuple_shape = ShapeUtil::MakeValidatedTupleShape({shape}).value();
...
TEST(ShapeUtilTest, PermuteDynamicDimensions) {
  Shape shape =
      ShapeUtil::MakeValidatedShape(F32, {10, 100, 1000},
...
TEST(ShapeUtilTest, PrependMajorDimension) {
  Shape shape = ShapeUtil::MakeValidatedShape(F32, {10, 20, 30}).value();
  EXPECT_EQ(ShapeUtil::PrependMajorDimension(40, shape),
            ShapeUtil::MakeValidatedShape(F32, {40, 10, 20, 30}).value());
...
TEST(ShapeUtilTest, MoveDimToMajor) {
  Shape shape = ShapeUtil::MakeValidatedShape(F32, {10, 10, 10})
                    .value();  // implicit {2, 1, 0}
...
TEST(ShapeUtilTest,
  ...
  Shape shape = ShapeUtil::MakeValidatedShape(
                    F32, {128, 24, Shape::kUnboundedSize, 48, 48},
  ...
  *shape.mutable_layout() = LayoutUtil::MakeLayout({2, 4, 3, 1, 0});
  Shape new_shape =
      ShapeUtil::MakeValidatedShapeWithDescendingLayoutAndSamePhysicalLayout(
          shape)
          .value();
  Shape expected_shape = ShapeUtil::MakeValidatedShape(
                             F32, {128, 24, 48, 48, Shape::kUnboundedSize},
...
TEST(ShapeUtilTest, Int4ShapeSize) {
  Shape int4_shape = ShapeUtil::MakeValidatedShape(S4, {64, 128}).value();
  ...
  Shape int4_shape2 = ShapeUtil::MakeValidatedShape(S4, {9216, 6144}).value();
...
TEST(XlaShapeUtilTest, ZeroSize) {
  ...
  for (const auto& dimensions : test_cases) {
    xla::Shape int4_shape =
        ShapeUtil::MakeValidatedShape(xla::S4, dimensions).value();
    int4_shape.mutable_layout()->set_element_size_in_bits(4);
...
TEST(AlignmentTest, AlignLayoutsWithoutTrivialDimensions) {
  ...
  auto aligned_shape = ShapeUtil::AlignLayouts(
      input,
      ShapeUtil::MakeValidatedShape(xla::F32, {4, 3, 2, 7, 5, 11}).value());
  ...
  aligned_shape = ShapeUtil::AlignLayouts(
      input,
      ShapeUtil::MakeValidatedShape(xla::F32, {3, 2, 4, 35, 11}).value());
  EXPECT_TRUE(aligned_shape);
  EXPECT_THAT(aligned_shape.value().layout().minor_to_major(),
...
TEST(AlignmentTest, AlignLayoutsWithTrivialDimensions) {
  ...
  auto aligned_shape = ShapeUtil::AlignLayouts(
      input,
      ShapeUtil::MakeValidatedShape(xla::F32, {1, 4, 1, 3, 2, 7, 5, 11, 1})
          .value());
  EXPECT_TRUE(aligned_shape);
  EXPECT_TRUE(ShapeUtil::ReshapeIsBitcast(input, aligned_shape.value()));
}
...
TEST(AlignmentTest, AlignLayoutsWithAllTrivialDimensions) {
  ...
  auto aligned_shape = ShapeUtil::AlignLayouts(
      input, ShapeUtil::MakeValidatedShape(xla::F32, {1, 1, 1, 1, 1}).value());
  EXPECT_TRUE(aligned_shape);
  EXPECT_TRUE(ShapeUtil::ReshapeIsBitcast(input, aligned_shape.value()));
}
...
TEST(AlignmentTest,
  ...
  Shape input = ShapeUtil::MakeShapeWithDenseLayout(xla::F32, {3, 8, 5, 7, 11},
                                                    {3, 2, 1, 0, 4});
  auto aligned_shape = ShapeUtil::AlignLayouts(
      input, ShapeUtil::MakeValidatedShape(xla::F32, {4, 3, 2, 5, 77}).value());
  EXPECT_FALSE(aligned_shape);
}
...
Shape ShapeForBenchmark(::testing::benchmark::State& state) {
  ...
  switch (state.range(0)) {
    case 0: {
      shape = ShapeUtil::MakeValidatedShape(xla::F32, {1}).value();
      break;
    }
    case 1: {
      shape = ShapeUtil::MakeValidatedShape(xla::F32, {4, 1}).value();
      break;
    }
    case 2: {
      shape = ShapeUtil::MakeValidatedShape(xla::F32, {256, 1, 1024}).value();
      break;
    }
  }
