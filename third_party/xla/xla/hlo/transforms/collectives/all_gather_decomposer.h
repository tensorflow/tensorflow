...
#ifndef XLA_HLO_TRANSFORMS_COLLECTIVES_ALL_GATHER_DECOMPOSER_H_
#define XLA_HLO_TRANSFORMS_COLLECTIVES_ALL_GATHER_DECOMPOSER_H_
...
#endif  // XLA_HLO_TRANSFORMS_COLLECTIVES_ALL_GATHER_DECOMPOSER_H_
