...
Shape ReduceWindowUtil::ShapeAtIndex(const Shape& shape,
...
HloInstruction* ReduceWindowUtil::GetAtIndex(HloInstruction* hlo,
                                             const ShapeIndex& shape_index) {
  if (shape_index.empty()) {
    return hlo;
  }
...
absl::Status ReduceWindowUtil::Replace1DReduceWindowWithReshape(
