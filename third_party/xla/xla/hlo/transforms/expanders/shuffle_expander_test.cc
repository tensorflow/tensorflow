...
ENTRY main {
  ...
  EXPECT_EQ(dim0_slice0->slice_starts(), (std::vector<int64_t>{1, 0}));
  EXPECT_EQ(dim0_slice0->slice_limits(), (std::vector<int64_t>{2, 3}));
  EXPECT_EQ(dim0_slice0->slice_strides(), (std::vector<int64_t>{1, 1}));

  EXPECT_EQ(dim0_slice1->operand(0), p0);
  EXPECT_EQ(dim0_slice1->slice_starts(), (std::vector<int64_t>{0, 0}));
  EXPECT_EQ(dim0_slice1->slice_limits(), (std::vector<int64_t>{1, 3}));
  EXPECT_EQ(dim0_slice1->slice_strides(), (std::vector<int64_t>{1, 1}));
  ...
  EXPECT_EQ(dim1_slice0->slice_starts(), (std::vector<int64_t>{0, 2}));
  EXPECT_EQ(dim1_slice0->slice_limits(), (std::vector<int64_t>{2, 3}));
  EXPECT_EQ(dim1_slice0->slice_strides(), (std::vector<int64_t>{1, 1}));

  EXPECT_EQ(dim1_slice1->slice_starts(), (std::vector<int64_t>{0, 0}));
  EXPECT_EQ(dim1_slice1->slice_limits(), (std::vector<int64_t>{2, 2}));
  EXPECT_EQ(dim1_slice1->slice_strides(), (std::vector<int64_t>{1, 1}));
}
