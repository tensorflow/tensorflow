...
class HloFunctionImporter {
 ...
 private:
  ...
  // must be in permute or multi-rotate mode, is imported as: one index of the
  // operand of `shuffle` for every element of its result.
  absl::StatusOr<mlir::Value> ImportShuffleStartIndices(
