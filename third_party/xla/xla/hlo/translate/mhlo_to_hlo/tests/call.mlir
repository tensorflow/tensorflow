...
module @call_with_sharding_multiple_results {
  func.func @main(%arg0: tensor<8x2xi32>) -> tensor<8x2xi32> {
    ...
    // CHECK-SAME:     sharding={{[{][{]maximal device=0}, {replicated[}][}]}}, {{.*}}backend_config={"flag_configs":[],"scoped_memory_configs":[],"device_type":"DEVICE_TYPE_HOST","used_scoped_memory_configs":[]}
