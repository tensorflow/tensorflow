...
// Returns an OpSharding that represents the sharding contained within the
// frontend attributes of the given `op`. Returns std::nullopt if no sharding
// is found.
std::optional<xla::OpSharding> ExtractShardingFromFrontendAttrs(
    mlir::Operation* op);

// Returns an OpSharding that represents the sharding contained within the
// frontend attributes of the argument at `arg_num` in `function`. Returns
...
// Returns an OpSharding that represents the sharding contained within the
// frontend attributes of the result at `res_num` in `function`. Returns
// std::nullopt if no sharding is found.
