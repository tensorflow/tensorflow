...
class SymbolicExprStorage : public mlir::StorageUniquer::BaseStorage {
 ...
 protected:
  ...
  friend SymbolicExpr CreateSymbolicConstant(int64_t value,
                                             mlir::MLIRContext* mlir_context);
  friend SymbolicExpr CreateSymbolicVariable(int64_t var_id,
                                             mlir::MLIRContext* mlir_context);
  friend SymbolicExpr CreateSymbolicBinaryOp(SymbolicExprType type,
...
SymbolicExpr GetOrCreateSymbolicExpr(SymbolicExprType type, int64_t value,
  ...
  // TODO(karupayun): I am afraid this might be too slow.
