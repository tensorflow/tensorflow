...
class ShapeTracker {
 public:
  ...
  // Concatenates another ShapeTracker's dimensions to this one, applying
  // their transformations independently.
  friend absl::StatusOr<ShapeTracker> ConcatenateDimensions(
      const ShapeTracker& lhs, const ShapeTracker& rhs);
