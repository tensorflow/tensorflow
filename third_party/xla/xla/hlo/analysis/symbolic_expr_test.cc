...
TEST_F(SymbolicExprTest, UniquingWorksAcrossDifferentMlirContexts) {
  mlir::MLIRContext mlir_context2;

  EXPECT_NE(CreateSymbolicConstant(42, &ctx),
            CreateSymbolicConstant(42, &mlir_context2));
  EXPECT_NE(CreateSymbolicVariable(0, &ctx),
            CreateSymbolicVariable(0, &mlir_context2));
}
