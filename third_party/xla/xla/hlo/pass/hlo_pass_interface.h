...
class HloPassInterface {
 public:
  ...
  //
  // When a derived class overrides one of the overloaded functions, C++ hides
  // the non-overridden overloaded functions in the derived class. The the
  // non-overridden overloaded functions may be called with 1. explicit
  // qualification, 2. casting, or 3. brought to the derived class with `using
  // BaseClass::OverloadedFunction`. Example declaration with `using` for the
  // Run function:
  ...
  //
  // See the caveat about non-overridden overloaded functions in the Run
  // function above.
