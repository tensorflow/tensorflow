...
// The instructions are first matched by node similarity like shape, metadata,
// etc. If 'Add' is set to true, the left unmatched instructions are
// matched by position one by one.
