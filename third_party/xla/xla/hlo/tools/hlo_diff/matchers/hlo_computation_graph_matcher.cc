...
void MatchComputationParams(const HloGumgraph& left_graph,
  ...
  MatchSameTypeInstructions(
      left_graph, right_graph, left_params, right_params, mappings,
      matcher_type,
      /*map_by_position=*/
      !left_computation.computation()->IsEntryComputation() &&
          left_params.size() == right_params.size());
}
...
void MatchComputationConstants(const HloGumgraph& left_graph,
  ...
  MatchSameTypeInstructions(
      left_graph, right_graph, left_constants, right_constants, mappings,
      matcher_type,
      /*map_by_position=*/
      !left_computation.computation()->IsEntryComputation() &&
