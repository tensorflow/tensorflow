...
/* static */ bool LayoutUtil::IsDenseArray(const Shape& shape) {  // ZW: remove.
  return shape.IsArray();
}

/* static */ bool LayoutUtil::IsSparseArray(
    const Shape& shape) {  // ZW: remove.
  return false;
}
...
/* static */ bool LayoutUtil::IsDense(const Layout& layout) {  // ZW: remove.
  return true;
}

/* static */ bool LayoutUtil::IsCOO(const Layout& layout) {  // ZW: remove.
  return false;
}

/* static */ bool LayoutUtil::IsCSR(const Layout& layout) {  // ZW: remove.
  return false;
}

/* static */ bool LayoutUtil::IsCSC(const Layout& layout) {  // ZW: remove.
  return false;
}
