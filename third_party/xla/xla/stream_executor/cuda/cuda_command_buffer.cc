...
#include "xla/stream_executor/cuda/cuda_graph_conditional.h"
...
absl::Status CudaCommandBuffer::LaunchSetIfElseConditionKernel(
  ...
  return CommandBuffer::Launch(set_if_else_condition_kernel_,
                               ...
                               if_conditional->handle(),
                               else_conditional->handle(), predicate);
}
absl::Status CudaCommandBuffer::LaunchSetIfConditionKernel(
  ...
  return CommandBuffer::Launch(set_if_condition_kernel_, execution_scope_id,
                               ThreadDim(), BlockDim(),
                               if_conditional->handle(), predicate);
}
absl::Status CudaCommandBuffer::LaunchSetForConditionKernel(
  ...
  return CommandBuffer::Launch(set_for_condition_kernel_, execution_scope_id,
                               ThreadDim(), BlockDim(), conditional->handle(),
...
CudaCommandBuffer::CreateConditionalNode(const Dependencies& dependencies,
  ...
  cu_params.conditional.handle =
      static_cast<CudaGraphConditional*>(conditional)->handle();
...
absl::StatusOr<GraphConditional*> CudaCommandBuffer::CreateConditionalHandle() {
  ...
  conditionals_.push_back(std::make_unique<CudaGraphConditional>(handle));
  return conditionals_.back().get();
#else
  return absl::UnimplementedError(
