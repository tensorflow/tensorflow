...
#ifndef XLA_STREAM_EXECUTOR_ROCM_HIP_GRAPH_NODE_H_
#define XLA_STREAM_EXECUTOR_ROCM_HIP_GRAPH_NODE_H_
...
class RocmCommandBuffer;

// The ROCm specific implementation of the GpuGraphNode. It represents a node
// in a HIP graph with methods to update its properties. It's tied to
// RocmCommandBuffer and can't be used on its own.
class HipGraphNode final : public GpuGraphNode {
 public:
...
#endif  // XLA_STREAM_EXECUTOR_ROCM_HIP_GRAPH_NODE_H_
