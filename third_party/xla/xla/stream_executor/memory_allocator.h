...
class MemoryAllocator {
 public:
  ...
  // payload must report the exact tracked allocation size. Handles
  // reconstructed from a base pointer use pointer lookup and may report zero
  // or any size no larger than the tracked allocation size. Passing a different
  // base address, an oversized range, or an untracked address is an error.
