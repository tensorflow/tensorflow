...
==============================================================================*/
#ifndef XLA_STREAM_EXECUTOR_GPU_BUFFER_DEBUG_XOR_CHECKSUM_KERNEL_LIB_CU_H_
#define XLA_STREAM_EXECUTOR_GPU_BUFFER_DEBUG_XOR_CHECKSUM_KERNEL_LIB_CU_H_
...
// Atomically increments `*write_idx` with system scope and returns the previous
// value. Defined by the platform-specific translation unit, as the intrinsic
// differs between CUDA and ROCm.
...
#endif  // XLA_STREAM_EXECUTOR_GPU_BUFFER_DEBUG_XOR_CHECKSUM_KERNEL_LIB_CU_H_
