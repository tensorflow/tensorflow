...
#ifndef XLA_STREAM_EXECUTOR_GPU_COLLECTIVE_KERNEL_UTIL_CU_H_
#define XLA_STREAM_EXECUTOR_GPU_COLLECTIVE_KERNEL_UTIL_CU_H_
...
template <PlatformType T = PlatformType::NOGPU,
          int64_t kMaxNumSignalPadPtrs = 8>
__device__ __forceinline__ void SyncRemoteBlocks(
    std::array<uint32_t* __restrict__, kMaxNumSignalPadPtrs> signal_pad_ptrs,
...
#endif  // XLA_STREAM_EXECUTOR_GPU_COLLECTIVE_KERNEL_UTIL_CU_H_
