...
struct BlasLtGemmRunner {
  ...
  absl::Status Run(Stream& stream, blas::Transpose trans_a,         
      ...
      const DeviceMemory<TypeB>& b, int64_t ldb, 
      Scalar beta, DeviceMemory<TypeC> *c, int64_t ldc, 
  ...
  absl::Status Run(Stream& stream, blas::Transpose trans_a,
      blas::Transpose trans_b, int64_t m, int64_t n, int64_t k, 
      Scalar alpha, const TypeA* a, int64_t lda, 
      const TypeB *b, int64_t ldb, 
      Scalar beta, TypeC *c, int64_t ldc, 
      ScratchAllocator* allocator) {
  ...
  absl::Status RunStridedBatched(Stream& stream, blas::Transpose trans_a, 
      blas::Transpose trans_b, int64_t m, int64_t n, int64_t k, 
      Scalar alpha, const TypeA* a, int64_t lda, int64_t stride_a, 
      const TypeB* b, int64_t ldb, int64_t stride_b,
      Scalar beta, TypeC* c, int64_t ldc, int64_t stride_c,
  ...
  absl::Status RunStridedBatched(Stream& stream, blas::Transpose trans_a, 
      blas::Transpose trans_b, int64_t m, int64_t n, int64_t k, 
      Scalar alpha, const DeviceMemory<TypeA>& a, int64_t lda, int64_t stride_a, 
      const DeviceMemory<TypeB>& b, int64_t ldb, int64_t stride_b,
      Scalar beta, DeviceMemory<TypeC> *c, int64_t ldc, int64_t stride_c,
      int64_t batch_count, ScratchAllocator* allocator) {
...
//         blas::Transpose trans_b, int64_t m, int64_t n, int64_t k, Scalar alpha, 
//         const port::ArraySlice<DeviceMemory<T> *> &a, int64_t lda, 
//         const port::ArraySlice<DeviceMemory<T> *> &b, int64_t ldb, Scalar beta,
//         const port::ArraySlice<DeviceMemory<T> *> &c, int64_t ldc, 
//         int64_t batch_count, ScratchAllocator* allocator) {
...
//       T** c, int64_t ldc, int64_t batch_count, ScratchAllocator* allocator){
...
private:
  ...
  absl::Status RunStridedBatchedImpl(Stream& stream, blas::Transpose trans_a, 
      blas::Transpose trans_b, int64_t m, int64_t n, int64_t k, xla::complex128 alpha, 
