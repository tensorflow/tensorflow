...
#ifndef XLA_STREAM_EXECUTOR_INTEGRATIONS_GPU_VIRTUAL_MEM_ALLOCATOR_H_
#define XLA_STREAM_EXECUTOR_INTEGRATIONS_GPU_VIRTUAL_MEM_ALLOCATOR_H_
...
#endif  // XLA_STREAM_EXECUTOR_INTEGRATIONS_GPU_VIRTUAL_MEM_ALLOCATOR_H_
