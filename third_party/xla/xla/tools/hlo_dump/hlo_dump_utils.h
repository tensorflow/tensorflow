...
#ifndef XLA_TOOLS_HLO_DUMP_HLO_DUMP_UTILS_H_
#define XLA_TOOLS_HLO_DUMP_HLO_DUMP_UTILS_H_
...
struct TensorKey {
  ...
  bool operator!=(const TensorKey& other) const { return !(*this == other); }
...
#endif  // XLA_TOOLS_HLO_DUMP_HLO_DUMP_UTILS_H_
