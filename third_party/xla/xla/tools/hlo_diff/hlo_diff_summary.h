...
#ifndef XLA_TOOLS_HLO_DIFF_HLO_DIFF_SUMMARY_H_
#define XLA_TOOLS_HLO_DIFF_HLO_DIFF_SUMMARY_H_
...
#include "xla/tools/hlo_diff/graph/hlo_gumgraph.h"
#include "xla/tools/hlo_diff/hlo_diff_result.h"
#include "xla/tools/hlo_diff/hlo_gumgraph_mappings.h"
...
struct ComputationSummary {
  ...
  // Insructions are matched in the previous step of go/hlo-diff.
...
#endif  // XLA_TOOLS_HLO_DIFF_HLO_DIFF_SUMMARY_H_
