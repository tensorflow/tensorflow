...
#ifndef XLA_TOOLS_HLO_DIFF_UTILS_CONNECTED_COMPONENTS_H_
#define XLA_TOOLS_HLO_DIFF_UTILS_CONNECTED_COMPONENTS_H_
...
#endif  // XLA_TOOLS_HLO_DIFF_UTILS_CONNECTED_COMPONENTS_H_
