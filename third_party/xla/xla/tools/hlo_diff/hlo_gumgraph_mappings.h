...
#ifndef XLA_TOOLS_HLO_DIFF_HLO_GUMGRAPH_MAPPINGS_H_
#define XLA_TOOLS_HLO_DIFF_HLO_GUMGRAPH_MAPPINGS_H_

#include <cstdint>

#include "boost/bimap.hpp"
#include "xla/service/call_graph.h"
#include "xla/tools/hlo_diff/graph/hlo_gumgraph_node.h"
...
struct HloGumgraphMappings {
  ...
  // http://shortn/_9YoAvcfH9N for more details on the bimap API.
...
#endif  // XLA_TOOLS_HLO_DIFF_HLO_GUMGRAPH_MAPPINGS_H_
