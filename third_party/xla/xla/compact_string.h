...
class CompactString {
 public:
  ...
  CompactString& operator=(absl::string_view s) {
    set(s);
    return *this;
  }
 ...
 private:
  ...
  // rep plus a null terminating '\0' character, which starts with the length
  // encoded as a varint value, followed by the actual bytes of the string,
  // followed by '\0'
