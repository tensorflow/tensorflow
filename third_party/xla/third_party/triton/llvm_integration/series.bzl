...
llvm_patch_list = [
    "//third_party/triton:llvm_integration/cl663261950.patch",
    "//third_party/triton:llvm_integration/cl667589778.patch",
    "//third_party/triton:llvm_integration/cl669413924.patch",
