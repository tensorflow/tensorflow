...
genrule(
    ...
    cmd = "\n".join([
        ...
        "",
        "#if defined(_WIN32)",
        # Starting in curl 8.22.0, lib/config-win32.h has a preprocessor #error
        # rejecting _MSC_VER > 1800 (restricting it to legacy MSVC 2010-2013
        # IDE builds). We inline the Windows configuration macros from
        # lib/config-win32.h here instead of including it directly.
