...
alias(
  name = "nccl",
  actual = if_hermetic_nccl_libs("@cuda_nccl//:nccl", "@nccl_archive//:nccl"),
  visibility = ["//visibility:public"],
)
...
alias(
  name = "nccl_config",
  actual = if_hermetic_nccl_libs(":hermetic_nccl_config", "@nccl_archive//:nccl_config"),
  visibility = ["//visibility:public"],
)
"""
...
alias(
  name = "nccl",
  actual = if_hermetic_nccl_libs("@cuda_nccl//:nccl", "@nccl_archive//:nccl_via_stub"),
  visibility = ["//visibility:public"],
)

alias(
  name = "nccl_headers",
  actual = if_hermetic_nccl_libs("@cuda_nccl//:headers", "@nccl_archive//:nccl_headers"),
  visibility = ["//visibility:public"],
)
