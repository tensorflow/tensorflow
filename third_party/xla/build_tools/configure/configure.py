...
def _parse_args():
    ...
    parser.add_argument(
        "--local_cuda_path",
        help=(
            "Optional: Local CUDA dir will be used in dependencies if the flag is set"
        ),
    )
    parser.add_argument(
        "--local_cudnn_path",
        help=(
            "Optional: Local CUDNN dir will be used in dependencies if the flag is set"
        ),
    )
    parser.add_argument(
        "--local_nccl_path",
        help=(
            "Optional: Local NCCL dir will be used in dependencies if the flag is set"
        ),
    )
...
def is_hermetic_build(backend: Backend, os_host: OS):
    return backend != Backend.ROCM and os_host == OS.LINUX
