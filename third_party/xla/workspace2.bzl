...
def _tf_repositories():
    ...
    tf_http_archive(
        ...
        patch_file = [
            "//third_party/googletest:add-status-macros.patch",
            # This has to be applied after add-status-macros to also replace
            # the dependences added there. It's not used in bzlmod build.
