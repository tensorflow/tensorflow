...
def workspace():
    ...
    if "rules_ml_toolchain" not in native.existing_rules():
        http_archive(
            ...
            sha256 = "5e603c5ccd68d475cf5cf4ead4ec1a35c0f8cf5b540c99218683f1afe418bf89",
            strip_prefix = "rules_ml_toolchain-ace8302a15036dd1c700599211ab4d9e408072c6",
            urls = [
                "https://github.com/google-ml-infra/rules_ml_toolchain/archive/ace8302a15036dd1c700599211ab4d9e408072c6.tar.gz",
            ],
        )
