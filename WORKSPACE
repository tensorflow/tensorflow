...
http_archive(
    ...
    urls = [
        "https://github.com/yuriivcs/rules_ml_toolchain/archive/fc6c2df611c648ebe0c01bbaa4d1406fbe23a3c3.tar.gz",
    ],
)
...
register_toolchains("@rules_ml_toolchain//cc:linux_x86_64_linux_x86_64_ext")

register_toolchains("@rules_ml_toolchain//cc:linux_x86_64_linux_x86_64_cuda")

register_toolchains("@rules_ml_toolchain//cc:linux_aarch64_linux_aarch64")

register_toolchains("@rules_ml_toolchain//cc:linux_aarch64_linux_aarch64_ext")
