...
load("//third_party/KDNN:repository.bzl", "kdnn_repository")  # copybara:comment_replace load("//third_party/tensorflow/third_party/KDNN:repository.bzl", "kdnn_repository")
