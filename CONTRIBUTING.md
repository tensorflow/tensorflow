...
*   When you contribute a new feature to TensorFlow, the maintenance burden is
    (by default) transferred to the TensorFlow team. This means that the benefit of
...
*   Full new features (e.g., a new op implementing a cutting-edge algorithm)
    ...
    airtime before a decision is made regarding whether they are to be migrated to
    the core.
