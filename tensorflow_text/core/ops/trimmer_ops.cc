...
#ifndef THIRD_PARTY_TENSORFLOW_TEXT_CORE_OPS_TRIMMER_OPS_H_
#define THIRD_PARTY_TENSORFLOW_TEXT_CORE_OPS_TRIMMER_OPS_H_
...
#endif  // THIRD_PARTY_TENSORFLOW_TEXT_CORE_OPS_TRIMMER_OPS_H_
